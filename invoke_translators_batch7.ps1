...
$articles = @("network-dns", "technology-blockchain", "technology-credit-card", "history-electronic-money", "game-shogi-rules")
...
$json += "] }"
$json | Out-File -Encoding utf8 subagents7.json
