...
後來發現高斯也使用對數積分 $ \text{Li}(x) $ 做出了類似的猜想，最終在1896年，[質數定理](/zh-tw/p/prime-number-theorem/)被雅克·阿達馬和夏爾·德·拉瓦萊-普桑完全獨立地證明。雖然嚴格的證明超出了他的能力範圍，但它表明勒讓德的直覺在本質上是多麼正確。
...
此外，關於[質數定理](/zh-tw/p/prime-number-theorem/)（勒讓德的猜想 $ \pi(x) \approx \frac{x}{\ln x - 1.08366} $）和二次互反律，即使勒讓德首先發現並表述了它們，高斯卻完全證明了它們，並對其進行了更深層次的推廣，導致所有的公眾讚譽都集中在高斯身上。對勒讓德來說，高斯是一座太高的牆，奪走了他所有的成就，成為他一生的宿敵。
