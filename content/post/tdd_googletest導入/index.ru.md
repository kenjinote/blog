...
Здесь на помощь приходят **внедрение зависимостей ([Dependency Injection](https://kenji.blog/ru/p/design-patterns-modern-practices/): DI)** и создание моков для интерфейсов с использованием **GoogleMock**.
...
**Решение**: Сведите к минимуму зависимости заголовочных файлов, используя предварительные объявления (Forward Declaration) и идиому Pimpl ([Pointer](https://kenji.blog/ru/p/c-language-pointers-memory-management-stack-heap/) to implementation). Также эффективным будет использование инструментов кэширования сборки, таких как Ccache.
