...
यहीं पर **डिपेंडेंसी इंजेक्शन ([Dependency Injection](https://kenji.blog/hi/p/design-patterns-modern-practices/): DI)** और **GoogleMock** का उपयोग करके इंटरफेस की मॉकिंग काम आती है।
...
**समाधान**: फॉरवर्ड डिक्लेरेशन (Forward Declaration) और Pimpl ([Pointer](https://kenji.blog/hi/p/c-language-pointers-memory-management-stack-heap/) to implementation) इडियम का उपयोग करके हेडर फ़ाइलों की निर्भरता को कम करें। इसके अलावा, Ccache जैसे बिल्ड कैशिंग टूल पेश करना भी प्रभावी हो सकता है।
