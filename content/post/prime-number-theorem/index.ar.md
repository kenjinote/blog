...
من أجمل النتائج في مجال الرياضيات هي **نظرية الأعداد الأولية** ([Prime Number Theorem](https://kenji.blog/ar/p/prime-number-theorem/), PNT). إنها توضح أن الأعداد الأولية، التي تبدو للوهلة الأولى غير منتظمة وتظهر بشكل عشوائي، تمتلك انتظامًا سلسًا بشكل مذهل عند النظر إليها من منظور كلي.
...
يعود تاريخ نظرية الأعداد الأولية إلى أواخر القرن الثامن عشر. لاحظ عالم الرياضيات العبقري كارل فريدريش غاوس، وهو في الخامسة عشرة من عمره فقط، أثناء نظره في جداول الأعداد الأولية أن وتيرة ظهور الأعداد الأولية ترتبط بالدالة اللوغاريتمية. وفي نفس الوقت تقريبًا، وضع [أدريان-ماري ليجاندر](https://kenji.blog/ar/p/legendre/) بشكل مستقل حدسية مشابهة.
...
يرتبط بنظرية الأعداد الأولية ارتباطًا لا ينفصل أهم مسألة غير محلولة في الرياضيات وهي **فرضية ريمان** ([Riemann](https://kenji.blog/ar/p/riemann/) Hypothesis).
...
تستفيد خوارزميات تشفير المفتاح العام مثل [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) من خاصية أن "التحليل إلى العوامل الأولية للأعداد الصحيحة الضخمة أمر بالغ الصعوبة". تضمن نظرية الأعداد الأولية الاحتمال الذي يمكن من خلاله العثور على "أعداد أولية بالحجم المناسب" ضرورية لإنشاء مفاتيح التشفير.
