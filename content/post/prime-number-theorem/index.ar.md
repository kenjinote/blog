...
من أجمل النتائج في مجال الرياضيات هي **نظرية الأعداد الأولية** ([Prime Number Theorem](https://kenji.blog/p/prime-number-theorem/), PNT). إنها توضح أن الأعداد الأولية، التي تبدو للوهلة الأولى غير منتظمة وتظهر بشكل عشوائي، تمتلك انتظامًا سلسًا بشكل مذهل عند النظر إليها من منظور كلي.
