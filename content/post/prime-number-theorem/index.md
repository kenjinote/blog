...
証明の大きな進展は、1859年の[ベルンハルト・リーマン](https://kenji.blog/p/riemann/)による画期的な論文「与えられた数より小さい素数の個数について」によってもたらされました。リーマンは、複素関数である **ゼータ関数** $\zeta(s)$ を用いて、素数の分布を複素数平面上の問題に変換するという全く新しいアプローチを提示しました。
