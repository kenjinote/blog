...
企業の売上高や従業員数、さらには個人の所得分布も **べき乗則** に従います。所得分布に関する法則は、イタリアの経済学者ヴィルフレド・パレートにちなんで **[パレートの法則](/p/business-pareto-principle/)** （Pareto Principle）と呼ばれます。「全体の80%の富は、20%の人が所有している」という「80:20の法則」としても知られています。数学的には、 **[ジップの法則](https://kenji.blog/p/zipfs-law/)** と **[パレートの法則](/p/business-pareto-principle/)** は同じ現象を異なる角度（順位か、規模か）から見ているに過ぎません。
