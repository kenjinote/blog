---
title: "Edsger Dijkstra: Der rebellische Philosoph, der die Grundlagen der Informatik legte"
...
```mermaid
graph TD
    A["Edsger W. Dijkstra (1930-2002)"] --> B["Kürzeste-Wege-Algorithmus (1956)"]
    A --> C["ALGOL 60 Compiler (1960)"]
    A --> D["THE Betriebssystem (1968)"]
    A --> E["Strukturierte Programmierung (1968)"]
    A --> F["Philosophenproblem"]
    
    B --> G["Modernes Routing & GPS"]
    C --> H["Grundlage der Blockstruktur"]
    D --> I["Semaphor & Nebenläufigkeit"]
    E --> J["Clean Code & Lesbarkeit"]
    F --> K["Deadlock-Vermeidung"]
    
    I --> L["Modernes OS-Design"]
