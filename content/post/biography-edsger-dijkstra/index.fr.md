---
title: "Edsger Dijkstra : Le philosophe rebelle qui a posé les fondations de l'informatique"
...
```mermaid
graph TD
    A["Edsger W. Dijkstra (1930-2002)"] --> B["Algorithme du plus court chemin (1956)"]
    A --> C["Compilateur ALGOL 60 (1960)"]
    A --> D["Système d'exploitation THE (1968)"]
    A --> E["Programmation structurée (1968)"]
    A --> F["Problème des philosophes en train de dîner"]
    
    B --> G["Routage moderne et GPS"]
    C --> H["Fondation de la structure de blocs"]
    D --> I["Sémaphore et concurrence"]
    E --> J["Code propre et lisibilité"]
    F --> K["Évitement des interblocages"]
    
    I --> L["Conception d'OS modernes"]
    J --> M["Ingénierie logicielle"]
    K --> L
```
