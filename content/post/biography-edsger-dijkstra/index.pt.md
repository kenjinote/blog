---
title: "Edsger Dijkstra: O filósofo rebelde que lançou as bases da ciência da computação"
...
```mermaid
graph TD
    A["Edsger W. Dijkstra (1930-2002)"] --> B["Algoritmo do Caminho Mais Curto (1956)"]
    A --> C["Compilador ALGOL 60 (1960)"]
    A --> D["Sistema Operacional THE (1968)"]
    A --> E["Programação Estruturada (1968)"]
    A --> F["Problema dos Filósofos Jantando"]
    
    B --> G["Roteamento Moderno e GPS"]
    C --> H["Fundação da Estrutura de Blocos"]
    D --> I["Semáforos e Concorrência"]
    E --> J["Código Limpo e Legibilidade"]
    F --> K["Prevenção de Interbloqueio"]
    
    I --> L["Design de SO Modernos"]
    J --> M["Engenharia de Software"]
    K --> L
```
