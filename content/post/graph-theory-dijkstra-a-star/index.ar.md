...
في علوم الحاسوب الحديثة، توفر **نظرية الرسوم البيانية** (Graph Theory) إطارًا رياضيًا قويًا لنمذجة هياكل الشبكات. في حياتنا اليومية، تُستخدم تقنية حساب "المسار الأقصر" في مواقف مختلفة مثل الملاحة في السيارات، وتوجيهات نقل السكك الحديدية، وتوجيه الإنترنت، وحتى البحث عن المسار في الذكاء الاصطناعي للألعاب.

في هذه المقالة، بدءًا من التعريف الرياضي لنظرية الرسوم البيانية التي تشكل أساس البحث عن المسار، سنشرح بشكل شامل آلية خوارزمية البحث التمثيلية **خوارزمية ديكسترا** (Dijkstra's Algorithm)، وتطورها الإضافي **خوارزمية A*** (A-Star Algorithm)، والبراهين الرياضية الخاصة بها، وطرق التنفيذ العملية باستخدام بايثون.
...
## 3. خوارزمية ديكسترا (Dijkstra's Algorithm)
...
عند استخدام الكومة الثنائية (Binary Heap) كطابور أولوية، يتم استخراج كل رأس من الطابور مرة واحدة، ويتم استرخاء كل حافة مرة واحدة.
