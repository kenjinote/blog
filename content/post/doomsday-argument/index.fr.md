...
categories: ["paradoxes", "probability-theory"]
tags:
  - Doomsday Argument
  - Théorème de Bayes
  - Philosophie
...
```mermaid
graph TD
    subgraph "Modèle court (Doom Early)"
        A_Early["Population totale N: Faible (ex. 200 milliards)"]
        B_Early["Votre position n: Proche de la fin"]
        A_Early -->|"Rend n=110 milliards ordinaire"| B_Early
    end

    subgraph "Modèle long (Doom Late)"
        A_Late["Population totale N: Élevée (ex. 10 000 milliards)"]
        B_Late["Votre position n: Extrêmement précoce"]
        A_Late -->|"Rend n=110 milliards exceptionnel"| B_Late
    end
```
