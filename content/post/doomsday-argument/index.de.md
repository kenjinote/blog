...
Lassen Sie uns diese Intuition mit **Bayes'scher Inferenz** (Bayesian Inference) rigoros mathematisch formulieren. Der [Satz von Bayes](https://kenji.blog/de/p/bayes-theorem/) beschreibt, wie die Wahrscheinlichkeit einer Hypothese (A-posteriori-Wahrscheinlichkeit) aktualisiert werden sollte, wenn ein neuer Beweis (Beobachtungsdaten) gefunden wird.
