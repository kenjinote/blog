...
دعنا نصيغ هذا الحدس رياضيًا بصرامة باستخدام **الاستدلال البايزي**. مبرهنة بايز توضح كيف يجب تحديث احتمال فرضية معينة (الاحتمال اللاحق) عند الحصول على دليل جديد (بيانات ملاحظة).
...
باستخدام هذه القيم، نحسب الاحتمال اللاحق لـ $H_{DOOM}$. بتوسيع مبرهنة بايز باستخدام قانون الاحتمال الكلي، نحصل على التالي:
