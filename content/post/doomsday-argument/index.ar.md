...
دعنا نصيغ هذا الحدس رياضيًا بصرامة باستخدام **الاستدلال البايزي**. [مبرهنة بايز](https://kenji.blog/p/bayes-theorem/) توضح كيف يجب تحديث احتمال فرضية معينة (الاحتمال اللاحق) عند الحصول على دليل جديد (بيانات ملاحظة).
...
باستخدام هذه القيم، نحسب الاحتمال اللاحق لـ $H_{DOOM}$. بتوسيع [مبرهنة بايز](https://kenji.blog/p/bayes-theorem/) باستخدام قانون الاحتمال الكلي، نحصل على التالي:
