...
मानवता का अंत कब होगा? इस प्रश्न को लंबे समय से धर्म, दर्शन और विज्ञान कथा के विषय के रूप में माना जाता रहा है। हालाँकि, 1980 के दशक के बाद से, शोधकर्ता सामने आए हैं जिन्होंने **संभाव्यता सिद्धांत (probability theory)** और **बायेसियन अनुमान (Bayesian inference)** का उपयोग करके इस प्रश्न के लिए एक गणितीय दृष्टिकोण का प्रयास किया है। वह है **कयामत का तर्क या [प्रलय का तर्क (Doomsday Argument)](https://kenji.blog/hi/p/doomsday-argument/)** जिसे हम इस बार पेश करेंगे।
...
graph TD
    subgraph "लेस्ली का कलश विचार प्रयोग"
        ...
        C -.->|"P(E#124;H1) = 1/10"| E["परिकल्पना 1 की संभावना अधिक है"]
