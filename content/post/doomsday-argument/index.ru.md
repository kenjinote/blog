...
Когда вымрет человечество? Этот вопрос издавна был темой религий, философии и научной фантастики. Однако начиная с 1980-х годов появились исследователи, попытавшиеся подойти к этому вопросу математически, используя **теорию вероятностей** и **байесовский вывод**. Это и есть **[Аргумент судного дня (Doomsday Argument)](https://kenji.blog/ru/p/doomsday-argument/)**, о котором пойдет речь.
...
graph TD
    subgraph "Мысленный эксперимент Лесли с урной"
        ...
        C -.->|"P(E#124;H1) = 1/10"| E["Правдоподобие Гипотезы 1 выше"]
...
Давайте строго математически сформулируем эту интуицию, используя **байесовский вывод**. [Теорема Байеса](https://kenji.blog/ru/p/bayes-theorem/) показывает, как следует обновлять вероятность гипотезы (апостериорную вероятность) при получении новых доказательств (данных наблюдений).
