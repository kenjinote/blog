---
title: "Martin Luther King Jr.: Die Verkörperung eines Traums, der die Welt durch Gewaltlosigkeit veränderte"
...
description: "Martin Luther King Jr. (15. Januar 1929 – 4. April 1968) war ein US-amerikanischer baptistischer Geistlicher und der prominenteste Führer der Bürgerrechtsb"
---
...
```mermaid
graph TD
    A["Montgomery Bus Boykott (1955)"] --> B["Gründung der SCLC (1957)"]
    B --> C["Birmingham-Kampagne (1963)"]
    C --> D["Marsch auf Washington (1963)"]
    D --> E["'I Have a Dream'-Rede"]
    E --> F["Bürgerrechtsgesetz verabschiedet (1964)"]
    E --> G["Friedensnobelpreis (1964)"]
    F --> H["Selma-nach-Montgomery-Märsche (1965)"]
    H --> I["Wahlrechtsgesetz verabschiedet (1965)"]
```
