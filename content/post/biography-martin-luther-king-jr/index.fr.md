...
description: "Martin Luther King Jr. (15 janvier 1929 - 4 avril 1968) était un pasteur baptiste protestant américain et le leader le plus éminent du mouvement des droits"
---
...
```mermaid
graph TD
    A["Boycott des bus de Montgomery (1955)"] --> B["Création du SCLC (1957)"]
    B --> C["Campagne de Birmingham (1963)"]
    C --> D["Marche sur Washington (1963)"]
    D --> E["Discours 'I Have a Dream'"]
    E --> F["Adoption du Civil Rights Act (1964)"]
    E --> G["Prix Nobel de la Paix (1964)"]
    F --> H["Marches de Selma à Montgomery (1965)"]
    H --> I["Adoption du Voting Rights Act (1965)"]
```
