...
```mermaid
graph TD
    A["Boikot Bus Montgomery (1955)"] --> B["Pendirian SCLC (1957)"]
    B --> C["Kampanye Birmingham (1963)"]
    C --> D["Pawai ke Washington (1963)"]
    D --> E["Pidato 'I Have a Dream'"]
    E --> F["Undang-Undang Hak Sipil Disahkan (1964)"]
    E --> G["Hadiah Nobel Perdamaian (1964)"]
    F --> H["Pawai Selma ke Montgomery (1965)"]
    H --> I["Undang-Undang Hak Pilih Disahkan (1965)"]
```
