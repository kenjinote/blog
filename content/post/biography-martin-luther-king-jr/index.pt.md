---
title: "Martin Luther King Jr.: A encarnação de um sonho que mudou o mundo através da não-violência"
...
```mermaid
graph TD
    A["Boicote aos Autocarros de Montgomery (1955)"] --> B["Estabelecimento da SCLC (1957)"]
    B --> C["Campanha de Birmingham (1963)"]
    C --> D["Marcha sobre Washington (1963)"]
    D --> E["Discurso 'I Have a Dream'"]
    E --> F["Lei dos Direitos Civis Aprovada (1964)"]
    E --> G["Prémio Nobel da Paz (1964)"]
    F --> H["Marchas de Selma a Montgomery (1965)"]
    H --> I["Lei dos Direitos de Voto Aprovada (1965)"]
```
