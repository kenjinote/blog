...
[Carl Gustav Jacob Jacobi](https://kenji.blog/fr/p/jacobi/) (1804–1851) était un **mathématicien allemand** du 19e siècle qui a apporté des contributions décisives à divers domaines tels que l'algèbre, l'analyse, la théorie des nombres et la mécanique. Avec [Niels Henrik Abel](/fr/p/abel/), il est célèbre en tant que "découvreur des fonctions elliptiques" et a donné son nom au "[Jacobi](https://kenji.blog/fr/p/jacobi/)en" (déterminant jacobien) que nous rencontrons fréquemment dans le calcul multivariable aujourd'hui.
