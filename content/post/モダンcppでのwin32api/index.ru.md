...
В C++23 был введен тип `std::expected`, эквивалентный типу `Result` в [Rust](https://kenji.blog/ru/p/webassembly-wasm-current-future/). Это лучший способ модернизировать возвращаемые значения Win32 в проектах, которые не одобряют использование исключений (из-за производительности или архитектуры, где ошибки происходят часто).
