...
数学之美常常在于：极其简单的规则却能推导出无人预料的深奥结果。“ **[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)** ([Sperner's Lemma](https://kenji.blog/p/sperners-lemma/))”就是其中最具代表性的例子之一。这个由德国数学家埃马努埃尔·斯佩纳（Emanuel Sperner）于1928年发表的引理，乍看之下不过是一个连小学生都能看懂的“三角形着色拼图”。
...
在本文中，我们将结合图解，详细解释[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)：从其直观含义、严密的数学证明，到其作为通往连续世界的桥梁在不动点定理中的应用。

# 2. 单形与单纯复形：几何学基础

为了理解[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)，我们首先需要明确“ **单形** (Simplex)”和“ **单纯复形** (Simplicial Complex / Triangulation)”的概念。
...
对于这样分割成的三角形网络，为每个顶点着色，便构成了[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)的舞台。
...
# 4. [斯佩纳引理](https://kenji.blog/p/sperners-lemma/)的结论

当按照斯佩纳着色的规则完成着色后，会发生什么现象呢？[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)提出了以下令人惊叹的事实。

> **[斯佩纳引理](https://kenji.blog/p/sperners-lemma/) (二维)**
...
[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)不仅局限于二维的三角形，对于任意的 $n$ 维单形同样成立。
...
为什么[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)受到如此高的重视呢？这是因为这个离散定理成为了证明连续拓扑学定理—— **布劳威尔不动点定理** ——的桥梁。
...
## 7.2. 从[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)的推导路径

从[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)推导不动点定理的逻辑非常优雅。
...
3. **向极限过渡**
   将三角形不断地进行更细密的三角剖分。在每一次剖分中，根据[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)，必然存在集齐了3种颜色的小三角形。
...
除了不动点定理，[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)还直接应用于现实世界的问题中。
典型的例子是“公平分租问题”和“切蛋糕问题”。

当多人合租房屋时，由于房间的大小和条件不同，大家往往会为了谁以多少钱租哪个房间而产生争议。应用基于[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)的算法（如 Su 的算法），可以证明必然存在一种公平的分配方式，使得“每个人都对自己选择的房间和租金感到满意，且租金总和等于原总额”，并且还能近似地找出这种分配方式。

此外，约翰·纳什在经济学中证明的“纳什均衡的存在性”也依赖于布劳威尔或角谷的不动点定理，其根本上隐藏着类似[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)的组合数学结构。

# 9. 结语

[斯佩纳引理](https://kenji.blog/p/sperners-lemma/)从一个近乎游戏的设定——按照规则为三角形顶点着色——出发。然而，在“计算门的数量”这般简单的逻辑中，却隐藏着关于空间连续性与不变性的深奥真理。
