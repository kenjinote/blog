...
[スペルナーの補題](https://kenji.blog/p/sperners-lemma/)は、三角形の頂点をルール通りに色塗りするという、まるで遊びのような設定から出発します。しかし、その「ドアの数を数える」というシンプルな論理の中に、空間の連続性や[不変性](https://kenji.blog/p/functional-programming-concepts-pure-functions-monads/)という深遠な真理が隠されていました。
