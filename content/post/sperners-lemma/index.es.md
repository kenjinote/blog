...
La belleza de las matemáticas a menudo radica en cómo reglas extremadamente simples pueden llevar a resultados profundos y completamente inesperados. Uno de los ejemplos más icónicos de esto es el **Lema de Sperner** (Sperner's Lemma). Publicado en 1928 por el matemático alemán Emanuel Sperner, este lema, a primera vista, parece no ser más que un "rompecabezas de colorear triángulos" que incluso un estudiante de primaria podría entender.
...
Cuando terminas de colorear de acuerdo con las reglas de la coloración de Sperner, ¿qué fenómeno ocurre? El Lema de Sperner afirma el siguiente hecho asombroso.
...
El Lema de Sperner no se limita a triángulos 2D, sino que es válido para cualquier símplice $n$-dimensional.
...
El Lema de Sperner comienza con un escenario casi parecido a un juego, de colorear los vértices de un triángulo según unas reglas. Sin embargo, dentro de esa simple lógica de "contar el número de puertas", se ocultaban profundas verdades sobre la continuidad y la invariancia del espacio.
