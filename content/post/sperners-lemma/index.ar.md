...
في هذه المقالة، سنشرح [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) بالتفصيل مع الرسوم البيانية، ونغطي كل شيء بدءاً من معناها البديهي وإثباتها الرياضي الدقيق، إلى تطبيقها على نظريات النقطة الثابتة التي تسد الفجوة مع العالم المستمر.

# 2. التبسيطات والمركبات المبسطة: أسس الهندسة

لفهم [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/)، يجب علينا أولاً توضيح مفاهيم **المبسط** (Simplex) و **المركب المبسط** (Simplicial Complex / Triangulation).
...
بالنسبة لشبكة المثلثات المقسمة بهذه الطريقة، فإن تلوين كل رأس يمهد الطريق ل[توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/).
...
# 4. بيان [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/)

عند الانتهاء من التلوين وفقاً لقواعد تلوين سبيرنر، ما هي الظاهرة التي تحدث؟ تؤكد [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) الحقيقة المذهلة التالية.

> **[توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) (ثنائية الأبعاد)**
...
لا تقتصر [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) على المثلثات ثنائية الأبعاد بل تنطبق على أي $n$-مبسط.
...
لماذا تعتبر [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) مهمة جداً؟ ذلك لأن هذه النظرية المنفصلة تعمل كجسر لإثبات نظرية طوبولوجية مستمرة، وهي **نظرية النقطة الثابتة لـ براور**.
...
## 7.2. النهج من [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/)

المنطق لاستنتاج نظرية النقطة الثابتة من [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) أنيق للغاية.
...
3. **الانتقال إلى النهاية**
   نقوم بتثليث المثلث بشكل أدق وأدق. في كل تثليث، وفقاً ل[توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/)، هناك دائماً مثلث صغير حيث توجد الألوان الثلاثة.
...
إلى جانب نظرية النقطة الثابتة، تُطبق [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) مباشرة على مشاكل العالم الحقيقي.
الأمثلة النموذجية هي "مشكلة تقسيم الإيجار العادل" و "مشكلة تقطيع الكيك".

عندما يتشارك العديد من الأشخاص في منزل، يمكن أن تنشأ صراعات حول من يستأجر أي غرفة وبأي مبلغ، لأن حجم وظروف الغرف تختلف. باستخدام الخوارزميات التي تطبق [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) (مثل خوارزمية سو)، يمكن إثبات أنه يوجد دائماً تخصيص عادل حيث "يشعر الجميع بالرضا عن غرفتهم وإيجارهم الذي اختاروه، ومجموع الإيجارات يتطابق مع المبلغ الأصلي"، وعلاوة على ذلك، يمكن العثور على ذلك تقريباً.

أيضاً، يعتمد "وجود توازن ناش" الذي أثبته جون ناش في الاقتصاد على نظريات النقطة الثابتة لـ براور أو كاكوتاني، مما يخفي بشكل أساسي الهياكل التركيبية مثل [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/).

# 9. خاتمة

تبدأ [توطئة سبيرنر](https://kenji.blog/p/sperners-lemma/) بإعداد يشبه اللعبة تقريباً لتلوين رؤوس مثلث وفقاً للقواعد. ومع ذلك، ففي إطار هذا المنطق البسيط لـ "عد عدد الأبواب"، اختبأت حقائق عميقة حول استمرارية وثبات المساحة.
