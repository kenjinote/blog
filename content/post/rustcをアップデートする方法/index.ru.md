---
title: 'Как обновить компилятор Rust (rustc) до последней версии'
...
description: 'Объясняется простой способ обновления компилятора Rust (rustc) до последней версии. Выполнив всего одну строку с командой `rustup update` в терминале или командной строке, вы можете массово обновить компилятор и связанные компоненты.'
---
# Как обновить rustc
