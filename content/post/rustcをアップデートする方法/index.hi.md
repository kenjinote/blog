---
title: 'Rust कंपाइलर (rustc) को नवीनतम संस्करण में कैसे अपडेट करें'
...
description: 'हम Rust के कंपाइलर rustc को नवीनतम संस्करण में अपडेट करने का आसान तरीका समझाते हैं। टर्मिनल या कमांड प्रॉम्प्ट में केवल एक लाइन का `rustup update` कमांड चलाकर, आप संबंधित घटकों सहित सब कुछ एक साथ अपडेट कर सकते हैं।'
---
# rustc को अपडेट करने का तरीका

बस कमांड में निम्नलिखित एक पंक्ति चलाएं।
