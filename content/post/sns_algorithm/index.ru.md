...
2. **Следите за RFC (Request for Comments):** Многие зрелые проекты с открытым исходным кодом (React, Rust, Python и т. д.) используют процесс RFC при внедрении новых функций. В RFC логично и беспристрастно описаны вопросы «зачем нужна эта функция», «каковы архитектурные компромиссы» и «каковы альтернативы», без оглядки на алгоритмическую вовлеченность. Именно здесь кроется истинная техническая ценность.
