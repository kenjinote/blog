...
Los algoritmos de recomendación de las redes sociales aceleran artificialmente esta homofilia. Por ejemplo, supongamos que hay una comunidad de ingenieros que promueven la "arquitectura sin servidor (Serverless)" y una comunidad que apoya el "bare metal on-premise". El algoritmo aprenderá a reducir el peso de las aristas entre diferentes comunidades (Cross-cutting ties) y fortalecer las aristas dentro de la misma comunidad (porque las opiniones opuestas a menudo provocan abandono y corren el riesgo de reducir el nivel de participación. O por el contrario, a veces provocan participación a través de una ira extrema, pero en la comunidad técnica, prevalece la primera tendencia).
