...
**तकनीक के चयन पर प्रभाव:**
DLRM जैसे विशाल मॉडल अत्यंत सूक्ष्म संकेतों (उदाहरण के लिए, "वीडियो वाली पोस्ट" या "विशिष्ट बज़वर्ड वाली पोस्ट" पर ठहरने के समय में मामूली वृद्धि) को भी कैप्चर करते हैं और उन्हें पूर्वानुमान स्कोर में दर्शाते हैं। नतीजतन, तकनीकी जानकारी जिसमें "कट्टरपंथी शीर्षक (जैसे: 'React अब पुराना हो गया है', '[Microservices](https://kenji.blog/hi/p/microservices-architecture-bff-api-gateway/) का अंत')" या "दिखने में आकर्षक डेमो" शामिल हैं, एल्गोरिथम रूप से अधिक महत्व प्राप्त करने की संभावना है।
...
SNS सिफारिश एल्गोरिदम कृत्रिम रूप से इस होमोफिली को तेज करते हैं। उदाहरण के लिए, मान लीजिए कि "[सर्वरलेस आर्किटेक्चर](/hi/p/serverless-architecture-aws-lambda-cold-start/)" को बढ़ावा देने वाले इंजीनियरों का एक समुदाय है और "ऑन-प्रिमाइसेस बेयर मेटल" का समर्थन करने वाला दूसरा समुदाय है। एल्गोरिदम अलग-अलग समुदायों (Cross-cutting ties) के बीच किनारों के वजन को कम करने और एक ही समुदाय के भीतर किनारों को मजबूत करने के लिए सीखता है (क्योंकि विरोधी राय अक्सर लोगों को दूर ले जाती है और एंगेजमेंट कम होने का जोखिम पैदा करती है। या इसके विपरीत, चरम क्रोध से एंगेजमेंट बढ़ सकता है, लेकिन तकनीकी जगत में पहले वाली स्थिति अधिक आम है)।
...
इस लूप के बारे में डरावनी बात यह है कि **"बारंबारता भ्रम (Baader-Meinhof phenomenon)"** जानबूझकर एल्गोरिदम द्वारा ट्रिगर किया जाता है। यदि आप एक नई [स्टेट मैनेजमेंट](/hi/p/state-management-history-redux-context-recoil-zustand/) लाइब्रेरी का नाम एक बार देखते हैं, तो एल्गोरिदम इसे एक संकेत के रूप में लेता है और अगले दिन से आपकी फ़ीड को उस लाइब्रेरी के विषयों से भर देता है। मानव मस्तिष्क गलती से इसे "वैश्विक महामारी" मान लेता है।
...
SNS एल्गोरिदम "नवीनता" को पसंद करते हैं। हालाँकि, उत्पादन के माहौल का सामना करने में सक्षम एक मजबूत सिस्टम बनाने के लिए 10 से अधिक वर्षों के ट्रैक रिकॉर्ड वाली "उबाऊ" तकनीकों (जैसे PostgreSQL, [Redis](https://kenji.blog/hi/p/nosql-database-selection-kvs-document-graph-wide-column/), और मानक [REST API](https://kenji.blog/hi/p/graphql-vs-rest-api-[overfetching](https://kenji.blog/hi/p/graphql-vs-rest-api-overfetching-type-safety/)-type-safety/)) की आवश्यकता होती है, जहाँ Google खोज पर विफलता पुनर्प्राप्ति प्रक्रियाओं के लिए लाखों परिणाम मिलते हैं।
