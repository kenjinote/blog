...
تقوم هذه الخوارزمية بتقريب "الشخص أ المهتم بـ [Rust](https://kenji.blog/ar/p/webassembly-wasm-current-future/)" و "الشخص ب المهتم بـ [Rust](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/)" في المساحة الكامنة. إذا أعجب الشخص أ بمنشور حول إطار عمل الويب الناشئ، فهناك احتمال كبير أن يظهر المنشور الخاص بإطار العمل هذا في الخط الزمني للشخص ب. نتيجة لذلك، تحدث ظاهرة حيث تصبح تقنية معينة شائعة محليًا داخل مجموعة من المهندسين الذين يفضلون مجموعة تقنية معينة.

### 2.2 نماذج التوصية باستخدام التعلم العميق (DLRM)

في السنوات الأخيرة، أصبحت البنى القائمة على التعلم العميق الممثلة في Deep Learning Recommendation Model (DLRM) شائعة، خاصة حول Meta ([فيسبوك سابقًا](/ar/p/history-of-meta-facebook/)). تأخذ DLRM مجموعة متنوعة من الميزات كمدخلات، مثل سجل سلوك المستخدم السابق والبيانات الوصفية للعنصر، وتتنبأ بنسبة النقر إلى الظهور (CTR: Click-Through Rate) وما إلى ذلك.
...
2. **تتبع RFC (Request for Comments):** تتبنى العديد من المشاريع الناضجة مفتوحة المصدر (React, [Rust](https://kenji.blog/ar/p/webassembly-wasm-current-future/), Python, وما إلى ذلك) عملية RFC عند تقديم ميزات جديدة. في RFC، تتم كتابة "لماذا هذه الميزة ضرورية؟"، "ما هي المفاضلات في التصميم؟"، و "ما هي البدائل؟" بشكل منطقي وموضوعي دون القلق بشأن تفاعل الخوارزمية. هنا تكمن القيمة التقنية الحقيقية.

### 5.2 القراءة المتأنية للأوراق البحثية (Academic Papers) والأوراق البيضاء

فيما يتعلق باختيار التقنيات الأساسية مثل [الأنظمة الموزعة](/ar/p/cap-theorem-distributed-systems-tradeoff/) وقواعد البيانات وبنيات نماذج التعلم الآلي، يجب عليك قراءة الأوراق البحثية المنشورة في ACM أو IEEE أو arXiv، أو الأوراق البيضاء التفصيلية التي تنشرها الشركات (مثل ورقة Google Spanner أو ورقة Amazon Dynamo) مباشرة، بدلاً من ملخص من بضعة أسطر على الشبكات الاجتماعية.
...
تفضل خوارزميات الشبكات الاجتماعية "الحداثة". ومع ذلك، لبناء نظام قوي يمكنه تحمل العمليات الفعلية، فإن ما نحتاجه هو تقنيات "مملة" (PostgreSQL، [Redis](https://kenji.blog/ar/p/nosql-database-selection-kvs-document-graph-wide-column/)، واجهة برمجة تطبيقات REST قياسية، إلخ) لديها سجل حافل لأكثر من 10 سنوات وتظهر ملايين النتائج في بحث Google لإجراءات التعافي من الكوارث.
