...
Os algoritmos de recomendação de redes sociais aceleram artificialmente essa homofilia. Por exemplo, suponha que haja uma comunidade de engenheiros que promovem a "Arquitetura Serverless" e uma comunidade que apoia "Bare Metal On-Premise". O algoritmo aprenderá a reduzir o peso das arestas (Cross-cutting ties) entre diferentes comunidades e a fortalecer as arestas dentro da mesma comunidade (porque opiniões divergentes frequentemente causam aversão, correndo o risco de diminuir o engajamento. Ou inversamente, às vezes, podem causar engajamento através de raiva extrema, mas a primeira tendência é mais comum no mundo da tecnologia).
