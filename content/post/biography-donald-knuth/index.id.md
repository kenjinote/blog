---
title: "Bapak Ilmu Komputer: Jejak dan Filosofi Donald Knuth"
...
graph TD
    ...
    B --> E["Pembentukan Analisis Algoritma"]
    C --> F["Standardisasi Penerbitan Akademis"]
    D --> G["Dampak pada Rekayasa Perangkat Lunak"]
    
    E --> H["Dasar-dasar Ilmu Komputer Modern"]
    F --> H
    G --> H
```
