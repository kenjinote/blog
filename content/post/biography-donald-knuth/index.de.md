---
title: "Der Vater der Informatik: Der Weg und die Philosophie von Donald Knuth"
...
graph TD
    ...
    B --> E["Etablierung der Algorithmenanalyse"]
    C --> F["Standardisierung des wissenschaftlichen Publizierens"]
    D --> G["Einfluss auf die Softwareentwicklung"]
    
    E --> H["Grundlagen der modernen Informatik"]
    F --> H
    G --> H
```
