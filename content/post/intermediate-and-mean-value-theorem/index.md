...
平均値の定理（[ラグランジュ](https://kenji.blog/p/lagrange/)の平均値の定理）は、微積分学全体を支える大黒柱とも言える定理です。
...
## 5. [コーシー](https://kenji.blog/p/cauchy/)の平均値の定理 ([Cauchy](https://kenji.blog/p/cauchy/)'s Mean Value Theorem)

平均値の定理を2つの関数に拡張したものが、[コーシー](https://kenji.blog/p/cauchy/)の平均値の定理です。

> **定理（[コーシー](https://kenji.blog/p/cauchy/)の平均値の定理）**
...
本記事では、微積分学の基盤となる[中間値の定理と平均値の定理](https://kenji.blog/p/intermediate-and-mean-value-theorem/)について解説しました。
