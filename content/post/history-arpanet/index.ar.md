...
من ناحية أخرى، توصل دونالد ديفيز من المختبر الفيزيائي الوطني (NPL) في المملكة المتحدة بشكل مستقل إلى مفهوم مماثل، وأطلق على كتل البيانات المقسمة اسم "حزم" (Packets). بالإضافة إلى ذلك، أثبت ليونارد كلينروك من معهد ماساتشوستس للتكنولوجيا (MIT) كفاءة طريقة نقل البيانات هذه باستخدام [نظرية الطوابير](/ar/p/queuing-theory-basics/) الرياضية.
