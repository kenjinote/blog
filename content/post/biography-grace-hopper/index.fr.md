---
title: "[Grace Hopper : La vie et l'héritage de la \"Mère de COBOL\" qui a ouvert la voie à l'avenir de la programmation]"
date: "2026-09-24T19:44:38+09:00"
description: "Grace Hopper, contre-amirale de la marine américaine connue sous le nom de \"Mère de COBOL\". De l'invention du compilateur à la découverte du premier bogue informatique, nous expliquons en détail sa vie mouvementée et ses grandes réalisations qui ont jeté les bases de la société informatique moderne."
...
```mermaid
flowchart TD
    A["Code en langage de haut niveau compréhensible par l'homme"] -- "Processus de compilation" --> B["Compilateur (A-0 etc.)"]
    B -- "Traduction" --> C["Langage machine (code binaire de 0 et 1)"]
    C -- "Exécution" --> D["Matériel informatique"]
    A -- "Vérification des erreurs" --> A
```
...
```mermaid
flowchart TD
    A["Développement de FLOW-MATIC (basé sur l'anglais)"] -- "Héritage de la philosophie de conception" --> B["Formation du comité CODASYL"]
    B -- "Processus de normalisation" --> C["Naissance du langage COBOL"]
    C -- "Adoption généralisée" --> D["Systèmes de base (finance, administration, etc.)"]
    D -- "Maintenance et modernisation" --> E["Survit en tant que partie intégrante de l'infrastructure informatique moderne"]
```
