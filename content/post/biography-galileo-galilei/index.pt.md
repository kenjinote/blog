---
title: "O Pai da Ciência Moderna: A Vida e o Legado Filosófico de Galileu Galilei"
...
```mermaid
graph TD
    Galileo["Galileu Galilei"] -->|Observação Astronômica| Telescope["Aperfeiçoamento do Telescópio"]
    Telescope --> Moons["Descoberta das Luas de Júpiter"]
    Telescope --> Venus["Observação das Fases de Vênus"]
    Telescope --> Sunspots["Observação das Manchas Solares"]
    Galileo -->|Estudos Físicos| FallingBody["Lei da Queda dos Corpos"]
    Galileo -->|Estudos Físicos| Inertia["Lei da Inércia (Protótipo)"]
    Moons --> Heliocentrism["Comprovação do Heliocentrismo"]
    Venus --> Heliocentrism
    Heliocentrism --> Inquisition["Inquisição (1633)"]
    Inquisition --> Epur["E pur si muove (E no entanto ela se move)"]
    FallingBody --> Mechanics["Contribuição à Mecânica Clássica"]
    Inertia --> Mechanics
    Mechanics --> Newton["Legado para Isaac Newton"]
```
