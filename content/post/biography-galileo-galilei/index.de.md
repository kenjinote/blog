...
```mermaid
graph TD
    Galileo["Galileo Galilei"] -->|Astronomische Beobachtungen| Telescope["Verbesserung des Teleskops"]
    Telescope --> Moons["Entdeckung der Jupitermonde"]
    Telescope --> Venus["Beobachtung der Venusphasen"]
    Telescope --> Sunspots["Beobachtung der Sonnenflecken"]
    Galileo -->|Physikalische Forschungen| FallingBody["Fallgesetz"]
    Galileo -->|Physikalische Forschungen| Inertia["Trägheitsgesetz (Prototyp)"]
    Moons --> Heliocentrism["Bestätigung des heliozentrischen Weltbildes"]
    Venus --> Heliocentrism
    Heliocentrism --> Inquisition["Inquisitionsprozess (1633)"]
    Inquisition --> Epur["Und sie bewegt sich doch"]
    FallingBody --> Mechanics["Beitrag zur klassischen Mechanik"]
    Inertia --> Mechanics
    Mechanics --> Newton["Vermächtnis an Isaac Newton"]
```
