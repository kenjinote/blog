---
title: "Le père de la science moderne : La vie et l'héritage philosophique de Galilée"
date: "2026-09-24T16:08:36+09:00"
categories: ["biography"]
tags: ["galileo-galilei", "history"]
image: "eyecatch.jpg"
slug: "biography-galileo-galilei"
description: "Galilée (1564 - 1642) est un physicien, astronome et philosophe italien, souvent qualifié de \"père de la science moderne\"."
---
...
```mermaid
graph TD
    Galileo["Galilée"] -->|Observations astronomiques| Telescope["Amélioration du télescope"]
    Telescope --> Moons["Découverte des satellites de Jupiter"]
    Telescope --> Venus["Observation des phases de Vénus"]
    Telescope --> Sunspots["Observation des taches solaires"]
    Galileo -->|Recherches en physique| FallingBody["Loi de la chute des corps"]
    Galileo -->|Recherches en physique| Inertia["Principe d'inertie (prototype)"]
    Moons --> Heliocentrism["Preuve de l'héliocentrisme"]
    Venus --> Heliocentrism
    Heliocentrism --> Inquisition["Procès de l'Inquisition (1633)"]
    Inquisition --> Epur["Et pourtant elle tourne"]
    FallingBody --> Mechanics["Contribution à la mécanique classique"]
    Inertia --> Mechanics
    Mechanics --> Newton["Héritage transmis à Isaac Newton"]
```
