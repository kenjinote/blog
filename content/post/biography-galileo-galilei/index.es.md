...
description: "Galileo Galilei (1564 - 1642) es un físico, astrónomo y filósofo italiano conocido como el \"padre de la ciencia moderna\"."
---
...
```mermaid
graph TD
    Galileo["Galileo Galilei"] -->|Observaciones astronómicas| Telescope["Mejora del telescopio"]
    Telescope --> Moons["Descubrimiento de los satélites de Júpiter"]
    Telescope --> Venus["Observación de las fases de Venus"]
    Telescope --> Sunspots["Observación de manchas solares"]
    Galileo -->|Estudios de física| FallingBody["Ley de los cuerpos en caída"]
    Galileo -->|Estudios de física| Inertia["Ley de la inercia (prototipo)"]
    Moons --> Heliocentrism["Respaldo del heliocentrismo"]
    Venus --> Heliocentrism
    Heliocentrism --> Inquisition["Juicio de la Inquisición (1633)"]
    Inquisition --> Epur["Y sin embargo se mueve"]
    FallingBody --> Mechanics["Contribución a la mecánica clásica"]
    Inertia --> Mechanics
    Mechanics --> Newton["Legado a Isaac Newton"]
```
