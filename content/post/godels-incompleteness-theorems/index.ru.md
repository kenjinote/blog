...
1. **Непротиворечивость ([Consistency](https://kenji.blog/ru/p/cap-theorem-distributed-systems-tradeoff/))**: Отсутствие в системе противоречий (когда доказывается как некое утверждение $P$, так и его отрицание $\neg P$).
...
Тьюринг применил теорему Гёделя о неполноте к миру компьютеров и доказал, что «не существует универсального алгоритма, который бы заранее определял, завершатся ли вычисления любой компьютерной программы или будут продолжаться вечно». Это знаменитая **проблема остановки ([Halting Problem](https://kenji.blog/ru/p/turing-machine-computability/))**.
