---
title: "La vie et la philosophie de Confucius : La sagesse intemporelle de « Ren » et « Li »"
...
```mermaid
graph TD
    A["Confucius"] --> B["Pensée centrale"]
    A --> C["Principales réalisations"]
    
    B --> B1["Ren (Compassion / Amour humain)"]
    B --> B2["Li (Normes sociales / Ordre)"]
    B --> B3["Règne par la vertu (Gouvernance morale)"]
    
    C --> C1["Création d'une école privée (Éducation pour tous)"]
    C --> C2["Compilation de classiques (Poésie, Histoire, Rites, Musique)"]
    C --> C3["Entretiens (Paroles et actions notées par les disciples)"]
    
    B1 --> D["Application moderne"]
    B2 --> D
    B3 --> D
    C3 --> E["Établissement du Confucianisme"]
    E --> F["Influence immense sur la sphère culturelle de l'Asie de l'Est"]
    
    D --> G["Gestion par la raison d'être / Théorie du leadership"]
```
