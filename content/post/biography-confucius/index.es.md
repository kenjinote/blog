---
title: "La vida y filosofía de Confucio: La sabiduría atemporal de 'Ren' y 'Li'"
...
```mermaid
graph TD
    A["Confucio (Confucius)"] --> B["Pensamiento central"]
    A --> C["Logros principales"]
    
    B --> B1["Ren (Consideración / Humanidad)"]
    B --> B2["Li (Normas sociales / Orden)"]
    B --> B3["Gobernanza por virtud (Gobierno moral)"]
    
    C --> C1["Apertura de escuela privada (Educación sin distinción de estatus)"]
    C --> C2["Compilación de clásicos (Poesía, Documentos, Ritos, Música)"]
    C --> C3["Analectas (Registro de palabras y acciones por discípulos)"]
    
    B1 --> D["Aplicación a la era moderna"]
    B2 --> D
    B3 --> D
    C3 --> E["Establecimiento del Confucianismo"]
    E --> F["Enorme influencia en la esfera cultural de Asia Oriental"]
    
    D --> G["Gestión por propósito / Teoría del liderazgo"]
```
