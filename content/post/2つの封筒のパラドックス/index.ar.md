...
بافتراض أي توزيع مسبق $P(x)$، وعند حساب القيمة المتوقعة باستخدام [مبرهنة بايز](https://kenji.blog/ar/p/bayes-theorem/)، فقد ثبت رياضياً أنه **مهما كان التوزيع الاحتمالي واقعياً (بمجموع يساوي 1)، فإنه لا يوجد توزيع سحري يجعل "التبديل مربحاً أكثر" لجميع قيم $X$**.
...
هذا الخلل الناتج عن "القيمة المتوقعة اللانهائية" يشترك في جذور عميقة مع **[مفارقة سانت بطرسبرغ](/ar/p/st-petersburg-paradox/)** (وهي مسألة تتناول المبلغ الذي يمكن للشخص أن يدفعه في مقامرة ذات قيمة متوقعة لانهائية).
