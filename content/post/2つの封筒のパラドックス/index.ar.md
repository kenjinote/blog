...
بافتراض أي توزيع مسبق $P(x)$، وعند حساب القيمة المتوقعة باستخدام [مبرهنة بايز](https://kenji.blog/p/bayes-theorem/)، فقد ثبت رياضياً أنه **مهما كان التوزيع الاحتمالي واقعياً (بمجموع يساوي 1)، فإنه لا يوجد توزيع سحري يجعل "التبديل مربحاً أكثر" لجميع قيم $X$**.
