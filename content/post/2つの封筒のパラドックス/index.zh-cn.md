...
假设有任意的先验分布 $P(x)$，利用[贝叶斯定理](https://kenji.blog/zh-cn/p/bayes-theorem/)计算期望值，数学上已经证明了： **无论怎样现实的（总和为1的）概率分布，都不存在那种在所有金额 $X$ 下都“交换更划算”的魔法分布** 。
...
这种“无限大期望值”引发的bug，与 **[圣彼得堡悖论](/zh-cn/p/st-petersburg-paradox/)** （面对期望值为无限大的赌博，人们愿意支付多少钱的问题）有着极深的渊源。
