...
العالم الذي نعيش فيه مليء بعدم اليقين. من احتمال هطول المطر غدًا، إلى احتمال أن يكون دواء جديد فعالاً ضد مرض معين، أو احتمال أن يكون البريد الإلكتروني الذي تلقيناه رسالة غير مرغوب فيها، نحن نتخذ القرارات باستمرار بناءً على معلومات غير مكتملة. الإطار القوي للتعامل مع عدم اليقين هذا رياضيًا و **تحديث توقعاتنا في كل مرة يتم فيها الحصول على معلومات (أدلة) جديدة** هو مبرهنة بايز (Bayes' Theorem).

اكتشف هذه المبرهنة توماس بايز، وهو قس وعالم رياضيات إنجليزي من القرن الثامن عشر، وأصبحت نظرية أساسية يقوم عليها الذكاء الاصطناعي الحديث والتعلم الآلي. في هذه المقالة، سنتعمق في كل شيء بدءًا من الرياضيات الأساسية لمبرهنة بايز، إلى مفارقات الاحتمالات التي تتحدى الحدس، وكيف يتم تطبيقها في التكنولوجيا الحديثة.

## الصياغة الرياضية لمبرهنة بايز

مبرهنة بايز هي مبرهنة تُستخدم لحساب الاحتمال $P(A|B)$ لحدث $A$ بشرط وقوع الحدث $B$، بناءً على الاحتمال الشرطي العكسي $P(B|A)$ وعوامل أخرى. على الرغم من أن المعادلة بسيطة للغاية، إلا أن آثارها عميقة.
...
باختصار، يمكن وصف مبرهنة بايز بأنها الصياغة الرياضية لعملية **تحديث معتقدنا إلى "احتمال بعدي" عن طريق ضرب "الاحتمال القبلي" في "مدى ملاءمة الدليل الجديد (الأرجحية)"**.

## الانحراف عن الحدس: مفارقة "الإيجابية الخاطئة" (مثال الفحص الطبي)

غالبًا ما يرتكب الحدس البشري أخطاء في حسابات الاحتمالات. كمثال كلاسيكي لفهم قوة مبرهنة بايز، دعونا نفكر في اختبار الأمراض (الفحص الطبي).
...
يميل الكثير من الناس إلى التفكير: "بما أن دقة الاختبار $99\%$، فهناك فرصة بنسبة $90\%$ أو أكثر أن أكون مصابًا بالمرض". ومع ذلك، دعونا نحسبها باستخدام مبرهنة بايز.
...
وبهذه الطريقة، تقوم مبرهنة بايز بتصحيح الفخاخ التي يقع فيها حدسنا بسهولة رياضيًا، وتعمل كأداة قوية لاتخاذ أحكام هادئة.
...
## تطبيق مبرهنة بايز في الذكاء الاصطناعي والتعلم الآلي

تتجاوز مبرهنة بايز مجرد كونها لغزًا للاحتمالات؛ فهي تلعب دورًا حاسمًا في علوم البيانات الحديثة والذكاء الاصطناعي (AI). وذلك لأن عملية تعلم الأنماط من كميات كبيرة من البيانات وعمل تنبؤات حول البيانات غير المعروفة بحد ذاتها يمكن صياغتها على أنها "تعظيم للاحتمال البعدي".

### 1. مصنف بايز الساذج (Naive Bayes Classifier)

يعد "مصنف بايز الساذج"، والذي غالبًا ما يستخدم لتصفية رسائل البريد الإلكتروني العشوائية، أحد أكثر التطبيقات المباشرة لمبرهنة بايز. تعامل هذه الخوارزمية الكلمات الواردة في البريد الإلكتروني (مثل "مجاني"، "فائز"، "كلمة مرور") كأدلة (ميزات) وتحسب الاحتمال البعدي لكون البريد الإلكتروني عشوائيًا.
...
على سبيل المثال، في الذكاء الاصطناعي للتشخيص الطبي، يتم نمذجة التأثير الاحتمالي من "عمر المريض" و "عادات نمط الحياة" و "العوامل الوراثية" على "مرض معين"، ثم يتم ربط تأثير ذلك المرض على "الأعراض الظاهرة". في كل مرة يتم فيها إدخال عرض جديد (دليل)، يتم تحديث الاحتمالات عبر الشبكة بالكامل وفقًا لمبرهنة بايز، واستنتاج اسم المرض الأكثر احتمالاً. يتم استخدام هذا في مجموعة واسعة من المجالات، مثل تقييم الموقف في السيارات ذاتية القيادة والتنبؤ بالأسواق المالية.
...
من ناحية أخرى، في البايزية، يُعامل الاحتمال على أنه **"درجة معتقد المراقب (احتمال شخصي)"**. يمثل احتمال هطول المطر غدًا بنسبة $70\%$ "درجة ثقة" وكالة الأرصاد الجوية بناءً على بيانات الطقس المتاحة (الأدلة). إذا تمت ملاحظة بيانات جديدة (على سبيل المثال، انخفاض مفاجئ في الضغط الجوي)، فسيتم تحديث هذه الثقة وفقًا لمبرهنة بايز.
...
توفر مبرهنة بايز نوعًا من إطار التفكير الذي يتجاوز مجرد معادلة رياضية.

لدينا جميعًا "احتمالات قبلية (معتقدات أولية)" بناءً على التجارب السابقة والتحيزات. هذا ليس بالضرورة شيئًا سيئًا؛ إنه نقطة انطلاق لإدراك العالم بكفاءة. ومع ذلك، فإن المهم هو امتلاك **المرونة لتحديث معتقدات المرء بسلاسة (التحديث إلى الاحتمال البعدي)، تمامًا مثل مبرهنة بايز، بدلاً من غض الطرف عند مواجهة حقائق وأدلة جديدة**.

تمامًا كما يصبح الذكاء الاصطناعي أكثر ذكاءً من خلال استهلاك البيانات، يجب علينا نحن البشر أيضًا دمج معلومات جديدة كأدلة وتحديث أنفسنا باستمرار، للوصول إلى فهم أكثر دقة للعالم. ربما يمكن القول إن مبرهنة بايز هي تمثيل رياضي لـ "جوهر الذكاء" نفسه.
