...
Разработка CLI на [Rust](https://kenji.blog/ru/p/webassembly-wasm-current-future/) — это потрясающий опыт, который позволяет гарантировать качество программного обеспечения еще на этапе проектирования посредством диалога с компилятором. Возьмите созданный нами базовый код и попробуйте разработать свой собственный, оригинальный CLI-инструмент и поделиться им с миром! Happy Rust Coding!
