...
> **[Гипотеза Ходжа ([Hodge Conjecture](https://kenji.blog/p/hodge-conjecture/))](https://kenji.blog/p/hodge-conjecture/)**
...
Одним из самых простых и понятных примеров является одномерное комплексное многообразие, то есть **риманова поверхность** (Riemann Surface). Среди них тор (в форме пончика) с родом (количеством дыр) равным 1 известен в алгебраической геометрии как **эллиптическая кривая** (Elliptic Curve).
...
[Александр Гротендик](https://kenji.blog/p/grothendieck/) выдвинул серию грандиозных гипотез об алгебраических циклах на алгебраических многообразиях. Это **Стандартные гипотезы** (Standard Conjectures on Algebraic Cycles).
