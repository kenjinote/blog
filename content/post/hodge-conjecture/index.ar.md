...
- **حدسية هودج المعممة (Generalized Hodge Conjecture)**: محاولة لتوسيع حدسية هودج إلى إطار أكثر عمومية (على سبيل المثال، المتنوعات ذات النقاط الشاذة، المتنوعات المفتوحة، إلخ). تمت صياغتها من قبل ألكسندر غروتينديك (Alexander Grothendieck) وآخرين، ولكن تم العثور على أمثلة مضادة، مما جعل الصياغة المناسبة بحد ذاتها تحدياً صعباً.
...
وضع ألكسندر غروتينديك سلسلة من الحدسيات الكبرى حول الدورات الجبرية على المتنوعات الجبرية. هذه هي **الحدسيات القياسية** (Standard Conjectures on Algebraic Cycles).
