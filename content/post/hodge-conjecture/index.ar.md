...
> **[حدسية هودج ([Hodge Conjecture](https://kenji.blog/p/hodge-conjecture/))](https://kenji.blog/p/hodge-conjecture/)**
...
- **حدسية هودج المعممة (Generalized [Hodge Conjecture](https://kenji.blog/p/hodge-conjecture/))**: محاولة لتوسيع حدسية هودج إلى إطار أكثر عمومية (على سبيل المثال، المتنوعات ذات النقاط الشاذة، المتنوعات المفتوحة، إلخ). تمت صياغتها من قبل [ألكسندر غروتينديك](https://kenji.blog/p/grothendieck/) ([Alexander Grothendieck](https://kenji.blog/p/grothendieck/)) وآخرين، ولكن تم العثور على أمثلة مضادة، مما جعل الصياغة المناسبة بحد ذاتها تحدياً صعباً.
...
وضع [ألكسندر غروتينديك](https://kenji.blog/p/grothendieck/) سلسلة من الحدسيات الكبرى حول الدورات الجبرية على المتنوعات الجبرية. هذه هي **الحدسيات القياسية** (Standard Conjectures on Algebraic Cycles).
