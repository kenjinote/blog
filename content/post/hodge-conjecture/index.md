...
- **一般化されたホッジ予想 (Generalized Hodge Conjecture)**: ホッジ予想をより一般的な枠組み (例えば、特異点を持つ多様体や、開多様体など) へと拡張しようとする試みです。[アレクサンドル・グロタンディーク](https://kenji.blog/p/grothendieck/) (Alexander Grothendieck) などによって定式化されましたが、反例が見つかるなど、適切な定式化自体が困難な課題となっています。
