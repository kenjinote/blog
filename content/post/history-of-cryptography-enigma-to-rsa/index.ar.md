...
لمواجهة هذا الأمر، تتقدم الأبحاث حول 'التشفير المقاوم للكم (PQC)' بوتيرة سريعة في جميع أنحاء العالم. ستقوم تقنيات التشفير من الجيل القادم، استنادًا إلى مشاكل رياضية صعبة جديدة مثل التشفير القائم على الشبكة وتشفير متعدد الحدود متعدد المتغيرات، بتحمل مسؤولية أمان المستقبل. ستستمر معركة 'الرمح والدرع' حول التشفير في واجهة الرياضيات وعلوم الكمبيوتر.
