...
В C++26 **сопоставление с образцом (Pattern Matching)** было встроено как языковая возможность (согласно P2688). Это делает сопоставление интуитивно понятным, подобно функциональным языкам (таким как [Rust](https://kenji.blog/ru/p/webassembly-wasm-current-future/) или Haskell).
...
## 6.2 Hazard [Pointer](https://kenji.blog/ru/p/c-language-pointers-memory-management-stack-heap/)s и RCU (Read-Copy Update)
...
*   Благодаря **Senders/Receivers** и **RCU / Hazard [Pointer](https://kenji.blog/ru/p/c-language-pointers-memory-management-stack-heap/)s** стандартизирована параллельная обработка, выжимающая максимальную производительность.
