---
title: "Coco Chanel: The Life and Philosophy of the Revolutionary Who Liberated Women"
...
```mermaid
graph TD
    A["Birth of Gabrielle Chanel (1883)"] --> B["Strict life at the orphanage (Origin of aesthetics)"]
    B --> C["Seamstress and cabaret singer 'Coco' era"]
    C --> D["Opening of hat shop 'Chanel Modes' (1910)"]
    D --> E["Introduction of jersey material and liberation from corsets"]
    E --> F["Release of 'Chanel No. 5' (1921)"]
    E --> G["Release of 'Little Black Dress' (1926)"]
    F --> H["Retirement due to WWII and exile in Switzerland"]
    G --> H
    H --> I["Miraculous return to the fashion world (1954)"]
    I --> J["Birth of 'Chanel Suit': Functionality and elegance"]
    J --> K["Passing (1971) and eternal legacy"]
```
