---
title: "Coco Chanel: Kehidupan dan Filosofi Sang Revolusioner yang Membebaskan Wanita"
...
```mermaid
graph TD
    A["Kelahiran Gabrielle Chanel (1883)"] --> B["Kehidupan yang ketat di panti asuhan (asal estetika)"]
    B --> C["Era 'Coco', penjahit dan penyanyi kabaret"]
    C --> D["Pembukaan toko topi 'Chanel Modes' (1910)"]
    D --> E["Pengenalan bahan jersey dan pembebasan dari korset"]
    E --> F["Perilisan 'Chanel No. 5' (1921)"]
    E --> G["Perilisan 'Little Black Dress' (1926)"]
    F --> H["Pensiun karena Perang Dunia II dan pengasingan di Swiss"]
    G --> H
    H --> I["Kembalinya secara ajaib ke dunia mode (1954)"]
    I --> J["Kelahiran 'Setelan Chanel' dengan fungsionalitas dan keanggunan"]
    J --> K["Wafat (1971) dan warisan abadi"]
```
