---
title: "Coco Chanel : La vie et la philosophie de la révolutionnaire qui a libéré les femmes"
...
description: "Dans le monde de la mode du 20e siècle, personne d'autre que Gabrielle \"Coco\" Chanel n'a bouleversé aussi fondamentalement le mode de vie des femmes."
---
...
```mermaid
graph TD
    A["Naissance de Gabrielle Chanel (1883)"] --> B["Vie stricte à l'orphelinat (Origine de son esthétique)"]
    B --> C["Époque de couturière et chanteuse de cabaret 'Coco'"]
    C --> D["Ouverture de la boutique de chapeaux 'Chanel Modes' (1910)"]
    D --> E["Introduction du jersey et libération du corset"]
    E --> F["Lancement de 'Chanel N°5' (1921)"]
    E --> G["Lancement de la 'Petite robe noire' (1926)"]
    F --> H["Retraite à cause de la Seconde Guerre mondiale et exil en Suisse"]
    G --> H
    H --> I["Retour miraculeux dans le monde de la mode (1954)"]
    I --> J["Naissance du 'tailleur Chanel', fonctionnalité et élégance"]
    J --> K["Décès (1971) et héritage éternel"]
```
