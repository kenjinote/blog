---
title: "Coco Chanel: La Vida y Filosofía de la Revolucionaria que Liberó a las Mujeres"
...
```mermaid
graph TD
    A["Nacimiento de Gabrielle Chanel (1883)"] --> B["Vida estricta en el orfanato (Origen de su estética)"]
    B --> C["Época de costurera y cantante de cabaret 'Coco'"]
    C --> D["Apertura de la tienda de sombreros 'Chanel Modes' (1910)"]
    D --> E["Introducción del tejido jersey y liberación de los corsés"]
    E --> F["Lanzamiento de 'Chanel No. 5' (1921)"]
    E --> G["Lanzamiento del 'Pequeño Vestido Negro' (1926)"]
    F --> H["Retiro por la Segunda Guerra Mundial y exilio en Suiza"]
    G --> H
    H --> I["Regreso milagroso al mundo de la moda (1954)"]
    I --> J["Nacimiento del 'Traje Chanel': Funcionalidad y elegancia"]
    J --> K["Fallecimiento (1971) y legado eterno"]
```
