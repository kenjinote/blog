---
title: "Coco Chanel: A Vida e Filosofia da Revolucionária que Libertou as Mulheres"
...
description: "No mundo da moda do século XX, talvez não haja outra figura que tenha revolucionado o próprio estilo de vida das mulheres de forma tão profunda quanto Gabr"
---
...
```mermaid
graph TD
    A["Nascimento de Gabrielle Chanel (1883)"] --> B["Vida estrita no orfanato (origem de sua estética)"]
    B --> C["Era 'Coco', costureira e cantora de cabaré"]
    C --> D["Abertura da chapelaria 'Chanel Modes' (1910)"]
    D --> E["Introdução do tecido jersey e libertação do espartilho"]
    E --> F["Lançamento de 'Chanel No. 5' (1921)"]
    E --> G["Lançamento de 'Vestidinho Preto' (1926)"]
    F --> H["Aposentadoria devido à Segunda Guerra Mundial e exílio na Suíça"]
    G --> H
    H --> I["Retorno milagroso ao mundo da moda (1954)"]
    I --> J["Nascimento do 'Terno Chanel' com funcionalidade e elegância"]
    J --> K["Falecimento (1971) e legado eterno"]
```
