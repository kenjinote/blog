---
title: "El creador de Python: La vida y filosofía de Guido van Rossum"
...
```mermaid
graph TD
    A["Nacido en los Países Bajos (1956)"] --> B["CWI: Lenguaje ABC"]
    B --> C["Proyecto de pasatiempo navideño (1989)"]
    C --> D["Lanzamiento de Python 0.9.0 (1991)"]
    
    D --> E["Liderazgo como BDFL"]
    E --> F["Google (2005-2012)"]
    E --> G["Dropbox (2013-2019)"]
    
    F --> H["Lanzamiento de Python 3.0 (2008)"]
    G --> I["Renuncia como BDFL (2018)"]
    
    I --> J["Microsoft (2020-)"]
    
    H --> K["Auge de la IA y la Ciencia de Datos"]
    J --> K
```
