---
title: "Le créateur de Python : La vie et la philosophie de Guido van Rossum"
...
description: "\"Python\" est l'un des langages de programmation les plus populaires au monde. Son créateur est le programmeur néerlandais Guido van Rossum."
---
...
```mermaid
graph TD
    A["Né aux Pays-Bas (1956)"] --> B["CWI : Langage ABC"]
    B --> C["Projet de Noël (1989)"]
    C --> D["Sortie de Python 0.9.0 (1991)"]
    
    D --> E["Leadership BDFL"]
    E --> F["Google (2005-2012)"]
    E --> G["Dropbox (2013-2019)"]
    
    F --> H["Sortie de Python 3.0 (2008)"]
    G --> I["Démission du poste de BDFL (2018)"]
    
    I --> J["Microsoft (2020-)"]
    
    H --> K["Boom de l'IA et de la science des données"]
    J --> K
```
