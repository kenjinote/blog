---
title: "O Criador do Python: A Vida e Filosofia de Guido van Rossum"
...
```mermaid
graph TD
    A["Nascido na Holanda (1956)"] --> B["CWI: Linguagem ABC"]
    B --> C["Projeto de Hobby de Natal (1989)"]
    C --> D["Lançamento do Python 0.9.0 (1991)"]
    
    D --> E["Liderança BDFL"]
    E --> F["Google (2005-2012)"]
    E --> G["Dropbox (2013-2019)"]
    
    F --> H["Lançamento do Python 3.0 (2008)"]
    G --> I["Renúncia do cargo de BDFL (2018)"]
    
    I --> J["Microsoft (2020-)"]
    
    H --> K["Boom de IA e Ciência de Dados"]
    J --> K
```
