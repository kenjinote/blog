---
title: "Der Schöpfer von Python: Leben und Philosophie von Guido van Rossum"
...
```mermaid
graph TD
    A["Geboren in den Niederlanden (1956)"] --> B["CWI: ABC-Sprache"]
    B --> C["Weihnachts-Hobbyprojekt (1989)"]
    C --> D["Veröffentlichung von Python 0.9.0 (1991)"]
    
    D --> E["BDFL-Führung"]
    E --> F["Google (2005-2012)"]
    E --> G["Dropbox (2013-2019)"]
    
    F --> H["Veröffentlichung von Python 3.0 (2008)"]
    G --> I["Rücktritt als BDFL (2018)"]
    
    I --> J["Microsoft (2020-)"]
    
    H --> K["KI & Data Science Boom"]
    J --> K
```
