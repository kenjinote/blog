...
В истории математики одной из самых драматичных и глубоких теорий является **теория Галуа** ([Galois Theory](https://kenji.blog/ru/p/galois-theory/)).
Эта теория была создана в начале 19 века молодым французским математиком Эваристом Галуа ([Évariste Galois](https://kenji.blog/ru/p/galois/)).
...
Галуа обнаружил, что множество таких перестановок, сохраняющих симметрию, обладает математической структурой, называемой **группой**. Эта группа называется **группой Галуа** ([Galois](https://kenji.blog/ru/p/galois/) Group) данного уравнения.
