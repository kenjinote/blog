...
在數學的歷史中，最富有戲劇性且最深奧的理論之一就是 **伽羅瓦理論** （[Galois Theory](https://kenji.blog/zh-tw/p/galois-theory/)）。
這個理論是由 19 世紀初法國年輕數學家[埃瓦里斯特·伽羅瓦](https://kenji.blog/zh-tw/p/galois/)（[Évariste Galois](https://kenji.blog/zh-tw/p/galois/)）所建構的。
伽羅瓦理論使用了一種名為 **群** （Group）的全新概念，完美解決了「為何五次以上方程式不存在一般公式解？」這個古老的難題。

在本篇文章中，我們將盡可能[深入淺出](/zh-tw/p/quantum-annealing-vs-gate-model-explained/)地解說伽羅瓦理論的基本概念、其歷史背景，以及對現代數學的影響。讓我們一起推開代數學的大門，接觸對稱性的美妙吧。
...
伽羅瓦發現，這些保持對稱性的置換集合，具有一種名為 **群** 的數學結構。我們將這個群稱為該方程式的 **伽羅瓦群** （[Galois](https://kenji.blog/zh-tw/p/galois/) Group）。
...
# 4. [埃瓦里斯特·伽羅瓦](https://kenji.blog/zh-tw/p/galois/)的一生
...
他所遺留下來的艱澀筆記，在歷經十年以上後，由[約瑟夫·劉維爾](/zh-tw/p/liouville/)仔細地解讀並整理，終於在 1846 年發表於學術期刊。其驚人的內容為世人所知並震驚了數學界，已是他死後很久以後的事了。
