...
description: "Aujourd'hui, les ordinateurs sont présents sur nos bureaux et dans nos poches comme une évidence."
---
...
```mermaid
flowchart TD
    A["Enfance et Découverte de la Programmation (1968)"] --> B["Fondation de Microsoft (1975)"]
    B --> C["Établissement de la Valeur du Logiciel"]
    B --> D["Partenariat MS-DOS avec IBM (1980)"]
    D --> E["Propagation Explosive de Windows 95 (1995)"]
    E --> F["Réalisation de la Révolution du PC"]
    C --> F
    F --> G["Fondation Bill et Melinda Gates (2000)"]
    G --> H["Lutte contre les Problèmes de Santé Publique et d'Environnement (Présent)"]
```
