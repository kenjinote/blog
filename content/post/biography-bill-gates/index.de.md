---
title: "Moderner Prometheus: Die Laufbahn von Bill Gates und die durch Technologie veränderte Welt"
...
```mermaid
flowchart TD
    A["Kindheit und Begegnung mit der Programmierung (1968)"] --> B["Gründung von Microsoft (1975)"]
    B --> C["Etablierung des Wertes von Software"]
    B --> D["MS-DOS Partnerschaft mit IBM (1980)"]
    D --> E["Explosive Verbreitung von Windows 95 (1995)"]
    E --> F["Erreichen der PC-Revolution"]
    C --> F
    F --> G["Bill & Melinda Gates Foundation (2000)"]
    G --> H["Bewältigung von Problemen der öffentlichen Gesundheit und Umwelt (Gegenwart)"]
```
