...
## [Zipf's Law](https://kenji.blog/en/p/zipfs-law/) and Market Distribution

The relationship between the rank of a market and its size often follows [Zipf's Law](https://kenji.blog/en/p/zipfs-law/) or the Pareto principle. If we let the rank of the market be $k$ and its market size (revenue potential) be $P(k)$, it can be expressed by the following power-law model:
