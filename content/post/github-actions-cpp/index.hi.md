...
3. **बिल्ड का समय**: बड़े [C++ प्रोजेक्ट्स](/hi/p/tdd-cpp-googletest-introduction/) में बिल्ड होने में दसियों मिनट से लेकर घंटों तक का समय लगना आम बात है। CI वातावरण में सीमित कंप्यूटिंग संसाधनों के साथ कुशलतापूर्वक बिल्ड करने के लिए कैशिंग रणनीतियों और समानांतरकरण (parallelization) की आवश्यकता होती है।
...
इन चुनौतियों को हल करने के लिए, [GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) सबसे अच्छा समाधान है, जो मांग (on-demand) पर विभिन्न OS वर्चुअल मशीनों को प्रोविजन कर सकता है, और जटिल वर्कफ़्लो को कोड के रूप में परिभाषित (Configuration as Code) कर सकता है।

## 2. [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) पाइपलाइन आर्किटेक्चर का अवलोकन
...
## 4. [GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) की मूल बातें और मैट्रिक्स रणनीति

GitHub Actions को `.github/workflows/` निर्देशिका में YAML फ़ाइलों द्वारा कॉन्फ़िगर किया जाता है।
[C++ प्रोजेक्ट्स](/hi/p/tdd-cpp-googletest-introduction/) में सबसे शक्तिशाली विशेषता "मैट्रिक्स रणनीति (Matrix Strategy)" है। यह आपको OS और कंपाइलर संयोजनों को गतिशील रूप से उत्पन्न करने और उन्हें समानांतर में निष्पादित करने की अनुमति देता है।
...
क्लाउड वातावरण में [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) समय के खिलाफ एक दौड़ है, और बिल्ड का समय सीधे डेवलपर्स के प्रतीक्षा समय और रनिंग कॉस्ट से जुड़ा है।
...
[GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) मानक धावक (standard runner) (Linux) 2 कोर (थ्रेड्स) प्रदान करता है। इसलिए जब $N = 2$:
...
इसके अलावा, हम लागत गणना पर भी विचार करते हैं। [GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) के उपयोग की कुल लागत $C_{total}$, जॉब निष्पादन समय $T_i$ और रनर की इकाई लागत (unit price) $R_i$ के गुणनफल का योग है।
...
[GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) में कवरेज मापने के लिए एक स्वतंत्र जॉब परिभाषित करें।
...
आइए [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) के "CD" भाग का निर्माण करें। जब कोई डेवलपर गिट में संस्करण टैग (उदाहरण: `v1.2.0`) जोड़ता है और उसे पुश करता है, तो यह स्वचालित रूप से प्रत्येक OS के लिए निष्पादन योग्य (executable) बाइनरी संकलित करेगा, उन्हें ZIP या Tarball में पैक करेगा, और उन्हें GitHub Releases पर अपलोड करेगा।
...
## 9. पूर्ण [Workflow](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) YAML फ़ाइल
...
## 10. अधिक उन्नत [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) की ओर (स्थिर विश्लेषण और स्वरूपण)
...
3. **vcpkg / Conan कैश का उपयोग**: यदि आप कई थर्ड-पार्टी लाइब्रेरी का उपयोग करते हैं, तो निर्भरताएँ बनाने (build dependencies) में लंबा समय लगता है। [GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) के `actions/cache` का उपयोग करके, vcpkg की इंस्टॉल की गई निर्देशिका या Conan के कैश को बनाए रखकर बिल्ड समय को काफी कम किया जा सकता है।

## निष्कर्ष

[C++ प्रोजेक्ट्स](/hi/p/tdd-cpp-googletest-introduction/) में [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) पाइपलाइन बनाना प्लेटफ़ॉर्म निर्भरताओं और बिल्ड टूल्स की जटिलता के कारण पहली नज़र में एक बड़ी बाधा लग सकता है। हालाँकि, [GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/), आधुनिक CMake, और CTest/CPack इकोसिस्टम को सही ढंग से संयोजित करके, आप एक अत्यधिक शक्तिशाली और स्वचालित विकास प्रवाह (development flow) प्राप्त कर सकते हैं।
