...
$$
\text{Exemplo do polinómio de Diofanto (notação moderna):} \\
3x^3 - 2x^2 + 5x - 1 = 0
$$
...
> Aqui jaz Diofanto. Os números dizem a duração da sua vida.
...
Portanto, podemos ver que Diofanto morreu aos **84** anos. Considerando a expectativa de vida média da época, ele viveu uma vida muito longa. A linha do tempo da sua vida é a seguinte:
