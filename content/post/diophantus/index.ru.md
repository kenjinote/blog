...
$$
\text{Пример полинома Диофанта (современная запись):} \\
3x^3 - 2x^2 + 5x - 1 = 0
$$
...
Таким образом, мы видим, что Диофант умер в возрасте **84** лет. Учитывая среднюю продолжительность жизни того времени, он прожил очень долгую жизнь. Хронология его жизни выглядит следующим образом:
