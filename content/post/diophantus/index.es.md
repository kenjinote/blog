...
$$
\text{Ejemplo del polinomio de Diofanto (notación moderna):} \\
3x^3 - 2x^2 + 5x - 1 = 0
$$
...
> Aquí yace Diofanto. Los números cuentan la duración de su vida.
...
Por lo tanto, podemos ver que Diofanto murió a la edad de **84** años. Teniendo en cuenta la esperanza de vida promedio de la época, vivió una vida muy larga. La línea de tiempo de su vida es la siguiente:
