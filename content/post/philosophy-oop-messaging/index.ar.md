...
في تطوير البرمجيات الحديثة، لا يمر يوم دون أن نسمع مصطلح "البرمجة كائنية التوجه ([OOP](/ar/p/object-oriented-programming-oop-solid-principles/): Object-Oriented Programming)". تعتمد معظم لغات البرمجة السائدة مثل Java و C# و Python و Ruby و C++ على نموذج البرمجة كائنية التوجه، مما يجعلها معرفة أساسية للمطورين.

ولكن، هل تعلم أن "[العناصر الثلاثة الرئيسية للبرمجة كائنية التوجه](/ar/p/object-oriented-programming-oop-solid-principles/)" التي يتعلمها معظم المطورين في البداية — وهي "التغليف Encapsulation" و"الوراثة Inheritance" و"تعدد الأشكال Polymorphism" — تنحرف في الواقع بشكل كبير عن الجوهر الذي قصده آلان كاي (Alan Kay)، والذي يمكن اعتباره الأب الروحي للبرمجة كائنية التوجه؟
...
في هذا المقال، سنعود إلى التاريخ المبكر لظهور مصطلح البرمجة كائنية التوجه، وإلى الرؤية التي أراد آلان كاي حقًا تحقيقها. الكلمة الأساسية هنا هي **"المراسلة (Messaging)"**. من خلال فهم مفهوم المراسلة بشكل صحيح، ستتوسع آفاقك في تصميم الأنظمة بشكل كبير، وستكتسب رؤى عميقة تنطبق على تصميم [الأنظمة الموزعة](/ar/p/cap-theorem-distributed-systems-tradeoff/) الحديثة مثل [بنية الخدمات المصغرة](/ar/p/microservices-architecture-bff-api-gateway/) ونموذج الفاعل (Actor Model).
...
3. **الشفافية عبر الشبكة**
   يمكن لنموذج المراسلة التعامل مع الكائنات الموجودة في نفس مساحة الذاكرة (العملية)، وكذلك الكائنات الموجودة على خوادم منفصلة عبر الشبكة، بنفس الطريقة تمامًا. يفترض استدعاء الدوال وجود الكائنات في نفس مساحة الذاكرة، بينما تتمتع المراسلة بخصائص تجعلها تتوسع بشكل طبيعي في [الأنظمة الموزعة](/ar/p/cap-theorem-distributed-systems-tradeoff/).
...
علاوة على ذلك، يمكن اعتبار **"[بنية الخدمات المصغرة](/ar/p/microservices-architecture-bff-api-gateway/) (Microservices Architecture)"** الحديثة في جوهرها نسخة ضخمة من البرمجة كائنية التوجه الموجهة نحو المراسلة. إذا اعتبرنا كل خدمة مصغرة كـ "كائن" ضخم واحد، فإنها تخفي تمامًا قاعدة البيانات الخاصة بها (الحالة الداخلية)، وتبني النظام بأكمله من خلال تبادل "الرسائل" عبر REST [API](/ar/p/chatgpt-gemini-claude-api-comparison/) أو gRPC أو Kafka وما إلى ذلك.
...
4. **فهم البنية باستخدام استعارة مشتركة، من داخل العملية الواحدة إلى [الأنظمة الموزعة](/ar/p/cap-theorem-distributed-systems-tradeoff/)**.
