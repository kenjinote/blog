...
By separating the build environment from the execution environment, you can drastically reduce the final image size. This is especially effective in compiled languages such as Go, Rust, and Java.
