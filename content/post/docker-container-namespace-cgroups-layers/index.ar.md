...
من خلال فصل بيئة البناء عن بيئة التشغيل، يمكن تقليل الحجم النهائي للصورة بشكل كبير. هذا فعال بشكل خاص مع لغات الترجمة (Compiled languages) مثل Go و Rust و Java.
