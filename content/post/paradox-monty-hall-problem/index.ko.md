...
하지만 [베이즈 정리](/ko/p/bayes-theorem/)로 계산하면, 실제로 병에 걸렸을 확률은 **불과 약 1% 미만(약 0.98%)**에 지나지 않습니다. 압도적 다수인 '건강한 사람(9,999명)' 중 1%(약 100명)가 '위양성'이 되기 때문에, 양성 반응이 나온 사람들의 집단 안에서는 진짜 환자(약 1명)가 극소수파가 되기 때문입니다.
