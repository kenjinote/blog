...
Таким образом, [теорема Байеса](/ru/p/bayes-theorem/) математически безупречно доказывает, что новая информация (то, что Монти открыл дверь B) обновляет вероятности, и вероятность для двери C возрастает до 2/3.
