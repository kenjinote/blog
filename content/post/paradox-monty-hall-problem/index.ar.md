...
يمكن حل مفارقة مونتي هول بدقة رياضية أكبر باستخدام "[مبرهنة بايز](/ar/p/bayes-theorem/)" (Bayes' theorem) لحساب الاحتمال الشرطي. الاستدلال البايزي هو أداة قوية توضح كيف ينبغي تحديث الاحتمال المسبق (prior probability) عندما تتوفر معلومات (أدلة) جديدة (posterior probability).
...
صيغة [مبرهنة بايز](/ar/p/bayes-theorem/) هي كالتالي:
...
بهذه الطريقة، باستخدام [مبرهنة بايز](/ar/p/bayes-theorem/)، يتم إثبات رياضياً وبشكل مثالي أن الاحتمال يتم تحديثه بالمعلومات الجديدة (أن مونتي فتح الباب ب)، ويقفز احتمال الباب ج إلى 2/3.
