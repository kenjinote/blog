...
しかし、[ベイズの定理](/p/bayes-theorem/)で計算すると、実際に罹患している確率は**わずか約1%弱（約0.98%）**に過ぎません。圧倒的多数の「健康な人（9,999人）」のうちの1%（約100人）が「偽陽性」となるため、陽性反応が出た人の集団の中では、本物の患者（ほぼ1人）はごく少数派になるからです。
