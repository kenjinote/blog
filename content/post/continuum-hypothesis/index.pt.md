...
Considerando o conjunto dos números naturais $\mathbb{N}$ e o conjunto dos números reais $\mathbb{R}$, o argumento da [diagonalização](/pt/p/diagonalization-and-jordan-normal-form/) de Cantor mostrou que o conjunto dos números reais é "verdadeiramente maior" que o conjunto dos números naturais. A cardinalidade dos números naturais é denotada como $\aleph_0$ (Aleph-zero) e a cardinalidade dos números reais como $\mathfrak{c}$ (cardinalidade do contínuo) ou $2^{\aleph_0}$. De acordo com o teorema de Cantor, $\aleph_0 < 2^{\aleph_0}$.
