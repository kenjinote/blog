...
Это было началом **Континуум-гипотезы** ([Continuum Hypothesis](https://kenji.blog/p/continuum-hypothesis/), CH), которая позже потрясла основы математики.
...
В 1900 году на Втором Международном конгрессе математиков в Париже [Давид Гильберт](https://kenji.blog/p/hilbert/) ([David Hilbert](https://kenji.blog/p/hilbert/)) предложил «23 проблемы Гильберта», которые математика 20-го века должна была решить. Этим памятным **первым вопросом** было именно «доказательство континуум-гипотезы».
...
## 5. [Курт Гёдель](https://kenji.blog/p/godel/) и «конструктивные множества»

В 1940 году [Курт Гёдель](https://kenji.blog/p/godel/) ([Kurt Gödel](https://kenji.blog/p/godel/)) опубликовал удивительный результат. Он доказал, что если предположить, что система аксиом ZFC непротиворечива, то **«добавление CH к системе аксиом ZFC не вызовет противоречия»**.
...
Исследование иерархии бесконечностей, о которой мечтал [Георг Кантор](https://kenji.blog/p/cantor/), достигло драматического конца: «невозможно ни доказать, ни опровергнуть» благодаря двум гениям — Гёделю и Коэну. Однако это ни в коем случае не означает поражения математики. Напротив, это привело к созданию мощного инструмента — метода форсинга, и развитию области теории множеств в нечто более богатое и сложное, чем когда-либо прежде.
