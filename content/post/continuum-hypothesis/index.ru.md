...
Рассматривая множество натуральных чисел $\mathbb{N}$ и множество вещественных чисел $\mathbb{R}$, [диагональный аргумент Кантора](/ru/p/cantors-diagonal-argument/) показал, что множество вещественных чисел «строго больше» множества натуральных чисел. Мощность натуральных чисел обозначается как $\aleph_0$ (алеф-нуль), а мощность вещественных чисел как $\mathfrak{c}$ (мощность континуума) или $2^{\aleph_0}$. Согласно теореме Кантора, $\aleph_0 < 2^{\aleph_0}$.
