...
Este fue el comienzo de la **Hipótesis del continuo** (Continuum Hypothesis, CH), que más tarde sacudiría los fundamentos de las matemáticas.
...
## 3. La agonía de Cantor y la propuesta de David Hilbert
...
En el Segundo Congreso Internacional de Matemáticos celebrado en París en el año 1900, David Hilbert propuso los "23 problemas de Hilbert" que las matemáticas del siglo XX debían resolver. El memorable **primer problema** fue precisamente esta "demostración de la Hipótesis del continuo".
...
## 5. Kurt Gödel y el "universo constructible"

En 1940, Kurt Gödel publicó un resultado sorprendente. Demostró que, suponiendo que el sistema de axiomas ZFC sea consistente, **"añadir la CH al sistema de axiomas ZFC no genera contradicciones"**.
