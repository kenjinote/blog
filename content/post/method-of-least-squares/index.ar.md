...
الطريقة الأساسية التي لا تزال تلعب دورًا في غاية الأهمية كأساس لتعلم الآلة الحديث هي **[طريقة المربعات الصغرى](https://kenji.blog/p/method-of-least-squares/)** ([Method of Least Squares](https://kenji.blog/p/method-of-least-squares/)).
...
## 2. الفكرة البديهية ل[طريقة المربعات الصغرى](https://kenji.blog/p/method-of-least-squares/)
...
[طريقة المربعات الصغرى](https://kenji.blog/p/method-of-least-squares/) هي تقنية للعثور على المعلمات $c$ و $d$ التي تقلل من **مجموع مربعات** الأخطاء. يتم تعريف مجموع الأخطاء المربعة $E$ على النحو التالي:
...
يظهر الجمال الحقيقي ل[طريقة المربعات الصغرى](https://kenji.blog/p/method-of-least-squares/) عندما نعيد كتابة هذا باستخدام لغة المصفوفات والمتجهات، أي **الجبر الخطي**.
...
ما نبحث عنه ليس حلاً مثاليًا، بل متجه داخل $C(A)$ أقرب ما يمكن إلى $\mathbf{b}$. دعنا نسمي هذا $A\hat{\mathbf{x}}$. في هذا الوقت، يتم تقليل المسافة (المربعة) بين المتجه $\mathbf{b}$ و $A\hat{\mathbf{x}}$. هذه هي بالضبط [طريقة المربعات الصغرى](https://kenji.blog/p/method-of-least-squares/).
...
لا تقتصر هذه الطريقة على تركيب الخط البسيط (الانحدار البسيط). بإضافة مصطلحات مثل $x^2, x^3$ إلى أعمدة مصفوفة التصميم $A$، يمكن توسيعها بشكل طبيعي إلى **الانحدار متعدد الحدود**، ويمكن أيضًا تطويرها إلى **[طريقة المربعات الصغرى](https://kenji.blog/p/method-of-least-squares/) المرجحة**، والتي ترجح أهمية كل نقطة بيانات.

كخطوة أولى للاقتراب من الحقيقة الكامنة وراء البيانات، فإن الفهم الأساسي ل[طريقة المربعات الصغرى](https://kenji.blog/p/method-of-least-squares/) له قيمة لا تقاس.
