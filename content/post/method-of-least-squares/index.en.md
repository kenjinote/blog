...
The most fundamental method, which still plays an extremely important role as the foundation of modern machine learning, is the **Method of Least Squares**.
...
## 2. Intuitive Idea of the Method of Least Squares
...
The Method of Least Squares is a technique to find the parameters $c$ and $d$ that minimize the **sum of squared** errors. The sum of squared errors $E$ is defined as follows:
