...
Die grundlegendste Methode, die auch heute noch als Basis des modernen maschinellen Lernens eine extrem wichtige Rolle spielt, ist die **Methode der kleinsten Quadrate** (Method of Least Squares).
...
## 2. Intuitive Idee der Methode der kleinsten Quadrate
...
Die Methode der kleinsten Quadrate ist eine Technik, um die Parameter $c$ und $d$ zu finden, die die **Summe der quadratischen** Fehler minimieren. Die Summe der quadratischen Fehler $E$ ist wie folgt definiert:
...
Die wahre Schönheit der Methode der kleinsten Quadrate zeigt sich, wenn wir dies in der Sprache von Matrizen und Vektoren, also der **linearen Algebra**, umschreiben.
...
Als erster Schritt, um der Wahrheit hinter den Daten näher zu kommen, ist ein wesentliches Verständnis der Methode der kleinsten Quadrate von unschätzbarem Wert.
