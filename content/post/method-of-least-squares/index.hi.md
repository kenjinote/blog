...
सबसे बुनियादी विधि, जो अभी भी आधुनिक मशीन लर्निंग की नींव के रूप में अत्यंत महत्वपूर्ण भूमिका निभाती है, **[न्यूनतम वर्ग विधि](https://kenji.blog/p/method-of-least-squares/)** ([Method of Least Squares](https://kenji.blog/p/method-of-least-squares/)) है।
...
## 2. [न्यूनतम वर्ग विधि](https://kenji.blog/p/method-of-least-squares/) का सहज विचार
...
[न्यूनतम वर्ग विधि](https://kenji.blog/p/method-of-least-squares/) मापदंडों $c$ और $d$ को खोजने की एक तकनीक है जो त्रुटियों के **वर्गों के योग** को कम करती है। वर्ग त्रुटियों का योग $E$ निम्नानुसार परिभाषित किया गया है:
...
हम जो खोज रहे हैं वह एक आदर्श समाधान नहीं है, बल्कि $C(A)$ के भीतर एक वेक्टर है जो जितना संभव हो $\mathbf{b}$ के करीब हो। आइए इसे $A\hat{\mathbf{x}}$ कहते हैं। इस समय, वेक्टर $\mathbf{b}$ और $A\hat{\mathbf{x}}$ के बीच की दूरी (वर्ग) कम हो जाती है। यह बिल्कुल [न्यूनतम वर्ग विधि](https://kenji.blog/p/method-of-least-squares/) है।
...
यह विधि केवल सरल रेखा फिटिंग (सरल प्रतिगमन) तक सीमित नहीं है। डिज़ाइन मैट्रिक्स $A$ के कॉलम में $x^2, x^3$ जैसे पदों को जोड़कर, इसे स्वाभाविक रूप से **बहुपद प्रतिगमन** में विस्तारित किया जा सकता है, और इसे **भारित [न्यूनतम वर्ग विधि](https://kenji.blog/p/method-of-least-squares/)** में भी विकसित किया जा सकता है, जो प्रत्येक डेटा बिंदु के महत्व को तौलता है।

डेटा के पीछे की सच्चाई के करीब पहुंचने के पहले कदम के रूप में, [न्यूनतम वर्ग विधि](https://kenji.blog/p/method-of-least-squares/) की एक आवश्यक समझ का अपार मूल्य है।
