...
```mermaid
graph LR
    A["Dunia Kurva Eliptik (Geometri Aljabar)"] <-->|"Jembatan oleh Konjektur Taniyama-Shimura"| B["Dunia Bentuk Modular (Analisis Kompleks)"]
    C["Fungsi Zeta dan Fungsi L"] -->|"Kelanjutan Analitik"| B
    A -->|"Struktur Titik Rasional"| C
    B -->|"Koefisien Fourier"| C
```

## 4. Simposium Nikko 1955

Konjektur besar ini pertama kali disarankan secara publik pada tahun 1955 di sebuah simposium internasional tentang teori bilangan aljabar yang diadakan di Nikko, Jepang. Simposium ini dihadiri oleh matematikawan top dunia pada saat itu, seperti André Weil dan Jean-Pierre Serre.
...
1. Jika Teorema Terakhir Fermat salah, ada kurva eliptik non-modular (kurva Frey).
2. Namun, menurut Konjektur Taniyama-Shimura, "semua kurva eliptik adalah modular."
3. Oleh karena itu, jika Konjektur Taniyama-Shimura benar, kurva Frey tidak mungkin ada, dan Teorema Terakhir Fermat juga harus benar.

Dengan kata lain, rantai takdir telah terhubung: **"Jika Konjektur Taniyama-Shimura terbukti, Teorema Terakhir Fermat, yang tak terpecahkan selama lebih dari 300 tahun, akan secara otomatis terbukti juga."**

```mermaid
flowchart TD
    A["Asumsikan contoh penyangkal Teorema Terakhir Fermat (A^n + B^n = C^n)"] -->|"Bangun kurva Frey E"| B["Kurva eliptik E dengan sifat yang sangat tidak normal"]
    C["Konjektur Taniyama-Shimura"] -->|"Semua kurva eliptik atas bilangan rasional adalah modular"| D["Tidak ada kurva eliptik non-modular yang eksis"]
    B -.->|"Kontradiksi oleh bukti Ken Ribet"| D
    D ==>|"Kesimpulan melalui kontradiksi"| E["Teorema Terakhir Fermat adalah benar"]
```

## 7. Bukti Konjektur dan Program Langlands

Orang yang paling terinspirasi oleh fakta ini adalah matematikawan Inggris **Andrew Wiles**. Ia telah terpesona oleh Teorema Terakhir Fermat sejak kecil dan bertekad mendedikasikan hidupnya untuk membuktikannya. Setelah tujuh tahun penelitian rahasia, ia mengumumkan pada tahun 1993 bahwa ia telah "membuktikan Konjektur Taniyama-Shimura untuk kurva eliptik semi-stabil." Meskipun celah ditemukan pada sebagian bukti, dengan bantuan mantan muridnya Richard Taylor, ia berhasil mengisi celah tersebut pada tahun 1995 dan menerbitkan bukti yang lengkap. Hasilnya, bagian krusial dari konjektur yang ditinggalkan oleh Taniyama telah terbukti, dan pada saat yang sama, Teorema Terakhir Fermat menjadi kebenaran abadi.
...
Konjektur sederhana yang disajikan Yutaka Taniyama di simposium Nikko menjadi fondasi untuk menegakkan Teorema Terakhir Fermat, puncak kecerdasan manusia, setengah abad kemudian. Wawasannya tentang "koneksi tersembunyi di balik objek matematika yang berbeda" terus menginspirasi para matematikawan saat ini.

Matematikawan jenius Yutaka Taniyama, yang meninggal muda. Konjektur indah yang ia tinggalkan akan terus menjadi cahaya penuntun yang menerangi alam semesta matematika yang luas. Kita tidak bisa tidak bertanya-tanya kebenaran mendalam apa lagi yang akan ia tunjukkan kepada kita jika ia masih hidup.
