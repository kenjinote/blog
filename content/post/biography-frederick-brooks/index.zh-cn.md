...
他还从“概念完整性”（Conceptual Integrity）的角度解释了软件开发本质上的困难。系统必须基于一个连贯的单一设计理念来构建，为此，应该将设计交给少数优秀的“架构师”。这是论述当今[软件架构](/zh-cn/p/clean-architecture-basics-guide/)重要性的先驱性思想。
