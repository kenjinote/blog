---
title: 'フレッツ光からJ:COMへ乗り換えた結果！料金と通信速度のリアルな感想'
...
余談ですが、J:COMは[P2P](https://kenji.blog/p/webrtc-realtime-communication-p2p/)通信を規制していることもありP2Pアプリの速度は出ないようです。P2Pを使用する方は注意したほうが良いです。
...
![ネットワーク診断](trouble_shooting.webp)
