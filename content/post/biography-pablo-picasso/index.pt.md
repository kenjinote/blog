---
title: "Pablo Picasso: O maior gênio do século XX que repetiu a destruição e a criação"
...
description: "Pablo Picasso (1881–1973) não foi apenas um pintor, mas um dos \"maiores artistas do século XX\" que revolucionou todos os campos das artes visuais, incluind"
---
...
```mermaid
flowchart TD
    A["Infância e Academicismo"] --> B["Fase Azul (Solidão e Tristeza)"]
    B --> C["Fase Rosa (Esperança e Cores)"]
    C --> D["Fundação do Cubismo (Desconstrução da Perspectiva)"]
    
    D --> E["Les Demoiselles d'Avignon (1907)"]
    E --> F["Porta para a Arte Abstrata"]
    
    D --> G["Neoclassicismo e Surrealismo"]
    G --> H["Guernica (1937) / Símbolo Anti-guerra"]
    
    F --> I["Arte e Design Modernos"]
    H --> I
    I --> J["Pensamento de Inovação Moderno (Desconstrução e Reconstrução)"]
```
