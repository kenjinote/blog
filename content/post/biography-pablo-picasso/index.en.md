---
title: "Pablo Picasso: The Greatest Genius of the 20th Century Who Repeated Destruction and Creation"
...
```mermaid
flowchart TD
    A["Childhood and Academicism"] --> B["Blue Period (Loneliness and Sorrow)"]
    B --> C["Rose Period (Hope and Colors)"]
    C --> D["Founding of Cubism (Deconstruction of Perspective)"]
    
    D --> E["Les Demoiselles d'Avignon (1907)"]
    E --> F["Gateway to Abstract Art"]
    
    D --> G["Neoclassicism and Surrealism"]
    G --> H["Guernica (1937) / Anti-war Symbol"]
    
    F --> I["Modern Art and Design"]
    H --> I
    I --> J["Modern Innovation Thinking (Deconstruction and Reconstruction)"]
```
