---
title: "Pablo Picasso: Das größte Genie des 20. Jahrhunderts, das Zerstörung und Schöpfung wiederholte"
...
description: "Pablo Picasso (1881–1973) war nicht nur ein Maler, sondern einer der „größten Künstler des 20."
---
...
```mermaid
flowchart TD
    A["Kindheit und Akademismus"] --> B["Blaue Periode (Einsamkeit und Trauer)"]
    B --> C["Rosa Periode (Hoffnung und Farben)"]
    C --> D["Gründung des Kubismus (Dekonstruktion der Perspektive)"]
    
    D --> E["Les Demoiselles d'Avignon (1907)"]
    E --> F["Tor zur abstrakten Kunst"]
    
    D --> G["Neoklassizismus und Surrealismus"]
    G --> H["Guernica (1937) / Antikriegssymbol"]
    
    F --> I["Moderne Kunst und Design"]
    H --> I
    I --> J["Modernes Innovationsdenken (Dekonstruktion und Rekonstruktion)"]
```
