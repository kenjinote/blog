---
title: "Pablo Picasso : Le plus grand génie du 20e siècle qui a répété la destruction et la création"
...
description: "Pablo Picasso (1881-1973) n'était pas seulement un peintre, mais l'un des « plus grands artistes du 20e siècle » qui a révolutionné tous les domaines des a"
---
...
```mermaid
flowchart TD
    A["Enfance et académisme"] --> B["Période bleue (Solitude et tristesse)"]
    B --> C["Période rose (Espoir et couleurs)"]
    C --> D["Fondation du cubisme (Déconstruction de la perspective)"]
    
    D --> E["Les Demoiselles d'Avignon (1907)"]
    E --> F["Porte vers l'art abstrait"]
    
    D --> G["Néoclassicisme et surréalisme"]
    G --> H["Guernica (1937) / Symbole anti-guerre"]
    
    F --> I["Art et design modernes"]
    H --> I
    I --> J["Pensée de l'innovation moderne (Déconstruction et reconstruction)"]
```
