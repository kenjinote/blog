---
title: "Pablo Picasso: Jenius Terbesar Abad ke-20 yang Mengulang Penghancuran dan Penciptaan"
date: 2026-09-23T20:51:46+09:00
categories: ["biography"]
tags: ["pablo-picasso", "history"]
image: "eyecatch.jpg"
slug: "biography-pablo-picasso"
description: "Pablo Picasso (1881–1973) bukan sekadar pelukis, melainkan salah satu \"seniman terbesar abad ke-20\" yang merevolusi setiap bidang seni visual, termasuk pat"
---
...
```mermaid
flowchart TD
    A["Masa Kecil dan Akademisisme"] --> B["Periode Biru (Kesepian dan Kesedihan)"]
    B --> C["Periode Merah Jambu (Harapan dan Warna)"]
    C --> D["Mendirikan Kubisme (Dekonstruksi Perspektif)"]
    
    D --> E["Les Demoiselles d'Avignon (1907)"]
    E --> F["Gerbang menuju Seni Abstrak"]
    
    D --> G["Neoklasikisme dan Surealisme"]
    G --> H["Guernica (1937) / Simbol Anti-perang"]
    
    F --> I["Seni dan Desain Modern"]
    H --> I
    I --> J["Pemikiran Inovasi Modern (Dekonstruksi dan Rekonstruksi)"]
```
