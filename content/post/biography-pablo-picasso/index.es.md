---
title: "Pablo Picasso: El mayor genio del siglo XX que repitió la destrucción y la creación"
date: 2026-09-23T20:51:46+09:00
categories: ["biography"]
tags: ["pablo-picasso", "history"]
image: "eyecatch.jpg"
slug: "biography-pablo-picasso"
description: "Pablo Picasso (1881–1973) fue más que un pintor; fue uno de los \"más grandes artistas del siglo XX\" que revolucionó todos los campos de las artes visuales,"
---
...
```mermaid
flowchart TD
    A["Infancia y Academicismo"] --> B["Período Azul (Soledad y Tristeza)"]
    B --> C["Período Rosa (Esperanza y Colores)"]
    C --> D["Fundación del Cubismo (Deconstrucción de la Perspectiva)"]
    
    D --> E["Las señoritas de Aviñón (1907)"]
    E --> F["Puerta al Arte Abstracto"]
    
    D --> G["Neoclasicismo y Surrealismo"]
    G --> H["Guernica (1937) / Símbolo contra la Guerra"]
    
    F --> I["Arte y Diseño Modernos"]
    H --> I
    I --> J["Pensamiento de Innovación Moderno (Deconstrucción y Reconstrucción)"]
```
