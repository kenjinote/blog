---
title: "Leonardo Fibonacci: Jenius yang Membawa Cahaya Matematika ke Eropa Abad Pertengahan"
description: 'Pendalaman tentang kehidupan Fibonacci, penyebaran angka Arab melalui "Liber Abaci", dan hubungan menakjubkan antara deret Fibonacci dan rasio emas di alam.'
slug: "fibonacci"
...
```mermaid
flowchart TD
    A["Matematika India (Penemuan Nol)"] -->|"Ke Dunia Persia-Arab"| B["Matematika Zaman Keemasan Islam"]
    B -->|"Afrika Utara (Bugia)"| C["Pembelajaran Fibonacci Muda"]
    C -->|"Diterbitkan tahun 1202"| D["Liber Abaci"]
    D -->|"Efisiensi Perhitungan Komersial"| E["Revolusi Komersial Eropa"]
...
stateDiagram-v2
    ...
    13 --> 21: "+ 8"
    21 --> [*]
    %% Gambar proses pembuatan deret menggunakan transisi status
```
