...
```mermaid
flowchart TD
    A["Matemáticas Indias (Descubrimiento del Cero)"] -->|"Hacia el Mundo Persa-Árabe"| B["Matemáticas de la Edad de Oro Islámica"]
    B -->|"Norte de África (Bugía)"| C["Aprendizaje del joven Fibonacci"]
    C -->|"Publicado en 1202"| D["Liber Abaci"]
    D -->|"Racionalización de Cálculos Comerciales"| E["Revolución Comercial Europea"]
...
stateDiagram-v2
    ...
    13 --> 21: "+ 8"
    21 --> [*]
    %% Imagen del proceso de generación de la sucesión usando transiciones de estado
```
