...
```mermaid
graph TD
    Corner["Sudut papan (Pojok)"] --> |"Batu pasti yang paling kuat"| Control["Mengarah pada penguasaan tepi"]
    Edge["Tepi papan (Pinggir)"] --> |"Aman selama sudut tidak direbut"| EdgeControl["Perluasan batu pasti"]
```
