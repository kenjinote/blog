...
```mermaid
graph TD
    Corner["Las cuatro esquinas del tablero"] --> |"Las piedras estables más fuertes"| Control["Conduce al control de los bordes"]
    Edge["Los bordes del tablero"] --> |"Seguro si no te toman las esquinas"| EdgeControl["Expansión de las piedras estables"]
```
