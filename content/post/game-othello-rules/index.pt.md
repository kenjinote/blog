...
```mermaid
graph TD
    Corner["Cantos do tabuleiro (Quinas)"] --> |"Os discos estáveis mais fortes"| Control["Leva ao controle das bordas"]
    Edge["Bordas do tabuleiro (Extremidades)"] --> |"Seguro desde que o canto não seja tomado"| EdgeControl["Expansão dos discos estáveis"]
```
