...
```mermaid
graph TD
    Corner["Die vier Ecken des Spielbretts"] --> |"Die stärksten sicheren Steine"| Control["Führt zur Kontrolle der Kanten"]
    Edge["Die Kanten (Ränder) des Spielbretts"] --> |"Sicher, solange die Ecke nicht eingenommen wird"| EdgeControl["Ausweitung der sicheren Steine"]
```
