...
```mermaid
graph TD
    Corner["Les quatre coins du plateau"] --> |"Le disque définitif le plus fort"| Control["Mène au contrôle des bords"]
    Edge["Les bords du plateau"] --> |"Sûr si les coins ne sont pas pris"| EdgeControl["Extension des disques définitifs"]
```
