...
```mermaid
graph TD
    Corner["Four corners of the board (Corners)"] --> |"Strongest stable disc"| Control["Leads to control of the edges"]
    Edge["Edges of the board (Sides)"] --> |"Safe as long as corners are not taken"| EdgeControl["Expansion of stable discs"]
```
