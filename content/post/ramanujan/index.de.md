...
sequenceDiagram
    ...
    participant C as "Universität Cambridge"
    
    R->>H: "Sendet einen Brief mit Theoremen"
    Note over H: "Liest den Brief und ist verblüfft"
    H->>R: "Erkennt das Talent und sendet eine Einladung"
    R->>C: "Verlässt Indien und reist nach England"
    Note over R,C: "Beginn der gemeinsamen Forschung"
```
...
```mermaid
graph TD
    A["Ramanujans Intuition"] --> B["Analytische Zahlentheorie"]
    A --> C["Unendliche Reihen und Kettenbrüche"]
    A --> D["Mock-Thetafunktionen"]
    
    B --> E["Partitionsformel"]
    B --> F["Ramanujan-Primzahl"]
    
    C --> G["Schnelle Pi-Berechnung"]
    
    D --> H["Moderne Physik und Stringtheorie"]
```
...
Das turbulente Leben von Srinivasa Ramanujan wurde in Robert Kanigels Biografie *Der Mann, der die Unendlichkeit kannte* und der gleichnamigen Verfilmung von 2015 dargestellt, die unzählige Menschen über die mathematische Gemeinschaft hinaus inspirierte.
