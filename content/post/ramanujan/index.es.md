...
sequenceDiagram
    ...
    participant C as "Univ. de Cambridge"
    
    R->>H: "Envía una carta que contiene teoremas"
    Note over H: "Lee la carta y queda asombrado"
    H->>R: "Reconoce su talento y envía una invitación"
    R->>C: "Sale de la India y viaja a Inglaterra"
    Note over R,C: "Comienza la investigación conjunta"
```
...
```mermaid
graph TD
    A["Intuición de Ramanujan"] --> B["Teoría Analítica de Números"]
    A --> C["Series Infinitas y Fracciones Continuas"]
    A --> D["Falsas Funciones Theta"]
    
    B --> E["Fórmula de Partición"]
    B --> F["Primo de Ramanujan"]
    
    C --> G["Cálculo Rápido de Pi"]
    
    D --> H["Física Moderna y Teoría de Cuerdas"]
```
...
La turbulenta vida de [Srinivasa Ramanujan](https://kenji.blog/es/p/ramanujan/) fue retratada en la biografía de Robert Kanigel *El hombre que conocía el infinito* y en su adaptación cinematográfica de 2015 del mismo nombre, inspirando a innumerables personas más allá de la comunidad matemática.
