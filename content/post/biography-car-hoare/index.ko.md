...
이 말은 현대의 복잡해지는 소프트웨어 개발에서 [마이크로서비스 아키텍처](/ko/p/microservices-architecture-bff-api-gateway/)나 [함수형 프로그래밍](/ko/p/lambda-calculus-functional-programming/)이 다시 '단순함'을 추구하고 있는 현상을 멋지게 예견하고 있습니다.
