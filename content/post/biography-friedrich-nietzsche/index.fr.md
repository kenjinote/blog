---
title: "Le prophète solitaire : La vie et l'abîme philosophique de Friedrich Nietzsche"
...
```mermaid
graph TD
    Nietzsche["Friedrich Nietzsche"] --> Concepts["Concepts fondamentaux"]
    Concepts --> Uebermensch["Surhomme"]
    Concepts --> EternalRecurrence["Éternel retour"]
    Concepts --> WillToPower["Volonté de puissance"]
    Concepts --> Nihilism["Surmonter le nihilisme"]
    
    Nietzsche --> Works["Œuvres majeures"]
    Works --> Zarathustra["Ainsi parlait Zarathoustra"]
    Works --> BeyondGoodEvil["Par-delà le bien et le mal"]
    
    Nietzsche --> Influences["Influences sur Nietzsche"]
