...
```mermaid
graph TD
    Nietzsche["Friedrich Nietzsche"] --> Concepts["Conceptos principales"]
    Concepts --> Uebermensch["Übermensch (Superhombre)"]
    Concepts --> EternalRecurrence["Eterno retorno"]
    Concepts --> WillToPower["Voluntad de poder"]
    Concepts --> Nihilism["Superación del nihilismo"]
    
    Nietzsche --> Works["Obras principales"]
    Works --> Zarathustra["Así habló Zaratustra"]
    Works --> BeyondGoodEvil["Más allá del bien y del mal"]
    
    Nietzsche --> Influences["Influencias sobre Nietzsche"]
