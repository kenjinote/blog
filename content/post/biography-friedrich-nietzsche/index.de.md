---
title: "Der einsame Prophet: Das Leben Friedrich Nietzsches und der Abgrund seiner Philosophie"
...
```mermaid
graph TD
    Nietzsche["Friedrich Nietzsche"] --> Concepts["Kernkonzepte"]
    Concepts --> Uebermensch["Übermensch"]
    Concepts --> EternalRecurrence["Ewige Wiederkunft"]
    Concepts --> WillToPower["Wille zur Macht"]
    Concepts --> Nihilism["Überwindung des Nihilismus"]
    
    Nietzsche --> Works["Hauptwerke"]
    Works --> Zarathustra["Also sprach Zarathustra"]
    Works --> BeyondGoodEvil["Jenseits von Gut und Böse"]
    
    Nietzsche --> Influences["Einflüsse auf Nietzsche"]
