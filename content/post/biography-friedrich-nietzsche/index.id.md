---
title: "Nabi yang Kesepian: Kehidupan Friedrich Nietzsche dan Jurang Filsafatnya"
...
```mermaid
graph TD
    Nietzsche["Friedrich Nietzsche"] --> Concepts["Konsep Inti"]
    Concepts --> Uebermensch["Übermensch (Manusia Super)"]
    Concepts --> EternalRecurrence["Eternal Recurrence (Kembalinya Segala Sesuatu Secara Abadi)"]
    Concepts --> WillToPower["Will to Power (Kehendak untuk Berkuasa)"]
    Concepts --> Nihilism["Overcoming Nihilism (Mengatasi Nihilisme)"]
    
    Nietzsche --> Works["Karya Utama"]
    Works --> Zarathustra["Thus Spoke Zarathustra (Sabda Zarathustra)"]
    Works --> BeyondGoodEvil["Beyond Good and Evil (Melampaui Baik dan Jahat)"]
    
    Nietzsche --> Influences["Pengaruh pada Nietzsche"]
