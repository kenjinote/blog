...
```mermaid
flowchart LR
    Xerox["施乐 PARC (GUI 概念)"] --> Jobs["史蒂夫·乔布斯参观 (1979)"]
    Jobs --> Lisa["Apple Lisa (1983)"]
    Lisa --> Mac["Macintosh (1984)"]
    Mac --> Modern["现代 GUI 操作系统"]
```
