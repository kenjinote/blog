...
description: 'نشرح كيفية الاستخدام الأساسي لـ "أداة القطع" (Snipping Tool)، أداة التقاط الشاشة المدمجة في Windows. نوضح بوضوح خطوات التشغيل السريع باستخدام اختصارات لوحة المفاتيح، وقص وحفظ جزء من الصورة، وإجراءات تسجيل الشاشة بالفيديو.'
---
