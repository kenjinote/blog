...
```mermaid
graph TD
    A["Anjezë Gonxhe Bojaxhiu (1910)"] --> B["Hermanas de Loreto (1928)"]
    B --> C["Enseñando en Calcuta (1929-1946)"]
    C -->|"La llamada dentro de la llamada (1946)"| D["Trabajo en barrios marginales de Calcuta (1948)"]
    D --> E["Misioneras de la Caridad (1950)"]
    E --> F["Nirmal Hriday (1952)"]
    E --> G["Shishu Bhavan (Orfanato)"]
    E --> H["Shanti Nagar (Centro de lepra)"]
    F --> I["Premio Nobel de la Paz (1979)"]
    I --> J["Canonizada como Santa Teresa (2016)"]
```
