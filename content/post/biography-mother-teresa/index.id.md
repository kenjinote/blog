---
title: "Kehidupan yang Didedikasikan untuk 'Orang Termiskin di Antara yang Miskin': Jejak dan Filosofi Bunda Teresa"
...
```mermaid
graph TD
    A["Agnes Gonxha Bojaxhiu (1910)"] --> B["Suster-suster Loreto (1928)"]
    B --> C["Mengajar di Kalkuta (1929-1946)"]
    C -->|"Panggilan di dalam panggilan (1946)"| D["Pekerjaan di daerah kumuh Kalkuta (1948)"]
    D --> E["Misionaris Cinta Kasih (1950)"]
    E --> F["Nirmal Hriday (1952)"]
    E --> G["Shishu Bhavan (Panti Asuhan)"]
    E --> H["Shanti Nagar (Pusat Kusta)"]
    F --> I["Hadiah Nobel Perdamaian (1979)"]
    I --> J["Dikanonisasi sebagai Santa Teresa (2016)"]
```
