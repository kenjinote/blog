---
title: "Une vie dédiée aux « plus pauvres d'entre les pauvres » : le parcours et la philosophie de Mère Teresa"
...
```mermaid
graph TD
    A["Agnes Gonxha Bojaxhiu (1910)"] --> B["Sœurs de Lorette (1928)"]
    B --> C["Enseignement à Calcutta (1929-1946)"]
    C -->|"Appel dans l'appel (1946)"| D["Travail dans les bidonvilles de Calcutta (1948)"]
    D --> E["Missionnaires de la Charité (1950)"]
    E --> F["Nirmal Hriday (1952)"]
    E --> G["Shishu Bhavan (Orphelinat)"]
    E --> H["Shanti Nagar (Centre pour lépreux)"]
    F --> I["Prix Nobel de la paix (1979)"]
    I --> J["Canonisée Sainte Teresa (2016)"]
```
