...
تحليل العوامل الأولية الذي يعتمد عليه تشفير RSA هو أحد الأمثلة على ذلك.
...
2. **اللجوء إلى التخفيف والتقريب**:
    ...
    - **البرمجة الديناميكية (Dynamic Programming - DP)**: استغلال قيود المدخلات إذا كان هناك حل يعتمد على حجم الأرقام المدخلة (وقت كثير الحدود الزائف) مثلما في مشكلة حقيبة الظهر.
