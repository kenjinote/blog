---
title: "Lewis Carroll: La trayectoria del matemático y lógico que creó 'Alicia en el país de las maravillas'"
...
```mermaid
graph TD
    A["Charles Lutwidge Dodgson"] --> B["Universidad de Oxford (Christ Church)"]
    A --> C["Lewis Carroll (Seudónimo)"]
    
    B --> D["Matemáticas y Lógica"]
    B --> E["Fotografía"]
    
    C --> F["Literatura del absurdo"]
    C --> G["Amistad con Alice Liddell"]
    
    D --> H["Lógica simbólica y paradojas"]
    G --> I["Alicia en el país de las maravillas"]
    I --> F
    
    F --> J["Impacto en la literatura moderna (Surrealismo)"]
    F --> K["Cultura pop y medios"]
    H --> L["Influencia en la filosofía y la ciencia cognitiva"]
    
    J --> M["Legado perdurable"]
    K --> M
    L --> M
```
