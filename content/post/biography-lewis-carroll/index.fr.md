---
title: "Lewis Carroll: La trajectoire du mathématicien et logicien qui a créé 'Alice au pays des merveilles'"
...
description: "En entendant le nom de « Lewis Carroll », beaucoup de gens pensent à l'auteur du livre pour enfants mondialement apprécié « Alice au pays des merveilles »."
---
...
```mermaid
graph TD
    A["Charles Lutwidge Dodgson"] --> B["Université d'Oxford (Christ Church)"]
    A --> C["Lewis Carroll (Pseudonyme)"]
    
    B --> D["Mathématiques & Logique"]
    B --> E["Photographie"]
    
    C --> F["Littérature de l'absurde"]
    C --> G["Amitié avec Alice Liddell"]
    
    D --> H["Logique symbolique & Paradoxes"]
    G --> I["Alice au pays des merveilles"]
    I --> F
    
    F --> J["Impact sur la littérature moderne (Surréalisme)"]
    F --> K["Culture pop & Médias"]
    H --> L["Influence sur la philosophie & Sciences cognitives"]
    
    J --> M["Héritage durable"]
    K --> M
    L --> M
```
