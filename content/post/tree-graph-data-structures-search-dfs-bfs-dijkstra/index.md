...
ここで登場するのが、[エドガー・ダイクストラ](/p/biography-edsger-dijkstra/)によって考案された **ダイクストラ法** です。
...
木構造やグラフ構造に対する[探索アルゴリズム](/p/search-algorithms-linear-binary-hash-table-principles/)は、一見すると抽象的で難解に思えるかもしれません。しかし、DFS、BFS、ダイクストラ法という基本的なパーツをしっかりと理解し、自分の手で実装してみることで、世界中の複雑な情報網をプログラムで解き明かす感覚を掴むことができるはずです。
