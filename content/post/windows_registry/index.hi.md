...
इसके अलावा, नवीनतम Windows में रजिस्ट्री की विश्वसनीयता बढ़ाने के लिए ट्रांजेक्शन लॉगिंग ([Transaction](https://kenji.blog/hi/p/rdbms-transaction-acid-isolation-level-lock/) Logging) लागू की गई है। हाइव फ़ाइलों में परिवर्तन सीधे डेटा फ़ाइलों में नहीं लिखे जाते हैं, बल्कि पहले ट्रांजेक्शन लॉग (`.log1`, `.log2`) में दर्ज किए जाते हैं। यह लिखने के दौरान अप्रत्याशित बिजली विफलता या सिस्टम क्रैश होने पर डेटा भ्रष्टाचार (करप्शन) को रोकता है, और लगभग [ACID](https://kenji.blog/hi/p/rdbms-transaction-acid-isolation-level-lock/) गुणों के साथ डेटाबेस की अखंडता की गारंटी देता है।
...
रजिस्ट्री सीधे OS के प्रदर्शन (विशेष रूप से बूट समय और प्रक्रिया आरंभीकरण गति) से संबंधित है, इसलिए आंतरिक रूप से इसे "Cell Index" नामक [B-Tree](https://kenji.blog/hi/p/b-tree-database-index-theory/) (B-ट्री) के समान एक उन्नत डेटा संरचना का उपयोग करके अनुकूलित किया गया है।
