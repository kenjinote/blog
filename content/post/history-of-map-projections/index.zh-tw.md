...
在講述地圖投影法歷史之前，首先必須理解由「[卡爾·弗里德里希·高斯](/zh-tw/p/gauss/)」所證明的數學大前提。19世紀偉大的數學家高斯，推導出了被稱為「絕妙定理（[Theorema Egregium](/zh-tw/p/theorema-egregium/)）」的微分幾何學定理。根據這個定理，曲面的高斯曲率具有即使將該曲面彎曲也不會改變的性質。
