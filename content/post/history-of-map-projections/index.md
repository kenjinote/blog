...
地図投影法の歴史を語る上で、まず理解しなければならないのは「[カール・フリードリヒ・ガウス](/p/gauss/)」が証明した数学的な大前提です。19世紀の偉大な数学者ガウスは、「驚異の定理（[Theorema Egregium](/p/theorema-egregium/)）」と呼ばれる微分幾何学の定理を導き出しました。この定理によれば、曲面におけるガウス曲率は、その曲面を曲げても変わらないという性質を持っています。
