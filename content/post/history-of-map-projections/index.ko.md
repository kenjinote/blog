...
지도 투영법의 역사를 논할 때 먼저 이해해야 할 것은 '카를 프리드리히 가우스'가 증명한 수학적 대전제입니다. 19세기의 위대한 수학자 가우스는 '경이로운 정리(Theorema Egregium)'라고 불리는 미분기하학의 정리를 도출해 냈습니다. 이 정리에 따르면 곡면에서의 가우스 곡률은 그 곡면을 구부려도 변하지 않는 성질을 가지고 있습니다.
