...
आधुनिक क्रिप्टोग्राफी में, **एलिप्टिक कर्व क्रिप्टोग्राफी (Elliptic Curve [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy: ECC)** अत्यंत महत्वपूर्ण भूमिका निभाती है। हमारे दैनिक इंटरनेट संचार (HTTPS/TLS) से लेकर, स्मार्टफोन के सुरक्षित एन्क्लेव, SSH के माध्यम से सर्वर प्रमाणीकरण, FIDO जैसे पासवर्ड रहित प्रमाणीकरण, और यहाँ तक कि बिटकॉइन और एथेरियम जैसी क्रिप्टो संपत्तियों तक, यह कहना अतिशयोक्ति नहीं होगी कि आधुनिक डिजिटल समाज का विश्वास आधार ECC द्वारा समर्थित है।
...
## 1. एलिप्टिक कर्व क्रिप्टोग्राफी क्यों? ([RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) के साथ तुलना)
...
### 2.1. समूह (Group) और एबेलियन समूह ([Abel](https://kenji.blog/hi/p/abel/)ian Group)
...
इसके अलावा, एक समूह जिसमें संक्रियाओं के क्रम को बदलने से परिणाम नहीं बदलता है, अर्थात जो निम्नलिखित शर्त को पूरा करता है, उसे **एबेलियन समूह ([Abel](https://kenji.blog/hi/p/abel/)ian group या क्रमविनिमेय समूह)** कहा जाता है।
...
क्रिप्टोग्राफी में, हम वास्तविक या सम्मिश्र संख्याओं जैसे निरंतर और असीम अवयवों वाले क्षेत्रों के बजाय **परिमित क्षेत्र (Finite Field)** या गैलवा क्षेत्र ([Galois](https://kenji.blog/hi/p/galois/) Field) का उपयोग करते हैं, जिनमें अवयवों की संख्या परिमित होती है।
...
1. **विस्तारित [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिदम (Extended [[Euclid](https://kenji.blog/hi/p/euclid/)e](https://kenji.blog/p/euclid/)an Algorithm)**: यह तेज़ है, लेकिन कार्यान्वयन के आधार पर, प्रसंस्करण समय इनपुट मान पर निर्भर कर सकता है, जिससे टाइमिंग हमलों का जोखिम होता है।
2. **फ़र्मेट का छोटा प्रमेय ([Fermat's Little Theorem](https://kenji.blog/hi/p/fermats-little-theorem/))**: जब $p$ एक अभाज्य संख्या है और $b \neq 0$ है, तो $b^{p-1} \equiv 1 \pmod p$ लागू होता है। दोनों पक्षों को $b$ से विभाजित करने पर, हमें $b^{p-2} \equiv b^{-1} \pmod p$ मिलता है। दूसरे शब्दों में, $b$ की घात $p-2$ की गणना करके प्रतिलोम पाया जा सकता है। चूंकि घातांकीकरण (exponentiation) को निरंतर समय (constant time) में लागू करना आसान होता है, इसलिए क्रिप्टोग्राफ़िक कार्यान्वयन में इसे प्राथमिकता दी जाती है।
...
> [!IMPORTANT]
> इन सूत्रों में $(x_2 - x_1)^{-1}$ और $(2y_1)^{-1}$ जैसे **विभाजन (मॉड्यूलर प्रतिलोम की गणना)** शामिल हैं। मॉड्यूलर प्रतिलोम की गणना की कम्प्यूटेशनल लागत बहुत अधिक होती है, इसलिए वास्तविक कार्यान्वयन में, **"जैकोबियन कोऑर्डिनेट्स ([Jacobi](https://kenji.blog/hi/p/jacobi/)an Coordinates)"** जैसी प्रक्षेपीय समन्वय प्रणालियों (projective coordinate systems) का आमतौर पर उपयोग किया जाता है जो विभाजन को विलंबित करते हैं।
...
क्रिप्टोग्राफ़िक प्रोटोकॉल में, **$k$ "निजी कुंजी (Private Key)" से मेल खाता है, और $Q$ "सार्वजनिक कुंजी ([Public Key](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/))"** से मेल खाता है।
...
सबसे पहले, हम परिमित क्षेत्र पर संचालन के लिए सहायक कार्यों को परिभाषित करते हैं। हम फ़र्मेट के छोटे प्रमेय ([Fermat's Little Theorem](https://kenji.blog/hi/p/fermats-little-theorem/)) का उपयोग करके प्रतिलोम गणना को लागू करेंगे।
...
1. **[RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) पर लाभ**: बहुत छोटी कुंजी की लंबाई के साथ मजबूत सुरक्षा प्रदान करता है, जो इसे आधुनिक मोबाइल और IoT युग के लिए आदर्श बनाता है।
...
अगले लेख में, हम इस एलिप्टिक कर्व का उपयोग करने वाले डिजिटल हस्ताक्षर एल्गोरिदम **ECDSA (Elliptic Curve [Digital Signature](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) Algorithm)** के तंत्र, और बिटकॉइन में प्रयुक्त ** स्क्नोर (Schnorr) हस्ताक्षर** के बारे में और गहराई से जानेंगे।
