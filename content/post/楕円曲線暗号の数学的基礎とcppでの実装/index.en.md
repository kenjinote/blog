...
First, we define helper functions for operations over finite fields. We implement inverse calculation using [Fermat's Little Theorem](https://kenji.blog/en/p/fermats-little-theorem/).
