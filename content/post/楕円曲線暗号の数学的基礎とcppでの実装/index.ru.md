...
math: true
mermaid: true
categories: ["cryptography", "cpp", "Математика"]
tags: ["ECC", "Cryptography", "C++", "Математика"]
---
...
В следующей статье мы планируем глубже погрузиться в механизмы **алгоритма цифровой подписи на эллиптических кривых (ECDSA - Elliptic Curve Digital Signature Algorithm)** и ** подписей Шнорра (Schnorr)**, которые используются в [Биткойн](https://kenji.blog/ru/p/cryptocurrency-and-bitcoin/)е.
