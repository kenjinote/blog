...
1. **Расширенный алгоритм [Евклид](https://kenji.blog/ru/p/euclid/)а (Extended [Euclide](https://kenji.blog/p/euclid/)an Algorithm)**: Он быстр, но в зависимости от реализации время обработки может зависеть от входных значений, что создает риск тайминг-атак.
