---
title: "John D. Rockefeller: A Vida e a Filosofia do Magnata do Petróleo que Moldou o Capitalismo Moderno"
date: 2026-09-23T20:59:57+09:00
categories: ["biography"]
tags: ["john-d-rockefeller", "history"]
image: "eyecatch.jpg"
slug: "biography-john-d-rockefeller"
description: "Do final do século XIX ao início do século XX, houve uma figura que teve um impacto enorme não apenas nos Estados Unidos, mas na economia global."
---
...
```mermaid
flowchart TD
    A["John D. Rockefeller"] --> B["Fundação da Standard Oil (1870)"]
    B --> C["Integração horizontal"]
    B --> D["Integração vertical"]
    C --> E["Aquisição de concorrentes"]
    C --> F["Acordos de desconto com ferrovias"]
    D --> G["Construção de oleodutos"]
    D --> H["Fabricação própria de barris e produtos químicos"]
    E --> I["Controle de 90% da capacidade de refino dos EUA"]
    F --> I
    G --> I
    H --> I
    I --> J["Estabelecimento do sistema de Trust (1882)"]
    J --> K["Dissolução pela lei antitruste (1911)"]
```
...
```mermaid
flowchart LR
    A["Acúmulo de imensa riqueza"] --> B["Desenvolvimento da filantropia científica"]
    B --> C["Fundação da Universidade de Chicago"]
    B --> D["Instituto Rockefeller de Pesquisa Médica"]
    B --> E["Criação da Fundação Rockefeller (1913)"]
    C --> F["Desenvolvimento da educação"]
    D --> G["Avanços em saúde pública e medicina"]
    E --> H["Contribuição global para o bem-estar da humanidade"]
```
