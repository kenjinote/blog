---
title: "John D. Rockefeller: The Life and Philosophy of the Oil King Who Shaped Modern Capitalism"
date: 2026-09-23T20:59:57+09:00
categories: ["biography"]
tags: ["john-d-rockefeller", "history"]
image: "eyecatch.jpg"
slug: "biography-john-d-rockefeller"
description: "From the late 19th century to the early 20th century, there was a figure who had a massive impact not only on the United States but on the global economy."
---
...
```mermaid
flowchart TD
    A["John D. Rockefeller"] --> B["Establishment of Standard Oil (1870)"]
    B --> C["Horizontal Integration"]
    B --> D["Vertical Integration"]
    C --> E["Acquisition of Competitors"]
    C --> F["Rebate Agreements with Railroads"]
    D --> G["Pipeline Construction"]
    D --> H["In-house Manufacturing of Barrels and Chemicals"]
    E --> I["Control of 90% of US Refining Capacity"]
    F --> I
    G --> I
    H --> I
    I --> J["Establishment of the Trust System (1882)"]
    J --> K["Dissolution by Antitrust Laws (1911)"]
```
...
```mermaid
flowchart LR
    A["Accumulation of Massive Wealth"] --> B["Development of Scientific Philanthropy"]
    B --> C["Founding of the University of Chicago"]
    B --> D["Rockefeller Institute for Medical Research"]
    B --> E["Establishment of the Rockefeller Foundation (1913)"]
    C --> F["Advancement of Education"]
    D --> G["Progress in Public Health and Medicine"]
    E --> H["Contribution to Global Human Welfare"]
```
