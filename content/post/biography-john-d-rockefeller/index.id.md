---
title: "John D. Rockefeller: Kehidupan dan Filosofi Raja Minyak yang Membentuk Kapitalisme Modern"
...
description: "Dari akhir abad ke-19 hingga awal abad ke-20, ada seorang tokoh yang memberikan pengaruh besar tidak hanya pada Amerika Serikat tetapi juga pada ekonomi dunia."
---
...
```mermaid
flowchart TD
    A["John D. Rockefeller"] --> B["Pendirian Standard Oil Company (1870)"]
    B --> C["Integrasi Horizontal"]
    B --> D["Integrasi Vertikal"]
    C --> E["Akuisisi Pesaing"]
    C --> F["Perjanjian Potongan Harga dengan Perusahaan Kereta Api"]
    D --> G["Pembangunan Jaringan Pipa"]
    D --> H["Pembuatan Tong dan Bahan Kimia Sendiri"]
    E --> I["Penguasaan 90% Kapasitas Penyulingan AS"]
    F --> I
    G --> I
    H --> I
    I --> J["Pembentukan Sistem Trust (1882)"]
    J --> K["Pembubaran Berdasarkan UU Anti-Trust (1911)"]
```
...
```mermaid
flowchart LR
    A["Akumulasi Kekayaan Luar Biasa"] --> B["Penyebaran Filantropi Ilmiah"]
    B --> C["Pendirian Universitas Chicago"]
    B --> D["Rockefeller Institute for Medical Research"]
    B --> E["Pendirian Rockefeller Foundation (1913)"]
    C --> F["Pengembangan Pendidikan"]
    D --> G["Kemajuan dalam Kesehatan Masyarakat dan Kedokteran"]
    E --> H["Kontribusi terhadap Kesejahteraan Umat Manusia Global"]
```
