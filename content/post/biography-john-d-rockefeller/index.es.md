---
title: "John D. Rockefeller: La vida y filosofía del magnate petrolero que dio forma al capitalismo moderno"
date: 2026-09-23T20:59:57+09:00
categories: ["biography"]
tags: ["john-d-rockefeller", "history"]
image: "eyecatch.jpg"
slug: "biography-john-d-rockefeller"
description: "Desde finales del siglo XIX hasta principios del siglo XX, hubo una figura que tuvo un profundo impacto no solo en los Estados Unidos, sino en la economía"
---
...
```mermaid
flowchart TD
    A["John D. Rockefeller"] --> B["Fundación de Standard Oil Co. (1870)"]
    B --> C["Integración horizontal"]
    B --> D["Integración vertical"]
    C --> E["Adquisición de competidores"]
    C --> F["Acuerdos de reembolso con ferrocarriles"]
    D --> G["Construcción de oleoductos"]
    D --> H["Fabricación propia de barriles y químicos"]
    E --> I["Control del 90% de la capacidad de refinación de EE. UU."]
    F --> I
    G --> I
    H --> I
    I --> J["Establecimiento del sistema Trust (1882)"]
    J --> K["Disolución bajo la Ley Antimonopolio (1911)"]
```
...
```mermaid
flowchart LR
    A["Acumulación de riqueza masiva"] --> B["Desarrollo de la filantropía científica"]
    B --> C["Fundación de la Univ. de Chicago"]
    B --> D["Instituto Rockefeller de Investigación Médica"]
    B --> E["Fundación de la Fundación Rockefeller (1913)"]
    C --> F["Desarrollo de la educación"]
    D --> G["Avances en salud pública y medicina"]
    E --> H["Contribución al bienestar humano global"]
```
