---
title: "John D. Rockefeller: Leben und Philosophie des Ölmagnaten, der den modernen Kapitalismus prägte"
...
```mermaid
flowchart TD
    A["John D. Rockefeller"] --> B["Gründung der Standard Oil Company (1870)"]
    B --> C["Horizontale Integration"]
    B --> D["Vertikale Integration"]
    C --> E["Übernahme von Konkurrenten"]
    C --> F["Rabattvereinbarungen mit Eisenbahngesellschaften"]
    D --> G["Bau von Pipelines"]
    D --> H["Eigene Herstellung von Fässern und Chemikalien"]
    E --> I["Kontrolle über 90% der US-Raffineriekapazität"]
    F --> I
    G --> I
    H --> I
    I --> J["Etablierung des Trust-Systems (1882)"]
    J --> K["Zerschlagung durch das Kartellrecht (1911)"]
```
...
```mermaid
flowchart LR
    A["Anhäufung von immensem Reichtum"] --> B["Entwicklung der wissenschaftlichen Philanthropie"]
    B --> C["Gründung der University of Chicago"]
    B --> D["Rockefeller Institute for Medical Research"]
    B --> E["Gründung der Rockefeller Foundation (1913)"]
    C --> F["Entwicklung der Bildung"]
    D --> G["Fortschritte in der öffentlichen Gesundheit und Medizin"]
    E --> H["Beitrag zum globalen menschlichen Wohlergehen"]
```
