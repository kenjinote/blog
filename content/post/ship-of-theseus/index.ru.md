...
Здравствуйте. Знакомы ли вы с парадоксом (мысленным экспериментом) **Корабль Тесея**?
...
## 1. «Корабль Тесея» в программном обеспечении
...
Это и есть сам **Корабль Тесея**. Даже если все компоненты (детали), составляющие систему, были заменены, считается, что «идентичность» системы в целом сохранилась.
...
## 4. «Корабль Тесея» в проектных командах
...
Греческий философский парадокс «Корабль Тесея» учит нас, что поиск идентичности в физической сущности приводит к противоречиям.
