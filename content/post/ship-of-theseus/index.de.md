...
Ein typisches Architekturmuster für den Systemersatz ist das **Strangler Fig Pattern**. Dabei wird ein riesiges und komplexes Legacy-System (Monolith) nicht auf einmal ersetzt, sondern die Funktionen werden nach und nach in ein neues System (z. B. [Microservices](https://kenji.blog/de/p/microservices-architecture-bff-api-gateway/)) migriert.
