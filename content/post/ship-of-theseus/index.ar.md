...
مرحباً. هل سمعتم من قبل عن المفارقة الفلسفية (التجربة الفكرية) المعروفة باسم **سفينة ثيسيوس** (Ship of Theseus)؟
...
"هل هذه السفينة التي تم استبدال جميع أجزائها، هي في الواقع **نفس سفينة ثيسيوس الأصلية**؟"
...
في هذه المقالة، وانطلاقاً من مفارقة **سفينة ثيسيوس** هذه، سنتعمق في استكشاف إعادة الهيكلة (Refactoring) في تطوير البرمجيات، ونقل الأنظمة القديمة (Migration)، ومفهوم "الهوية" في البرمجة الكائنية التوجه (OOP).

## 1. "سفينة ثيسيوس" في عالم البرمجيات
...
هذه بالضبط هي **سفينة ثيسيوس**. حتى لو تم استبدال جميع المكونات (الأجزاء) التي يتكون منها النظام، يُعتبر أن "الهوية" الخاصة بالنظام ككل قد تم الحفاظ عليها.
...
في سفينة ثيسيوس، فإن الادعاء بأن "جميع الأجزاء قد تم استبدالها ولذلك فهي سفينة مختلفة" هو طريقة تفكير تؤكد على **تساوي القيمة**. من ناحية أخرى، فإن الادعاء بأن "السياق التاريخي والاجتماعي مستمر ولذلك فهي نفس السفينة" يمكن القول إنه أقرب إلى نوع من **تساوي المرجع**.
...
وبتطبيق هذا على سفينة ثيسيوس، يمكن الحصول على نمذجة واضحة جداً.
...
ما يضمن هذا "السلوك الخارجي" هو **الاختبارات الآلية (Automated Tests)**. طالما أن جميع الاختبارات تستمر في النجاح، فمهما تم استبدال الأجزاء الداخلية (طرق أو فئات أو البنية بأكملها)، فإن هذا البرنامج سيظل "نفس الشيء" مثل سفينة ثيسيوس.

## 4. "سفينة ثيسيوس" في فرق العمل (Project Teams)

ليس فقط نظام البرمجيات بحد ذاته، بل **فريق التطوير** الذي يبنيه يمكن أن يكون أيضاً سفينة ثيسيوس.
...
هناك نسخة موسعة وشهيرة لمفارقة سفينة ثيسيوس أضافها الفيلسوف توماس هوبز (Thomas Hobbes).

> إذا قام شخص ما بجمع جميع "الأجزاء القديمة المتعفنة" التي أزيلت من السفينة، واستخدمها معاً لبناء "سفينة أخرى"، فأي منهما ستكون سفينة ثيسيوس الحقيقية؟
...
تُعلمنا مفارقة "سفينة ثيسيوس" اليونانية أنه تحدث تناقضات إذا سعينا إلى الهوية في الكيانات المادية.
...
إن قيامنا بتطوير البرمجيات وصيانتها يشبه تماماً مشاركتنا في صيانة سفينة ثيسيوس العظيمة هذه. نحن نستبدل الأجزاء واحداً تلو الآخر بأجزاء أفضل، وننقل إلى المستقبل الهوية المتمثلة في "الهدف" و"القيمة" المتأصلة في النظام.

في المرة القادمة التي تقوم فيها بإعادة هيكلة كود قديم، تذكر هذا. أنت الآن تقوم بتجديد قطعة مهمة من سفينة ثيسيوس التاريخية العظيمة.
