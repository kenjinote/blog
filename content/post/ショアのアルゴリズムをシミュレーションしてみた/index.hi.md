...
यह इंगित करता है कि $N$ का $(a^{r/2} - 1)$ या $(a^{r/2} + 1)$ के साथ कोई सार्व भाजक (common divisor) है (बशर्ते कि शर्त $a^{r/2} \not\equiv -1 \pmod N$ संतुष्ट हो)। इसलिए, [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) ([Euclide](https://kenji.blog/p/euclid/)an algorithm) का उपयोग करके,
