...
आधुनिक इंटरनेट समाज में सुरक्षा का अधिकांश हिस्सा **सार्वजनिक कुंजी क्रिप्टोग्राफी ([Public Key](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) Cryptography)** (विशेष रूप से [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन) पर निर्भर करता है। जब हम ऑनलाइन शॉपिंग के दौरान क्रेडिट कार्ड की जानकारी भेजते हैं या अत्यधिक गोपनीय डेटा का आदान-प्रदान करते हैं, तो उस संचार की सामग्री को RSA एन्क्रिप्शन द्वारा दृढ़ता से सुरक्षित किया जाता है।

RSA एन्क्रिप्शन की सुरक्षा का आधार इस गणितीय तथ्य पर निर्भर करता है कि "**एक बहुत बड़े पूर्णांक का अभाज्य गुणनखंडन शास्त्रीय कंप्यूटरों (जैसे पीसी या सुपरकंप्यूटर) के लिए अत्यंत कठिन है ** ।" हालाँकि, 1994 में पीटर शोर (Peter Shor) द्वारा प्रकाशित "**शोर का एल्गोरिथ्म ([Shor's Algorithm](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/))**" इस आधार को पूरी तरह से पलट देता है। यह गणितीय रूप से सिद्ध हो चुका है कि यदि शोर के एल्गोरिथ्म को बड़े पैमाने के क्वांटम कंप्यूटर पर निष्पादित किया जाए, तो अभाज्य गुणनखंडन, जिसे शास्त्रीय कंप्यूटर पर हल करने में ब्रह्मांड की आयु से अधिक समय लग सकता है, उसे केवल कुछ मिनटों से लेकर कुछ घंटों में हल किया जा सकता है।
...
अभाज्य गुणनखंडन इतना कठिन क्यों है? भले ही हम "[सामान्य संख्या क्षेत्र चलनी](/hi/p/%E4%B8%80%E8%88%AC%E6%95%B0%E4%BD%93%E7%AF%A9%E6%B3%95gnfs%E3%81%AE%E7%9C%9F%E3%81%AE%E0%A4%97%E0%A4%A3%E0%A4%BF%E0%A4%A4%E7%9A%84%E6%A7%8B%E9%80%A0/) (General Number Field Sieve, GNFS)" का उपयोग करें, जिसे शास्त्रीय कंप्यूटरों के लिए सबसे अच्छा अभाज्य गुणनखंडन एल्गोरिथ्म माना जाता है, इसकी कम्प्यूटेशनल जटिलता उप-घातांकीय (sub-exponential) है।
...
यह इंगित करता है कि $N$ का $(a^{r/2} - 1)$ या $(a^{r/2} + 1)$ के साथ कोई सार्व भाजक (common divisor) है (बशर्ते कि शर्त $a^{r/2} \not\equiv -1 \pmod N$ संतुष्ट हो)। इसलिए, [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/hi/p/euclidean-algorithm/) ([Euclide](https://kenji.blog/hi/p/euclid/)an algorithm) का उपयोग करके,
...
हालाँकि एक सिमुलेटर पर $N=15$ का अभाज्य गुणनखंडन करना आसान था, वास्तविक दुनिया में उपयोग किए जा रहे [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)-2048 (617 अंकों की दशमलव संख्या) का अभाज्य गुणनखंडन करने के लिए वास्तविक क्वांटम कंप्यूटरों को अभी भी कई बाधाओं का सामना करना पड़ता है।
...
ऐसे "Q-Day (वह दिन जब क्वांटम कंप्यूटर एन्क्रिप्शन को तोड़ेंगे)" के आगमन की तैयारी में, अमेरिका के नेशनल इंस्टीट्यूट ऑफ स्टैंडर्ड्स एंड टेक्नोलॉजी (NIST) के नेतृत्व में, दुनिया भर के क्रिप्टोग्राफर **पोस्ट-क्वांटम क्रिप्टोग्राफी (Post-Quantum [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy, PQC)** के लिए मानक विकसित कर रहे हैं।
...
IT इन्फ्रास्ट्रक्चर का प्रबंधन करने वाले इंजीनियरों के लिए, मौजूदा [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) और इलिप्टिक कर्व क्रिप्टोग्राफी (elliptic curve cryptography) से PQC में सिस्टमिक बदलाव करना, अर्थात् "क्रिप्टो-एजिलिटी ([Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)-agility: एन्क्रिप्शन विधियों को तेज़ी से बदलने की क्षमता)" को सिस्टम में शामिल करना, भविष्य का एक बड़ा मिशन होगा।
