...
シミュレータ上で $N=15$ を素因数分解することは簡単にできましたが、実社会で使われているRSA-2048（617桁の10進数）を素因数分解するには、現実の[量子コンピュータ](https://kenji.blog/p/quantum-computing-shors-algorithm/)にはまだ数多くの壁が存在します。
