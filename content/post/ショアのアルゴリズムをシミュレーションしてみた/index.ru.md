...
Для инженеров, управляющих ИТ-инфраструктурой, одной из главных задач в будущем станет внедрение в системы «криптографической гибкости (crypto-agility: возможности быстрого переключения методов шифрования)» для перехода от существующего [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) и криптографии на эллиптических кривых к PQC.
