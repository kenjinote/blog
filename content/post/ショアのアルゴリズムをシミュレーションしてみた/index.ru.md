...
Хотя на симуляторе легко факторизовать $N=15$, для факторизации [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/)-2048 (617-значное десятичное число), используемого в реальном мире, перед реальными квантовыми компьютерами всё ещё стоит множество барьеров.
...
В преддверии такого «Q-Day» (дня, когда квантовые компьютеры взломают шифрование), криптографы по всему миру во главе с Национальным институтом стандартов и технологий США (NIST) работают над стандартизацией **постквантовой криптографии (Post-Quantum [Crypto](https://kenji.blog/ru/p/cryptocurrency-and-bitcoin/)graphy, PQC)**.
...
[Для инженеров](/ru/p/prompt-engineering-for-engineers/), управляющих ИТ-инфраструктурой, одной из главных задач в будущем станет внедрение в системы «криптографической гибкости (crypto-agility: возможности быстрого переключения методов шифрования)» для перехода от существующего [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) и криптографии на эллиптических кривых к PQC.
