...
В этой статье мы углубимся в философию, сильные стороны и **ограничения** доминирующего в современной разработке ПО **объектно-ориентированного программирования** (ООП), математически надежного **функционального программирования** (ФП), а также **дата-ориентированного программирования** (ДОП / DOD), ориентированного на производительность и разделение данных. Кроме того, мы объясним, как современные мощные языки (такие как Rust и TypeScript) **объединяют** их.
...
**Дата-ориентированное проектирование** (Data-Oriented Design) или **дата-ориентированное программирование** — это парадигма, родившаяся в разработке игр (особенно C++ и Rust) и впоследствии распространившаяся на корпоративную сферу (например, философия Clojure).
...
Сегодня бессмысленно выбирать "единственно правильный ответ" из этих вариантов. Современные языки программирования (Rust, TypeScript, Scala, Go и др.) берут **лучшее из всех парадигм**.
...
- Получение данных и управление кэшем — **дата-ориентированными** (нормализованное дерево состояний с помощью [Redux](https://kenji.blog/ru/p/state-management-history-future/) или Zustand).
