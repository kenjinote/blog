...
**Объектно-ориентированное** ([Object-Oriented](https://kenji.blog/ru/p/object-oriented-programming-oop-solid-principles/) Programming) программирование господствовало как абсолютный король разработки ПО с 1990-х по 2010-е годы. Такие языки, как [Java](https://kenji.blog/ru/p/programming-languages-history-paradigm-evolution/), C++ и C#, двигали эту парадигму, и интуитивно понятный подход моделирования реального мира получил широкое признание.
...
**Функциональное программирование** ([Functional Programming](https://kenji.blog/ru/p/functional-programming-concepts-pure-functions-monads/)) оказалось в центре внимания как антитеза сложности, вызванной "мутацией состояния" в ООП. Оно не только повлияло на такие языки, как Haskell, Scala и Clojure, но и оказало сильное влияние на современные JavaScript и TypeScript.
...
Сегодня бессмысленно выбирать "единственно правильный ответ" из этих вариантов. Современные языки программирования ([Rust](https://kenji.blog/ru/p/webassembly-wasm-current-future/), TypeScript, Scala, [Go](https://kenji.blog/ru/p/programming-languages-history-paradigm-evolution/) и др.) берут **лучшее из всех парадигм**.

### 5.1 [Rust](https://kenji.blog/ru/p/programming-languages-history-paradigm-evolution/) демонстрирует окончательное слияние
