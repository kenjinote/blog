...
इस लेख में, हम आधुनिक सॉफ्टवेयर विकास में मुख्यधारा बन चुके **ऑब्जेक्ट-ओरिएंटेड प्रोग्रामिंग** ([OOP](https://kenji.blog/hi/p/object-oriented-programming-oop-solid-principles/)), गणितीय मजबूती वाली **फंक्शनल प्रोग्रामिंग** (FP), और प्रदर्शन और डेटा के अलगाव पर केंद्रित **डेटा-ओरिएंटेड प्रोग्रामिंग** (DOP / DOD) के पीछे के दर्शन, उनकी शक्तियों और **सीमाओं** की गहराई से जांच करेंगे। इसके अलावा, हम यह भी स्पष्ट करेंगे कि कैसे आधुनिक शक्तिशाली भाषाएं (जैसे [Rust](https://kenji.blog/hi/p/webassembly-wasm-current-future/) और TypeScript) इन्हें **एकीकृत** कर रही हैं।

---

## 1. ऑब्जेक्ट-ओरिएंटेड प्रोग्रामिंग ([OOP](https://kenji.blog/hi/p/object-oriented-programming-oop-solid-principles/)) का उत्थान और पतन

**ऑब्जेक्ट-ओरिएंटेड** ([Object-Oriented](https://kenji.blog/hi/p/object-oriented-programming-oop-solid-principles/) Programming) ने 1990 से 2010 के दशक तक सॉफ्टवेयर विकास के निर्विवाद राजा के रूप में शासन किया। [Java](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/), C++, C# जैसी भाषाओं ने इस प्रतिमान का नेतृत्व किया, और वास्तविक दुनिया को मॉडल करने के इसके सहज दृष्टिकोण को व्यापक रूप से स्वीकार किया गया।
...
### 1.2 [OOP](https://kenji.blog/hi/p/object-oriented-programming-oop-solid-principles/) की सीमाएं और "केले और गोरिल्ला की समस्या"
...
[OOP](https://kenji.blog/hi/p/object-oriented-programming-oop-solid-principles/) की "स्थिति के म्यूटेशन" के कारण होने वाली जटिलता के विपरीत **फंक्शनल प्रोग्रामिंग** ([Functional Programming](https://kenji.blog/hi/p/functional-programming-concepts-pure-functions-monads/)) ने सुर्खियां बटोरीं। Haskell, Scala, Clojure जैसी भाषाओं के साथ-साथ, इसने आधुनिक JavaScript और TypeScript को भी गहराई से प्रभावित किया है।
...
DOP का सर्वोच्च लक्ष्य "डेटा और लॉजिक को अलग करना" है। जहां [OOP](https://kenji.blog/hi/p/object-oriented-programming-oop-solid-principles/) ने डेटा और लॉजिक को क्लास में मिला दिया, वहीं DOP उन्हें अलग कर देता है।
...
| :--- | :--- | :--- | :--- |
| **[OOP](https://kenji.blog/hi/p/object-oriented-programming-oop-solid-principles/)** | सहज मॉडलिंग, इनकैप्सुलेशन द्वारा छिपाना | इनहेरिटेंस की जटिलता, निहित स्थिति परिवर्तन से बग | GUI फ्रेमवर्क, व्यावसायिक डोमेन मॉडलिंग |
...
आज, इनमें से किसी एक को "एकमात्र सही उत्तर" के रूप में चुनना निरर्थक माना जाता है। आधुनिक प्रोग्रामिंग भाषाएं ([Rust](https://kenji.blog/hi/p/webassembly-wasm-current-future/), TypeScript, Scala, [Go](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) आदि) इन प्रतिमानों के **सर्वोत्तम पहलुओं** को अपना रही हैं।

### 5.1 [Rust](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) द्वारा प्रस्तुत अंतिम एकीकरण
