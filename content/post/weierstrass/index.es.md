...
```mermaid
timeline
    title "La trayectoria de la vida de Karl Weierstrass"
    1815 : "Nace en Ostenfelde"
    1834 : "Ingresa en la Universidad de Bonn como estudiante de derecho"
    1838 : "Abandona la Universidad de Bonn sin un título"
    1839 : "Ingresa en la Academia de Münster, estudia con Gudermann"
    1841 : "Comienza su carrera como profesor de gimnasio"
    1854 : "Publica un artículo en el 'Diario de Crelle' y gana fama repentina"
    1856 : "Nombrado profesor en la Universidad de Berlín"
    1897 : "Muere de neumonía en Berlín"
```
...
```mermaid
graph TD
    A["Principales logros de Weierstrass"] --> B["Rigorización del análisis"]
    A --> C["Descubrimiento de funciones patológicas"]
    A --> D["Construcción del análisis complejo"]
    A --> E["Contribuciones al cálculo de variaciones"]
    B --> F["Establecimiento de la definición épsilon-delta"]
    B --> G["Construcción de la teoría de números reales (Aritmetización del análisis)"]
    C --> H["Función de Weierstrass, continua pero no derivable"]
    D --> I["Definición de funciones analíticas por series de potencias"]
    D --> J["Sistematización de la teoría de funciones elípticas (función p)"]
    E --> K["Condición de Weierstrass para extremos"]
```
...
Al enterarse de su fama, excelentes estudiantes de toda Europa se reunieron a su alrededor. Sus discípulos y matemáticos influenciados por él incluyen a [Georg Cantor](https://kenji.blog/p/cantor/) (fundador de la teoría de conjuntos), Felix Klein, Ferdinand Georg Frobenius, Hermann Schwarz y muchos otros gigantes que luego dejaron sus nombres en la historia de las matemáticas.
...
El 19 de febrero de 1897, [Karl Weierstrass](https://kenji.blog/p/weierstrass/) falleció de neumonía en Berlín a la edad de 81 años.

## Conclusión

A través de su rigurosa lógica y su espíritu indomable, [Karl Weierstrass](https://kenji.blog/p/weierstrass/) hizo evolucionar las matemáticas hacia algo más sólido y hermoso. Superando los reveses de la juventud y un largo y solitario período de oscuridad como maestro rural para eventualmente llegar a la cima del mundo, su vida nos da un inmenso valor a quienes vivimos en la era moderna.
