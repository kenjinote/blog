...
```mermaid
timeline
    title "La trajectoire de vie de Karl Weierstrass"
    1815 : "Naissance à Ostenfelde"
    1834 : "Entre à l'Université de Bonn en tant qu'étudiant en droit"
    1838 : "Abandonne l'Université de Bonn sans diplôme"
    1839 : "Entre à l'Académie de Münster, étudie sous Gudermann"
    1841 : "Commence sa carrière comme professeur de gymnase"
    1854 : "Publie un article dans le 'Journal de Crelle' et gagne une soudaine renommée"
    1856 : "Nommé professeur à l'Université de Berlin"
    1897 : "Décès d'une pneumonie à Berlin"
```
...
```mermaid
graph TD
    A["Réalisations majeures de Weierstrass"] --> B["Rigueur de l'analyse"]
    A --> C["Découverte de fonctions pathologiques"]
    A --> D["Construction de l'analyse complexe"]
    A --> E["Contributions au calcul des variations"]
    B --> F["Établissement de la définition Epsilon-Delta"]
    B --> G["Construction de la théorie des nombres réels (Arithmétisation de l'analyse)"]
    C --> H["Fonction de Weierstrass continue mais non dérivable"]
    D --> I["Définition des fonctions analytiques par des séries entières"]
    D --> J["Systématisation de la théorie des fonctions elliptiques (fonction p)"]
    E --> K["Condition de Weierstrass pour les extrema"]
```
...
Le 19 février 1897, [Karl Weierstrass](https://kenji.blog/p/weierstrass/) est décédé d'une pneumonie à Berlin à l'âge de 81 ans.

## Conclusion

Grâce à sa logique rigoureuse et à son esprit indomptable, [Karl Weierstrass](https://kenji.blog/p/weierstrass/) a fait évoluer les mathématiques vers quelque chose de plus solide et de plus beau. Surmontant les échecs de jeunesse et une longue période de solitude et d'obscurité en tant qu'enseignant rural pour finalement s'élever au sommet du monde, sa vie donne un courage immense à ceux d'entre nous qui vivent à l'ère moderne.
