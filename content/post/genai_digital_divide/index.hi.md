...
अतीत के सॉफ़्टवेयर टूल मूल रूप से "निष्क्रिय उपकरण" थे। उपयोगकर्ता के स्पष्ट इनपुट के लिए निश्चित परिणाम वापस करना पारंपरिक सॉफ़्टवेयर की सीमा थी (जैसे: स्प्रेडशीट सॉफ़्टवेयर में सूत्र दर्ज करके गणना परिणाम प्राप्त करना)। हालाँकि, वर्तमान जेनरेटिव एआई, विशेष रूप से ट्रांसफॉर्मर ([Transformer](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/)) आर्किटेक्चर पर आधारित एलएलएम (GPT-4, Claude 3.5, Llama 3, आदि), "सक्रिय बुद्धि के अंश" के रूप में कार्य करते हैं।
...
OpenAI, Anthropic, और Google द्वारा प्रदान किए गए अत्याधुनिक फ्रंटियर मॉडल (जैसे GPT-4o, Claude 3.5 Sonnet) तक आमतौर पर API के माध्यम से पहुंचा जाता है। हालाँकि, यदि आप एक उन्नत स्वायत्त एजेंट (Agentic [Workflow](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/)) बनाते हैं जो एक दिन में हजारों API कॉल उत्पन्न करता है, तो लागत विस्फोटक रूप से बढ़ जाएगी।
