---
title: "Eiichi Shibusawa, o Pai do Capitalismo Japonês: Uma Vida Dedicada à Unificação da Moral e da Economia"
...
flowchart TD
    A["Eiichi Shibusawa"]
    A --> B["Modernização econômica e industrial"]
    A --> C["Contribuição social e educacional"]
    
    B --> B1["Primeiro Banco Nacional (Finanças)"]
    B --> B2["Oji Paper・Toyobo (Manufatura)"]
    B --> B3["Tokyo Gas・Nippon Yusen (Infraestrutura)"]
    
    C --> C1["Universidade Hitotsubashi・Universidade Feminina do Japão (Educação)"]
    C --> C2["Asilo de Tóquio (Bem-estar)"]
    C --> C3["Cruz Vermelha Japonesa (Saúde)"]
    
    B -. "Retorno dos lucros à sociedade" .-> C
    C -. "Produção de talentos excepcionais" .-> B
