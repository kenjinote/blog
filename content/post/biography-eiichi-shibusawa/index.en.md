---
title: "Eiichi Shibusawa, the Father of Japanese Capitalism: A Life Dedicated to the Unification of Morality and Economy"
...
flowchart TD
    A["Eiichi Shibusawa"]
    A --> B["Modernization of Economy and Industry"]
    A --> C["Contribution to Society and Education"]
    
    B --> B1["First National Bank (Finance)"]
    B --> B2["Oji Paper & Toyobo (Manufacturing)"]
    B --> B3["Tokyo Gas & Nippon Yusen (Infrastructure)"]
    
    C --> C1["Hitotsubashi University & Japan Women's University (Education)"]
    C --> C2["Tokyo Yoikuin (Welfare)"]
    C --> C3["Japanese Red Cross Society (Healthcare)"]
    
    B -. "Returning profits to society" .-> C
    C -. "Producing excellent talent" .-> B
