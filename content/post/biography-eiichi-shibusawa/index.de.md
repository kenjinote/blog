---
title: "Der Vater des japanischen Kapitalismus, Eiichi Shibusawa: Ein Leben mit dem Ziel der Einheit von Moral und Wirtschaft"
...
flowchart TD
    A["Eiichi Shibusawa"]
    A --> B["Modernisierung von Wirtschaft und Industrie"]
    A --> C["Beitrag zu Gesellschaft und Bildung"]
    
    B --> B1["Erste Nationalbank (Finanzen)"]
    B --> B2["Oji Paper・Toyobo (Produktion)"]
    B --> B3["Tokyo Gas・Nippon Yusen (Infrastruktur)"]
    
    C --> C1["Hitotsubashi-Universität・Japanische Frauenuniversität (Bildung)"]
    C --> C2["Tokioter Waisenhaus (Wohlfahrt)"]
    C --> C3["Japanisches Rotes Kreuz (Medizin)"]
    
    B -. "Rückgabe von Gewinnen an die Gesellschaft" .-> C
    C -. "Hervorbringung exzellenter Fachkräfte" .-> B
