---
title: "Bapak Kapitalisme Jepang Eiichi Shibusawa: Kehidupan yang Bertujuan pada Kesatuan Moral dan Ekonomi"
...
flowchart TD
    A["Eiichi Shibusawa"]
    A --> B["Modernisasi Ekonomi dan Industri"]
    A --> C["Kontribusi terhadap Masyarakat dan Pendidikan"]
    
    B --> B1["The First National Bank (Keuangan)"]
    B --> B2["Oji Paper・Toyobo (Manufaktur)"]
    B --> B3["Tokyo Gas・Nippon Yusen (Infrastruktur)"]
    
    C --> C1["Universitas Hitotsubashi・Universitas Wanita Jepang (Pendidikan)"]
    C --> C2["Panti Asuhan Tokyo (Kesejahteraan)"]
    C --> C3["Palang Merah Jepang (Medis)"]
    
    B -. "Pengembalian Keuntungan ke Masyarakat" .-> C
    C -. "Menghasilkan SDM Unggul" .-> B
