---
title: "Eiichi Shibusawa, padre del capitalismo japonés: Una vida dedicada a unir la moral y la economía"
...
flowchart TD
    A["Eiichi Shibusawa"]
    A --> B["Modernización de la economía y la industria"]
    A --> C["Contribución a la sociedad y la educación"]
    
    B --> B1["Primer Banco Nacional (Finanzas)"]
    B --> B2["Oji Paper, Toyobo (Manufactura)"]
    B --> B3["Tokyo Gas, NYK Line (Infraestructura)"]
    
    C --> C1["Universidad Hitotsubashi, Universidad de Mujeres de Japón (Educación)"]
    C --> C2["Asilo de Tokio (Bienestar)"]
    C --> C3["Cruz Roja Japonesa (Medicina)"]
    
    B -. "Retorno de beneficios a la sociedad" .-> C
    C -. "Producción de talento humano sobresaliente" .-> B
