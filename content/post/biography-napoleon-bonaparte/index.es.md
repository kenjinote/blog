---
title: "Napoleón Bonaparte: ¿Hijo de la Revolución o dictador?"
...
```mermaid
graph TD
    A["Ascenso militar (1793-1799)"] --> B["Nombramiento como Primer Cónsul (1799)"]
    B --> C["Impulso de las reformas internas"]
    C --> D["Fundación del Banco de Francia (1800)"]
    C --> E["Firma del Concordato (1801)"]
    C --> F["Creación de la Legión de Honor (1802)"]
    C --> G["Promulgación del Código Napoleónico (1804)"]
    B --> H["Transición al Imperio (1804)"]
    H --> I["Batalla de Austerlitz (1805)"]
    H --> J["Bloqueo Continental (1806)"]
```
...
```mermaid
graph LR
    N["Napoleón Bonaparte"] -->|Primera esposa| J["Josefina"]
    N -->|Segunda esposa| ML["María Luisa (Casa de Habsburgo)"]
    N -->|Archienemigo| W["Duque de Wellington (Gran Bretaña)"]
    N -->|Archienemigo| N2["Almirante Nelson (Gran Bretaña)"]
    N -->|Alianza y traición| A["Alejandro I (Rusia)"]
    N -->|Ministro de Asuntos Exteriores| T["Talleyrand"]
    N -->|Ministro de Policía| F["Fouché"]
```
