---
title: "Napoleon Bonaparte: Anak Revolusi atau Diktator?"
...
```mermaid
graph TD
    A["Kebangkitan Militer (1793-1799)"] --> B["Menjabat Konsul Pertama (1799)"]
    B --> C["Mendorong Reformasi Dalam Negeri"]
    C --> D["Pendirian Bank Prancis (1800)"]
    C --> E["Perjanjian Konkordat (1801)"]
    C --> F["Pembentukan Légion d'honneur (1802)"]
    C --> G["Pemberlakuan Kode Napoleon (1804)"]
    B --> H["Transisi ke Kekaisaran (1804)"]
    H --> I["Pertempuran Austerlitz (1805)"]
    H --> J["Sistem Kontinental (1806)"]
```
...
```mermaid
graph LR
    N["Napoleon Bonaparte"] -->|Istri Pertama| J["Joséphine"]
    N -->|Istri Kedua| ML["Marie Louise (Wangsa Habsburg)"]
    N -->|Musuh Bebuyutan| W["Adipati Wellington (Inggris)"]
    N -->|Musuh Bebuyutan| N2["Laksamana Nelson (Inggris)"]
    N -->|Aliansi dan Pengkhianatan| A["Alexander I (Rusia)"]
    N -->|Menteri Luar Negeri| T["Talleyrand"]
    N -->|Menteri Kepolisian| F["Fouché"]
```
