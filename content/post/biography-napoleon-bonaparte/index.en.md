---
title: "Napoleon Bonaparte: Child of the Revolution or Dictator?"
...
```mermaid
graph TD
    A["Military Rise (1793-1799)"] --> B["Became First Consul (1799)"]
    B --> C["Promotion of Domestic Reforms"]
    C --> D["Establishment of the Bank of France (1800)"]
    C --> E["Concordat of 1801"]
    C --> F["Creation of the Legion of Honour (1802)"]
    C --> G["Promulgation of the Napoleonic Code (1804)"]
    B --> H["Transition to Empire (1804)"]
    H --> I["Battle of Austerlitz (1805)"]
    H --> J["Continental System (1806)"]
```
...
```mermaid
graph LR
    N["Napoleon Bonaparte"] -->|First Wife| J["Joséphine"]
    N -->|Second Wife| ML["Marie Louise (House of Habsburg)"]
    N -->|Archrival| W["Duke of Wellington (Britain)"]
    N -->|Archrival| N2["Admiral Nelson (Britain)"]
    N -->|Alliance and Betrayal| A["Alexander I (Russia)"]
    N -->|Foreign Minister| T["Talleyrand"]
    N -->|Minister of Police| F["Fouché"]
```
