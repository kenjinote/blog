...
## [Go](https://kenji.blog/zh-cn/p/programming-languages-history-paradigm-evolution/)
...
## OCaml
由 INRIA（法国国家信息与自动化研究所）开发的一种函数式语言。

## Clojure
一种编程语言，是 LISP 系语言的一种方言

## Scheme
一种简单的编程语言

## Erlang
一种可以在计算机中用于通用目的的面向并发处理的开源软件（Open Source Software，简称：OSS）编程语言及执行环境。
...
## BASIC
一种过程式编程语言。名称是“beginners' all-purpose symbolic instruction code”的缩写。
...
非常类似于 [Java](https://kenji.blog/zh-cn/p/programming-languages-history-paradigm-evolution/) 的语言
