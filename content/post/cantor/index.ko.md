...
베를린 대학에서는 당시 수학계의 거두였던 **[카를 바이어슈트라스](https://kenji.blog/ko/p/weierstrass/)** ([Karl Weierstrass](https://kenji.blog/ko/p/weierstrass/))와 **레오폴트 크로네커** (Leopold Kronecker)의 지도를 받았습니다. 특히 크로네커는 나중에 칸토어의 가장 큰 논적이 됩니다.
...
칸토어는 이 가설의 증명에 말년의 많은 시간을 바쳤지만, 끝내 해결할 수는 없었습니다. 훗날 [쿠르트 괴델](https://kenji.blog/ko/p/godel/)과 폴 코언의 연구에 의해, 연속체 가설은 일반적인 집합론의 공리계(ZFC 공리계)로부터는 "증명도 반증도 할 수 없는" 독립된 명제임이 판명되어, 수학계에 다시 한번 큰 충격을 주었습니다.
