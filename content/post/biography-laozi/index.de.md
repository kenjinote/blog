---
title: "Laozi: Begründer des Daoismus, sein rätselhaftes Leben und die Tiefen des Daodejing"
...
```mermaid
graph TD
    Laozi["Laozi (Laotse)"] --> Daodejing["Daodejing (Tao Te King)"]
    Laozi -.-> Confucius["Legende des Dialogs mit Konfuzius"]
    Daodejing --> Dao["Dao (Der Weg) - Urgrund des Kosmos"]
    Daodejing --> Wuwei["Wu Wei & Ziran (Natürliches Handeln)"]
    Daodejing --> RouRuo["Das Weiche besiegt das Harte"]
    Dao --> Daoism["Daoistische Philosophie & Religion"]
    Wuwei --> Daoism
    RouRuo --> Daoism
    Daoism --> Zhuangzi["Zhuangzi - Weiterentwicklung des Denkens"]
    Daoism --> Religion["Religiöser Volksdaoismus"]
    Daoism --> Modern["Einfluss auf Minimalismus & moderne Psychologie"]
```
