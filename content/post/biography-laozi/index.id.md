...
description: "\"Laozi\" adalah seorang pemikir Tiongkok kuno yang diakui sebagai pendiri Taoisme."
---
...
```mermaid
graph TD
    Laozi["Laozi"] --> Daodejing["Daodejing (Tao Te Ching)"]
    Laozi -.-> Confucius["Legenda dialog dengan Konfusius"]
    Daodejing --> Dao["Dao (Jalan) - Sumber Alam Semesta"]
    Daodejing --> Wuwei["Wu Wei (Tindakan Alami Tanpa Paksaan)"]
    Daodejing --> RouRuo["Kelembutan Mengalahkan Kekerasan"]
    Dao --> Daoism["Filsafat Taoisme / Agama Tao"]
    Wuwei --> Daoism
    RouRuo --> Daoism
    Daoism --> Zhuangzi["Zhuangzi - Pengembangan Pemikiran"]
    Daoism --> Religion["Taoisme sebagai Agama Rakyat"]
    Daoism --> Modern["Pengaruh pada Minimalisme & Psikologi Modern"]
```
