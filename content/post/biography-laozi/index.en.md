...
description: "Laozi is revered as an ancient Chinese philosopher and the founder of Daoism. His enduring work, the Daodejing (Tao Te Ching), continues to be read across"
---
...
```mermaid
graph TD
    Laozi["Laozi"] --> Daodejing["Daodejing"]
    Laozi -.-> Confucius["Dialogue with Confucius (Legend)"]
    Daodejing --> Dao["Dao (The Way) - Primordial Source"]
    Daodejing --> Wuwei["Wu Wei (Effortless Action / Non-Action)"]
    Daodejing --> RouRuo["Softness Overcomes Hardness"]
    Dao --> Daoism["Daoist Philosophy & School (Daoism)"]
    Wuwei --> Daoism
    RouRuo --> Daoism
    Daoism --> Zhuangzi["Zhuangzi - Evolution of Thought"]
    Daoism --> Religion["Daoism as Folk Religion"]
    Daoism --> Modern["Impact on Modern Minimalism & Psychology"]
```
