---
title: "Laozi: O Fundador do Taoísmo, Sua Vida Enigmática e as Profundezas do Daodejing"
...
```mermaid
graph TD
    Laozi["Laozi (Lao-Tsé)"] --> Daodejing["Daodejing (Tao Te Ching)"]
    Laozi -.-> Confucius["Lenda do diálogo com Confúcio"]
    Daodejing --> Dao["Dao (O Caminho) - Princípio Cósmico"]
    Daodejing --> Wuwei["Wu Wei (Ação Espontânea / Não-Ação)"]
    Daodejing --> RouRuo["Flexibilidade vence a Rigidez"]
    Dao --> Daoism["Filosofia Taoísta / Taoísmo"]
    Wuwei --> Daoism
    RouRuo --> Daoism
    Daoism --> Zhuangzi["Zhuangzi - Expansão do Pensamento"]
    Daoism --> Religion["Taoísmo Religioso Popular"]
    Daoism --> Modern["Influência no Minimalismo e Psicologia Moderna"]
```
