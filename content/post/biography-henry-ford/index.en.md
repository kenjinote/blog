...
description: "Henry Ford (1863-1947) went beyond being just the founder of an automobile manufacturing company; he etched his name in history as the \"Automobile King\" wh"
---
...
```mermaid
flowchart TD
    A["Standardization of parts"] --> B["Subdivision and simplification of processes"]
    B --> C["Introduction of the moving assembly line"]
    C --> D["Dramatic reduction in manufacturing time"]
    D --> E["Cost reduction and price drop"]
    E --> F["Popularization of automobiles among the masses"]
```
...
```mermaid
flowchart LR
    W["High wages ($5 a day)"] --> P["Improvement of purchasing power"]
    P --> C["Mass consumption by the public"]
    C --> M["Maintenance and expansion of mass production"]
    M --> W
```
