---
title: "Raja Mobil Henry Ford: Awal Mula Masyarakat Konsumsi Massal dan Inovasi 'Sistem Produksi Ford'"
...
```mermaid
flowchart TD
    A["Standardisasi suku cadang"] --> B["Subdivisi dan penyederhanaan proses"]
    B --> C["Pengenalan jalur perakitan berjalan"]
    C --> D["Pengurangan waktu manufaktur yang dramatis"]
    D --> E["Pengurangan biaya dan penurunan harga"]
    E --> F["Mempopulerkan mobil di kalangan massa"]
```
...
```mermaid
flowchart LR
    W["Upah tinggi ($5 sehari)"] --> P["Peningkatan daya beli"]
    P --> C["Konsumsi massal oleh publik"]
    C --> M["Pemeliharaan dan perluasan produksi massal"]
    M --> W
```
