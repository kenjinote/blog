...
description: "Henry Ford (1863-1947) fue más allá de ser solo el fundador de una empresa de fabricación de automóviles; grabó su nombre en la historia como el \"Rey del A"
---
...
```mermaid
flowchart TD
    A["Estandarización de piezas"] --> B["Subdivisión y simplificación de procesos"]
    B --> C["Introducción de la línea de ensamblaje móvil"]
    C --> D["Reducción dramática en el tiempo de fabricación"]
    D --> E["Reducción de costos y caída de precios"]
    E --> F["Popularización de los automóviles entre las masas"]
```
...
```mermaid
flowchart LR
    W["Altos salarios ($5 al día)"] --> P["Mejora del poder adquisitivo"]
    P --> C["Consumo masivo por parte del público"]
    C --> M["Mantenimiento y expansión de la producción masiva"]
    M --> W
```
