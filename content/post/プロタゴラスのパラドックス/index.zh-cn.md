...
普罗泰戈拉悖论与“说谎者悖论（『这句话是谎言』）”和“[罗素悖论](/zh-cn/p/russells-paradox/)”具有相同的 **自我指涉结构** 。某个命题（审判的结论）影响了决定其自身真伪的条件（协议的达成）。

这种类型的悖论，与现代计算机科学中的“[停机问题](/zh-cn/p/halting-problem/)（无法编写出一个程序来判断另一个程序是否会停止）”，以及[哥德尔不完备定理](https://kenji.blog/zh-cn/p/godels-incompleteness-theorems/)等揭示逻辑与计算根本极限的问题有着深刻的联系。
