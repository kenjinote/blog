...
이러한 종류의 역설은 현대 컴퓨터 과학의 '정지 문제(어떤 프로그램이 정지할지 여부를 판정하는 프로그램은 만들 수 없다)'나 [괴델의 불완전성 정리](https://kenji.blog/ko/p/godels-incompleteness-theorems/) 등, 논리와 계산의 근본적인 한계를 보여주는 문제들과 깊은 관련이 있습니다.
