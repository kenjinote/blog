...
Парадокс Протагора имеет ту же **структуру самореференции**, что и «Парадокс лжеца» («Это утверждение ложно») и «[Парадокс Рассела](/ru/p/russells-paradox/)». Определенное утверждение (решение суда) влияет на условие, которое определяет его собственную истинность или ложность (выполнение договора).

Такого рода парадоксы глубоко связаны с проблемами, демонстрирующими фундаментальные пределы логики и вычислений, такими как «[Проблема остановки](/ru/p/halting-problem/)» в современной информатике (невозможно создать программу, которая бы определяла, остановится ли любая другая программа) и теорема Гёделя о неполноте.
