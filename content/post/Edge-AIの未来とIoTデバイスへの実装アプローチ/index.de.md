...
**1. Betrieb von LLMs ([Large Language Models](https://kenji.blog/de/p/large-language-models-llm-transformer-prompt-engineering/)) an der Edge**:
Das wichtigste Thema der letzten Jahre ist der Versuch der "Edge [LLM](https://kenji.blog/de/p/large-language-models-llm-transformer-prompt-engineering/)", generative KI und LLMs an der Edge auszuführen. Während es unmöglich ist, ein Modell mit Dutzenden Milliarden Parametern direkt auf der Edge zu platzieren, bricht dank Optimierungs-Frameworks wie llama.cpp, extremer Quantisierung auf 4 Bit/2 Bit (AWQ, GPTQ usw.) und sogar dem Erscheinen kompakter, aber leistungsstarker SLMs (Small Language Models) wie Microsofts Phi-3 allmählich das Zeitalter an, in dem die Verarbeitung natürlicher Sprache selbst auf Smartphones und Raspberry Pi [offline](https://kenji.blog/de/p/pwa-progressive-web-apps-service-worker/) abgeschlossen werden kann.
