...
- **[NVIDIA](/hi/p/history-of-nvidia/) Jetson सीरीज़**:
  Jetson Nano, Xavier, और Orin सीरीज़ SoC हैं जो ARM CPU और [NVIDIA](/hi/p/history-of-nvidia/) के शक्तिशाली GPU कोर को एकीकृत करते हैं। चूंकि CUDA इकोसिस्टम का सीधा उपयोग किया जा सकता है, इसलिए क्लाउड में प्रशिक्षित PyTorch या TensorFlow मॉडल को TensorRT के माध्यम से एज पर तैनात (deploy) करना बेहद आसान है।
...
हाल के वर्षों में सबसे बड़ा विषय जनरेटिव एआई (Generative AI) या [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) को एज पर चलाने, यानी "Edge [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/)" का प्रयास है। दसियों अरबों मापदंडों (parameters) वाले मॉडल को सीधे एज पर डालना असंभव है, लेकिन llama.cpp जैसे ऑप्टिमाइज़ेशन फ्रेमवर्क, 4-बिट/2-बिट जैसे चरम क्वांटिज़ेशन (AWQ, GPTQ आदि), और माइक्रोसॉफ्ट के Phi-3 जैसे छोटे लेकिन उच्च प्रदर्शन वाले SLM (Small Language Models) के आने से, एक ऐसा युग आ रहा है जहाँ स्मार्टफोन और Raspberry Pi पर भी प्राकृतिक भाषा प्रसंस्करण (NLP) ऑफ़लाइन रूप से पूरा हो सकेगा।
