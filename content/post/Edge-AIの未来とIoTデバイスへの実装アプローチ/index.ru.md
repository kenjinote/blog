...
**1. Работа [LLM](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/) ([больших языковых моделей](/ru/p/large-language-models-llm-transformer-prompt-engineering/)) на периферии**:
...
Более того, технологические рубежи стремительно расширяются за счет подходов распределенного обучения, таких как Federated Learning, и работы генеративного ИИ (SLM) на периферии. [Для инженеров](/ru/p/prompt-engineering-for-engineers/) и архитекторов поиск ответа на вопрос: «Как добиться максимального интеллекта на периферии с ограниченными ресурсами», не полагаясь исключительно на гигантские ресурсы облака, станет самой сложной и захватывающей задачей будущего.
