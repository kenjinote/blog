...
3. **عرض النطاق الترددي للشبكة والتكلفة**: إذا كانت ملايين كاميرات [إنترنت الأشياء](/ar/p/technology-iot/) ترسل باستمرار تدفقات فيديو بدقة 4K إلى السحابة، فسيتم استنفاد عرض النطاق الترددي للشبكة، وستصبح تكاليف نقل البيانات وتكاليف التخزين السحابي باهظة.
...
في التعلم الآلي التقليدي، يتم تجميع البيانات الأولية (مثل الفيديو والصوت والسجلات وما إلى ذلك) من جميع أجهزة [إنترنت الأشياء](/ar/p/technology-iot/) في السحابة وتدريب النموذج دفعة واحدة. ومع ذلك، فإن تجميع البيانات من الهواتف الذكية الشخصية والأجهزة الطبية في السحابة ينطوي على مخاطر خصوصية خطيرة.
...
تطور الذكاء الاصطناعي الطرفي من مجرد كونه "تقنية مكملة للسحابة" إلى تقنية أساسية تحدد بنية أنظمة [إنترنت الأشياء](/ar/p/technology-iot/) (IoT) بأكملها. إن الفوائد التي يجلبها الذكاء الاصطناعي الطرفي، مثل تقليل زمن انتقال الاستدلال إلى الحد الأدنى، وضمان حماية الخصوصية، والتقليل الكبير في عرض النطاق الترددي للاتصالات وتكاليف السحابة، لا تقدر بثمن.
...
علاوة على ذلك، تتوسع آفاق التكنولوجيا بسرعة، مثل نُهج التعلم الموزع مثل التعلم الموحد (Federated Learning) وتشغيل الذكاء الاصطناعي التوليدي (SLM) على الحافة (Edge). بالنسبة [للمهندسين](/ar/p/prompt-engineering-for-engineers/) والمعماريين، سيكون السعي وراء "كيفية استخلاص أقصى قدر من الذكاء في الموارد الطرفية المحدودة"، بدلاً من الاعتماد فقط على موارد السحابة الضخمة، التحدي الأكثر إثارة للإعجاب في المستقبل.

في طليعة [إنترنت الأشياء](/ar/p/technology-iot/) حيث يندمج العالم المادي والعالم الرقمي، سيكون الذكاء الاصطناعي الطرفي بلا شك الجهاز العصبي المركزي الذي يقود المستقبل.
