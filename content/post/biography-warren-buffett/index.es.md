---
title: "Warren Buffett, el «Oráculo de Omaha»: el inversor que encarna la filosofía de la inversión a largo plazo y el interés compuesto"
...
description: "Conocido como el inversor más exitoso del mundo, Warren Buffett, apodado el «Oráculo de Omaha», no se limita a ser un mero multimillonario que ha amasado u"
---
...
flowchart TD
    ...
    WB --> CM["Charlie Munger (Amigo de siempre y vicepresidente)"]
    WB --> BH["Berkshire Hathaway (CEO)"]
    WB --> GP["The Giving Pledge (Filantropía)"]
    GP --> BG2["Bill Gates (Actividad conjunta)"]
    BH --> GEICO["GEICO (Seguros y fuente de float)"]
    BH --> AAPL["Apple (Inversión principal)"]
    BG --> VI["Filosofía de la inversión en valor"]
    VI --> MOS["Margen de seguridad (Margin of Safety)"]
    CM --> MOAT["Foso económico (Economic Moat)"]
```
