---
title: "Warren Buffett, o 'Oráculo de Omaha': O Investidor que Personifica a Filosofia do Investimento a Longo Prazo e dos Juros Compostos"
...
flowchart TD
    ...
    WB --> CM["Charlie Munger (Parceiro de Longa Data e Vice-Presidente)"]
    WB --> BH["Berkshire Hathaway (CEO)"]
    WB --> GP["The Giving Pledge (Filantropia)"]
    GP --> BG2["Bill Gates (Parceiro de Atividades)"]
    BH --> GEICO["GEICO (Seguros e Fonte de Float)"]
    BH --> AAPL["Apple (Principal Investimento)"]
    BG --> VI["Filosofia do Investimento em Valor"]
    VI --> MOS["Margem de Segurança (Margin of Safety)"]
    CM --> MOAT["Economic Moat (Fosso Econômico)"]
```
