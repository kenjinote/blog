---
title: "L'Oracle d'Omaha, Warren Buffett : L'investisseur qui incarne la philosophie de l'investissement à long terme et des intérêts composés"
...
flowchart TD
    ...
    WB --> CM["Charlie Munger (Ami et vice-président)"]
    WB --> BH["Berkshire Hathaway (PDG)"]
    WB --> GP["The Giving Pledge (Philanthropie)"]
    GP --> BG2["Bill Gates (Partenaire d'activités)"]
    BH --> GEICO["GEICO (Assurance / Source de float)"]
    BH --> AAPL["Apple (Investissement principal)"]
    BG --> Philosophie["Philosophie de l'investissement dans la valeur"]
    Philosophie --> MOS["Marge de sécurité (Margin of Safety)"]
    CM --> MOAT["Fossé économique (Economic Moat)"]
```
