...
description: "Warren Buffett, dikenal sebagai investor paling sukses di dunia. Dengan julukan \"Sage of Omaha\", ia tidak hanya sekadar miliarder yang mengumpulkan kekayaa"
---
...
flowchart TD
    ...
    WB --> CM["Charlie Munger (Rekan & Wakil Ketua)"]
    WB --> BH["Berkshire Hathaway (CEO)"]
    WB --> GP["The Giving Pledge (Filantropi)"]
    GP --> BG2["Bill Gates (Rekan Aktivitas)"]
    BH --> GEICO["GEICO (Asuransi / Sumber Float)"]
    BH --> AAPL["Apple (Investasi Utama)"]
    BG --> VI["Filosofi Value Investing"]
    VI --> MOS["Margin Keamanan (Margin of Safety)"]
    CM --> MOAT["Parit Ekonomi (Economic Moat)"]
```
