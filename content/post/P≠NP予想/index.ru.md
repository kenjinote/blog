---
title: 'Что такое гипотеза P≠NP? Неразрешенная проблема в теории вычислительной сложности и разница между классами P и NP понятным языком'
slug: "P≠NP予想"
...
description: 'Объясняется суть величайшей нерешенной проблемы в информатике «гипотеза P≠NP» с точки зрения детерминированных машин Тьюринга, с понятным описанием разницы между «классом P», который можно решить за полиномиальное время, и «классом NP», в котором правильность решения можно проверить за полиномиальное время.'
---
