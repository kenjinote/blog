...
- **レオンハルト・[オイラー](https://kenji.blog/p/euler/)** ：18世紀最大の数学者[オイラー](https://kenji.blog/p/euler/)は、 $n = 3$ および $n = 4$ の場合の証明に成功しました（ $n = 4$ は[フェルマー](https://kenji.blog/p/fermat/)自身が証明していたとも言われます）。
