...
However, proving this simple assertion was a journey of unimaginable difficulty for humanity. In this article, we will trace the history of how **[Fermat's Last Theorem](https://kenji.blog/en/p/fermats-last-theorem/)** was born, what kind of mathematicians challenged it, and how it was finally proven.
...
Entering the 20th century, [Fermat's Last Theorem](https://kenji.blog/en/p/fermats-last-theorem/) became connected to a completely seemingly unrelated field of mathematics. That was the **Taniyama-Shimura Conjecture**.

In 1955, [Yutaka Taniyama](https://kenji.blog/en/p/taniyama-yutaka/) and [Goro Shimura](https://kenji.blog/en/p/shimura-goro/), two young Japanese mathematicians, made a bold conjecture: "All elliptic curves are modular."
...
Then, in the 1980s, Gerhard Frey suggested that if a counterexample to [Fermat's Last Theorem](https://kenji.blog/en/p/fermats-last-theorem/) existed (that is, if there were natural numbers satisfying $A^n + B^n = C^n$), the elliptic curve created from it, called the **Frey curve**, would have abnormal properties and **could not possibly be modular**. Later, Ken Ribet rigorously proved this idea of Frey's.

As a result, if the **Taniyama-Shimura Conjecture** could be proven, **[Fermat's Last Theorem](https://kenji.blog/en/p/fermats-last-theorem/)** would automatically be proven as well.
...
## 5. The Glory of [Andrew Wiles](https://kenji.blog/en/p/wiles/)

It was **[Andrew Wiles](https://kenji.blog/en/p/wiles/)**, a British-born mathematician, who was strongly inspired by this dramatic development. He is a person who encountered a book on [Fermat's Last Theorem](https://kenji.blog/en/p/fermats-last-theorem/) in a library when he was 10 years old and aspired to become a mathematician.
...
The proof of **[Fermat's Last Theorem](https://kenji.blog/en/p/fermats-last-theorem/)** has a meaning beyond simply solving an old problem. The numerous mathematical methods and theories developed in the process (for example, Iwasawa theory and the Kolyvagin-Flach method) now function as powerful tools in modern mathematics.

A mystery left in the margin of a book by a single amateur mathematician became a guiding star for mathematicians over centuries and pushed the limits of human intellect. [Fermat's Last Theorem](https://kenji.blog/en/p/fermats-last-theorem/) can be said to be an eternal monument symbolizing the greatness of the human spirit that continues to challenge the impossible.
