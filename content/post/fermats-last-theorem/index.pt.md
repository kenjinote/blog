...
Na história da matemática, existe um problema que fascinou e atormentou a maior quantidade de pessoas. Esse é **[O Último Teorema de Fermat](https://kenji.blog/p/fermats-last-theorem/)** ([Fermat's Last Theorem](https://kenji.blog/p/fermats-last-theorem/)). De uma breve nota deixada na margem de seu livro favorito, "Arithmetica" de [Diofanto](https://kenji.blog/p/diophantus/), pelo juiz e matemático amador francês do século 17, [Pierre de Fermat](https://kenji.blog/p/fermat/), começou um drama matemático épico que durou 360 anos.
...
No entanto, provar esta afirmação simples foi um caminho incrivelmente difícil para a humanidade. Neste artigo, rastrearemos a história de como **[O Último Teorema de Fermat](https://kenji.blog/p/fermats-last-theorem/)** nasceu, que tipos de matemáticos o desafiaram e, finalmente, como ele foi provado.
...
- **[Leonhard Euler](https://kenji.blog/p/euler/)**: Euler, o maior matemático do século 18, conseguiu provar para os casos em que $n = 3$ e $n = 4$ (diz-se que o próprio Fermat havia provado para $n = 4$).
...
- **[Ernst Kummer](https://kenji.blog/p/kummer/)**: Em meados do século 19, Kummer introduziu o conceito de "números ideais" e provou o teorema para muitos números primos chamados de primos regulares.
...
Em 1955, os jovens matemáticos japoneses [Yutaka Taniyama](https://kenji.blog/p/taniyama-yutaka/) e [Goro Shimura](https://kenji.blog/p/shimura-goro/) fizeram a ousada conjectura de que "todas as curvas elípticas são modulares".
...
## 5. A glória de [Andrew Wiles](https://kenji.blog/p/wiles/)

Quem se sentiu fortemente estimulado por esse desenvolvimento dramático foi o matemático britânico **[Andrew Wiles](https://kenji.blog/p/wiles/)**. Ele encontrou um livro sobre o Último Teorema de Fermat na biblioteca quando tinha cerca de 10 anos de idade e decidiu se tornar um matemático.
