...
Dans l'histoire des mathématiques, il y a un problème qui a fasciné et tourmenté le plus grand nombre de personnes. Il s'agit du **dernier théorème de Fermat** ([Fermat's Last Theorem](https://kenji.blog/fr/p/fermats-last-theorem/)). C'est à partir d'une courte note laissée dans la marge de son livre de chevet, l'« Arithmétique » de [Diophante](https://kenji.blog/fr/p/diophantus/), par [Pierre de Fermat](https://kenji.blog/fr/p/fermat/), juge français du XVIIe siècle et mathématicien amateur, qu'a commencé un drame mathématique épique qui a duré 360 ans.
...
Cependant, prouver cette simple affirmation fut un parcours d'une difficulté inimaginable pour l'humanité. Dans cet article, nous retracerons l'histoire de la façon dont ce **dernier théorème de Fermat** est né, quels mathématiciens l'ont défié, et enfin comment il a été prouvé.
...
- **[Leonhard Euler](https://kenji.blog/fr/p/euler/)** : Le plus grand mathématicien du XVIIIe siècle, Euler, a réussi à le prouver pour les cas $n = 3$ et $n = 4$ (on dit que Fermat lui-même l'avait prouvé pour $n = 4$).
...
- **[Ernst Kummer](https://kenji.blog/fr/p/kummer/)** : Au milieu du XIXe siècle, Kummer a introduit le concept de « nombre idéal » et a prouvé le théorème pour de nombreux nombres premiers appelés nombres premiers réguliers.
...
Celui qui a été fortement stimulé par ce développement dramatique était le mathématicien d'origine britannique **[Andrew Wiles](https://kenji.blog/fr/p/wiles/)**. Il avait découvert un livre sur le dernier théorème de Fermat dans une bibliothèque à l'âge de 10 ans et avait alors décidé de devenir mathématicien.
