...
在數學的歷史上，有一個問題讓無數人為之著迷，同時也讓他們備受折磨。那就是 **費馬最後定理** （[Fermat's Last Theorem](https://kenji.blog/p/fermats-last-theorem/)）。17世紀的法國法官、業餘數學家皮埃爾·德·費馬（Pierre de Fermat），在他愛不釋手的丟番圖《算術》一書的空白處留下了短短的筆記，從此展開了長達360年波瀾壯闊的數學史詩。
...
1955年，日本年輕的數學家谷山豐與[志村五郎](https://kenji.blog/p/shimura-goro/)，提出了一個大膽的猜想：「所有的橢圓曲線都是模形式（Modular）的」。
