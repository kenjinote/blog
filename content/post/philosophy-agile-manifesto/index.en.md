...
```mermaid
graph TD
    A["Traditional Method (Waterfall)"]
    B["Strict planning and phase separation"]
    C["Enormous cost of responding to change"]
    D["Agile Manifesto (2001)"]
    E["Values individuals and interactions"]
    F["Values working software"]
    G["Values customer collaboration"]
    H["Values responding to change"]

    A -- "Characteristics" --> B
    B -- "Results" --> C
    C -- "Demand for Paradigm Shift" --> D
    D -- "Value 1" --> E
    D -- "Value 2" --> F
    D -- "Value 3" --> G
    D -- "Value 4" --> H
...
```mermaid
graph LR
    A["Misunderstandings of Agile"]
    B["No plan/documentation needed"]
    C["Scrum = Agile"]
    D["Mere speed up"]

    E["Truths of Agile"]
    F["Continuous planning and moderate documentation"]
    G["Practice of mindset and philosophy"]
    H["Adaptability to change and value maximization"]

    A -- "Misunderstanding 1" --> B
    A -- "Misunderstanding 2" --> C
    A -- "Misunderstanding 3" --> D
