---
title: 'Как интегрировать KaTeX в Hugo и отображать красивые математические формулы в стиле LaTeX'
slug: "hugoでKaTeX(LaTeX風Математическая формула表示)を有効にする方法"
...
description: 'Описывается процедура интеграции быстрой библиотеки для рендеринга формул «KaTeX» в генератор статических сайтов Hugo. Вы легко узнаете, как включить отображение красивых математических формул в стиле LaTeX в вашем блоге, от создания файла math.html до настройки его загрузки в заголовке.'
---
# Что такое KaTeX?
