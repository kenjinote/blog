...
عند مناقشة الانقسام الاجتماعي، لا مفر من البدء بتحليل بنية المجتمع باستخدام "نظرية الشبكات" ([Graph Theory](https://kenji.blog/ar/p/graph-theory-dijkstra-a-star/)). يمكن نمذجة العلاقات الإنسانية على وسائل التواصل الاجتماعي كـ "مخطط بياني" ([Graph](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) ضخم، حيث يمثل المستخدمون "عقدًا" (Nodes)، وتمثل المتابعة والتفاعل بين المستخدمين "حواف" أو روابط (Edges).
...
البرمجيات هي القانون، والبنية هي السياسة. سطر الكود الذي نكتبه، ونقطة نهاية واجهة برمجة التطبيقات ([API](/ar/p/chatgpt-gemini-claude-api-comparison/) Endpoint) التي نحددها، ومخطط قاعدة البيانات الذي نصممه، كل ذلك يشكل الإدراك المعرفي لملايين بل لمليارات المستخدمين، ويمكن أن يسرع الانقسام الاجتماعي، أو قد يبني جسورًا تشجع على الحوار.
