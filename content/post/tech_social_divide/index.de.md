...
Wenn man über gesellschaftliche Spaltung diskutiert, kommt man um die Strukturanalyse von Gemeinschaften mithilfe der "Netzwerktheorie" ([Graph Theory](https://kenji.blog/de/p/graph-theory-dijkstra-a-star/)) nicht herum. Menschliche Beziehungen in sozialen Medien lassen sich als riesiger [Graph](https://kenji.blog/de/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) modellieren, bei dem die Nutzer als "Knoten" (Nodes) und die Verbindungen oder Interaktionen zwischen ihnen als "Kanten" (Edges) fungieren.
