...
При обсуждении социального раскола невозможно обойти стороной структурный анализ сообществ с использованием «теории сетей» ([Graph Theory](https://kenji.blog/ru/p/graph-theory-dijkstra-a-star/)). Человеческие отношения в социальных сетях можно смоделировать как гигантский граф, где пользователи являются «узлами» (вершинами), а подписки или взаимодействия между ними — «ребрами» (связями).
