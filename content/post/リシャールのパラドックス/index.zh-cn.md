...
法国数学家朱尔·理查德（Jules Richard）在1905年发表的“理查德悖论”，可以说是之前介绍的“[贝里悖论](/zh-cn/p/berry-paradox/)”的亲戚。然而，它更具数学性，包含了如同窥视无限彼岸般的深刻矛盾。
...
产生这个悖论的原因，和[贝里悖论](/zh-cn/p/berry-paradox/)一样，都在于混淆了“语言的层级”。
...
1931年，为这个问题画上最终句号的，是年仅25岁的天才数学家[库尔特·哥德尔](https://kenji.blog/zh-cn/p/godel/)。
哥德尔运用 **“严谨的数学公式（哥德尔数）”** ，完美地翻译并重现了理查德利用“语言的模糊性”引发的这个悖论结构。

其结果导出的，就是那著名的 **“[哥德尔不完备定理](https://kenji.blog/zh-cn/p/godels-incompleteness-theorems/)”** 。
