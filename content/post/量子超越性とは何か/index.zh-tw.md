...
為了理解量子超越性，首先必須了解量子計算的數學基礎，以及其在計算[複雜度](/zh-tw/p/time-space-complexity-big-o-notation-examples/)理論中的定位。
...
$$
p_L \approx \[Lambda](https://kenji.blog/zh-tw/p/serverless-architecture-aws-lambda-cold-start/) \left( \frac{p}{p_{th}} \right)^{\frac{d+1}{2}}
$$
