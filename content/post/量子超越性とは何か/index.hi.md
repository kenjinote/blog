...
$$
p_L \approx \[Lambda](https://kenji.blog/hi/p/serverless-architecture-aws-lambda-cold-start/) \left( \frac{p}{p_{th}} \right)^{\frac{d+1}{2}}
$$
...
मैजिक स्टेट डिस्टिलेशन (Magic [State](https://kenji.blog/hi/p/iac-infrastructure-as-code-terraform/) Distillation) जैसे नॉन-क्लिफोर्ड गेट्स को फॉल्ट-टोलरेंट तरीके से लागू करने के लिए प्रोटोकॉल का कार्यान्वयन भी भविष्य में एक बड़ी तकनीकी बाधा होगी। एक व्यावहारिक शोर (Shor) के एल्गोरिथ्म को निष्पादित करने और 2048-बिट आरएसए ([RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)) एन्क्रिप्शन को क्रैक करने के लिए, $10^{-8}$ या उससे कम त्रुटि दर वाले हजारों लॉजिकल क्यूबिट्स और लाखों से करोड़ों भौतिक क्यूबिट्स की आवश्यकता होगी, और यह सफर अभी लंबा है।
