---
title: 'تنفيذ منخل حقل الأعداد العام (GNFS) في C++ | آليات خوارزمية فك تشفير RSA'
...
description: 'شرح شامل مع كود تنفيذ C++ لآلية ''منخل حقل الأعداد العام (GNFS)''، وهي خوارزمية تحليل العوامل الأولية المستخدمة في فك تشفير RSA. محتوى يجب رؤيته لمحبي البرمجة، حيث يقترب من أعماق نظرية الأعداد الجبرية والمنطق الحسابي باستخدام مكتبة Boost.'
---

# "تشريح كامل" فهم أقوى خوارزمية لتحليل التشفير "GNFS" عن طريق تنفيذها بلغة C++

يدعم "تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)" أسس الإنترنت الحديث. يعتمد أمانه على الاعتقاد الرياضي بأنه "من المستحيل عمليا على أجهزة الكمبيوتر الحالية تحليل عدد مركب عملاق إلى عوامله الأولية".
...
هنا، إذا استخدمنا [خوارزمية [إقليدس](https://kenji.blog/ar/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) لحساب ** $\gcd(X-Y, N)$ ** ، فيمكننا بسهولة إيجاد العامل الأولي لـ $N$.
...
في مصفوفة المرحلة 4، تتم إضافة عدد قليل من أعمدة البقايا التربيعية (رمز [Legendre](https://kenji.blog/ar/p/legendre/)) سراً لمثاليات أولية خاصة. بفضل ذلك، تتجاوز المجموعة المكتشفة $S$ العوائق باحتمال كبير جدا، وتشكل بنجاح "مربع عنصر حقيقي $\gamma^2$".
...
كل ما تبقى هو حساب $\gcd(X-Y, N)$. في 0.001 ثانية فقط، عندما تتم طباعة العامل غير البديهي على الشاشة، ينهار تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) الذي لا يُقهر تماما.
