...
현대 인터넷의 근간을 지탱하는 「[RSA](https://kenji.blog/ko/p/modern-cryptography-public-key-hash-signature/) 암호」. 그 견고함은 「거대한 합성수를 소인수분해하는 것은 현재의 컴퓨터로는 사실상 불가능하다」는 수학적 신념에 의존하고 있습니다.
...
여기서 [[유클리드](https://kenji.blog/ko/p/euclid/) 호제법](https://kenji.blog/p/euclidean-algorithm/)을 사용하여 **$\gcd(X-Y, N)$** 을 계산하면, $N$의 소인수를 아주 쉽게 구할 수 있습니다.
...
남은 것은 $\gcd(X-Y, N)$을 계산하는 것뿐입니다. 0.001초의 처리가 순식간에 지나가고 비자명한 인수가 화면에 인쇄되는 순간, 난공불락을 자랑하던 [RSA](https://kenji.blog/ko/p/modern-cryptography-public-key-hash-signature/) 암호는 완전히 붕괴됩니다.
