...
Aquí, si usamos el algoritmo de [Euclides](https://kenji.blog/p/euclid/) para calcular **$\gcd(X-Y, N)$**, podemos encontrar los factores primos de $N$ con mucha facilidad.
