...
Here, if we compute **$\gcd(X-Y, N)$** using the [[Euclid](https://kenji.blog/p/euclid/)e](https://kenji.blog/p/euclid/)an algorithm, the prime factors of $N$ can be easily found.
