...
Di sini, jika kita menggunakan [Algoritma Euclidean](https://kenji.blog/p/euclidean-algorithm/) untuk menghitung ** $\gcd(X-Y, N)$ **, kita dapat dengan mudah menemukan faktor prima dari $N$.
