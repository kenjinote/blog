...
现在，我们在中间的隔板上设置一扇“极小的门”。并安排一个可以控制这扇门开闭的智能生命体，即<strong>“恶魔”</strong>。

恶魔根据以下规则来开关门：
- 发现从右室（A）飞向左室（B）的<strong>“快分子”</strong>时，打开门让其进入B。
- 发现从右室（A）飞向左室（B）的<strong>“慢分子”</strong>时，关上门将其留在A。
- 发现从左室（B）飞向右室（A）的<strong>“慢分子”</strong>时，打开门让其进入A。
- 发现从左室（B）飞向右室（A）的<strong>“快分子”</strong>时，关上门将其留在B。
...
这样一来，第二定律岂不是再次被打破了？但是兰道尔在完全不同的地方找到了熵产生的原因。那就是<strong>“信息的擦除”</strong>。
