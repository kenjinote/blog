...
Dans l'histoire des mathématiques, certaines figures ont joué des rôles cruciaux, même si elles restent parfois dans l'ombre de grandes découvertes ultérieures. Le mathématicien français du XVIIe siècle **[Claude Gaspard Bachet](https://kenji.blog/fr/p/bachet/) de Méziriac (1581–1638)** est l'une d'entre elles. Il est célèbre pour son influence sur [Pierre de Fermat](https://kenji.blog/fr/p/fermat/), mais ses propres réalisations furent également vastes et diverses.

Dans cet article, nous allons plonger dans la vie de [Bachet](https://kenji.blog/fr/p/bachet/) et ses accomplissements mathématiques majeurs.

## La vie de [Bachet](https://kenji.blog/fr/p/bachet/) : De noble à érudit

[Bachet](https://kenji.blog/fr/p/bachet/) est né le 9 octobre 1581 à Bourg-en-Bresse, dans le centre-est de la France. Sa famille appartenait à la riche noblesse et il eut la chance de recevoir une excellente éducation dès son plus jeune âge.

Ayant perdu ses parents très tôt, il fut éduqué par les Jésuites, étudiant à Lyon, Milan et ailleurs. Il envisagea brièvement de rejoindre l'ordre des Jésuites pour vivre comme moine, mais retourna plus tard à la vie laïque et se consacra à la recherche académique. [Bachet](https://kenji.blog/fr/p/bachet/) excellait non seulement en mathématiques, mais aussi en littérature, linguistique et poésie, acquérant une renommée en tant que traducteur de classiques latins et grecs. En 1635, il fut également élu parmi les premiers membres de la prestigieuse Académie Française.
...
## La traduction latine de l'"Arithmetica" de [Diophante](https://kenji.blog/fr/p/diophantus/)
...
## L'équation de [Bachet](https://kenji.blog/fr/p/bachet/)

En théorie des nombres, [Bachet](https://kenji.blog/fr/p/bachet/) a étudié une forme spécifique d'équation diophantienne aujourd'hui connue sous le nom d'**équation de [Bachet](https://kenji.blog/fr/p/bachet/)**. Cela représente une courbe cubique (un type de courbe elliptique) sous la forme suivante :
...
[Bachet](https://kenji.blog/fr/p/bachet/) a considéré des méthodes géométriques et algébriques (équivalentes à ce qu'on appelle aujourd'hui l'addition de points sur les courbes elliptiques, en particulier la méthode de la tangente pour la duplication) pour dériver de nouvelles solutions rationnelles lorsqu'une solution rationnelle spécifique est donnée. Cela a montré un moyen de générer une infinité de solutions à l'équation diophantienne et est devenu l'un des fondements de la théorie ultérieure des courbes elliptiques.

## Père des mathématiques récréatives : "Problèmes plaisans et délectables"

En 1612, [Bachet](https://kenji.blog/fr/p/bachet/) a publié un livre intitulé "Problèmes plaisans et délectables, qui se font par les nombres". Il est considéré comme le premier livre spécialisé sur les "Mathématiques Récréatives" publié en Europe.

Ce livre contenait de nombreuses énigmes mathématiques qui restent populaires aujourd'hui, telles que l'énigme de la traversée de la rivière, le problème de Josèphe, les méthodes de création de carrés magiques et le célèbre "problème des poids de [Bachet](https://kenji.blog/fr/p/bachet/)".

### Le problème des poids de [Bachet](https://kenji.blog/fr/p/bachet/)
...
Ici, $a_i = 1$ signifie placer le poids sur le plateau opposé à l'objet pesé, $a_i = -1$ signifie le placer sur le même plateau, et $a_i = 0$ signifie ne pas utiliser ce poids. Le problème de [Bachet](https://kenji.blog/fr/p/bachet/) était une brillante expression de la théorie fondamentale des systèmes de numération à travers le jeu.

## L'identité de [Bachet](https://kenji.blog/fr/p/bachet/) (Identité de Bézout)

De plus, [Bachet](https://kenji.blog/fr/p/bachet/) a prouvé le théorème connu dans les mathématiques modernes sous le nom d'"identité de Bézout" pour les entiers plus de 150 ans avant Étienne Bézout.

[Bachet](https://kenji.blog/fr/p/bachet/) a montré que pour deux entiers premiers entre eux $a$ et $b$, il existe toujours des entiers $x, y$ qui satisfont ce qui suit :

$$
ax + by = 1
$$

$x$ et $y$ peuvent être concrètement calculés en développant l'algorithme d'[Euclide](https://kenji.blog/fr/p/euclid/) (l'algorithme d'[Euclide](https://kenji.blog/fr/p/euclid/) étendu), qui est devenu un théorème fondamental indispensable dans la cryptographie moderne (comme RSA). Dans les contextes qui valorisent l'exactitude historique, cela est parfois appelé le **théorème de [Bachet](https://kenji.blog/fr/p/bachet/)**.
