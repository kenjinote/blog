...
$x$ и $y$ можно конкретно вычислить, используя расширенный алгоритм [Евклид](https://kenji.blog/ru/p/euclid/)а, который стал незаменимой фундаментальной теоремой в современной криптографии (такой как [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/)). В контекстах, где ценится историческая точность, это иногда называют **теоремой Баше**.
