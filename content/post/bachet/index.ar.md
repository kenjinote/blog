...
يمكن حساب $x, y$ تحديدًا عن طريق توسيع [خوارزمية إقليدس](https://kenji.blog/ar/p/euclidean-algorithm/) ([خوارزمية إقليدس](https://kenji.blog/ar/p/euclidean-algorithm/) الموسعة)، وقد أصبحت نظرية أساسية لا غنى عنها في التشفير الحديث (مثل تشفير RSA). في السياقات التي تقدر الدقة التاريخية، يطلق عليها أحيانًا **مبرهنة باشيه**.
