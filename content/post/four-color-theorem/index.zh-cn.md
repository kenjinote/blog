...
1997年，尼尔·罗伯逊（Neil Robertson）等人对阿佩尔和哈肯的证明进行了改进，将不可避免集的数量减少到了633个。到了2005年，乔治·贡提耶（Georges Gonthier）利用定理证明辅助系统 Coq 完成了四色定理的完整形式化证明。这使得由于计算机程序的 bug 而导致错误的可能性降到了极低，证明的正确性变得不可动摇。
