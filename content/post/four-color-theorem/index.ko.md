...
[4색 정리(Four Color Theorem)](https://kenji.blog/ko/p/four-color-theorem/)는 수학, 특히 [그래프 이론](/ko/p/graph-theory-dijkstra-a-star/) 및 위상 수학에서 가장 유명하고 매력적인 문제 중 하나입니다. 그 주장은 매우 단순하여 초등학생도 이해할 수 있을 정도로 직관적입니다. "어떠한 평면상의 지도라도, 인접한 영역이 다른 색이 되도록 칠하려면 최대 **4색** 이면 충분하다"는 것입니다.
...
4색 정리를 수학적으로 엄밀하게 다루기 위해, 문제는 [그래프 이론](/ko/p/graph-theory-dijkstra-a-star/)의 언어로 번역됩니다. 지도상의 각 영역을 "정점(Vertex)"으로 하고, 경계선을 공유하는 영역끼리를 "간선(Edge)"으로 연결합니다. 이렇게 만들어진 그래프는 "평면 그래프(Planar [Graph](https://kenji.blog/ko/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))"라고 불립니다.
...
4색 정리는 "언뜻 단순해 보이는 문제가 얼마나 깊고 복잡한 수학적 구조를 숨기고 있는가"를 보여주는 가장 좋은 예입니다. 지도를 칠한다는 장난기에서 시작된 이 문제는 [그래프 이론](/ko/p/graph-theory-dijkstra-a-star/)을 발전시켰고, 나아가 수학적 증명의 존재 방식 자체를 변혁한다는 헤아릴 수 없는 영향을 미쳤습니다.
