...
## 1. What is the [Four Color Theorem](https://kenji.blog/p/four-color-theorem/)?
...
## 2. Historical Background of the [Four Color Theorem](https://kenji.blog/p/four-color-theorem/)
...
A planar graph is a graph that can be drawn on a plane without edges crossing. The [Four Color Theorem](https://kenji.blog/p/four-color-theorem/) reduces to the problem that "the vertices of every planar graph can be colored with **4 colors** such that adjacent vertices have different colors."
