...
Cette propriété est une technique indispensable pour prédire les états à long terme dans des modèles de probabilité tels que les [chaînes de Markov](/fr/p/markov-chain/), lors de la résolution de systèmes d'équations différentielles, ou même lors de la recherche du terme général de la suite de [Fibonacci](https://kenji.blog/fr/p/fibonacci/).
