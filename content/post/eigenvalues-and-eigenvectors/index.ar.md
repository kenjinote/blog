...
من تقليل الأبعاد (PCA) في التعلم الآلي وخوارزمية PageRank التي دعمت محرك بحث جوجل، إلى التصميم الزلزالي للمباني ومعادلة شرودنغر في ميكانيكا الكم، تظهر [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/p/eigenvalues-and-eigenvectors/) في كل مكان.
...
لفهم [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/p/eigenvalues-and-eigenvectors/)، تحتاج أولاً إلى تغيير منظورك حول "ما هي المصفوفة". المصفوفة ليست مجرد شبكة من الأرقام. إنها **محول (Transformation)** في الفضاء.
...
## تعريف [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/p/eigenvalues-and-eigenvectors/) والخلفية الرياضية
...
الآن، دعونا نحسب [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/p/eigenvalues-and-eigenvectors/) يدويًا باستخدام مصفوفة محددة $2 \times 2$. هذه خطوة شائعة جدًا في امتحانات الجبر الخطي.
...
الآن، لقد وجدنا جميع [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/p/eigenvalues-and-eigenvectors/) للمصفوفة $A$.

## حساب [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/p/eigenvalues-and-eigenvectors/) باستخدام بايثون (Python)
...
يعد **تقطير المصفوفة (Matrix Diagonalization)** أحد أهم تطبيقات [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/p/eigenvalues-and-eigenvectors/). التقطير هو عملية تحليل مصفوفة معقدة $A$ باستخدام مصفوفة قطرية يسهل حسابها $D$ على النحو التالي:
...
هذه الخاصية هي تقنية لا غنى عنها عند التنبؤ بالحالات طويلة الأجل في نماذج الاحتمالات مثل [سلاسل ماركوف](https://kenji.blog/p/markov-chain/)، عند حل أنظمة المعادلات التفاضلية، أو حتى عند البحث عن الحد العام لتسلسل فيبوناتشي.
...
في PCA، نحسب [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/p/eigenvalues-and-eigenvectors/) لمصفوفة التباين المشترك للبيانات.
