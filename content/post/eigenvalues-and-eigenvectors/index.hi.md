...
मशीन लर्निंग में डायमेंशनलिटी रिडक्शन (PCA) और Google के सर्च इंजन को संचालित करने वाले PageRank एल्गोरिदम से लेकर इमारतों के भूकंपीय डिजाइन और क्वांटम यांत्रिकी में श्रोडिंगर समीकरण तक, [आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) हर जगह दिखाई देते हैं।
...
[आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) को समझने के लिए, आपको सबसे पहले "मैट्रिक्स क्या है" इस पर अपना दृष्टिकोण बदलना होगा। मैट्रिक्स केवल संख्याओं का ग्रिड नहीं है। यह अंतरिक्ष में एक **ट्रांसफॉर्मर (Transformation)** है।
...
## [आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) की परिभाषा और गणितीय पृष्ठभूमि
...
अब, आइए एक विशिष्ट $2 \times 2$ मैट्रिक्स का उपयोग करके [आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) की गणना हाथ से करें। यह रैखिक बीजगणित की परीक्षाओं में बहुत ही सामान्य कदम है।
...
अब, हमने मैट्रिक्स $A$ के लिए सभी [आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) खोज लिए हैं।

## पायथन (Python) के साथ [आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) की गणना
...
[आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) के सबसे महत्वपूर्ण अनुप्रयोगों में से एक **मैट्रिक्स विकर्णीकरण (matrix diagonalization)** है। विकर्णीकरण एक आसानी से गणना योग्य विकर्ण मैट्रिक्स $D$ का उपयोग करके एक जटिल मैट्रिक्स $A$ को विघटित करने की प्रक्रिया है:
...
## [आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) के वास्तविक दुनिया के अनुप्रयोग
...
PCA में, हम डेटा के सहप्रसरण मैट्रिक्स (covariance matrix) के [आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) की गणना करते हैं।
...
पहली नज़र में, [आइगेनवैल्यू और आइगेनवेक्टर](https://kenji.blog/p/eigenvalues-and-eigenvectors/) अमूर्त गणितीय पहेली की तरह लग सकते हैं। हालाँकि, ज्यामितीय रूप से, यह "आवश्यक अक्षों को निकालने का संचालन है जो मैट्रिक्स द्वारा जटिल परिवर्तनों के बीच कभी नहीं बदलते हैं", और इसके अनुप्रयोग कंप्यूटर विज्ञान से लेकर डेटा विज्ञान, सैद्धांतिक भौतिकी और मैकेनिकल इंजीनियरिंग तक व्यापक रूप से फैले हुए हैं।
