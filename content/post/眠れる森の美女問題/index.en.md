...
## 3. Calculating with [Bayes' Theorem](https://kenji.blog/en/p/bayes-theorem/)

There is also an attempt to unravel this problem using "[Bayes' Theorem](https://kenji.blog/en/p/bayes-theorem/)," a tool for mathematically updating probabilities.
