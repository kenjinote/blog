...
गणितीय रूप से प्रायिकताओं को अद्यतन करने के लिए एक उपकरण, "बेयस प्रमेय ([Bayes' Theorem](https://kenji.blog/hi/p/bayes-theorem/))" का उपयोग करके इस समस्या को हल करने के प्रयास भी किए गए हैं।
