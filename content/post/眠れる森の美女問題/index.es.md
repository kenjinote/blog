...
## 3. Intentando calcular con el [Teorema de Bayes](https://kenji.blog/es/p/bayes-theorem/)

También hay intentos de desentrañar este problema utilizando el "[Teorema de Bayes](https://kenji.blog/es/p/bayes-theorem/)", una herramienta para actualizar matemáticamente las probabilidades.
