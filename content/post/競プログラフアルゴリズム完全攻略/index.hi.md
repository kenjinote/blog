...
*   $O(V + E)$ : यह वर्टिसेस $V, E \le 10^5 \sim 10^6$ वाली समस्याओं के लिए आवश्यक कॉम्प्लेक्सिटी है। डेप्थ-फर्स्ट सर्च ([DFS](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) और ब्रेड्थ-फर्स्ट सर्च ([BFS](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) इसके अंतर्गत आते हैं।
*   $O((V + E) \log V)$ : यह $V, E \le 10^5 \sim 2 \cdot 10^5$ वाली समस्याओं में अक्सर देखा जाता है। यह [Dijkstra](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) या Prim के एल्गोरिदम में प्रायोरिटी क्यू (Priority Queue) का उपयोग करने पर टाइम कॉम्प्लेक्सिटी है।
*   $O(V^2)$ : यह $V \le 2000 \sim 3000$ के डेंस ग्राफ़ (Dense [Graph](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) ($E \approx V^2$) के लिए स्वीकार्य है।
...
टोपोलॉजिकल सॉर्ट एक एल्गोरिदम है जो डायरेक्टेड एसाइक्लिक ग्राफ़ (DAG: Directed Acyclic Graph) के वर्टिसेस को एक पंक्ति में इस तरह से व्यवस्थित करता है कि सभी डायरेक्टेड एजेस आगे वाले वर्टेक्स से पीछे वाले वर्टेक्स की ओर पॉइंट करते हैं। इसका उपयोग टास्क डिपेंडेंसी को हल करने (जैसे: टास्क A के खत्म होने तक टास्क B शुरू नहीं किया जा सकता) और DAG पर डायनामिक प्रोग्रामिंग ([DP](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)) के निष्पादन के क्रम को तय करने के लिए किया जाता है।
...
### डिजक्स्ट्रा का एल्गोरिदम ([Dijkstra](https://kenji.blog/hi/p/graph-theory-dijkstra-a-star/)'s Algorithm)
...
यह एल्गोरिदम ग्राफ़ में वर्टिसेस के सभी पेयर्स (जोड़ों) के बीच की सबसे कम दूरी का पता लगाता है। यह डायनामिक प्रोग्रामिंग ([DP](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)) पर आधारित है। यह एल्गोरिदम बहुत सरल है, और इसे इम्प्लीमेंट करना भी बेहद आसान है, जो इसकी एक बड़ी खासियत है।

स्टेट ट्रांज़िशन ([State](https://kenji.blog/hi/p/iac-infrastructure-as-code-terraform/) transition) का समीकरण इस प्रकार है। हम वर्टेक्स $k$ से होकर जाने वाले या न जाने वाले रास्ते में से छोटे रास्ते को चुनते हैं:
...
## 5. मिनिमम स्पैनिंग ट्री (MST: Minimum Spanning [Tree](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))
...
CP में, इसका उपयोग अक्सर 2-SAT समस्याओं को हल करने, या साइकिल वाले ग्राफ़ को DAG में सिकोड़ने (condense) और फिर उस पर [DP](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) लगाने के लिए किया जाता है।

### कोसारजू का एल्गोरिदम (Kosaraju's Algorithm)

कोसारजू का एल्गोरिदम एक सुंदर और कुशल तरीका है जो केवल दो बार [DFS](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) (डेप्थ-फर्स्ट सर्च) करके SCC का निर्माण कर सकता है। इसकी टाइम कॉम्प्लेक्सिटी $O(V + E)$ है और यह लीनियर टाइम (linear time) में काम करता है।

एल्गोरिदम के चरण:
1. मूल ग्राफ़ पर DFS चलाएँ, और वर्टिसेस को पोस्ट-ऑर्डर (post-order) में एक एरे में रिकॉर्ड करें।
2. सभी एजेस की दिशा को पलटकर एक **रिवर्स ग्राफ़ (Reverse [Graph](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))** बनाएँ।
...
1. सबसे पहले, बिना किसी गलती के [DFS](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) / [BFS](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) तेज़ी से लिखना सीखें।
