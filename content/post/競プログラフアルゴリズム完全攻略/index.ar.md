...
في البرمجة التنافسية، تعتبر نظرية الرسوم البيانية ([Graph Theory](https://kenji.blog/ar/p/graph-theory-dijkstra-a-star/)) وخوارزمياتها من أهم المواضيع التي لا يمكن تجنبها. العديد من المسائل المطروحة في مسابقات مثل AtCoder، Codeforces، و TopCoder تحتوي على هيكل رسم بياني في خلفيتها. إنها تمثل سلاحاً قوياً لتجريد وحل المشكلات الواقعية، مثل أقصر مسار في شبكة الطرق، وتقليل تكلفة الاتصال في الشبكات، وحل تبعيات المهام.
...
*   $O(V + E)$ : هذا هو التعقيد الحسابي المطلوب للمسائل التي يكون فيها عدد الرؤوس $V, E \le 10^5 \sim 10^6$. ينطبق هذا على البحث في العمق ([DFS](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) والبحث في العرض ([BFS](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)).
...
الفرز الطوبولوجي هو خوارزمية لترتيب رؤوس الرسم البياني الموجه الخالي من الحلقات (DAG: Directed Acyclic [Graph](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) في خط واحد بحيث تتجه جميع الحواف الموجهة من الرؤوس الأمامية إلى الرؤوس الخلفية. يتم استخدامه لحل تبعيات المهام (مثال: لا يمكن بدء المهمة ب قبل انتهاء المهمة أ) ولتحديد ترتيب العمليات الحسابية في البرمجة الديناميكية ([DP](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)) على الـ DAG.
...
### خوارزمية ديكسترا ([Dijkstra](https://kenji.blog/ar/p/graph-theory-dijkstra-a-star/)'s Algorithm)
...
إنها خوارزمية لإيجاد أقصر مسافة بين جميع أزواج الرؤوس في الرسم البياني. تعتمد الخوارزمية على البرمجة الديناميكية ([DP](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)). وتتميز بكونها مبسطة للغاية وسهلة التطبيق بشكل كبير.
...
## 5. الشجرة الممتدة الصغرى (MST: Minimum Spanning [Tree](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))
...
في البرمجة التنافسية، تُستخدم بكثرة لحل مشكلات 2-SAT، ولتقليص الرسوم البيانية التي تحتوي على حلقات إلى DAG لإجراء البرمجة الديناميكية ([DP](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)) عليها.

### خوارزمية كوساراجو (Kosaraju's Algorithm)

خوارزمية كوساراجو هي طريقة أنيقة وفعالة لبناء الـ SCC من خلال تنفيذ [DFS](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) (البحث في العمق) مرتين فقط. التعقيد الزمني الخاص بها هو $O(V + E)$، وتعمل بوقت خطي.
...
1. أولاً، تأكد من قدرتك على كتابة [DFS](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) و [BFS](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) بسرعة وبدون أخطاء.
