...
*   $O(V + E)$ : Требуемая сложность для задач с количеством вершин $V, E \le 10^5 \sim 10^6$. Сюда относятся поиск в глубину ([DFS](https://kenji.blog/ru/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) и поиск в ширину ([BFS](https://kenji.blog/ru/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)).
...
### Алгоритм Дейкстры ([Dijkstra](https://kenji.blog/ru/p/graph-theory-dijkstra-a-star/)'s Algorithm)
...
Это алгоритм для нахождения кратчайших расстояний между всеми парами вершин в графе. Он основан на динамическом программировании ([DP](https://kenji.blog/ru/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)). Алгоритм очень лаконичен, а его реализация чрезвычайно проста, что делает его весьма привлекательным.
...
## 5. Минимальное остовное дерево (MST: Minimum Spanning [Tree](https://kenji.blog/ru/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))
...
В спортивном программировании он часто используется для решения задач 2-SAT или в ситуациях, когда граф с циклами стягивается в DAG для выполнения [DP](https://kenji.blog/ru/p/dynamic-programming-dp-introduction-knapsack-fibonacci/).

### Алгоритм Косарайю (Kosaraju's Algorithm)

Алгоритм Косарайю — это красивый и эффективный метод построения SCC всего за два прохода [DFS](https://kenji.blog/ru/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) (поиска в глубину). Его вычислительная сложность линейна и составляет $O(V + E)$.
...
1. Сначала научитесь быстро и безошибочно писать [DFS](https://kenji.blog/ru/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) / [BFS](https://kenji.blog/ru/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/).
