---
title: "George Soros 'Pria yang Menghancurkan Bank of England': Jejak Penuh Gejolak dari Seorang Investor Filosofis"
...
```mermaid
graph TD
    A["Hungaria di bawah Pendudukan Nazi (Pengalaman Awal Strategi Bertahan Hidup)"] --> B["London School of Economics (LSE)"]
    B --> C["Filosofi Karl Popper (Falibilisme)"]
    C --> D["Teori Refleksivitas (Reflexivity)"]
    D --> E["Pendirian Quantum Fund"]
    E --> F["Short Selling Poundsterling 1992 (Rabu Hitam)"]
    C --> G["Pendirian Open Society Foundations (Filantropi)"]
    F --> H["Dukungan Demokratisasi Global dan Reformasi Sosial"]
    G --> H
```
