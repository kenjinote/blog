...
description: "George Soros. ¿Qué le viene a la mente cuando escucha este nombre? ¿Un inversor legendario conocido como \"el hombre que quebró al Banco de Inglaterra\", o u"
---
...
```mermaid
graph TD
    A["Hungría bajo ocupación nazi (Experiencia original de estrategia de supervivencia)"] --> B["London School of Economics (LSE)"]
    B --> C["Filosofía de Karl Popper (Falibilismo)"]
    C --> D["Teoría de la reflexividad"]
    D --> E["Fundación del Quantum Fund"]
    E --> F["Venta en corto de la libra en 1992 (Miércoles Negro)"]
    C --> G["Fundación de las Open Society Foundations (Filantropía)"]
    F --> H["Apoyo a la democratización global y reforma social"]
    G --> H
```
