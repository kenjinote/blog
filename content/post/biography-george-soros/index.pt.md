---
title: "\"O Homem que Quebrou o Banco da Inglaterra\" George Soros: A Trajetória Turbulenta de um Investidor Filosófico"
...
```mermaid
graph TD
    A["Hungria sob Ocupação Nazista (Experiência de Sobrevivência)"] --> B["London School of Economics (LSE)"]
    B --> C["Filosofia de Karl Popper (Falibilismo)"]
    C --> D["Teoria da Reflexividade (Reflexivity)"]
    D --> E["Fundação do Quantum Fund"]
    E --> F["Venda a Descoberto da Libra em 1992 (Quarta-feira Negra)"]
    C --> G["Fundação da Open Society Foundations (Filantropia)"]
    F --> H["Apoio Global à Democratização e Reforma Social"]
    G --> H
```
