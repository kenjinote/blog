---
title: "« L'homme qui a fait sauter la Banque d'Angleterre » George Soros : la trajectoire tumultueuse d'un investisseur philosophe"
...
```mermaid
graph TD
    A["La Hongrie sous occupation nazie (Expérience originelle de stratégie de survie)"] --> B["London School of Economics (LSE)"]
    B --> C["Philosophie de Karl Popper (Faillibilisme)"]
    C --> D["Théorie de la réflexivité (Reflexivity)"]
    D --> E["Création du Quantum Fund"]
    E --> F["Vente à découvert de la livre en 1992 (Mercredi noir)"]
    C --> G["Création de l'Open Society Foundations (Philanthropie)"]
    F --> H["Soutien mondial à la démocratisation et aux réformes sociales"]
    G --> H
```
