---
title: '魅惑の数学の未解決問題：完全数、ゴールドバッハの予想、リーマン予想とは？'
...
[ゴールドバッハの予想](/p/goldbachs-conjecture/)は、すべての2よりも大きな偶数は2つの素数の和として表すことができるという予想です。
...
[リーマン](https://kenji.blog/p/riemann/)ゼータ関数は、$s$を複素数、$n$を自然数とするとき、
