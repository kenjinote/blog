...
Saat ini, bermunculan algoritma BFT baru yang mengurangi biaya (overhead) komunikasi PBFT dan meningkatkan skalabilitas, seperti **Nakamoto Consensus (PoW)** yang diadopsi oleh Bitcoin, Tendermint, HotStuff, dan lainnya. Memilih algoritma konsensus yang tepat sesuai dengan persyaratan sistem (keandalan node, *throughput* yang diperlukan, latensi) adalah kunci dalam membangun sistem terdistribusi yang tangguh.
