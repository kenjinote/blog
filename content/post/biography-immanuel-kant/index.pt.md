...
description: "Uma estrela gigante que é impossível de ignorar ao discutir a filosofia moderna. Esse é Immanuel Kant (1724–1804)."
---
...
flowchart TD
    ...
    subgraph "As Três Críticas (Filosofia Crítica)"
        direction TB
        Pure["Crítica da Razão Pura (1781)<br/>O que posso saber?"]
        Practical["Crítica da Razão Prática (1788)<br/>O que devo fazer?"]
        Judgment["Crítica da Faculdade do Juízo (1790)<br/>O que me é permitido esperar?"]
    end

    subgraph "Principais Conceitos Filosóficos"
        direction TB
        Copernican["Revolução Copernicana<br/>(Mudança Epistemológica)"]
        Categorical["Imperativo Categórico<br/>(Lei Moral Incondicional)"]
        Perpetual["À Paz Perpétua<br/>(Visão de uma Organização de Paz Internacional)"]
    end
    
    subgraph "Influência nas Gerações Futuras"
        direction TB
        Idealism["Idealismo Alemão<br/>(Fichte, Schelling, Hegel)"]
        NeoKantian["Neokantismo<br/>(Filosofia dos Valores, Filosofia da Cultura)"]
        ModernEthics["Ética Moderna e Direito Internacional<br/>(Rawls, Visão da ONU)"]
    end
