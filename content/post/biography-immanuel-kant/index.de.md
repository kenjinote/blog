---
title: "Immanuel Kant: Die Flugbahn der „Kopernikanischen Wende“ auf dem Höhepunkt der modernen Philosophie"
...
flowchart TD
    ...
    subgraph "Drei Kritiken (Kritische Philosophie)"
        direction TB
        Pure["Kritik der reinen Vernunft (1781)<br/>Was kann ich wissen?"]
        Practical["Kritik der praktischen Vernunft (1788)<br/>Was soll ich tun?"]
        Judgment["Kritik der Urteilskraft (1790)<br/>Was darf ich hoffen?"]
    end

    subgraph "Wichtigste philosophische Konzepte"
        direction TB
        Copernican["Kopernikanische Wende<br/>(Erkenntnistheoretischer Wandel)"]
        Categorical["Kategorischer Imperativ<br/>(Bedingungsloses moralisches Gesetz)"]
        Perpetual["Zum ewigen Frieden<br/>(Vision einer internationalen Friedensorganisation)"]
    end
    
    subgraph "Einfluss auf spätere Generationen"
        direction TB
        Idealism["Deutscher Idealismus<br/>(Fichte, Schelling, Hegel)"]
        NeoKantian["Neukantianismus<br/>(Wertphilosophie, Kulturphilosophie)"]
        ModernEthics["Moderne Ethik & Völkerrecht<br/>(Rawls, UN-Vision)"]
    end
