---
title: "Immanuel Kant: La trayectoria del «Giro Copernicano» que alcanzó la cima de la filosofía moderna"
...
flowchart TD
    ...
    subgraph "Tres Críticas (Filosofía crítica)"
        direction TB
        Pure["Crítica de la razón pura (1781)<br/>『¿Qué puedo saber?』"]
        Practical["Crítica de la razón práctica (1788)<br/>『¿Qué debo hacer?』"]
        Judgment["Crítica del juicio (1790)<br/>『¿Qué me está permitido esperar?』"]
    end

    subgraph "Conceptos filosóficos principales"
        direction TB
        Copernican["Giro Copernicano<br/>(Revolución epistemológica)"]
        Categorical["Imperativo Categórico<br/>(Ley moral incondicional)"]
        Perpetual["Sobre la paz perpetua<br/>(Concepto de organización internacional de paz)"]
    end
    
    subgraph "Influencia en la posteridad"
        direction TB
        Idealism["Idealismo alemán<br/>(Fichte, Schelling, Hegel)"]
        NeoKantian["Neokantismo<br/>(Filosofía de los valores, filosofía de la cultura)"]
        ModernEthics["Ética contemporánea y derecho internacional<br/>(Rawls, concepto de la ONU)"]
    end
