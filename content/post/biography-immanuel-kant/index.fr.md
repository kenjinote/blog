---
title: "Emmanuel Kant : La trajectoire de la « révolution copernicienne » au sommet de la philosophie moderne"
...
```mermaid
flowchart TD
    Kant["Emmanuel Kant (1724-1804)"]

    subgraph "Les trois Critiques (Philosophie critique)"
        direction TB
        Pure["Critique de la raison pure (1781)<br/>« Que puis-je savoir ? »"]
        Practical["Critique de la raison pratique (1788)<br/>« Que dois-je faire ? »"]
        Judgment["Critique de la faculté de juger (1790)<br/>« Que m'est-il permis d'espérer ? »"]
    end

    subgraph "Concepts philosophiques majeurs"
        direction TB
        Copernican["Révolution copernicienne<br/>(Transformation épistémologique)"]
        Categorical["Impératif catégorique<br/>(Loi morale inconditionnelle)"]
        Perpetual["Vers la paix perpétuelle<br/>(Conception d'une organisation internationale pour la paix)"]
    end
    
    subgraph "Influence sur la postérité"
        direction TB
        Idealism["Idéalisme allemand<br/>(Fichte, Schelling, Hegel)"]
        NeoKantian["Néokantisme<br/>(Philosophie des valeurs, philosophie de la culture)"]
        ModernEthics["Éthique moderne et droit international<br/>(Rawls, conception de l'ONU)"]
    end
