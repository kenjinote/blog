---
title: "Immanuel Kant: Jejak \"Revolusi Kopernikan\" di Puncak Filsafat Modern"
...
flowchart TD
    ...
    subgraph "Tiga Kritik (Filsafat Kritis)"
        direction TB
        Pure["Kritik atas Nalar Murni (1781)<br/>Apa yang dapat saya ketahui?"]
        Practical["Kritik atas Nalar Praktis (1788)<br/>Apa yang harus saya lakukan?"]
        Judgment["Kritik atas Daya Pertimbangan (1790)<br/>Apa yang boleh saya harapkan?"]
    end

    subgraph "Konsep Filsafat Utama"
        direction TB
        Copernican["Revolusi Kopernikan<br/>(Pergeseran Epistemologi)"]
        Categorical["Imperatif Kategoris<br/>(Hukum Moral Tanpa Syarat)"]
        Perpetual["Menuju Perdamaian Abadi<br/>(Visi Organisasi Perdamaian Internasional)"]
    end
    
    subgraph "Pengaruh pada Generasi Mendatang"
        direction TB
        Idealism["Idealisme Jerman<br/>(Fichte, Schelling, Hegel)"]
        NeoKantian["Neo-Kantianisme<br/>(Filsafat Nilai, Filsafat Budaya)"]
        ModernEthics["Etika Modern & Hukum Internasional<br/>(Rawls, Visi PBB)"]
    end
