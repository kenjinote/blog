...
इस लेख में, हम वेब सुरक्षा के मूल सिद्धांतों जैसे [XSS](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) और [CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) जैसी क्लासिक कमजोरियों के बारे में विस्तार से चर्चा करेंगे, जो आज भी खतरा बनी हुई हैं, से लेकर CORS, CSP, और SameSite Cookie जैसे नवीनतम सुरक्षा तंत्रों तक, जो आधुनिक वेब विकास में आवश्यक हैं। इसके अलावा, हम विशिष्ट कोड उदाहरणों और Mermaid आरेखों का उपयोग करके यह भी स्पष्ट करेंगे कि ये तकनीकें एक मजबूत वेब एप्लिकेशन बनाने के लिए एक साथ कैसे काम करती हैं।

---

# 1. क्लासिक और आधुनिक खतरों वाली कमजोरियाँ

वेब अनुप्रयोगों के इतिहास में लंबे समय से मौजूद और अभी भी [OWASP](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) टॉप 10 में नियमित रूप से शामिल **इंजेक्शन (Injection)** और **टूटा हुआ एक्सेस कंट्रोल (Broken Access Control)** से संबंधित कमजोरियां हैं। यहाँ, हम उनके मुख्य प्रतिनिधियों, क्रॉस-साइट स्क्रिप्टिंग (XSS) और क्रॉस-साइट रिक्वेस्ट फोर्जरी (CSRF) के बारे में गहराई से जानेंगे।
...
### 1.1.3 [XSS](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) के विशिष्ट कोड उदाहरण और सुरक्षा उपाय
...
[XSS](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) को रोकने का मूल सिद्धांत उपयोगकर्ता इनपुट को हानिरहित बनाना (एस्केप करना) है ताकि इसे HTML के रूप में व्याख्यायित न किया जा सके। विशेष रूप से, 5 विशेष वर्णों `<`, `>`, `&`, `"`, `'` को HTML संस्थाओं में परिवर्तित किया जाता है।
...
आजकल, React और Vue.js जैसे आधुनिक फ्रंट-एंड फ्रेमवर्क डिफ़ॉल्ट रूप से एस्केप प्रोसेसिंग करते हैं, इसलिए डेवलपर्स को सचेत हुए बिना कुछ हद तक [XSS](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) के खिलाफ सुरक्षा प्रदान की जाती है। हालाँकि, `dangerouslySetInnerHTML` (React) या `v-html` (Vue.js) का उपयोग करते समय अभी भी सावधानी बरतने की आवश्यकता है।

---

## 1.2 क्रॉस-साइट रिक्वेस्ट फोर्जरी ([CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/))
...
ब्राउज़र के विनिर्देशों के कारण, किसी विशिष्ट डोमेन के लिए अनुरोधों में स्वचालित रूप से उस डोमेन से जुड़ी Cookie शामिल होती है। [CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) इसी तंत्र का दुरुपयोग करता है।
...
बाद में वर्णित **SameSite** विशेषता को Cookie में सेट करके, आप क्रॉस-साइट से अनुरोधों में Cookie को संलग्न होने से रोक सकते हैं, जो [CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) के खिलाफ बहुत प्रभावी है।
...
**सामग्री सुरक्षा नीति (Content Security Policy: CSP)** [XSS](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) और डेटा इंजेक्शन हमलों को मूल रूप से रोकने के लिए एक मजबूत बहु-स्तरीय रक्षा तंत्र है। यह सर्वर-साइड पर एक सख्त श्वेतसूची को परिभाषित करता है जिसमें उन संसाधनों (स्क्रिप्ट, चित्र, स्टाइलशीट, आदि) के स्रोत (ऑरिजिन) शामिल होते हैं जिन्हें एक वेब पेज लोड कर सकता है।
...
### 2.2.2 इनलाइन स्क्रिप्ट पर प्रतिबंध के माध्यम से [XSS](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) का उन्मूलन
...
CSP में एक सुविधा होती है जो नीति उल्लंघन होने पर ब्राउज़र को निर्दिष्ट समापन बिंदु पर एक रिपोर्ट भेजने की अनुमति देती है। यह प्रशासकों को अज्ञात [XSS](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) प्रयासों या गलत कॉन्फ़िगरेशन के बारे में जागरूक होने की अनुमति देता है।
...
## 2.3 SameSite Cookie द्वारा [CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) रक्षा
...
| उपयोगकर्ता की कार्रवाई (जालसाज साइट पर) | HTTP विधि | अनुरोध का प्रकार | Cookie भेजना | [CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) पर प्रभाव |
| :--- | :--- | :--- | :--- | :--- |
...
| फॉर्म (`<form>`) सबमिट करना | POST | शीर्ष-स्तरीय नेविगेशन | **अवरुद्ध** | **[CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) हमले को रोकता है** |
...
इस प्रकार, केवल `SameSite=Lax` सेट करने से (या इसे ब्राउज़र डिफ़ॉल्ट के रूप में कार्य करने देने से), POST विधि का उपयोग करके होने वाले क्लासिक [CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) हमले बेअसर हो जाते हैं। हालाँकि, पूर्ण सुरक्षा के लिए, इसे पारंपरिक CSRF टोकन के संयोजन में उपयोग करने की अनुशंसा की जाती है।
...
उदाहरण के लिए, यदि Cookie की SameSite विशेषता को `Strict` पर सेट किया जाता है, तो यह [CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) के खिलाफ बहुत शक्तिशाली है, लेकिन यदि उपयोगकर्ता किसी प्रचार ईमेल में लिंक पर क्लिक करके आपकी साइट तक पहुंचता है, तो उसे गैर-लॉगिन माना जा सकता है, जो UX (उपयोगकर्ता अनुभव) से समझौता कर सकता है। एप्लिकेशन की विशेषताओं के अनुसार `Lax` का चयन करना आवश्यक है और महत्वपूर्ण कार्यों के लिए वन-टाइम पासवर्ड या पुनः प्रमाणीकरण की मांग करके संतुलन बनाना आवश्यक है।
...
*   **[XSS](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/) और [CSRF](https://kenji.blog/hi/p/web-application-vulnerability-owasp-top-10/)**: क्लासिक कमजोरियां जो आज भी घातक नुकसान पहुंचाती हैं। उचित एस्केप और टोकन का उपयोग करके सुरक्षा मूलभूत है।
