---
title: '收集了各種軟體的版本資訊對話方塊畫面'
slug: "いろんな版本資訊ダイアログ集めてみた"
...
## Google Chrome
這是 Google Chrome。自從 Edge 出現後，我就不怎麼用了。
...
## Microsoft Edge
這是 Microsoft Edge。最近我經常使用這個。
![img_9.png](img_9.webp)

## OBS Studio
這是 OBS Studio。最近我不怎麼用了。
![img_10.png](img_10.webp)

## TradingView
這是 TradingView。最近我用它來看美元兌日圓的圖表。
![img_11.png](img_11.webp)

## Spy++
這是 Spy++。它是 Windows SDK 中包含的工具。
![img_12.png](img_12.webp)

## dependency walker
這是 dependency walker。它是 Windows SDK 中包含的工具。
![img_13.png](img_13.webp)

## resource hacker
這是 resource hacker。它是用於編輯和獲取可執行檔案資源的工具。
...
## bandicam
這是 bandicam。它是一款影片擷取工具。
![img_16.png](img_16.webp)

## winmerge
這是 winmerge。它是一款查看檔案差異的工具。
...
## Adobe Photoshop CS6
這是 Adobe Photoshop CS6。
![img_20.png](img_20.webp)

## Adobe Illustrator CS6
這是 Adobe Illustrator CS6。
