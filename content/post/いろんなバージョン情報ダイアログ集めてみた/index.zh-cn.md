...
## [Paint](https://kenji.blog/zh-cn/p/browser-rendering-mechanism-dom-paint/).NET
这是图像编辑软件。
...
## Microsoft Edge
这是Microsoft Edge。最近经常使用这个。
![img_9.png](img_9.webp)

## OBS Studio
这是OBS Studio。最近很少使用了。
![img_10.png](img_10.webp)

## TradingView
这是TradingView。最近用来查看美元/日元的图表。
![img_11.png](img_11.webp)

## Spy++
这是Spy++。是包含在Windows SDK中的工具。
![img_12.png](img_12.webp)

## depency walker
这是depency walker。是包含在Windows SDK中的工具。
![img_13.png](img_13.webp)

## resource hacker
这是resource hacker。是用来编辑和提取可执行文件资源的工具。
...
## Adobe Photoshop CS6
这是Adobe Photoshop CS6。
![img_20.png](img_20.webp)

## Adobe Illustrator CS6
这是Adobe Illustrator CS6。
