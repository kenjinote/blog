...
这就是 **[祖先悖论](https://kenji.blog/zh-cn/p/pedigree-collapse/)** 的真相。为什么会产生这样的矛盾呢？是数学上破产了吗？其答案就在于 **血统崩塌** （Pedigree Collapse）这个概念。本文将结合数学模型、历史实例以及最新的群体遗传学知识，对这个 **血统崩塌** 进行深入探讨。
...
**[祖先悖论](https://kenji.blog/zh-cn/p/pedigree-collapse/)** 乍看之下就像是一个单纯的数学谜题或计算把戏。但是，通过理解其背后的 **血统崩塌** 机制，我们就能看到人类历史上婚姻与交融的真实样貌。
