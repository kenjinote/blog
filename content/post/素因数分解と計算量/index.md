...
実用的な規模の（ノイズが少なく十分な数の論理量子ビットを持つ）[量子コンピュータ](https://kenji.blog/p/quantum-computing-shors-algorithm/)上で実行できるようになると、現在安全とされている2048ビットのRSA暗号は、数時間から数日で完全に解読されてしまう可能性があります。
