...
आधुनिक इंटरनेट समाज में, हम सुरक्षित रूप से ऑनलाइन खरीदारी का आनंद ले सकते हैं और गोपनीय जानकारी का आदान-प्रदान कर सकते हैं क्योंकि "क्रिप्टोग्राफी" ([Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy) तकनीक मौजूद है। और इस क्रिप्टोग्राफी तकनीक (विशेष रूप से व्यापक रूप से उपयोग किए जाने वाले [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन आदि) की सुरक्षा का मूल आधार एक गणितीय तथ्य है कि "विशाल पूर्णांकों का अभाज्य गुणनखंडन (Prime Factorization) बेहद कठिन है"।
...
2. **$\mathcal{O}(\log N)$ : लघुगणकीय समय (Logarithmic time)**
   एक अत्यधिक कुशल एल्गोरिदम जहां यदि इनपुट आकार दोगुना भी हो जाता है, तो निष्पादन समय केवल एक स्थिरांक से बढ़ता है। "बाइनरी सर्च ([Binary Search](https://kenji.blog/hi/p/search-algorithms-linear-binary-hash-table-principles/))", जो एक सॉर्ट किए गए एरे से एक लक्ष्य मान की खोज करता है, एक विशिष्ट उदाहरण है। यहां तक कि 1 अरब डेटा आइटम के साथ, लक्ष्य डेटा केवल 30 तुलनाओं में पाया जा सकता है।
...
# [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन का तंत्र और अभाज्य गुणनखंडन समस्या
...
## 2. फ़र्मेट की गुणनखंडन विधि ([Fermat](https://kenji.blog/hi/p/fermat/)'s Factorization Method)

यह विधि 17वीं सदी के गणितज्ञ [पियरे डी फ़र्मेट](https://kenji.blog/hi/p/fermat/) ([Pierre de Fermat](https://kenji.blog/hi/p/fermat/)) द्वारा तैयार की गई थी। जब एक विषम संयुक्त संख्या $N$ दी जाती है, तो यह $N$ को दो पूर्ण वर्गों (perfect squares) के अंतर के रूप में व्यक्त करने का प्रयास करता है।
...
## क्वांटम कंप्यूटर के रूप में एक "गेम चेंजर": शोर का एल्गोरिदम ([Shor's Algorithm](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/))

जबकि [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन क्लासिकल कंप्यूटरों के विरुद्ध मज़बूत है, "क्वांटम कंप्यूटर", जो पूरी तरह से अलग सिद्धांतों पर काम करते हैं, के व्यावहारिक उपयोग में आने पर स्थिति पूरी तरह से बदल जाती है।
...
* **[सामान्य संख्या क्षेत्र चलनी](/hi/p/%E4%B8%80%E8%88%AC%E6%95%B0%E4%BD%93%E7%AF%A9%E6%B3%95gnfs%E3%81%AE%E7%9C%9F%E3%81%AE%E0%A4%97%E0%A4%A3%E0%A4%BF%E0%A4%A4%E7%9A%84%E6%A7%8B%E9%80%A0/) (GNFS)**, जो वर्तमान में सबसे तेज़ क्लासिकल एल्गोरिदम है, उन्नत बीजीय संख्या सिद्धांत का पूरा उपयोग करके "उप-घातीय समय" प्राप्त करता है, लेकिन फिर भी यह बहुपदीय समय तक नहीं पहुंचता है, और विशाल संख्याओं के अभाज्य गुणनखंडन के लिए खगोलीय समय की आवश्यकता होती है।
