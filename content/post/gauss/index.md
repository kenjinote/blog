...
ここで登場したのが[ガウス](https://kenji.blog/p/gauss/)です。彼は自身が以前から密かに構築していた新しい数学的手法、すなわち **「最小二乗法」** (Method of Least Squares) を用いてケレスの軌道を計算しました。最小二乗法とは、観測データに含まれる誤差を最小化するように、最も確からしいパラメータを推定する手法です。
...
この定理により、例えば平らな紙（曲率0）をどのように丸めても、球面（正の曲率）を歪みなく作ることは不可能であることが数学的に証明されます。この[ガウス](https://kenji.blog/p/gauss/)の微分幾何学のアイデアは、後にベルンハルト・リーマンによって高次元へと一般化され（リーマン幾何学）、さらに後年、アルベルト・アインシュタインの一般相対性理論の数学的基礎として不可欠なものとなりました。
...
[ガウス](https://kenji.blog/p/gauss/)の驚くべき先見性を示すエピソードとして、**「非ユークリッド幾何学」** に関する逸話があります。ユークリッドの平行線公準（ある直線外の1点を通る平行線はただ1本存在する）が証明可能かどうかは、2000年以上にわたる数学上の大きな謎でした。
...
後に、ニコライ・ロバチェフスキーとヤーノシュ・ボヤイが独立に非ユークリッド幾何学を発表した際、ボヤイの父親（[ガウス](https://kenji.blog/p/gauss/)の旧友）から論文を送られた[ガウス](https://kenji.blog/p/gauss/)は、「この成果を賞賛することは、自分自身を賞賛することになる。なぜなら、ここに書かれていることは、私が30年前から考えていたことと完全に一致しているからだ」と返信しました。これにより若いボヤイは深く落胆したと言われていますが、同時に[ガウス](https://kenji.blog/p/gauss/)がどれほど時代を先取りしていたかを示す証左でもあります。
