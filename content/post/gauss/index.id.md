...
```mermaid
flowchart TD
    A["Januari 1801: Penemuan Ceres oleh Piazzi"] --> B["Ceres bersembunyi di balik matahari dan hilang"]
    B --> C["Perhitungan orbit menggunakan 'Metode Kuadrat Terkecil' oleh Gauss"]
    C --> D["Pengamatan ulang berhasil pada posisi yang ditentukan oleh Gauss"]
    D --> E["1807: Diangkat menjadi Direktur Observatorium Göttingen"]
```
