...
## 4. Beiträge zur Astronomie: Bahnberechnung von Ceres und die Methode der kleinsten Quadrate
...
Eine Episode, die die erstaunliche Weitsicht von Gauß zeigt, ist die Anekdote zur **„Nicht-euklidischen Geometrie“**. Ob Euklids Parallelenaxiom (durch einen Punkt außerhalb einer Geraden gibt es genau eine parallele Gerade) bewiesen werden könnte, war über 2.000 Jahre lang ein großes mathematisches Rätsel gewesen.
