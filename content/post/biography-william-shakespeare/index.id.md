---
title: "William Shakespeare: Sang Alkemis Kata yang Abadi"
...
```mermaid
graph TD
    A["William Shakespeare"] --> B["Empat Tragedi Besar"]
    A --> C["Komedi dan Drama Sejarah"]
    A --> D["Puisi dan Soneta"]
    ...
    C --> I["Impian di Tengah Musim Panas (A Midsummer Night's Dream)"]
    C --> J["Richard III"]

    D --> K["Refleksi mendalam tentang keindahan manusia, cinta, dan berlalunya waktu"]
```
