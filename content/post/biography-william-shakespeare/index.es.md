---
title: "William Shakespeare: El alquimista intemporal de las palabras"
...
```mermaid
graph TD
    A["William Shakespeare"] --> B["Las Cuatro Grandes Tragedias"]
    A --> C["Comedias y Obras Históricas"]
    A --> D["Poemas y Sonetos"]

    B --> E["Hamlet"]
    B --> F["Macbeth"]
    B --> G["Otelo (Othello)"]
    B --> H["El Rey Lear (King Lear)"]

    C --> I["El sueño de una noche de verano (A Midsummer Night's Dream)"]
    C --> J["Ricardo III (Richard III)"]

    D --> K["Profundas reflexiones sobre la belleza humana, el amor y el paso del tiempo"]
```
