---
title: "William Shakespeare : L'alchimiste intemporel des mots"
...
description: "William Shakespeare (1564 - 1616) est largement considéré comme le plus grand dramaturge et poète de l'histoire, et est souvent appelé le « poète national"
---
...
```mermaid
graph TD
    A["William Shakespeare"] --> B["Les Quatre Grandes Tragédies"]
    A --> C["Comédies et Pièces Historiques"]
    A --> D["Poèmes et Sonnets"]

    B --> E["Hamlet"]
    B --> F["Macbeth"]
    B --> G["Othello"]
    B --> H["Le Roi Lear (King Lear)"]

    C --> I["Le Songe d'une nuit d'été (A Midsummer Night's Dream)"]
    C --> J["Richard III"]

    D --> K["Réflexions profondes sur la beauté humaine, l'amour et le passage du temps"]
```
