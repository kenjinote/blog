...
```mermaid
graph TD
    A["William Shakespeare"] --> B["Four Great Tragedies"]
    A --> C["Comedies and Histories"]
    A --> D["Poems and Sonnets"]
    ...
    C --> I["A Midsummer Night's Dream"]
    C --> J["Richard III"]

    D --> K["Deep reflections on human beauty, love, and the passage of time"]
```
