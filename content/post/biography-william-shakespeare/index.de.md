---
title: "William Shakespeare: Der zeitlose Alchemist der Worte"
...
```mermaid
graph TD
    A["William Shakespeare"] --> B["Die vier großen Tragödien"]
    A --> C["Komödien und Historiendramen"]
    A --> D["Gedichte und Sonette"]

    B --> E["Hamlet"]
    B --> F["Macbeth"]
    B --> G["Othello"]
    B --> H["König Lear (King Lear)"]

    C --> I["Ein Sommernachtstraum (A Midsummer Night's Dream)"]
    C --> J["Richard III."]

    D --> K["Tiefe Reflexionen über menschliche Schönheit, Liebe und das Vergehen der Zeit"]
```
