---
title: "William Shakespeare: O intemporal alquimista das palavras"
...
description: "William Shakespeare (1564 - 1616) é amplamente considerado o maior dramaturgo e poeta da história, frequentemente chamado de poeta nacional da Inglaterra."
---
...
```mermaid
graph TD
    A["William Shakespeare"] --> B["Quatro Grandes Tragédias"]
    A --> C["Comédias e Dramas Históricos"]
    A --> D["Poemas e Sonetos"]

    B --> E["Hamlet"]
    B --> F["Macbeth"]
    B --> G["Otelo (Othello)"]
    B --> H["Rei Lear (King Lear)"]

    C --> I["Sonho de uma Noite de Verão (A Midsummer Night's Dream)"]
    C --> J["Ricardo III (Richard III)"]

    D --> K["Reflexões profundas sobre a beleza humana, o amor e a passagem do tempo"]
```
