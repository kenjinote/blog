...
### Автоматическая проверка с помощью [CI/CD](https://kenji.blog/ru/p/cicd-pipeline-github-actions-best-practices/) пайплайна

Кроме того, используя [GitHub Actions](https://kenji.blog/ru/p/cicd-pipeline-github-actions-best-practices/), мы построим CI пайплайн, в котором `textlint` будет автоматически запускаться при отправке (push) статей в блог. Это позволит предотвратить деплой статей, нарушающих правила.
...
## 5. Искусство написания Markdown в эпоху [LLM](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/)
...
Кроме того, написание сложных диаграмм Mermaid или математических формул (LaTeX) также можно доверить ИИ, который сгенерирует точный синтаксис по вашим указаниям. Например, основы верстки формул и диаграмм в этой статье также были ускорены за счет совместного написания с [LLM](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/).
...
4. **textlint и статический анализ**: Интеграция [CI/CD](https://kenji.blog/ru/p/cicd-pipeline-github-actions-best-practices/) и локального Linter'а для сведения времени вычитки к нулю.
5. **Интеграция [LLM](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/)**: Вывод структуры Markdown и кода для диаграмм непосредственно ИИ внутри редактора.
