---
title: "L'histoire d'Alibaba : La révolution du commerce électronique en Chine et la construction d'un écosystème numérique"
description: "Comment Jack Ma a transformé la vente au détail et les paiements en Chine, et a construit un écosystème numérique géant."
...
```mermaid
flowchart LR
    Buyer["Acheteur"] --> Alipay["Alipay (Tiers de confiance)"]
    Alipay --> Seller["Vendeur"]
    Seller --> Goods["Expédier les marchandises"]
    Goods --> Buyer
    Buyer --> Release["Débloquer les fonds"]
    Release --> Alipay
```
