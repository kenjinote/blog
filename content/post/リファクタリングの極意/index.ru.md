...
Даже при возникновении исключений (Exceptions), деструкторы локальных переменных вызываются автоматически в процессе развертывания стека ([Stack](https://kenji.blog/ru/p/c-language-pointers-memory-management-stack-heap/) Unwinding), что предотвращает утечки ресурсов.
...
- **Создание пайплайна [CI/CD](https://kenji.blog/ru/p/cicd-pipeline-github-actions-best-practices/)**: Используйте [GitHub Actions](https://kenji.blog/ru/p/cicd-pipeline-github-actions-best-practices/) или GitLab CI для выполнения сборок, автоматических тестов и статического анализа для всех pull-запросов, чтобы предотвратить появление нового технического долга.
