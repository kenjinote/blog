...
## 4. 密結合の打破：依存性の注入 ([Dependency Injection](https://kenji.blog/p/design-patterns-modern-practices/))
...
レガシーC++において最も頭を悩ませるのが、グローバル変数と「シングルトン (Singleton) パターン」の乱用です。シングルトンは一見すると便利な[デザインパターン](https://kenji.blog/p/design-patterns-modern-practices/)に思えますが、実態は「[オブジェクト指向](https://kenji.blog/p/oop-vs-fp-vs-dop/)の皮を被ったグローバル変数」に過ぎません。
