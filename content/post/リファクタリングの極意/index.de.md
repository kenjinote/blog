...
- **Aufbau einer [CI/CD](https://kenji.blog/de/p/cicd-pipeline-github-actions-best-practices/)-Pipeline**: Verwenden Sie [GitHub Actions](https://kenji.blog/de/p/cicd-pipeline-github-actions-best-practices/) oder GitLab CI, um Builds, automatisierte Tests und statische Analysen für alle Pull Requests auszuführen und so das Einschleichen neuer technischer Schulden zu verhindern.
