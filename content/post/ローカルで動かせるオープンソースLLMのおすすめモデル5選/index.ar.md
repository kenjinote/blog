...
في السنوات الأخيرة، كان التطور التقني للنماذج اللغوية الكبيرة ([LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/)) ملحوظاً، وانتشرت خدمات الذكاء الاصطناعي القائمة على السحابة مثل ChatGPT و Claude على نطاق واسع. ولكن من ناحية أخرى، تزداد الحاجة بسرعة إلى "عدم الرغبة في إرسال البيانات السرية للشركة إلى خوادم خارجية"، و"الرغبة في تقليل رسوم استخدام واجهة برمجة التطبيقات (API)"، و"بناء نظام ذكاء اصطناعي يعمل دون اتصال بالإنترنت تماماً".
