...
हाल के वर्षों में, लार्ज लैंग्वेज मॉडल ([LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/)) तकनीक का विकास उल्लेखनीय रहा है, और ChatGPT तथा Claude जैसी क्लाउड-आधारित AI सेवाएं व्यापक रूप से लोकप्रिय हो गई हैं। हालांकि, इसके साथ ही, "हम अपने गोपनीय डेटा को बाहरी सर्वर पर नहीं भेजना चाहते", "हम API की लागत को कम करना चाहते हैं", और "हम एक AI सिस्टम बनाना चाहते हैं जो पूरी तरह से ऑफलाइन काम करे" जैसी ज़रूरतें भी तेज़ी से बढ़ रही हैं।

इन मांगों को पूरा करने के लिए "लोकल [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) (ओपन सोर्स [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/))" हैं, जिन्हें आप सीधे अपने पीसी या इन-हाउस सर्वर पर डाउनलोड करके चला सकते हैं। 2023 तक लोकल मशीन पर व्यावहारिक सटीकता प्राप्त करना मुश्किल था, लेकिन मॉडल आर्किटेक्चर के विकास और क्वांटाइजेशन (Quantization) तकनीक की प्रगति के कारण, अब उपभोक्ता-ग्रेड GPU (जैसे [NVIDIA](/hi/p/history-of-nvidia/) RTX 3090 / 4090 या Mac के Apple Silicon) पर भी बहुत शक्तिशाली [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) को तेज़ी से चलाना संभव हो गया है।

इस लेख में, हम कई ओपन सोर्स [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) में से "5 अनुशंसित मॉडल" चुनेंगे, जिन्हें 2026 तक विशेष रूप से उत्कृष्ट माना गया है। हम उनके आर्किटेक्चर की विशेषताओं, पैरामीटर की संख्या, [GGUF](/hi/p/llama-cpp-quantization-gguf/) क्वांटाइजेशन के कारण मेमोरी की आवश्यकता, और विशिष्ट उपयोग के मामलों तक, अत्यंत विस्तृत और तकनीकी दृष्टिकोण से तुलना और व्याख्या करेंगे।

---

# लोकल LLM क्यों चलाएं?

लोकल [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) को अपनाने के कई अनूठे फायदे हैं जो क्लाउड-आधारित API में नहीं होते हैं।
...
मॉडल्स के परिचय से पहले, आइए "VRAM आवश्यकता" और "क्वांटाइजेशन (Quantization)" को गणितीय रूप से समझ लें, जो लोकल वातावरण में [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) चलाने के लिए अपरिहार्य हैं।

## VRAM (वीडियो मेमोरी) और क्वांटाइजेशन की गणितीय नींव

[LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) को GPU पर इनफेरेंस (inference) कराने के लिए, मॉडल के पैरामीटर्स (वज़न) को VRAM में लोड करना आवश्यक है। मॉडल की मेमोरी आवश्यकता $M$ का अनुमान निम्नलिखित सूत्र द्वारा लगाया जा सकता है।
...
वर्तमान में सबसे लोकप्रिय फॉर्मेट **[GGUF](/hi/p/llama-cpp-quantization-gguf/) (GPT-Generated Unified Format)** है, जिसे Georgi Gerganov (llama.cpp के डेवलपर) द्वारा विकसित किया गया है। [GGUF](/hi/p/llama-cpp-quantization-gguf/) एक बाइनरी फॉर्मेट है जो CPU और GPU दोनों पर कुशलतापूर्वक इनफेरेंस करने के लिए है, और यह विशेष रूप से Mac (Apple Silicon) के Unified Memory आर्किटेक्चर के साथ बहुत अच्छी तरह से काम करता है।
...
इसके परिणामस्वरूप, केवल 8GB VRAM वाले एंट्री-लेवल GPU या सामान्य लैपटॉप भी 8B क्लास के शक्तिशाली [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) को स्थानीय रूप से सुचारू रूप से चला सकते हैं।

---

# अनुशंसित लोकल LLM के 5 मॉडल

आइए 5 ऐसे ओपन सोर्स [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) को देखें जिन्हें दुनिया भर के डेवलपर्स और AI रिसर्चर्स द्वारा सबसे अधिक समर्थन प्राप्त है।

## 1. Llama 3 (Meta)

Meta द्वारा विकसित "Llama 3" सीरीज़, ओपन सोर्स [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) का वास्तविक उद्योग मानक (de facto standard) बन गई है।
...
Llama 3 को कम्युनिटी से सबसे अधिक समर्थन प्राप्त है, और इसका सबसे बड़ा फायदा यह है कि [GGUF](/hi/p/llama-cpp-quantization-gguf/), AWQ, और EXL2 जैसे सभी क्वांटाइजेशन फॉर्मेट्स तुरंत उपलब्ध होते हैं।
...
"Mixtral 8x7B" ओपन सोर्स [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) के रूप में **MoE (Mixture of Experts)** आर्किटेक्चर को पूर्ण रूप से अपनाने वाला पहला सफल मॉडल था।
...
Google द्वारा विकसित "Gemma" सीरीज़, उनके अत्याधुनिक "[Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/)" मॉडल की तकनीक पर आधारित एक ओपन मॉडल है। अपनी दूसरी पीढ़ी के रूप में, Gemma 2 ने अपने आर्किटेक्चर में बड़े बदलाव किए हैं।
...
हाल ही में [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) विकास में "बस पैरामीटर्स और डेटा की मात्रा बढ़ाएं" की ब्रूट-फोर्स रणनीति मुख्यधारा थी, लेकिन Microsoft ने साबित कर दिया कि "यदि हम मॉडल को दिए गए डेटा की गुणवत्ता (उच्च-गुणवत्ता वाला पाठ्यपुस्तक डेटा या सिंथेटिक डेटा) को अत्यधिक बढ़ा देते हैं, तो छोटे पैरामीटर्स के साथ भी GPT-3.5 वर्ग की बुद्धिमत्ता प्राप्त की जा सकती है।"
Phi-3 को [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) (Large Language Model) के बजाय **SLM (Small Language Model)** कहा जाता है।
...
लोकल [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) की इनफेरेंस गति GPU की "मेमोरी बैंडविड्थ (Memory Bandwidth)" पर बहुत अधिक निर्भर करती है। ऐसा इसलिए है क्योंकि जनरेशन फेज़ (डिकोडिंग) में, प्रत्येक टोकन उत्पन्न होने पर मॉडल के सभी वेट्स को मेमोरी से पढ़ना पड़ता है। यह एक मेमोरी-बाउंड (Memory-bound) प्रक्रिया है, न कि कंप्यूट-बाउंड (Compute-bound)।
...
उदाहरण के लिए, [NVIDIA](/hi/p/history-of-nvidia/) RTX 4090 (मेमोरी बैंडविड्थ 1,008 GB/s) पर Llama 3 8B (4-bit संस्करण, लगभग 4.5 GB) चलाने की गणना करते हैं। यदि हम मानते हैं कि प्रभावी बैंडविड्थ सैद्धांतिक मूल्य का लगभग 80% (लगभग 800 GB/s) है:
...
इन शक्तिशाली ओपन सोर्स [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) को लोकल वातावरण में चलाने के लिए सॉफ़्टवेयर इकोसिस्टम वर्तमान में बहुत समृद्ध है। यहाँ तीन प्रतिनिधि टूल्स दिए गए हैं:

### 1. Ollama
वर्तमान में, यह सबसे आसान और सबसे लोकप्रिय टूल है। [Docker](https://kenji.blog/hi/p/docker-container-namespace-[cgroups](https://kenji.blog/hi/p/docker-container-namespace-cgroups-layers/)-layers/) की तरह, यह एक सिंगल कमांड के साथ मॉडल को डाउनलोड करने से लेकर उसे चलाने तक का काम करता है। यह Mac, Windows और Linux सभी को सपोर्ट करता है।
...
### 3. llama.cpp
यह C/C++ इम्प्लीमेंटेशन वाली लाइब्रेरी है जिसने लोकल [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) बूम को जन्म दिया और यह सब का आधार है। यह उन इंजीनियरों के लिए है जो चरम प्रदर्शन ट्यूनिंग चाहते हैं, या हैकर्स के लिए जो इसे अपनी खुद की स्क्रिप्ट में एम्बेड करना चाहते हैं। यह Apple के Metal, NVIDIA के CUDA, AMD के ROCm और यहाँ तक कि Intel के AVX इंस्ट्रक्शन सेट जैसे सभी हार्डवेयर की क्षमता को अधिकतम सीमा तक बढ़ा देता है।
