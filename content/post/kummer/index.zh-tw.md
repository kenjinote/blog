...
# 恩斯特·庫默爾：理想數之父與代數數論的黎明

在數學的歷史上，對某個特定未解之謎的挑戰開啟了全新研究領域的現象並不罕見。恩斯特·愛德華·庫默爾 ( **Ernst Eduard Kummer** ) 就是一位創造了如此歷史轉折點的 19 世紀德國數學巨人。在與 **費馬最後定理** ( **[Fermat's Last Theorem](https://kenji.blog/p/fermats-last-theorem/)** ) 深刻搏鬥的過程中，他引入了具有突破性的 **理想數** ( **Ideal Numbers** ) 概念，為現代代數數論奠定了基礎。
...
恩斯特·庫默爾於 1810 年 1 月 29 日出生在普魯士王國（今屬波蘭）的索勞 ( **Sorau** )。他的父親是一名醫生，在庫默爾很小的時候就去世了，他由母親撫養長大。儘管家境貧寒，庫默爾還是接受了良好的教育，並於 1828 年進入哈雷大學。
...
他卓越的研究成果吸引了當時頂尖數學家的注意。1842 年，在卡爾·古斯塔夫·雅各布·雅可比 ( **Carl Gustav Jacob Jacobi** ) 和彼得·古斯塔夫·勒熱納·狄利克雷 ( **Peter Gustav Lejeune Dirichlet** ) 的推薦下，庫默爾成為布雷斯勞大學的正式教授。此外，在 1855 年，他被任命為柏林大學教授，接替前往哥廷根的狄利克雷。

在柏林大學，庫默爾與卡爾·魏爾斯特拉斯 ( **Karl Weierstrass** ) 以及他以前的學生克羅內克一起，將柏林提升為全球數學中心。他的講座極其清晰且充滿激情，吸引了來自歐洲各地的許多才華橫溢的學生。
...
庫默爾最大的成就是他在數論中對 **費馬最後定理** 的研究。該定理指出以下內容：
...
1847 年，法國數學家加布里埃爾·拉梅 ( **Gabriel Lamé** ) 和奧古斯丁-路易·柯西 ( **Augustin-Louis Cauchy** ) 宣布他們已成功證明了這一定理。他們的方法是將因式分解擴展到複數（分圓域）領域。
...
利用理想數理論，庫默爾對費馬最後定理發起了重擊。他定義了 **正則質數** ( **Regular Primes** ) 的概念，並證明了一個驚人的結果：「如果 $p$ 是一個正則質數，那麼費馬最後定理對 $p$ 成立。」
...
利用這一標準，庫默爾證明了費馬最後定理對於 $100$ 以下的所有質數都成立，除了非正則質數 $37, 59$ 和 $67$。這是一項具有里程碑意義的成就，在當時的數學界引起了轟動。
...
恩斯特·庫默爾在解決費馬最後定理這個「無解之謎」時，擴展了數學本身的框架。他的 **理想數** 思想成為後來代數學中不可或缺的語言，並繼續影響著現代數學的各個分支。
