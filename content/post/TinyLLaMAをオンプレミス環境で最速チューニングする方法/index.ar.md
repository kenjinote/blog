...
يوضح مخطط Mermaid أدناه تدفق البيانات العام لـ TinyLLaMA وبنية كتلة المحول ([Transformer](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) block).
...
الآن، سنشرح نص PyTorch المخصص لأسرع ضبط، والذي يتضمن جميع التحسينات المذكورة أعلاه. هنا نستخدم `SFTTrainer` من مكتبة `trl` ([Transformer](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) Reinforcement Learning) الخاصة بـ Hugging Face.
...
- من خلال **LoRA / QLoRA** ، أصبح من الممكن إجراء ضبط لـ [LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) بشكل احترافي حتى على وحدات معالجة الرسومات المخصصة للمستهلكين.
