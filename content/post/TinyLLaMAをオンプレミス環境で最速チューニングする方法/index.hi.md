...
लार्ज लैंग्वेज मॉडल ([LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/)) का विकास अविश्वसनीय गति से आगे बढ़ रहा है, और इसके साथ, मॉडल के मापदंडों की संख्या सैकड़ों अरबों तक फैल रही है। GPT-4 और Claude 3 जैसे विशाल मॉडल बेजोड़ प्रदर्शन का दावा करते हैं, लेकिन अनुमान और प्रशिक्षण से जुड़ी गणना लागत, साथ ही बाहरी API का उपयोग करते समय सुरक्षा और डेटा गोपनीयता की चिंताएँ कंपनियों के लिए बड़ी बाधाएँ बन गई हैं। विशेष रूप से, अत्यधिक गोपनीय आंतरिक डेटा या [व्यक्तिगत जानकारी](/hi/p/powershell-%E3%81%A7-excel-%E3%81%AE%E0%A4%AE%E0%A5%87%E0%A4%9F%E0%A4%BE%E0%A4%A1%E0%A5%87%E0%A4%9F%E0%A4%BE%E0%A4%B5%E0%A5%8D%E0%A4%AF%E0%A4%95%E0%A5%8D%E0%A4%A4%E0%A4%BF%E0%A4%97%E0%A4%A4-%E0%A4%9C%E0%A4%BE%E0%A4%A8%E0%A4%95%E0%A4%BE%E0%A4%B0%E0%A5%80%E3%82%92%E5%89%8A%E9%99%A4%E3%81%99%E3%82%8B%E6%96%B9%E6%B3%95/) से जुड़े कार्यों में, अनुपालन (जैसे GDPR और APPI) के दृष्टिकोण से सार्वजनिक क्लाउड [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) API में डेटा भेजना अक्सर अस्वीकार्य होता है।
...
नीचे दिया गया Mermaid आरेख TinyLLaMA के समग्र डेटा प्रवाह और [Transformer](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) ब्लॉक की संरचना को दर्शाता है।
...
3. **पेज्ड ऑप्टिमाइज़र:** [NVIDIA](/hi/p/history-of-nvidia/) के यूनिफाइड मेमोरी फ़ीचर का उपयोग करके, VRAM कम होने पर ऑप्टिमाइज़र की स्थिति को अस्थायी रूप से CPU RAM में ले जाने का एक तंत्र।
...
अब, आइए सबसे तेज़ ट्यूनिंग के लिए एक PyTorch स्क्रिप्ट देखें जिसमें उपरोक्त सभी अनुकूलन शामिल हैं। यहाँ, हम Hugging Face की `trl` ([Transformer](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) Reinforcement Learning) लाइब्रेरी से `SFTTrainer` का उपयोग करेंगे।
...
- **LoRA / QLoRA** उपभोक्ता-ग्रेड GPU पर भी पूर्ण विकसित [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) ट्यूनिंग को सक्षम बनाता है।
...
ऑन-प्रिमाइसेस स्थानीय [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) का संचालन न केवल डेटा गोपनीयता की रक्षा करता है, बल्कि कम लागत पर विशिष्ट डोमेन (कानूनी, चिकित्सा, आंतरिक कंपनी नियम, आदि) के अनुरूप विशेष AI बनाने के लिए सबसे मजबूत हथियार बन जाता है। कृपया इस मार्गदर्शिका को संदर्भ के रूप में उपयोग करें और अपना स्वयं का समर्पित TinyLLaMA विकसित करने का प्रयास करें।
