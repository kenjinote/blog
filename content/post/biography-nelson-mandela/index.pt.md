...
description: "Nelson Mandela está profundamente gravado na memória das pessoas ao redor do mundo como um dos maiores líderes do século XX."
---
...
```mermaid
flowchart TD
    A["1918: Nascido em Mvezo, África do Sul"] --> B["Juntou-se ao Congresso Nacional Africano (CNA)"]
    B --> C["Anos 1960: Movimento Anti-Apartheid e Luta Armada"]
    C --> D["1964: Condenado a Prisão Perpétua"]
    D --> E["Passou 27 Anos na Prisão (Robben Island)"]
    E --> F["1990: Libertado da Prisão"]
    F --> G["Negociações para Acabar com o Apartheid"]
    G --> H["1993: Recebeu o Prêmio Nobel da Paz"]
    H --> I["1994: Eleito Primeiro Presidente Negro"]
    I --> J["Estabeleceu a Comissão da Verdade e Reconciliação"]
    J --> K["Defendeu o Perdão e a Nação Arco-Íris"]
    K --> L["2013: Faleceu aos 95 anos, deixando um legado global de paz"]
```
