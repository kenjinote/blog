---
title: "Nelson Mandela: La nueva Sudáfrica construida sobre un espíritu indomable y el 'perdón'"
...
```mermaid
flowchart TD
    A["1918: Nacido en Mvezo, Sudáfrica"] --> B["Se unió al Congreso Nacional Africano (CNA)"]
    B --> C["Años 1960: Movimiento anti-apartheid y lucha armada"]
    C --> D["1964: Condenado a cadena perpetua"]
    D --> E["Pasó 27 años en prisión (Isla Robben)"]
    E --> F["1990: Liberado de la prisión"]
    F --> G["Negociaciones para poner fin al Apartheid"]
    G --> H["1993: Galardonado con el Premio Nobel de la Paz"]
    H --> I["1994: Elegido primer presidente negro"]
    I --> J["Estableció la Comisión de la Verdad y la Reconciliación"]
    J --> K["Abogó por el perdón y la Nación del Arco Iris"]
    K --> L["2013: Falleció a los 95 años, dejando un legado global de paz"]
```
