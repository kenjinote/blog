---
title: "Nelson Mandela: Afrika Selatan Baru yang Dibangun di Atas Semangat Pantang Menyerah dan 'Pemaafan'"
...
```mermaid
flowchart TD
    A["1918: Lahir di Mvezo, Afrika Selatan"] --> B["Bergabung dengan Kongres Nasional Afrika (ANC)"]
    B --> C["1960-an: Gerakan Anti-Apartheid & Perjuangan Bersenjata"]
    C --> D["1964: Dijatuhi Hukuman Penjara Seumur Hidup"]
    D --> E["Menghabiskan 27 Tahun di Penjara (Pulau Robben)"]
    E --> F["1990: Dibebaskan dari Penjara"]
    F --> G["Negosiasi untuk Mengakhiri Apartheid"]
    G --> H["1993: Menerima Hadiah Nobel Perdamaian"]
    H --> I["1994: Terpilih sebagai Presiden Kulit Hitam Pertama"]
    I --> J["Mendirikan Komisi Kebenaran dan Rekonsiliasi"]
    J --> K["Menganjurkan Pemaafan dan Bangsa Pelangi"]
    K --> L["2013: Meninggal pada usia 95 tahun, meninggalkan warisan perdamaian global"]
```
