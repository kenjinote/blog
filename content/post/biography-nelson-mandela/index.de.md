...
description: "Nelson Mandela hat sich als einer der größten Führer des 20. Jahrhunderts tief in das Gedächtnis der Menschen weltweit eingeprägt."
---
...
```mermaid
flowchart TD
    A["1918: Geboren in Mvezo, Südafrika"] --> B["Beitritt zum African National Congress (ANC)"]
    B --> C["1960er Jahre: Anti-Apartheid-Bewegung & Bewaffneter Kampf"]
    C --> D["1964: Verurteilung zu lebenslanger Haft"]
    D --> E["Verbrachte 27 Jahre im Gefängnis (Robben Island)"]
    E --> F["1990: Entlassung aus dem Gefängnis"]
    F --> G["Verhandlungen zur Beendigung der Apartheid"]
    G --> H["1993: Ausgezeichnet mit dem Friedensnobelpreis"]
    H --> I["1994: Zum ersten schwarzen Präsidenten gewählt"]
    I --> J["Gründung der Wahrheits- und Versöhnungskommission"]
    J --> K["Eintreten für Vergebung und die Regenbogennation"]
    K --> L["2013: Verstarb im Alter von 95 Jahren und hinterließ ein globales Friedenserbe"]
```
