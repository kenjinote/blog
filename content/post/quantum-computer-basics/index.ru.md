...
В настоящее время безопасные коммуникации в Интернете (например, оплата кредитными картами или передача личных данных) защищены «алгоритмом шифрования [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/)», который основан на предпосылке, что «факторизация огромных чисел практически невозможна (требует колоссального времени) для классического компьютера».
