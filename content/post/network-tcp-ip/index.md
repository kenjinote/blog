...
この「ネットワーク側はただの土管である」というシンプルな設計だったからこそ、インターネットは特定の管理者に縛られることなく、誰もが自由に新しいアプリケーション（Web、動画配信、P2P、ブロックチェーンなど）を端っこの端末で作るだけで、世界中に展開できる「イノベーションのインフラ」へと成長できたのです。
