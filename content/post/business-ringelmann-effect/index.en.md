...
```mermaid
flowchart TD
    A["Expansion of Group Size"] -- "Diffusion of responsibility" --> B["Decrease in Individual Sense of Ownership"]
    B -- "Obscuring of contribution" --> C["Decline in Motivation"]
    C -- "Emergence of free riders" --> D["Social Loafing (Ringelmann Effect)"]
    D -- "Decline in overall team productivity" --> E["Organizational Stagnation and Performance Deterioration"]
```
...
```mermaid
flowchart TD
    A["Preventive Measures for the Ringelmann Effect"] -- "Clarification of roles" --> B["Identify Individual Scopes of Responsibility"]
    A -- "Optimization of evaluation systems" --> C["Visualization of Processes and Individual Contributions"]
    A -- "Optimization of team size" --> D["Two-Pizza Rule (Small Groups)"]
    A -- "Building psychological safety" --> E["Strengthening Mutual Trust and Communication"]
    B -- "Improvement of sense of ownership" --> F["Maximizing Overall Team Performance"]
    C -- "Expectation of fair evaluation" --> F
    D -- "Elimination of a sense of being buried" --> F
    E -- "Promotion of cooperation" --> F
```
