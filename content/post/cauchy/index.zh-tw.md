...
在數學史上，19世紀被稱為「嚴密化時代」。為之前一直憑藉直覺處理的微積分學奠定堅實邏輯基礎的，正是法國數學家 **[奧古斯丁-路易·柯西](https://kenji.blog/zh-tw/p/cauchy/)** ([Augustin-Louis Cauchy](https://kenji.blog/zh-tw/p/cauchy/), 1789-1857)。他的名字冠於如此多的定理和概念之上，以至於任何學習現代數學的人都必然會遇到他。
...
柯西最大的成就是為數學分析奠定了嚴密的基石。他使用嚴密的定義（後來由魏爾施特拉斯完善的 [epsilon-delta](/zh-tw/p/epsilon-delta-definition/) 論證，也就是我們今天所學的）重建了極限、連續性、微分和積分等概念。
...
毫不誇張地說，複變函數論（複分析）幾乎是由柯西一人創立的。其核心定理就是 **[柯西積分定理](/zh-tw/p/cauchys-integral-theorem/)**。
...
[奧古斯丁-路易·柯西](https://kenji.blog/zh-tw/p/cauchy/)通過邏輯的力量，將依賴於直覺的數學鍛造成了一門嚴密的學術學科。他創造的概念和定理在現代數學的各個角落都根深蒂固。
