...
En la historia de las matemáticas, el siglo XIX es conocido como la "Era del Rigor". El matemático francés **[Augustin-Louis Cauchy](https://kenji.blog/p/cauchy/)** (1789-1857) es quien proporcionó un fundamento lógico firme para el cálculo, que anteriormente se había tratado de forma intuitiva. Su nombre corona tantos teoremas y conceptos que cualquiera que estudie matemáticas modernas está destinado a encontrarlo.

Este artículo explora la vida turbulenta de Cauchy, un gigante del mundo matemático, y los brillantes logros matemáticos que dejó.

## Una vida turbulenta: Viviendo en una Francia agitada

Cauchy nació en París en 1789, poco después del estallido de la Revolución Francesa. Su vida estuvo constantemente entrelazada con las convulsiones políticas de Francia.

### Infancia y educación

El padre de Cauchy ocupaba un alto cargo en las fuerzas policiales, pero para escapar del caos de la revolución, la familia huyó a Arcueil, un suburbio de París. Allí, recibió instrucción de grandes científicos de la época, como Laplace y Lagrange, que eran amigos de su padre. Lagrange, en particular, reconoció el talento matemático del joven Cauchy y predijo de forma célebre: "Este chico nos superará a todos algún día".
...
Cauchy era un devoto católico y un ferviente monárquico (partidario de la Casa de Borbón). Cuando Carlos X abdicó tras la Revolución de Julio de 1830, se negó a prestar juramento de lealtad al nuevo régimen y eligió el exilio. Deambuló por Suiza, Italia y Praga, dejando su patria durante unos ocho años hasta regresar a París en 1838. Incluso después de su regreso, continuó rechazando el juramento, y durante mucho tiempo no pudo asegurar un puesto universitario formal.

Su ideología conservadora y su personalidad intransigente a veces causaron fricciones con colegas y matemáticos más jóvenes (como Abel y Galois), pero su dedicación a las matemáticas y su productividad abrumadora no podían ser negadas por nadie.
...
### 1. Sucesión de Cauchy

El concepto de **sucesión de Cauchy** es esencial cuando se discute la continuidad de los números reales. Una sucesión $ (a_n) $ es una sucesión de Cauchy si la diferencia entre $ a_n $ y $ a_m $ se vuelve arbitrariamente pequeña cuando los índices $ n $ y $ m $ son suficientemente grandes.

Expresado matemáticamente, para cualquier $ \epsilon > 0 $, existe un número natural $ N $ tal que para todos los $ n, m > N $,
$$ |a_n - a_m| < \epsilon $$
siempre se cumple.

En el espacio de los números reales, la propiedad de que "una sucesión de Cauchy siempre converge" indica que el espacio es "completo". Este concepto de completitud es la base de la topología moderna y del análisis funcional.

### 2. Teorema integral de Cauchy

No es exagerado decir que la teoría de funciones complejas (análisis complejo) fue fundada casi sin ayuda por Cauchy. Su teorema central es el **Teorema Integral de Cauchy**.
...
De este teorema aparentemente simple, se derivan continuamente resultados asombrosos. Por ejemplo, obtenemos la **Fórmula Integral de Cauchy**, que muestra que el valor de una función está determinado únicamente por sus valores en el límite.
...
[Augustin-Louis Cauchy](https://kenji.blog/p/cauchy/) forjó las matemáticas, que se habían basado en la intuición, en una disciplina académica rigurosa a través del poder de la lógica. Los conceptos y teoremas que creó están profundamente arraigados en todas partes de las matemáticas modernas.
