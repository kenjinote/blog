...
2. **क्रिप्टोग्राफ़िक हस्ताक्षर ([Digital Signature](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/))**: मैनिफेस्ट और छवि के हैश मान (पिक्सेल डेटा का सारांश) दोनों को हार्डवेयर या सॉफ़्टवेयर की निजी कुंजी (private key) का उपयोग करके डिजिटल रूप से हस्ताक्षरित किया जाता है।
