...
2. **Cryptographic Signature (Digital Signature)**: A digital signature is applied to the Manifest and the hash value of the image itself (a summary of the pixel data) using a hardware or software private key.
