...
2. **암호학적 서명([Digital Signature](https://kenji.blog/ko/p/modern-cryptography-public-key-hash-signature/))**: 매니페스트와 이미지 자체의 해시값(픽셀 데이터의 요약)에 대해 하드웨어나 소프트웨어의 비밀키를 사용하여 디지털 서명이 부여됩니다.
