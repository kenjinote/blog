...
`std::unique_ptr` का सबसे बड़ा आकर्षण इसका प्रदर्शन है। कस्टम डिलीटर (deleter) के बिना डिफ़ॉल्ट स्थिति में, `std::unique_ptr` का आकार कच्चे पॉइंटर (Raw [Pointer](https://kenji.blog/hi/p/c-language-pointers-memory-management-stack-heap/)) के बिल्कुल समान होता है। इसमें कोई अनावश्यक सदस्य चर (member variables) नहीं होते हैं, और वर्चुअल फ़ंक्शन का भी उपयोग नहीं किया जाता है। कंपाइलर ऑप्टिमाइज़ेशन के कारण, `std::unique_ptr` के माध्यम से एक्सेस करने पर कच्चे पॉइंटर के समान असेंबली कोड उत्पन्न होता है।
