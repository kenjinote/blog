...
판정하고 싶은 수 $n$ 에 대해 무작위로 기수 $a$ 를 선택하고, [페르마의 소정리](https://kenji.blog/p/fermats-little-theorem/)의 확장에 기반한 특정 조건식을 만족하는지를 테스트합니다.
...
## 3. [몬테카를로법과 라스베이거스법](https://kenji.blog/p/monte-carlo-and-las-vegas-algorithms/)의 비교
