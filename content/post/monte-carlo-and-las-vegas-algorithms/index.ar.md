...
هذه خوارزمية سريعة لتحديد ما إذا كان رقم ضخم هو رقم أولي أم لا. عند إنشاء مفاتيح في تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) وغيره، نحتاج إلى أعداد أولية مكونة من مئات الأرقام. إذا فعلنا ذلك باستخدام طريقة القسمة التجريبية الحتمية (قسمة الرقم على $2, 3, 5, \dots$ على التوالي)، فلن ينتهي الأمر حتى نهاية عمر الكون.

هنا نستخدم طريقة مونت كارلو تسمى **اختبار ميلر-رابين للأولية** (Miller-Rabin primality test).
للرقم المراد اختباره $n$، يتم اختيار أساس عشوائي $a$، واختبار ما إذا كان يفي بشرط معين يعتمد على تمديد [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/).
...
### مثال 2: إنشاء جداول التجزئة ([Hash Table](https://kenji.blog/ar/p/search-algorithms-linear-binary-hash-table-principles/)s)

مثال آخر على طريقة لاس فيغاس هو إنشاء دالة تجزئة مثالية (Perfect [Hash Function](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)).
