...
**[안정 결혼 문제](https://kenji.blog/p/stable-marriage-problem/)**는 이 질문에 명확한 기준을 제시합니다. 이름과 달리 수학적 핵심은 선호를 가진 두 그룹 사이의 일대일 매칭입니다. 여기서는 실제 결혼이나 성별을 가정하지 않고 A, B, C와 X, Y, Z라는 기호를 사용합니다.
