...
**[Задача об устойчивых браках](https://kenji.blog/p/stable-marriage-problem/)** предлагает точный критерий. Несмотря на название, её математическое содержание — взаимно однозначное сопоставление двух групп. Мы будем использовать A, B, C и X, Y, Z, не предполагая определённого пола и не описывая реальные браки.
