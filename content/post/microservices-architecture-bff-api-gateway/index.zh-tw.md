...
在現代軟體開發中，為了提升擴展性與開發的敏捷性，越來越多企業選擇採用 **微服務架構** 。然而，將系統拆分的同時，也意味著會產生新的[複雜度](/zh-tw/p/time-space-complexity-big-o-notation-examples/)。
...
然而，微服務並非「銀彈」。將系統分散化，也伴隨著[分散式系統](/zh-tw/p/cap-theorem-distributed-systems-tradeoff/)特有的[複雜度](/zh-tw/p/time-space-complexity-big-o-notation-examples/)這種「陰影」。
...
微服務架構是讓龐大系統朝可擴展形式進化的一種強大方法，但我們必須面對[分散式系統](/zh-tw/p/cap-theorem-distributed-systems-tradeoff/)所帶來的「陰影」挑戰。
