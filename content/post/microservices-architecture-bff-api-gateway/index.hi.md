...
चूंकि प्रत्येक सेवा का अपना डेटाबेस होता है, इसलिए कई सेवाओं में डेटा (ट्रांजेक्शन) को अपडेट करना बहुत मुश्किल हो जाता है। पारंपरिक [RDBMS](https://kenji.blog/hi/p/rdbms-transaction-acid-isolation-level-lock/) में उपलब्ध [ACID](https://kenji.blog/hi/p/rdbms-transaction-acid-isolation-level-lock/) ट्रांजेक्शन का उपयोग नहीं किया जा सकता है, और इसके बजाय, **Saga पैटर्न** और **इवेंट सोर्सिंग** जैसे जटिल डिज़ाइन पैटर्न पेश करने होंगे जो परिणामी निरंतरता (Eventual [Consistency](https://kenji.blog/hi/p/cap-theorem-distributed-systems-tradeoff/)) की अनुमति देते हैं।
