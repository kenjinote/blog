...
```mermaid
graph LR
    subgraph "Movimento durante a descarga (uso do smartphone)"
        Negative["Ânodo (Grafite)"] -->|"Elétrons (e-) passam pelo fio condutor"| Device(("Smartphone"))
        Device -->|"Elétrons (e-)"| Positive["Cátodo (Óxido metálico)"]
        Negative -.->|"Íons de lítio (Li+) passam pelo eletrólito"| Positive
    end
```
