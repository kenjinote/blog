---
title: "Die Geschichte der Betriebssysteme: Die Geburt von Linux und die Open-Source-Revolution"
description: "Die Geschichte von Linux, das als Hobby eines einzelnen Studenten begann und dazu führte, Server und Smartphones (Android) auf der ganzen Welt zu dominieren."
...
```mermaid
graph LR
    Kernel["Linux-Kernel (Linus, 1991)"] --> OS["GNU/Linux-Betriebssystem"]
    GNU["GNU-Tools (Stallman, 1983)"] --> OS
