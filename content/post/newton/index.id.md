...
```mermaid
flowchart TD
    A["1642: Lahir di Woolsthorpe"] --> B["1661: Masuk Universitas Cambridge"]
    B --> C["1665-1667: Pulang ke rumah akibat Wabah Besar"]
    C -->|"Tahun Keajaiban"| D["Inspirasi Kalkulus, Optika, Gravitasi"]
    D --> E["1669: Diangkat menjadi Profesor Lucasian"]
    E --> F["1687: Menerbitkan Principia"]
    F --> G["1727: Wafat"]
```
