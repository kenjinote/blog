---
title: "Isaac Newton : Approche de la vie du génie à travers la découverte du calcul et de la gravitation universelle"
description: "Une plongée approfondie dans la vie extraordinaire d'Isaac Newton, ses épisodes durant l'Année des Merveilles, et ses découvertes révolutionnaires en mathématiques et en physique."
slug: "newton"
...
```mermaid
flowchart TD
    A["1642 : Naissance à Woolsthorpe"] --> B["1661 : Entre à l'Université de Cambridge"]
    B --> C["1665-1667 : Retourne chez lui en raison de la Grande Peste"]
    C -->|"Année des Merveilles"| D["Inspiration pour le Calcul, l'Optique, la Gravité"]
    D --> E["1669 : Nommé Professeur Lucasien"]
    E --> F["1687 : Publie les Principia"]
    F --> G["1727 : Décès"]
```
