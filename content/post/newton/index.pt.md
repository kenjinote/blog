...
```mermaid
flowchart TD
    A["1642: Nasce em Woolsthorpe"] --> B["1661: Entra na Universidade de Cambridge"]
    B --> C["1665-1667: Volta para casa devido à Grande Peste"]
    C -->|"Ano Miraculoso"| D["Inspiração para o Cálculo, Óptica, Gravidade"]
    D --> E["1669: Nomeado Professor Lucasiano"]
    E --> F["1687: Publica os Principia"]
    F --> G["1727: Falece"]
```
