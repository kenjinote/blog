...
categories: ["Математика", "economics"]
tags:
...
В 1951 году экономист Кеннет Эрроу (Kenneth Arrow) математически доказал, что не существует правила принятия решений, которое было бы совершенным и отвечало бы определенному набору разумных условий. Это и есть **«[Теорема Эрроу о невозможности](https://kenji.blog/ru/p/arrows-impossibility-theorem/) ([Arrow's Impossibility Theorem](https://kenji.blog/ru/p/arrows-impossibility-theorem/))»**. За этот и другие вклады в теорию общественного выбора Эрроу был удостоен Нобелевской премии по экономике в 1972 году.
...
[Теорема Эрроу о невозможности](https://kenji.blog/ru/p/arrows-impossibility-theorem/) математически доказала шокирующий факт: **«Не существует функции общественного благосостояния, которая удовлетворяла бы всем 4 условиям одновременно (наложение условия отсутствия диктатора обязательно приводит к противоречию)»**.
...
[Теорема Эрроу о невозможности](https://kenji.blog/ru/p/arrows-impossibility-theorem/) использовала холодный язык математики, чтобы доказать **«отсутствие идеальных правил для всех»**. Но это не означает поражения демократии.
