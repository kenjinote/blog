...
[Теорема Эрроу о невозможности](https://kenji.blog/p/arrows-impossibility-theorem/) математически доказала шокирующий факт: **«Не существует функции общественного благосостояния, которая удовлетворяла бы всем 4 условиям одновременно (наложение условия отсутствия диктатора обязательно приводит к противоречию)»**.
...
[Теорема Эрроу о невозможности](https://kenji.blog/p/arrows-impossibility-theorem/) использовала холодный язык математики, чтобы доказать **«отсутствие идеальных правил для всех»**. Но это не означает поражения демократии.
