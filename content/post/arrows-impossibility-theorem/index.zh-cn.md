...
1951年，经济学家肯尼斯·阿罗（Kenneth Arrow）在数学上证明了：满足一定合理条件的完美决策规则是不存在的。这就是 **“[阿罗的不可能定理](https://kenji.blog/p/arrows-impossibility-theorem/)（[Arrow's Impossibility Theorem](https://kenji.blog/p/arrows-impossibility-theorem/)）”** 。凭借包含这一成就在内的对社会选择理论的贡献，阿罗于1972年获得了诺贝尔经济学奖。

本文将结合具体例子、数学公式和图解，详细解说这一定理意味着什么。

## 1. 什么是[阿罗的不可能定理](https://kenji.blog/p/arrows-impossibility-theorem/)？

用一句话概括[阿罗的不可能定理](https://kenji.blog/p/arrows-impossibility-theorem/)，就是 **“在3名以上的投票者从3个以上的选项中进行选择时，不可能同时满足『公平的选举（决策规则）』所应满足的多个条件”** 。
...
[阿罗的不可能定理](https://kenji.blog/p/arrows-impossibility-theorem/)，就是用数学证明了 **“同时满足这4个条件的社会福利函数是不存在的（如果施加非独裁性，必然会产生矛盾）”** 这样一个令人震惊的事实。
...
让我们尝试用数学公式和逻辑表达式更严密地表达[阿罗的不可能定理](https://kenji.blog/p/arrows-impossibility-theorem/)。
...
[阿罗的不可能定理](https://kenji.blog/p/arrows-impossibility-theorem/)，运用数学这一冷酷的语言证明了 **“对所有人来说完美的规则是不存在的”** 。但这并不意味着民主主义的失败。
