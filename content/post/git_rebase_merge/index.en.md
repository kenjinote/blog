...
1. **Pointer to a [Tree](https://kenji.blog/en/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) object**: A snapshot of the directory structure and files (Blobs) at that time
