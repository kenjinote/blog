...
استلهم مكارثي من "حساب التفاضل والتكامل لامدا ([Lambda Calculus](/ar/p/lambda-calculus-functional-programming/))" لألونزو تشيرش، وقام ببناء الأساس النظري للغة يمكنها كتابة دوال رياضية بحتة. وكانت النتيجة هي Lisp، التي تمثل بنية البرنامج في بنية بيانات بسيطة للغاية تُعرف بالقائمة (List).
