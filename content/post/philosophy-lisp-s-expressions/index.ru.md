...
Вдохновленный «лямбда-исчислением» ([Lambda Calculus](/ru/p/lambda-calculus-functional-programming/)) Алонзо Чёрча, Маккарти заложил теоретические основы языка, способного описывать чистые математические функции. Результатом стал Lisp — язык, представляющий структуру программы в виде предельно простой структуры данных, называемой списком (List).
