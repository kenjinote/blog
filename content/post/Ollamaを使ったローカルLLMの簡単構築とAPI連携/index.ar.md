...
من أجل توفير نماذج [LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) المحلية على مستوى يمكن أن يتحمل العمليات الفعلية، من الضروري تحليل زمن الوصول (Latency) والإنتاجية (Throughput). تتضمن استجابات Ollama API مقاييس مفصلة تتعلق بالأداء.
