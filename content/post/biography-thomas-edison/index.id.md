---
title: "Kehidupan dan Filosofi 'Penyihir Menlo Park' Thomas Edison: Jejak Inovasi yang Tak Takut Gagal"
...
description: "\"Jenius adalah satu persen inspirasi dan sembilan puluh sembilan persen keringat.\" Thomas Alva Edison (1847-1931), yang meninggalkan kata-kata ini, adalah"
---
...
```mermaid
flowchart TD
    E["Thomas Edison"] --> P["Fonograf (1877)"]
    E --> L["Komersialisasi Bola Lampu Pijar (1879)"]
    E --> M["Kinetoskop (1891)"]
    
    L --> PP["Pembangunan Pembangkit Listrik"]
    PP --> GE["Pendirian General Electric (GE)"]
    
    E --> T["Perang Arus"]
    T --> Tesla["Nikola Tesla (Sistem AC)"]
    T --> EdisonDC["Edison (Sistem DC)"]
```
