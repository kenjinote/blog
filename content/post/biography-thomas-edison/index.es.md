---
title: "La vida y filosofía del 'Mago de Menlo Park' Thomas Edison: Una trayectoria de innovación sin miedo al fracaso"
...
```mermaid
flowchart TD
    E["Thomas Edison"] --> P["Fonógrafo (1877)"]
    E --> L["Comercialización de la bombilla incandescente (1879)"]
    E --> M["Kinetoscopio (1891)"]
    
    L --> PP["Construcción de plantas de energía"]
    PP --> GE["Establecimiento de General Electric (GE)"]
    
    E --> T["Guerra de las corrientes"]
    T --> Tesla["Nikola Tesla (Sistema de CA)"]
    T --> EdisonDC["Edison (Sistema de CC)"]
```
