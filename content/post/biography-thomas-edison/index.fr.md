---
title: "La vie et la philosophie du 'Sorcier de Menlo Park' Thomas Edison : Une trajectoire d'innovation sans peur de l'échec"
...
description: "« Le génie, c'est 1 % d'inspiration et 99 % de transpiration. » Thomas Alva Edison (1847-1931), qui a laissé ces mots, est l'un des inventeurs les plus pro"
---
...
```mermaid
flowchart TD
    E["Thomas Edison"] --> P["Phonographe (1877)"]
    E --> L["Commercialisation de l'ampoule à incandescence (1879)"]
    E --> M["Kinétoscope (1891)"]
    
    L --> PP["Construction de centrales électriques"]
    PP --> GE["Création de General Electric (GE)"]
    
    E --> T["Guerre des courants"]
    T --> Tesla["Nikola Tesla (Système CA)"]
    T --> EdisonDC["Edison (Système CC)"]
```
