---
title: "Das Leben und die Philosophie des 'Zauberers von Menlo Park' Thomas Edison: Ein Weg der Innovation ohne Angst vor dem Scheitern"
...
flowchart TD
    ...
    E --> L["Kommerzialisierung der Glühbirne (1879)"]
    E --> M["Kinetoskop (1891)"]
    
    L --> PP["Bau von Kraftwerken"]
    PP --> GE["Gründung von General Electric (GE)"]
    
    E --> T["Stromkrieg"]
    T --> Tesla["Nikola Tesla (Wechselstromsystem)"]
    T --> EdisonDC["Edison (Gleichstromsystem)"]
```
