...
description: "\"La suerte está echada\", \"Vine, vi, vencí\", \"¿Tú también, Bruto?\" — Incluso aquellos que no están familiarizados con la historia mundial probablemente haya"
---
...
```mermaid
flowchart TD
    A["Nacimiento de César (100 a. C.)"] --> B["Primer Triunvirato (60 a. C.)"]
    B --> C["Guerras Gálicas (58-50 a. C.)"]
    C --> D["Cruce del Rubicón (49 a. C.)"]
    D --> E["Derrota de Pompeyo (48 a. C.)"]
    E --> F["Dictador Perpetuo (44 a. C.)"]
    F --> G["Asesinato (15 de marzo, 44 a. C.)"]
```
