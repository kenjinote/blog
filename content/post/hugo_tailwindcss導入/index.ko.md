...
또한 출력되는 CSS 크기가 항상 최소화되기 때문에 Core [Web Vitals](https://kenji.blog/ko/p/web-vitals-frontend-performance-optimization-lcp-fid-cls/) 점수 향상으로도 직결되며 SEO 관점에서도 매우 유리하게 작용합니다.
