...
```mermaid
flowchart TD
    A["Otto von Bismarck"] --> B["Primer Ministro de Prusia (1862)"]
    B --> C["Política de Sangre y Hierro"]
    
    C --> D["Guerra de los Ducados (1864)"]
    D --> E["Guerra Austro-Prusiana (1866)"]
    E --> F["Confederación Alemana del Norte (1867)"]
    F --> G["Guerra Franco-Prusiana (1870-1871)"]
    G --> H["Unificación de Alemania (1871)"]
    
    H --> I["Sistema Bismarckiano (Aislamiento diplomático de Francia)"]
    I --> J["Doble Alianza con Austria (1879)"]
    I --> K["Triple Alianza con Italia (1882)"]
    I --> L["Tratado de Reaseguro con Rusia (1887)"]
    
    I --> M["Legislación de bienestar social (Política interior)"]
```
