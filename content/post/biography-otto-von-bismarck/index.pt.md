...
```mermaid
flowchart TD
    A["Otto von Bismarck"] --> B["Ministro-Presidente da Prússia (1862)"]
    B --> C["Política de Sangue e Ferro"]
    
    C --> D["Segunda Guerra de Schleswig (1864)"]
    D --> E["Guerra Austro-Prussiana (1866)"]
    E --> F["Confederação da Alemanha do Norte (1867)"]
    F --> G["Guerra Franco-Prussiana (1870-1871)"]
    G --> H["Unificação da Alemanha (1871)"]
    
    H --> I["Sistema de Bismarck (Isolamento Diplomático da França)"]
    I --> J["Dupla Aliança com a Áustria (1879)"]
    I --> K["Tríplice Aliança com a Itália (1882)"]
    I --> L["Tratado de Resseguro com a Rússia (1887)"]
    
    I --> M["Legislação de Bem-Estar Social (Política Interna)"]
```
