---
title: "Kanselir Besi Otto von Bismarck: Arsitek Penyatuan Jerman dan Realpolitiknya"
...
```mermaid
flowchart TD
    A["Otto von Bismarck"] --> B["Presiden Menteri Prusia (1862)"]
    B --> C["Kebijakan Darah dan Besi"]
    
    C --> D["Perang Schleswig Kedua (1864)"]
    D --> E["Perang Austria-Prusia (1866)"]
    E --> F["Konfederasi Jerman Utara (1867)"]
    F --> G["Perang Prancis-Prusia (1870-1871)"]
    G --> H["Penyatuan Jerman (1871)"]
    
    H --> I["Sistem Bismarck (Isolasi Diplomatik Prancis)"]
    I --> J["Aliansi Ganda dengan Austria (1879)"]
    I --> K["Aliansi Tiga dengan Italia (1882)"]
    I --> L["Perjanjian Reasuransi dengan Rusia (1887)"]
    
    I --> M["Legislasi Kesejahteraan Sosial (Kebijakan Domestik)"]
```
