---
title: "Der Eiserne Kanzler Otto von Bismarck: Architekt der deutschen Reichsgründung und seine Realpolitik"
...
```mermaid
flowchart TD
    A["Otto von Bismarck"] --> B["Ministerpräsident von Preußen (1862)"]
    B --> C["Blut-und-Eisen-Politik"]
    
    C --> D["Deutsch-Dänischer Krieg (1864)"]
    D --> E["Deutscher Krieg (1866)"]
    E --> F["Norddeutscher Bund (1867)"]
    F --> G["Deutsch-Französischer Krieg (1870-1871)"]
    G --> H["Reichsgründung (1871)"]
    
    H --> I["Bündnissystem Bismarcks (Diplomatische Isolierung Frankreichs)"]
    I --> J["Zweibund mit Österreich (1879)"]
    I --> K["Dreibund mit Italien (1882)"]
    I --> L["Rückversicherungsvertrag mit Russland (1887)"]
    
    I --> M["Sozialgesetzgebung (Innenpolitik)"]
```
