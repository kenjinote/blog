...
```mermaid
graph TD
    A["Henrietta Lacks"] -- "Tumor biopsy (without consent)" --> B["Johns Hopkins Hospital"]
    B -- "Provision of tissue sample" --> C["Dr. George Gey's Laboratory"]
    C -- "Cultivation in special medium" --> D["Birth of HeLa cells (immortalized cells)"]
    D -- "Free distribution" --> E["Research institutions worldwide"]
    E -- "Utilization for medical research" --> F["Polio vaccine, cancer research, genetic engineering"]
```
...
```mermaid
graph LR
    A["Contributions of HeLa Cells"] --> B["Virus Research"]
    A --> C["Genetics & Cell Biology"]
    A --> D["Medicine & Drug Development"]
    
    B --> B1["Polio vaccine testing"]
    B --> B2["HIV, papillomavirus research"]
    
    C --> C1["Determination of human chromosome number (46)"]
    C --> C2["Discovery of telomerase"]
    C --> C3["Foundation of cloning technology"]
    
    D --> D1["Anticancer drug testing"]
    D --> D2["Development of IVF technology"]
    D --> D3["COVID-19 vaccine research"]
```
