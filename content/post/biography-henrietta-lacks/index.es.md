---
title: "Henrietta Lacks y las células inmortales HeLa: la historia no contada que dio forma a la medicina moderna"
date: "2026-09-24T19:44:38+09:00"
description: "Una mirada profunda a la vida de Henrietta Lacks, los avances científicos de las células HeLa, esenciales para la medicina y la biología modernas, y su profundo impacto en la bioética."
...
```mermaid
graph TD
    A["Henrietta Lacks"] -- "Biopsia de tumor (sin consentimiento)" --> B["Hospital Johns Hopkins"]
    B -- "Provisión de muestra de tejido" --> C["Laboratorio del Dr. George Gey"]
    C -- "Cultivo en medio especial" --> D["Nacimiento de células HeLa (células inmortalizadas)"]
    D -- "Distribución gratuita" --> E["Instituciones de investigación de todo el mundo"]
    E -- "Utilización para investigación médica" --> F["Vacuna contra la polio, investigación del cáncer, ingeniería genética"]
```
...
```mermaid
graph LR
    A["Contribuciones de las células HeLa"] --> B["Investigación de virus"]
    A --> C["Genética y biología celular"]
    A --> D["Medicina y desarrollo de fármacos"]
    
    B --> B1["Pruebas de la vacuna contra la polio"]
    B --> B2["Investigación del VIH y del papilomavirus"]
    
    C --> C1["Determinación del número de cromosomas humanos (46)"]
    C --> C2["Descubrimiento de la telomerasa"]
    C --> C3["Base de la tecnología de clonación"]
    
    D --> D1["Pruebas de medicamentos contra el cáncer"]
    D --> D2["Desarrollo de tecnología de FIV"]
    D --> D3["Investigación de la vacuna COVID-19"]
```
