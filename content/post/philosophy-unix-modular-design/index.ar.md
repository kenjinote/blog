...
تكوين الدوال في البرمجة الوظيفية (استخدام مخرجات دالة كمدخلات لدالة أخرى) له تشابه رياضي مع مفهوم خطوط أنابيب يونيكس. تعد معالجة التدفق في معالجة البيانات الضخمة مثل Apache Kafka أيضًا تطبيقًا لمفهوم تدفق النص في الأنظمة الموزعة.
