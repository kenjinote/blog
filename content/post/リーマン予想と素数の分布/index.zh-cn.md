...
15岁的天才数学家[卡尔·弗里德里希·高斯](https://kenji.blog/zh-cn/p/gauss/)（[Carl Friedrich Gauss](https://kenji.blog/zh-cn/p/gauss/)）计算了庞大的素数表，并发现素数出现的频率与自然对数 $\ln x$ 成反比而递减。也就是说，他推测在一个数 $x$ 附近找到素数的概率大约是 $\frac{1}{\ln x}$。
...
这里的 $\Gamma(x)$ 是[伽玛函数](https://kenji.blog/zh-cn/p/gamma-function/)。通过这个方程，可以从右半平面的性质得知左半平面的性质。
...
像都市传说一样，有人说“一旦黎曼猜想被解开，[RSA](https://kenji.blog/zh-cn/p/modern-cryptography-public-key-hash-signature/)加密就会瞬间崩溃”， **但这在数学上是不准确的。**
