...
Die stärkste Waffe bei der Analyse der Verteilung von Primzahlen ist die **[Riemann](https://kenji.blog/de/p/riemann/)sche Zeta-Funktion (Riemann Zeta Function)**. Ursprünglich war es eine unendliche Reihe, die von [Leonhard Euler](https://kenji.blog/de/p/euler/) für reelle Zahlen $s > 1$ definiert wurde.
...
Wenn wir jedoch annehmen, dass die **"Erweiterte [Riemann](https://kenji.blog/de/p/riemann/)sche Vermutung" (Generalized Riemann Hypothesis, GRH)**, die die [Riemann](https://kenji.blog/de/p/riemann/)sche Vermutung auf die Dirichletschen L-Funktionen erweitert, wahr ist, ändert sich die Situation dramatisch.
...
Es ist extrem wahrscheinlich, dass während des Prozesses des Beweises der [Riemann](https://kenji.blog/de/p/riemann/)schen Vermutung **"neue mathematische Werkzeuge" oder "unbekannte Analysemethoden" entdeckt werden**. Die Geschichte zeigt, dass bei Beweisen wie dem Großen Fermatschen Satz oder der [Poincaré](https://kenji.blog/de/p/poincare/)-Vermutung neue Theorien entwickelt wurden, die die gesamte Mathematik maßgeblich vorangebracht haben.
