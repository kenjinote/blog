...
أقوى سلاح في تحليل توزيع الأعداد الأولية هو **دالة زيتا لريمان (Riemann Zeta Function)**. في الأصل، كانت متسلسلة لانهائية تم تعريفها من قبل ليونهارت أويلر ([Leonhard Euler](https://kenji.blog/ar/p/euler/)) للأعداد الحقيقية $s > 1$:
