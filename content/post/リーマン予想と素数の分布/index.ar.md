...
أقوى سلاح في تحليل توزيع الأعداد الأولية هو **دالة زيتا لريمان (Riemann Zeta Function)**. في الأصل، كانت متسلسلة لانهائية تم تعريفها من قبل ليونهارت أويلر ([Leonhard Euler](https://kenji.blog/p/euler/)) للأعداد الحقيقية $s > 1$:
...
حيث $\Gamma(x)$ هي [دالة غاما](https://kenji.blog/p/gamma-function/). من خلال هذه المعادلة، يمكننا معرفة خصائص النصف الأيسر من المستوى بناءً على خصائص النصف الأيمن.
...
لأنه في عملية إثبات فرضية ريمان، هناك احتمال كبير جداً لاكتشاف **"أدوات رياضية جديدة" أو "أساليب تحليل غير معروفة"**. بالنظر إلى التاريخ، عندما تم إثبات [مبرهنة فيرما الأخيرة](https://kenji.blog/p/fermats-last-theorem/) أو [حدسية بوانكاريه](https://kenji.blog/p/poincare-conjecture/)، فإن النظريات الجديدة التي طُورت خلال تلك العملية دفعت الرياضيات بأكملها إلى قفزات هائلة.
