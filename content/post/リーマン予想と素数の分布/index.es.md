...
El arma más poderosa para analizar la distribución de los números primos es la **función zeta de Riemann (Riemann Zeta Function)**. Originalmente fue una serie infinita definida por [Leonhard Euler](https://kenji.blog/es/p/euler/) para números reales $s > 1$.
