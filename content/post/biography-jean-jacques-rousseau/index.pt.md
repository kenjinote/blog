---
title: "A Vida e o Pensamento de Jean-Jacques Rousseau: O Inconformista do Iluminismo que Buscou Liberdade e Igualdade"
...
```mermaid
graph TD
    A["Jean-Jacques Rousseau"] --> B["Crítica ao Pensamento Iluminista"]
    A --> C["Filosofia Política"]
    A --> D["Educação e Visão da Humanidade"]
    
    B --> E["Discurso sobre as Ciências e as Artes"]
    B --> F["Discurso sobre a Desigualdade"]
    
    C --> G["O Contrato Social"]
    G --> H["Soberania Popular e Vontade Geral"]
    H --> I["Contribuição Ideológica para a Revolução Francesa"]
    
    D --> J["Emílio"]
    J --> K["Descoberta da Criança e Crescimento Natural"]
    K --> L["Origens da Pedagogia Moderna e do Romantismo"]
```
