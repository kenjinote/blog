---
title: "Kehidupan dan Pemikiran Jean-Jacques Rousseau: Tokoh Pembaharu Pencerahan yang Mengejar Kebebasan dan Kesetaraan"
...
```mermaid
graph TD
    A["Jean-Jacques Rousseau"] --> B["Kritik terhadap Pemikiran Pencerahan"]
    A --> C["Filsafat Politik"]
    A --> D["Pendidikan dan Pandangan tentang Kemanusiaan"]
    
    B --> E["Wacana tentang Ilmu Pengetahuan dan Seni"]
    B --> F["Wacana tentang Ketidaksetaraan"]
    
    C --> G["Kontrak Sosial"]
    G --> H["Kedaulatan Rakyat dan Kehendak Umum"]
    H --> I["Kontribusi Ideologis pada Revolusi Prancis"]
    
    D --> J["Emile"]
    J --> K["Penemuan Anak dan Pertumbuhan Alami"]
    K --> L["Asal-usul Pedagogi Modern dan Romantisisme"]
```
