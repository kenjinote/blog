---
title: "La vie et la pensée de Jean-Jacques Rousseau : Le non-conformiste des Lumières qui a poursuivi la liberté et l'égalité"
...
description: "Dans l'Europe du XVIIIe siècle, alors que la pensée des Lumières, qui considérait la raison comme suprême, s'épanouissait, un homme a défié la tendance et"
---
...
```mermaid
graph TD
    A["Jean-Jacques Rousseau"] --> B["Critique de la pensée des Lumières"]
    A --> C["Philosophie politique"]
    A --> D["Éducation et vision de l'humanité"]
    
    B --> E["Discours sur les sciences et les arts"]
    B --> F["Discours sur l'origine de l'inégalité"]
    
    C --> G["Du contrat social"]
    G --> H["Souveraineté populaire et volonté générale"]
    H --> I["Contribution idéologique à la Révolution française"]
    
    D --> J["Émile"]
    J --> K["Découverte de l'enfant et croissance naturelle"]
    K --> L["Origines de la pédagogie moderne et du romantisme"]
```
