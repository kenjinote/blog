---
title: "La vida y el pensamiento de Jean-Jacques Rousseau: El inconformista de la Ilustración que persiguió la libertad y la igualdad"
...
description: "En la Europa del siglo XVIII, mientras florecía el pensamiento ilustrado que consideraba la razón como suprema, hubo un hombre que desafió la corriente y c"
---
...
```mermaid
graph TD
    A["Jean-Jacques Rousseau"] --> B["Crítica al pensamiento ilustrado"]
    A --> C["Filosofía política"]
    A --> D["Educación y visión de la humanidad"]
    
    B --> E["Discurso sobre las ciencias y las artes"]
    B --> F["Discurso sobre el origen de la desigualdad"]
    
    C --> G["El contrato social"]
    G --> H["Soberanía popular y voluntad general"]
    H --> I["Contribución ideológica a la Revolución Francesa"]
    
    D --> J["Emilio"]
    J --> K["Descubrimiento del niño y crecimiento natural"]
    K --> L["Orígenes de la pedagogía moderna y el romanticismo"]
```
