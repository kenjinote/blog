...
このようにして生成される直交する多項式の列は **[ルジャンドル](https://kenji.blog/p/legendre/)多項式 ([Legendre](https://kenji.blog/p/legendre/) polynomials)** と呼ばれ、物理学における電磁気学や量子力学、数値積分（[ガウス](https://kenji.blog/p/gauss/)求積法）において非常に重要な役割を果たしています。代数的なアルゴリズムが、深い物理法則の記述を自然と導き出す美しい例です。
