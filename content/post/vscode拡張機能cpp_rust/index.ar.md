...
`Error Lens` هي إضافة ثورية تبرز أخطاء القوالب الطويلة في C++ وأخطاء فحص الاستعارة ([Borrow Checker](https://kenji.blog/ar/p/memory-management-garbage-collection/)) الصارمة في Rust مضمنةً مباشرة على يمين السطر ذي الصلة في المحرر.
