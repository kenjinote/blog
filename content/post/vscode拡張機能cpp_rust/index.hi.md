...
`Error Lens` एक क्रांतिकारी एक्सटेंशन है जो C++ की लंबी टेम्पलेट त्रुटियों या Rust की सख्त बरो चेकर ([Borrow Checker](https://kenji.blog/hi/p/memory-management-garbage-collection/)) त्रुटियों को सीधे एडिटर में संबंधित लाइन के दाईं ओर इनलाइन हाइलाइट करता है।
