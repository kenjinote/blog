...
विंडोज़ शेड्यूलिंग में, हार्डवेयर इंटरप्ट्स (ISR: Interrupt [Service](https://kenji.blog/hi/p/kubernetes-k8s-architecture-pod-service-ingress/) Routine) और DPC (Deferred Procedure Call) को सामान्य यूज़र थ्रेड्स की तुलना में उच्च प्राथमिकता (IRQL: Interrupt Request Level) पर निष्पादित किया जाता है। अर्थात, यदि कोई खराब ड्राइवर DPC को लंबा खींचता है, तो CPU उस कोर पर कोई अन्य कार्य बिल्कुल नहीं कर पाएगा।
...
*   **[Service](https://kenji.blog/hi/p/kubernetes-k8s-architecture-pod-service-ingress/)s / Drivers**: कर्नेल मोड में चलने वाले ड्राइवर। आप यहां उन संदिग्ध `.sys` फाइलों को अक्षम कर सकते हैं जो पहले बताए गए 100% CPU स्पाइक का कारण बनती हैं।
...
TCPView सभी [TCP](https://kenji.blog/hi/p/http3-quic-protocol-tcp-udp/) और [UDP](https://kenji.blog/hi/p/http3-quic-protocol-tcp-udp/) एंडपॉइंट्स को वास्तविक समय में मॉनिटर करता है, और सूचीबद्ध करता है कि कौन सा प्रोसेस किस रिमोट एड्रेस और पोर्ट के साथ संचार कर रहा है।
...
यदि आपको कोई संदिग्ध संचार मिलता है, तो आप [TCP](https://kenji.blog/hi/p/http3-quic-protocol-tcp-udp/) सत्र को जबरन डिस्कनेक्ट (RST पैकेट जारी करना) करने के लिए TCPView से सीधे `Close Connection` भेज सकते हैं, या `End Process` का उपयोग करके संबंधित प्रोसेस को जबरदस्ती समाप्त कर सकते हैं।
