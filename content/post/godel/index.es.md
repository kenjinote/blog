...
[La paradoja de Russell](/es/p/russells-paradox/) considera "el conjunto de todos los conjuntos que no se contienen a sí mismos como miembros". Si este conjunto se contiene a sí mismo, contradice su propia definición; si no se contiene a sí mismo, debe por definición ser un miembro de sí mismo, lo que conduce de nuevo a una contradicción. Este descubrimiento expuso la extrema fragilidad de los fundamentos matemáticos de la época, que se basaban en gran medida en el razonamiento intuitivo.
