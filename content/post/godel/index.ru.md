...
[Теоремы Гёделя о неполноте](https://kenji.blog/p/godels-incompleteness-theorems/) и идея гёделевой нумерации оказали прямое и глубокое влияние на зарождение теории вычислений. Британский математик [Алан Тьюринг](https://kenji.blog/p/turing/) применил логику Гёделя для создания абстрактной вычислительной модели, известной как «машина Тьюринга», и доказал, что существуют проблемы, которые не могут быть решены никаким алгоритмом (Проблема остановки). Примерно в то же время Алонзо Чёрч пришел к аналогичному выводу, используя лямбда-исчисление.
