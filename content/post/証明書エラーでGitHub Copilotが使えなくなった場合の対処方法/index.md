---
title: 'GitHub Copilotの証明書エラー対処法（UNABLE_TO_VERIFY_LEAF_SIGNATURE）'
...
image: "img.webp"
categories: ["ツール・開発環境"]
description: 'GitHub Copilotで「unable to verify the first certificate」等の証明書エラーが発生して使えなくなった際の解決方法を解説します。ESETの設定変更による具体的な手順を紹介しています。'
---
