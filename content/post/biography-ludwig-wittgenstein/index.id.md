...
description: "Ludwig Wittgenstein (1889–1951) adalah salah satu filsuf paling penting dan berpengaruh di abad ke-20."
---
...
```mermaid
flowchart TD
    A["Kelahiran Wittgenstein (1889)"] --> B["Minat dari Teknik ke Matematika dan Logika"]
    B --> C["Penelitian di Cambridge"]
    
    C --- D["Bertrand Russell"]
    D -.->|"Menemukan Bakat"| C

    C --> E["Berpartisipasi dalam Perang Dunia I"]
    E --> F["Penulisan Tractatus Logico-Philosophicus"]
    F --> G["Apa yang tidak bisa dibicarakan, harus disikapi dengan diam"]
    
    G --> H["Pensiun dari Filsafat (Guru & Arsitek)"]
    H --> I["Interaksi dengan Lingkaran Wina"]
    I --> J["Kembali ke Cambridge (1929)"]
    
    J --> K["Gagasan Investigasi Filosofis"]
    K --> L["Konsep Permainan Bahasa"]
    L --> M["Makna adalah penggunaan bahasa"]

    F -.->|"Filsafat Awal (Batas Logika)"| N["Pengaruh kuat pada Positivisme Logis"]
    K -.->|"Filsafat Akhir (Bahasa Sehari-hari)"| O["Pengaruh pada Aliran Bahasa Biasa dan Filsafat Analitik"]
```
