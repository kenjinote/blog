---
title: "Ludwig Wittgenstein: O Filósofo Genial que Viveu Entre o Silêncio e o Cotidiano"
...
description: "Ludwig Wittgenstein (1889–1951) foi um dos filósofos mais importantes e influentes do século XX."
---
...
```mermaid
flowchart TD
    A["Nascimento de Wittgenstein (1889)"] --> B["Do interesse por engenharia para matemática e lógica"]
    B --> C["Pesquisa em Cambridge"]
    
    C --- D["Bertrand Russell"]
    D -.->|"Descobre seu talento"| C

    C --> E["Serviço na Primeira Guerra Mundial"]
    E --> F["Escrita do Tractatus Logico-Philosophicus"]
    F --> G["Sobre aquilo de que não se pode falar, deve-se calar"]
    
    G --> H["Aposentadoria da filosofia (Professor e Arquiteto)"]
    H --> I["Interação com o Círculo de Viena"]
    I --> J["Retorno a Cambridge (1929)"]
    
    J --> K["Concepção de Investigações Filosóficas"]
    K --> L["Conceito de Jogos de Linguagem"]
    L --> M["O significado é o uso da linguagem"]

    F -.->|"Primeira Filosofia (Limites da Lógica)"| N["Forte influência no Positivismo Lógico"]
    K -.->|"Filosofia Tardia (Linguagem Cotidiana)"| O["Influência na Escola da Linguagem Comum e Filosofia Analítica"]
```
