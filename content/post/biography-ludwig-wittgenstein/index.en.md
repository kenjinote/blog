---
title: "Ludwig Wittgenstein: The Genius Philosopher Who Lived Between Silence and the Everyday"
date: 2026-09-23T19:53:31+09:00
categories: ["biography"]
tags: ["ludwig-wittgenstein", "history"]
image: "eyecatch.jpg"
slug: "biography-ludwig-wittgenstein"
description: "Ludwig Wittgenstein (1889–1951) is one of the most important and influential philosophers of the 20th century."
---
...
```mermaid
flowchart TD
    A["Wittgenstein's Birth (1889)"] --> B["Interest shifts from engineering to math and logic"]
    B --> C["Research at Cambridge"]
    
    C --- D["Bertrand Russell"]
    D -.->|"Discovers his talent"| C

    C --> E["Service in World War I"]
    E --> F["Writing of Tractatus Logico-Philosophicus"]
    F --> G["Whereof one cannot speak thereof one must be silent"]
    
    G --> H["Retirement from philosophy (Teacher and Architect)"]
    H --> I["Interaction with the Vienna Circle"]
    I --> J["Return to Cambridge (1929)"]
    
    J --> K["Conception of Philosophical Investigations"]
    K --> L["Concept of language games"]
    L --> M["Meaning is the use of language"]

    F -.->|"Early philosophy (Limits of logic)"| N["Strong influence on logical positivism"]
    K -.->|"Later philosophy (Ordinary language)"| O["Influence on ordinary language philosophy and analytic philosophy"]
```
