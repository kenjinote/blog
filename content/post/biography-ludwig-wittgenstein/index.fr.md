---
title: "Ludwig Wittgenstein : Le génie de la philosophie entre silence et quotidien"
date: 2026-09-23T19:53:31+09:00
categories: ["biography"]
tags: ["ludwig-wittgenstein", "history"]
image: "eyecatch.jpg"
slug: "biography-ludwig-wittgenstein"
description: "Ludwig Wittgenstein (1889–1951) est l'un des philosophes les plus importants et influents du XXe siècle."
---
...
```mermaid
flowchart TD
    A["Naissance de Wittgenstein (1889)"] --> B["Intérêt pour les mathématiques et la logique depuis l'ingénierie"]
    B --> C["Recherche à Cambridge"]
    
    C --- D["Bertrand Russell"]
    D -.->|"Découvre son talent"| C

    C --> E["Service militaire de la Première Guerre mondiale"]
    E --> F["Rédaction du Tractatus Logico-Philosophicus"]
    F --> G["Ce dont on ne peut parler, il faut le taire"]
    
    G --> H["Retraite de la philosophie (enseignant/architecte)"]
    H --> I["Interaction avec le Cercle de Vienne"]
    I --> J["Retour à Cambridge (1929)"]
    
    J --> K["Inspiration pour les Recherches philosophiques"]
    K --> L["Concept de jeux de langage"]
    L --> M["La signification est l'usage du langage"]

    F -.->|"Première philosophie (Limites de la logique)"| N["Forte influence sur le positivisme logique"]
    K -.->|"Seconde philosophie (Langage ordinaire)"| O["Influence sur la philosophie du langage ordinaire et analytique"]
```
