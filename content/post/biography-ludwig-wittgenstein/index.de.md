---
title: "Ludwig Wittgenstein: Das Genie der Philosophie zwischen Schweigen und Alltag"
date: 2026-09-23T19:53:31+09:00
categories: ["biography"]
tags: ["ludwig-wittgenstein", "history"]
image: "eyecatch.jpg"
slug: "biography-ludwig-wittgenstein"
description: "Ludwig Wittgenstein (1889–1951) ist einer der wichtigsten und einflussreichsten Philosophen des 20."
---
...
```mermaid
flowchart TD
    A["Geburt von Wittgenstein (1889)"] --> B["Interesse von den Ingenieurwissenschaften an Mathematik und Logik"]
    B --> C["Forschung in Cambridge"]
    
    C --- D["Bertrand Russell"]
    D -.->|"Erkennt sein Talent"| C

    C --> E["Dienst im Ersten Weltkrieg"]
    E --> F["Verfassen des Tractatus Logico-Philosophicus"]
    F --> G["Wovon man nicht sprechen kann, darüber muss man schweigen"]
    
    G --> H["Rückzug aus der Philosophie (Lehrer, Architekt)"]
    H --> I["Austausch mit dem Wiener Kreis"]
    I --> J["Rückkehr nach Cambridge (1929)"]
    
    J --> K["Konzeption der Philosophischen Untersuchungen"]
    K --> L["Konzept der Sprachspiele"]
    L --> M["Bedeutung ist der Gebrauch der Sprache"]

    F -.->|"Frühphilosophie (Grenzen der Logik)"| N["Starker Einfluss auf den logischen Empirismus"]
    K -.->|"Spätphilosophie (Alltagssprache)"| O["Einfluss auf die Philosophie der normalen Sprache und die analytische Philosophie"]
```
