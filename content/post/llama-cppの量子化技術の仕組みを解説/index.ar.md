...
## 1. مقدمة: لماذا تحتاج النماذج اللغوية الكبيرة ([LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/)) إلى التكميم (Quantization)؟
...
تم تقديم **GGUF** في أغسطس 2023، وهي صيغة عالية التنوع مصممة لحل هذه المشكلات. أكبر ميزة لها هي اعتمادها على ** هيكل بيانات وصفية (Metadata) يعتمد على المفتاح والقيمة ([Key-Value](https://kenji.blog/ar/p/nosql-database-selection-kvs-document-graph-wide-column/))**.
