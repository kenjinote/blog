...
### 2.1 ऑब्जेक्ट मॉडल: Blob, [Tree](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/), Commit
...
2. **[Tree](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)**
   यह एक ऑब्जेक्ट है जो डायरेक्टरी की संरचना को दर्शाता है। Tree ऑब्जेक्ट में अन्य Tree ऑब्जेक्ट्स (सबडायरेक्टरी) या Blob ऑब्जेक्ट्स (फ़ाइलें) के [पॉइंटर्स](/hi/p/c-language-pointers-memory-management-stack-heap/) (SHA-1 हैश मान), साथ ही उनके फ़ाइल नाम और एक्सेस अनुमतियां शामिल होती हैं। यह UNIX डायरेक्टरी की तरह काम करता है।
3. **Commit**
...
Git ब्रांच केवल हल्के [पॉइंटर्स](/hi/p/c-language-pointers-memory-management-stack-heap/) (फ़ाइलें) हैं जो विशिष्ट कमिट्स को इंगित करते हैं। केवल इस तथ्य को जानने से यह डर दूर हो जाता है कि "अगर मैं ब्रांच को हटा दूं तो क्या सारी फ़ाइलें गायब हो जाएंगी?"
...
Git में, कमिट स्वतंत्र ऑब्जेक्ट हैं, और ब्रांच केवल [पॉइंटर्स](/hi/p/c-language-pointers-memory-management-stack-heap/) हैं। इसलिए, आप "एक नई ब्रांच बनाकर और फिर वर्तमान ब्रांच के पॉइंटर को पीछे हटाकर" इसे तुरंत हल कर सकते हैं।
...
आइए इस दौरान ब्रांच [पॉइंटर्स](/hi/p/c-language-pointers-memory-management-stack-heap/) की गति की कल्पना करने के लिए Mermaid के `gitGraph` का उपयोग करें।
...
Git में एक अंतर्निहित उपकरण है जो गणितीय बाइनरी सर्च ([Binary Search](https://kenji.blog/hi/p/search-algorithms-linear-binary-hash-table-principles/)) के माध्यम से उस कमिट को ढूंढता है जिसने बग पेश किया था। चूँकि जटिलता $\mathcal{O}(\log N)$ है, भले ही 1000 कमिट हों, इसे लगभग 10 परीक्षणों में पहचाना जा सकता है।
