...
- **阿基米德之爪** (The Claw of Archimedes)：一種巨大的類似起重機的機械，據說能將敵船從海裡吊起並將其傾覆。
...
在這部著作中，阿基米德揭示了他得出眾多幾何發現的「思考過程」。他將圖形分割成無限薄的「線」或「面」的集合，並使用在天平上平衡它們的力學模型來猜測它們的面積和體積。這種方法在本質上與後來[艾薩克·牛頓](https://kenji.blog/p/newton/)和[戈特弗里德·萊布尼茨](https://kenji.blog/p/leibniz/)建立的「積分學」相同，這表明阿基米德離微積分的概念只有一步之遙。
