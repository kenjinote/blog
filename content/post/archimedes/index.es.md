---
title: "El Genio de la Antigua Grecia: Vida y Logros Matemáticos de Arquímedes"
description: "Arquímedes de Siracusa. Desde el episodio de '¡Eureka!' hasta el cálculo de pi, el teorema de la esfera y el cilindro, y el 'Método' que fue pionero del cálculo, profundizamos en la vida y los logros del mayor matemático y físico de la antigua Grecia."
slug: "archimedes"
...
```mermaid
flowchart TD
    A["Esfera"] -->|"Volumen y Área Superficial"| B["Cilindro"]
    B -->|"Proporción"| C["La Esfera es 2/3 del Cilindro"]
    A -->|"Inscrita en"| B
    %% Este es un diagrama que muestra la relación entre una esfera y un cilindro
```
...
```mermaid
flowchart LR
    A["Sumergir objeto en agua"] --> B["Desplazar agua"]
    B --> C["Peso del agua desplazada = Flotabilidad"]
    C --> D["El objeto se vuelve más ligero"]
    %% Proceso del Principio de Arquímedes
```
