...
من البرمجة التنافسية إلى تصميم الخوارزميات العملي، تظهر **البرمجة الديناميكية ([Dynamic Programming](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)، وتُعرف اختصارًا بـ [DP](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/))** في العديد من المواقف، وتشكل عقبة للكثير من المبرمجين. "لا أستطيع صياغة علاقة التكرار"، "تختلط عليّ الفهارس"، "لا أستطيع تحديد ما إذا كان يمكن حل المشكلة باستخدام DP أم لا"...... ربما يعاني الكثيرون من هذه المشاكل.
...
- **العيوب:** 
  ...
  - إذا كان عمق الاستدعاء العودي كبيرًا، فهناك خطر حدوث طفح المكدس ([Stack](https://kenji.blog/ar/p/c-language-pointers-memory-management-stack-heap/) Overflow) (يتطلب ذلك حذرًا خاصًا في لغات مثل Python).
...
أهم خطوة لحل [DP](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) هي تحديد "الحالة ([State](https://kenji.blog/ar/p/iac-infrastructure-as-code-terraform/))" بشكل مناسب.
...
كمشكلة [DP](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) نموذجية تتعامل مع السلاسل النصية، سنتناول الـ LCS. إن خوارزمية LCS مطبقة على نطاق واسع في العالم الحقيقي، مثل الكشف عن الاختلافات في الملفات (أدوات diff) وتقييم التشابه في تسلسلات الحمض النووي.
...
لقد رأينا حتى الآن العديد من المشكلات، ولكن عندما تواجه مشكلة [DP](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) غير مألوفة، كيف يجب أن تفكر؟ ضع في اعتبارك الخطوات التالية دائمًا.
...
2. **تحديد الحالة ([State](https://kenji.blog/ar/p/iac-infrastructure-as-code-terraform/))**
...
قد تبدو البرمجة الديناميكية معقدة في البداية. ومع ذلك، من خلال تكرار التدريب على إيجاد "تعريف الحالة" و "الانتقال" في مشاكل مختلفة، ستبدأ الأنماط في الظهور تدريجيًا. هناك تطبيقات أكثر تقدمًا مثل [Tree](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) [DP](https://kenji.blog/ar/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)، Digit DP، Bit DP، و Interval DP، ولكن جميعها مبنية على أساس "تداخل المشكلات الفرعية" و "التحسين" الذي تعلمناه هذه المرة.
