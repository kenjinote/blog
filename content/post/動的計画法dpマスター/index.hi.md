...
प्रतिस्पर्धी प्रोग्रामिंग से लेकर व्यावहारिक एल्गोरिदम डिज़ाइन तक, कई स्थितियों में जो सामने आता है और कई प्रोग्रामर्स के लिए एक बाधा बन जाता है, वह है **डायनेमिक प्रोग्रामिंग ([Dynamic Programming](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/), जिसे आमतौर पर [DP](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) कहा जाता है)** । "पुनरावृत्ति संबंध (recurrence relation) नहीं बना पा रहा हूँ", "इंडेक्स (subscript) में बग आ रहा है", "यह तय नहीं कर पा रहा कि यह समस्या DP से हल हो सकती है या नहीं"…… ऐसे बहुत से लोग होंगे जो इन समस्याओं से जूझ रहे होंगे।
...
[DP](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) को हल करने के लिए सबसे महत्वपूर्ण कदम "अवस्था ([State](https://kenji.blog/hi/p/iac-infrastructure-as-code-terraform/))" को उचित रूप से परिभाषित करना है।
...
स्ट्रिंग्स को संभालने वाली एक विशिष्ट [DP](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) समस्या के रूप में, हम LCS पर चर्चा करेंगे। LCS एक ऐसा एल्गोरिदम है जिसका उपयोग वास्तविक दुनिया में व्यापक रूप से किया जाता है, जैसे कि फ़ाइल अंतर का पता लगाने (diff टूल) और DNA अनुक्रम समानता निर्धारण के लिए।
...
हमने अब तक विभिन्न समस्याओं को देखा है, लेकिन जब आप किसी अज्ञात [DP](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) समस्या का सामना करते हैं तो आपको कैसे विचार करना चाहिए? कृपया हमेशा निम्नलिखित चरणों को ध्यान में रखें।
...
2. **अवस्था ([State](https://kenji.blog/hi/p/iac-infrastructure-as-code-terraform/)) को परिभाषित करें**
...
डायनेमिक प्रोग्रामिंग पहली बार में मुश्किल लग सकती है। हालाँकि, विभिन्न समस्याओं में "अवस्था परिभाषा" और "संक्रमण" खोजने के अभ्यास को दोहराने से, आपको धीरे-धीरे पैटर्न दिखाई देने लगेंगे। ट्री [DP](https://kenji.blog/hi/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) ([Tree](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) DP), डिजिट DP (Digit DP), बिट DP (Bit DP) और इंटरवल DP (Interval DP) जैसे अधिक उन्नत अनुप्रयोग भी हैं, लेकिन वे सभी "ओवरलैपिंग उप-समस्याएं" और "अनुकूलन" की नींव पर बने हैं जो हमने इस बार सीखे हैं।
