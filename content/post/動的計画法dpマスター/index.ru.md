...
От спортивного программирования до проектирования алгоритмов на практике — **динамическое программирование ([Dynamic Programming](https://kenji.blog/ru/p/dynamic-programming-dp-introduction-knapsack-fibonacci/), сокращенно [DP](https://kenji.blog/ru/p/dynamic-programming-dp-introduction-knapsack-fibonacci/))** появляется во многих ситуациях и часто становится препятствием для многих программистов. «Не могу составить рекуррентное соотношение», «Ошибки с индексами», «Вообще не могу понять, решается ли эта задача с помощью DP»... Наверное, многие сталкивались с подобными проблемами.
...
Самый важный шаг для решения с помощью [DP](https://kenji.blog/ru/p/dynamic-programming-dp-introduction-knapsack-fibonacci/) — это правильное определение «состояния» ([State](https://kenji.blog/ru/p/iac-infrastructure-as-code-terraform/)).
...
В качестве классической [DP](https://kenji.blog/ru/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)-задачи для работы со строками мы рассмотрим LCS. LCS — это алгоритм, который широко применяется в реальном мире, например, в утилитах для сравнения файлов (инструменты diff) и для определения сходства последовательностей ДНК.
...
К настоящему моменту мы рассмотрели различные задачи, но как следует думать, столкнувшись с неизвестной задачей [DP](https://kenji.blog/ru/p/dynamic-programming-dp-introduction-knapsack-fibonacci/)? Всегда держите в уме следующие шаги.
...
2. **Определение состояния ([State](https://kenji.blog/ru/p/iac-infrastructure-as-code-terraform/))**
