...
```mermaid
graph TD
    A["Increase in given time"] -- "Causes" --> B["Complexity and excessive quality of work"]
    A -- "Causes" --> C["Decrease in psychological pressure and procrastination"]
    B -- "Results in" --> D["Occurrence of useless work"]
    C -- "Results in" --> D
    D -- "Ultimately leads to" --> E["Decline in productivity and completion just before the deadline"]
...
```mermaid
graph LR
    F["Task occurrence"] -- "Follows Parkinson's Law" --> G["Dragging on work until the deadline"]
    F -- "Applying overcoming approach" --> H["Setting tight artificial deadlines and timeboxing"]
    H -- "Dramatic improvement in concentration" --> I["High-quality and early completion"]
    I -- "Creation of spare time" --> J["Next important task or intentional rest"]
    G -- "Accumulation of fatigue and compromise" --> K["Low-quality delivery at the last minute"]
