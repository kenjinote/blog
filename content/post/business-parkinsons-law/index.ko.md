...
2. **완벽주의의 함정**
   시간이 허락하는 한 "더 잘할 수 있지 않을까"라며 수정을 거듭해 버립니다. [파레토의 법칙(80](/ko/p/business-pareto-principle/):20의 법칙)에 따르면, 80%의 성과를 내기 위해 필요한 시간은 20%이지만, 나머지 20%의 품질을 완벽하게 만들기 위해 80%의 시간을 낭비해 버립니다.
