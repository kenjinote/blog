...
आधुनिक समाज के डिजिटल बुनियादी ढांचे का आधार [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) और [एलिप्टिक कर्व क्रिप्टोग्राफी](/hi/p/elliptic-curve-cryptography-math-cpp/) ([ECC](/hi/p/elliptic-curve-cryptography-math-cpp/)) जैसी पब्लिक-की क्रिप्टोग्राफी (Public-key cryptography) तकनीकें हैं। इन क्रिप्टोग्राफी विधियों की सुरक्षा "प्राइम फैक्टराइजेशन प्रॉब्लम (Prime Factorization Problem)" और "डिस्क्रीट लॉगरिथम प्रॉब्लम (Discrete Logarithm Problem)" जैसी गणितीय कठिनाइयों पर निर्भर करती है, जिनके बारे में माना जाता है कि पारंपरिक क्लासिकल कंप्यूटरों द्वारा उन्हें कुशलतापूर्वक हल नहीं किया जा सकता है (इसमें एक्सपोनेंशियल समय लगता है)।

हालाँकि, 1994 में पीटर शोर (Peter Shor) द्वारा प्रस्तुत "शोर का एल्गोरिदम ([Shor's Algorithm](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/))" ने क्रिप्टोग्राफी की दुनिया में तहलका मचा दिया। इस एल्गोरिदम ने गणितीय रूप से यह साबित कर दिया कि जब बड़े पैमाने पर क्वांटम कंप्यूटर वास्तविकता बन जाएंगे, तो वे प्राइम फैक्टराइजेशन और डिस्क्रीट लॉगरिथम समस्याओं को पॉलीनोमियल समय (Polynomial time) में हल कर देंगे। इसका अर्थ है कि वर्तमान में व्यापक रूप से उपयोग की जाने वाली पब्लिक-की क्रिप्टोग्राफी भविष्य में पूरी तरह से डिक्रिप्ट (decrypt) की जा सकेगी।

इस तरह के "क्वांटम खतरे (Quantum Threat)" का मुकाबला करने के लिए, नई क्रिप्टोग्राफिक विधियों पर शोध करना एक तत्काल आवश्यकता बन गई, जिन्हें क्वांटम कंप्यूटरों का उपयोग करके भी तोड़ना मुश्किल हो। इस क्षेत्र को "पोस्ट-क्वांटम क्रिप्टोग्राफी (Post-Quantum [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy: PQC)" या "क्वांटम-प्रतिरोधी क्रिप्टोग्राफी" कहा जाता है।
...
**परिभाषा (SVP):**
मान लें कि कोई भी जाली बेसिस $B$ दिया गया है, तो उस जाली $\mathcal{L}(B)$ से संबंधित सभी गैर-शून्य वेक्टरों में से, उस वेक्टर $\mathbf{v}$ का पता लगाएं जिसका [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन नॉर्म (लंबाई) सबसे कम हो।
...
# 5. LWE का उपयोग करके पब्लिक-की क्रिप्टोग्राफी (रेगेव क्रिप्टोग्राफी - Regev [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)system) का निर्माण
...
6. पब्लिक की ([Public Key](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)) $(A, \mathbf{b})$ होगी।
...
Shor का एल्गोरिदम, जो क्वांटम कंप्यूटरों को [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) और [एलिप्टिक कर्व क्रिप्टोग्राफी](/hi/p/elliptic-curve-cryptography-math-cpp/) को तोड़ने की अनुमति देता है, अनिवार्य रूप से "हिडन सबग्रुप प्रॉब्लम (Hidden Subgroup Problem: HSP)" को हल करने के लिए एक एल्गोरिदम है। RSA और [ECC](/hi/p/elliptic-curve-cryptography-math-cpp/) (परिमित एबेलियन समूह / finite [Abel](https://kenji.blog/hi/p/abel/)ian groups) के पीछे की गणितीय संरचना में आवधिकता (periodicity) होती है, और क्वांटम फूरियर ट्रांसफॉर्म (QFT) नामक क्वांटम एल्गोरिदम के लिए विशिष्ट ऑपरेशन का उपयोग करके इस अवधि (छिपे हुए उपसमूह) को एक बार में निकाला जा सकता है।
...
3. LWE समस्या का उपयोग करते हुए, जानबूझकर शोर जोड़ने या हटाने के एक सरल तंत्र के माध्यम से एन्क्रिप्शन और डिक्रिप्शन (**रेगेव क्रिप्टोग्राफी - Regev [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)system**) प्राप्त किया जाता है।
