...
Shor का एल्गोरिदम, जो क्वांटम कंप्यूटरों को [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) और एलिप्टिक कर्व क्रिप्टोग्राफी को तोड़ने की अनुमति देता है, अनिवार्य रूप से "हिडन सबग्रुप प्रॉब्लम (Hidden Subgroup Problem: HSP)" को हल करने के लिए एक एल्गोरिदम है। RSA और ECC (परिमित एबेलियन समूह / finite [Abel](https://kenji.blog/hi/p/abel/)ian groups) के पीछे की गणितीय संरचना में आवधिकता (periodicity) होती है, और क्वांटम फूरियर ट्रांसफॉर्म (QFT) नामक क्वांटम एल्गोरिदम के लिए विशिष्ट ऑपरेशन का उपयोग करके इस अवधि (छिपे हुए उपसमूह) को एक बार में निकाला जा सकता है।
