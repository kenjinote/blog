...
Um dieser "Quantenbedrohung (Quantum Threat)" entgegenzuwirken, wurde die Erforschung neuer kryptographischer Methoden, die selbst für Quantencomputer schwer zu knacken sind, zu einer dringenden Aufgabe. Dieses Feld wird "Post-Quanten-Kryptographie (Post-Quantum [Crypto](https://kenji.blog/de/p/cryptocurrency-and-bitcoin/)graphy: PQC)" oder "quantensichere Kryptographie" genannt.
