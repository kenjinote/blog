...
description: "Mark Elliot Zuckerberg est né le 14 mai 1984 à White Plains, dans l'État de New York."
---
...
```mermaid
graph TD
    A["Enfance et années d'études"] --> B["Développement de ZuckNet"]
    A --> C["Entrée à l'Université Harvard"]
    C --> D["TheFacebook (2004)"]
    D --> E["Expansion mondiale et plateformisation"]
    E --> F["Acquisition d'Instagram et WhatsApp"]
    E --> G["Changement de nom pour Meta (2021)"]
    G --> H["Focus sur le métavers et l'IA"]
```
