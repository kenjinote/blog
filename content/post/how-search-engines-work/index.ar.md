...
تحد الآلة الواحدة من سعة الفهرس ومعدل الطلبات والقدرة على تحمل الأعطال. تقسم [الأنظمة الموزعة](/ar/p/cap-theorem-distributed-systems-tradeoff/) الفهرس إلى أجزاء، تبحث فيها آلات مختلفة، ثم تدمج النتائج. تسمى هذه الأجزاء غالبًا شظايا أو shards.
