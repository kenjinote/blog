...
## अतिरिक्त तकनीकी सत्यापन भाग REPLACE_ME_I
...
out = part0
for i in range(1, 15):
    out += partN_template.replace('REPLACE_ME_I', str(i))
out += "\n"

with codecs.open('c:\\work\\kenji.blog\\content\\post\\physics-led-mechanism\\index.hi.md', 'w', 'utf-8') as f:
    f.write(out)
