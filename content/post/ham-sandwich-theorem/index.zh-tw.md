...
在數學的世界裡，有很多以日常事物命名的奇妙定理。其中最著名、也最直觀有趣的定理之一就是 **「[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)（Ham Sandwich Theorem）」**。

當您製作三明治時，您通常會想像兩片麵包中間夾著一片火腿。這個定理提出了一個令人驚訝的事實：**「無論形狀多麼扭曲，或者它們在空中如何散落，只需用刀切一次（一個平面），就能完美地同時將兩片麵包和一片火腿的體積平分。」**

在本文中，我們將詳細解釋這個[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)，從直觀的理解到其背後的強大代數拓撲學定理——**「博蘇克-烏拉姆定理（Borsuk-Ulam Theorem）」**。
...
令人驚訝的是，根據一個數學定理，**即使在這種情況下，如果你使用一把巨大的刀（一個平面），你仍然可以同時將這三者平分**。這就是「[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)」的精髓。它對物體的相對位置或形狀沒有任何要求，它們甚至不需要是單一的連續塊。

## 2. 從二維開始：煎餅定理

在考慮三維的[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)之前，讓我們先看看二維（平面）的情況。二維版本有時被稱為 **「煎餅定理（Pancake Theorem）」**。
...
## 3. 擴展到三維：[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)
...
為了在數學上嚴格證明[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)，需要用到拓撲學中一個非常重要的定理：**博蘇克-烏拉姆定理（Borsuk-Ulam Theorem）**。
...
這裡，$S^n$ 是 $(n+1)$ 維空間中的 $n$ 維球面（例如，$S^2$ 是像我們居住的地球表面一樣的普通球面），$\mathbb{R}^n$ 是 $n$ 維[歐幾里得](https://kenji.blog/p/euclid/)空間。此外，$x$ 和 $-x$ 指的是球面上的 **對蹠點**（穿過中心的直線的兩端的點，就像地球上的北極和南極，或者東京和巴西沿海）。
...
### [火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)的證明概要

[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)（三維版本）可以使用博蘇克-烏拉姆定理 $n=2$ 的情況來證明。下面是其優美證明的概要。
...
## 5. 廣義 n 維[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)
...
- $n=3$（空間）：用 1 個平面平分 3 個立體的體積（[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)）。
...
「[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)」經常被當作純數學中的一個有趣話題來講述，但它實際上在 **計算幾何** 和 **計算機科學** 等領域有實際應用。

例如，當空間中存在海量資料點（點雲）時，有時會使用[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)的演算法版本來有效地劃分和處理這些資料。透過同時平分被分類為多個類別的資料，它有助於使用分治法構建高效的資料處理和搜尋演算法。

## 7. 結語

乍看之下，[火腿三明治定理](https://kenji.blog/p/ham-sandwich-theorem/)可能像是一個帶有滑稽名字的玩笑，但在現實中，它是現代數學（特別是代數拓撲學）中一個強大定理的優美應用結果。抽象的數學理論透過三明治這樣具體和日常的事物表達出來，這無疑是數學迷人的方面之一。
