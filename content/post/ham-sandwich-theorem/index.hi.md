...
गणित में रोज़मर्रा के नामों वाले कई उत्सुक प्रमेय हैं। उनमें से, सबसे प्रसिद्ध और सहज रूप से दिलचस्प में से एक **[हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/) (Ham Sandwich Theorem)** है।
...
इस लेख में, हम एक सहज समझ से लेकर इसके पीछे की शक्तिशाली बीजीय टोपोलॉजी प्रमेय, **बोरसुक-उलम प्रमेय (Borsuk-Ulam Theorem)** तक, इस [हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/) को विस्तार से समझाएंगे।
...
हैरानी की बात है, एक गणितीय प्रमेय के अनुसार, **तभी, यदि आप एक विशाल चाकू (एक समतल) का उपयोग करते हैं, तो आप एक साथ तीनों को आधा कर सकते हैं**। यह "[हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/)" का सार है। वस्तुओं की सापेक्ष स्थिति या आकार के लिए कोई आवश्यकताएं नहीं हैं, और न ही उन्हें एकल निरंतर टुकड़े होने की आवश्यकता है।

## 2. 2डी से शुरू: पैनकेक प्रमेय

3डी [हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/) पर विचार करने से पहले, आइए 2-आयामी (समतल) मामले को देखें। 2डी संस्करण को कभी-कभी **पैनकेक प्रमेय (Pancake Theorem)** कहा जाता है।
...
## 3. 3डी का विस्तार: [हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/)
...
[हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/) को गणितीय और कठोर रूप से सिद्ध करने के लिए, टोपोलॉजी में एक बहुत ही महत्वपूर्ण प्रमेय का उपयोग किया जाता है: **बोरसुक-उलम प्रमेय (Borsuk-Ulam Theorem)**।
...
यहां, $S^n$, $(n+1)$-आयामी अंतरिक्ष में $n$-आयामी क्षेत्र है (उदाहरण के लिए, $S^2$ पृथ्वी की सतह की तरह एक साधारण क्षेत्र है जिस पर हम रहते हैं), और $\mathbb{R}^n$, $n$-आयामी [यूक्लिड](https://kenji.blog/p/euclid/)ियन अंतरिक्ष है। इसके अलावा, $x$ और $-x$ क्षेत्र पर **एंटीपोडल बिंदुओं** को संदर्भित करते हैं (केंद्र से गुजरने वाली सीधी रेखा के विपरीत किनारों पर स्थित बिंदु, जैसे पृथ्वी पर उत्तरी और दक्षिणी ध्रुव, या टोक्यो और ब्राजील के तट पर)।
...
### [हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/) का प्रमाण स्केच

[हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/) (3D संस्करण) को बोरसुक-उलम प्रमेय के $n=2$ मामले का उपयोग करके सिद्ध किया जा सकता है। नीचे इसके सुंदर प्रमाण का एक रेखाचित्र दिया गया है।
...
## 5. सामान्यीकृत n-आयामी [हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/)
...
- $n=3$ (अंतरिक्ष): 1 समतल के साथ 3 ठोसों की मात्रा को आधा करें ([हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/))।
...
"[हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/)" को अक्सर शुद्ध गणित में एक मजेदार विषय के रूप में बताया जाता है, लेकिन वास्तव में इसके व्यावहारिक अनुप्रयोग **कम्प्यूटेशनल ज्योमेट्री** और **कंप्यूटर साइंस** जैसे क्षेत्रों में हैं।

उदाहरण के लिए, जब अंतरिक्ष में बड़े पैमाने पर डेटा बिंदु (बिंदु बादल) मौजूद होते हैं, तो उस डेटा को कुशलतापूर्वक विभाजित करने और संसाधित करने के लिए कभी-कभी [हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/) के एल्गोरिथम संस्करण का उपयोग किया जाता है। एक साथ कई वर्गों में वर्गीकृत डेटा को आधा करके, यह डिवाइड एंड कॉन्कर दृष्टिकोण का उपयोग करके कुशल डेटा प्रोसेसिंग और खोज एल्गोरिदम बनाने में मदद करता है।

## 7. निष्कर्ष

[हैम सैंडविच प्रमेय](https://kenji.blog/p/ham-sandwich-theorem/) पहली नज़र में एक मज़ेदार नाम वाले मज़ाक जैसा लग सकता है, लेकिन वास्तव में, यह आधुनिक गणित में एक शक्तिशाली प्रमेय, विशेष रूप से बीजीय टोपोलॉजी से लागू एक सुंदर परिणाम है। यह तथ्य कि एक अमूर्त गणितीय सिद्धांत को सैंडविच जैसी ठोस और रोजमर्रा की किसी चीज़ के माध्यम से व्यक्त किया जाता है, यकीनन गणित के आकर्षक पहलुओं में से एक है।
