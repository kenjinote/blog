...
## 3. Extensión a 3D: [El Teorema del Sándwich de Jamón](https://kenji.blog/es/p/ham-sandwich-theorem/)
...
[El Teorema del Sándwich de Jamón](https://kenji.blog/es/p/ham-sandwich-theorem/) (versión 3D) se puede probar utilizando el caso $n=2$ del Teorema de Borsuk-Ulam. A continuación se presenta un esbozo de su hermosa prueba.
