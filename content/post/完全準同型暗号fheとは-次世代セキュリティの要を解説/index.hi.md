...
*   **[RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन (गुणा के लिए समरूपता)**
...
लंबे समय तक, FHE को "क्रिप्टोग्राफी का पवित्र कंठ (Holy Grail of [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy)" कहा जाता था, और यहां तक कहा जाता था कि इसे साकार करना असंभव हो सकता है। हालाँकि, 2009 में, स्टैनफोर्ड विश्वविद्यालय के एक तत्कालीन पीएचडी छात्र **क्रेग जेंट्री (Craig Gentry)** ने आदर्श जालक (Ideal Lattices) का उपयोग करते हुए पहली FHE योजना प्रस्तावित की और दुनिया को चौंका दिया।

---

## 3. FHE का गणितीय आधार: LWE समस्या और Ring-LWE

कई मुख्यधारा की FHE योजनाएँ आज **LWE (Learning With Errors) समस्या** पर आधारित हैं, जो "लैटिस-आधारित क्रिप्टोग्राफी (Lattice-based [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy)" में एक कठिन गणितीय समस्या है, जिसे पोस्ट-क्वांटम क्रिप्टोग्राफी के रूप में भी जाना जाता है।
...
*   **Zama (Concrete)**: TFHE पर आधारित एक फ्रेमवर्क। इसे रस्ट/पायथन ([Rust](https://kenji.blog/hi/p/webassembly-wasm-current-future/)/Python) में लिखा जा सकता है और यह मौजूदा PyTorch मॉडल को संकलित (compile) करने और उन्हें FHE (Concrete ML) पर चलाने की सुविधा प्रदान करता है।
...
1.  **कम्प्यूटेशनल ओवरहेड**: प्लेनटेक्स्ट में गणना की तुलना में, सीपीयू पर सिफरटेक्स्ट में गणना हजारों से दसियों हजार गुना धीमी होती है। बहुपद गुणा और बूटस्ट्रैपिंग के लिए भारी मात्रा में [FFT](/hi/p/fast-fourier-transform-algorithm/) ([फास्ट फूरियर ट्रांसफॉर्म](/hi/p/fast-fourier-transform-algorithm/)) और NTT (नंबर थ्योरेटिक ट्रांसफॉर्म) गणनाओं की आवश्यकता होती है।
...
*   **GPU त्वरण (GPU Acceleration)**: [NVIDIA](/hi/p/history-of-nvidia/) जैसे शक्तिशाली GPU का उपयोग करके NTT गणनाओं और बूटस्ट्रैपिंग को समानांतर करने के प्रयास चल रहे हैं, जिसमें सॉफ्टवेयर कार्यान्वयन की तुलना में दसियों गुना गति में वृद्धि की सूचना है (उदाहरण: 100x.ai, Zama का TFHE-rs CUDA बैकएंड)।
...
3.  **सुरक्षित AI अनुमान API (MaaS: Model as a [Service](https://kenji.blog/hi/p/kubernetes-k8s-architecture-pod-service-ingress/))**:
    उपयोगकर्ता अपनी आवाज़, चेहरे की छवियों और संकेतों (prompts) को एन्क्रिप्ट कर सकते हैं और उन्हें AI सेवाओं (जैसे कि ChatGPT जैसे [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/)) में भेज सकते हैं। AI प्रदाता उपयोगकर्ता के इनपुट को जाने बिना उत्तर उत्पन्न करते हैं और इसे सिफरटेक्स्ट के रूप में वापस करते हैं। यह "AI द्वारा व्यक्तिगत जानकारी सीखने या झाँकने" की चिंताओं को पूरी तरह से दूर करता है।

---

## 9. निष्कर्ष: क्रिप्टोग्राफी का भविष्य "अदृश्य गणना (Invisible Computing)" की ओर

जिस तरह 1970 के दशक में सार्वजनिक कुंजी एन्क्रिप्शन ([RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)) के आविष्कार ने इंटरनेट पर सुरक्षित संचार (जैसे HTTPS) को संभव बनाया, उसी तरह क्रेग जेंट्री द्वारा FHE का आविष्कार क्रिप्टोग्राफी के इतिहास में सबसे महत्वपूर्ण मील के पत्थरों में से एक है।
