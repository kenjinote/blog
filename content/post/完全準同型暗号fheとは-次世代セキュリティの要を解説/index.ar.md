...
تمامًا كما تم اختراع تشفير المفتاح العام ([RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)) في سبعينيات القرن العشرين ومكّن الاتصال الآمن على الإنترنت (مثل HTTPS)، فإن اختراع FHE من قبل كريج جينتري يعد واحدًا من أهم المعالم في تاريخ التشفير.
