...
*   **تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) (التماثل بالنسبة للضرب)**
...
1.  **عبء الحساب**: مقارنة بالحساب في النص الصريح، يكون الحساب في النص المشفر أبطأ بآلاف إلى عشرات الآلاف من المرات على وحدات المعالجة المركزية (CPUs). تتطلب عملية ضرب متعددات الحدود و Bootstrapping عمليات حسابية ضخمة مثل [FFT](/ar/p/fast-fourier-transform-algorithm/) ([تحويل فورييه السريع](/ar/p/fast-fourier-transform-algorithm/)) و NTT (تحويل نظرية الأعداد).
...
3.  **واجهة برمجة تطبيقات استدلال الذكاء الاصطناعي الآمنة (MaaS: Model as a [Service](https://kenji.blog/ar/p/kubernetes-k8s-architecture-pod-service-ingress/))**:
...
تمامًا كما تم اختراع تشفير المفتاح العام ([RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)) في سبعينيات القرن العشرين ومكّن الاتصال الآمن على الإنترنت (مثل HTTPS)، فإن اختراع FHE من قبل كريج جينتري يعد واحدًا من أهم المعالم في [تاريخ التشفير](/ar/p/history-of-cryptography-enigma-to-rsa/).

حاليًا، خرج التشفير المتماثل بالكامل (FHE) من نظرية المختبر إلى مرحلة تتنافس فيها Microsoft و IBM و Intel و Google والعديد من الشركات الناشئة لوضعه موضع التنفيذ. على الرغم من استمرار تحديات التكلفة الحسابية وحجم البيانات، يستمر تحسين الأداء بوتيرة تتجاوز [قانون مور](/ar/p/business-moores-law/) بفضل تحسين الخوارزميات وتطور مسرعات الأجهزة.
