---
title: "Passion et Radioactivité : La Vie et le Dévouement Scientifique de Marie Curie"
...
```mermaid
graph TD
    A["Marie Curie (Maria Skłodowska)"] -->|Mariage et recherche conjointe| B["Pierre Curie"]
    A -->|Recherche sur les rayonnements inconnus| C["Découverte du Polonium"]
    A -->|Recherche sur les rayonnements inconnus| D["Découverte du Radium"]
    B --> C
    B --> D
    C --> E["Prix Nobel de physique de 1903"]
    D --> E
    D --> F["Prix Nobel de chimie de 1911"]
    F --> G["Établissement de la radiochimie et de la physique nucléaire"]
    A -->|Contribution lors de la 1ère GM| H["Unités radiologiques mobiles (Petites Curies)"]
    H --> I["Sauvetage de soldats blessés et application à la médecine moderne"]
    G --> J["Traitement du cancer et immense influence sur la science et la technologie"]
    I --> J
```
