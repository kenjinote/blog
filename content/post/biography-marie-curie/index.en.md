---
title: "Passion and Radioactivity: The Life and Scientific Dedication of Marie Curie"
...
```mermaid
graph TD
    A["Marie Curie (Maria Skłodowska)"] -->|Marriage and joint research| B["Pierre Curie"]
    A -->|Research unknown radiation| C["Discovery of Polonium"]
    A -->|Research unknown radiation| D["Discovery of Radium"]
    B --> C
    B --> D
    C --> E["1903 Nobel Prize in Physics"]
    D --> E
    D --> F["1911 Nobel Prize in Chemistry"]
    F --> G["Establishment of radiochemistry and nuclear physics"]
    A -->|Contribution in WWI| H["Mobile X-ray units (Petites Curies)"]
    H --> I["Lifesaving of wounded soldiers and application to modern medicine"]
    G --> J["Cancer treatment and immense influence on future science and technology"]
    I --> J
```
