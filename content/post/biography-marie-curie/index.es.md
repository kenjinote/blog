---
title: "Pasión y Radiactividad: La Vida y Dedicación Científica de Marie Curie"
date: 2026-09-23T19:53:31+09:00
categories: ["biography"]
tags: ["marie-curie", "history"]
image: "eyecatch.jpg"
slug: "biography-marie-curie"
description: "En la historia de la ciencia, una de las personas que recorrió el camino más brillante y arduo es Marie Curie (Madame Curie)."
---
...
```mermaid
graph TD
    A["Marie Curie (Maria Skłodowska)"] -->|Matrimonio e investigación conjunta| B["Pierre Curie"]
    A -->|Investigación de radiación desconocida| C["Descubrimiento del Polonio"]
    A -->|Investigación de radiación desconocida| D["Descubrimiento del Radio"]
    B --> C
    B --> D
    C --> E["Premio Nobel de Física 1903"]
    D --> E
    D --> F["Premio Nobel de Química 1911"]
    F --> G["Establecimiento de la radioquímica y la física nuclear"]
    A -->|Contribución en la Primera Guerra Mundial| H["Unidades móviles de rayos X (Pequeños Curie)"]
    H --> I["Salvamento de soldados heridos y aplicación a la medicina moderna"]
    G --> J["Tratamiento del cáncer e inmensa influencia en la ciencia y la tecnología"]
    I --> J
```
