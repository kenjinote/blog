---
title: "Semangat dan Radioaktivitas: Kehidupan dan Dedikasi Ilmiah Marie Curie"
...
```mermaid
graph TD
    A["Marie Curie (Maria Skłodowska)"] -->|Pernikahan dan penelitian bersama| B["Pierre Curie"]
    A -->|Meneliti radiasi yang tidak diketahui| C["Penemuan Polonium"]
    A -->|Meneliti radiasi yang tidak diketahui| D["Penemuan Radium"]
    B --> C
    B --> D
    C --> E["Hadiah Nobel Fisika 1903"]
    D --> E
    D --> F["Hadiah Nobel Kimia 1911"]
    F --> G["Pembentukan radiokimia dan fisika nuklir"]
    A -->|Kontribusi dalam Perang Dunia I| H["Unit sinar-X bergerak (Petites Curies)"]
    H --> I["Penyelamatan tentara yang terluka dan aplikasi pada pengobatan modern"]
    G --> J["Pengobatan kanker dan pengaruh luar biasa pada sains dan teknologi masa depan"]
    I --> J
```
