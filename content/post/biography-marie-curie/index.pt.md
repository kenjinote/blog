---
title: "Paixão e Radioatividade: A Vida e Dedicação Científica de Marie Curie"
date: "2026-09-24T16:08:36+09:00"
categories: ["biography"]
tags: ["marie-curie", "history"]
image: "eyecatch.jpg"
slug: "biography-marie-curie"
description: "Na história da ciência, uma das pessoas que percorreu o caminho mais brilhante e árduo é Marie Curie (Madame Curie)."
---
...
```mermaid
graph TD
    A["Marie Curie (Maria Skłodowska)"] -->|Casamento e pesquisa conjunta| B["Pierre Curie"]
    A -->|Pesquisa de radiação desconhecida| C["Descoberta do Polônio"]
    A -->|Pesquisa de radiação desconhecida| D["Descoberta do Rádio"]
    B --> C
    B --> D
    C --> E["Prêmio Nobel de Física de 1903"]
    D --> E
    D --> F["Prêmio Nobel de Química de 1911"]
    F --> G["Estabelecimento da radioquímica e física nuclear"]
    A -->|Contribuição na Primeira Guerra Mundial| H["Unidades móveis de raios X (Pequenos Curie)"]
    H --> I["Salvamento de soldados feridos e aplicação na medicina moderna"]
    G --> J["Tratamento de câncer e imensa influência na ciência e tecnologia futuras"]
    I --> J
```
