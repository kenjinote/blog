---
title: "Leidenschaft und Radioaktivität: Das Leben und die wissenschaftliche Hingabe der Marie Curie"
...
```mermaid
graph TD
    A["Marie Curie (Maria Skłodowska)"] -->|Heirat und gemeinsame Forschung| B["Pierre Curie"]
    A -->|Erforschung unbekannter Strahlung| C["Entdeckung von Polonium"]
    A -->|Erforschung unbekannter Strahlung| D["Entdeckung von Radium"]
    B --> C
    B --> D
    C --> E["Nobelpreis für Physik 1903"]
    D --> E
    D --> F["Nobelpreis für Chemie 1911"]
    F --> G["Etablierung der Radiochemie und Kernphysik"]
    A -->|Beitrag im Ersten Weltkrieg| H["Mobile Röntgeneinheiten (Petites Curies)"]
    H --> I["Rettung verwundeter Soldaten und Anwendung in der modernen Medizin"]
    G --> J["Krebsbehandlung und immenser Einfluss auf die zukünftige Wissenschaft und Technologie"]
    I --> J
```
