...
ここで登場するのが、数学の中でも最も美しい理論の一つとされる **複素解析** （複素関数論）における強力な定理、すなわち **[留数定理](https://kenji.blog/p/residue-theorem/)** （[Cauchy](https://kenji.blog/p/cauchy/)'s [Residue Theorem](https://kenji.blog/p/residue-theorem/)）です。実数直線（1次元）上で行っていた積分を、思い切って **複素平面** （2次元）へと拡張することで、計算不可能な実数積分を鮮やかに解くことができます。
