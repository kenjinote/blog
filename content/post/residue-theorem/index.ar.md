...
هنا يأتي دور سلاح قوي من **التحليل المركب** (نظرية الدوال المركبة)، والذي يُعتبر على نطاق واسع أحد أجمل النظريات في الرياضيات: **[نظرية البواقي](https://kenji.blog/p/residue-theorem/) لكوشي** (Cauchy's [Residue Theorem](https://kenji.blog/p/residue-theorem/)). من خلال توسيع التكامل الذي يتم إجراؤه على خط الأعداد الحقيقية (أحادي الأبعاد) بجرأة إلى **المستوى المركب** (ثنائي الأبعاد)، يمكن حل التكاملات الحقيقية المستحيلة ببراعة.
...
## [نظرية البواقي](https://kenji.blog/p/residue-theorem/) لكوشي

يؤدي دمج هذه المفاهيم إلى **[نظرية البواقي](https://kenji.blog/p/residue-theorem/)**. إذا كان المنحنى المغلق $C$ يحتوي على عدة نقاط شاذة معزولة $z_1, z_2, \dots, z_k$ بداخله، فيمكن حساب التكامل المركب على طول $C$ على النحو التالي:
...
دعونا نستخدم بالفعل [نظرية البواقي](https://kenji.blog/p/residue-theorem/) لحل التكامل المقدم في البداية.
...
### الخطوة 3: تطبيق [نظرية البواقي](https://kenji.blog/p/residue-theorem/)
بواسطة [نظرية البواقي](https://kenji.blog/p/residue-theorem/)، يصبح التكامل على المنحنى المغلق $C$:
...
نطبق [نظرية البواقي](https://kenji.blog/p/residue-theorem/):
