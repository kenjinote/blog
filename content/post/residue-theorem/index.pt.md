...
A integração desses conceitos produz o **Teorema dos Resíduos**. Se uma curva fechada $C$ contém múltiplas singularidades isoladas $z_1, z_2, \dots, z_k$ dentro dela, a integral complexa ao longo de $C$ pode ser calculada da seguinte forma:
...
### Passo 3: Aplicando o Teorema dos Resíduos
