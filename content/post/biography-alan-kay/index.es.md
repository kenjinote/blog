---
title: "La mejor manera de predecir el futuro es inventarlo: La trayectoria y filosofía de Alan Kay"
...
description: "Alan Kay es un científico de la computación estadounidense, a menudo llamado el \"padre del ordenador personal\", y un genio visionario que tuvo un profundo"
---
...
Al mismo tiempo, se desarrolló una "GUI (interfaz gráfica de usuario)" con ventanas, iconos, ratón y puntero como entorno operativo para Smalltalk. Además, nació el "Xerox Alto" como el hardware prototipo para ejecutar este software. Estos logros históricos en PARC inspiraron fuertemente a [Steve Jobs](/es/p/biography-steve-jobs/) de Apple, quien visitó el laboratorio en 1979, y llevaron directamente al posterior nacimiento de Lisa y Macintosh.

```mermaid
graph TD
    A["Biología (Concepto de célula)"] --> B["Programación orientada a objetos"]
    C["Sketchpad y NLS"] --> D["Concepto de Dynabook (1972)"]
    B --> E["Smalltalk"]
    D --> E
    E --> F["Xerox Alto (GUI)"]
    F --> G["Apple Macintosh"]
    F --> H["Windows OS"]
    G --> I["PC y tabletas modernas"]
    H --> I
```
