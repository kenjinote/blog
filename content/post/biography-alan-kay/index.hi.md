...
description: "एलन के (Alan Kay) एक अमेरिकी कंप्यूटर वैज्ञानिक हैं, जिन्हें \"पर्सनल कंप्यूटर का पिता\" भी कहा जाता है, और एक प्रतिभाशाली दूरदर्शी (visionary) हैं जिन्होंने"
---
...
इस प्रक्रिया में, प्रोग्रामिंग भाषा "Smalltalk" का निर्माण हुआ। स्मॉलटॉक दुनिया में पहली बार "[ऑब्जेक्ट-ओरिएंटेड प्रोग्रामिंग](/hi/p/object-oriented-programming-oop-solid-principles/)" की अवधारणा को पूरी तरह से लागू करने वाली भाषा थी, जिसमें सभी तत्वों को "ऑब्जेक्ट्स" के रूप में माना जाता है, और प्रोग्राम उनके एक-दूसरे को "संदेश" भेजने के माध्यम से संचालित होता है।

उसी समय, स्मॉलटॉक के ऑपरेटिंग वातावरण के रूप में, विंडोज़, आइकन, माउस और [पॉइंटर्स](/hi/p/c-language-pointers-memory-management-stack-heap/) का उपयोग करके एक "GUI (ग्राफिकल यूजर इंटरफेस)" विकसित किया गया था। इसके अलावा, इन सॉफ्टवेयर को चलाने के लिए प्रोटोटाइप हार्डवेयर के रूप में "Xerox Alto" का जन्म हुआ। PARC में इन ऐतिहासिक उपलब्धियों ने 1979 में संस्थान का दौरा करने वाले Apple के [स्टीव जॉब्स](/hi/p/biography-steve-jobs/) को गहराई से प्रेरित किया, और बाद में लिसा (Lisa) और मैकिंटोश (Macintosh) के निर्माण का मार्ग प्रशस्त किया।
...
1. **[ऑब्जेक्ट-ओरिएंटेड प्रोग्रामिंग](/hi/p/object-oriented-programming-oop-solid-principles/) का प्रसार**
