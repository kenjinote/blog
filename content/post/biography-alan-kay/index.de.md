...
description: "Alan Kay ist ein amerikanischer Informatiker, der oft als \"Vater des Personal Computers\" bezeichnet wird, und ein genialer Visionär, der das moderne Comput"
---
...
```mermaid
graph TD
    A["Biologie (Zellkonzept)"] --> B["Objektorientierte Programmierung"]
    C["Sketchpad & NLS"] --> D["Dynabook-Konzept (1972)"]
    B --> E["Smalltalk"]
    D --> E
    E --> F["Xerox Alto (GUI)"]
    F --> G["Apple Macintosh"]
    F --> H["Windows OS"]
    G --> I["Moderne PCs & Tablets"]
    H --> I
```
