...
同时，作为 Smalltalk 的操作环境，使用窗口、图标、鼠标和指针的“GUI（图形用户界面）”被开发了出来。此外，为了运行这些软件，诞生了作为原型硬件的“Xerox Alto”。这项在 PARC 取得的历史性成果，在1979年给予了造访该研究所的苹果公司创始人[史蒂夫·乔布斯](/zh-cn/p/biography-steve-jobs/)极大的启发，并直接促成了后来 Lisa 和 Macintosh 的诞生。
