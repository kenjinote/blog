---
title: "Michelangelo Buonarroti: A Vida e a Filosofia de um Mestre do Renascimento"
...
```mermaid
graph TD
    A["Michelangelo (1475-1564)"] -->|Escultura| B["Pietà (1499)"]
    A -->|Escultura| C["Davi (1504)"]
    A -->|Pintura| D["Teto da Capela Sistina (1512)"]
    A -->|Pintura| E["O Juízo Final (1541)"]
    A -->|Arquitetura| F["Basílica de São Pedro (1546-)"]
    
    G["Família Médici (Florença)"] -->|Patrono| A
    H["Júlio II (Papa)"] -->|Patrono| A
    I["Neoplatonismo"] -->|Influência filosófica| A
    A -->|Influência artística| J["Maneirismo (Alto/Tardo Renascimento)"]
```
