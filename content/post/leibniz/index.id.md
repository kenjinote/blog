...
Akan tetapi, pada tahun-tahun terakhirnya, reputasinya sangat ternoda oleh "perselisihan prioritas kalkulus" yang meletus dengan Isaac Newton. Selain itu, bahkan setelah tuannya di Hannover berangkat ke London sebagai Raja George I dari Britania Raya, Leibniz diperintahkan untuk menyelesaikan penyusunan buku-buku sejarah dan dipaksa tetap tinggal di Hannover. Ketika ia meninggal pada usia 70 tahun pada 1716, konon hanya sekretarisnya yang menghadiri pemakamannya.
...
```mermaid
timeline
    title "Garis Waktu Sengketa Prioritas Kalkulus"
    1665 : "Newton memahami metode fluksion"
    1675 : "Leibniz menemukan kalkulus"
    1684 : "Leibniz menerbitkan makalah pertamanya tentang kalkulus"
    1687 : "Newton menerbitkan Principia"
    1704 : "Newton menerbitkan risalah tentang kuadratur sebagai lampiran Opticks"
    1711 : "Perselisihan prioritas memanas di Royal Society"
```
...
Leibniz bukan hanya seorang matematikawan teoretis tetapi juga seorang penemu praktis yang mengukir namanya dalam sejarah kalkulator mekanis. Ia menyempurnakan kalkulator Blaise Pascal (Pascaline), yang hanya bisa melakukan penambahan dan pengurangan, dan menemukan kalkulator yang menggunakan "Roda Leibniz" (Stepped Reckoner) yang mampu melakukan perkalian dan pembagian.
...
```mermaid
graph TD
    A["Input (Dial)"] -->|"Menggerakkan roda gigi"| B["Roda Leibniz"]
    B -->|"Mentransmisikan putaran"| C["Mekanisme perhitungan"]
    C -->|"Mengeluarkan hasil"| D["Layar (Register)"]
