...
```mermaid
timeline
    title "Timeline of the Calculus Priority Dispute"
    1665 : "Newton conceives the method of fluxions"
    1675 : "Leibniz discovers calculus"
    1684 : "Leibniz publishes his first paper on calculus"
    1687 : "Newton publishes the Principia"
    1704 : "Newton publishes On the Quadrature of Curves as an appendix to Opticks"
    1711 : "The priority dispute intensifies at the Royal Society"
```
...
```mermaid
graph TD
    A["Input (Dials)"] -->|"Engages gears"| B["Leibniz wheel"]
    B -->|"Transmits rotation"| C["Calculation mechanism"]
    C -->|"Outputs result"| D["Display (Register)"]
