...
En sus últimos años, sin embargo, su reputación se vio gravemente empañada por la "controversia sobre la paternidad del cálculo" con [Isaac Newton](https://kenji.blog/p/newton/). Además, tras la partida de su soberano de Hannover a Londres como el rey Jorge I de Gran Bretaña, se le ordenó permanecer en Hannover para terminar de compilar los libros de historia. Cuando murió a los 70 años en 1716, se dice que solo su secretario asistió a su funeral.
...
```mermaid
timeline
    title "Línea de tiempo de la controversia del cálculo"
    1665 : "Newton concibe el método de las fluxiones"
    1675 : "Leibniz descubre el cálculo"
    1684 : "Leibniz publica su primer artículo sobre el cálculo"
    1687 : "Newton publica los Principia"
    1704 : "Newton publica un tratado de cuadraturas como apéndice a su Óptica"
    1711 : "Se intensifica la disputa de prioridad en la Royal Society"
```
...
```mermaid
graph TD
    A["Entrada (Diales)"] -->|"Engrana los dientes"| B["Cilindro de Leibniz"]
    B -->|"Transmite rotación"| C["Mecanismo de cálculo"]
    C -->|"Muestra resultado"| D["Pantalla (Registro)"]
