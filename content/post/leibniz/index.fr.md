...
```mermaid
timeline
    title "Chronologie de la controverse sur le calcul infinitésimal"
    1665 : "Newton conçoit la méthode des fluxions"
    1675 : "Leibniz découvre le calcul infinitésimal"
    1684 : "Leibniz publie son premier article sur le calcul"
    1687 : "Newton publie les Principia"
    1704 : "Newton publie un traité sur la quadrature des courbes en annexe de l'Optique"
    1711 : "La querelle de priorité s'intensifie à la Royal Society"
```
...
```mermaid
graph TD
    A["Entrée (Cadrans)"] -->|"Engrène les pignons"| B["Cylindre de Leibniz"]
    B -->|"Transmet la rotation"| C["Mécanisme de calcul"]
    C -->|"Affiche le résultat"| D["Affichage (Registre)"]
