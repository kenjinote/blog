...
数学と物理学の歴史において、最も重要な貢献をした人物の一人でありながら、その名が一般に広く知られていない天才が存在します。その人物こそが、ドイツ出身の数学者 **[エミー・ネーター](https://kenji.blog/p/noether/)** （Emmy Noether, 1882–1935）です。彼女は「現代代数学の母」と称され、抽象代数学という分野を根本から作り変えました。さらに、物理学の分野においては、対称性と保存則を結びつける **「ネーターの定理」** を証明し、アインシュタインの一般相対性理論や現代の素粒子物理学の基礎を築きました。
