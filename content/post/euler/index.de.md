...
```mermaid
flowchart TD
    A["1707: Geboren in Basel, Schweiz"] --> B["1727: Umzug nach St. Petersburg"]
    B --> C["1741: Wechsel zur Berliner Akademie der Wissenschaften"]
    C --> D["1766: Rückkehr nach St. Petersburg"]
    D --> E["1783: Gestorben im Alter von 76 Jahren"]
```
...
```mermaid
graph TD
    A["Nordgewann"] -->|"Brücke 1"| B["Kneiphof (Insel)"]
    A -->|"Brücke 2"| B
    C["Südgewann"] -->|"Brücke 3"| B
    C -->|"Brücke 4"| B
    A -->|"Brücke 5"| D["Östliches Land"]
    C -->|"Brücke 6"| D
    B -->|"Brücke 7"| D
```
