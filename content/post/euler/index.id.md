...
Saat menengok kembali sejarah matematika, sangat mustahil untuk mengabaikan nama **Leonhard Euler** (1707–1783). Ia secara luas diakui sebagai salah satu matematikawan paling produktif dan berpengaruh dalam sejarah manusia. Mulai dari kalkulus dan teori bilangan hingga teori graf, mekanika, optik, dan astronomi, pemikirannya yang kritis dan jejak karyanya meluas ke berbagai bidang sains.
...
```mermaid
flowchart TD
    A["1707: Lahir di Basel, Swiss"] --> B["1727: Pindah ke St. Petersburg"]
    B --> C["1741: Pindah ke Akademi Ilmu Pengetahuan Berlin"]
    C --> D["1766: Kembali ke St. Petersburg"]
    D --> E["1783: Wafat pada usia 76 tahun"]
```
...
### 4.2 Tujuh Jembatan Königsberg

Pada tahun 1736, Euler memecahkan teka-teki yang dikenal sebagai "Tujuh Jembatan Königsberg". Pertanyaannya adalah: "Apakah mungkin berjalan melewati ketujuh jembatan di atas Sungai Pregel tepat satu kali dan kembali ke titik awal?"
...
```mermaid
graph TD
    A["Tepi Utara"] -->|"Jembatan 1"| B["Pulau Tengah"]
    A -->|"Jembatan 2"| B
    C["Tepi Selatan"] -->|"Jembatan 3"| B
    C -->|"Jembatan 4"| B
    A -->|"Jembatan 5"| D["Daratan Timur"]
    C -->|"Jembatan 6"| D
    B -->|"Jembatan 7"| D
```
...
Leonhard Euler bukan hanya seorang jenius dalam berhitung; ia memiliki intuisi dan wawasan yang luar biasa, memungkinkan dirinya memecahkan struktur-struktur esensial dari fenomena rumit dan mengungkapkannya dalam rumus dan konsep yang indah.
