...
```mermaid
flowchart TD
    A["1707 : Né à Bâle, Suisse"] --> B["1727 : Déménage à Saint-Pétersbourg"]
    B --> C["1741 : Transféré à l'Académie des sciences de Berlin"]
    C --> D["1766 : Retour à Saint-Pétersbourg"]
    D --> E["1783 : Décède à l'âge de 76 ans"]
```
...
```mermaid
graph TD
    A["Rive Nord"] -->|"Pont 1"| B["Île Centrale"]
    A -->|"Pont 2"| B
    C["Rive Sud"] -->|"Pont 3"| B
    C -->|"Pont 4"| B
    A -->|"Pont 5"| D["Terre de l'Est"]
    C -->|"Pont 6"| D
    B -->|"Pont 7"| D
```
