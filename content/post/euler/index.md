...
数学の歴史を振り返るとき、 **レオンハルト・[オイラー](https://kenji.blog/p/euler/)** （Leonhard Euler, 1707–1783）の名前を外すことは決してできません。彼は、人類史上最も多作であり、かつ最も影響力のある数学者の一人として広く認識されています。解析学、整数論、[グラフ理論](https://kenji.blog/p/graph-theory-dijkstra-a-star/)、力学、光学、天文学など、彼の探求心と足跡は科学のあらゆる分野に及んでいます。
...
この発見は、今日の **[グラフ理論](https://kenji.blog/p/graph-theory-dijkstra-a-star/)** や **トポロジー** （位相幾何学）の基礎を築く画期的なものでした。
...
全く異なる分野から生まれたこれらの定数が、たった一つのシンプルな数式で見事に結びついていることは、数学の深い神秘性と調和を表しています。物理学者の[リチャード・ファインマン](/p/biography-richard-feynman/)は、これを「我々の至宝」であり「数学において最も注目すべき数式」と評しました。
...
[ニュートン](https://kenji.blog/p/newton/)が定式化した質点の力学を、オイラーは剛体（変形しない固体）の力学へと拡張しました。また、流体の運動を記述する「[オイラー](https://kenji.blog/p/euler/)方程式」を導き出し、現代の航空工学や気象学の基礎となる流体力学を確立しました。
