...
将棋は日本固有の複雑なボードゲームであり、AIの進化において重要なベンチマークとなってきました。
...
将棋には他のゲームにはない「持ち駒」という独自のルールが存在します。
...
AIは評価関数と探索アルゴリズム（ミニマックス法、アルファベータ法など）を駆使して強くなりました。
近年ではディープラーニングを用いた手法が主流です。
