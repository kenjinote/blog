...
تقدم الرياضيات إجابة واضحة وجميلة جدًا على هذا السؤال. وهذا هو موضوع هذا المقال: **[المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/)**. تؤكد هذه المبرهنة أن "أي كثيرة حدود من الدرجة $n$ بمعاملات مركبة لها دائمًا جذر (حل) ضمن الأعداد المركبة". بعبارة أخرى، في المحيط الشاسع للأعداد المركبة، يوجد حل لأي معادلة دائمًا، مما يضمن عدم الحاجة إلى اختراع أي أعداد جديدة.

في هذا المقال، سنشرح **[المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/)** بالتفصيل، بدءًا من خلفيتها التاريخية، وانتقالاً إلى نهج بديهي يعتمد على الطوبولوجيا، وأخيرًا تقديم إثبات صارم وجميل باستخدام التحليل المركب.

## الخلفية التاريخية للمبرهنة الأساسية في الجبر

لم يتم إثبات **[المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/)** بين عشية وضحاها. لقد كافح العديد من علماء الرياضيات العظماء لتحقيق إثبات كامل، ولم يشكوا أبدًا في حقيقة المبرهنة.

في القرن السابع عشر، عرف علماء رياضيات مثل [رينيه ديكارت](https://kenji.blog/p/descartes/) وألبرت جيرارد تجريبيًا أن "معادلة من الدرجة $n$ يجب أن يكون لها $n$ من الجذور". ومع ذلك، وضمن الإطار الرياضي في ذلك الوقت، لم تكن هناك وسيلة صارمة لإثبات ذلك.
...
**مبرهنة ([المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/))**
...
دعونا الآن نثبت [المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/) باستخدام مبرهنة ليوفيل. ستندهش من روعة هذا الإثبات. هنا نستخدم البرهان بالخُلف.
...
تضمن [المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/) وجود "حل واحد على الأقل". وبدمج هذه الحقيقة مع **مبرهنة العامل** لقسمة كثيرات الحدود، يمكننا إثبات أنه يمكن تحليل كثيرة الحدود بالكامل إلى حاصل ضرب حدود خطية.

بإعطاء كثيرة حدود $P_n(z)$ من الدرجة $n$، تنص [المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/) على أنه يوجد حل $\alpha_1$ بحيث أن $P_n(\alpha_1) = 0$. ووفقًا لمبرهنة العامل، فإن $P_n(z)$ لها $(z - \alpha_1)$ كعامل. أي، يمكن تحليلها على النحو التالي:

$$
P_n(z) = (z - \alpha_1) P_{n-1}(z)
$$

هنا، $P_{n-1}(z)$ هي كثيرة حدود من الدرجة $n-1$. وإذا كان $n-1 \ge 1$، فيمكننا تطبيق [المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/) مرة أخرى لإيجاد حل $\alpha_2$ لـ $P_{n-1}(z)$. وبتكرار ذلك $n$ من المرات، يمكننا تحليلها بالكامل على النحو التالي:
...
في هذا المقال، ألقينا نظرة مفصلة على [المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/)، وغطينا خلفيتها التاريخية، والحدس الطوبولوجي، والإثبات التحليلي المركب باستخدام مبرهنة ليوفيل.
...
اكتسب بحث البشرية الطويل لإيجاد جذور المعادلات مسرح المستوى المركب الواسع من خلال إدخال الأعداد التخيلية الجديدة، وتم إثبات اكتمال هذا المسرح من خلال [المبرهنة الأساسية في الجبر](https://kenji.blog/p/fundamental-theorem-of-algebra/). أصبحت هذه المبرهنة المفتاح الذي فتح الأبواب الرائعة المؤدية إلى نظرية غالوا والهندسة الجبرية، والتي تشكل حجر الأساس للرياضيات الحديثة.
