...
## 4. Contributions à la théorie des nombres : Le théorème de Lamé et l'algorithme d'[[Euclid](https://kenji.blog/fr/p/euclid/)e](https://kenji.blog/p/euclid/)
...
L'**algorithme d'[[Euclid](https://kenji.blog/fr/p/euclid/)e](https://kenji.blog/p/euclid/)**, transmis depuis la Grèce antique, est un algorithme efficace pour trouver le plus grand commun diviseur (PGCD) de deux entiers naturels. Cependant, jusqu'à Lamé en 1844, personne n'avait prouvé avec précision « à quelle vitesse » cet algorithme se terminait. Le théorème de Lamé énonce ce qui suit :
