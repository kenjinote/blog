...
ラメはこの定理を証明する過程で、[[ユークリッド](https://kenji.blog/p/euclid/)の互除法](https://kenji.blog/p/euclidean-algorithm/)が最も手こずる（つまり最もステップ数が多くなる）最悪のケースが、連続する二つの **フィボナッチ数** を入力とした場合であることを発見しました。フィボナッチ数列の成長率と黄金比の性質を利用することで、彼はこの美しい上限を導き出したのです。この業績により、ラメは現代の計算機科学における「計算量理論の祖」の一人とも見なされています。
