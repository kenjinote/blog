...
在電腦系統中，為了快速確認密碼或檔案的同一性，我們會使用一種稱為「雜湊函數（[Hash Function](https://kenji.blog/zh-tw/p/modern-cryptography-public-key-hash-signature/)）」的機制。雜湊函數無論輸入什麼資料，都會回傳固定長度的隨機字串（雜湊值）。
