...
نأخذ بعين الاعتبار [متسلسلة تايلور](/ar/p/taylor-and-maclaurin-series/) للدالة الأسية $e^{-x}$. عندما تكون $x$ صغيرة بما يكفي، يتحقق التقريب التالي.
$$ e^{-x} \approx 1 - x $$
...
في أنظمة الكمبيوتر، تُستخدم آلية تسمى "دالة التجزئة ([Hash Function](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/))" للتحقق بسرعة من تطابق كلمات المرور أو الملفات. دالة التجزئة تعيد سلسلة نصية عشوائية بطول ثابت (قيمة التجزئة) بغض النظر عن البيانات المدخلة.
