---
title: 'コンピュータの5大装置とは？IT初心者が知っておくべきハードウェアとソフトウェアの基本知識'
slug: "コンピュータの基本知識"
...
description: 'コンピュータが動く仕組みをIT初心者向けにわかりやすく解説します。入力・出力・記憶・制御・演算の「5大装置」の役割から、ハードウェアとソフトウェア（プログラム）の関係性まで、ITの基礎として知っておくべき基本知識をまとめました。'
---
