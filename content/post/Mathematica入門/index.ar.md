---
title: 'مقدمة في Mathematica: كيفية استخدام الأوامر الأساسية مثل المعادلات والتفاضل والتكامل'
slug: "Mathematica入門"
...
## إيجاد [القيم الذاتية والمتجهات الذاتية](https://kenji.blog/ar/p/eigenvalues-and-eigenvectors/)
```
Eigensystem[m]
```
الخرج
