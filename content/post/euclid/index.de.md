...
```mermaid
graph TD
    A["'Elemente'"] --> B["Ebene Geometrie (Bände 1-6)"]
    A --> C["Zahlentheorie (Bände 7-9)"]
    A --> D["Inkommensurable Größen (Band 10)"]
    A --> E["Raumgeometrie (Bände 11-13)"]
    B --> B1["Satz des Pythagoras"]
    C --> C1["Euklidischer Algorithmus"]
    C --> C2["Unendlichkeit der Primzahlen"]
    E --> E1["Reguläre Polyeder (Platonische Körper)"]
```
