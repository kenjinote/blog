...
When talking about the history of mathematics, there is a giant star that cannot be ignored. That is the ancient Greek mathematician **[Euclid](https://kenji.blog/p/euclid/)**. Also known as the "Father of Geometry", he was the pioneer who established mathematics as a logical system. In this article, we will delve into the episodes of [Euclid](https://kenji.blog/p/euclid/)'s life, the contents of his historical masterpiece "Elements", and the important mathematical achievements he left behind.

## [Euclid](https://kenji.blog/p/euclid/)'s Life and Episodes

Regarding the life of [Euclid](https://kenji.blog/p/euclid/) (around 300 BC), there are actually very few definitive historical records left. Where he was born and what kind of life he led can only be inferred from fragmentary descriptions by scholars in later eras. However, it is widely known that he was active in **Alexandria**, Egypt, and ran a mathematics school during the reign of Ptolemy I.

### "There is no royal road to geometry"

One of the most famous episodes related to [Euclid](https://kenji.blog/p/euclid/) is his interaction with the Egyptian King Ptolemy I.
The king tried to study [Euclid](https://kenji.blog/p/euclid/)'s book "Elements", but because its content was too difficult and lengthy, he asked [Euclid](https://kenji.blog/p/euclid/):
"Is there no shorter or easier path to learning geometry?"
To this, [Euclid](https://kenji.blog/p/euclid/) is said to have replied firmly:
...
[Euclid](https://kenji.blog/p/euclid/)'s greatest and most enduring achievement is the compilation of the mathematics book **"Elements"**, consisting of 13 volumes. This book is a compilation of ancient Greek mathematical knowledge and is said to be the most published book in the world after the Bible.
...
This postulate was more complex than the other four, and many mathematicians suspected, "Isn't this a theorem that can be proven from the other postulates, rather than a postulate itself?" Attempts to prove it spanning thousands of years all ended in failure. However, in the 19th century, **Non-[Euclide](https://kenji.blog/p/euclid/)an geometry**, a geometry in which the fifth postulate does not hold, was finally discovered, bringing a revolution to the mathematical world. It can be said that this event paradoxically proved the sharpness of [Euclid](https://kenji.blog/p/euclid/)'s intuition.

## [Euclid](https://kenji.blog/p/euclid/)'s Great Mathematical Achievements

[Euclid](https://kenji.blog/p/euclid/) left outstanding achievements not only in geometry but also in the field of number theory. Here we introduce two particularly famous achievements.

### 1. [Euclide](https://kenji.blog/p/euclid/)an Algorithm

The **[Euclide](https://kenji.blog/p/euclid/)an algorithm** is an algorithm for efficiently finding the greatest common divisor (GCD) of two natural numbers. It is also called one of the oldest algorithms in human history.
...
In the 9th volume of "Elements", [Euclid](https://kenji.blog/p/euclid/) proved that there are infinitely many prime numbers using a very beautiful and elegant proof by contradiction.
...
## Conclusion: [Euclid](https://kenji.blog/p/euclid/)'s Legacy

[Euclid](https://kenji.blog/p/euclid/)'s "Elements" goes beyond being a mere mathematics textbook; it has greatly influenced later great scientists such as Newton and Einstein as the ultimate teaching material for humanity to learn logical thinking.
