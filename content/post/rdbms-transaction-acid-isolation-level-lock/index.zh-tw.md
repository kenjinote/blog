...
在下一篇文章中，我們預計將解說這種交易控制在[分散式系統](/zh-tw/p/cap-theorem-distributed-systems-tradeoff/)或[微服務架構](/zh-tw/p/microservices-architecture-bff-api-gateway/)中是如何演進的（例如 Saga 模式或 2PC 等）。敬請期待。
