...
5. احسب المعكوس الضربي المعياري $d$ لـ $e$ (الأس الخاص). أي، أوجد $d$ بحيث يتحقق ما يلي:
   ...
   يُستخدم **[خوارزمية إقليدس](https://kenji.blog/p/euclidean-algorithm/) الممتدة** في هذه العملية الحسابية.
...
سنقوم أيضًا بتضمين "[خوارزمية إقليدس](https://kenji.blog/p/euclidean-algorithm/) الممتدة" لإيجاد المعكوس الضربي المعياري $d$.
