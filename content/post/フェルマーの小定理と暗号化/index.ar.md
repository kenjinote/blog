...
في المجتمع الرقمي الحديث، وخاصة في الاتصالات عبر الإنترنت، أصبح "التشفير" تقنية أساسية لا غنى عنها. إن قدرتنا على تصفح مواقع الويب بأمان عبر HTTPS في متصفحات الويب، وإجراء المعاملات المالية عبر الخدمات المصرفية عبر الإنترنت، والتواصل الخاص عبر تطبيقات المراسلة، كلها ممكنة بفضل بروتوكولات التشفير المدعومة بنظريات رياضية متقدمة تعمل في الخلفية. من بين هذه البروتوكولات، يلعب "تشفير المفتاح العام" دورًا مهمًا للغاية، وأبرز مثال عليه هو **تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)**.

تعتمد سلامة وصحة العديد من خوارزميات التشفير، بما في ذلك تشفير RSA، بشكل كبير على مبرهنة جميلة وقوية جدًا اكتشفها عالم الرياضيات الفرنسي في القرن السابع عشر [بيير دي فيرما](https://kenji.blog/ar/p/fermat/) ([Pierre de Fermat](https://kenji.blog/ar/p/fermat/)). هذه المبرهنة هي **[مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) ([Fermat's Little Theorem](https://kenji.blog/ar/p/fermats-little-theorem/))**. علاوة على ذلك، فإن مبرهنة ليونهارت أويلر ([Leonhard Euler](https://kenji.blog/ar/p/euler/))، التي تعمم هذه المبرهنة، تلعب أيضًا دورًا حاسمًا في نظرية التشفير.

في هذا المقال، سنشرح بالتفصيل ومن الأساسيات كيف يتم تطبيق اكتشاف رياضي بحت مثل [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) في تقنيات التشفير العملية الحديثة، وخاصة في "اختبار الأولية" و "تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)". سيكون هذا دليلًا تقنيًا مفصلاً للغاية يغطي الإثباتات الرياضية، وآليات التشفير وفك التشفير، وصولاً إلى تطبيقات الخوارزميات المحددة باستخدام C++ و Python.

---

## 2. أساسيات التطابق والحساب المعياري

لفهم [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/)، يجب أولاً التعرف على المفهوم الرياضي لـ "الحساب المعياري (التطابق)". الحساب المعياري هو نظام حسابي يركز على "الباقي" بعد القسمة على عدد ثابت (يسمى المعيار أو المقياس). نظرًا لأنه يشبه الحساب على مينا الساعة (التي تكمل دورة كل 12 ساعة)، يُطلق عليه أيضًا "رياضيات الساعة".
...
ومع ذلك، يجب توخي الحذر فيما يتعلق بـ **القسمة**. بشكل عام، فقط لأن $a \times c \equiv b \times c \pmod n$، فهذا لا يعني أنه يمكنك قسمة كلا الجانبين على $c$ للحصول على $a \equiv b \pmod n$. هذا ينطبق فقط عندما يكون $c$ و $n$ أوليين فيما بينهما (القاسم المشترك الأكبر هو 1). هذا المفهوم لـ "المعكوس الضربي المعياري" سيكون في غاية الأهمية في توليد مفاتيح تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)، والذي سيتم مناقشته لاحقًا.

---

## 3. الخلفية الرياضية ل[مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) وإثباتها

الآن وقد فهمنا أساسيات الحساب المعياري، دعونا ننتقل إلى الموضوع الرئيسي وهو [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/).

### 3.1 تعريف المبرهنة

تُصاغ [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) على النحو التالي:
...
هذا هو إثبات [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/).

---

## 4. دالة مؤشر أويلر ومبرهنة أويلر

[مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) هي مبرهنة تتعلق بـ "الأعداد الأولية $p$"، ولكن تم تعميمها على "أي عدد صحيح موجب $n$" بواسطة ليونهارت أويلر. لفهم تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)، هذا التوسيع ضروري.
...
عمم أويلر [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) على النحو التالي:

> **مبرهنة أويلر (Euler's Theorem)**
> لأي عدد صحيح موجب $n$ وعدد صحيح $a$ أولي نسبيًا معه، يتحقق ما يلي:
> $$ a^{\phi(n)} \equiv 1 \pmod n $$

إذا كان $n$ عددًا أوليًا $p$، فإن $\phi(p) = p - 1$، وبالتالي تصبح هذه المبرهنة هي [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) نفسها ($a^{p-1} \equiv 1 \pmod p$). وبعبارة أخرى، [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) ليست سوى حالة خاصة من مبرهنة أويلر.

---

## 5. العثور على أعداد أولية ضخمة: اختبار فيرما للأولية

في تقنيات التشفير (مثل تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) وتبادل مفاتيح Diffie-Hellman)، من الضروري العثور بسرعة على "أعداد أولية ضخمة" قد تصل إلى مئات الأرقام. ومع ذلك، لتحديد ما إذا كان رقم ضخم $N$ أوليًا، فإن "طريقة القسمة التجريبية"، والتي تختبر قابلية القسمة على كل الأرقام من $2$ إلى $\sqrt{N}$، ستستغرق وقتًا يعادل عمر الكون.

هنا يأتي دور "اختبار الأولية الاحتمالي" الذي يعكس [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/)، وهو **اختبار فيرما ([Fermat](https://kenji.blog/ar/p/fermat/) Primality Test)**.

### 5.1 ما هو اختبار الأولية الاحتمالي

وفقًا ل[مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/)، إذا كان $p$ أوليًا، فبالنسبة لأي $a$ ($1 < a < p$)، فإن $a^{p-1} \equiv 1 \pmod p$ يتحقق دائمًا.
...
## 7. التطبيق في تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/): حيث تلتقي أفكار فيرما وأويلر

إن التطبيق الأعظم ل[مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) (ومبرهنة أويلر) هو **تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)** ، الذي طوره ريفست (Rivest)، وشامير (Shamir)، وأدلمان (Adleman) في عام 1977.
...
5. احسب المعكوس الضربي المعياري $d$ لـ $e$ (الأس الخاص). أي، أوجد $d$ بحيث يتحقق ما يلي:
   ...
   يُستخدم **[خوارزمية [إقليدس](https://kenji.blog/ar/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة** في هذه العملية الحسابية.
...
هنا، تظهر [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) (ومبرهنة أويلر) قيمتها الحقيقية. لماذا يعود $C^d \pmod N$ إلى $M$؟
...
هنا تظهر **مبرهنة أويلر** ($M^{\phi(N)} \equiv 1 \pmod N$). (※ بدقة، يجب أن يكون $M$ و $N$ أوليين نسبيًا، ولكن في [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)، فإن احتمال عدم كون $M$ و $N$ أوليين نسبيًا منخفض فلكيًا، وباستخدام مبرهنة الباقي الصينية، يمكن إثبات أنها تظل صحيحة حتى لو لم يكونا أوليين نسبيًا).
...
سنقوم أيضًا بتضمين "[خوارزمية [إقليدس](https://kenji.blog/ar/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة" لإيجاد المعكوس الضربي المعياري $d$.
...
في القرن السابع عشر، عندما اكتشف [بيير دي فيرما](https://kenji.blog/ar/p/fermat/) هذه "المبرهنة الصغرى"، لم يعتقد أحد أنها ستكون مفيدة لأي شيء. فيرما نفسه أجرى أبحاثه في نظرية الأعداد بدافع من الفضول الرياضي البحت.

ومع ذلك، بعد حوالي 300 عام، وتحديدًا في السبعينيات أثناء فجر شبكات الكمبيوتر، عادت مبرهنة فيرما للظهور بشكل دراماتيكي كتقنية تشفير لا غنى عنها لإنشاء بروتوكولات اتصال آمنة. تقنيات اختبار الأولية القائمة على [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/)، وتشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) القائم على مبرهنة أويلر، تدعم حرفياً البنية التحتية للإنترنت الحديثة.

إن رسائل LINE التي نرسلها دون تفكير كل يوم، ومشترياتنا من أمازون، كلها ترقص على أنغام هذه الصيغة البسيطة والجميلة $a^{p-1} \equiv 1 \pmod p$. تعلمنا [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) أنه مهما كانت الرياضيات مجردة، فسيأتي يوم تكون فيه مفيدة للبشرية.
