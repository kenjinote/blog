...
## 3. الخلفية الرياضية ل[مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) وإثباتها

الآن وقد فهمنا أساسيات الحساب المعياري، دعونا ننتقل إلى الموضوع الرئيسي وهو [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/).

### 3.1 تعريف المبرهنة

تُصاغ [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) على النحو التالي:

> **[مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) ([Fermat's Little Theorem](https://kenji.blog/p/fermats-little-theorem/))**
...
هذا هو إثبات [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/).

---

## 4. دالة مؤشر أويلر ومبرهنة أويلر

[مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) هي مبرهنة تتعلق بـ "الأعداد الأولية $p$"، ولكن تم تعميمها على "أي عدد صحيح موجب $n$" بواسطة ليونهارت أويلر. لفهم تشفير RSA، هذا التوسيع ضروري.
...
عمم أويلر [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) على النحو التالي:

> **مبرهنة أويلر (Euler's Theorem)**
> لأي عدد صحيح موجب $n$ وعدد صحيح $a$ أولي نسبيًا معه، يتحقق ما يلي:
> $$ a^{\phi(n)} \equiv 1 \pmod n $$

إذا كان $n$ عددًا أوليًا $p$، فإن $\phi(p) = p - 1$، وبالتالي تصبح هذه المبرهنة هي [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) نفسها ($a^{p-1} \equiv 1 \pmod p$). وبعبارة أخرى، [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) ليست سوى حالة خاصة من مبرهنة أويلر.
...
هنا يأتي دور "اختبار الأولية الاحتمالي" الذي يعكس [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/)، وهو **اختبار فيرما (Fermat Primality Test)**.

### 5.1 ما هو اختبار الأولية الاحتمالي

وفقًا ل[مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/)، إذا كان $p$ أوليًا، فبالنسبة لأي $a$ ($1 < a < p$)، فإن $a^{p-1} \equiv 1 \pmod p$ يتحقق دائمًا.
...
إن التطبيق الأعظم ل[مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) (ومبرهنة أويلر) هو **تشفير RSA** ، الذي طوره ريفست (Rivest)، وشامير (Shamir)، وأدلمان (Adleman) في عام 1977.
...
5. احسب المعكوس الضربي المعياري $d$ لـ $e$ (الأس الخاص). أي، أوجد $d$ بحيث يتحقق ما يلي:
   ...
   يُستخدم **[خوارزمية [إقليدس](https://kenji.blog/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة** في هذه العملية الحسابية.
...
هنا، تظهر [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) (ومبرهنة أويلر) قيمتها الحقيقية. لماذا يعود $C^d \pmod N$ إلى $M$؟
...
سنقوم أيضًا بتضمين "[خوارزمية [إقليدس](https://kenji.blog/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة" لإيجاد المعكوس الضربي المعياري $d$.
...
في القرن السابع عشر، عندما اكتشف [بيير دي فيرما](https://kenji.blog/p/fermat/) هذه "المبرهنة الصغرى"، لم يعتقد أحد أنها ستكون مفيدة لأي شيء. فيرما نفسه أجرى أبحاثه في نظرية الأعداد بدافع من الفضول الرياضي البحت.

ومع ذلك، بعد حوالي 300 عام، وتحديدًا في السبعينيات أثناء فجر شبكات الكمبيوتر، عادت مبرهنة فيرما للظهور بشكل دراماتيكي كتقنية تشفير لا غنى عنها لإنشاء بروتوكولات اتصال آمنة. تقنيات اختبار الأولية القائمة على [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/)، وتشفير RSA القائم على مبرهنة أويلر، تدعم حرفياً البنية التحتية للإنترنت الحديثة.

إن رسائل LINE التي نرسلها دون تفكير كل يوم، ومشترياتنا من أمازون، كلها ترقص على أنغام هذه الصيغة البسيطة والجميلة $a^{p-1} \equiv 1 \pmod p$. تعلمنا [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) أنه مهما كانت الرياضيات مجردة، فسيأتي يوم تكون فيه مفيدة للبشرية.
