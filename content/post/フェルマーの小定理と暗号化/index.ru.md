...
[Малая теорема Ферма](https://kenji.blog/ru/p/fermats-little-theorem/) формулируется следующим образом:
...
[Малая теорема Ферма](https://kenji.blog/ru/p/fermats-little-theorem/) касается «простого числа $p$», но [Леонард Эйлер](https://kenji.blog/ru/p/euler/) обобщил ее для «любого положительного целого числа $n$». Это расширение необходимо для понимания алгоритма [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/).
...
И здесь на помощь приходит «вероятностный тест на простоту», использующий малую теорему Ферма наоборот. Он называется **тест Ферма ([Fermat](https://kenji.blog/ru/p/fermat/) Primality Test)**.
...
## 7. Применение в алгоритме [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/): Место встречи Ферма и Эйлера
...
5. Вычисляется модульный обратный элемент $d$ (закрытая экспонента) для $e$. То есть, находится такое $d$, которое удовлетворяет условию:
   ...
   Для этих вычислений используется **расширенный алгоритм [Евклид](https://kenji.blog/ru/p/euclid/)а**.
...
Здесь и появляется **теорема Эйлера** ($M^{\phi(N)} \equiv 1 \pmod N$). (※Строго говоря, $M$ и $N$ должны быть взаимно простыми, но в [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) вероятность того, что $M$ и $N$ не взаимно просты, астрономически мала, и, используя китайскую теорему об остатках, можно доказать, что это будет работать, даже если они не взаимно просты).
...
Мы также включим в реализацию «расширенный алгоритм [Евклид](https://kenji.blog/ru/p/euclid/)а» для нахождения модульного обратного элемента $d$.
...
Когда в 17 веке [Пьер де Ферма](https://kenji.blog/ru/p/fermat/) открыл эту «малую теорему», никто не мог подумать, что она когда-нибудь пригодится. Сам Ферма занимался теорией чисел исключительно из чистого математического любопытства.

Однако почти 300 лет спустя, в 1970-х годах, на заре компьютерных сетей теорема Ферма совершила драматическое возрождение в качестве криптографической технологии, необходимой для создания безопасных протоколов связи. Метод проверки простоты, основанный на малой теореме Ферма, и алгоритм [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/), основанный на теореме Эйлера, буквально поддерживают инфраструктуру современного Интернета.

И сообщения в мессенджерах, которые мы отправляем каждый день, и покупки на Amazon — все это танцует на фундаменте одной простой и красивой формулы: $a^{p-1} \equiv 1 \pmod p$. [Малая теорема Ферма](https://kenji.blog/ru/p/fermats-little-theorem/) учит нас тому, что независимо от того, насколько абстрактной может быть математика, однажды обязательно наступит время, когда она послужит человечеству.
