...
Безопасность и корректность многих криптографических алгоритмов, включая RSA, во многом зависят от очень красивой и мощной теоремы, открытой в 17 веке французским математиком Пьером де Ферма ([Pierre de Fermat](https://kenji.blog/p/fermat/)). Это **[Малая теорема Ферма](https://kenji.blog/p/fermats-little-theorem/) ([Fermat's Little Theorem](https://kenji.blog/p/fermats-little-theorem/))**. Кроме того, теорема Леонарда Эйлера ([Leonhard Euler](https://kenji.blog/p/euler/)), которая является ее обобщением, также играет решающую роль в теории криптографии.
...
[Малая теорема Ферма](https://kenji.blog/p/fermats-little-theorem/) формулируется следующим образом:
...
[Малая теорема Ферма](https://kenji.blog/p/fermats-little-theorem/) касается «простого числа $p$», но [Леонард Эйлер](https://kenji.blog/p/euler/) обобщил ее для «любого положительного целого числа $n$». Это расширение необходимо для понимания алгоритма RSA.
...
5. Вычисляется модульный обратный элемент $d$ (закрытая экспонента) для $e$. То есть, находится такое $d$, которое удовлетворяет условию:
   ...
   Для этих вычислений используется **расширенный алгоритм [Евклид](https://kenji.blog/p/euclid/)а**.
...
Мы также включим в реализацию «расширенный алгоритм [Евклид](https://kenji.blog/p/euclid/)а» для нахождения модульного обратного элемента $d$.
...
Когда в 17 веке [Пьер де Ферма](https://kenji.blog/p/fermat/) открыл эту «малую теорему», никто не мог подумать, что она когда-нибудь пригодится. Сам Ферма занимался теорией чисел исключительно из чистого математического любопытства.
...
И сообщения в мессенджерах, которые мы отправляем каждый день, и покупки на Amazon — все это танцует на фундаменте одной простой и красивой формулы: $a^{p-1} \equiv 1 \pmod p$. [Малая теорема Ферма](https://kenji.blog/p/fermats-little-theorem/) учит нас тому, что независимо от того, насколько абстрактной может быть математика, однажды обязательно наступит время, когда она послужит человечеству.
