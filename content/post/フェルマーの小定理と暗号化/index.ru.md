...
math: true
mermaid: true
categories: ["Математика", "cryptography", "programming"]
...
[Малая теорема Ферма](https://kenji.blog/ru/p/fermats-little-theorem/) касается «простого числа $p$», но [Леонард Эйлер](https://kenji.blog/ru/p/euler/) обобщил ее для «любого положительного целого числа $n$». Это расширение необходимо для понимания алгоритма RSA.
