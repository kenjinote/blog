...
math: true
mermaid: true
categories: ["Matemáticas", "cryptography", "programming"]
...
5. Calcular el inverso modular $d$ (exponente privado) de $e$. Es decir, encontrar $d$ que cumpla lo siguiente:
   ...
   Para este cálculo, se utiliza el **algoritmo de [[[Euclid](https://kenji.blog/es/p/euclid/)e](https://kenji.blog/p/euclid/)s](https://kenji.blog/p/euclid/) extendido**.
...
También incluiremos en la implementación el "algoritmo de [[[Euclid](https://kenji.blog/es/p/euclid/)e](https://kenji.blog/p/euclid/)s](https://kenji.blog/p/euclid/) extendido" para encontrar el inverso modular $d$.
