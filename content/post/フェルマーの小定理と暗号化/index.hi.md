...
RSA सहित कई क्रिप्टोग्राफिक एल्गोरिदम की सुरक्षा और वैधता 17वीं सदी के फ्रांसीसी गणितज्ञ पियरे डी फर्मेट ([Pierre de Fermat](https://kenji.blog/p/fermat/)) द्वारा खोजे गए एक अत्यंत सुंदर और शक्तिशाली प्रमेय पर काफी हद तक निर्भर करती है। यह **फर्मेट का छोटा प्रमेय ([Fermat's Little Theorem](https://kenji.blog/p/fermats-little-theorem/))** है। इसके अलावा, [लियोनहार्ड यूलर](https://kenji.blog/p/euler/) ([Leonhard Euler](https://kenji.blog/p/euler/)) का प्रमेय, जो कि इसका सामान्यीकरण है, भी क्रिप्टोग्राफिक सिद्धांत में एक निर्णायक भूमिका निभाता है।
...
मॉड्यूलर अंकगणित के मूल सिद्धांतों को समझने के बाद, आइए हमारे मुख्य विषय, फर्मेट के छोटे प्रमेय ([Fermat's Little Theorem](https://kenji.blog/p/fermats-little-theorem/)) पर नज़र डालते हैं।

### 3.1 प्रमेय की परिभाषा

फर्मेट के छोटे प्रमेय को इस प्रकार तैयार किया गया है:

> **फर्मेट का छोटा प्रमेय ([Fermat's Little Theorem](https://kenji.blog/p/fermats-little-theorem/))**
...
फर्मेट का छोटा प्रमेय 'अभाज्य संख्या $p$' के बारे बारे में है, लेकिन [लियोनहार्ड यूलर](https://kenji.blog/p/euler/) ने इसे 'किसी भी धनात्मक पूर्णांक $n$' के लिए सामान्यीकृत किया। RSA क्रिप्टोग्राफी को समझने के लिए यह विस्तार आवश्यक है।
...
5. $e$ के मॉड्यूलर व्युत्क्रम (modular inverse) $d$ (निजी घातांक/private exponent) की गणना करें। अर्थात, ऐसा $d$ खोजें जो निम्नलिखित को संतुष्ट करे:
   ...
   इस गणना के लिए **विस्तारित [यूक्लिड](https://kenji.blog/p/euclid/)ियन एल्गोरिदम (Extended [[Euclid](https://kenji.blog/p/euclid/)e](https://kenji.blog/p/euclid/)an Algorithm)** का उपयोग किया जाता है।
...
यहीं पर **यूलर का प्रमेय** ($M^{\phi(N)} \equiv 1 \pmod N$) लागू होता है। (※कड़ाई से कहें तो, $M$ और $N$ का सह-अभाज्य होना आवश्यक है, लेकिन RSA में, $M$ और $N$ के सह-अभाज्य न होने की संभावना खगोलीय रूप से कम है, और यह सिद्ध किया जा सकता है कि चाइनीज़ रिमाइंडर थ्योरम ([Chinese Remainder Theorem](https://kenji.blog/p/chinese-remainder-theorem/)) का उपयोग करके यह सह-अभाज्य न होने पर भी काम करता है)।
...
हम मॉड्यूलर व्युत्क्रम (modular inverse) $d$ खोजने के लिए "विस्तारित [यूक्लिड](https://kenji.blog/p/euclid/)ियन एल्गोरिदम (Extended [[Euclid](https://kenji.blog/p/euclid/)e](https://kenji.blog/p/euclid/)an Algorithm)" को भी कार्यान्वयन में शामिल करेंगे।
