...
फर्मेट का छोटा प्रमेय 'अभाज्य संख्या $p$' के बारे बारे में है, लेकिन [लियोनहार्ड यूलर](https://kenji.blog/hi/p/euler/) ने इसे 'किसी भी धनात्मक पूर्णांक $n$' के लिए सामान्यीकृत किया। RSA क्रिप्टोग्राफी को समझने के लिए यह विस्तार आवश्यक है।
...
यहीं पर **यूलर का प्रमेय** ($M^{\phi(N)} \equiv 1 \pmod N$) लागू होता है। (※कड़ाई से कहें तो, $M$ और $N$ का सह-अभाज्य होना आवश्यक है, लेकिन RSA में, $M$ और $N$ के सह-अभाज्य न होने की संभावना खगोलीय रूप से कम है, और यह सिद्ध किया जा सकता है कि चाइनीज़ रिमाइंडर थ्योरम ([Chinese Remainder Theorem](https://kenji.blog/hi/p/chinese-remainder-theorem/)) का उपयोग करके यह सह-अभाज्य न होने पर भी काम करता है)।
