...
आधुनिक डिजिटल समाज में, विशेष रूप से इंटरनेट के माध्यम से संचार में, 'क्रिप्टोग्राफी' (एन्क्रिप्शन) एक अपरिहार्य आधारभूत तकनीक बन गई है। हम वेब ब्राउज़र में HTTPS के माध्यम से सुरक्षित रूप से वेबसाइट ब्राउज़ कर सकते हैं, ऑनलाइन बैंकिंग में वित्तीय लेनदेन कर सकते हैं, और मैसेजिंग ऐप्स पर निजी बातचीत कर सकते हैं, यह सब उन्नत गणितीय सिद्धांतों द्वारा समर्थित क्रिप्टोग्राफ़िक प्रोटोकॉल के बैकग्राउंड में काम करने के कारण संभव है। इनमें से 'पब्लिक-की क्रिप्टोग्राफी' (सार्वजनिक-कुंजी क्रिप्टोग्राफी) एक बहुत ही महत्वपूर्ण भूमिका निभाती है, और इसका सबसे प्रमुख उदाहरण **[RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) क्रिप्टोग्राफी** है।

RSA सहित कई क्रिप्टोग्राफिक एल्गोरिदम की सुरक्षा और वैधता 17वीं सदी के फ्रांसीसी गणितज्ञ पियरे डी फर्मेट ([Pierre de Fermat](https://kenji.blog/hi/p/fermat/)) द्वारा खोजे गए एक अत्यंत सुंदर और शक्तिशाली प्रमेय पर काफी हद तक निर्भर करती है। यह **फर्मेट का छोटा प्रमेय ([Fermat's Little Theorem](https://kenji.blog/hi/p/fermats-little-theorem/))** है। इसके अलावा, [लियोनहार्ड यूलर](https://kenji.blog/hi/p/euler/) ([Leonhard Euler](https://kenji.blog/hi/p/euler/)) का प्रमेय, जो कि इसका सामान्यीकरण है, भी क्रिप्टोग्राफिक सिद्धांत में एक निर्णायक भूमिका निभाता है।

इस लेख में, हम शुरुआत से गहराई से बताएंगे कि कैसे फर्मेट के छोटे प्रमेय, जो कि शुद्ध गणित की एक खोज है, को आधुनिक व्यावहारिक क्रिप्टोग्राफिक तकनीकों, विशेष रूप से 'अभाज्य संख्या परीक्षण' (Primality Test) और '[RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) क्रिप्टोग्राफी' में लागू किया जाता है। यह एक बहुत विस्तृत तकनीकी मार्गदर्शिका होगी, जिसमें गणितीय प्रमाण, एन्क्रिप्शन और डिक्रिप्शन के तंत्र, और C++ और Python का उपयोग करके विशिष्ट एल्गोरिदम के कार्यान्वयन को शामिल किया गया है।
...
मॉड्यूलर अंकगणित के मूल सिद्धांतों को समझने के बाद, आइए हमारे मुख्य विषय, फर्मेट के छोटे प्रमेय ([Fermat's Little Theorem](https://kenji.blog/hi/p/fermats-little-theorem/)) पर नज़र डालते हैं।

### 3.1 प्रमेय की परिभाषा

फर्मेट के छोटे प्रमेय को इस प्रकार तैयार किया गया है:

> **फर्मेट का छोटा प्रमेय ([Fermat's Little Theorem](https://kenji.blog/hi/p/fermats-little-theorem/))**
...
फर्मेट का छोटा प्रमेय 'अभाज्य संख्या $p$' के बारे बारे में है, लेकिन [लियोनहार्ड यूलर](https://kenji.blog/hi/p/euler/) ने इसे 'किसी भी धनात्मक पूर्णांक $n$' के लिए सामान्यीकृत किया। [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) क्रिप्टोग्राफी को समझने के लिए यह विस्तार आवश्यक है।
...
यहीं पर फर्मेट के छोटे प्रमेय का उपयोग करने वाला 'प्रायिकतात्मक अभाज्य परीक्षण' (Probabilistic primality test), जिसे **फर्मेट टेस्ट ([Fermat](https://kenji.blog/hi/p/fermat/) Primality Test)** कहा जाता है, सामने आता है।
...
## 7. [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) क्रिप्टोग्राफी में अनुप्रयोग: जहाँ फर्मेट और यूलर फलीभूत होते हैं
...
5. $e$ के मॉड्यूलर व्युत्क्रम (modular inverse) $d$ (निजी घातांक/private exponent) की गणना करें। अर्थात, ऐसा $d$ खोजें जो निम्नलिखित को संतुष्ट करे:
   ...
   इस गणना के लिए **विस्तारित [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिदम (Extended [[Euclid](https://kenji.blog/hi/p/euclid/)e](https://kenji.blog/p/euclid/)an Algorithm)** का उपयोग किया जाता है।
...
यहीं पर **यूलर का प्रमेय** ($M^{\phi(N)} \equiv 1 \pmod N$) लागू होता है। (※कड़ाई से कहें तो, $M$ और $N$ का सह-अभाज्य होना आवश्यक है, लेकिन [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) में, $M$ और $N$ के सह-अभाज्य न होने की संभावना खगोलीय रूप से कम है, और यह सिद्ध किया जा सकता है कि चाइनीज़ रिमाइंडर थ्योरम ([Chinese Remainder Theorem](https://kenji.blog/hi/p/chinese-remainder-theorem/)) का उपयोग करके यह सह-अभाज्य न होने पर भी काम करता है)।
...
## 8. [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) क्रिप्टोग्राफी का टॉय इम्प्लीमेंटेशन (Python)
...
हम मॉड्यूलर व्युत्क्रम (modular inverse) $d$ खोजने के लिए "विस्तारित [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिदम (Extended [[Euclid](https://kenji.blog/hi/p/euclid/)e](https://kenji.blog/p/euclid/)an Algorithm)" को भी कार्यान्वयन में शामिल करेंगे।
...
हालाँकि, लगभग 300 साल बाद 1970 के दशक में, कंप्यूटर नेटवर्क के शुरुआती दिनों में, सुरक्षित संचार प्रोटोकॉल स्थापित करने के लिए आवश्यक क्रिप्टोग्राफिक तकनीक के रूप में फर्मेट के प्रमेय का नाटकीय रूप से पुनरुत्थान हुआ। फर्मेट के छोटे प्रमेय पर आधारित अभाज्य परीक्षण तकनीक और यूलर के प्रमेय पर आधारित [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) क्रिप्टोग्राफी आज के इंटरनेट बुनियादी ढांचे को सचमुच में सहारा देती है।
