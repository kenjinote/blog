...
image: "img.webp"
categories: ["ツール・開発環境"]
description: 'نشرح كيفية تثبيت التطبيقات من سطر الأوامر باستخدام مدير الحزم "WinGet" في Windows 11. نقدم خطوات التثبيت والإدارة السريعة للبرامج الرئيسية مثل Chrome و VSCode و Slack عبر سطر الأوامر.'
---
## المتطلبات الأساسية
