...
```mermaid
flowchart TD
    A["Studies at Kyoto University (Supervised by Yasuo Akizuki)"] -->|"Meeting Zariski"| B["Study Abroad at Harvard University"]
    B -->|"Presentation of Unsolved Problem"| C["Challenge to the Resolution of Singularities Problem"]
    C -->|"Over 10 Years of Struggle"| D["Proof of the Resolution of Singularities Theorem (1964)"]
    D -->|"Global Recognition"| E["Awarded the Fields Medal (1970)"]
```
...
```mermaid
flowchart LR
    X["Variety with Singularities X"] -->|"Blow-up Operation"| Y["Space with Exceptional Divisor E"]
    Y -->|"Iterative Operation"| Z["Smooth Variety X~"]
```
...
```mermaid
stateDiagram-v2
    s1: "Recognition of the Problem"
    s2: "Intuitive Reasoning"
    s3: "Logical Construction"
    s4: "Impasse (Singularity)"
    s5: "Shift in Perspective (Blow-up)"
    s6: "Resolution"
