...
- **بطاقة جيدة**: "أجب بصيغة [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/) الرياضية" ← "بالنسبة لعدد أولي $p$ وعدد صحيح $a$ أوليان نسبياً، $a^{p-1} \equiv 1 \pmod p$"
...
يعد تشفير RSA، وهو ممثل لتشفير المفتاح العام، تطبيقاً جميلاً لنظرية الأعداد الأولية (التطابق، نظرية أويلر، [خوارزمية [إقليدس](https://kenji.blog/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة).
