...
- **بطاقة جيدة**: "أجب بصيغة [مبرهنة فيرما الصغرى](https://kenji.blog/ar/p/fermats-little-theorem/) الرياضية" ← "بالنسبة لعدد أولي $p$ وعدد صحيح $a$ أوليان نسبياً، $a^{p-1} \equiv 1 \pmod p$"
...
### 4.1 المثال الأول: رياضيات تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) وتطبيقه بلغة Python

يعد تشفير RSA، وهو ممثل لتشفير المفتاح العام، تطبيقاً جميلاً لنظرية الأعداد الأولية (التطابق، نظرية أويلر، [خوارزمية [إقليدس](https://kenji.blog/ar/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة).

#### الخلفية الرياضية
يتم التعبير عن عمليات توليد المفاتيح والتشفير وفك التشفير في [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) بالمعادلات التالية.
...
لإيجاد $d$ الذي يحقق المعادلة $e \cdot d \equiv 1 \pmod{\phi(n)}$، من الضروري برمجة خوارزمية تسمى [خوارزمية [إقليدس](https://kenji.blog/ar/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة. بهذه الطريقة، **عند محاولة برمجة معادلة رياضية، ستواجه تحديات في التنفيذ مثل "كيف أقوم بحساب هذا المتغير بالتحديد؟"، ومن خلال حل هذه المشكلة، يتعمق فهمك الرياضي بشكل كبير.**
