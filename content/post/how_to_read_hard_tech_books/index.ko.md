...
- **나쁜 카드**: "다익스트라([Dijkstra](https://kenji.blog/ko/p/graph-theory-dijkstra-a-star/)) 알고리즘의 증명을 모두 쓰시오"
- **좋은 카드**: "다익스트라 알고리즘에서, 어떤 정점의 최단 거리가 확정되었다고 간주할 수 있는 조건은 무엇인가?" → "미확정 정점 집합 중에서, 잠정 거리가 최소인 정점을 선택했을 때."
- **좋은 카드**: "[페르마의 소정리](https://kenji.blog/ko/p/fermats-little-theorem/) 수식을 답하시오" → "소수 $p$ 와 서로소인 정수 $a$ 에 대하여, $a^{p-1} \equiv 1 \pmod p$"
