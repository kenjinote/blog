...
### 4.1 Пример 1: Математика шифрования [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) и реализация на Python

Алгоритм RSA — типичный пример криптографии с открытым ключом, является прекрасным применением элементарной теории чисел (модулярная арифметика, теорема Эйлера, расширенный алгоритм [Евклид](https://kenji.blog/ru/p/euclid/)а).

#### Математическая основа
Процесс генерации ключей, шифрования и расшифровки в [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) описывается следующими формулами.
...
Чтобы найти $d$, удовлетворяющее уравнению $e \cdot d \equiv 1 \pmod{\phi(n)}$, нужно реализовать расширенный алгоритм [Евклид](https://kenji.blog/ru/p/euclid/)а. Таким образом, **при попытке закодировать формулу вы сталкиваетесь с проблемой реализации: «А как конкретно вычислить эту переменную?», и в процессе её решения ваше понимание математики кардинально углубляется**.
