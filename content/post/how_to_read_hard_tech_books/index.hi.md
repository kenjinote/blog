...
- **अच्छा कार्ड**: "फर्मेट का छोटा प्रमेय ([Fermat's Little Theorem](https://kenji.blog/p/fermats-little-theorem/)) का सूत्र बताइए" → "एक अभाज्य संख्या $p$ और एक सह-अभाज्य पूर्णांक $a$ के लिए, $a^{p-1} \equiv 1 \pmod p$"
...
पब्लिक-की क्रिप्टोग्राफी (Public-key cryptography) का एक प्रमुख उदाहरण, RSA एन्क्रिप्शन, प्रारंभिक संख्या सिद्धांत (समीकरण, यूलर का प्रमेय, विस्तारित [यूक्लिड](https://kenji.blog/p/euclid/)ियन एल्गोरिदम) का एक सुंदर अनुप्रयोग है।
...
समीकरण $e \cdot d \equiv 1 \pmod{\phi(n)}$ को संतुष्ट करने वाले $d$ को खोजने के लिए, हमें विस्तारित [यूक्लिड](https://kenji.blog/p/euclid/)ियन एल्गोरिदम को लागू करने की आवश्यकता है। इस प्रकार, **जब आप गणितीय सूत्रों को कोड में बदलने का प्रयास करते हैं, तो आपको इस तरह की कार्यान्वयन चुनौतियों का सामना करना पड़ता है कि "इस चर की गणना विशेष रूप से कैसे की जानी चाहिए?", और इसे हल करने की प्रक्रिया में आपकी गणितीय समझ काफी गहरी हो जाती है** ।
