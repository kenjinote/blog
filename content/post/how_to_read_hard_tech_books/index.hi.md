...
- **बुरा कार्ड**: "[Dijkstra](https://kenji.blog/hi/p/graph-theory-dijkstra-a-star/) एल्गोरिदम का पूरा प्रमाण लिखें"
- **अच्छा कार्ड**: "[Dijkstra](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) एल्गोरिदम में, यह मानने की शर्त क्या है कि किसी शीर्ष (vertex) की सबसे छोटी दूरी निर्धारित हो गई है?" → "जब अनिर्धारित शीर्षों के समूह में से सबसे छोटी अस्थायी दूरी वाला शीर्ष चुना जाता है।"
- **अच्छा कार्ड**: "फर्मेट का छोटा प्रमेय ([Fermat's Little Theorem](https://kenji.blog/hi/p/fermats-little-theorem/)) का सूत्र बताइए" → "एक अभाज्य संख्या $p$ और एक सह-अभाज्य पूर्णांक $a$ के लिए, $a^{p-1} \equiv 1 \pmod p$"
...
### 4.1 उदाहरण 1: [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) क्रिप्टोग्राफी का गणित और Python में इसे लागू करना

पब्लिक-की क्रिप्टोग्राफी (Public-key cryptography) का एक प्रमुख उदाहरण, RSA एन्क्रिप्शन, प्रारंभिक संख्या सिद्धांत (समीकरण, यूलर का प्रमेय, विस्तारित [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिदम) का एक सुंदर अनुप्रयोग है।

#### गणितीय पृष्ठभूमि
[RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन में कुंजी निर्माण और एन्क्रिप्शन/डिक्रिप्शन प्रक्रिया को निम्नलिखित सूत्रों द्वारा दर्शाया गया है:
...
समीकरण $e \cdot d \equiv 1 \pmod{\phi(n)}$ को संतुष्ट करने वाले $d$ को खोजने के लिए, हमें विस्तारित [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिदम को लागू करने की आवश्यकता है। इस प्रकार, **जब आप गणितीय सूत्रों को कोड में बदलने का प्रयास करते हैं, तो आपको इस तरह की कार्यान्वयन चुनौतियों का सामना करना पड़ता है कि "इस चर की गणना विशेष रूप से कैसे की जानी चाहिए?", और इसे हल करने की प्रक्रिया में आपकी गणितीय समझ काफी गहरी हो जाती है** ।

### 4.2 उदाहरण 2: [Dijkstra](https://kenji.blog/hi/p/graph-theory-dijkstra-a-star/) का एल्गोरिदम और रिलैक्सेशन (Relaxation)

ग्राफ थ्योरी में सिंगल-सोर्स शॉर्टेस्ट पाथ (SSSP) समस्या को हल करने वाले [Dijkstra](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) एल्गोरिदम पर विचार करें।
