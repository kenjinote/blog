...
description: 'Обзор использования трекбола среднего размера «Deft Pro (M-DPT1MRBK)» от Elecom в течение недели. Объясняются плюсы, такие как снижение нагрузки на запястье и широкие возможности назначения кнопок, а также минусы, такие как хлопоты с очисткой и привыкание к управлению.'
---
...
- Нельзя использовать колесико, удерживая левую кнопку (например, если вы хотите изменить масштаб при выделении области в [Paint](https://kenji.blog/ru/p/browser-rendering-mechanism-dom-paint/))
