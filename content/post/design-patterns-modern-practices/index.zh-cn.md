...
1. **Facade（外观）**: 为复杂的子系统提供简单接口的概念，在微服务架构中扩展为了 [API Gateway](https://kenji.blog/zh-cn/p/microservices-architecture-bff-api-gateway/)（BFF: [Backend for Frontend](https://kenji.blog/zh-cn/p/microservices-architecture-bff-api-gateway/)）。
