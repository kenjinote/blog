...
1. **Facade (फसाड)**: जटिल सबसिस्टम के लिए एक सरल इंटरफ़ेस प्रदान करने की अवधारणा माइक्रोसर्विसेज आर्किटेक्चर में API गेटवे (BFF: Backend for Frontend) के रूप में विकसित हुई है।
