...
1. **Facade**: The concept of providing a simple interface to a complex subsystem has scaled up as an [API Gateway](https://kenji.blog/en/p/microservices-architecture-bff-api-gateway/) (BFF: [Backend for Frontend](https://kenji.blog/en/p/microservices-architecture-bff-api-gateway/)) in microservices architecture.
