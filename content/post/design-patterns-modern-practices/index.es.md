...
1. **Facade (Fachada)**: El concepto de proporcionar una interfaz simple para un subsistema complejo se ha ampliado como API Gateway (BFF: Backend for Frontend) en la arquitectura de microservicios.
