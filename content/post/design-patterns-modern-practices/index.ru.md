...
1. **Facade (Фасад)**: Концепция предоставления простого интерфейса к сложной подсистеме масштабировалась до [API Gateway](https://kenji.blog/ru/p/microservices-architecture-bff-api-gateway/) (BFF: [Backend for Frontend](https://kenji.blog/ru/p/microservices-architecture-bff-api-gateway/)) в микросервисной архитектуре.
