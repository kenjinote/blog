...
1. **Facade**: O conceito de fornecer uma interface simples para um subsistema complexo escalou como um [API Gateway](https://kenji.blog/pt/p/microservices-architecture-bff-api-gateway/) (BFF: [Backend for Frontend](https://kenji.blog/pt/p/microservices-architecture-bff-api-gateway/)) em arquiteturas de microsserviços.
