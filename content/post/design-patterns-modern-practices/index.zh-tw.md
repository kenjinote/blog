...
1. **Facade（外觀）** : 為複雜的子系統提供簡單介面的概念，已擴展為微服務架構中的 [API Gateway](https://kenji.blog/zh-tw/p/microservices-architecture-bff-api-gateway/)（BFF: [Backend for Frontend](https://kenji.blog/zh-tw/p/microservices-architecture-bff-api-gateway/)）。
