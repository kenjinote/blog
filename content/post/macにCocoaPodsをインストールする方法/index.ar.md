...
1. افتح الجهاز الطرفي
2. قم بتنفيذ `sudo gem install cocoapods`
→ لسبب ما، ظهرت رسالة الخطأ التالية وفشل التثبيت.
...
3. لذلك قمت بالبحث عن رسالة الخطأ على الويب (انظر "المراجع" أدناه)، ونفذت الأمر التالي
...
4. قم بتنفيذ `brew install cocoapods`
