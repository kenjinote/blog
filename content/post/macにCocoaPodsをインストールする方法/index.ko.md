...
title: 'Mac에 CocoaPods를 설치하는 방법과 오류 대처법'
slug: "macにCocoaPodsを설치する方法"
date: 2023-04-09T03:25:54+09:00
tags: ["mac", "CocoaPods", "macOS", "xcode"]
draft: false
image: "img_1.webp"
categories: ["pc-gadgets"]
description: 'Mac 환경에서 터미널을 사용하여 CocoaPods를 설치하는 절차를 자세히 설명합니다. ''sudo gem install cocoapods'' 실행 시의 오류 해결 방법과 Homebrew를 사용한 설치 명령어도 소개합니다.'
---
...
# 터미널에서 설치
1. 터미널 열기
2. `sudo gem install cocoapods` 실행
→ 어째서인지 아래와 같은 에러 메시지가 나오며 설치에 실패했다.
...
3. 그래서 에러 메시지를 웹에서 검색해서 (아래 '참고'를 참조), 다음 명령어를 실행했다
