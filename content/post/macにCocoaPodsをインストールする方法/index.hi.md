---
title: 'Mac पर CocoaPods इंस्टॉल करने का तरीका और त्रुटियों का समाधान'
slug: "macにCocoaPodsをइंस्टॉलする方法"
...
1. टर्मिनल खोलें
2. `sudo gem install cocoapods` चलाएँ
→ किसी कारण से, निम्न त्रुटि संदेश दिखाई दिया और स्थापना विफल रही।
...
3. इसलिए, मैंने त्रुटि संदेश के लिए वेब पर खोज की (नीचे "संदर्भ" देखें) और निम्न कमांड चलाया:
...
4. `brew install cocoapods` चलाएँ
...
ऐसा लगता है कि यह सफलतापूर्वक स्थापित हो गया है।
