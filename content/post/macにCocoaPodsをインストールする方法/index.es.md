...
slug: "macにCocoaPodsをInstalaciónする方法"
...
1. Abre la terminal
2. Ejecuta `sudo gem install cocoapods`
→ Por alguna razón, apareció el siguiente mensaje de error y la instalación falló.
...
3. Entonces busqué el mensaje de error en la web (ver "Referencias" abajo) y ejecuté el siguiente comando:
...
4. Ejecuta `brew install cocoapods`
...
Parece que se instaló correctamente.
