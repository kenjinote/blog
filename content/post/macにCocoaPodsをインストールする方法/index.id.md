...
slug: "macにCocoaPodsをInstalasiする方法"
...
1. Buka Terminal
2. Jalankan `sudo gem install cocoapods`
→ Entah kenapa, muncul pesan kesalahan berikut dan instalasi gagal.
...
3. Jadi saya mencari pesan kesalahan tersebut di web (lihat "Referensi" di bawah), dan menjalankan perintah berikut
...
4. Jalankan `brew install cocoapods`
