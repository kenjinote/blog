---
title: 'Como instalar o CocoaPods no Mac e resolver erros'
slug: "macにCocoaPodsをInstalaçãoする方法"
...
1. Abra o Terminal
2. Execute `sudo gem install cocoapods`
→ Por alguma razão, a seguinte mensagem de erro apareceu e a instalação falhou.
...
3. Então, pesquisei a mensagem de erro na web (veja "Referências" abaixo) e executei o seguinte comando:
...
4. Execute `brew install cocoapods`
...
Parece que foi instalado com sucesso.
