...
尽管留下了如此多伟大的成就，但毫无疑问，让费马成为历史上最著名的数学家的，是 **“费马大定理”**（Fermat's Last Theorem）的存在。
...
那就是英国数学家安德鲁·怀尔斯（Andrew Wiles）。他在 10 岁时在当地图书馆偶然发现了这个问题，便发誓要倾尽毕生精力去解决它。他采取了费马时代无法想象的宏大方法，将由日本数学家谷山丰和志村五郎提出的“所有椭圆曲线都是模形式的” **谷山-志村猜想**，与肯·里贝特（Ken Ribet）关于弗雷曲线的研究（epsilon 猜想）结合起来。
