...
儘管留下了如此多偉大的成就，但毫無疑問，讓費馬成為歷史上最著名的數學家的，是 **「費馬最後定理」**（Fermat's Last Theorem）的存在。
...
那就是英國數學家安德魯·懷爾斯（Andrew Wiles）。他在 10 歲時在當地圖書館偶然發現了這個問題，便發誓要傾盡畢生精力去解決它。他採取了費馬時代無法想像的宏大方法，將由日本數學家谷山豐和志村五郎提出的「所有橢圓曲線都是模形式的」 **谷山-志村猜想**，與肯·里貝特（Ken Ribet）關於弗雷曲線的研究（epsilon 猜想）結合起來。
