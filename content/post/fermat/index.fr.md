...
Le talent extraordinaire de Fermat ne se limitait pas à la théorie des nombres. En 1654, il a échangé une série de lettres avec le penseur de génie et mathématicien [Blaise Pascal](https://kenji.blog/fr/p/pascal/). Cette correspondance même est considérée comme l'aube de la **Théorie des probabilités** moderne.
...
Des décennies avant qu'[Isaac Newton](https://kenji.blog/fr/p/newton/) et [Gottfried Leibniz](https://kenji.blog/fr/p/leibniz/) n'établissent le calcul infinitésimal, Fermat avait conçu ses propres méthodes pour tracer des tangentes aux courbes et trouver les valeurs maximales et minimales des fonctions.
...
Dans les marges d'un passage concernant le théorème de Pythagore ( $x^2 + y^2 = z^2$ ) dans le volume 2 de son livre préféré, l'*Arithmetica* de [Diophante](https://kenji.blog/fr/p/diophantus/), Fermat a rédigé la note étonnante suivante en latin :
