...
```mermaid
graph TD
    WhiteE4["1. e4 (Avance del peón central blanco)"] --> BlackE5["1... e5 (El negro también reclama el centro)"]
    WhiteNf3["2. Nf3 (Desarrollo del caballo blanco, ataque al peón)"] --> BlackNc6["2... Nc6 (Desarrollo del caballo negro, defensa del peón)"]
    WhiteBb5["3. Bb5 (Desarrollo del alfil blanco, presión sobre el caballo negro)"] --> RuyLopez["'Ruy López' completado"]
```
...
```mermaid
graph TD
    WhiteE4["1. e4 (Avance del peón central blanco)"] --> BlackC5["1... c5 (El negro presiona el centro desde el flanco)"]
    BlackC5 --> Sicilian["'Defensa siciliana'"]
```
