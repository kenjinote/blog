...
```mermaid
graph TD
    WhiteE4["1. e4 (Vorstoß des weißen Zentrumsbauern)"] --> BlackE5["1... e5 (Schwarz beansprucht ebenfalls das Zentrum)"]
    WhiteNf3["2. Nf3 (Entwicklung des weißen Springers, Angriff auf den Bauern)"] --> BlackNc6["2... Nc6 (Entwicklung des schwarzen Springers, Verteidigung des Bauern)"]
    WhiteBb5["3. Bb5 (Entwicklung des weißen Läufers, Druck auf den schwarzen Springer)"] --> RuyLopez["'Ruy Lopez' vollendet"]
```
...
```mermaid
graph TD
    WhiteE4["1. e4 (Vorstoß des weißen Zentrumsbauern)"] --> BlackC5["1... c5 (Schwarz kontrolliert das Zentrum von der Flanke)"]
    BlackC5 --> Sicilian["'Sizilianische Verteidigung'"]
```
