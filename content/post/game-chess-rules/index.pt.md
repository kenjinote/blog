...
```mermaid
graph TD
    WhiteE4["1. e4 (Avanço do peão central das brancas)"] --> BlackE5["1... e5 (As pretas também reivindicam o centro)"]
    WhiteNf3["2. Nf3 (Desenvolvimento do cavalo das brancas, ataque ao peão)"] --> BlackNc6["2... Nc6 (Desenvolvimento do cavalo das pretas, defesa do peão)"]
    WhiteBb5["3. Bb5 (Desenvolvimento do bispo das brancas, pressão no cavalo das pretas)"] --> RuyLopez["Conclusão da 'Ruy Lopez'"]
```
...
```mermaid
graph TD
    WhiteE4["1. e4 (Avanço do peão central das brancas)"] --> BlackC5["1... c5 (As pretas restringem o centro pelo flanco)"]
    BlackC5 --> Sicilian["'Defesa Siciliana'"]
```
