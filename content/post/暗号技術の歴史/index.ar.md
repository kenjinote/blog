...
لذلك، تم اقتراح "تشفير المنحنى الإهليلجي (Elliptic Curve [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy: ECC)" في عام 1985. يستخدم هذا التشفير إضافة النقاط على المنحنيات الإهليلجية (عادة على شكل $y^2 = x^3 + ax + b$) فوق المجالات المحدودة.

من المعروف أن مشكلة اللوغاريتم المتقطع على المنحنيات الإهليلجية (ECDLP) أصعب في الحل من مشكلة التحليل إلى العوامل الأولية، **ويمكن لـ ECC تحقيق نفس مستوى الأمان لمفتاح [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) بطول 3072 بت باستخدام مفتاح بطول 256 بت فقط**. وقد أتاح هذا اتصالاً مشفرًا سريعًا وآمنًا (مثل ECDSA و ECDH) حتى في البيئات ذات الموارد الحسابية المحدودة، مثل الهواتف الذكية وأجهزة إنترنت الأشياء (IoT).
