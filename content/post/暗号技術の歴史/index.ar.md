...
تقنية التشفير ([Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy) هي تقنية للحفاظ على سرية المعلومات، وقد تطورت مع تاريخ البشرية. من نقل الأوامر السرية في الحروب القديمة إلى حماية معلومات بطاقات الائتمان في الإنترنت الحديث، كان الغرض من التشفير ثابتًا. وهو "ضمان أن المتلقي المقصود فقط يمكنه فهم المعلومات، ولا يمكن لأي طرف ثالث فك تشفيرها".

في أمن المعلومات الحديث، لا تقتصر تقنية التشفير على مجرد "سرية المعلومات (Confidentiality)"، بل تلعب أيضًا أدوارًا مهمة مثل "سلامة البيانات (Integrity)"، "المصادقة ([Authentication](https://kenji.blog/ar/p/oauth2-oidc-authentication-authorization-difference/))"، و"عدم التنصل (Non-repudiation)".

في هذا المقال، سنستعرض بالتفصيل تاريخ تطور تقنية التشفير من منظور تقني ورياضي، بدءًا من تشفير الاستبدال البسيط في العصور القديمة، مرورًا بالتشفير الميكانيكي، وتشفير المفتاح المشترك والمفتاح العام الحديث، وصولًا إلى عصر "التشفير المقاوم للكم ([PQC](/ar/p/post-quantum-cryptography/))" الذي سيحل مع الاستخدام العملي للحواسيب الكمومية.
...
## [آلان تورينج](https://kenji.blog/ar/p/turing/) و"بومب (Bombe)"
...
# 5. ثورة تشفير المفتاح العام: من ديفي-هيلمان إلى [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)
...
على الرغم من قوة تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)، إلا أنه مع تحسن أداء أجهزة الكمبيوتر، أصبح من الضروري زيادة طول المفتاح للحفاظ على الأمان (حاليًا 2048 أو 3072 بت)، مما أدى إلى مشكلة زيادة تكلفة الحساب.

لذلك، تم اقتراح "تشفير المنحنى الإهليلجي (Elliptic Curve [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy: [ECC](/ar/p/elliptic-curve-cryptography-math-cpp/))" في عام 1985. يستخدم هذا التشفير إضافة النقاط على المنحنيات الإهليلجية (عادة على شكل $y^2 = x^3 + ax + b$) فوق المجالات المحدودة.

من المعروف أن مشكلة اللوغاريتم المتقطع على المنحنيات الإهليلجية (ECDLP) أصعب في الحل من مشكلة التحليل إلى العوامل الأولية، **ويمكن لـ [ECC](/ar/p/elliptic-curve-cryptography-math-cpp/) تحقيق نفس مستوى الأمان لمفتاح [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) بطول 3072 بت باستخدام مفتاح بطول 256 بت فقط**. وقد أتاح هذا اتصالاً مشفرًا سريعًا وآمنًا (مثل ECDSA و ECDH) حتى في البيئات ذات الموارد الحسابية المحدودة، مثل الهواتف الذكية وأجهزة [إنترنت الأشياء](/ar/p/technology-iot/) (IoT).

---

# 7. تهديد الحواسيب الكمومية والتشفير المقاوم للكم (PQC)

بدت تقنية التشفير راسخة، ولكن في عام 1994، أحدث "خوارزمية شور" التي نشرها بيتر شور (Peter [Shor](/ar/p/shors-algorithm-and-rsa-breaking/)) صدمة كبيرة.

تستغل الحواسيب الكمومية خصائص ميكانيكا الكم المتمثلة في "التراكب" و"التشابك الكمي" لإجراء العمليات الحسابية. وقد تم إثبات رياضيًا أنه عند تشغيل خوارزمية شور على حاسوب كمومي ذي أداء كافٍ، يمكن حل مشكلة التحليل إلى العوامل الأولية ومشكلة اللوغاريتم المتقطع في "وقت متعدد الحدود". بمعنى آخر، في اليوم الذي يكتمل فيه حاسوب كمومي عملي (Q-Day)، ستنهار جميع تشفيرات المفتاح العام المستخدمة حاليًا مثل RSA و [ECC](/ar/p/elliptic-curve-cryptography-math-cpp/) على الفور.

## ظهور PQC (Post-Quantum [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy)
...
### 3. التشفير القائم على الرموز (Code-based [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy)
...
انهزم تشفير قيصر أمام تحليل التكرار، وهُزمت إنجما التي كانت تعتبر لا تُقهر أمام العقل العبقري لتورينج وقوة الآلات. والآن، تواجه التشفيرات القوية مثل [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) و ECC التي تدعم أساس مجتمع الإنترنت الحديث، تهديدًا أمام "الرمح" الجديد المتمثل في الحواسيب الكمومية.

ومع ذلك، فإن البشرية تتطلع بالفعل إلى المستقبل وتقوم بإعداد "درع" جديد يُسمى التشفير المقاوم للكم (PQC). في الوقت الحالي، أصبحت الاستعدادات للانتقال من تشفير المفتاح العام الحالي إلى PQC (ضمان المرونة التشفيرية - [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/) Agility) مهمة ملحة في البنى التحتية لتكنولوجيا المعلومات حول العالم.
