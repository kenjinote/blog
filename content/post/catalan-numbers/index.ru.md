...
[Числа Каталана](https://kenji.blog/p/catalan-numbers/) также встречаются в геометрии. Количество способов разбить выпуклый $(n+2)$-угольник на $n$ треугольников путем проведения непересекающихся диагоналей между вершинами в точности равно $C_n$.
...
[Числа Каталана](https://kenji.blog/p/catalan-numbers/) можно выразить очень простой **явной формулой** (Closed-form formula), используя комбинаторные обозначения:
