...
## 1. مقدمة: ما هي [أرقام كاتالان](https://kenji.blog/p/catalan-numbers/)؟

في عالم الرياضيات وعلوم الكمبيوتر، غالبًا ما نرى ظاهرة جميلة حيث تشترك العديد من المشكلات التي تبدو مختلفة تمامًا في نفس البنية الأساسية. أحد الأمثلة البارزة هو **[أرقام كاتالان](https://kenji.blog/p/catalan-numbers/)** (Catalan numbers).
...
تظهر هذه السلسلة كحل لمجموعة متنوعة بشكل مذهل من المشاكل التوافقية. في هذه المقالة، سنقدم أربعة أمثلة شهيرة تتضمن [أرقام كاتالان](https://kenji.blog/p/catalan-numbers/) (الأقواس الصحيحة، الأشجار الثنائية، تثليث المضلعات، ومسارات دايك). سنكشف عن البنية العودية التي تقف وراءها لنفهم لماذا تتوافق جميعها مع نفس السلسلة تمامًا. علاوة على ذلك، سوف نتعمق في الخوارزميات الحسابية باستخدام البرمجة الديناميكية (DP) والاشتقاقات الرياضية عبر [الدوال المولدة](https://kenji.blog/p/generating-functions/).

## 2. أربعة أمثلة ملموسة ل[أرقام كاتالان](https://kenji.blog/p/catalan-numbers/)
...
تظهر [أرقام كاتالان](https://kenji.blog/p/catalan-numbers/) أيضًا في الهندسة. إن عدد الطرق لتقسيم مضلع محدب مكون من $(n+2)$ ضلعًا إلى $n$ من المثلثات عن طريق رسم أقطار لا تتقاطع بين الرؤوس هو بالضبط $C_n$.
...
يمكن التعبير عن [أرقام كاتالان](https://kenji.blog/p/catalan-numbers/) بصيغة رياضية مغلقة بسيطة جدًا (Closed-form formula) باستخدام الترميز التوافقي:
...
### 4.2. نهج [الدوال المولدة](https://kenji.blog/p/generating-functions/) ([Generating Functions](https://kenji.blog/p/generating-functions/))

لتكن الدالة المولدة ل[أرقام كاتالان](https://kenji.blog/p/catalan-numbers/) هي $C(x) = \sum_{n=0}^\infty C_n x^n$.
...
## 5. الخوارزميات الحسابية ل[أرقام كاتالان](https://kenji.blog/p/catalan-numbers/)

عند حساب [أرقام كاتالان](https://kenji.blog/p/catalan-numbers/) برمجيًا، توجد ثلاثة مناهج أساسية.
...
### 5.2. البرمجة الديناميكية (Dynamic Programming)
...
سلسلة [أرقام كاتالان](https://kenji.blog/p/catalan-numbers/) $C_n$ هي سلسلة آسرة تظهر بشكل موحد في مجموعة كبيرة من المشكلات التي تبدو مختلفة، مثل سلاسل الأقواس الصحيحة، وأشكال الأشجار الثنائية، وتثليث المضلعات، ومسارات دايك. السبب في أن هذه المشكلات تسفر عن نفس العدد هو أنها جميعًا تجسد بنية عودية مشتركة: **"تقسيم الكل إلى مشكلتين فرعيتين ثم دمجهما"**.
