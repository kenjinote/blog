---
title: '在 VSCode 中建置 Qt 開發環境！Qt Extension Pack 的安裝與使用方法'
...
image: "img_1.webp"
categories: ["ツール・開発環境"]
description: '介紹在 VSCode (Visual Studio Code) 中用以開發 Qt 應用程式的擴充功能「Qt Extension Pack」導入步驟。推薦給想建置輕量級開發環境以取代 Qt Creator 的使用者。'
---
