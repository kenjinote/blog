---
title: '[Введение в Hugo] Как установить в Windows и предварительно просмотреть в локальной среде'
...
image: "img.webp"
categories: ["ブログ運営"]
description: 'Понятно объясняем процесс установки генератора статических сайтов «Hugo» в среде Windows, как настроить переменную среды Path и как использовать команды для запуска локального сервера и предварительного просмотра статей блога.'
---
# Установка HUGO
