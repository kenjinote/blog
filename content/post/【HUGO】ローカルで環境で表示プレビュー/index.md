...
[アドレス](https://kenji.blog/p/c-language-pointers-memory-management-stack-heap/)は実行時に出力されるので（上記の例では`http://localhost:1313/`）、ブラウザに[アドレス](https://kenji.blog/p/c-language-pointers-memory-management-stack-heap/)をコピーする。
