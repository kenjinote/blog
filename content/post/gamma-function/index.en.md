...
3. **Analytic Number Theory**: Through its relationship with the [Riemann](https://kenji.blog/en/p/riemann/) zeta function, it holds a central position in the study of prime number distribution.
