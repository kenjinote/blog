...
title: '소프트웨어의 규모는 어떻게 변했을까? 소스 코드 줄 수의 역사와 진화'
slug: "ソースコードの行数"
...
image: "img_1.webp"
categories: ["IT・테크놀로지"]
description: '우주 왕복선의 42만 줄부터 Google의 20억 줄까지 시대와 함께 극적으로 증가하는 소스 코드의 줄 수에 대해 해설합니다. 코드 증가의 장점과 버그 발생 위험의 관계나 Linux 커널의 사례도 소개합니다.'
---
