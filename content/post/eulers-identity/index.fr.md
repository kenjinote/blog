...
L'**identité d'Euler** ([Euler's Identity](https://kenji.blog/fr/p/eulers-identity/)) est connue comme la relation la plus belle et la plus profonde des mathématiques. Cette équation relie de manière étonnamment simple cinq constantes mathématiques fondamentales issues de domaines totalement différents.
...
```mermaid
graph TD
    A["Identité d'Euler"] -->|"inclut"| B["e (Analyse)"]
    A -->|"inclut"| C["i (Algèbre)"]
    A -->|"inclut"| D["pi (Géométrie)"]
    A -->|"inclut"| E["1, 0 (Arithmétique)"]
```
