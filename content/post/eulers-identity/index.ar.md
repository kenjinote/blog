...
تُعرف **متطابقة أويلر** (Euler's Identity) بأنها العلاقة الأجمل والأكثر عمقاً في الرياضيات. تربط هذه المعادلة بين 5 ثوابت رياضية أساسية تظهر في مجالات مختلفة تماماً، في شكل بسيط بشكل مذهل.
...
كان ليونهارت أويلر (Leonhard Euler) عالِم رياضيات بارزاً في القرن الثامن عشر، وقد ترك إنجازات في مجالات واسعة مثل الفيزياء، وعلم الفلك، والمنطق. هذه المتطابقة التي تحمل اسمه يمكن القول إنها واحدة من تتويجات أبحاثه الواسعة.
