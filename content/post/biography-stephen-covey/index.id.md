---
title: "Stephen Covey: Maestro Kepemimpinan yang Mengubah Dunia dengan 'The 7 Habits'"
...
```mermaid
flowchart TD
    A["Stephen Covey (1932-2012)"] --> B["Filosofi Inside-Out"]
    B --> C["Pemulihan Etika Karakter"]
    C --> D["The 7 Habits (1989)"]
    
    D --> E["Kemenangan Pribadi (Kebiasaan 1-3)"]
    D --> F["Kemenangan Publik (Kebiasaan 4-6)"]
    D --> G["Pembaruan (Kebiasaan 7)"]
    
    E --> H["Individu yang Mandiri"]
    F --> I["Sinergi Saling Ketergantungan"]
    
    H --> J["Kepemimpinan yang Berpusat pada Prinsip"]
    I --> J
    G --> J
```
