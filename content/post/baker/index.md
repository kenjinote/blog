...
イギリスの数学者 **[アラン・ベーカー](https://kenji.blog/p/baker/)（[Alan Baker](https://kenji.blog/p/baker/)）** は、この超越数論という極めて難解な分野において、歴史的なブレイクスルーをもたらしました。彼の最大の業績である「対数の一次形式に関する定理（[ベーカー](https://kenji.blog/p/baker/)の定理）」は、純粋な超越数論の枠を超えて、長年の未解決問題であった特定の[ディオファントス](https://kenji.blog/p/diophantus/)方程式の解法や、[ガウス](https://kenji.blog/p/gauss/)の類数問題の解決に決定的な役割を果たしました。この画期的な成果により、彼は1970年に31歳の若さで数学界の最高栄誉である **フィールズ賞（Fields Medal）** を受賞しました。
...
その後、彼はさらなる高みを目指してケンブリッジ大学のトリニティ・カレッジに進学しました。当時のケンブリッジ大学は、数論の研究において世界をリードする拠点の一つであり、[ベーカー](https://kenji.blog/p/baker/)はそこでイギリスの数論界を牽引していた偉大な数学者 **ハロルド・ダヴェンポート（Harold Davenport）** の指導を受けることになります。ダヴェンポートは[ディオファントス](https://kenji.blog/p/diophantus/)近似や解析的整数論の権威であり、彼のもとで[ベーカー](https://kenji.blog/p/baker/)は高度な数学的直感と厳密な証明の技術を磨き上げました。
...
1900年、[ダフィット・ヒルベルト](https://kenji.blog/p/hilbert/)はパリで開催された国際数学者会議において、23の未解決問題（ヒルベルトの23の問題）を提示しました。そのうちの第7問題は次のようなものでした。
...
[ベーカー](https://kenji.blog/p/baker/)は、自身の対数の一次形式に関する下界を用いることで、変数 $x, y$ の絶対値の上限を具体的に計算することに成功しました。これにより、計算機を用いて有限回の探索を行うことで、トゥエ方程式のすべての解を完全に決定するアルゴリズムが確立されました。同様の手法は **[モーデル](https://kenji.blog/p/mordell/)方程式（Mordell equation）** $y^2 = x^3 + k$ などのより複雑な[ディオファントス](https://kenji.blog/p/diophantus/)方程式にも適用され、計算機数論という新しい分野の発展を促しました。
