...
[David Hilbert](https://kenji.blog/en/p/hilbert/) (January 23, 1862 – February 14, 1943) was a German mathematician, widely recognized as one of the most influential and greatest mathematicians of the late 19th and early 20th centuries. Often compared to his brilliant French contemporary [Henri Poincaré](https://kenji.blog/en/p/poincare/), [Hilbert](https://kenji.blog/en/p/hilbert/) emphasized strict logic and formalism, in contrast to [Poincaré](https://kenji.blog/en/p/poincare/)'s reliance on intuition. [Hilbert](https://kenji.blog/en/p/hilbert/) profoundly influenced almost every field of modern mathematics, earning him the moniker **"The King of Mathematics"**.
...
[Hilbert](https://kenji.blog/en/p/hilbert/) was born on January 23, 1862, in Wehlau, near Königsberg (now Kaliningrad, Russia), the capital of the Province of East Prussia in the Kingdom of Prussia. His father, Otto [Hilbert](https://kenji.blog/en/p/hilbert/), was a strict district judge. His mother, Maria Therese, was a well-educated woman with a deep interest in philosophy and astronomy. It is said that [Hilbert](https://kenji.blog/en/p/hilbert/) inherited his logical thinking and thirst for knowledge from his parents.

Königsberg was a city with deep academic roots; it was the birthplace of the great philosopher Immanuel Kant and was famous for the "[Seven Bridges of Königsberg](https://kenji.blog/en/p/seven-bridges-of-konigsberg/)" problem solved by [Leonhard Euler](https://kenji.blog/en/p/euler/). During his school days, [Hilbert](https://kenji.blog/en/p/hilbert/)'s grades were unremarkable, but he possessed a special intuition and passion for mathematics. He loathed rote memorization, preferring to solve problems by constructing logic from scratch in his own mind. This approach—building from logical foundations rather than relying on memorization—became the core of his later mathematical style.

### "Mathematical Walks" and Lifelong Friends

In 1880, [Hilbert](https://kenji.blog/en/p/hilbert/) entered the University of Königsberg, where he met two individuals who would change his life. One was the genius Hermann Minkowski, who had won the mathematics prize of the Paris Academy of Sciences at just 18 years old. The other was Adolf Hurwitz, a brilliant young professor.

The three of them made it a daily routine to take a walk under an apple tree near the university at a set time, passionately discussing the latest mathematical problems. These daily **"mathematical walks"** allowed the young [Hilbert](https://kenji.blog/en/p/hilbert/)'s mathematical talents to fully blossom. By clashing ideas with two minds possessing entirely different mathematical intuitions, [Hilbert](https://kenji.blog/en/p/hilbert/) refined his own concepts and stepped into the depths of mathematics.

```mermaid
flowchart TD
    A["University of Königsberg"] -->|"Enrollment (1880)"| B["Start of Full-scale Mathematical Research"]
    B -->|"Interaction with Professors"| C["Adolf Hurwitz"]
    B -->|"Interaction with Classmates"| D["Hermann Minkowski"]
    C -->|"Daily Mathematical Walks"| E["Creation and Refinement of Ideas"]
    D -->|"Daily Mathematical Walks"| E
```

## 3. Breakthrough in Invariant Theory: Leaping Beyond Gordan's Criticism

[Hilbert](https://kenji.blog/en/p/hilbert/) first gained worldwide fame in the field of invariant theory. Invariant theory studies the properties of polynomials that remain unchanged under coordinate transformations. At the time, Paul Gordan, the leading expert in this field, had proven that invariants of two variables have a finite basis (Gordan's theorem), but the case for three or more variables required exceedingly complex calculations and remained an unsolved problem for years.

In 1888, [Hilbert](https://kenji.blog/en/p/hilbert/) tackled this challenge with an entirely new approach. Abandoning the traditional method of explicitly calculating and constructing the basis formulas, he used proof by contradiction to present an existence proof that **"a finite basis must exist"**. This powerful theorem is known today as **[Hilbert](https://kenji.blog/en/p/hilbert/)'s basis theorem**.

Legend has it that upon seeing this abstract proof completely devoid of calculation, Gordan angrily exclaimed, **"This is not mathematics. This is theology!"** (Das ist nicht Mathematik. Das ist Theologie!). Later, however, even Gordan had to admit the logical correctness and power of this method. [Hilbert](https://kenji.blog/en/p/hilbert/)'s achievement marked a historic turning point where the center of mathematics shifted from "construction via specific calculation" to "existence proof of abstract structures."
...
In this report, he applied [Galois theory](https://kenji.blog/en/p/galois-theory/) to number theory, laying the foundations for [Hilbert](https://kenji.blog/en/p/hilbert/)'s class field theory. Class field theory, later perfected by Teiji [Takagi](https://kenji.blog/en/p/takagi-teiji/) and Emil Artin, is considered one of the most beautiful theories in 20th-century number theory. [Hilbert](https://kenji.blog/en/p/hilbert/) managed to unify seemingly disparate results in number theory under higher, beautiful laws.

## 5. Axiomatization of Geometry: The Philosophy of "Tables, Chairs, and Beer Mugs"

In 1899, [Hilbert](https://kenji.blog/en/p/hilbert/) published the book "Grundlagen der Geometrie" (Foundations of Geometry). It completely reconstructed the axiom system of [[Euclid](https://kenji.blog/en/p/euclid/)e](https://kenji.blog/p/euclid/)an geometry, which had been the absolute foundation of geometry for over 2000 years, from a modern perspective.
...
## 7. The 1900 Paris International Congress of Mathematicians: [Hilbert](https://kenji.blog/en/p/hilbert/)'s 23 Problems

In 1900, at the second International Congress of Mathematicians (ICM) held in Paris, [Hilbert](https://kenji.blog/en/p/hilbert/) delivered a historic and monumental address. Asking "What are the problems that will guide the progress of mathematics in the coming century?", he presented **"23 unsolved problems"** that 20th-century mathematicians should strive to solve.
...
[Hilbert](https://kenji.blog/en/p/hilbert/)'s problems remain crucial signposts for modern mathematicians even today.

## 8. Integral Equations and [Hilbert](https://kenji.blog/en/p/hilbert/) Space: A Bridge to Quantum Mechanics

Entering the 1900s, [Hilbert](https://kenji.blog/en/p/hilbert/)'s interest shifted from algebra and geometry to analysis. He deeply studied the integral equation theory of the Swedish mathematician Ivar Fredholm and constructed a spectral theory in infinite-dimensional spaces.

Through this process, he introduced the concept of **[Hilbert](https://kenji.blog/en/p/hilbert/) space**, a generalization of finite-dimensional [[Euclid](https://kenji.blog/en/p/euclid/)e](https://kenji.blog/p/euclid/)an space into infinite dimensions. The inner product $\langle x, y \rangle$ in an inner product space $\mathcal{H}$ is strictly defined as a space that possesses linearity and Hermitian symmetry, and satisfies completeness (all [Cauchy](https://kenji.blog/en/p/cauchy/) sequences converge). Expressed mathematically, the inner product satisfies:
...
[Hilbert](https://kenji.blog/en/p/hilbert/) often joked that "physics is too difficult for physicists," and he aimed to reconstruct the foundations of physics using rigorous mathematical axiomatic methods (related to his 6th problem).

In 1915, during the period when Albert Einstein was struggling to complete the gravitational field equations for general relativity, [Hilbert](https://kenji.blog/en/p/hilbert/) was also working on the problem. Using the mathematically elegant technique of the variational principle, [Hilbert](https://kenji.blog/en/p/hilbert/) derived the correct gravitational field equations almost simultaneously with Einstein. Today, the action integral underlying this theory is known as the **Einstein-[Hilbert](https://kenji.blog/en/p/hilbert/) action**.
...
```mermaid
graph LR
    A["Formalization of Mathematics (Construction of Axiom System)"] --> B["Proof of Completeness"]
    A --> C["Proof of Consistency"]
    A --> D["Proof of Decidability (Existence of Algorithm)"]
```

This program triggered fierce debates (the foundational crisis) with intuitionists like L. E. J. Brouwer. However, [Hilbert](https://kenji.blog/en/p/hilbert/) boldly pushed his program forward, declaring, "No one shall expel us from the paradise that Cantor has created for us."

## 11. The Shock of [Gödel's Incompleteness Theorems](https://kenji.blog/en/p/godels-incompleteness-theorems/) and the Program's Transformation

However, in 1931, the young Austrian logician [Kurt Gödel](https://kenji.blog/en/p/godel/) published his **incompleteness theorems**, delivering a decisive blow to [Hilbert](https://kenji.blog/en/p/hilbert/)'s Program.
...
This demonstrated that the construction of the "perfect mathematical system where everything can be proven, including its own consistency," which [Hilbert](https://kenji.blog/en/p/hilbert/) had dreamed of, was impossible. Although [Hilbert](https://kenji.blog/en/p/hilbert/) was reportedly initially deeply disappointed and angered by this result, the rigorous methods of metamathematics and formal logic developed during the pursuit of [Hilbert](https://kenji.blog/en/p/hilbert/)'s Program ultimately led directly to the founding of computer science and theoretical computer science by [Alan Turing](https://kenji.blog/en/p/turing/).
...
Göttingen, once a vibrant mathematical sanctuary where talent from all over the world gathered, collapsed almost overnight. Once, at a banquet, the Nazi Minister of Education Bernhard Rust asked [Hilbert](https://kenji.blog/en/p/hilbert/), "How is mathematics at your institution now that it has been freed from the Jewish influence?" [Hilbert](https://kenji.blog/en/p/hilbert/) replied with anger and sorrow: "Mathematical Institute? There is really none any more."

On February 14, 1943, in the midst of World War II, [Hilbert](https://kenji.blog/en/p/hilbert/) passed away in solitude at the age of 81 in Göttingen, after most of his former students had fled to America and elsewhere. Very few people attended his funeral.

## 13. Conclusion: "We Must Know, We Will Know"

Even after [David Hilbert](https://kenji.blog/en/p/hilbert/)'s passing, the mathematical legacy he left behind has never faded. The trajectory of his thoughts is inscribed in every corner of modern mathematics.
...
* **1888**: Proves "[Hilbert](https://kenji.blog/en/p/hilbert/)'s basis theorem" in invariant theory.
...
* **1915**: Formulates the "Einstein-[Hilbert](https://kenji.blog/en/p/hilbert/) action" in general relativity.
* **1920s**: Proposes "[Hilbert](https://kenji.blog/en/p/hilbert/)'s Program."
