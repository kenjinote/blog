...
اعتبارًا من عام 2026، يشهد مجال تطوير البرمجيات فترة من التغيير الجذري غير المسبوق. حتى سنوات قليلة مضت، كان مفهوم "الذكاء الاصطناعي يكتب التعليمات البرمجية" يقتصر على كونه أداة مساعدة للمبرمجين، مثل إنشاء الأكواد النمطية (boilerplate) أو الإكمال التلقائي للدوال. ولكن، مع التطور المذهل للنماذج اللغوية الكبيرة (LLMs)، انقلبت الأمور رأسًا على عقب. فالذكاء الاصطناعي الحديث ليس مجرد "آلة كاتبة ذكية"؛ بل تحول إلى "مهندس مبتدئ مستقل" قادر على بناء أنظمة كاملة بشكل لحظي ومستقل، من الواجهة الأمامية إلى منطق الواجهة الخلفية، وتصميم مخطط قاعدة البيانات، وحتى بناء خطوط أنابيب [CI/CD](https://kenji.blog/ar/p/cicd-pipeline-github-actions-best-practices/)، بمجرد تزويده بمستند متطلبات.

في مثل هذا العصر، كيف يمكننا نحن "المبرمجين" و"مهندسي البرمجيات" البقاء على قيد الحياة؟ مع الانكماش السريع للقيمة الاقتصادية لفعل "كتابة الأكواد" نفسه، فإن "المبرمج" الذي يعرف فقط بناء الجملة (الـ syntax) للغة برمجة معينة ويتقن واجهات برمجة التطبيقات ([API](/ar/p/chatgpt-gemini-claude-api-comparison/)) لإطار عمل محدد يتم إقصاؤه سريعًا من السوق.
...
كان علماء الكمبيوتر الأوائل يتفاعلون مع مفاتيح الأجهزة المادية مباشرة باستخدام البطاقات المثقبة، ويعطون التعليمات للكمبيوتر بلغة الآلة (سلسلة من الأصفار والآحاد). بعد ذلك، ظهرت لغة التجميع (Assembly)، والتي أتاحت للبشر التحكم في الأجهزة باستخدام اختصارات سهلة الفهم. ومع تقدم الزمن، ظهرت لغات عالية المستوى مثل C و Fortran، ونجحت في تغليف التفاصيل المعقدة للأجهزة مثل إدارة الذاكرة وسجلات وحدة المعالجة المركزية. ثم من خلال لغات حديثة مثل [Java](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/) و Python و Ruby و TypeScript، أصبح بإمكان المبرمجين التركيز أكثر على "ما نريد أن يفعله الكمبيوتر (What)" بدلاً من "كيفية تشغيل الكمبيوتر (How)".

ظهور الذكاء الاصطناعي ([LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/)) هو التحول النموذجي الأحدث والأكبر في تاريخ التجريد هذا. إذا كان تطور لغات البرمجة بمثابة "إخفاء للأجهزة"، فإن تطور النماذج اللغوية الكبيرة هو "إخفاء لقواعد اللغة (syntax)".
...
ومع ذلك، في التطوير الحديث باستخدام الذكاء الاصطناعي، تعمل قدرة الذكاء الاصطناعي $A(t)$ كـ "مضاعف قوي (Multiplier)" يضخم القدرة البشرية. نظرًا لأن قدرات الذكاء الاصطناعي تنمو بشكل أُسي مع مرور الوقت $t$ (نسخة الذكاء الاصطناعي من [قانون مور](/ar/p/business-moores-law/))، يمكن التعبير عن الإنتاجية في عصر الذكاء الاصطناعي $P_{AI}(t)$ بالمعادلة التالية:
...
*   $\beta$: معامل يشير إلى مدى فعالية استخلاص الأدوات الخاصة بالذكاء الاصطناعي (جودة هندسة التلقين ([Prompt Engineering](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/)) ومدى تطور سير العمل التعاوني مع الذكاء الاصطناعي)
...
المهام التي تتميز بقدرة عالية على التنبؤ واعتماد منخفض على السياق، مثل كتابة عمليات التوجيه (routing) في واجهات برمجة التطبيقات ([API](/ar/p/chatgpt-gemini-claude-api-comparison/)) أو إنشاء شاشات CRUD بسيطة، سيكون لها $P_{auto} \approx 1$ وسيتم أتمتتها بالكامل تقريبًا. من ناحية أخرى، المهام التي تعتمد بشكل كبير على السياق، مثل "كيفية دمج الأنظمة القديمة مع الخدمات المصغرة الجديدة بأمان" أو "كيفية تصميم تدفق مصادقة يلبي متطلبات الإدارة القانونية دون الإضرار بتجربة المستخدم"، يصعب أتمتتها.
...
## 5. تحديد المتطلبات هو "هندسة التلقين ([Prompt Engineering](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/)) الحقيقية"
...
1.  **أعد تعلم "أساسيات" التكنولوجيا بشكل كامل**: اترك كيفية استخدام أطر العمل (frameworks) للذكاء الاصطناعي. ولكن، لا غنى عن الفهم العميق لآليات نظام التشغيل (OS)، وبروتوكولات الشبكة ([TCP](https://kenji.blog/ar/p/http3-quic-protocol-tcp-udp/)/IP، HTTP/3)، والهياكل الداخلية لقواعد البيانات ([B-Tree](https://kenji.blog/ar/p/b-tree-database-index-theory/)، مستويات عزل المعاملات)، وهياكل البيانات والخوارزميات. لكي تتمكن من الحكم على ما إذا كانت مخرجات الذكاء الاصطناعي صحيحة، فإن الأساس القوي في علوم الكمبيوتر أمر ضروري.
2.  **إتقان البنية السحابية (Cloud Architecture) والأنظمة الموزعة**: ركز على كيفية الجمع بين الموارد السحابية مثل AWS و GCP و Azure لبناء أنظمة قابلة للتوسع، بدلاً من التركيز على الأكواد الفردية. افهم مفهوم [البنية التحتية ككود](/ar/p/iac-infrastructure-as-code-terraform/) ([IaC](https://kenji.blog/ar/p/iac-infrastructure-as-code-terraform/)) مثل [Terraform](https://kenji.blog/ar/p/iac-infrastructure-as-code-terraform/)، وطور القدرة على تصميم النظام بأكمله ككود.
