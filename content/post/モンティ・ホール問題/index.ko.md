...
## 3. [베이즈 정리](https://kenji.blog/ko/p/bayes-theorem/)에 의한 엄밀한 증명

수학적으로 이 문제를 엄밀하게 풀기 위해서는 조건부 확률을 계산하는 '[베이즈 정리](https://kenji.blog/ko/p/bayes-theorem/)'를 사용합니다.
...
드디어 [베이즈 정리](https://kenji.blog/ko/p/bayes-theorem/)를 적용하여 문 A와 문 C의 사후 확률을 계산합니다.
