...
This theorem, discovered by [Pierre de Fermat](https://kenji.blog/en/p/fermat/), states the following:
...
For any base $a$ ($1 < a < N-1$), we verify whether $a^{N-1} \equiv 1 \pmod N$ according to [Fermat's Little Theorem](https://kenji.blog/en/p/fermats-little-theorem/), but we perform the calculation in steps.
