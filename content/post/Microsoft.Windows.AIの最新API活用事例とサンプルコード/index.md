...
## 7. [パフォーマンス最適化](https://kenji.blog/p/web-vitals-frontend-performance-optimization-lcp-fid-cls/)とベストプラクティス
...
Windows 11のCopilot Runtimeと `Microsoft.Windows.AI` APIは、すべてのWindows開発者に「ローカルAI」という極めて強力な武器をもたらしました。もはやクラウドAPIに完全に依存する必要はありません。レイテンシを排除し、プライバシーを堅守しつつ、[オフライン](https://kenji.blog/p/pwa-progressive-web-apps-service-worker/)でも完全に動作する次世代のAI体験をユーザーに提供することが可能です。
