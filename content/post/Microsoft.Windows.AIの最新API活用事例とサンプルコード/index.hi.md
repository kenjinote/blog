...
हाल ही के वर्षों में, AI तकनीक का विकास उल्लेखनीय रहा है, और क्लाउड पर बड़े भाषा मॉडल ([LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/)) के उपयोग से एज डिवाइस (स्थानीय पीसी) पर AI अनुमान (inference) की ओर तेज़ी से प्रतिमान बदलाव (paradigm shift) हो रहा है। इसके मूल में "Windows Copilot Runtime" है, जो Microsoft द्वारा Windows 11 के लिए प्रदान किया गया है, और इसे संचालित करने के लिए "Microsoft.Windows.AI" API है।
...
साथ ही, AI मॉडल, विशेष रूप से [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) का अनुमान (डिकोड चरण), **मेमोरी-बाउंड (Memory-Bound)** होने की प्रवृत्ति रखता है। सिस्टम मेमोरी की सैद्धांतिक बैंडविड्थ $BW$ की गणना इस प्रकार की जाती है:
...
- **NPU का डायनेमिक रिसोर्स स्केलिंग**: जब कई AI एप्लिकेशन एक साथ चल रहे हों (उदाहरण के लिए, बैकग्राउंड में शोर रद्दीकरण (noise cancellation) और फोरग्राउंड में कोड जनरेशन), तो Windows कर्नेल शेड्यूलर QoS (Quality of [Service](https://kenji.blog/hi/p/kubernetes-k8s-architecture-pod-service-ingress/)) की गारंटी देने के लिए NPU के निष्पादन संदर्भ को गतिशील रूप से स्विच करने में सक्षम होगा।
