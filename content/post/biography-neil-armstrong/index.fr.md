---
title: "Neil Armstrong : La vie et la philosophie du premier homme à marcher sur la Lune"
...
```mermaid
flowchart TD
    A["Naissance (1930, Ohio)"] --> B["Aviateur naval (Guerre de Corée)"]
    B --> C["Pilote d'essai (X-15, etc.)"]
    C --> D["Astronaute de la NASA (1962)"]
    D --> E["Gemini 8 (Premier amarrage orbital)"]
    E --> F["Apollo 11 (1969, Premier atterrissage lunaire)"]
    F --> G["Professeur à l'Université de Cincinnati (Formation de la relève)"]
    G --> H["Membre de la commission d'enquête sur l'accident de Challenger"]
    H --> I["Héritage pour la postérité (Le héros silencieux)"]
```
