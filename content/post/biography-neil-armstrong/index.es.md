---
title: "Neil Armstrong: La vida y filosofía del hombre que caminó por primera vez en la Luna"
...
```mermaid
flowchart TD
    A["Nacimiento (1930, Ohio)"] --> B["Aviador naval (Guerra de Corea)"]
    B --> C["Piloto de pruebas (X-15, etc.)"]
    C --> D["Astronauta de la NASA (1962)"]
    D --> E["Gemini 8 (Primer acoplamiento orbital)"]
    E --> F["Apolo 11 (1969, Primer aterrizaje humano en la Luna)"]
    F --> G["Profesor de la Universidad de Cincinnati (Educando sucesores)"]
    G --> H["Comisión investigadora del accidente del Challenger"]
    H --> I["Legado para las generaciones futuras (Héroe silencioso)"]
```
