---
title: "Neil Armstrong: Kehidupan dan Filosofi Pria Pertama yang Berjalan di Bulan"
...
```mermaid
flowchart TD
    A["Kelahiran (1930 Ohio)"] --> B["Penerbang Angkatan Laut (Perang Korea)"]
    B --> C["Pilot Penguji (X-15, dll.)"]
    C --> D["Astronot NASA (1962)"]
    D --> E["Gemini 8 (Docking orbital pertama)"]
    E --> F["Apollo 11 (1969 Pendaratan di bulan pertama)"]
    F --> G["Profesor Universitas Cincinnati (Mendidik generasi penerus)"]
    G --> H["Anggota Komite Investigasi Kecelakaan Challenger"]
    H --> I["Warisan untuk Generasi Mendatang (Pahlawan pendiam)"]
```
