...
このパラドックスは、後の数学の歴史を変える「[ゲーデルの不完全性定理](https://kenji.blog/p/godels-incompleteness-theorems/)（数学には絶対に証明できない真理が存在する）」や、コンピュータ科学における「コルモゴロフ複雑性（情報をどれだけ短く圧縮できるかという理論）」など、最先端の学問へと繋がっていく重要な道標となったのです。
