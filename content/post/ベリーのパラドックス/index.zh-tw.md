...
這個悖論成為了通往最先進學問的重要路標，它與後來改變數學歷史的「[哥德爾不完備定理](https://kenji.blog/zh-tw/p/godels-incompleteness-theorems/)（數學中存在絕對無法證明的真理）」，以及資訊科學中的「柯爾莫哥洛夫複雜性（探討資訊能被壓縮到多短的理論）」等都有著緊密的關聯。
