...
Этот парадокс стал важным ориентиром, который привел к таким передовым областям знаний, изменившим последующую историю математики, как «[Теоремы Гёделя о неполноте](https://kenji.blog/ru/p/godels-incompleteness-theorems/)» (существуют истины, которые в математике абсолютно невозможно доказать) и «Колмогоровская сложность» (теория о том, насколько кратко можно сжать информацию) в информатике.
