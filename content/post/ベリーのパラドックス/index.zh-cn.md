...
slug: 'berry-paradox'
description: '“不能用少于19个字表达的最小整数”这句话本身，却用不到19个字表达了那个数字！？本文将为你分析这个发生于日常语言与数学边界上、简短而优美的悖论。'
...
这个悖论成为了重要的路标，通向了后来改变数学历史的“[哥德尔不完备定理](https://kenji.blog/zh-cn/p/godels-incompleteness-theorems/)（数学中存在绝对无法证明的真理）”，以及计算机科学中的“柯尔莫哥洛夫复杂性（研究信息能被压缩到多短的理论）”等最前沿的学问。
