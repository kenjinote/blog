...
إثبات المعرفة الصفرية هو مفهوم في نظرية التشفير اقترحه لأول مرة شافي غولدفاسر (Shafi Goldwasser)، سيلفيو ميكالي (Silvio Micali)، وتشارلز راكوف (Charles Rackoff) في الثمانينيات، ولكنه ظل لفترة طويلة مقتصرًا على البحث النظري. ومع ذلك، مع ظهور تقنية [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) و Web3، تغير الوضع تمامًا. برز ZKP فجأة كـ "عصا سحرية" تحل في الوقت نفسه مشكلة قابلية التوسع (حدود القدرة على المعالجة) ومشكلة الخصوصية (أن جميع المعاملات عامة ومكشوفة) التي تواجهها شبكات [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) العامة مثل الإيثريوم (Ethereum).
...
هذه الطريقة قوية، ولكنها تتطلب أن يكون المُتَحَقِّق متصلاً بالإنترنت (أونلاين)، مما يجعلها غير مريحة للتطبيق في أنظمة موزعة غير متزامنة مثل [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/). في [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/)، يجب أن يكون أي شخص قادرًا على التحقق من الإثباتات السابقة في أي وقت.
...
نظرًا لوجود عدد لا يحصى من قيود مصفوفات R1CS، فإن التحقق منها بشكل فردي غير فعال للغاية. لذلك، باستخدام استيفاء لاغرانج ([Lagrange](https://kenji.blog/ar/p/lagrange/) interpolation)، يتم ضغط هذه القيود إلى معادلة متعددة حدود واحدة. هذا هو **QAP (Quadratic Arithmetic Program)**.
...
تواجه شبكات [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) من الطبقة الأولى (L1) مثل الإيثريوم قيودًا كبيرة في قابلية التوسع (المعضلة الثلاثية) بسبب تركيزها القوي على اللامركزية والأمن. الحل النهائي للطبقة الثانية (L2) لحل هذه المشكلة هو **ZK-Rollups**.
...
طالما شكلت خاصية "جميع البيانات علنية" في شبكات [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) العامة عائقًا كبيرًا أمام الشركات للتعامل مع المعاملات السرية ومعلومات سلسلة التوريد على [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/).
...
1. **تكلفة حساب إنشاء الإثبات وتسريع الأجهزة**
   يتطلب إنشاء ZKP حسابات هائلة لمتعددات الحدود، وتحويل فورييه السريع ([FFT](/ar/p/fast-fourier-transform-algorithm/))، والضرب القياسي المتعدد (MSM). في الوقت الحاضر، تتقدم الأبحاث بسرعة لتطوير أجهزة مخصصة (FPGA و ASIC) لتسريع إنشاء هذا الإثبات، وهو ما يسمى بـ **تعدين ZKP** (Prover Network).
2. **التقييس وتحسين تجربة المطورين (DX)**
   تنتشر العديد من اللغات المخصصة لكتابة دوائر ZKP مثل Circom، Cairo، Noir، و Leo. سيكون توحيد المعايير لهذه اللغات، ونضوج المترجمات (Compilers) التي تنشئ تلقائيًا دوائر ZKP من لغات موجودة مثل [Rust](https://kenji.blog/ar/p/webassembly-wasm-current-future/) أو C++، هو المفتاح لتبني ZKP من قبل مهندسي البرمجيات العامين.

## خاتمة

لقد تطور إثبات المعرفة الصفرية (ZKP) من مجرد "تقنية لزيادة سرية العملات المشفرة" إلى "تقنية متعددة الأغراض تعيد تعريف الثقة (Trust) على الإنترنت بأكمله". الإثباتات الصغيرة المحسوبة في أعماق المعادلات الرياضية ونظرية التشفير، ستوسع من قابلية التوسع في [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) بشكل لا نهائي، وستكون بمثابة درع قوي لحماية خصوصيتنا.
