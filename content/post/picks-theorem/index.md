...
[オイラー](https://kenji.blog/p/euler/)の定理によれば、平面上に描かれた連結なグラフ（ネットワーク）について、頂点の数を $V$ 、辺の数を $E$ 、面の数を $F$ としたとき、以下の関係式が成り立ちます。
...
[オイラー](https://kenji.blog/p/euler/)の公式をこのグラフに適用すると、
$$
(I + B) - E + (f + 1) = 2
$$
すなわち、
