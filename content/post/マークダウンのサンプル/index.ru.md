---
author: "Hugo Authors"
title: 'Примеры синтаксиса Markdown для Hugo: базовый синтаксис для заголовков, абзацев и т. д.'
slug: "マークダウンのサンプル"
date: "2019-03-11"
description: 'Представляем примеры базового синтаксиса Markdown, которые можно использовать при создании контента в генераторе статических сайтов Hugo. Вы можете посмотреть, как оформляются заголовки (от H1 до H6), абзацы и прочее с помощью CSS-темы.'
