...
Dans l'histoire des mathématiques, peu d'histoires sont aussi dramatiques et inspirantes que celle-ci. Le mathématicien britannique **[Andrew Wiles](https://kenji.blog/fr/p/wiles/)** a accompli l'exploit monumental de prouver le « dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/) », un problème qui était resté non résolu pendant plus de 350 ans.
...
[Andrew Wiles](https://kenji.blog/fr/p/wiles/) est né le 11 avril 1953 à Cambridge, en Angleterre. Son destin s'est scellé alors qu'il n'avait que 10 ans. Dans sa bibliothèque locale, il a pris un livre de mathématiques intitulé « Men of Mathematics » (par E. T. Bell).

Dans ce livre, il a rencontré ce qui était considéré comme le plus grand mystère de l'histoire des mathématiques : le dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/). C'est le célèbre théorème où le mathématicien français [Pierre de Fermat](https://kenji.blog/fr/p/fermat/) a écrit dans la marge d'un livre : « J'ai une démonstration véritablement merveilleuse de cette proposition, que cette marge est trop étroite pour contenir. »
...
## Qu'est-ce que le dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/) ?

[Le dernier théorème de Fermat](https://kenji.blog/fr/p/fermats-last-theorem/) s'exprime par la formule très simple suivante :
...
Dans les années 1980, alors que Wiles avait avancé ses recherches à Cambridge et Oxford et était finalement devenu professeur à l'Université de Princeton aux États-Unis, une approche complètement nouvelle pour résoudre le dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/) a émergé dans le monde mathématique. C'était un lien avec la « conjecture de Taniyama-Shimura ».

La conjecture de Taniyama-Shimura est une profonde conjecture mathématique stipulant que « toutes les courbes elliptiques sur le corps des nombres rationnels sont modulaires », ce qui à première vue semble sans rapport avec le théorème de [Fermat](https://kenji.blog/fr/p/fermat/). Cependant, en 1984, Gerhard Frey a proposé l'idée que « si le dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/) est faux (c'est-à-dire qu'une solution existe), la courbe elliptique spéciale créée à partir de celui-ci (la courbe de Frey) ne serait pas modulaire, contredisant ainsi la conjecture de Taniyama-Shimura. »

La situation a changé de façon spectaculaire en 1986 lorsque Ken Ribet a rigoureusement prouvé l'idée de Frey (le théorème de Ribet). En d'autres termes, le fait étonnant a été établi que « si vous prouvez la conjecture de Taniyama-Shimura, le dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/) est automatiquement prouvé. »

```mermaid
graph TD
    A["Contre-exemple au dernier théorème de Fermat"] -->|"Construction de la courbe de Frey"| B["Courbe elliptique avec des propriétés inhabituelles"]
    B -->|"Théorème de Ribet"| C["Non modulaire"]
    D["Conjecture de Taniyama-Shimura"] -->|"Toutes les courbes elliptiques sont modulaires"| E["Apparition d'une contradiction"]
    C -.->|"Conflit"| E
    E -->|"Conclusion"| F["Le dernier théorème de Fermat est vrai"]
```
...
Il y avait plusieurs raisons à son secret. L'une d'elles était que s'il devenait connu qu'il travaillait sur un problème aussi célèbre que le dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/), il ferait face à des interférences constantes de la part des médias et d'autres chercheurs, l'empêchant de se concentrer. Une autre était d'empêcher ses concurrents de voler ses idées.
...
À la fin de la conférence, Wiles a écrit la formule du dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/) au tableau noir et a annoncé tranquillement : « Je pense que je vais m'arrêter ici. » À ce moment-là, la salle a éclaté en un tonnerre d'applaudissements. Les médias du monde entier ont largement rapporté : « [Le dernier théorème de Fermat](https://kenji.blog/fr/p/fermats-last-theorem/) enfin prouvé ! », faisant de Wiles une célébrité soudaine.
...
> « C'était une révélation incroyable. C'était tellement beau, tellement simple, et je ne pouvais pas comprendre comment j'avais pu passer à côté. » ([Andrew Wiles](https://kenji.blog/fr/p/wiles/))
...
Pour cette réalisation, Wiles a reçu de nombreux prix prestigieux, dont l'hommage spécial de la médaille Fields et le prix [Abel](https://kenji.blog/fr/p/abel/), et a été fait chevalier (Sir) par la famille royale britannique.

## Conclusion

L'histoire d'[Andrew Wiles](https://kenji.blog/fr/p/wiles/) démontre les possibilités infinies des êtres humains apportées par la curiosité pure et un esprit indomptable. Le rêve apparemment **téméraire** nourri par un garçon de 10 ans est devenu réalité des décennies plus tard, surmontant de nombreux revers.

Bien que le dernier théorème de [Fermat](https://kenji.blog/fr/p/fermat/) ait été résolu, de nombreux mathématiciens continuent d'explorer les nouveaux champs fertiles des mathématiques ouverts par Wiles à la recherche de la prochaine vérité. Son nom, avec celui de [Pierre de Fermat](https://kenji.blog/fr/p/fermat/), restera à jamais gravé dans l'histoire de l'intellect humain.
