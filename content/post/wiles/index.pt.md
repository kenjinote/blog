---
title: "Andrew Wiles: O matemático solitário que provou o Último Teorema de Fermat"
description: "Explorando a vida e as conquistas matemáticas de Andrew Wiles, que estabeleceu um marco histórico na matemática ao provar o Último Teorema de Fermat."
slug: "wiles"
...
Na história da matemática, poucas histórias são tão dramáticas e inspiradoras como esta. O matemático britânico **[Andrew Wiles](https://kenji.blog/pt/p/wiles/)** alcançou a façanha monumental de provar o "Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/)", um problema que permaneceu sem solução por mais de 350 anos.
...
[Andrew Wiles](https://kenji.blog/pt/p/wiles/) nasceu em 11 de abril de 1953 em Cambridge, Inglaterra. Seu destino foi traçado quando ele tinha apenas 10 anos. Em sua biblioteca local, ele pegou um livro de matemática intitulado "Homens da Matemática" (por E. T. Bell).

Nesse livro, ele encontrou o que era considerado o maior mistério da história da matemática: o Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/). É o famoso teorema em que o matemático francês [Pierre de Fermat](https://kenji.blog/pt/p/fermat/) escreveu à margem de um livro: "Tenho uma demonstração verdadeiramente maravilhosa desta proposição, que esta margem é muito estreita para conter."
...
## O que é o Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/)?

[O Último Teorema de Fermat](https://kenji.blog/pt/p/fermats-last-theorem/) é expresso pela seguinte fórmula muito simples:
...
Na década de 1980, quando Wiles havia avançado em sua pesquisa em Cambridge e Oxford e, finalmente, se tornou professor na Universidade de Princeton, nos Estados Unidos, uma abordagem completamente nova para resolver o Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/) surgiu no mundo matemático. Era uma conexão com a "Conjectura de Taniyama-Shimura".

A conjectura de Taniyama-Shimura é uma conjectura matemática profunda afirmando que "todas as curvas elípticas sobre o corpo dos números racionais são modulares", o que, à primeira vista, parece não ter relação com o Teorema de [Fermat](https://kenji.blog/pt/p/fermat/). No entanto, em 1984, Gerhard Frey propôs a ideia de que "se o Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/) for falso (o que significa que uma solução existe), a curva elíptica especial criada a partir dele (a curva de Frey) não seria modular, contradizendo assim a conjectura de Taniyama-Shimura".

A situação mudou dramaticamente em 1986, quando Ken Ribet provou rigorosamente a ideia de Frey (o Teorema de Ribet). Em outras palavras, estabeleceu-se o fato surpreendente de que "se você provar a conjectura de Taniyama-Shimura, o Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/) é automaticamente provado".

```mermaid
graph TD
    A["Contraexemplo do Último Teorema de Fermat"] -->|"Construção da Curva de Frey"| B["Curva Elíptica com Propriedades Incomuns"]
    B -->|"Teorema de Ribet"| C["Não Modular"]
    D["Conjectura de Taniyama-Shimura"] -->|"Todas as Curvas Elípticas são Modulares"| E["Ocorre uma Contradição"]
    C -.->|"Conflito"| E
    E -->|"Conclusão"| F["O Último Teorema de Fermat é Verdadeiro"]
```
...
Havia várias razões para o seu segredo. Uma era que se soubessem que ele estava trabalhando em um problema tão famoso quanto o Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/), ele enfrentaria interferência constante da mídia e de outros pesquisadores, impedindo-o de se concentrar. Outra era para evitar que os concorrentes roubassem suas ideias.
...
No final da palestra, Wiles escreveu a fórmula do Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/) no quadro-negro e anunciou baixinho: "Acho que vou parar por aqui." Naquele momento, a sala explodiu em aplausos estrondosos. A mídia em todo o mundo relatou amplamente: "Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/) finalmente provado!", tornando Wiles uma celebridade repentina.
...
> "Foi uma revelação inacreditável. Foi tão bonito, tão simples, e eu não conseguia entender como tinha deixado passar." ([Andrew Wiles](https://kenji.blog/pt/p/wiles/))
...
Por essa conquista, Wiles recebeu vários prêmios de prestígio, incluindo o tributo especial da Medalha Fields e o Prêmio [Abel](https://kenji.blog/pt/p/abel/), e recebeu o título de cavaleiro (Sir) pela família real britânica.

## Conclusão

A história de [Andrew Wiles](https://kenji.blog/pt/p/wiles/) demonstra as infinitas possibilidades dos seres humanos provocadas pela pura curiosidade e um espírito indomável. O sonho aparentemente **imprudente** abrigado por um menino de 10 anos tornou-se realidade décadas depois, superando inúmeros contratempos.

Embora o Último Teorema de [Fermat](https://kenji.blog/pt/p/fermat/) tenha sido resolvido, muitos matemáticos continuam a explorar os férteis novos campos da matemática abertos por Wiles em busca da próxima verdade. Seu nome, juntamente com [Pierre de Fermat](https://kenji.blog/pt/p/fermat/), ficará para sempre gravado na história do intelecto humano.
