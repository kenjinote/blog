...
它指出，不存在满足该方程的正整数解 $(x, y, z)$ 。当 $n = 2$ 时，它作为[毕达哥拉斯](/zh-cn/p/pythagoras/)定理（[勾股定理](/zh-cn/p/diverse-proofs-of-pythagorean-theorem/)）广为人知，并且存在无数个解（[毕达哥拉斯](/zh-cn/p/pythagoras/)数）。然而，费马主张，当 $n$ 为3或更大时，该方程永远不成立。
