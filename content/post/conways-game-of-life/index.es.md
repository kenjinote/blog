...
El **Juego de la vida de Conway** ([Conway's Game of Life](https://kenji.blog/es/p/conways-game-of-life/)) es un tipo de **autómata celular** ideado por el matemático británico John Horton Conway en 1970. Aunque se llama juego, es un "juego de cero jugadores", lo que significa que su evolución está determinada por su estado inicial, sin requerir más intervención.
