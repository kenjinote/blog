...
O **Jogo da Vida de Conway** ([Conway's Game of Life](https://kenji.blog/pt/p/conways-game-of-life/)) é um tipo de **autômato celular** inventado pelo matemático britânico John Horton Conway em 1970. Embora seja chamado de jogo, é um "jogo de zero jogadores", o que significa que sua evolução é determinada pelo seu estado inicial, não necessitando de nenhuma entrada adicional.
