...
En la sociedad actual de Internet, nuestra capacidad para comunicarnos de forma segura se debe a la **criptografía**. En la base de esta criptografía se encuentra un hermoso teorema descubierto en el siglo XVII por el matemático Pierre de Fermat.
...
El Pequeño Teorema de Fermat es un teorema extremadamente simple pero poderoso que demuestra la relación entre los números primos y los números enteros.
...
Un pequeño teorema descubierto por Pierre de Fermat en el siglo XVII se ha convertido en un elemento indispensable que sustenta la base de la seguridad de la información en la sociedad moderna cientos de años después.

**El Pequeño Teorema de Fermat** puede considerarse uno de los ejemplos más hermosos que demuestran cómo las matemáticas puras se conectan con la tecnología práctica (criptografía y algoritmos). Uno no puede evitar asombrarse por la profundidad de las matemáticas y la amplitud de su aplicabilidad.
