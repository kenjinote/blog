...
इन नेटवर्कों को सरलता और गणितीय रूप से कठोरता से प्रस्तुत करने और उनका विश्लेषण करने के लिए एक शक्तिशाली रूपरेखा प्रदान करना, जो पहली नज़र में अत्यधिक जटिल और यहां तक ​​कि अराजक लगते हैं, **ग्राफ सिद्धांत** ([Graph Theory](https://kenji.blog/hi/p/graph-theory-dijkstra-a-star/)) है। ग्राफ सिद्धांत का उपयोग करके, हम जटिल प्रणालियों के भीतर छिपी संरचनाओं और गुणों को उजागर कर सकते हैं, इष्टतम संचार मार्ग खोज सकते हैं, और पूरे नेटवर्क की भेद्यता का मूल्यांकन कर सकते हैं।
...
## 2. ग्राफ सिद्धांत का जन्म: [कोनिग्सबर्ग के सात पुल](https://kenji.blog/hi/p/seven-bridges-of-konigsberg/)

ग्राफ सिद्धांत का इतिहास 18वीं शताब्दी का है। 1736 में, शानदार स्विस गणितज्ञ [लियोनहार्ड यूलर](https://kenji.blog/hi/p/euler/) ([Leonhard Euler](https://kenji.blog/hi/p/euler/)) ने एक प्रसिद्ध गणितीय पहेली को शानदार ढंग से हल किया, जिससे इस क्षेत्र की शुरुआत हुई। इस पहेली को "[कोनिग्सबर्ग के सात पुल](https://kenji.blog/hi/p/seven-bridges-of-konigsberg/)" के रूप में जाना जाता है।
...
*   **अनिर्देशित ग्राफ (Undirected [Graph](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))**: एक ग्राफ जहां किनारों की कोई दिशा नहीं होती है। इसका उपयोग तब किया जाता है जब संबंध हमेशा पारस्परिक और दो-तरफा होता है, जैसे संचार लाइनें, दो-तरफ़ा सड़कें, या फेसबुक "मित्र" संबंध।
...
वास्तविक दुनिया की समस्याओं को मॉडल करते समय, हम अक्सर न केवल "क्या वे जुड़े हुए हैं" बल्कि "कनेक्शन में आसानी" या "लागत" भी व्यक्त करना चाहते हैं। ऐसे मामलों में, एक **भारित ग्राफ (Weighted [Graph](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))** का उपयोग किया जाता है, जहां प्रत्येक किनारे को एक संख्यात्मक मान (वजन) सौंपा जाता है। वजन शहरों के बीच की दूरी, संचार विलंब समय या यात्रा लागत का प्रतिनिधित्व कर सकता है।
...
### 5.1. चौड़ाई-पहली खोज ([BFS](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) और गहराई-पहली खोज ([DFS](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))
...
*   **गहराई-पहली खोज (DFS)**: यथासंभव गहराई तक अन्वेषण करता है, और जब एक गतिरोध से टकराता है, तो किसी अन्य मार्ग का अन्वेषण करने के लिए पिछले शाखा बिंदु पर वापस आ जाता है। यह दीवारों का अनुसरण करके भूलभुलैया को हल करने जैसा है। एक ग्राफ में चक्रों का पता लगाने या टोपोलॉजिकल छँटाई के लिए उपयोग किया जाता है। इसे स्टैक ([Stack](https://kenji.blog/hi/p/c-language-pointers-memory-management-stack-heap/)) या पुनरावर्ती फ़ंक्शन कॉल का उपयोग करके कार्यान्वित किया जाता है।
...
### 5.3. न्यूनतम फैले हुए पेड़ (Minimum Spanning [Tree](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) की समस्या: क्रुसकल का एल्गोरिथ्म
