...
Roberval a réalisé cette grande découverte, mais, fidèle à lui-même, a retardé sa publication pour défendre son poste de professeur, ne la communiquant que par lettres à quelques mathématiciens proches (comme [Mersenne](https://kenji.blog/fr/p/mersenne/)).
...
- **Conflit avec [René Descartes](https://kenji.blog/fr/p/descartes/)** :
  Alors que [Descartes](https://kenji.blog/fr/p/descartes/) promouvait la "géométrie analytique", qui résolvait la géométrie à l'aide de l'algèbre, Roberval valorisait les méthodes purement géométriques et cinématiques. Roberval critiquait la méthode de [Descartes](https://kenji.blog/fr/p/descartes/) comme étant trop artificielle et attaquait souvent les failles des théories de [Descartes](https://kenji.blog/fr/p/descartes/). [Descartes](https://kenji.blog/fr/p/descartes/), à son tour, méprisait Roberval en le qualifiant de "grossier et sans éducation", et leur relation resta hostile tout au long de leur vie.
