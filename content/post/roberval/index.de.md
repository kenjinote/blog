...
- **Konflikt mit [René Descartes](https://kenji.blog/de/p/descartes/)**:
  Während [Descartes](https://kenji.blog/de/p/descartes/) die „analytische Geometrie“ förderte, die die Geometrie mithilfe der Algebra löste, schätzte Roberval rein geometrische und kinematische Methoden. Roberval kritisierte Descartes' Methode als zu künstlich und griff oft Fehler in Descartes' Theorien an. Descartes wiederum blickte auf [Roberval](https://kenji.blog/de/p/roberval/) als „grob und ungebildet“ herab, und ihre Beziehung blieb ihr Leben lang feindselig.
...
- **Einfluss auf [Blaise Pascal](https://kenji.blog/de/p/pascal/)**:
  Auch das junge Genie [Pascal](https://kenji.blog/de/p/pascal/) wurde stark von Roberval beeinflusst. Pascal veröffentlichte später Arbeiten über die Zykloide unter dem Pseudonym „A. Dettonville“, und viele der darin verwendeten Methoden waren verfeinerte Versionen von Robervals Ideen über Indivisible. Roberval schätzte [Pascal](https://kenji.blog/de/p/pascal/)s Talent sehr und unterstützte ihn.
