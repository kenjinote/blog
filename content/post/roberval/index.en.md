...
This "kinematic tangent method" demonstrated tremendous power in finding tangents for transcendental curves (curves that cannot be expressed by algebraic equations) like the cycloid. Roberval's approach of bringing this physical concept of motion into mathematics was an extremely important step that directly led to the fundamental ideology of the "Method of Fluxions" (kinematic calculus) later founded by [Isaac Newton](https://kenji.blog/en/p/newton/).
