---
title: "Gilles Personne de Roberval: Pionero de los indivisibles y la geometría cinemática"
description: "Gilles Personne de Roberval fue uno de los principales matemáticos franceses del siglo XVII. Activo en vísperas del cálculo, profundizamos en su vida y logros, incluyendo el método de los indivisibles, los cálculos del área de la cicloide, las tangentes cinemáticas y la invención de la 'balanza de Roberval'."
slug: "roberval"
...
## 2. La vida de Roberval y el contexto histórico
...
Habiendo aprendido por sí mismo matemáticas y lenguas clásicas (latín y griego) a una edad temprana, Roberval aspiró a metas académicas más altas y se trasladó a la capital, París, alrededor de 1628. París en ese momento era un crisol de erudición que reunía a intelectuales de toda Europa. Allí, comenzó a frecuentar la reunión de intelectuales centrada en torno al padre Marin Mersenne, conocida como la "Académie de Mersenne". Mersenne, a menudo llamado "el administrador de correos de la erudición europea", actuaba como intermediario de correspondencia entre los eruditos de toda Europa, desempeñando un papel clave en el intercambio de los últimos descubrimientos científicos.

A través del salón de Mersenne, Roberval profundizó en sus interacciones con las mentes más brillantes de Francia de la época, como René Descartes, Pierre de Fermat, Blaise Pascal y Étienne Pascal (el padre de Blaise), lo que permitió que sus talentos matemáticos florecieran.

### 2.2. La cátedra del Collège Royal y las extenuantes batallas de defensa

En 1632, llegó un punto de inflexión importante para Roberval. Quedó vacante un puesto de profesor de matemáticas (la cátedra de Ramus), creada por Pierre de la Ramée, un famoso lógico y matemático, en el Collège de France (entonces conocido como Collège Royal) en París.
...
Roberval ganó de forma espléndida esta agotadora competición y ocupó el puesto de profesor. Sorprendentemente, defendió con éxito esta posición sin una sola derrota durante más de 40 años, hasta su fallecimiento a los 73 años en 1675.
...
```mermaid
flowchart TD
    A["Nacido en Roberval (1602)"] -->|"Matemáticas autodidactas"| B["Se trasladó a París (c. 1628)"]
    B -->|"Interacciones profundizadas"| C["Se unió a la Académie de Mersenne"]
    C -->|"Ganó el debate público"| D["Nombrado profesor en el Collège Royal (1632)"]
    D -->|"Secretismo e investigación"| E["Estallido de la controversia de la cicloide (década de 1630-)"]
    E -->|"Contribución a la física"| F["Inventó la balanza de Roberval (1669)"]
    F -->|"Mantuvo la cátedra de por vida"| G["Murió en París (1675)"]
```
...
Roberval logró este gran descubrimiento, pero, fiel a su estilo, retrasó la publicación para defender su cátedra, comunicándolo solo por carta a unos pocos matemáticos cercanos (como Mersenne).
...
Al enterarse de esto, Roberval se puso furioso. Acusó a Torricelli, afirmando: "Torricelli robó una mirada a mis resultados a través de las cartas de Mersenne y los publicó como si fueran su propio descubrimiento". Esta controversia sobre el plagio se volvió extremadamente feroz y la relación entre los dos se vio irreparablemente dañada. Hoy en día, se cree que el descubrimiento de Torricelli se realizó de forma independiente y no fue un plagio, pero este incidente se recuerda como una anécdota que ilustra el fuerte temperamento de Roberval y las limitaciones de la transmisión de información en la época.
...
En aquel momento, hallar la tangente a una curva era uno de los problemas más importantes de la geometría. René Descartes estaba tratando de hallar las tangentes usando un enfoque geométrico algebraico con ecuaciones algebraicas, pero tenía el inconveniente de unos cálculos extremadamente engorrosos.
...
```mermaid
graph LR
    A["Movimiento de una curva compleja"] -->|"Descomposición del movimiento"| B["Vectores componentes (Traslación, Rotación, etc.)"]
    B -->|"Composición de los vectores velocidad"| C["Vector velocidad instantánea"]
    C -->|"La dirección coincide"| D["Tangente de la curva"]
    D -->|"Influencia ideológica"| E["Método de fluxiones de Newton"]
```

Este "método de la tangente cinemática" demostró un tremendo poder para hallar tangentes de curvas trascendentales (curvas que no se pueden expresar mediante ecuaciones algebraicas) como la cicloide. El enfoque de Roberval de introducir este concepto físico del movimiento en las matemáticas fue un paso extremadamente importante que condujo directamente a la ideología fundamental del "Método de las fluxiones" (cálculo cinemático) fundado posteriormente por Isaac Newton.

## 6. Contribuciones a la mecánica: La balanza de Roberval

Si bien Roberval exploró lo infinito abstracto y el movimiento en matemáticas, también poseía un talento excepcional en la física del mundo real, la mecánica e incluso en el diseño ingenieril de máquinas. El ejemplo más destacado, ampliamente conocido hoy en día bajo su nombre, es la **"Balanza de Roberval"**.
...
- **Influencia sobre Blaise Pascal**:
...
graph TD
    ...
    M -->|"Centro de información / Intermediario de cartas"| R
    M -->|"Centro de información / Intermediario de cartas"| D
    M -->|"Centro de información / Intermediario de cartas"| F
    
    R <-->|"Feroz hostilidad / Controversia"| D
    R <-->|"Amistad / Cooperación matemática"| F
    R -->|"Acusación de plagio"| T
    R -->|"Transmisión de métodos / Apoyo"| P
```

## 8. Conclusión: El genio solitario que tendió el puente hacia el cálculo

Gilles Personne de Roberval, en la época inmediatamente anterior al nacimiento formal del cálculo, utilizó a fondo dos potentes armas —el método de los indivisibles y el enfoque cinemático— para resolver secuencialmente los problemas matemáticos más difíciles de su tiempo.
...
Además, como se observa en su invención de la "balanza de Roberval" en mecánica, más que unas matemáticas abstractas, su pensamiento teórico siempre estuvo profundamente conectado con el mundo físico real. Roberval, que estuvo activo en la frontera entre las matemáticas y la física, quedará verdaderamente grabado en la historia de las matemáticas para siempre como un "actor clave entre bastidores" que apoyó e impulsó fundamentalmente la Revolución Científica del siglo XVII.
