---
title: "The Charismatic Icon of Aestheticism: The Life and Philosophy of Oscar Wilde"
...
```mermaid
graph TD
    A["Oscar Wilde (1854–1900)"] -->|Influence| B["Aestheticism"]
    A -->|Masterpiece| C["The Picture of Dorian Gray"]
    A -->|Theatrical Success| D["The Importance of Being Earnest"]
    
    A -->|Romantic Relationship| E["Lord Alfred Douglas (Bosie)"]
    E -->|Conflict| F["Marquess of Queensberry"]
    F -->|Libel Trial| A
    A -->|Arrest & Imprisonment| G["Reading Gaol (1895–1897)"]
    
    G -->|Written in Prison| H["De Profundis"]
    H -->|Exile After Release| I["Death in Paris (1900)"]
    
    I -->|Posthumous Reappraisal| J["Status as an LGBTQ+ Icon"]
    C -->|Literary Legacy| K["Decadent & Symbolist Aesthetics"]
    D -->|Peak of Comedy of Manners| L["Impact on Modern Theatre"]
```
