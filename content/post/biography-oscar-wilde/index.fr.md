...
description: "Dans le monde littéraire britannique de la fin du XIXe siècle, aucun auteur n'a brillé avec autant d'éclat ni connu de chute aussi vertigineuse qu'Oscar Wilde."
---
...
```mermaid
graph TD
    A["Oscar Wilde (1854-1900)"] -->|Influence| B["Esthétisme (Aestheticism)"]
    A -->|Chef-d'œuvre| C["Le Portrait de Dorian Gray"]
    A -->|Succès théâtral| D["L'Importance d'être Constant"]
    
    A -->|Relation passionnée| E["Lord Alfred Douglas (Bosie)"]
    E -->|Conflit| F["Marquis de Queensberry"]
    F -->|Procès en diffamation| A
    A -->|Arrestation et emprisonnement| G["Prison de Reading (1895-1897)"]
    
    G -->|Écrit en prison| H["De Profundis"]
    H -->|Exil après libération| I["Mort à Paris (1900)"]
    
    I -->|Postérité et réhabilitation| J["Statut d'icône LGBTQ+"]
    C -->|Héritage littéraire| K["Esthétique décadente et symboliste"]
    D -->|Comédie de mœurs| L["Impact sur le théâtre moderne"]
```
