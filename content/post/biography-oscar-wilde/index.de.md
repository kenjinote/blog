---
title: "Die charismatische Ikone des Ästhetizismus: Leben und Philosophie von Oscar Wilde"
...
```mermaid
graph TD
    A["Oscar Wilde (1854–1900)"] -->|Einfluss| B["Ästhetizismus (Aestheticism)"]
    A -->|Hauptwerk| C["Das Bildnis des Dorian Gray"]
    A -->|Bühnenerfolg| D["The Importance of Being Earnest (Bunbury)"]
    
    A -->|Liebesbeziehung| E["Lord Alfred Douglas (Bosie)"]
    E -->|Konflikt| F["Marquess of Queensberry"]
    F -->|Verleumdungsprozess| A
    A -->|Verhaftung und Haft| G["Reading Gaol (1895–1897)"]
    
    G -->|Im Gefängnis verfasst| H["De Profundis"]
    H -->|Exil nach Entlassung| I["Tod in Paris (1900)"]
    
    I -->|Posthume Neubewertung| J["Status als LGBTQ+-Ikone"]
    C -->|Literarisches Erbe| K["Dekadente und symbolistische Ästhetik"]
    D -->|Höhepunkt der Gesellschaftskomödie| L["Einfluss auf das moderne Theater"]
```
