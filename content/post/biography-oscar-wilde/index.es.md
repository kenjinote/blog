---
title: "El carisma del esteticismo: vida y filosofía de Oscar Wilde"
...
```mermaid
graph TD
    A["Oscar Wilde (1854-1900)"] -->|Influencia| B["Esteticismo (Aestheticism)"]
    A -->|Obra cumbre| C["El retrato de Dorian Gray"]
    A -->|Éxito teatral| D["La importancia de llamarse Ernesto"]
    
    A -->|Relación sentimental| E["Lord Alfred Douglas (Bosie)"]
    E -->|Conflicto| F["Marqués de Queensberry"]
    F -->|Juicio por difamación| A
    A -->|Arresto y condena| G["Prisión de Reading (1895-1897)"]
    
    G -->|Escrito en prisión| H["De Profundis"]
    H -->|Exilio tras la liberación| I["Muerte en París (1900)"]
    
    I -->|Revalorización histórica| J["Estatus de icono LGBTQ+"]
    C -->|Legado literario| K["Estética decadentista y simbolista"]
    D -->|Perfección de la comedia de costumbres| L["Influencia en el teatro contemporáneo"]
```
