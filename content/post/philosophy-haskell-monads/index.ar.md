...
الفكرة الأساسية الكامنة وراء [البرمجة الوظيفية](/ar/p/lambda-calculus-functional-programming/) هي "التعامل مع الحسابات كتقييم للدوال الرياضية". خاصة في لغة وظيفية "بحتة" مثل هاسكل، يتم اتباع هذه القاعدة بصرامة شديدة.
