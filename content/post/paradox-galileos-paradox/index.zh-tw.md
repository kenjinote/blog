...
這次，讓我們來深入探討被譽為科學之父的伽利略·伽利萊（1564-1642）在晚年的著作《關於兩門新科學的對話》中提出的奇妙悖論。它被稱為「伽利略的悖論」，並成為開啟無限之門的關鍵鑰匙，進而連結到後世數學家，特別是[格奧爾格·康托爾](/zh-tw/p/cantor/)的「集合論」。
...
著名的希臘數學家[歐幾里得](/zh-tw/p/euclid/)的公理中也有一句話：**「整體大於部分」**。這條公理在有限的世界裡是絕對無法動搖的真理。從 10 顆蘋果中取出 3 顆，剩下 7 顆。原本的 10 顆（整體）顯然比取出的 3 顆（部分）還要大。
...
將這個概念套用到伽利略的發現中，就會導出<strong>「自然數的個數」與「平方數的個數」完全相等</strong>的結論。
...
然而，數學的歷史並沒有停留在這裡。大約 250 年後，到了 19 世紀後半葉，一位天才數學家正面迎擊了「無限」這頭怪物。他就是[格奧爾格·康托爾](/zh-tw/p/cantor/)（Georg Cantor）。
...
康托爾思想的根本，正是伽利略所發現的<strong>「一對一對應（雙射：Bijection）」</strong>手法。
...
更令人驚訝的是，自然數與「全體偶數」、「全體奇數」，甚至是「全體整數」和「全體有理數（能用分數表示的數）」之間，也能建立一對一對應，因此它們被證明全都是<strong>「與自然數大小相同的無限」</strong>。
...
在此，有限世界的常識——[歐幾里得](/zh-tw/p/euclid/)「整體大於部分」的公理，在無限世界中不成立的事實已變得非常明確。
...
用來證明這個論點的，就是著名的**「[康托爾的對角線論證](/zh-tw/p/cantors-diagonal-argument/)」**。
...
無限這個概念，至今仍隱藏著許多謎團。「在自然數的無限與實數的無限之間，是否存在著另一種大小的無限？」這個問題（[連續統假設](/zh-tw/p/continuum-hypothesis/)），在目前的數學公理系統中，已達到「既無法證明也無法反證」這個令人驚訝的結論。
