...
في هذه المقالة، وانطلاقًا من هذا السؤال الذي يبدو بسيطًا، سنشرح بالتفصيل الأداة الرياضية القوية للعد مع مراعاة التناظر، وهي **"[تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/)"** ([Burnside's Lemma](https://kenji.blog/p/burnsides-lemma/))، من الأساسيات إلى تطبيقاتها. يعد هذا موضوعًا مثاليًا لمقدمة عملية في نظرية الزمر، لذا يُرجى البقاء معنا حتى النهاية.
...
## 5. [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/)

هنا أخيرًا، تظهر نجمة هذه المرة، **[تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/)**. وتسمى أحيانًا أيضًا تمهيدية كوشي-فروبينيوس. هذه مبرهنة مذهلة تسمح لنا بسهولة بحساب "عدد المدارات (عدد الأنماط المختلفة بشكل أساسي)" عندما تؤثر زمرة $G$ على مجموعة منتهية $X$.
...
ما تعنيه هذه الصيغة بديهي للغاية. تؤكد [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/) أنه يمكننا الحصول على العدد المطلوب من المدارات من خلال **"حساب 'عدد الأنماط غير المتغيرة (عدد النقاط الثابتة)' لكل عملية، وإضافتها جميعًا معًا، والقسمة على العدد الإجمالي للعمليات (أي أخذ المتوسط)"**.
...
الآن، دعونا نستخدم بالفعل [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/) لحساب عدد تصميمات قلادة مكونة من 4 خرزات (لونين أحمر وأزرق).
...
الآن، لدينا جميع أعداد النقاط الثابتة لجميع العمليات. نقوم باستبدال هذه في صيغة [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/).
...
## 8. مخطط إثبات [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/)
...
بقسمة كلا الجانبين على $|G|$، نحصل على صيغة [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/). إنه تطور منطقي جميل للغاية ومعقد.

## 9. التطور إلى مبرهنة بوليا للعد

[تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/) قوية، ولكن العثور على عدد النقاط الثابتة واحدة تلو الأخرى يدويًا يصبح صعبًا كلما زاد حجم المشكلة. على سبيل المثال، في مشكلة مثل "كم عدد الطرق المتاحة لطلاء كل وجه من أوجه مجسم منتظم ذي اثني عشر وجهًا بثلاثة ألوان؟"، هناك 60 نوعًا من عمليات الدوران، مما يجعل الحساب هائلاً.
...
تمثل [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/) خطوة مهمة نحو فهم مبرهنة بوليا، مما يرسي الأساس لعد نظرية الزمر.

## 10. الخلفية التاريخية ل[تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/)
...
لإدراك قوة [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/) بشكل أكبر، دعونا نعطي مثالاً مشهورًا آخر. إنها المشكلة: "كم عدد الطرق المتاحة لطلاء أوجه المكعب الـ 6 بلونين، أحمر وأزرق؟" هنا أيضًا، نتعامل مع تلك التي تصبح كما هي عند تدويرها على أنها متطابقة.
...
من خلال حساب عدد النقاط الثابتة (التلوين حيث لا تتغير الألوان) لكل عملية دوران وأخذ المتوسط، يمكن العثور على إجمالي عدد طرق تلوين المكعب. حتى بالنسبة لمشكلة يصعب حسابها بديهيًا بشكل كبير، فإن استخدام [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/) يقللها إلى مشكلات "محلية" تتعلق بالتناظر على طول كل محور دوران. ونتيجة لذلك، فمن المعروف أن عدد طرق تلوين هذا المكعب هو **$10$ طرق**.

## 12. الخاتمة

كيف كانت رحلتك؟ في هذا المقال، وباستخدام عدد تصميمات القلائد كمثال، قمنا بشرح [تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/) بالتفصيل.
...
*   باستخدام **[تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/)**، يمكن حساب عدد الأنماط المختلفة بشكل أساسي من خلال الإجراء الميكانيكي المتمثل في "حساب متوسط عدد النقاط الثابتة في كل عملية".
*   تستند هذه المبرهنة إلى خاصية عميقة في نظرية الزمر تسمى مبرهنة المدار-المثبت.

[تمهيدية بيرنسايد](https://kenji.blog/p/burnsides-lemma/) هي مبرهنة عملية جدًا تُطبق في مجموعة واسعة من المجالات، مثل إحصاء المتصاوغات الجزيئية في الكيمياء، وتحديد تماثل الرسم البياني في نظرية المخططات، وحتى الميكانيكا الإحصائية في الفيزياء.
