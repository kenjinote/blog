...
## 5. Lemma von Burnside

Hier tritt schließlich der Star dieses Mals, das **Lemma von Burnside**, auf. Es wird manchmal auch Cauchy-Frobenius-Lemma genannt. Dies ist ein erstaunlicher Lehrsatz, der es uns ermöglicht, die "Anzahl der Bahnen (Anzahl der im Wesentlichen unterschiedlichen Muster)" leicht zu berechnen, wenn eine Gruppe $G$ auf eine endliche Menge $X$ wirkt.
...
Was diese Formel bedeutet, ist sehr intuitiv. Das Lemma von Burnside besagt, dass wir die gewünschte Anzahl von Bahnen erhalten können, indem wir **"die 'Anzahl der unveränderlichen Muster (Anzahl der Fixpunkte)' für jede Operation zählen, alle addieren und durch die Gesamtzahl der Operationen dividieren (d.h. den Durchschnitt bilden)"**.
...
Lassen Sie uns nun tatsächlich das Lemma von Burnside verwenden, um die Anzahl der Designs für eine Halskette mit 4 Perlen (2 Farben, rot und blau) zu berechnen.
...
## 8. Skizze des Beweises für das Lemma von Burnside
...
Indem man beide Seiten durch $|G|$ dividiert, erhält man die Formel für das Lemma von Burnside. Es ist eine sehr schöne und raffinierte logische Entwicklung.

## 9. Entwicklung zum Abzählsatz von Pólya

Das Lemma von Burnside ist leistungsstark, aber das manuelle Finden der Anzahl von Fixpunkten nacheinander wird schwierig, wenn der Umfang des Problems zunimmt. Bei einem Problem wie "Wie viele Möglichkeiten gibt es, jede Seite eines regelmäßigen Dodekaeders mit 3 Farben zu bemalen?" gibt es beispielsweise 60 Arten von Rotationsoperationen, was die Berechnung enorm macht.
...
Das Lemma von Burnside ist ein wichtiger Schritt zum Verständnis des Satzes von Pólya und legt den Grundstein für gruppentheoretische Abzählungen.
...
Historisch gesehen hatte Augustin-Louis Cauchy jedoch bereits 1845 einen Spezialfall dieses Lehrsatzes (bezüglich symmetrischer Gruppen) veröffentlicht, und später 1887 lieferte Ferdinand Georg Frobenius einen Beweis für endliche Gruppen im Allgemeinen.
...
Wie war es? In diesem Artikel haben wir am Beispiel der Anzahl der Halskettendesigns das Lemma von Burnside im Detail erklärt.
...
Das Lemma von Burnside ist ein sehr praktischer Lehrsatz, der in einer Vielzahl von Bereichen angewendet wird, wie z.B. bei der Zählung von molekularen Isomeren in der Chemie, der Bestimmung der Graphenisomorphie in der Graphentheorie und sogar in der statistischen Mechanik der Physik.
