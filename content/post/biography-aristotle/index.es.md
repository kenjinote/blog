---
title: "El padre de todas las ciencias, Aristóteles: el buscador supremo del conocimiento legado por la antigua Grecia"
...
```mermaid
flowchart TD
    %% Genealogía de la antigua Grecia
    S["Sócrates (Búsqueda de la ética)"] --> P["Platón (Teoría de las Ideas)"]
    P --> A["Aristóteles (Empirismo y sistematización)"]
    
    %% Influencia directa de Aristóteles
    A --> Alex["Alejandro Magno (Conquistador de Macedonia)"]
    A --> Lyceum["Liceo (Escuela peripatética)"]
    
    %% Transmisión y desarrollo hacia la posteridad
    Lyceum --> Islam["Filosofía islámica (Ibn Rushd, etc.)"]
    Islam --> MiddleAges["Escolástica medieval (Tomás de Aquino)"]
    
    %% Conexión con la era moderna
    MiddleAges --> Modern["Ciencia y filosofía modernas (Herencia de la lógica y clasificación)"]
