---
title: "Aristoteles, Bapak Segala Ilmu: Pencari Pengetahuan Tertinggi Peninggalan Yunani Kuno"
...
```mermaid
flowchart TD
    %% Garis Keturunan Yunani Kuno
    S["Socrates (Pencarian Etika)"] --> P["Plato (Teori Ide)"]
    P --> A["Aristoteles (Empirisme dan Sistematisasi)"]
    
    %% Pengaruh Langsung dari Aristoteles
    A --> Alex["Aleksander Agung (Penguasa Makedonia)"]
    A --> Lyceum["Lyceum (Aliran Peripatetik)"]
    
    %% Penyebaran dan Perkembangan ke Generasi Berikutnya
    Lyceum --> Islam["Filsafat Islam (Ibnu Rusyd dll.)"]
    Islam --> MiddleAges["Skolastisisme Abad Pertengahan (Thomas Aquinas)"]
    
    %% Keterkaitan ke Era Modern
    MiddleAges --> Modern["Sains & Filsafat Modern (Pewarisan Logika & Klasifikasi)"]
