---
title: "Aristoteles, der Vater aller Wissenschaften: Der ultimative Wissenssucher des antiken Griechenlands"
...
```mermaid
flowchart TD
    %% Genealogie des antiken Griechenlands
    S["Sokrates (Erforschung der Ethik)"] --> P["Platon (Ideenlehre)"]
    P --> A["Aristoteles (Empirie und Systematisierung)"]
    
    %% Direkter Einfluss von Aristoteles
    A --> Alex["Alexander der Große (Herrscher von Makedonien)"]
    A --> Lyceum["Lykeion (Peripatetische Schule)"]
    
    %% Verbreitung und Entwicklung in späteren Generationen
    Lyceum --> Islam["Islamische Philosophie (Ibn Ruschd etc.)"]
    Islam --> MiddleAges["Mittelalterliche Scholastik (Thomas von Aquin)"]
    
    %% Verbindung zur Moderne
    MiddleAges --> Modern["Moderne Wissenschaft/Philosophie (Vererbung von Logik/Klassifikation)"]
