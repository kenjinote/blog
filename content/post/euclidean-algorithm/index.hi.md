...
# [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) क्या है?

**[यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/)** ([Euclide](https://kenji.blog/p/euclid/)an algorithm) दो प्राकृतिक संख्याओं (या पूर्णांकों) के सबसे बड़े सामान्य भाजक (GCD) की गणना करने के लिए एक कुशल विधि है। लगभग 300 ईसा पूर्व में प्राचीन यूनानी गणितज्ञ [यूक्लिड](https://kenji.blog/p/euclid/) द्वारा उनके गणितीय ग्रंथ "एलिमेंट्स" (Elements) की पुस्तक VII में वर्णित, इसे "मानवता के सबसे पुराने एल्गोरिदम" में से एक के रूप में व्यापक रूप से जाना जाता है।

जीसीडी खोजने का सबसे सरल तरीका दोनों संख्याओं का अभाज्य गुणनखंडन खोजना और सामान्य अभाज्य गुणनखंडों को गुणा करना है। हालाँकि, जैसे-जैसे संख्याएँ बड़ी होती जाती हैं, अभाज्य गुणनखंडन की कम्प्यूटेशनल जटिलता बहुत अधिक हो जाती है, जिससे इसे यथार्थवादी समय सीमा में हल करना मुश्किल हो जाता है। दूसरी ओर, **[यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/)** का उपयोग करके, हजारों अंकों वाले विशाल संख्याओं के लिए भी अत्यंत तेज़ी से जीसीडी की गणना करना संभव है।

## मूल प्रमेय और यांत्रिकी

मान लें कि $\gcd(a, b)$ दो प्राकृतिक संख्याओं $a$ और $b$ (जहाँ $a \ge b$) का सबसे बड़ा सामान्य भाजक है।
[यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) निम्नलिखित सरल प्रमेय पर आधारित है:
...
इस गुण का लाभ उठाते हुए, [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) बार-बार विभाजन करता है जब तक कि शेषफल $0$ न हो जाए।
...
[यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) कितना तेज़ है? इसकी कम्प्यूटेशनल जटिलता के संबंध में, **लेमे की प्रमेय** (Lamé's theorem), जिसे 1844 में फ्रांसीसी गणितज्ञ गेब्रियल लेमे द्वारा सिद्ध किया गया था, सर्वविदित है।

> **लेमे की प्रमेय**
> दो प्राकृतिक संख्याओं $a, b$ ($a > b$) पर [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) लागू करने के लिए आवश्यक विभाजन चरणों की संख्या $b$ के दशमलव निरूपण में अंकों की संख्या का अधिकतम $5$ गुना है।
...
## विस्तारित [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/)

पूर्णांकों $x, y$ को खोजने के लिए एल्गोरिथ्म का विस्तार जो सबसे बड़ा सामान्य भाजक खोजने के अलावा, निम्नलिखित बेज़ाउट की पहचान (Bézout's identity) को संतुष्ट करता है, **विस्तारित [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/)** (Extended [Euclide](https://kenji.blog/p/euclid/)an algorithm) कहलाता है।

$$
ax + by = \gcd(a, b)
$$

### विस्तारित [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) का कार्यान्वयन
...
विस्तारित [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) केवल एक गणितीय पहेली नहीं है, बल्कि आधुनिक इंटरनेट समाज का समर्थन करने वाली एक आवश्यक तकनीक है।
...
चूंकि इसे $ed + k\phi(N) = 1$ के रूप में पुनर्व्यवस्थित किया जा सकता है, इसलिए हम बहुत उच्च गति पर $d$ की गणना करने के लिए विस्तारित [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) का उपयोग कर सकते हैं।

## निष्कर्ष

ईसा पूर्व युग में बहुत पहले खोजे जाने के बावजूद, [यूक्लिडियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) अपने सुव्यवस्थित तर्क और उच्च कम्प्यूटेशनल दक्षता के कारण आधुनिक कंप्यूटर विज्ञान की नींव को रेखांकित करता है। यद्यपि एल्गोरिदम का अध्ययन करते समय यह अक्सर सामना किया जाने वाला पहला विषय होता है, यह दृश्यों के पीछे गणितीय सुंदरता और व्यावहारिकता से भरा होता है।
