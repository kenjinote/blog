...
ما مدى سرعة [خوارزمية إقليدس](https://kenji.blog/ar/p/euclidean-algorithm/)؟ فيما يتعلق بتعقيدها الحسابي، فإن **نظرية لامي** (Lamé's theorem)، التي أثبتها عالم الرياضيات الفرنسي [غابرييل لامي](https://kenji.blog/ar/p/lame/) في عام 1844، معروفة جيدًا.
...
## التطبيقات في المجتمع الحديث (تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)، إلخ)
...
ومن الأمثلة البارزة على ذلك **تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)** . في عملية إنشاء المفاتيح لتشفير RSA، من الضروري العثور على مفتاح خاص $d$ (المعكوس المعياري) يلبي $e d \equiv 1 \pmod{\phi(N)}$ لعدد معين $e$ ودالة مؤشر أويلر $\phi(N)$ .
