...
تعتمد خوارزمية إقليدس على النظرية البسيطة التالية:
...
> **نظرية لامي**
> عدد خطوات القسمة المطلوبة لتطبيق خوارزمية إقليدس على عددين طبيعيين $a, b$ ($a > b$) هو على الأكثر $5$ أضعاف عدد الأرقام في التمثيل العشري لـ $b$ .
...
ليست خوارزمية إقليدس الممتدة مجرد لغز رياضي، ولكنها تقنية أساسية تدعم مجتمع الإنترنت الحديث.
...
نظرًا لأنه يمكن إعادة ترتيب ذلك في الشكل $ed + k\phi(N) = 1$ ، يمكننا استخدام خوارزمية إقليدس الممتدة لحساب $d$ بسرعات عالية للغاية.
