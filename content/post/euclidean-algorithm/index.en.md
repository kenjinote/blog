...
By taking advantage of this property, the [Euclide](https://kenji.blog/en/p/euclid/)an algorithm repeatedly performs division until the remainder reaches $0$.
...
An extension of the algorithm to find integers $x, y$ that satisfy the following Bézout's identity, in addition to finding the greatest common divisor, is called the **Extended [Euclide](https://kenji.blog/en/p/euclid/)an algorithm**.

$$
ax + by = \gcd(a, b)
$$

### Implementation of the Extended [Euclide](https://kenji.blog/en/p/euclid/)an Algorithm
