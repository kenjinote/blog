...
Алгоритм Евклида основан на следующей простой теореме:
...
> **Теорема Ламе**
> Количество шагов деления, необходимых для применения алгоритма Евклида к двум натуральным числам $a, b$ ($a > b$), не превышает $5$ -кратного количества цифр в десятичном представлении числа $b$ .
...
Расширенный алгоритм Евклида — это не просто математическая головоломка, а важнейшая технология, поддерживающая современное интернет-общество.
...
Поскольку это можно преобразовать к виду $ed + k\phi(N) = 1$ , мы можем использовать расширенный алгоритм Евклида для вычисления $d$ с чрезвычайно высокой скоростью.
