...
- **رمز الوصول المميز (Access Token)** : "المفتاح" للوصول إلى واجهة برمجة التطبيقات (خادم الموارد). عادة لا يتم فك تشفير محتواه، بل يتم إرفاقه في ترويسة Authorization لطلب API واستخدامه (غالباً ما يكون رمزاً مبهماً Opaque).
- **الرمز المميز للمعرف (ID Token)** : "بطاقة عمل" أو "شهادة" تحتوي على نتيجة مصادقة المستخدم ومعلومات السمة (الملف الشخصي). يتم إصداره دائماً بتنسيق **JWT (JSON Web Token)**، ويقوم العميل بفك تشفيره لاستخدام معلومات المستخدم. **يجب عدم استخدامه كصلاحية وصول إلى API.**
