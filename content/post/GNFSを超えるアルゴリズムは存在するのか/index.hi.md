...
आधुनिक समाज में इंटरनेट संचार की सुरक्षा काफी हद तक सार्वजनिक-कुंजी क्रिप्टोग्राफी, [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) के सुरक्षित होने पर निर्भर करती है। और RSA क्रिप्टोग्राफी की सुरक्षा "विशाल भाज्य संख्याओं के गुणनखंडन की कठिनाई" की गणितीय धारणा पर आधारित है। यदि एक अत्यंत कुशल गुणनखंडन एल्गोरिदम खोजा जाता है, तो दुनिया भर का संचार बुनियादी ढांचा मूल रूप से ढह जाएगा।
...
GNFS का गणितीय आधार बहुत ही जटिल और उन्नत है। मूल विचार फर्मेट के लिटिल थ्योरम ([Fermat's Little Theorem](https://kenji.blog/hi/p/fermats-little-theorem/)) और क्वाड्रेटिक सीव (QS) का विस्तार है, और सर्वांगसमता (congruence) $X^2 \equiv Y^2 \pmod n$ को संतुष्ट करने वाले और $X \not\equiv \pm Y \pmod n$ होने वाले गैर-तुच्छ (non-trivial) जोड़े $(X, Y)$ को खोजकर $n$ का गुणनखंड $\gcd(X-Y, n)$ प्राप्त करना है।
...
हालाँकि, व्यवहार में, कई क्षेत्रों के प्रबंधन के कारण ओवरहेड बड़ा है, और व्यावहारिक पैमाने पर [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) मॉड्यूलस के लिए कोई निर्णायक सफलता नहीं मिली है।
...
यदि $L_n[1/4]$, या कोई क्लासिकल पॉलीनोमियल टाइम एल्गोरिदम मौजूद है, तो इसे GNFS जैसे "स्मूदनेस-आधारित" दृष्टिकोण से पूरी तरह से अलग होना चाहिए, और ऐसी नई गणितीय संरचनाओं पर निर्भर होना चाहिए जिनकी मानवता वर्तमान में कल्पना नहीं कर सकती (उदाहरण के लिए, अण्डाकार वक्र क्रिप्टोग्राफी (Elliptic Curve [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy) के लिए Schoof के एल्गोरिदम की तरह अधिक उन्नत बीजगणितीय ज्यामितीय दृष्टिकोण)। हालाँकि, वर्तमान में ऐसे कोई संकेत नहीं हैं।

---

## 5. क्वांटम कंप्यूटर के साथ सफलता: शोर का एल्गोरिदम ([Shor's Algorithm](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/))
...
उदाहरण के लिए, [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)-2048 (2048-बिट भाज्य संख्या) के गुणनखंडन के मामले पर विचार करें।
...
2. **क्लासिकल कंप्यूटरों पर [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) की सुरक्षा मजबूत बनी हुई है**: GNFS की कम्प्यूटेशनल जटिलता अभी भी बहुत बड़ी है, और RSA-2048 और RSA-4096 क्लासिकल कंप्यूटरों के हमलों के खिलाफ आने वाले कई दशकों तक सुरक्षित रहेंगे।
3. **असली खतरा क्वांटम एल्गोरिदम है**: क्वांटम यांत्रिकी के सिद्धांतों पर आधारित शोर का एल्गोरिदम कम्प्यूटेशनल जटिलता की बाधा को तोड़ता है। इसके कारण, दुनिया को पोस्ट-क्वांटम क्रिप्टोग्राफी (PQC: Post-Quantum [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy) में स्थानांतरित होने के लिए मजबूर होना पड़ रहा है। क्वांटम कंप्यूटरों (जो पॉलीनोमियल टाइम में हल नहीं किए जा सकते) के लिए भी कठिन मानी जाने वाली नई गणितीय समस्याओं, जैसे लैटिस-आधारित क्रिप्टोग्राफी और हैश-आधारित क्रिप्टोग्राफी में संक्रमण, वर्तमान क्रिप्टोग्राफी में सबसे आगे है।

जनरल नंबर फील्ड सीव (GNFS) "सर्वोच्च उपलब्धियों" में से एक है जिसे मानवता क्लासिकल [गणित और एल्गोरिदम](/hi/p/reading-hard-tech-books/) डिजाइन की सीमा तक पहुंचकर हासिल कर पाई है। GNFS की गहरी गणितीय संरचना को समझना न केवल क्रिप्टैनालिसिस (cryptanalysis) का इतिहास सीखना है, बल्कि यह कम्प्यूटेशनल कॉम्प्लेक्सिटी थ्योरी और बीजीय संख्या सिद्धांत (algebraic number theory) की सुंदरता का अनुभव करने के लिए एक बौद्धिक खोज की यात्रा भी है। उस दिन तक जब क्वांटम कंप्यूटर व्यावहारिक हो जाएंगे, GNFS संभवतः सबसे शक्तिशाली गुणनखंडन एल्गोरिदम के रूप में अपना सिंहासन बनाए रखेगा।
