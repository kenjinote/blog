...
[ラマヌジャン](https://kenji.blog/p/ramanujan/)の和を理解するための第一歩として、もう少し簡単な別の無限級数を見てみましょう。それは「 $1 - 1 + 1 - 1 + \dots$ 」という級数です。これは発見者の名を取って **グランディ級数** と呼ばれます。
...
### いよいよ[ラマヌジャン](https://kenji.blog/p/ramanujan/)の和へ
...
## 3. 解析接続と[リーマン](https://kenji.blog/p/riemann/)ゼータ関数
...
### [リーマン](https://kenji.blog/p/riemann/)ゼータ関数

解析接続を説明するために、 **[リーマン](https://kenji.blog/p/riemann/)ゼータ関数** $\zeta(s)$ を導入します。ゼータ関数は以下のように定義されます。
...
[リーマン](https://kenji.blog/p/riemann/)は、ゼータ関数が複素平面全体（ $s=1$ の極を除く）に一意に拡張できることを証明しました。拡張されたゼータ関数において $s = -1$ の値を計算すると、見事に **$-\frac{1}{12}$** となることがわかります。
...
[ラマヌジャン](https://kenji.blog/p/ramanujan/)の和は、数学の奥深さと、数学と物理学の間に存在する神秘的なつながりを教えてくれる、最も美しい例の一つと言えるでしょう。
