...
В этой статье объясняется метод, называемый «сумму Рамануджана» ([Ramanujan Summation](https://kenji.blog/p/ramanujan-summation/)), как выводится это странное значение и как оно связано с физическими явлениями в реальном мире.
