...
En este artículo, explicaremos este método llamado «[Suma de Ramanujan (Ramanujan Summation)](https://kenji.blog/es/p/ramanujan-summation/)», cómo se deriva este extraño valor y cómo se conecta con los fenómenos físicos del mundo real.
