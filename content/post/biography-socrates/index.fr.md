---
title: "Socrate : L'origine de la philosophie occidentale forgée par la sagesse de l'ignorance et le dialogue"
date: 2026-09-23T19:53:31+09:00
categories: ["biography"]
tags: ["socrates", "history"]
image: "eyecatch.jpg"
slug: "biography-socrates"
description: "Socrate (vers 470 av. J.-C. – 399 av. J.-C.) est le grand penseur qui a jeté les bases de la philosophie occidentale."
---
...
```mermaid
graph TD
    Oracle["Delphic Oracle (Oracle de Delphes)"] -->|Personne n'est plus sage que Socrate| Soc["Socrates (Socrate)"]
    
    Soc -->|Méthode socratique / Maïeutique| Citizens["Athenian Citizens (Citoyens athéniens)"]
    Citizens -->|Irrités par l'exposition de leur ignorance| Accusers["Meletus, Anytus, Lycon (Accusateurs)"]
    
    Accusers -->|Impiété et corruption de la jeunesse| Trial["Trial and Death (Procès et mort)"]
    Soc --> Trial
    
    Soc -->|Maître-disciple| Plato["Plato (Platon)"]
    Soc -->|Maître-disciple| Xenophon["Xenophon (Xénophon)"]
    Soc -->|Maître-disciple| Antisthenes["Antisthenes (Antisthène)"]
    
    Plato -->|Théorie des Idées / Académie| Aristotle["Aristotle (Aristote)"]
    Aristotle -->|Systématisation de la philosophie occidentale| WesternPhil["Western Philosophy (Philosophie occidentale)"]
```
