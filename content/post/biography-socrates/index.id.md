---
title: "Socrates: Asal Usul Filsafat Barat yang Ditempa oleh Kebijaksanaan Ketidaktahuan dan Dialog"
...
```mermaid
graph TD
    Oracle["Delphic Oracle (Orakel Delphi)"] -->|Tidak ada yang lebih bijaksana dari Socrates| Soc["Socrates"]
    
    Soc -->|Metode Socratic / Maieutika| Citizens["Athenian Citizens (Warga Athena)"]
    Citizens -->|Marah karena ketidaktahuannya terungkap| Accusers["Meletus, Anytus, Lycon (Para Penuduh)"]
    
    Accusers -->|Ketidaksalehan dan merusak generasi muda| Trial["Trial and Death (Pengadilan dan Kematian)"]
    Soc --> Trial
    
    Soc -->|Hubungan Guru-Murid| Plato["Plato"]
    Soc -->|Hubungan Guru-Murid| Xenophon["Xenophon"]
    Soc -->|Hubungan Guru-Murid| Antisthenes["Antisthenes"]
    
    Plato -->|Teori Bentuk / Akademi| Aristotle["Aristotle (Aristoteles)"]
    Aristotle -->|Sistematisasi Filsafat Barat| WesternPhil["Western Philosophy (Filsafat Barat)"]
```
