---
title: "Sócrates: El origen de la filosofía occidental forjado por la sabiduría de la ignorancia y el diálogo"
...
```mermaid
graph TD
    Oracle["Delphic Oracle (Oráculo de Delfos)"] -->|Nadie es más sabio que Sócrates| Soc["Socrates (Sócrates)"]
    
    Soc -->|Método socrático / Mayéutica| Citizens["Athenian Citizens (Ciudadanos atenienses)"]
    Citizens -->|Enfurecidos por la exposición de su ignorancia| Accusers["Meletus, Anytus, Lycon (Acusadores)"]
    
    Accusers -->|Impiedad y corrupción de los jóvenes| Trial["Trial and Death (Juicio y muerte)"]
    Soc --> Trial
    
    Soc -->|Maestro-discípulo| Plato["Plato (Platón)"]
    Soc -->|Maestro-discípulo| Xenophon["Xenophon (Jenofonte)"]
    Soc -->|Maestro-discípulo| Antisthenes["Antisthenes (Antístenes)"]
    
    Plato -->|Teoría de las ideas / Academia| Aristotle["Aristotle (Aristóteles)"]
    Aristotle -->|Sistematización de la filosofía occidental| WesternPhil["Western Philosophy (Filosofía occidental)"]
```
