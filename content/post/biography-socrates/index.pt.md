---
title: "Sócrates: A origem da filosofia ocidental forjada pela sabedoria da ignorância e pelo diálogo"
...
description: "Sócrates (c. 470 a.C. – 399 a.C.), o grande pensador que lançou as bases da filosofia ocidental."
---
...
```mermaid
graph TD
    Oracle["Delphic Oracle (Oráculo de Delfos)"] -->|Ninguém é mais sábio que Sócrates| Soc["Socrates (Sócrates)"]
    
    Soc -->|Método Socrático / Maiêutica| Citizens["Athenian Citizens (Cidadãos Atenienses)"]
    Citizens -->|Irritados pela exposição da ignorância| Accusers["Meletus, Anytus, Lycon (Acusadores)"]
    
    Accusers -->|Impiedade e corrupção da juventude| Trial["Trial and Death (Julgamento e Morte)"]
    Soc --> Trial
    
    Soc -->|Mestre-discípulo| Plato["Plato (Platão)"]
    Soc -->|Mestre-discípulo| Xenophon["Xenophon (Xenofonte)"]
    Soc -->|Mestre-discípulo| Antisthenes["Antisthenes (Antístenes)"]
    
    Plato -->|Teoria das Ideias / Academia| Aristotle["Aristotle (Aristóteles)"]
    Aristotle -->|Sistematização da Filosofia Ocidental| WesternPhil["Western Philosophy (Filosofia Ocidental)"]
```
