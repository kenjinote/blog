---
title: "O Homem que Construiu os Princípios das Relações Humanas: A Vida e Filosofia de Dale Carnegie"
...
```mermaid
flowchart TD
    A["Nascimento em uma familia de agricultores pobres no Missouri (1888)"] --> B["Experiencia em debates na universidade e dias como vendedor"]
    B --> C["Frustrado com o sonho de ser ator, muda-se para Nova York"]
    C --> D["Inicio das aulas de oratoria na ACM (1912)"]
    D --> E["Sistematizacao dos principios das relacoes humanas"]
    E --> F["Publicacao de Como Fazer Amigos e Influenciar Pessoas (1936)"]
    E --> G["Publicacao de Como Evitar Preocupacoes e Comecar a Viver (1948)"]
    F --> H["Torna-se um best-seller global"]
    G --> H
    H --> I["Impacto na filosofia de negocios e teoria de lideranca modernas"]
```
