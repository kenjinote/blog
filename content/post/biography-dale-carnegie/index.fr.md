---
title: "L'homme qui a établi les principes des relations humaines : la vie et la philosophie de Dale Carnegie"
...
```mermaid
flowchart TD
    A["Né dans une famille de fermiers pauvres dans le Missouri (1888)"] --> B["Expérience de débat à l'université et période de vendeur"]
    B --> C["Échec de son rêve d'acteur et départ pour New York"]
    C --> D["Début des cours d'art oratoire au YMCA (1912)"]
    D --> E["Systématisation des principes des relations humaines"]
    E --> F["Publication du livre Comment se faire des amis (1936)"]
    E --> G["Publication du livre Triomphez de vos soucis (1948)"]
    F --> H["Devient un best-seller mondial"]
    G --> H
    H --> I["Influence sur la philosophie des affaires moderne et la théorie du leadership"]
```
