---
title: "El hombre que estableció los principios de las relaciones humanas: La vida y filosofía de Dale Carnegie"
...
```mermaid
flowchart TD
    A["Nace en una familia de granjeros pobres en Missouri (1888)"] --> B["Experiencia en debates universitarios y época de vendedor"]
    B --> C["Fracasa en su sueño de ser actor y se muda a Nueva York"]
    C --> D["Inicia el curso de oratoria en la YMCA (1912)"]
    D --> E["Sistematiza los principios de las relaciones humanas"]
    E --> F["Publica el libro Cómo ganar amigos e influir sobre las personas (1936)"]
    E --> G["Publica el libro Cómo suprimir las preocupaciones y disfrutar de la vida (1948)"]
    F --> H["Se convierte en un best seller mundial"]
    G --> H
    H --> I["Influencia en la filosofía empresarial y teorías de liderazgo modernas"]
```
