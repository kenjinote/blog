...
[Rust](https://kenji.blog/hi/p/webassembly-wasm-current-future/) में टेस्ट लिखने के लिए, टेस्ट फ़ंक्शन की परिभाषा के ठीक ऊपर `#[test]` एट्रिब्यूट जोड़कर फ़ंक्शन बनाएं।
