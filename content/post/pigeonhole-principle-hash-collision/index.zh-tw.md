...
categories: ["technology", "cryptography", "數學"]
...
舉例來說，在[比特幣](https://kenji.blog/zh-tw/p/cryptocurrency-and-bitcoin/)等區塊鏈技術中使用的 SHA-256 ，其輸出為 256 位元。因此，可能產生的雜湊值種類共有 $2^{256}$ 種（約 $1.15 \times 10^{77}$ ）。這是一個逼近可觀測宇宙中原子總數的龐大數字，但終究還是一個 **有限的數字** 。
