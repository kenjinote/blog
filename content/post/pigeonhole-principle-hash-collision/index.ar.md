...
باستخدام التقريب $1 - x \approx e^{-x}$ المبني على [متسلسلة تايلور](/ar/p/taylor-and-maclaurin-series/)، يمكننا تقريب احتمالية حدوث التصادم $P$ إلى:
...
عند اختيار تقنيات التشفير، من الضروري توقع تحسن أداء حواسيب المهاجمين (مثل [قانون مور](/ar/p/business-moores-law/)) والظهور المستقبلي للحواسيب الكمومية، واختيار خوارزمية تتمتع بـ **هامش أمان (Security Margin)** كافٍ.
