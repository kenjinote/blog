...
То, что коллизии хеш-функций теоретически неизбежны, ясно из принципа Дирихле, но возникает практический вопрос: «Насколько сложно на самом деле найти такую коллизию?». Здесь на сцену выходят **«[Парадокс дней рождения](/ru/p/birthday-paradox/) (Birthday Paradox)»** и **«Атака ”Дни рождения” (Birthday Attack)»**, которая использует его математические свойства.
...
При выборе криптографической технологии важно прогнозировать рост производительности компьютеров злоумышленников ([закон Мура](/ru/p/business-moores-law/) и т.д.) и появление квантовых компьютеров в будущем, и выбирать алгоритмы с достаточным **«запасом прочности»**.
...
Глубокое понимание этих принципов напрямую связано с пониманием основ современных систем безопасности, таких как [блокчейн](/ru/p/blockchain-technology-smart-contract-distributed-ledger/), цифровые подписи и управление паролями.
