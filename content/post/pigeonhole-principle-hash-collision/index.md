...
[テイラー展開](/p/taylor-and-maclaurin-series/)を用いた近似公式 $1 - x \approx e^{-x}$ を利用すると、衝突が起こる確率 $P$ は以下のように近似できます。
...
暗号技術の選定においては、攻撃者のコンピューター性能の向上（[ムーアの法則](/p/business-moores-law/)など）や、将来の[量子コンピュータ](https://kenji.blog/p/quantum-computing-shors-algorithm/)ーの台頭を予測し、十分な 「 **セキュリティマージン** 」 を持ったアルゴリズムを選択することが不可欠です。
...
*  **[現代暗号](/p/modern-cryptography-public-key-hash-signature/)の設計思想** ：衝突をゼロにすることは不可能であるため、出力長を十分に大きくすることで、計算量的に衝突発見を不可能にする。
