...
一方、非向き付け可能な曲面では、ある経路を一周して元の場所に戻ってくると、**「左と右」や「表と裏」が反転** してしまいます。これから紹介する[メビウスの帯とクラインの壺](https://kenji.blog/p/mobius-strip-and-klein-bottle/)は、まさにこの性質を持っています。
...
3次元[ユークリッド](https://kenji.blog/p/euclid/)空間 $\mathbb{R}^3$ におけるメビウスの帯のパラメータ表示は、以下のようになります。パラメータ $u$ と $v$ を用いて表します。
