...
The parametric representation of a Möbius strip in 3-dimensional [Euclide](https://kenji.blog/en/p/euclid/)an space $\mathbb{R}^3$ is as follows. It is expressed using parameters $u$ and $v$.
