---
title: "La vida y filosofía de Peter Drucker, el padre del management moderno"
...
```mermaid
graph TD
    A["Crianza en Viena"] --> B["Interacción con intelectuales"]
    A --> C["Ascenso del fascismo y exilio"]
    
    B --> D["Adquisición de profunda perspicacia y cultura"]
    C --> E["Fuerte advertencia contra el totalitarismo"]
    
    D --> F["Actividades en los Estados Unidos"]
    E --> F
    
    F --> G["Investigación organizacional de GM"]
    G --> H["Establecimiento del concepto de management"]
    
    H --> I["Promoción de la importancia del trabajador del conocimiento"]
    H --> J["El propósito de crear un cliente"]
    H --> K["Conciencia de la responsabilidad social corporativa"]
    
    I --> L["Enorme contribución a la administración de empresas moderna"]
    J --> L
    K --> L
    
    L --> M["Un legado para los ejecutivos y la sociedad en todo el mundo"]
```
