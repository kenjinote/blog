...
تعتبر **مشكلة السكرتيرة** (Secretary Problem) واحدة من أشهر الأمثلة الكلاسيكية لـ **[مشكلة التوقف](/ar/p/halting-problem/) الأمثل** (Optimal Stopping Problem) في نظرية الاحتمالات التطبيقية. تُعرف هذه المشكلة أيضًا باسم مشكلة الزواج (Marriage Problem) أو مشكلة مهر السلطان (Sultan's Dowry Problem)، وهي تضع نموذجًا رائعًا لمعضلة اتخاذ القرار حول كيفية اتخاذ **أفضل خيار** وسط حالة من عدم اليقين.
