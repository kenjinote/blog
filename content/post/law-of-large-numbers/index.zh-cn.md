...
世界上有许多豪华的赌场。有些玩家一夜暴富，而另一些则失去一切。然而，赌场经营者绝对不会进行 **赌博** 。他们基于坚实的数学基础，即 **[大数定律（[Law of Large Numbers](https://kenji.blog/p/law-of-large-numbers/)）](https://kenji.blog/p/law-of-large-numbers/)** 开展业务。
...
根据收敛强度的不同，大数定律分为 **大数弱定律** （Weak [Law of Large Numbers](https://kenji.blog/p/law-of-large-numbers/), WLLN）和 **大数强定律** （Strong [Law of Large Numbers](https://kenji.blog/p/law-of-large-numbers/), SLLN）两种。其严格的数学表述如下。
