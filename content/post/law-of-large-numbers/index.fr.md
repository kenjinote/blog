...
La loi des grands nombres (LLN, pour Law of Large Numbers) est, pour faire simple, la loi selon laquelle **"si le nombre d'essais augmente suffisamment, la probabilité d'occurrence d'un événement converge vers sa valeur théorique (valeur espérée)."**
...
Cependant, la bille de la roulette n'a pas de mémoire. Au 11ème lancer, la probabilité d'obtenir rouge et celle d'obtenir noir restent indépendantes et identiques. La loi des grands nombres garantit que la proportion convergera dans "un futur infini", mais **elle ne signifie pas que des forces interviennent pour compenser les déséquilibres passés**.
...
La loi des grands nombres n'est pas universelle. L'une de ses conditions préalables est que "la valeur espérée (moyenne) doit être finie".
...
La loi des grands nombres n'est pas seulement utilisée dans les casinos, mais aussi dans divers systèmes qui soutiennent les fondements de notre société.
