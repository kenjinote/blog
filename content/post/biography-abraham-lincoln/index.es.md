...
```mermaid
graph TD
    A["Nacimiento en una cabaña de troncos en Kentucky (1809)"] --> B["Educación autodidacta y abogado"]
    B --> C["Carrera política (Illinois y el Congreso)"]
    C --> D["Elegido 16º presidente de EE. UU. (1860)"]
    D --> E["Inicio de la Guerra Civil Estadounidense (1861)"]
    E --> F["Proclamación de Emancipación (1863)"]
    E --> G["Discurso de Gettysburg (1863)"]
    F --> H["Cambio moral de la guerra"]
    G --> I["Redefinición de los ideales democráticos"]
    H --> J["Abolición de la esclavitud (13ª Enmienda)"]
    I --> K["Preservación de la Unión"]
    J --> L["Asesinato (1865)"]
    K --> L
    L --> M["Legado global perdurable de libertad"]
```
