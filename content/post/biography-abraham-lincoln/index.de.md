...
```mermaid
graph TD
    A["Geburt in einer Blockhütte in Kentucky (1809)"] --> B["Selbststudium und Anwalt"]
    B --> C["Politische Karriere (Illinois und Kongress)"]
    C --> D["Wahl zum 16. US-Präsidenten (1860)"]
    D --> E["Beginn des Amerikanischen Bürgerkriegs (1861)"]
    E --> F["Emanzipationsproklamation (1863)"]
    E --> G["Gettysburg-Rede (1863)"]
    F --> H["Moralischer Wandel des Krieges"]
    G --> I["Neudefinition demokratischer Ideale"]
    H --> J["Abschaffung der Sklaverei (13. Zusatzartikel)"]
    I --> K["Erhaltung der Union"]
    J --> L["Ermordung (1865)"]
    K --> L
    L --> M["Anhaltendes globales Vermächtnis der Freiheit"]
```
