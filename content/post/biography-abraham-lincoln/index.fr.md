---
title: "Abraham Lincoln : La vie et la philosophie du « Grand Émancipateur » qui a guidé une nation divisée"
...
```mermaid
graph TD
    A["Naissance dans une cabane en rondins du Kentucky (1809)"] --> B["Éducation autodidacte et avocat"]
    B --> C["Carrière politique (Illinois et Congrès)"]
    C --> D["Élu 16e président des États-Unis (1860)"]
    D --> E["Début de la guerre de Sécession (1861)"]
    E --> F["Proclamation d'émancipation (1863)"]
    E --> G["Discours de Gettysburg (1863)"]
    F --> H["Changement moral de la guerre"]
    G --> I["Redéfinition des idéaux démocratiques"]
    H --> J["Abolition de l'esclavage (13e amendement)"]
    I --> K["Préservation de l'Union"]
    J --> L["Assassinat (1865)"]
    K --> L
    L --> M["Héritage mondial durable de la liberté"]
```
