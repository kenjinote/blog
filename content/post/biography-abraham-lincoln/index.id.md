---
title: "Abraham Lincoln: Kehidupan dan Filosofi sang 'Pembebas Hebat' yang Memimpin Bangsa yang Terbelah"
...
```mermaid
graph TD
    A["Kelahiran di Kabin Kayu Kentucky (1809)"] --> B["Belajar Otodidak dan Menjadi Pengacara"]
    B --> C["Karier Politik (Illinois dan Kongres)"]
    C --> D["Terpilih Sebagai Presiden AS Ke-16 (1860)"]
    D --> E["Perang Saudara Amerika Pecah (1861)"]
    E --> F["Proklamasi Emansipasi (1863)"]
    E --> G["Pidato Gettysburg (1863)"]
    F --> H["Pergeseran Moral dari Perang"]
    G --> I["Mendefinisikan Ulang Cita-cita Demokrasi"]
    H --> J["Penghapusan Perbudakan (Amandemen Ke-13)"]
    I --> K["Pelestarian Uni"]
    J --> L["Pembunuhan (1865)"]
    K --> L
    L --> M["Warisan Kebebasan Global yang Abadi"]
```
