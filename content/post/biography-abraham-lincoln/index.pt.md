---
title: "Abraham Lincoln: A Vida e a Filosofia do 'Grande Emancipador' que Liderou uma Nação Dividida"
...
```mermaid
graph TD
    A["Nascimento em Cabana de Troncos no Kentucky (1809)"] --> B["Educação Autodidata e Advogado"]
    B --> C["Carreira Política (Illinois e Congresso)"]
    C --> D["Eleito 16º Presidente dos EUA (1860)"]
    D --> E["Início da Guerra Civil Americana (1861)"]
    E --> F["Proclamação de Emancipação (1863)"]
    E --> G["Discurso de Gettysburg (1863)"]
    F --> H["Mudança Moral da Guerra"]
    G --> I["Redefinindo os Ideais Democráticos"]
    H --> J["Abolição da Escravidão (13ª Emenda)"]
    I --> K["Preservação da União"]
    J --> L["Assassinato (1865)"]
    K --> L
    L --> M["Legado Global Duradouro de Liberdade"]
```
