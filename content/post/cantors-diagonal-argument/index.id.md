...
image: "eyecatch.jpg"
categories: ["Matematika", "Dasar Matematika", "Teori Himpunan"]
...
Secara intuitif, kita cenderung berpikir bahwa "tak terhingga adalah tak terhingga, dan keduanya sama-sama tidak memiliki ujung", tetapi matematikawan abad ke-19 Georg Cantor membuktikan fakta yang mengejutkan bahwa **"ketakterhinggaan memiliki perbedaan besaran (kardinalitas)"** .
...
## Jalan Menuju Hipotesis Kontinum (Continuum Hypothesis)
...
Hipotesis yang menyatakan bahwa "tidak ada kardinalitas perantara" disebut **Hipotesis Kontinum (Continuum Hypothesis, CH)** . Cantor mendedikasikan hidupnya untuk pembuktian ini, tetapi tidak pernah bisa menyelesaikannya.

Belakangan, Kurt Gödel dan Paul Cohen membuktikan bahwa Hipotesis Kontinum **"tidak dapat dibuktikan maupun disangkal (independen) di bawah sistem aksioma matematika saat ini (ZFC)"** . Ini adalah salah satu penemuan paling mendalam dalam matematika abad ke-20.
...
Keindahan logika yang berlawanan dengan intuisi namun mutlak inilah yang bisa dikatakan sebagai daya tarik terbesar dari ilmu matematika. Argumen diagonal kelak akan diaplikasikan pada teori-teori yang menjadi fondasi ilmu komputer dan logika matematika, seperti pembuktian masalah penghentian (Halting problem) oleh Alan Turing dan teorema ketaklengkapan (Incompleteness theorem) oleh Gödel.
