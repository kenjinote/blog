...
直观上我们很容易认为“无限就是无限，两者同样没有尽头”，但是19世纪的数学家[格奥尔格·康托尔](https://kenji.blog/p/cantor/)（[Georg Cantor](https://kenji.blog/p/cantor/)）证明了一个令人惊讶的事实： **“无限是有大小（势）之分的”** 。
...
## 通向[连续统假设（Continuum Hypothesis）](https://kenji.blog/p/continuum-hypothesis/)之路
...
“不存在中间势”的假设被称为 **连续统假设（[Continuum Hypothesis](https://kenji.blog/p/continuum-hypothesis/), CH）** 。康托尔为证明此假设倾注了一生，但未能解决。

后来，[库尔特·哥德尔](https://kenji.blog/p/godel/)（[Kurt Gödel](https://kenji.blog/p/godel/)）和保罗·科恩（Paul Cohen）证明了连续统假设 **“在当前的数学公理系统（ZFC）中，既无法证明也无法证伪（是独立的）”** 。这是 20 世纪数学中最深奥的发现之一。
...
这种违反直觉，却又具有绝对逻辑美的特征，可以说是数学这门学科最大的魅力所在。对角线论证后来也被应用于[艾伦·图灵](https://kenji.blog/p/turing/)（[Alan Turing](https://kenji.blog/p/turing/)）的停机问题和[哥德尔不完备定理](https://kenji.blog/p/godels-incompleteness-theorems/)的证明等，成为了计算机科学和数理逻辑根基理论的重要组成部分。
