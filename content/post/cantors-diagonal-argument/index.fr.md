...
image: "eyecatch.jpg"
categories: ["Mathématiques", "foundations-of-Mathématiques", "set-theory"]
...
Intuitivement, on a tendance à penser que « l'infini est l'infini, et les deux sont également sans fin », mais le mathématicien du 19ème siècle [Georg Cantor](https://kenji.blog/fr/p/cantor/) a prouvé un fait étonnant : **il existe des différences de taille (cardinalité) dans l'infini** .
...
## Vers l'hypothèse du continu ([Continuum Hypothesis](https://kenji.blog/fr/p/continuum-hypothesis/))
