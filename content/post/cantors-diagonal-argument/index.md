...
後に、[クルト・ゲーデル](https://kenji.blog/p/godel/)（Kurt Gödel）とポール・コーエン（Paul Cohen）によって、連続体仮説は **「現在の数学の公理系（ZFC）では、証明も反証もできない（独立である）」** ことが証明されました。これは20世紀数学における最も深遠な発見の一つです。
