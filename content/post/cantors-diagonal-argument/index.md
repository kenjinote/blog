...
この直感に反する、しかし絶対的な論理の美しさこそが、数学という学問の最大の魅力と言えるでしょう。対角線論法は、のちに[アラン・チューリング](https://kenji.blog/p/turing/)（[Alan Turing](https://kenji.blog/p/turing/)）の停止性問題や[ゲーデルの不完全性定理](https://kenji.blog/p/godels-incompleteness-theorems/)の証明など、計算機科学や数理論理学の根幹をなす理論にも応用されることになります。
