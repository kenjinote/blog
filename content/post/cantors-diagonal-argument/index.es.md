...
image: "eyecatch.jpg"
categories: ["Matemáticas", "Fundamentos de las matemáticas", "Teoría de conjuntos"]
...
Intuitivamente, solemos pensar que «el infinito es infinito, y ambos no tienen fin de la misma manera», pero el matemático del siglo XIX Georg Cantor (Georg Cantor) demostró un hecho asombroso: **«el infinito tiene diferencias de tamaño (cardinalidad)»** .
...
## El camino hacia la hipótesis del continuo (Continuum Hypothesis)
...
A la hipótesis de que «no existe una cardinalidad intermedia» se le llama la **hipótesis del continuo (Continuum Hypothesis, CH)** . Cantor dedicó su vida a intentar demostrar esto, pero no pudo resolverlo.

Más tarde, Kurt Gödel y Paul Cohen demostraron que la hipótesis del continuo es **«indemostrable e irrefutable (independiente) bajo el sistema axiomático actual de las matemáticas (ZFC)»** . Este es uno de los descubrimientos más profundos de las matemáticas del siglo XX.
...
Esta belleza lógica absoluta, aunque contraintuitiva, se puede decir que es el mayor atractivo de la disciplina matemática. El argumento diagonal se aplicaría más tarde a teorías fundamentales en ciencias de la computación y lógica matemática, como el problema de la parada de Alan Turing (Alan Turing) y la demostración de los teoremas de incompletitud de Gödel.
