...
علاوة على ذلك، فإن الخوارزمية التي تقلل بشكل كبير من التعقيد الحسابي لـ DFT من $O(N^2)$ إلى $O(N \log N)$ هي **[تحويل فورييه السريع (FFT)](/ar/p/fast-fourier-transform-algorithm/)**. مع ظهور [FFT](/ar/p/fast-fourier-transform-algorithm/)، شهد مجال معالجة الإشارات الرقمية (DSP) تطورًا هائلاً. تستفيد العديد من تقنياتنا المألوفة، مثل التعرف على الكلام على الهواتف الذكية وضغط صور JPEG، من [FFT](/ar/p/fast-fourier-transform-algorithm/).
