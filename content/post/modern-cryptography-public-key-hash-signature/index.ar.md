...
يعتمد أمان تشفير المفتاح العام على **الدالة أحادية الاتجاه** (One-way function)، حيث "يكون الحساب في اتجاه واحد سهلاً، ولكن الحساب العكسي يكون في غاية الصعوبة"، و **الدالة أحادية الاتجاه ذات الباب الخلفي** (Trapdoor one-way function) التي تتيح الحساب العكسي إذا كان هناك معلومات معينة (باب خلفي: Trapdoor) معروفة. هنا سنتعمق في تفاصيل تشفير RSA وتشفير المنحنيات الإهليلجية (ECC) كأمثلة بارزة.
...
5. حساب $d$ الذي يحقق التطابق التالي:
   ...
   يمكن حساب ذلك باستخدام خوارزمية إقليدس الممتدة.
...
يعتمد أمان ECC على صعوبة **مشكلة اللوغاريتم المتقطع على المنحنيات الإهليلجية** (ECDLP).
...
في ECC، يكون $k$ هو **المفتاح الخاص** ، و $P$ هو **المفتاح العام** .
...
- تبادل آمن للمفاتيح وتحقيق التباين باستخدام **تشفير المفتاح العام** (RSA و ECC)
...
هذا الجمال الرياضي ونظرية الحوسبة الدقيقة تحمي خصوصيتنا وممتلكاتنا يومياً من الهجمات السيبرانية. يستمر تطور تقنيات التشفير، ويجري العمل بسرعة على الأبحاث والتوحيد القياسي لـ **تشفير ما بعد الكم** (PQC: Post-Quantum Cryptography) استعداداً لظهور الحواسيب الكمومية.
