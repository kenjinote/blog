...
Безопасность [ECC](/ru/p/elliptic-curve-cryptography-math-cpp/) зависит от сложности **проблемы дискретного логарифмирования на эллиптической кривой** (ECDLP).
...
В [ECC](/ru/p/elliptic-curve-cryptography-math-cpp/) $k$ становится **закрытым ключом**, а $P$ — **открытым ключом**.
...
- Безопасный обмен ключами и реализация асимметрии с помощью **криптографии с открытым ключом** (RSA и [ECC](/ru/p/elliptic-curve-cryptography-math-cpp/))
