---
title: "Steve Jobs: A Trajetória e Filosofia do Rebelde que Mudou o Mundo"
...
description: "Na sociedade digital moderna, o fato de tocarmos naturalmente em nossos smartphones, digitarmos textos com fontes belas e carregarmos música no bolso se de"
---
...
```mermaid
flowchart TD
    A["Nascimento (1955)"] --> B["Fundação da Apple (1976)"]
    B --> C["Lançamento do Macintosh (1984)"]
    C --> D["Expulsão da Apple (1985)"]
    D --> E["Fundação da NeXT / Pixar (1985-1986)"]
    E --> F["Retorno à Apple (1996)"]
    F --> G["Lançamento do iMac (1998)"]
    G --> H["Lançamento do iPod (2001)"]
    H --> I["Lançamento do iPhone (2007)"]
    I --> J["Lançamento do iPad (2010)"]
    J --> K["Falecimento (2011)"]
```
