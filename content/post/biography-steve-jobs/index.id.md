---
title: "Steve Jobs: Jejak dan Filosofi Sang Pemberontak yang Mengubah Dunia"
...
```mermaid
flowchart TD
    A["Kelahiran (1955)"] --> B["Pendirian Apple (1976)"]
    B --> C["Peluncuran Macintosh (1984)"]
    C --> D["Diusir dari Apple (1985)"]
    D --> E["Pendirian NeXT / Pixar (1985-1986)"]
    E --> F["Kembali ke Apple (1996)"]
    F --> G["Peluncuran iMac (1998)"]
    G --> H["Peluncuran iPod (2001)"]
    H --> I["Peluncuran iPhone (2007)"]
    I --> J["Peluncuran iPad (2010)"]
    J --> K["Meninggal Dunia (2011)"]
```
