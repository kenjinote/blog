...
description: "In today's modern digital society, it is no exaggeration to say that we owe our ability to casually touch smartphones, type texts in beautiful fonts, and c"
---
...
```mermaid
flowchart TD
    A["Birth (1955)"] --> B["Apple Founded (1976)"]
    B --> C["Macintosh Announced (1984)"]
    C --> D["Exiled from Apple (1985)"]
    D --> E["NeXT / Pixar Founded (1985-1986)"]
    E --> F["Return to Apple (1996)"]
    F --> G["iMac Announced (1998)"]
    G --> H["iPod Announced (2001)"]
    H --> I["iPhone Announced (2007)"]
    I --> J["iPad Announced (2010)"]
    J --> K["Death (2011)"]
```
