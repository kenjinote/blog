---
title: "Steve Jobs: La trayectoria y filosofía del inconformista que cambió el mundo"
...
```mermaid
flowchart TD
    A["Nacimiento (1955)"] --> B["Fundación de Apple (1976)"]
    B --> C["Lanzamiento del Macintosh (1984)"]
    C --> D["Expulsión de Apple (1985)"]
    D --> E["Fundación de NeXT / Pixar (1985-1986)"]
    E --> F["Regreso a Apple (1996)"]
    F --> G["Lanzamiento del iMac (1998)"]
    G --> H["Lanzamiento del iPod (2001)"]
    H --> I["Lanzamiento del iPhone (2007)"]
    I --> J["Lanzamiento del iPad (2010)"]
    J --> K["Fallecimiento (2011)"]
```
