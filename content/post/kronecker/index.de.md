---
title: 'Leopold Kronecker: Das Leben und die algebraischen Beiträge des Mathematikers, der die ganzen Zahlen liebte'
description: 'Ein Überblick über das Leben, die Konflikte mit Cantor und die tiefgreifenden Errungenschaften von Leopold Kronecker, dem großen Mathematiker des 19. Jahrhunderts, der für das Zitat "Die ganzen Zahlen hat der liebe Gott gemacht, alles andere ist Menschenwerk" berühmt ist.'
slug: "kronecker"
...
In der Geschichte der Mathematik gibt es kaum ein Zitat, das so berühmt ist und die Ideologie eines Mathematikers so treffend zusammenfasst. Der Urheber dieser Worte ist der herausragende deutsche Mathematiker des 19. Jahrhunderts, **Leopold [Kronecker](https://kenji.blog/de/p/kronecker/)** (1823–1891).

Diese Aussage war nicht nur poetisch; sie wurde durch seinen vehementen Glauben an den **mathematischen Konstruktivismus** gestützt. In diesem Artikel tauchen wir tief in [Kronecker](https://kenji.blog/de/p/kronecker/)s Leben ein, beleuchten die Kontroversen, die er in der mathematischen Gemeinschaft auslöste, und das großartige Erbe, das er der modernen Mathematik hinterlassen hat.

# 2. [Kronecker](https://kenji.blog/de/p/kronecker/)s Leben und Episoden

## 2.1. Aufblühendes Talent und die Begegnung mit [Kummer](https://kenji.blog/de/p/kummer/)
...
```mermaid
graph TD
    A["Ernst Kummer"] -->|"Mathematische Anleitung und Einfluss"| B["Leopold Kronecker"]
    B -->|"Gemeinsame Forschung an der Uni Berlin"| A
    B -->|"Einfluss und Konflikt"| C["Georg Cantor"]
    B -->|"Ideologischer Konflikt"| D["Karl Weierstrass"]
```

## 2.2. Akademiker und Erfolg als Geschäftsmann

Im Jahr 1841 trat [Kronecker](https://kenji.blog/de/p/kronecker/) in die Universität Berlin ein und studierte bei hochkarätigen Mathematikern wie Peter Gustav Lejeune Dirichlet und [Carl Gustav Jacob Jacobi](https://kenji.blog/de/p/jacobi/). Bis 1845 promovierte er mit einer herausragenden Arbeit über die algebraische Zahlentheorie.

Danach schlug [Kronecker](https://kenji.blog/de/p/kronecker/) jedoch einen ungewöhnlichen Karriereweg ein. Anstatt eine Universitätsstelle zu suchen, kehrte er in seine Heimatstadt zurück, um das riesige landwirtschaftliche Gut und das Bankgeschäft seines Onkels zu übernehmen. Er erzielte als Geschäftsmann enormen Erfolg und häufte großen Reichtum an. Während dieser gesamten Zeit setzte er seine mathematische Forschung als Hobby fort, was ihn im Grunde zum stärksten Amateurmathematiker seiner Zeit machte.

## 2.3. Rückkehr an die Universität Berlin und akademische Prominenz

Nachdem er völlige finanzielle Unabhängigkeit erreicht hatte, kehrte [Kronecker](https://kenji.blog/de/p/kronecker/) 1855 nach Berlin zurück. Er begann als unbezahlter Privatdozent an der Universität Berlin Vorlesungen zu halten. Da er kein Gehalt zum Leben brauchte, konnte er sich ganz der Forschung und den Vorlesungen widmen, die er liebte.
...
Wenn man über [Kronecker](https://kenji.blog/de/p/kronecker/)s Leben spricht, darf man seine heftigen Debatten mit anderen Mathematikern nicht unerwähnt lassen.

## 3.1. Strikter Konstruktivismus

[Kronecker](https://kenji.blog/de/p/kronecker/) hatte die feste Überzeugung, dass "nur Dinge, die in einer endlichen Anzahl von Operationen explizit berechnet und konstruiert werden können, mathematisch existieren". Er verabscheute nicht-konstruktive Existenzbeweise durch Widerspruch (die Logik, dass "wenn wir annehmen, es existiere nicht, ein Widerspruch entsteht; folglich existiert es") zutiefst.

Zum Beispiel argumentierte er in Bezug auf den [Fundamentalsatz der Algebra](https://kenji.blog/de/p/fundamental-theorem-of-algebra/), dass der bloße Beweis, dass "eine Wurzel existiert", unzureichend sei; es müsse ein Algorithmus beigebracht werden, der detailliert beschreibt, "wie die Wurzel explizit konstruiert wird".

## 3.2. Zusammenstöße mit Cantor und Weierstraß

Diese extreme Ideologie brachte ihn in Konflikt mit seinen Zeitgenossen.

Am berühmtesten war seine vehemente Kritik an **[Georg Cantor](https://kenji.blog/de/p/cantor/)** und dessen Mengenlehre. [Kronecker](https://kenji.blog/de/p/kronecker/) verurteilte Cantors Konzepte der Mächtigkeiten unendlicher Mengen und transfiniter Zahlen als "Mystizismus, nicht Mathematik" und ergriff sogar Maßnahmen, um die Veröffentlichung von Cantors Arbeiten zu behindern.

Er stieß auch mit **[Karl Weierstrass](https://kenji.blog/de/p/weierstrass/)** zusammen, der einst ein enger Freund war. Bezüglich der weierstraßschen Analysis (wie der Konstruktion stetiger, nirgends differenzierbarer Funktionen) kritisierte [Kronecker](https://kenji.blog/de/p/kronecker/) solche Funktionen als "pathologisch" und erklärte, sie existierten nicht.

# 4. Große Beiträge zur Mathematik

Während [Kronecker](https://kenji.blog/de/p/kronecker/)s Ideologie manchmal extrem war, waren seine mathematischen Errungenschaften unbestreitbar erstklassig, und sein Name krönt zahlreiche Konzepte in der gesamten modernen Mathematik.

## 4.1. [Kronecker](https://kenji.blog/de/p/kronecker/)-Delta

Am bekanntesten ist vielleicht das "[Kronecker](https://kenji.blog/de/p/kronecker/)-Delta". Dieses Symbol, das häufig in der linearen Algebra und Physik (wie der Quantenmechanik und Tensoranalysis) auftritt, wird wie folgt definiert:
...
## 4.2. [Kronecker](https://kenji.blog/de/p/kronecker/)-Produkt

Das "[Kronecker](https://kenji.blog/de/p/kronecker/)-Produkt", eine Art Tensorprodukt für Matrizen, ist ebenfalls nach ihm benannt. Für eine Matrix $A$ (Größe $m \times n$) und eine Matrix $B$ (Größe $p \times q$) ist ihr [Kronecker](https://kenji.blog/de/p/kronecker/)-Produkt $A \otimes B$ als Blockmatrix der Größe $(mp) \times (nq)$ definiert:
...
## 4.3. Satz von [Kronecker](https://kenji.blog/de/p/kronecker/)-Weber

Eine der monumentalen Säulen der algebraischen Zahlentheorie ist der "Satz von [Kronecker](https://kenji.blog/de/p/kronecker/)-Weber". Der Satz besagt Folgendes:

**Satz ([Kronecker](https://kenji.blog/de/p/kronecker/)-Weber):** 
