...
命运的邂逅就在这里发生。学校迎来了一位新教师—— **恩斯特·库默尔** （Ernst Kummer），他后来成为了理想数理论的先驱。库默尔立刻发现了克罗内克的才华，并为他提供了深入的、个性化的数学指导。
...
其中最著名的就是他对 **格奥尔格·康托尔** （Georg Cantor）及其集合论的猛烈批评。克罗内克谴责康托尔关于无限集合的基数和超限数的概念是“神秘主义，而不是数学”，甚至采取行动阻碍康托尔论文的发表。

他还与曾经的密友 **卡尔·魏尔斯特拉斯** （Karl Weierstrass）发生了冲突。关于魏尔斯特拉斯的分析学（例如构造处处连续但处处不可微的函数），克罗内克批评这类函数是“病态的”，并宣称它们根本不存在。
