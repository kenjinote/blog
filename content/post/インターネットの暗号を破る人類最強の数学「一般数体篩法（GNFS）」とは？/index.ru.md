...
Другими словами, в момент вычисления наибольшего общего делителя скрытое простое число $p$ внезапно выпадает, и шифр оказывается полностью взломанным. (*Наибольший общий делитель можно моментально вычислить даже на смартфоне с помощью «Алгоритма [Евклид](https://kenji.blog/p/euclid/)а»*)
