---
title: 'Как настроить размер и размещение изображений в теме Hugo PaperMod с помощью CSS'
slug: "PaperModのИзображениеの配置変更"
date: 2022-09-11T18:50:40+09:00
tags: ["HUGO", "PaperMod"]
draft: false
image: "images/img.webp"
categories: ["blogging"]
description: 'Объясняется, как настроить размер и расположение изображений в статьях темы Hugo PaperMod. Представлены конкретные шаги по редактированию CSS (blank.css и post-entry.css) для обтекания текста вокруг изображений или их уменьшения по сравнению с настройками по умолчанию (ширина 100% и выравнивание по центру).'
---
