...
math: true
mermaid: true
categories: ["programming", "cpp", "tools"]
...
モダンCMakeでは、すべてを **ターゲット (Target)** と ** プロパティ (Property)** として扱います。[オブジェクト指向](https://kenji.blog/p/oop-vs-fp-vs-dop/)プログラミングにおけるクラスとメンバ変数の関係に似ています。
