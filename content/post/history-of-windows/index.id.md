---
title: "Sejarah OS: Silsilah Windows (Dari MS-DOS hingga Selesainya Arsitektur NT)"
description: "Sejarah evolusi Windows yang dimulai dari MS-DOS berbasis CUI, beralih ke GUI, dan mencapai arsitektur NT yang tangguh."
...
graph TD
    ...
    VMS["Konsep OS VMS"] --> NT["Windows NT (Kernel NT)"]
    W95 --> WXP["Windows XP"]
    NT --> WXP
```
