---
title: "Histoire de l'OS : La généalogie de Windows (de MS-DOS à l'achèvement de l'architecture NT)"
description: "L'histoire de l'évolution de Windows, en commençant par le CUI de MS-DOS, le passage à la GUI, jusqu'à l'architecture NT robuste."
...
```mermaid
graph TD
    DOS["MS-DOS"] --> W95["Windows 95/98/Me (noyau 9x)"]
    VMS["Concepts de l'OS VMS"] --> NT["Windows NT (noyau NT)"]
    W95 --> WXP["Windows XP"]
    NT --> WXP
```
