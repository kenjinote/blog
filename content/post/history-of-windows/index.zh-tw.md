---
title: "OS 歷史：Windows 的系譜 (從 MS-DOS 到 NT 架構的完成)"
description: "從 CUI 的 MS-DOS 開始，過渡到 GUI，最終演變成堅固的 NT 架構，這是 Windows 的演進歷史。"
...
```mermaid
graph TD
    DOS["MS-DOS"] --> W95["Windows 95/98/Me (9x 核心)"]
    VMS["VMS OS 概念"] --> NT["Windows NT (NT 核心)"]
    W95 --> WXP["Windows XP"]
    NT --> WXP
```
