...
這正是[中央極限定理](/zh-tw/p/central-limit-theorem/)最直接的體現：獨立同分佈的隨機變數之和會收斂於常態分佈。
...
在本文中，我們從最簡單的「醉漢漫步」出發，詳細講解了與[隨機漫步](https://kenji.blog/zh-tw/p/random-walk/)相關的數學背景，包括[中央極限定理](/zh-tw/p/central-limit-theorem/)向高斯分佈的收斂、擴散方程式的推導、愛因斯坦對布朗運動的解釋、波利亞定理，以及在金融工程中的應用。
