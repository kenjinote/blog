...
[Случайное блуждание](https://kenji.blog/p/random-walk/) — это математическая модель, в которой следующая позиция определяется случайным (вероятностным) образом. Его часто называют «блужданием пьяницы».
