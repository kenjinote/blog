...
この記事では、最も単純な「酔歩」から出発し、[中心極限定理](https://kenji.blog/p/central-limit-theorem/)による[ガウス](https://kenji.blog/p/gauss/)分布への収束、拡散方程式の導出、アインシュタインによるブラウン運動の解明、ポリアの定理、そして金融工学への応用まで、ランダムウォークにまつわる数学的背景を詳しく解説しました。
