...
[المشي العشوائي](https://kenji.blog/p/random-walk/) هو مفهوم رياضي يتم فيه تحديد الموضع التالي بشكل عشوائي (احتمالي). غالبًا ما يُطلق عليه "مشية السكران".
...
عند الحد المستمر، يصبح [المشي العشوائي](https://kenji.blog/p/random-walk/) **معادلة الانتشار**:
