...
## Strict Mathematical Formulation of the 1D Random Walk
...
## Stirling's Approximation and the Central Limit Theorem: Convergence to the Gaussian Distribution
...
This is precisely a direct manifestation of the Central Limit Theorem, which states that the sum of independent and identically distributed random variables converges to a normal distribution.
