...
# Alexander Grothendieck: Leben und Werk des größten Mathematikers des 20. Jahrhunderts
...
```mermaid
timeline
    title "Das frühe Leben und die Errungenschaften von Alexander Grothendieck"
    1928 : "Geboren in Berlin, Deutschland"
    1939 : "Flucht nach Frankreich, später im Lager interniert"
    1945 : "Eintritt in die Universität Montpellier, eigenständige Wiederentdeckung des Lebesgue-Maßes"
    1948 : "Umzug nach Paris, Teilnahme am Cartan-Seminar"
    1949 : "Umzug an die Universität Nancy, Studium bei Schwartz und Dieudonné"
    1953 : "Einreichung einer Doktorarbeit, die 14 offene Probleme der Funktionalanalysis löst"
```
...
```mermaid
graph TD
    A["Geometrie"] -->|"Vereint"| C["Schema-Theorie"]
    B["Zahlentheorie"] -->|"Vereint"| C
    C --> D["Étale-Kohomologie"]
    C --> E["Topos-Theorie"]
    D -->|"Löst teilweise die Weil-Vermutungen"| F["Weil-Vermutungen"]
    D -->|"Vollständig gelöst von Deligne"| F
    C --> G["Motiv"]
    E -->|"Verallgemeinerung von Raum und Logik"| H["Einfluss auf die moderne Mathematik und Logik"]
    G -->|"Universelle Kohomologie"| H
```
