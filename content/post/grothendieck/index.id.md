...
# [Alexander Grothendieck: Kehidupan dan Pencapaian Matematikawan Terbesar Abad ke-20](https://kenji.blog/id/p/grothendieck/)
...
```mermaid
timeline
    title "Kehidupan Awal dan Pencapaian Alexander Grothendieck"
    1928 : "Lahir di Berlin, Jerman"
    1939 : "Melarikan diri ke Prancis, kemudian diinternir di sebuah kamp"
    1945 : "Masuk Univ. Montpellier, menemukan kembali ukuran Lebesgue secara mandiri"
    1948 : "Pindah ke Paris, berpartisipasi dalam Seminar Cartan"
    1949 : "Pindah ke Univ. Nancy, belajar di bawah Schwartz dan Dieudonné"
    1953 : "Menyerahkan tesis PhD yang memecahkan 14 masalah terbuka dalam analisis fungsional"
```
...
```mermaid
graph TD
    A["Geometri"] -->|"Menyatukan"| C["Teori Skema"]
    B["Teori Bilangan"] -->|"Menyatukan"| C
    C --> D["Kohomologi Étale"]
    C --> E["Teori Topos"]
    D -->|"Secara parsial memecahkan Dugaan Weil"| F["Dugaan Weil"]
    D -->|"Diselesaikan sepenuhnya oleh Deligne"| F
    C --> G["Motif"]
    E -->|"Generalisasi ruang dan logika"| H["Dampak pada matematika dan logika modern"]
    G -->|"Kohomologi universal"| H
```
