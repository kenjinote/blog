...
# [[Alexandre Grothendieck](https://kenji.blog/p/grothendieck/) : Vie et Œuvres du Plus Grand Mathématicien du 20e Siècle](https://kenji.blog/p/grothendieck/)

[Alexandre Grothendieck](https://kenji.blog/p/grothendieck/) est l'un des plus grands mathématiciens de l'histoire, ayant apporté un changement de paradigme fondamental dans la communauté mathématique de la fin du 20e siècle, en particulier dans le domaine de la géométrie algébrique. Ses réalisations sont allées bien au-delà de la résolution de problèmes ouverts individuels ; elles ont fondamentalement reconstruit le langage même et le cadre conceptuel des mathématiques. Dans cet article, nous fournirons une explication détaillée de sa vie extraordinaire et dramatique, ainsi que de son impact incommensurable sur les mathématiques modernes.
...
```mermaid
timeline
    title "La Jeunesse et les Réalisations d'Alexandre Grothendieck"
    1928 : "Naissance à Berlin, Allemagne"
    1939 : "Fuit en France, plus tard interné dans un camp"
    1945 : "Entre à l'Université de Montpellier, redécouvre la mesure de Lebesgue"
    1948 : "Déménage à Paris, participe au Séminaire Cartan"
    1949 : "Déménage à l'Université de Nancy, étudie sous Schwartz et Dieudonné"
    1953 : "Soumet une thèse de doctorat résolvant 14 problèmes ouverts en analyse fonctionnelle"
```
...
```mermaid
graph TD
    A["Géométrie"] -->|"Unifie"| C["Théorie des Schémas"]
    B["Théorie des Nombres"] -->|"Unifie"| C
    C --> D["Cohomologie Étale"]
    C --> E["Théorie des Topos"]
    D -->|"Résout partiellement les Conjectures de Weil"| F["Conjectures de Weil"]
    D -->|"Complètement résolu par Deligne"| F
    C --> G["Motif"]
    E -->|"Généralisation de l'espace et de la logique"| H["Impact sur les mathématiques et la logique modernes"]
    G -->|"Cohomologie universelle"| H
```
