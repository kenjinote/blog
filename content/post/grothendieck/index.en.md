...
# [[Alexander Grothendieck](https://kenji.blog/en/p/grothendieck/): The Life and Achievements of the 20th Century's Greatest Mathematician](https://kenji.blog/p/grothendieck/)
...
```mermaid
timeline
    title "The Early Life and Achievements of Alexander Grothendieck"
    1928 : "Born in Berlin, Germany"
    1939 : "Fled to France, later interned in a camp"
    1945 : "Entered University of Montpellier, independently rediscovered Lebesgue measure"
    1948 : "Moved to Paris, participated in the Cartan Seminar"
    1949 : "Moved to University of Nancy, studied under Schwartz and Dieudonné"
    1953 : "Submitted a PhD thesis solving 14 open problems in functional analysis"
```
...
```mermaid
graph TD
    A["Geometry"] -->|"Unifies"| C["Scheme Theory"]
    B["Number Theory"] -->|"Unifies"| C
    C --> D["Étale Cohomology"]
    C --> E["Topos Theory"]
    D -->|"Partially solves the Weil Conjectures"| F["Weil Conjectures"]
    D -->|"Completely solved by Deligne"| F
    C --> G["Motive"]
    E -->|"Generalization of space and logic"| H["Impact on modern mathematics and logic"]
    G -->|"Universal cohomology"| H
```
