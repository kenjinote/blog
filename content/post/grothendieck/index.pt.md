...
```mermaid
timeline
    title "O Início da Vida e as Conquistas de Alexander Grothendieck"
    1928 : "Nascido em Berlim, Alemanha"
    1939 : "Foge para França, mais tarde internado num campo"
    1945 : "Ingressa na Univ. de Montpellier, redescobre a medida de Lebesgue"
    1948 : "Muda-se para Paris, participa no Seminário de Cartan"
    1949 : "Muda-se para a Univ. de Nancy, estuda com Schwartz e Dieudonné"
    1953 : "Submete uma tese de doutoramento resolvendo 14 problemas em análise funcional"
```
...
```mermaid
graph TD
    A["Geometria"] -->|"Unifica"| C["Teoria dos Esquemas"]
    B["Teoria dos Números"] -->|"Unifica"| C
    C --> D["Cohomologia Étale"]
    C --> E["Teoria dos Topos"]
    D -->|"Resolve parcialmente as Conjeturas de Weil"| F["Conjeturas de Weil"]
    D -->|"Completamente resolvido por Deligne"| F
    C --> G["Motivo"]
    E -->|"Generalização do espaço e da lógica"| H["Impacto na matemática e lógica modernas"]
    G -->|"Cohomologia universal"| H
```
