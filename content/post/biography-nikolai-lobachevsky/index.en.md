---
title: "Nikolai Lobachevsky: The \"Copernicus of Geometry\" Who Opened the Door to Non-Euclidean Geometry"
...
```mermaid
graph TD
    A["Euclidean Geometry"] -->|Absolute truth for 2000 years| B["Attempts to prove the parallel postulate"]
    B -->|The wall of unprovability| C["Lobachevsky's paradigm shift"]
    C -->|Multiple parallel lines can exist| D["Construction of Non-Euclidean Geometry (Hyperbolic Geometry)"]
    D --> E["Birth of the concept of space curvature"]
    E --> F["Development into Riemannian geometry"]
    F --> G["Einstein's General Theory of Relativity"]
    G --> H["Modern cosmology and understanding of black holes"]
```
...
```mermaid
graph LR
    subgraph "Correlation Diagram of Individuals and Influences"
        direction LR
        L["Lobachevsky"]
        E["Euclid"]
        G["Gauss"]
        ...
        L -->|Denied the parallel postulate| E
        L ---|Discovered independently and simultaneously| B
        G -->|Evaluated privately but didn't publish| L
        L -->|Provided the foundation of the theory| R
        R -->|Expanded the geometry of space| A
    end
```
