---
title: "Nikolái Lobachevski: El \"Copérnico de la Geometría\" que abrió la puerta a la geometría no euclidiana"
date: 2026-09-23T19:53:31+09:00
categories: ["biography"]
tags: ["nikolai-lobachevsky", "history"]
image: "eyecatch.jpg"
slug: "biography-nikolai-lobachevsky"
description: "En la historia de las matemáticas, pocos individuos han anulado fundamentalmente el sentido común existente y presentado una nueva visión del mundo."
---
...
```mermaid
graph TD
    A["Geometría euclidiana"] -->|Verdad absoluta durante 2000 años| B["Intentos de probar el postulado de las paralelas"]
    B -->|El muro de la imposibilidad de prueba| C["Cambio de paradigma de Lobachevski"]
    C -->|Pueden existir múltiples líneas paralelas| D["Construcción de geometría no euclidiana (geometría hiperbólica)"]
    D --> E["Nacimiento del concepto de curvatura del espacio"]
    E --> F["Desarrollo en la geometría de Riemann"]
    F --> G["Teoría general de la relatividad de Einstein"]
    G --> H["Cosmología moderna y comprensión de los agujeros negros"]
```
...
```mermaid
graph LR
    subgraph "Diagrama de correlación de individuos e influencias"
        direction LR
        L["Lobachevski"]
        E["Euclides"]
        G["Gauss"]
        ...
        L -->|Negó el postulado de las paralelas| E
        L ---|Descubierto independientemente y simultáneamente| B
        G -->|Evaluado en privado pero no publicado| L
        L -->|Proporcionó la base de la teoría| R
        R -->|Expandió la geometría del espacio| A
    end
```
