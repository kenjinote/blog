...
1969年7月20日，阿波罗11号在静海着陆，[尼尔·阿姆斯特朗](/zh-cn/p/biography-neil-armstrong/)船长成为首位踏上月球的人类。这一历史性壮举不仅是火箭工程、材料科学和天体力学等硬件进步的结晶，也是当时极具创新性的“软件”的胜利。
...
汉密尔顿深刻认识到，在像阿波罗计划这样关乎人命和国家威望的任务中，软件的Bug是不可容忍的。她将与硬件工程同等严格的测试方法、版本控制和质量保证流程引入到软件开发中。她亲自提出了<strong>“软件工程”</strong>一词，使软件开发确立为一门正当的工程学科。
...
AGC软件设计中最具革命性的一点是引入了实时操作系统（RTOS）概念，即<strong>“异步执行程序（Asynchronous Executive）”</strong>。
...
此外，她们还内置了当系统过载时的故障安全机制<strong>“BAILOUT（紧急逃生）”</strong>。
