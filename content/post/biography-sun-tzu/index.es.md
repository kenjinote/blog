...
flowchart TD
    ...
    GoShisho["Wu Zixu (Ministro de Wu)"]
    Koryo["Helu (Rey de Wu)"]
    Chu["Chu (Superpotencia occidental)"]

    %% Relaciones
    GoShisho -->|"Recomendación"| SunTzu
    SunTzu -->|"Presentó 13 capítulos del Arte de la Guerra"| Koryo
    Koryo -->|"Nombrado General"| SunTzu
    SunTzu -->|"Reforma militar y mando"| Chu
    
    %% Logros y flujo
    Reform["Disciplina estricta y entrenamiento"]
    Battle["Batalla de Boju (506 a.C.)"]
    Victory["Captura de Ying, capital de Chu"]
