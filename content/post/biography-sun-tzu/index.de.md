---
title: "Sun Tzu: Der Werdegang des genialen Militärstrategen, der die größte Kunst des Krieges schuf"
...
flowchart TD
    ...
    GoShisho["Wu Zixu (Hochrangiger Minister von Wu)"]
    Koryo["Helu (König von Wu)"]
    Chu["Chu (Westliche Supermacht)"]

    %% Beziehungen
    GoShisho -->|"Empfehlung"| SunTzu
    SunTzu -->|"Präsentierte 13 Kapitel der Kunst des Krieges"| Koryo
    Koryo -->|"Ernennung zum General"| SunTzu
    SunTzu -->|"Militärreform und Kommando"| Chu
    
    %% Errungenschaften und Ablauf
    Reform["Strikte Disziplin und Training"]
    Battle["Schlacht von Boju (506 v. Chr.)"]
    Victory["Eroberung von Ying, der Hauptstadt von Chu"]
