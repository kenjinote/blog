---
title: "Sun Tzu : La trajectoire du stratège militaire de génie qui a créé le plus grand Art de la guerre"
...
```mermaid
flowchart TD
    %% Corrélation des personnes
    SunTzu["Sun Wu (Sun Tzu)"]
    GoShisho["Wu Zixu (Haut ministre de Wu)"]
    Koryo["Helu (Roi de Wu)"]
    Chu["Chu (Superpuissance occidentale)"]

    %% Relations
    GoShisho -->|"Recommandation"| SunTzu
    SunTzu -->|"A présenté les 13 chapitres de l'Art de la guerre"| Koryo
    Koryo -->|"Nommé Général"| SunTzu
    SunTzu -->|"Réforme militaire et commandement"| Chu
    
    %% Accomplissements et déroulement
    Reform["Discipline stricte et entraînement"]
    Battle["Bataille de Boju (506 av. J.-C.)"]
    Victory["Capture de Ying, capitale de Chu"]
