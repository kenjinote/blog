...
这个悖论绝不仅仅是类似“[消失的1美元之谜](/zh-cn/p/missing-dollar/)”那样简单的计算错误或错觉。它与动摇了数学基础的 **[罗素悖论](/zh-cn/p/russells-paradox/)** （“所有不包含自身的集合的集合，是否包含自身？”）具有本质上相同的结构。

格雷林-纳尔逊悖论可以说是[罗素悖论](/zh-cn/p/russells-paradox/)在语义学（词语意义）上的版本。

集合论中的[罗素悖论](/zh-cn/p/russells-paradox/)：
$$ R = \\{ x \mid x \notin x \\} $$
