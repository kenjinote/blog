...
このパラドックスは、「[消えた1ドルの謎](/p/missing-dollar/)」のような単純な計算ミスや錯覚ではありません。数学の基礎を揺るがした **[ラッセルのパラドックス](/p/russells-paradox/)** （「自分自身を含まないすべての集合の集合は、自分自身を含むか？」）と本質的に同じ構造を持っています。

グレリング＝ネルソンのパラドックスは、[ラッセルのパラドックス](/p/russells-paradox/)の意味論（言葉の意味）バージョンとも言えます。

集合論における[ラッセルのパラドックス](/p/russells-paradox/)：
$$ R = \\{ x \mid x \notin x \\} $$
