...
這個悖論並非像「消失的一元謎題」那種簡單的計算錯誤或錯覺。它與動搖了數學基礎的 **[羅素悖論](/zh-tw/p/russells-paradox/)** （「所有不包含自身的集合所組成的集合，是否包含其自身？」）在本質上具有相同的結構。

格雷林-納爾遜悖論可以說是[羅素悖論](/zh-tw/p/russells-paradox/)的語義學（詞語含義）版本。

集合論中的[羅素悖論](/zh-tw/p/russells-paradox/)：
$$ R = \{ x \mid x \notin x \} $$
