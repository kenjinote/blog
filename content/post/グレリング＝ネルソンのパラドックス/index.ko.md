...
이 역설은 ['사라진 1달러의 수수께끼](https://kenji.blog/ko/p/消えた1ドルの謎/)'와 같은 단순한 계산 실수나 착각이 아닙니다. 수학의 기초를 뒤흔든 **[러셀의 역설](/ko/p/russells-paradox/)**('자기 자신을 포함하지 않는 모든 집합의 집합은 자기 자신을 포함하는가?')과 본질적으로 같은 구조를 가지고 있습니다.

그렐링-넬슨의 역설은 [러셀의 역설](/ko/p/russells-paradox/)의 의미론(단어의 의미) 버전이라고도 할 수 있습니다.

집합론에서의 [러셀의 역설](/ko/p/russells-paradox/):
$$ R = \\{ x \mid x \notin x \\} $$
