...
इन सिस्टम्स को **"नेविगेशनल (Navigational)"** कहा जाता था। डेटा के बीच के संबंध भौतिक [पॉइंटर्स](/hi/p/c-language-pointers-memory-management-stack-heap/) (मेमोरी एड्रेस के संदर्भ) द्वारा हार्ड-कोड किए गए थे, और डेटा प्राप्त करने के लिए प्रोग्रामर को स्वयं भौतिक संरचना के बारे में सचेत रहना पड़ता था और "पैरेंट रिकॉर्ड से चाइल्ड रिकॉर्ड तक पॉइंटर को फॉलो करते हुए आगे बढ़ें" जैसा प्रक्रियात्मक कोड लिखना पड़ता था।

### नेविगेशनल डेटाबेस की घातक समस्याएं

1. **डेटा स्वतंत्रता का अभाव (Lack of Data Independence)**
   भौतिक डेटा संरचना (इंडेक्स की उपस्थिति या अनुपस्थिति, [पॉइंटर्स](/hi/p/c-language-pointers-memory-management-stack-heap/) को कैसे सेट किया गया है, आदि) एप्लिकेशन कोड के साथ बहुत करीब से जुड़े हुए थे (Tightly coupled)। इसलिए, अगर डेटाबेस की संरचना में थोड़ा सा भी बदलाव किया जाता, तो उस पर निर्भर सभी एप्लिकेशन कोड को फिर से लिखना पड़ता था।
...
NoSQL ने उन क्षेत्रों को कवर किया जिनमें रिलेशनल डेटाबेस कमजोर थे, जैसे कि स्केलेबिलिटी (हॉरिजॉन्टल डिस्ट्रीब्यूशन, शार्डिंग) और स्कीमा-रहित होने के कारण विकास की गति में सुधार। इसके अलावा, JSON दस्तावेज़ों को सीधे सहेजने की क्षमता [ऑब्जेक्ट-ओरिएंटेड प्रोग्रामिंग](/hi/p/object-oriented-programming-oop-solid-principles/) भाषाओं (इम्पीडेंस मिसमैच को हल करना) के साथ अनुकूलता में लाभप्रद थी।
