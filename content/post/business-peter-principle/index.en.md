...
```mermaid
flowchart TD
    A["New Employee"] -- "Promoted because competent" --> B["Mid-level Employee (Practitioner)"]
    B -- "Promoted because competent" --> C["Team Leader"]
    C -- "Lack of management ability exposed" --> D["Reached incompetence level (Promotion stops)"]
    
    style D fill:#f99,stroke:#333,stroke-width:2px
    
    E["Actual work of the organization"] -- "Supported by" --> B
    E -- "Supported by" --> C
```
...
```mermaid
flowchart LR
    A["Young Employee"] --> B["Mid-level Employee"]
    
    B -- "Has management aptitude" --> C["Management Route (Manager)"]
    C --> D["Executive / Management Board"]
    
    B -- "Specializes in technical skills" --> E["Specialist Route (Specialist)"]
    E --> F["Fellow / Executive Engineer"]
    
    style C fill:#d4edda,stroke:#28a745
    style E fill:#cce5ff,stroke:#007bff
    
    C -. "Equal reward and authority" .- E
```
