...
```mermaid
flowchart TD
    A["Karyawan Baru"] -- "Kompeten, maka dipromosikan" --> B["Karyawan Menengah (Staf Praktis)"]
    B -- "Kompeten, maka dipromosikan" --> C["Pemimpin Tim"]
    C -- "Kurangnya kemampuan manajemen terungkap" --> D["Mencapai tingkat ketidakmampuan (Promosi berhenti)"]
    
    style D fill:#f99,stroke:#333,stroke-width:2px
    
    E["Pekerjaan aktual organisasi"] -- "Didukung oleh" --> B
    E -- "Didukung oleh" --> C
```
...
```mermaid
flowchart LR
    A["Karyawan Muda"] --> B["Karyawan Menengah"]
    
    B -- "Ada bakat manajemen" --> C["Jalur Manajemen (Manajer)"]
    C --> D["Eksekutif / Manajemen Puncak"]
    
    B -- "Fokus pada keterampilan khusus" --> E["Jalur Spesialis"]
    E --> F["Fellow / Insinyur Eksekutif"]
    
    style C fill:#d4edda,stroke:#28a745
    style E fill:#cce5ff,stroke:#007bff
    
    C -. "Kompensasi & Otoritas Setara" .- E
```
