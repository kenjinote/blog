---
title: "Absoluter Geist und Dialektik: Das Leben und die Philosophie von Georg Wilhelm Friedrich Hegel"
...
```mermaid
graph TD
    A["These"] --> C["Synthese (Aufheben)"]
    B["Antithese"] --> C
    C --> D["Neue These (Zu einem höheren Zustand)"]
    D -.-> E["Dialektische Entwicklung"]
```
...
```mermaid
graph TD
    Hegel["Hegels philosophisches System"]
    Hegel --> Right["Hegelsche Rechte (Althegelianer)"]
    Hegel --> Left["Hegelsche Linke (Junghegelianer)"]
    Right --> Conservative["Verteidigung des Staates und Rechtfertigung der Religion"]
    Left --> Critical["Religionskritik und Systemkritik"]
    Left --> Feuerbach["Feuerbach (Anthropologie, Materialismus)"]
    Feuerbach --> Marx["Karl Marx (Historischer Materialismus, Marxismus)"]
    Marx --> ModernHistory["Sozialistische Bewegungen des 20. Jahrhunderts, Modernes Denken"]
    Hegel --> Existentialism["Existenzialistische Kritik durch Kierkegaard und andere"]
```
