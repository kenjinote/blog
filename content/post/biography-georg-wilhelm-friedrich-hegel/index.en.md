---
title: "Absolute Spirit and Dialectics: The Life and Philosophy of Georg Wilhelm Friedrich Hegel"
...
```mermaid
graph TD
    A["Thesis"] --> C["Synthesis (Aufheben)"]
    B["Antithesis"] --> C
    C --> D["New Thesis (To a higher state)"]
    D -.-> E["Dialectical Development"]
```
...
```mermaid
graph TD
    Hegel["Hegel's Philosophical System"]
    Hegel --> Right["Right Hegelians (Old Hegelians)"]
    Hegel --> Left["Left Hegelians (Young Hegelians)"]
    Right --> Conservative["Defense of State System / Justification of Religion"]
    Left --> Critical["Critique of Religion / Critique of the System"]
    Left --> Feuerbach["Feuerbach (Anthropology / Materialism)"]
    Feuerbach --> Marx["Karl Marx (Historical Materialism / Marxism)"]
    Marx --> ModernHistory["20th Century Socialist Movements / Modern Thought"]
    Hegel --> Existentialism["Existentialist Critique by Kierkegaard and Others"]
```
