---
title: "El Espíritu Absoluto y la Dialéctica: Vida y Filosofía de Georg Wilhelm Friedrich Hegel"
...
```mermaid
graph TD
    A["Tesis"] --> C["Síntesis (Aufheben)"]
    B["Antítesis"] --> C
    C --> D["Nueva Tesis (Hacia un estado superior)"]
    D -.-> E["Desarrollo dialéctico"]
```
...
```mermaid
graph TD
    Hegel["Sistema filosófico de Hegel"]
    Hegel --> Right["Derecha hegeliana (Viejos hegelianos)"]
    Hegel --> Left["Izquierda hegeliana (Jóvenes hegelianos)"]
    Right --> Conservative["Defensa del sistema estatal y justificación de la religión"]
    Left --> Critical["Crítica de la religión y del sistema"]
    Left --> Feuerbach["Feuerbach (Antropología y materialismo)"]
    Feuerbach --> Marx["Karl Marx (Materialismo histórico y marxismo)"]
    Marx --> ModernHistory["Movimiento socialista del siglo XX y pensamiento contemporáneo"]
    Hegel --> Existentialism["Crítica existencialista por Kierkegaard y otros"]
```
