---
title: "Espírito Absoluto e Dialética: A Vida e Filosofia de Georg Wilhelm Friedrich Hegel"
...
```mermaid
graph TD
    A["Tese"] --> C["Síntese (Aufheben)"]
    B["Antítese"] --> C
    C --> D["Nova Tese (Para um estado superior)"]
    D -.-> E["Desenvolvimento Dialético"]
```
...
graph TD
    ...
    Hegel --> Right["Hegelianos de Direita"]
    Hegel --> Left["Hegelianos de Esquerda"]
    Right --> Conservative["Defesa do Sistema Estatal e Justificação da Religião"]
    Left --> Critical["Crítica da Religião e do Sistema"]
    Left --> Feuerbach["Feuerbach (Antropologia, Materialismo)"]
    Feuerbach --> Marx["Karl Marx (Materialismo Histórico, Marxismo)"]
    Marx --> ModernHistory["Movimento Socialista do Século XX, Pensamento Moderno"]
    Hegel --> Existentialism["Crítica Existencialista de Kierkegaard e outros"]
```
