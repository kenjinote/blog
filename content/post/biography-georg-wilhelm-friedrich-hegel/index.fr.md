...
```mermaid
graph TD
    A["Thèse"] --> C["Synthèse (Aufheben)"]
    B["Antithèse"] --> C
    C --> D["Nouvelle thèse (vers un état supérieur)"]
    D -.-> E["Développement dialectique"]
```
...
```mermaid
graph TD
    Hegel["Système philosophique de Hegel"]
    Hegel --> Right["Droite hégélienne (Vieux hégéliens)"]
    Hegel --> Left["Gauche hégélienne (Jeunes hégéliens)"]
    Right --> Conservative["Défense du système étatique et justification de la religion"]
    Left --> Critical["Critique de la religion et du système"]
    Left --> Feuerbach["Feuerbach (Anthropologie et matérialisme)"]
    Feuerbach --> Marx["Karl Marx (Matérialisme historique et marxisme)"]
    Marx --> ModernHistory["Mouvements socialistes du 20e siècle et pensée contemporaine"]
    Hegel --> Existentialism["Critique existentialiste par Kierkegaard et d'autres"]
```
