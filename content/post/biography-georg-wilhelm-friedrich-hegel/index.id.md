---
title: "Roh Absolut dan Dialektika: Kehidupan dan Filsafat Georg Wilhelm Friedrich Hegel"
...
```mermaid
graph TD
    A["Tesis"] --> C["Sintesis (Aufheben)"]
    B["Antitesis"] --> C
    C --> D["Tesis Baru (Menuju keadaan yang lebih tinggi)"]
    D -.-> E["Perkembangan Dialektis"]
```
...
```mermaid
graph TD
    Hegel["Sistem Filsafat Hegel"]
    Hegel --> Right["Hegelian Kanan"]
    Hegel --> Left["Hegelian Kiri"]
    Right --> Conservative["Pembelaan Sistem Negara dan Pembenaran Agama"]
    Left --> Critical["Kritik Agama dan Sistem"]
    Left --> Feuerbach["Feuerbach (Antropologi, Materialisme)"]
    Feuerbach --> Marx["Karl Marx (Materialisme Historis, Marxisme)"]
    Marx --> ModernHistory["Gerakan Sosialis Abad ke-20, Pemikiran Modern"]
    Hegel --> Existentialism["Kritik Eksistensialis oleh Kierkegaard dan lainnya"]
```
