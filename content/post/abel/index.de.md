...
# 1. Einführung: Das junge Genie [Abel](https://kenji.blog/de/p/abel/)
...
Im Jahr 1825 erhielt [Abel](https://kenji.blog/de/p/abel/) ein Stipendium der norwegischen Regierung und hatte die Möglichkeit, auf dem europäischen Festland zu studieren. Sein Ziel war es, Paris, das damalige Zentrum der Mathematik, und Göttingen zu besuchen, wo der große Mathematiker [Carl Friedrich Gauss](https://kenji.blog/de/p/gauss/) lebte.

[Abel](https://kenji.blog/de/p/abel/) schickte seine Arbeit an Gauss, aber Gauss ignorierte sie, ohne sie überhaupt zu lesen. Da er die Hoffnung aufgab, Gauss zu treffen, reiste [Abel](https://kenji.blog/de/p/abel/) nach Berlin.

In Berlin lernte er **August Leopold Crelle** kennen, einen Bauingenieur und leidenschaftlichen Mathematik-Enthusiasten. Beeindruckt von [Abel](https://kenji.blog/de/p/abel/)s Talent, startete Crelle die weltweit erste spezialisierte Mathematikzeitschrift, *Journal für die reine und angewandte Mathematik* (allgemein bekannt als Crelles Journal). [Abel](https://kenji.blog/de/p/abel/) trug mit mehreren Arbeiten zur Erstausgabe bei und machte seinen Namen in der europäischen mathematischen Gemeinschaft bekannt.

# 5. Rückschlag in Paris und [Cauchy](https://kenji.blog/de/p/cauchy/)s Nachlässigkeit

1826 kam [Abel](https://kenji.blog/de/p/abel/) in Paris an. Hier reichte er der Französischen Akademie der Wissenschaften eine Arbeit über ein „Umfassendes Theorem über transzendente Funktionen“ ein, die als sein Meisterwerk angesehen werden könnte. Diese Arbeit enthielt bahnbrechende Inhalte, die später als **[Abel](https://kenji.blog/de/p/abel/)sches Theorem** bekannt wurden.

Das Unglück schlug jedoch erneut zu. Der große Mathematiker **[Augustin-Louis Cauchy](https://kenji.blog/de/p/cauchy/)**, der mit der Überprüfung beauftragt wurde, verlegte [Abel](https://kenji.blog/de/p/abel/)s Arbeit in einem Stapel von Dokumenten in seinem Zimmer und überprüfte sie nie.

Getrieben von Verzweiflung, Geldmangel und der fortschreitenden Tuberkulose, war [Abel](https://kenji.blog/de/p/abel/) gezwungen, Paris zu verlassen.

# 6. Rückkehr in die Heimat und tragisches Ende

Im Jahr 1827 erwartete [Abel](https://kenji.blog/de/p/abel/) bei seiner Rückkehr nach Norwegen extreme Armut. Da er keine feste akademische Position finden konnte, schrieb er in der kurzen Zeit, die ihm noch blieb, verzweifelt an weiteren Arbeiten.

Am 6. April 1829 verstarb [Abel](https://kenji.blog/de/p/abel/) im Beisein seiner Verlobten und seiner Freunde im jungen Alter von 26 Jahren.

Tragischerweise traf nur zwei Tage nach seinem Tod ein Brief von Crelle ein. Darin stand, dass **für [Abel](https://kenji.blog/de/p/abel/) eine Mathematikprofessur an der Universität Berlin gesichert worden war**. Bis sein Talent die verdiente Anerkennung fand, war es bereits zu spät.

# 7. [Abel](https://kenji.blog/de/p/abel/)s mathematisches Erbe

Die Errungenschaften, die [Abel](https://kenji.blog/de/p/abel/) hinterließ, haben in allen Bereichen der modernen Mathematik Wurzeln geschlagen.

## 7.1 [Abel](https://kenji.blog/de/p/abel/)sche Gruppe

In der abstrakten Algebra ist eine der grundlegendsten und wichtigsten Strukturen die „Gruppe“. Unter den Gruppen werden diejenigen, bei denen sich das Ergebnis nicht ändert, auch wenn die Reihenfolge der Operationen vertauscht wird, **[Abel](https://kenji.blog/de/p/abel/)sche Gruppen** genannt.

Per Definition wird eine Gruppe $G$ als [Abel](https://kenji.blog/de/p/abel/)sche Gruppe bezeichnet, wenn das folgende Kommutativgesetz für alle Elemente $a, b$ in $G$ gilt:

$$ a * b = b * a \quad (\text{Kommutativgesetz}) $$

```mermaid
flowchart LR
    A["Gruppe"] --> B{"Gilt das Kommutativgesetz?"}
    B -- "Ja: a*b = b*a" --> C["Abelsche Gruppe"]
    B -- "Nein: a*b ≠ b*a" --> D["Nicht-Abelsche Gruppe"]
    
    C --> E["Beispiel: Ganze Zahlen mit Addition"]
    D --> F["Beispiel: Matrizenmultiplikation"]
```
...
[Abel](https://kenji.blog/de/p/abel/) hinterließ auch im Bereich der Analysis bedeutende Spuren. Es ist ein Satz bezüglich der Konvergenz unendlicher Reihen.
