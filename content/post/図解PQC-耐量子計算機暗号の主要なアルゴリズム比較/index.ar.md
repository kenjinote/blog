...
2. **التوقيعات الرقمية ([Digital Signature](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)s)**: آلية لإثبات عدم تلاعب البيانات، وعدم انتحال هوية المرسل (الموثوقية)، وذلك في تحديثات البرامج والشهادات الرقمية.
...
1. **التشفير الشبكي (Lattice-based [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy)**:
...
2. **التشفير المبني على التجزئة (Hash-based [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy)**:
...
3. **التشفير المبني على الأكواد (Code-based [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy)**:
...
4. **تشفير متعدد الحدود متعدد المتغيرات (Multivariate Polynomial [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy)**:
...
5. **التشفير المبني على التماثلات (Isogeny-based [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy)**:
...
في عصر PQC، بدلاً من النهج المباشر كما في [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) حيث "يقوم العميل بإنشاء مفتاح مشترك وتشفيره بالمفتاح العام للخادم وإرساله"، سيصبح إطار عمل التغليف المعروف باسم KEM هو المعيار.
...
أكبر نقطة قوة لـ Kyber هي **سرعة المعالجة ** الفائقة و** حجم المفتاح المعتدل**. في حالة Kyber768، يبلغ حجم المفتاح العام 1,184 بايت، وحجم النص المشفر 1,088 بايت. وعلى الرغم من أنها أكبر مقارنةً بـ [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)-3072 (حجم المفتاح حوالي 384 بايت)، إلا أنه يمكن تضمينها ضمن وحدة الإرسال القصوى (MTU) لاتصالات الإنترنت الحديثة دون تجزئة الحزم، مما لا يؤثر تقريباً على زمن انتقال الشبكة.
...
النهج الواقعي والموصى به لتقليل مخاطر عدم اليقين هذه هو "**التشفير الهجين (Hybrid [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy)**".
...
graph TD
    ...
    B --> C
    C -->|"#quot;المدخلات: (المفتاح المشترك لـ X25519)#quot;#124;#124; (المفتاح المشترك لـ Kyber)"| D["مفتاح اتصال آمن (AES-256 / ChaCha20)"]
...
بالإضافة إلى ذلك، في تصميم النظام، أصبح مفهوم **مرونة التشفير ([Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/) Agility)** - وهو بناء "هيكل لا يعتمد بشكل مفرط على خوارزمية تشفير معينة، ويمكنه التبديل بسرعة إلى خوارزمية أخرى (على سبيل المثال من Kyber إلى McEliece، أو من Dilithium إلى SPHINCS+) عند فشل الخوارزمية" - متطلباً أساسياً في تطوير الأنظمة المستقبلية.
...
---
*References:*
* *NIST Post-Quantum [Crypto](https://kenji.blog/ar/p/cryptocurrency-and-bitcoin/)graphy Standardization Program*
* *FIPS 203: Module-Lattice-Based Key-Encapsulation Mechanism Standard*
* *FIPS 204: Module-Lattice-Based [Digital Signature](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) Standard*
