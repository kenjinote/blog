...
title: "Der Mann, der aus der Frühzeit des Internets die Zukunft gestaltet: Leben und Philosophie von Marc Andreessen"
slug: "biography-marc-andreessen"
description: "Eine Person, die das moderne Internet zu einer Selbstverständlichkeit gemacht hat und die Welt weiterhin formt, indem sie riesige Geldsummen in die Zukunft"
---
...
```mermaid
flowchart TD
    UIUC["Universität von Illinois"] --> Mosaic["NCSA Mosaic (1993)"]
    Mosaic --> Netscape["Netscape (1994)"]
    Netscape --> IPO["Netscape Börsengang (1995)"]
    IPO --> BrowserWars["Browserkrieg vs. Microsoft"]
    BrowserWars --> Loudcloud["Loudcloud / Opsware (1999)"]
    Loudcloud --> a16z["Andreessen Horowitz - a16z (2009)"]
    a16z --> Philosophy1["Software frisst die Welt (2011)"]
    a16z --> Philosophy2["Techno-Optimismus (2023)"]
```
