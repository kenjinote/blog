...
```mermaid
flowchart TD
    UIUC["Université de l'Illinois"] --> Mosaic["NCSA Mosaic (1993)"]
    Mosaic --> Netscape["Netscape (1994)"]
    Netscape --> IPO["Introduction en bourse de Netscape (1995)"]
    IPO --> BrowserWars["Guerre des navigateurs contre Microsoft"]
    BrowserWars --> Loudcloud["Loudcloud / Opsware (1999)"]
    Loudcloud --> a16z["Andreessen Horowitz - a16z (2009)"]
    a16z --> Philosophy1["Le logiciel dévore le monde (2011)"]
    a16z --> Philosophy2["Techno-Optimisme (2023)"]
```
...
Sa vie n'est pas seulement une histoire de réussite. C'est l'histoire de l'acharnement d'un "bâtisseur" (builder) qui découvre rapidement la valeur des technologies inconnues, les popularise et continue de mettre à jour la société dans son ensemble. Les graines qu'il a semées continuent de germer aujourd'hui dans les bureaux des startups du monde entier ou dans les communautés open source. Son attitude, qui incarne l'idée que "[la meilleure façon de prédire l'avenir est de l'inventer](/fr/p/biography-alan-kay/)", continuera d'inspirer la prochaine génération d'entrepreneurs.
