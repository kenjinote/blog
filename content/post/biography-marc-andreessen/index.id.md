...
```mermaid
flowchart TD
    UIUC["Universitas Illinois"] --> Mosaic["NCSA Mosaic (1993)"]
    Mosaic --> Netscape["Netscape (1994)"]
    Netscape --> IPO["IPO Netscape (1995)"]
    IPO --> BrowserWars["Perang Peramban vs Microsoft"]
    BrowserWars --> Loudcloud["Loudcloud / Opsware (1999)"]
    Loudcloud --> a16z["Andreessen Horowitz - a16z (2009)"]
    a16z --> Philosophy1["Perangkat lunak memakan dunia (2011)"]
    a16z --> Philosophy2["Tekno-Optimisme (2023)"]
```
