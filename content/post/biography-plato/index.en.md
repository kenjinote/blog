---
title: "The Life and Philosophy of Plato: The Great Thinker Who Laid the Foundations of Western Thought"
...
Plato (c. 427 BC - c. 347 BC) was born into a powerful aristocratic family in Athens. In his youth, he aspired to become a politician, but his life was decisively altered by his encounter with the philosopher [Socrates](/en/p/biography-socrates/). Deeply impressed by [Socrates](/en/p/biography-socrates/)' thoughts and way of life, Plato became his devoted student.

However, in 399 BC, his teacher [Socrates](/en/p/biography-socrates/) was tried in an Athenian popular court on charges of "corrupting the youth and not believing in the gods of the state," and was sentenced to death. This absurd event was an immeasurable shock to the young Plato. Acutely aware of the limitations of democracy (which he viewed as mob rule at the time), he abandoned his path in politics and resolved to pursue philosophy to seek true justice.

Following the death of [Socrates](/en/p/biography-socrates/), Plato traveled to places like Egypt and Italy, learning mathematics and religious doctrines from the Pythagoreans. Returning to Athens around 387 BC, he founded the "Academy". This is often considered the first institution of higher learning in Western history, and it later gathered many brilliant scholars, including Aristotle, contributing greatly to the advancement of learning.
...
```mermaid
graph TD
    S["Socrates (Teacher)"] -->|Dialogue Method / Ethical Inquiry| P["Plato"]
    P -->|Theory of Forms / Philosopher King| A["Aristotle (Student)"]
    P -->|Establishment| AC["Academy (School)"]
    AC -->|Academic Inquiry| A
    P -.->|Influence on Posterity| NP["Neoplatonism (Plotinus, etc.)"]
    NP -.->|Ideological Influence| CT["Christian Theology (Augustine, etc.)"]
    P -.->|Ideological Influence| MP["Modern Philosophy (Descartes, Kant, etc.)"]
```
