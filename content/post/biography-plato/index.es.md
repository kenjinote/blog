---
title: "La vida y filosofía de Platón: el gran pensador que sentó las bases del pensamiento occidental"
...
```mermaid
graph TD
    S["Sócrates (Maestro)"] -->|Diálogo e indagación ética| P["Platón"]
    P -->|Teoría de las Ideas y el Rey Filósofo| A["Aristóteles (Discípulo)"]
    P -->|Fundación| AC["Academia (Escuela)"]
    AC -->|Indagación académica| A
    P -.->|Influencia en la posteridad| NP["Neoplatonismo (Plotino, etc.)"]
    NP -.->|Influencia ideológica| CT["Teología Cristiana (Agustín, etc.)"]
    P -.->|Influencia ideológica| MP["Filosofía Moderna (Descartes, Kant, etc.)"]
```
