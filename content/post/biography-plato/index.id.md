---
title: "Kehidupan dan Filsafat Plato: Pemikir Besar yang Meletakkan Dasar Pemikiran Barat"
...
```mermaid
graph TD
    S["Sokrates (Guru)"] -->|Metode Dialog / Penyelidikan Etis| P["Plato"]
    P -->|Teori Bentuk / Raja Filsuf| A["Aristoteles (Murid)"]
    P -->|Pendirian| AC["Akademi (Sekolah)"]
    AC -->|Penyelidikan Akademik| A
    P -.->|Pengaruh pada Anak Cucu| NP["Neoplatonisme (Plotinus, dll.)"]
    NP -.->|Pengaruh Ideologis| CT["Teologi Kristen (Agustinus, dll.)"]
    P -.->|Pengaruh Ideologis| MP["Filsafat Modern (Descartes, Kant, dll.)"]
```
