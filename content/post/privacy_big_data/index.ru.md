...
### 2.2 Дифференциальная приватность (Differential Privacy: [DP](https://kenji.blog/ru/p/dynamic-programming-dp-introduction-knapsack-fibonacci/))
...
Гомоморфное шифрование делится на «частично гомоморфное шифрование» (Partially Homomorphic Encryption: PHE), которое позволяет выполнять только сложение или только умножение, и «полностью гомоморфное шифрование» (Fully Homomorphic Encryption: [FHE](/ru/p/fully-homomorphic-encryption-fhe-explained/)), которое позволяет выполнять и сложение, и умножение бесконечное число раз. С тех пор как в 2009 году Крейг Джентри построил первую схему [FHE](/ru/p/fully-homomorphic-encryption-fhe-explained/) с использованием криптографии на решетках ([Lattice-based cryptography](/ru/p/lattice-based-cryptography-math-intuition/)), это стало большим прорывом в криптографии.
