...
हालाँकि, वितरित सिस्टम (distributed systems) के निर्माण और संचालन में, इंजीनियरों को हमेशा एक कठिन विकल्प का सामना करना पड़ता है। यह "डेटा की निरंतरता (Consistency)" और "सिस्टम की उपलब्धता (Availability)" के बीच का ट्रेड-ऑफ है। इस अंतर्निहित दुविधा को गणितीय रूप से साबित करने और तैयार करने वाले को **CAP प्रमेय** (CAP theorem) कहा जाता है।
...
CAP प्रमेय पर चर्चा करने से पहले, आइए स्पष्ट करें कि **वितरित सिस्टम** (Distributed System) वास्तव में क्या है।
...
2.  **उपलब्धता (Availability)** : भले ही कुछ नोड्स विफल हो जाएं, अन्य नोड्स प्रसंस्करण जारी रखते हैं, यह सुनिश्चित करते हुए कि सिस्टम समग्र रूप से सेवा प्रदान करना जारी रखे।
...
1.  **C: Consistency** (निरंतरता/सुसंगति)
2.  **A: Availability** (उपलब्धता)
3.  **P: Partition Tolerance** (विभाजन सहनशीलता)
...
कई वितरित डेटाबेस (जैसे: Cassandra, DynamoDB आदि) पूरे सिस्टम को निश्चित CP या AP से बांधने के बजाय, प्रत्येक अनुरोध के लिए **Quorum** (कोरम) का उपयोग करके मापदंडों को समायोजित करके C और A के बीच संतुलन बनाने की अनुमति देते हैं।
...
*   $ W=1, R=1 $ सेट करने पर यह तेज़ और अत्यधिक उपलब्ध हो जाता है, लेकिन आप पुराना डेटा पढ़ सकते हैं (AP प्रकार, Eventual Consistency)।
...
*   **PA/EL** (Cassandra, Riak, DynamoDB)
    *   विभाजन के दौरान उपलब्धता को प्राथमिकता (PA)। सामान्य समय में कम विलंबता को प्राथमिकता, और Eventual Consistency (अंतिम सुसंगति) स्वीकार्य (EL)।
...
यह वितरित वातावरण में डेटा असंगति को गणितीय और एल्गोरिथम रूप से पूरी तरह से समाप्त कर देता है। `etcd`, जो Kubernetes का बैकएंड डेटास्टोर है, क्लस्टर के सख्त स्थिति प्रबंधन को प्राप्त करने के लिए भी इस [Raft](https://kenji.blog/hi/p/byzantine-generals-problem-consensus/) को अपनाता है।
...
मोनोलिथिक अनुप्रयोगों (Monolithic applications) में, एकल रिलेशनल डेटाबेस का उपयोग करके ACID ट्रांजैक्शन के साथ डेटा सुसंगति बनाए रखना आसान था। हालाँकि, माइक्रोसर्विसेज में, जहाँ प्रत्येक व्यावसायिक डोमेन के लिए सेवाओं और डेटाबेस को विभाजित किया जाता है, सेवाओं में फैले वितरित लेनदेन (distributed transactions) की आवश्यकता होती है।
...
Saga पैटर्न एक बड़ी ट्रांजैक्शन को स्थानीय ट्रांजैक्शन की श्रृंखला में विभाजित करने और उन्हें अतुल्यकालिक मैसेजिंग (जैसे Kafka या RabbitMQ) का उपयोग करके लिंक करने की एक विधि है।
...
Saga पैटर्न में, मजबूत सुसंगति को छोड़ दिया जाता है और **Eventual Consistency (अंतिम सुसंगति)** को स्वीकार किया जाता है (AP दृष्टिकोण)। यदि बीच में कोई प्रक्रिया विफल हो जाती है, तो हम रोलबैक के बजाय एक **क्षतिपूर्ति ट्रांजैक्शन (Compensating Transaction)** जारी करते हैं, जो तार्किक रूप से स्थिति को वापस लाने के लिए लॉजिक लागू करता है। यह उच्च स्केलेबिलिटी और उपलब्धता को बनाए रखते हुए व्यवसाय के लिए स्वीकार्य सुसंगति का स्तर प्राप्त करता है।

## निष्कर्ष

इस लेख में, हमने वितरित प्रणालियों में सबसे महत्वपूर्ण सिद्धांत, CAP प्रमेय में गहराई से गोता लगाया।

*   **CAP प्रमेय** दर्शाता है कि किसी वितरित प्रणाली के लिए Consistency (सुसंगति), Availability (उपलब्धता) और Partition Tolerance (विभाजन सहनशीलता) तीनों को एक ही समय में संतुष्ट करना असंभव है, और वास्तविकता में जहाँ विभाजन (P) अपरिहार्य है, यह प्रभावी रूप से **CP** या **AP** का विकल्प है।
