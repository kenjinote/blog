...
これにより、分散環境におけるデータの不整合を数学的・アルゴリズム的に完全に排除しています。Kubernetesのバックエンドデータストアである `etcd` も、この[Raft](https://kenji.blog/p/byzantine-generals-problem-consensus/)を採用することで、クラスタの厳密な状態管理を実現しています。
