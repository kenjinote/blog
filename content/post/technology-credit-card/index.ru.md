...
После ужина в ресторане, когда вы вставляете кредитную карту в [терминал](/ru/p/terminal-efficiency-powershell-bash-shortcuts/) и вводите ПИН-код, уже через несколько секунд появляется сообщение «одобрено» (платеж завершен).
...
1. **Считывание карты**: [Терминал](/ru/p/terminal-efficiency-powershell-bash-shortcuts/) в магазине (терминалы CAT/CCT) считывает зашифрованные данные с чипа карты.
