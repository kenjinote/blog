...
في حالة ext4 الذي يميز بين الأحرف الكبيرة والصغيرة، تتم إدارة الإدخالات في الدليل باستخدام هياكل مثل جداول التجزئة (Hash Tables) أو أشجار B ([B-Tree](https://kenji.blog/ar/p/b-tree-database-index-theory/)s). بافتراض أن عدد الملفات في الدليل هو $N$، وطول اسم الملف هو $L$، فإن تعقيد الوقت للبحث الثنائي البسيط أو البحث في الشجرة سيكون على النحو التالي:
