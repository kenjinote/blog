...
대소문자를 구분하는 ext4의 경우, 디렉토리 내의 항목은 해시 테이블이나 [B-Tree](https://kenji.blog/ko/p/b-tree-database-index-theory/) 등의 구조로 관리됩니다. 디렉토리 내 파일 수를 $N$, 파일 이름의 길이를 $L$이라고 할 때, 단순한 이진 탐색이나 트리 탐색의 경우 계산 복잡도는 다음과 같습니다.
