...
हालांकि, जब इस कोड को कमिट किया जाता है और [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) सर्वर (आमतौर पर Ubuntu जैसे लिनक्स) पर बिल्ड निष्पादित किया जाता है, तो लिनक्स का ext4 फ़ाइल सिस्टम केस-सेंसिटिव होने के कारण "फ़ाइल नहीं मिली" (File not found) संकलन त्रुटि (compile error) देगा।
...
केस-सेंसिटिव ext4 के मामले में, निर्देशिका (directory) के भीतर प्रविष्टियों (entries) को हैश टेबल या [B-Tree](https://kenji.blog/hi/p/b-tree-database-index-theory/) जैसी संरचनाओं में प्रबंधित किया जाता है। यदि निर्देशिका में फ़ाइलों की संख्या $N$ है और फ़ाइल नाम की लंबाई $L$ है, तो सरल बाइनरी सर्च या ट्री ट्रैवर्सल की गणना जटिलता (computational complexity) निम्न प्रकार होगी:
...
C++ या [Rust](https://kenji.blog/hi/p/webassembly-wasm-current-future/) (भाषाएं जो सीधे मशीन कोड में संकलित होती हैं) जैसे नेटिव कोड से निपटते समय, आपको नल्पन केवल OS-विशिष्ट API बल्कि बिल्ड सिस्टम और कंपाइलरों के अंतर को भी दूर करने की आवश्यकता होती है।
...
## 8. [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) में क्रॉस-प्लेटफ़ॉर्म सत्यापन (मैट्रिक्स बिल्ड)
...
नवीनतम CI टूल जैसे [GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) और GitLab CI का लाभ उठाएं, और एक मैट्रिक्स बिल्ड (Matrix Build) सेट करें जो हर बार पुल रिक्वेस्ट (Pull Request) बनाए जाने पर **विंडोज़, macOS, और लिनक्स के सभी वातावरणों में समानांतर में बिल्ड और परीक्षण निष्पादित करता है** ।
...
इस [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) प्रवाह (flow) को विज़ुअलाइज़ करने पर यह इस प्रकार दिखता है:
...
5.  **पर्यावरण चर (Environment Variables) और शेल**: `cross-env` जैसे अमूर्तीकरण टूल का उपयोग करें, या निष्पादन वातावरण (execution environment) को WSL/[Docker](https://kenji.blog/hi/p/docker-container-namespace-[cgroups](https://kenji.blog/hi/p/docker-container-namespace-cgroups-layers/)-layers/) आदि में मानकीकृत करें।
...
8.  **[CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/)**: मैट्रिक्स बिल्ड लागू करें, सभी लक्षित OS पर स्वच्छ बिल्ड और परीक्षण को स्वचालित करें, और मानवीय निर्भरता (manual dependency) को खत्म करें।
