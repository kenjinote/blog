...
في خط أنابيب التصيير ثلاثي الأبعاد (Rendering [Pipeline](https://kenji.blog/ar/p/cicd-pipeline-github-actions-best-practices/))، يتم إجراء ضرب المصفوفات بشكل تسلسلي على مراحل لتحويل بيانات الرؤوس ثلاثية الأبعاد إلى إحداثيات شاشة ثنائية الأبعاد نهائية. لأن الفضاء هنا ثلاثي الأبعاد، يصبح نظام الإحداثيات المتجانسة رباعي الأبعاد $(x, y, z, 1)$، ويتم استخدام مصفوفات بحجم $4 \times 4$.
