...
紐曼早期成就中最重要的一項，是關於集合論公理化的研究。由格奧爾格·康托爾創立的集合論曾被寄予厚望作為數學的基礎，但卻面臨了羅素悖論等邏輯矛盾（悖論）。為了解決這個問題，恩斯特·策梅洛和阿道夫·弗蘭克爾等人構建了公理化集合論，但紐曼採取了另一種方法。

他引入了「類」（Class）的概念，透過嚴格區分普通集合與因為太大而不能成為集合的類（真類），巧妙地迴避了悖論。這一體系後來被保羅·伯奈斯和庫爾特·哥德爾改良，現在被稱為 **紐曼-伯奈斯-哥德爾集合論** （NBG集合論）。
