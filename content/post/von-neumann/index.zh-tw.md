...
紐曼早期成就中最重要的一項，是關於集合論公理化的研究。由[格奧爾格·康托爾](https://kenji.blog/zh-tw/p/cantor/)創立的集合論曾被寄予厚望作為數學的基礎，但卻面臨了[羅素悖論](/zh-tw/p/russells-paradox/)等邏輯矛盾（悖論）。為了解決這個問題，恩斯特·策梅洛和阿道夫·弗蘭克爾等人構建了公理化集合論，但紐曼採取了另一種方法。
...
晚年，紐曼對生命自繁殖機制的數學建模產生了濃厚興趣。他在同事斯塔尼斯拉夫·烏拉姆的建議下，構想出了 **元胞[自動機](/zh-tw/p/automata-formal-language-theory/)** 的概念，即將空間劃分為網格，每個網格根據一定規則改變狀態。
...
4. **《自複製[自動機](/zh-tw/p/automata-formal-language-theory/)理論》 (Theory of Self-Reproducing [Automata](https://kenji.blog/zh-tw/p/automata-formal-language-theory/), 1966)**
   由阿瑟·伯克斯編纂紐曼遺稿出版。
...
* **1948年** ：發表元胞[自動機](/zh-tw/p/automata-formal-language-theory/)理論和自複製機器構想。
* **1951年** ：就任美國數學學會主席。
