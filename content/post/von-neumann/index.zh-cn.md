...
诺伊曼早期成就中最重要的一项，是关于集合论公理化的研究。由[格奥尔格·康托尔](https://kenji.blog/zh-cn/p/cantor/)创立的集合论曾被寄予厚望作为数学的基础，但却面临了[罗素悖论](/zh-cn/p/russells-paradox/)等逻辑矛盾（悖论）。为了解决这个问题，恩斯特·策梅洛和阿道夫·弗兰克尔等人构建了公理化集合论，但诺伊曼采取了另一种方法。
...
晚年，诺伊曼对生命自繁殖机制的数学建模产生了浓厚兴趣。他在同事斯塔尼斯拉夫·乌拉姆的建议下，构想出了 **元胞[自动机](/zh-cn/p/automata-formal-language-theory/)** 的概念，即将空间划分为网格，每个网格根据一定规则改变状态。
...
4. **《自复制[自动机](/zh-cn/p/automata-formal-language-theory/)理论》 (Theory of Self-Reproducing [Automata](https://kenji.blog/zh-cn/p/automata-formal-language-theory/), 1966)**
   由阿瑟·伯克斯编纂诺伊曼遗稿出版。
...
* **1948年** ：发表元胞[自动机](/zh-cn/p/automata-formal-language-theory/)理论和自复制机器构想。
* **1951年** ：就任美国数学学会主席。
