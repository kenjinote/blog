...
ここで、$q_i$ は一般化座標、$\dot{q}_i$ は一般化速度です。この **[オイラー](https://kenji.blog/p/euler/)＝[ラグランジュ](https://kenji.blog/p/lagrange/)方程式** により、[ニュートン](https://kenji.blog/p/newton/)力学では複雑になる斜面や振り子などの束縛系の問題が、座標系の取り方に依存しない統一的な方法で解けるようになりました。
