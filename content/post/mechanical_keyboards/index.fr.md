...
[Pour les ingénieurs](https://kenji.blog/fr/p/エンジニア向け[プロンプトエンジニアリング](https://kenji.blog/fr/p/large-language-models-llm-transformer-prompt-engineering/)の基本と開発への応用/) qui utilisent beaucoup de raccourcis complexes (ex: `Ctrl + Shift + Alt + une touche quelconque`) dans des éditeurs comme Vim ou Emacs, un NKRO complet est une condition indispensable.
