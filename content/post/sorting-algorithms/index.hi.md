...
### 3.3 हीप सॉर्ट ([Heap](https://kenji.blog/hi/p/c-language-pointers-memory-management-stack-heap/) Sort)
...
| **हीप सॉर्ट ([Heap](https://kenji.blog/hi/p/c-language-pointers-memory-management-stack-heap/) Sort)** | $O(n \log n)$ | $O(n \log n)$ | $O(n \log n)$ | $O(1)$ | No | बाइनरी हीप। इन-प्लेस और मजबूत। |
