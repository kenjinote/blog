+++
title = "सॉर्टिंग एल्गोरिदम की संपूर्ण मार्गदर्शिका: बबल सॉर्ट से टिमसॉर्ट तक"
description = "प्रोग्रामिंग में सॉर्टिंग एल्गोरिदम की संपूर्ण व्याख्या। मूल से लेकर उन्नत तक सब कुछ कवर किया गया है।"
...
# सॉर्टिंग एल्गोरिदम की संपूर्ण मार्गदर्शिका: बबल सॉर्ट से टिमसॉर्ट तक

एल्गोरिदम और डेटा संरचनाएं कंप्यूटर विज्ञान का मूल बनाने वाले बहुत महत्वपूर्ण विषय हैं। इनमें से, "सॉर्टिंग (क्रमबद्ध करना)" एक बुनियादी ऑपरेशन है जो हर स्थिति में आवश्यक होता है, जैसे कि खोजना, डेटा समूहीकरण, और विज़ुअलाइज़ेशन। इस लेख में, हम शुरुआती लोगों द्वारा सीखे जाने वाले बुनियादी सॉर्टिंग एल्गोरिदम से लेकर आधुनिक प्रोग्रामिंग भाषाओं की मानक लाइब्रेरी में उपयोग किए जाने वाले उन्नत सॉर्टिंग एल्गोरिदम तक, उनके तंत्र, कार्यान्वयन, समय जटिलता, और उन्हें किन स्थितियों में उपयोग किया जाना चाहिए, इसके बारे में बहुत विस्तार से समझाएंगे।

## 1. सॉर्टिंग एल्गोरिदम का बुनियादी ज्ञान

सॉर्टिंग एल्गोरिदम सीखने से पहले, कुछ महत्वपूर्ण अवधारणाओं को समझना आवश्यक है जो एल्गोरिदम के मूल्यांकन मानदंड के रूप में काम करते हैं। इन्हें समझने से यह स्पष्ट हो जाएगा कि इतने सारे सॉर्टिंग एल्गोरिदम क्यों मौजूद हैं, और स्थिति के आधार पर आपको किसे चुनना चाहिए।

### 1.1 स्थिरता (Stability)

सॉर्टिंग एल्गोरिदम में **स्थिरता** (Stability) एक गुण है जो यह दर्शाता है कि सॉर्ट करने से पहले और बाद में समान मान वाले तत्वों का सापेक्ष क्रम संरक्षित रहता है या नहीं।

उदाहरण के लिए, मान लें कि छात्रों के टेस्ट स्कोर और नामों वाले डेटा की एक सूची है।
`[ (80 अंक, "व्यक्ति A"), (70 अंक, "व्यक्ति B"), (80 अंक, "व्यक्ति C") ]`
जब इसे अंकों के आरोही क्रम में सॉर्ट किया जाता है, तो एक स्थिर सॉर्टिंग एल्गोरिदम के साथ, यह हमेशा निम्न प्रकार होगा।
`[ (70 अंक, "व्यक्ति B"), (80 अंक, "व्यक्ति A"), (80 अंक, "व्यक्ति C") ]`
चूंकि "व्यक्ति A" मूल रूप से "व्यक्ति C" से पहले था, इसलिए समान 80 अंक होने पर भी "व्यक्ति A" को पहले रखा जाता है। इसे **स्थिर सॉर्ट** (Stable Sort) कहा जाता है।

दूसरी ओर, एक अस्थिर सॉर्टिंग एल्गोरिदम के मामले में, यह क्रम उलट सकता है और `(80 अंक, "व्यक्ति C"), (80 अंक, "व्यक्ति A")` बन सकता है। स्थिरता तब बहुत महत्वपूर्ण हो जाती है जब कई कुंजियों के साथ कई बार सॉर्ट किया जाता है (उदाहरण के लिए: पहले नाम से सॉर्ट करें, और फिर अंक से)।

### 1.2 इन-प्लेस (In-place) और आउट-ऑफ-प्लेस (Out-of-place)

यह एक वर्गीकरण है जो दर्शाता है कि एल्गोरिदम को निष्पादन के दौरान कितनी अतिरिक्त मेमोरी की आवश्यकता है।

*   **इन-प्लेस (In-place)**: यह एक ऐसा एल्गोरिदम है जो सॉर्ट करते समय इनपुट ऐरे को ही सीधे संशोधित करता है, और तत्वों की अदला-बदली आदि के लिए केवल निरंतर आकार ($O(1)$) या लघुगणकीय आकार ($O(\log n)$) की अतिरिक्त मेमोरी की आवश्यकता होती है। यह उन वातावरणों में उपयोगी है जहां मेमोरी सख्त रूप से सीमित होती है।
*   **आउट-ऑफ-प्लेस (Out-of-place)**: यह एक एल्गोरिदम है जिसे सॉर्ट करने के लिए इनपुट ऐरे के अलावा इनपुट आकार के आनुपातिक (उदाहरण के लिए $O(n)$) अतिरिक्त मेमोरी स्पेस की आवश्यकता होती है।

### 1.3 समय जटिलता (Time Complexity) और बिग ओ नोटेशन (Big O Notation)

एल्गोरिदम की दक्षता को दर्शाने के लिए, हम एसिम्प्टोटिक नोटेशन **बिग ओ नोटेशन** (Big O Notation) का उपयोग करते हैं।
सॉर्टिंग एल्गोरिदम में, हम मुख्य रूप से **समय जटिलता** (निष्पादन समय) और **स्थान जटिलता** (मेमोरी उपयोग) का मूल्यांकन करते हैं।

*   $O(1)$: निरंतर समय। डेटा की मात्रा पर निर्भर नहीं करता, हमेशा स्थिर रहता है।
*   $O(n)$: रैखिक समय। डेटा की मात्रा के अनुपात में बढ़ता है।
*   $O(n \log n)$: रैखिक लघुगणकीय समय। तुलना पर आधारित सॉर्टिंग एल्गोरिदम में सैद्धांतिक रूप से उच्चतम गति।
*   $O(n^2)$: द्विघात समय। जब डेटा की मात्रा दोगुनी हो जाती है, तो समय चौगुना हो जाता है; बड़े पैमाने के डेटा के लिए अनुपयुक्त है।

तुलना-आधारित सॉर्टिंग एल्गोरिदम (एक तकनीक जहां तत्वों की तुलना उनके आकार के आधार पर उन्हें सॉर्ट करने के लिए की जाती है) में, यह गणितीय रूप से सिद्ध हो चुका है कि सबसे खराब स्थिति की समय जटिलता की निचली सीमा $O(n \log n)$ होगी।

$$
\text{तुलनात्मक सॉर्ट की निचली सीमा} = \Omega(n \log n)
$$
...
1. **बुनियादी अवधारणाओं की समझ**: समय जटिलता (Big O Notation), इन-प्लेस/आउट-ऑफ-प्लेस, और स्थिरता जैसी अवधारणाएं केवल सॉर्टिंग ही नहीं बल्कि सभी एल्गोरिदम और डेटा संरचनाओं को डिजाइन करने का आधार हैं।
