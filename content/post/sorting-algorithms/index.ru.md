...
### 3.3 Пирамидальная сортировка ([Heap](https://kenji.blog/ru/p/c-language-pointers-memory-management-stack-heap/) Sort)
...
| **Пирамидальная сортировка ([Heap](https://kenji.blog/ru/p/c-language-pointers-memory-management-stack-heap/) Sort)** | $O(n \log n)$ | $O(n \log n)$ | $O(n \log n)$ | $O(1)$ | Нет (No) | Двоичная куча. In-place и надежная. |
