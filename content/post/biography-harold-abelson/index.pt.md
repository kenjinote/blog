---
title: "Harold Abelson: Gigante do Ensino de Programação e da Cultura Aberta"
...
graph TD
    ...
    A --> B["Ensino de Programação"]
    A --> C["Cultura Aberta e Compartilhamento de Informações"]

    B --> B1["Popularização da Linguagem Logo (Anos 1980)"]
    B --> B2["SICP (1984)"]
    B --> B3["MIT App Inventor (Anos 2010)"]

    C --> C1["Membro do Conselho da Free Software Foundation (FSF)"]
    C --> C2["Membro Fundador do Conselho da Creative Commons (CC)"]
    C --> C3["MIT OpenCourseWare"]

    B1 -.-> D["Desenvolvimento do Pensamento Lógico para Crianças"]
    B2 -.-> E["Formação de Hackers e Engenheiros no Mundo Todo"]
    B3 -.-> F["Democratização da Tecnologia para Não Programadores"]
    C1 -.-> G["Liberdade de Software"]
    C2 -.-> H["Direitos Autorais Flexíveis e Compartilhamento de Conhecimento"]
    C3 -.-> H

    D --> I["Uma Sociedade Onde Todos se Tornam Criadores de Tecnologia"]
    E --> I
    F --> I
    G --> I
    H --> I
