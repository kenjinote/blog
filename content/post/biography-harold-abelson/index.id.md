---
title: "Harold Abelson: Maestro Pendidikan Pemrograman dan Budaya Terbuka"
...
graph TD
    ...
    A --> B["Pendidikan Pemrograman"]
    A --> C["Budaya Terbuka & Berbagi Informasi"]

    B --> B1["Mempopulerkan Bahasa Logo (1980-an)"]
    B --> B2["SICP (1984)"]
    B --> B3["MIT App Inventor (2010-an)"]

    C --> C1["Dewan Free Software Foundation (FSF)"]
    C --> C2["Dewan Pendiri Creative Commons (CC)"]
    C --> C3["MIT OpenCourseWare"]

    B1 -.-> D["Mengembangkan Pemikiran Logis untuk Anak-anak"]
    B2 -.-> E["Mendidik Peretas & Insinyur di Seluruh Dunia"]
    B3 -.-> F["Demokratisasi Teknologi untuk Non-Programmer"]
    C1 -.-> G["Kebebasan Perangkat Lunak"]
    C2 -.-> H["Hak Cipta Fleksibel dan Berbagi Pengetahuan"]
    C3 -.-> H

    D --> I["Masyarakat di Mana Setiap Orang Adalah Pembuat Teknologi"]
    E --> I
    F --> I
    G --> I
    H --> I
