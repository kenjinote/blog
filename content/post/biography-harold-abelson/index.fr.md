---
title: "Harold Abelson : Pionnier de l'enseignement de la programmation et de la culture libre"
...
description: "Dans l'histoire de l'informatique, certaines personnes ont eu autant d'impact sur « comment l'enseigner et la partager » que sur la technologie elle-même."
---
...
graph TD
    ...
    A --> B["Enseignement de la programmation"]
    A --> C["Culture libre et partage de l'information"]

    B --> B1["Popularisation du langage Logo (Années 1980)"]
    B --> B2["SICP (1984)"]
    B --> B3["MIT App Inventor (Années 2010)"]

    C --> C1["Membre du CA de la Free Software Foundation (FSF)"]
    C --> C2["Membre fondateur du CA de Creative Commons (CC)"]
    C --> C3["MIT OpenCourseWare"]

    B1 -.-> D["Développement de la pensée logique pour les enfants"]
    B2 -.-> E["Formation de hackers et d'ingénieurs dans le monde entier"]
    B3 -.-> F["Démocratisation de la technologie pour les non-programmeurs"]
    C1 -.-> G["Liberté logicielle"]
    C2 -.-> H["Droit d'auteur flexible et partage des connaissances"]
    C3 -.-> H

    D --> I["Une société où chacun devient créateur de technologie"]
    E --> I
    F --> I
    G --> I
    H --> I
