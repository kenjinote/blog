---
title: "Harold Abelson: Un maestro de la educación en programación y la cultura abierta"
...
description: "En la historia de la informática, hay figuras que han tenido un impacto tan grande en \"cómo enseñar y compartir\" la tecnología como en la tecnología misma."
---
...
graph TD
    ...
    A --> B["Educación en programación"]
    A --> C["Cultura abierta y Compartir información"]

    B --> B1["Popularización del lenguaje Logo (Años 80)"]
    B --> B2["SICP (1984)"]
    B --> B3["MIT App Inventor (Años 2010)"]

    C --> C1["Miembro de la junta de la FSF"]
    C --> C2["Miembro fundador de Creative Commons (CC)"]
    C --> C3["MIT OpenCourseWare"]

    B1 -.-> D["Fomento del pensamiento lógico en niños"]
    B2 -.-> E["Formación de hackers e ingenieros en el mundo"]
    B3 -.-> F["Democratización de la tecnología para no programadores"]
    C1 -.-> G["Libertad del software"]
    C2 -.-> H["Derechos de autor flexibles y conocimiento compartido"]
    C3 -.-> H

    D --> I["Una sociedad donde todos son creadores de tecnología"]
    E --> I
    F --> I
    G --> I
    H --> I
