---
title: "Harold Abelson: A Master of Programming Education and Open Culture"
...
graph TD
    ...
    A --> B["Programming Education"]
    A --> C["Open Culture & Information Sharing"]

    B --> B1["Popularization of Logo Language (1980s)"]
    B --> B2["SICP (1984)"]
    B --> B3["MIT App Inventor (2010s)"]

    C --> C1["Board Member of Free Software Foundation (FSF)"]
    C --> C2["Founding Board Member of Creative Commons (CC)"]
    C --> C3["MIT OpenCourseWare"]

    B1 -.-> D["Fostering Logical Thinking in Children"]
    B2 -.-> E["Fostering Hackers and Engineers Worldwide"]
    B3 -.-> F["Democratization of Technology for Non-programmers"]
    C1 -.-> G["Software Freedom"]
    C2 -.-> H["Flexible Copyright and Knowledge Sharing"]
    C3 -.-> H

    D --> I["A Society Where Everyone is a Creator of Technology"]
    E --> I
    F --> I
    G --> I
    H --> I
