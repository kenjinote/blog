---
title: "Harold Abelson: Ein Meister der Programmierausbildung und der offenen Kultur"
...
description: "In der Geschichte der Informatik gibt es eine Persönlichkeit, die einen ebenso großen Einfluss darauf hatte, \"wie man lehrt und wie man teilt\", wie auf die"
---
...
graph TD
    ...
    A --> B["Programmierausbildung"]
    A --> C["Offene Kultur & Informationsaustausch"]

    B --> B1["Verbreitung der Sprache Logo (1980er Jahre)"]
    B --> B2["SICP (1984)"]
    B --> B3["MIT App Inventor (2010er Jahre)"]

    C --> C1["Vorstandsmitglied der Free Software Foundation (FSF)"]
    C --> C2["Gründungsmitglied von Creative Commons (CC)"]
    C --> C3["MIT OpenCourseWare"]

    B1 -.-> D["Förderung des logischen Denkens bei Kindern"]
    B2 -.-> E["Ausbildung von Hackern & Ingenieuren weltweit"]
    B3 -.-> F["Demokratisierung der Technologie für Nicht-Programmierer"]
    C1 -.-> G["Freiheit der Software"]
    C2 -.-> H["Flexibles Urheberrecht und Wissensaustausch"]
    C3 -.-> H

    D --> I["Eine Gesellschaft, in der jeder ein Schöpfer von Technologie ist"]
    E --> I
    F --> I
    G --> I
    H --> I
