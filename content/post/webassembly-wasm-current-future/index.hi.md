...
वेब ब्राउज़रों पर लंबे समय तक एक ही भाषा, जावास्क्रिप्ट का दबदबा रहा है। हालाँकि, जैसे-जैसे वेब एप्लिकेशन अधिक जटिल होते गए और उन्हें नेटिव ऐप जैसी परफॉर्मेंस की आवश्यकता होने लगी, अकेले जावास्क्रिप्ट की सीमाएं स्पष्ट हो गईं। यहीं से **WebAssembly (Wasm)** की शुरुआत हुई।

वेबअसेंबली एक नया बाइनरी फॉर्मेट है जो ब्राउज़र में नेटिव कोड के समान गति पर चल सकता है। यह C, C++, और Rust जैसी प्रोग्रामिंग भाषाओं से कंपाइल होकर उत्पन्न होता है। आज, यह न केवल वेब डेवलपमेंट में बल्कि सर्वर-साइड, एज कंप्यूटिंग और यहां तक ​​कि IoT उपकरणों जैसे क्षेत्रों में भी नवाचार (इनोवेशन) ला रहा है।
...
इन अनुभवों से सीखते हुए, प्रमुख ब्राउज़र वेंडर्स (Mozilla, Google, Microsoft, Apple) ने मिलकर **वेबअसेंबली (WebAssembly)** नामक एक ओपन स्टैंडर्ड विकसित किया।
...
3.  **ओपन और डिबग करने योग्य** : बाइनरी फॉर्मेट के साथ-साथ, इसमें मानव-पठनीय टेक्स्ट फॉर्मेट (WAT: WebAssembly Text format) भी हो।
...
C और Rust में अक्सर पॉइंटर्स का उपयोग करके मेमोरी को मैनिपुलेट किया जाता है। इसे संभव बनाने के लिए, वेबअसेंबली **लीनियर मेमोरी (Linear Memory)** की अवधारणा का उपयोग करती है।

लीनियर मेमोरी एक सन्निहित (continuous) बाइट ऐरे है जिसे वेबअसेंबली इंस्टेंस द्वारा एक्सेस किया जा सकता है। जावास्क्रिप्ट से, यह `ArrayBuffer` या `SharedArrayBuffer` के रूप में दिखाई देता है। Wasm के भीतर पॉइंटर्स इस ऐरे के केवल इंडेक्स (पूर्णांक मान) होते हैं।
...
लेकिन इसे मैन्युअली लिखना बहुत थकाऊ हो सकता है। इसलिए, Rust इकोसिस्टम में **wasm-bindgen** जैसे टूल उपलब्ध हैं।
...
जब आप इस कोड को कंपाइल करते हैं, तो `wasm-bindgen` स्वचालित रूप से जावास्क्रिप्ट का ग्लू कोड (glue code) उत्पन्न करता है और स्ट्रिंग मेमोरी पासिंग जैसी चीजों को छिपा देता है। यह ऐसा विकास अनुभव देता है मानो Rust से सीधे ब्राउज़र API को कॉल किया जा रहा हो।
...
पारंपरिक Wasm को C और Rust के लिए डिज़ाइन किया गया था, जहाँ लीनियर मेमोरी को मैन्युअल रूप से प्रबंधित किया जाता है। हालाँकि, Java, Kotlin, C# और Dart जैसी गारबेज-कलेक्टेड भाषाओं को Wasm में कुशलतापूर्वक कंपाइल करने के लिए **Wasm GC** प्रस्ताव को मानकीकृत किया जा रहा है। इसने Flutter Web जैसी चीज़ों के प्रदर्शन में नाटकीय रूप से सुधार किया है।

---

# 7. ब्राउज़र के बाहर की दुनिया: WASI (WebAssembly System Interface)

वेबअसेंबली की क्षमता केवल ब्राउज़र तक सीमित नहीं है। **"क्या होगा यदि Wasm को ब्राउज़र के बाहर भी एक मानक (स्टैंडर्ड) प्रारूप के रूप में इस्तेमाल किया जा सके?"** इस विचार से **WASI (WebAssembly System Interface)** का जन्म हुआ।
...
वर्तमान में, कुबेरनेट्स (Kubernetes) पर डॉकर कंटेनरों के बजाय सीधे Wasm मॉड्यूल को ऑर्केस्ट्रेट करने के लिए कई प्रोजेक्ट्स (जैसे Kwasm और Spin) सक्रिय रूप से विकसित किए जा रहे हैं।
...
इसे हल करने के लिए **WebAssembly Component Model** लाया गया है।
एक बार जब कॉम्पोनेंट मॉडल साकार हो जाता है, तो "Python में लिखे गए Wasm मॉड्यूल" से "Rust में लिखे गए Wasm मॉड्यूल" के फ़ंक्शंस को बिना किसी बाधा के कॉल करना संभव हो जाएगा। इसमें प्लेटफ़ॉर्म और भाषा-स्वतंत्र नेक्स्ट-जेनरेशन माइक्रो-सर्विस आर्किटेक्चर की नींव बनने की क्षमता है।
