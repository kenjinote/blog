...
C और [Rust](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) में अक्सर पॉइंटर्स का उपयोग करके मेमोरी को मैनिपुलेट किया जाता है। इसे संभव बनाने के लिए, वेबअसेंबली **लीनियर मेमोरी (Linear Memory)** की अवधारणा का उपयोग करती है।
