...
Zum Beispiel platzieren wir am Ende eines Artikels über "Wie man [Redux](https://kenji.blog/de/p/state-management-history-future/)-Boilerplate reduziert" einen kontextbezogenen CTA wie: "Wenn Sie mit der Komplexität des [State](https://kenji.blog/de/p/iac-infrastructure-as-code-terraform/)-Managements zu kämpfen haben, probieren Sie mein neu entwickeltes Visualisierungstool für State-Management, StateViewer, aus."
