...
例えば、「[Redux](https://kenji.blog/p/state-management-history-future/)のボイラープレートを減らす方法」という記事の最後に、「もしあなたが状態管理の複雑さに悩んでいるなら、私が開発した新しい[状態管理](https://kenji.blog/p/state-management-history-redux-context-recoil-zustand/)可視化ツール『StateViewer』を試してみてください」というコンテキストに沿ったCTAを配置します。
