...
```mermaid
flowchart TD
    A["Inorganic Matter"] -- "Filter Candidate 1" --> B["Emergence of Life (Prokaryotes)"]
    B -- "Filter Candidate 2" --> C["Emergence of Eukaryotes"]
    C -- "Evolution" --> D["Multicellular Organisms"]
    D -- "Evolution" --> E["Acquisition of Intelligence and Tool Use"]
    E -- "Filter Candidate 3" --> F["Establishment of Technological Civilization"]
    F -- "Ultimate Filter?" --> G["Interstellar Civilization and Galactic Expansion"]
    
    style G fill:#ff9999,stroke:#333,stroke-width:2px
    
    H["Past Filters We Have\nOvercome"] -.-> B
    H -.-> C
    I["Future Filters We Will\nFace"] -.-> F
    I -.-> G
```
...
```mermaid
flowchart LR
    A["Civilization A\n(Own survival is top priority)"] -- "Discovery and Observation" --> B["Civilization B\n(Unknown civilization)"]
    A -- "Chain of Suspicion" --> C{"Is Civilization B benevolent or malicious?"}
    C -- "Impossible to judge" --> D["If left alone, a technological explosion\ncould make them a threat"]
    D -- "Logical conclusion" --> E["【Annihilation via Preemptive Strike】"]
