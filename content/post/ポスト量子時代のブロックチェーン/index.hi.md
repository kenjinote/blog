...
इससे बचने के लिए, नेटवर्क के हार्ड फोर्क (hard fork) के माध्यम से नए PQC सत्यापन के लिए प्रीकंपाइल्ड कॉन्ट्रैक्ट (उदाहरण के लिए: `0x10` को DilithiumVerify आवंटित करना) को EVM में ही बनाना आवश्यक होगा। इसके लिए एक लंबी प्रक्रिया की आवश्यकता होती है जहाँ प्रत्येक एथेरियम क्लाइंट (Geth, Nethermind, Erigon, आदि) के मुख्य विकासकर्ता C++, Go और [Rust](https://kenji.blog/hi/p/webassembly-wasm-current-future/) जैसी भाषाओं के स्तर पर लैटिस क्रिप्टोग्राफी सत्यापन तर्क को अनुकूलित (optimize) करने और सुरक्षा ऑडिट (security audit) करने के लिए सहयोग करते हैं।
