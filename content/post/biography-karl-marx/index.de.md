...
flowchart TD
    ...
    Engels["Friedrich Engels (Verbündeter)"]
    Manifesto["Das Kommunistische Manifest (1848)"]
    Capital["Das Kapital (1867)"]
    Materialism["Historischer Materialismus"]
    SurplusValue["Mehrwerttheorie"]
    Socialism["Sozialistische Staaten des 20. Jahrhunderts"]
    ModernCritique["Analysewerkzeug für den modernen Kapitalismus"]

    Marx <-->|"Lebenslange Zusammenarbeit und finanzielle Unterstützung"| Engels
    Marx -->|"Ausarbeitung"| Manifesto
    Marx -->|"Als Lebenswerk geschrieben"| Capital
    Manifesto -->|"Die Geschichte ist ein Klassenkampf"| Materialism
    Capital -->|"Entschlüsselung des Ausbeutungsmechanismus"| SurplusValue
    Materialism -->|"Ideologie der Revolution"| Socialism
    SurplusValue -->|"Warnung vor der sozialen Ungleichheit"| ModernCritique
    Socialism -->|"Zusammenbruch und Reflexion des Systems"| ModernCritique
```
