---
title: "Karl Marx: O Pensador que Atacou as Contradições do Capitalismo e Moveu a História"
date: "2026-09-24T16:08:36+09:00"
categories: ["biography"]
tags: ["karl-marx", "history"]
image: "eyecatch.jpg"
slug: "biography-karl-marx"
description: "Karl Marx. O que lhe vem à mente quando você ouve esse nome? Alguns podem considerá-lo um grande homem na história como o \"pai do comunismo\", enquanto outr"
---
...
flowchart TD
    ...
    Engels["Friedrich Engels (Aliado)"]
    Manifesto["O Manifesto Comunista (1848)"]
    Capital["O Capital (1867)"]
    Materialism["Materialismo Histórico"]
    SurplusValue["Teoria da Mais-valia"]
    Socialism["Estados Socialistas do Século 20"]
    ModernCritique["Ferramenta de análise do capitalismo moderno"]

    Marx <-->|"Colaboração vitalícia e apoio financeiro"| Engels
    Marx -->|"Elaboração"| Manifesto
    Marx -->|"Escrito como a obra de sua vida"| Capital
    Manifesto -->|"A história é a luta de classes"| Materialism
    Capital -->|"Elucidação do mecanismo de exploração"| SurplusValue
    Materialism -->|"Ideologia da revolução"| Socialism
    SurplusValue -->|"Alerta para a sociedade de desigualdade"| ModernCritique
    Socialism -->|"Colapso do sistema e reflexão"| ModernCritique
```
