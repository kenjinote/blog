---
title: "Karl Marx: El pensador que atacó las contradicciones del capitalismo y movió la historia"
...
flowchart TD
    ...
    Manifesto["El Manifiesto Comunista (1848)"]
    Capital["El Capital (1867)"]
    Materialism["Materialismo histórico"]
    SurplusValue["Teoría de la plusvalía"]
    Socialism["Estados socialistas del siglo XX"]
    ModernCritique["Herramienta de análisis del capitalismo moderno"]

    Marx <-->|"Colaboración de por vida y apoyo económico"| Engels
    Marx -->|"Redactado"| Manifesto
    Marx -->|"Escrito como obra de su vida"| Capital
    Manifesto -->|"La historia es la lucha de clases"| Materialism
    Capital -->|"Aclara el mecanismo de explotación"| SurplusValue
    Materialism -->|"Ideología de la revolución"| Socialism
    SurplusValue -->|"Advertencia a la sociedad desigual"| ModernCritique
    Socialism -->|"Colapso del sistema y reflexión"| ModernCritique
```
