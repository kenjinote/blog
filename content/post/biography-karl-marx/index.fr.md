---
title: "Karl Marx : Le Penseur qui a Ciblé les Contradictions du Capitalisme et Fait Bouger l'Histoire"
date: 2026-09-23T19:53:31+09:00
categories: ["biography"]
tags: ["karl-marx", "history"]
image: "eyecatch.jpg"
slug: "biography-karl-marx"
description: "Karl Marx. Que vous vient-il à l'esprit lorsque vous entendez ce nom ? Certains peuvent le considérer comme un grand homme de l'histoire en tant que « père"
---
...
flowchart TD
    ...
    Engels["Friedrich Engels (Allié)"]
    Manifesto["Le Manifeste du Parti communiste (1848)"]
    Capital["Le Capital (1867)"]
    Materialism["Matérialisme historique"]
    SurplusValue["Théorie de la plus-value"]
    Socialism["États socialistes du 20e siècle"]
    ModernCritique["Outil d'analyse du capitalisme moderne"]

    Marx <-->|"Collaboration à vie et soutien économique"| Engels
    Marx -->|"Rédaction"| Manifesto
    Marx -->|"Écrit comme l'œuvre de sa vie"| Capital
    Manifesto -->|"L'histoire est une lutte des classes"| Materialism
    Capital -->|"Élucidation du mécanisme d'exploitation"| SurplusValue
    Materialism -->|"Idéologie révolutionnaire"| Socialism
    SurplusValue -->|"Avertissement sur la société d'inégalités"| ModernCritique
    Socialism -->|"Effondrement du système et réflexion"| ModernCritique
```
