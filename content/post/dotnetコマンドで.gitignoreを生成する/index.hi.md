...
slug: "dotnetकमांडで.gitignoreを生成する"
...
cmd.exe को एडमिनिस्ट्रेटर प्रिविलेज के साथ शुरू करें और निम्नलिखित कमांड निष्पादित करें।
```cmd
winget install Microsoft.DotNet.SDK.6
```

## .gitignore जनरेट करें
dotnet.exe के साथ .gitignore जनरेट करने का कमांड निम्नलिखित है।
```bash
dotnet new gitignore
```
जनरेट किया गया .gitignore निम्नलिखित है।
```gitignore
...
```
विजुअल स्टूडियो के लिए कई फाइलें हैं, लेकिन इसमें ऐसे आइटम भी शामिल हैं जिन्हें आमतौर पर git पर प्रबंधित करने की आवश्यकता नहीं होती है, जैसे Mac का `.DS_Store`।

## संदर्भ साइटें
- [Windows पर .NET इंस्टॉल करें](https://docs.microsoft.com/ja-jp/dotnet/core/install/windows?tabs=net60)
