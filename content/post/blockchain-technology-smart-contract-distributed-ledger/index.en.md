...
- **[Stack](https://kenji.blog/en/p/c-language-pointers-memory-management-stack-heap/)**: A LIFO (Last-In-First-Out) data structure with up to 1024 elements. 256-bit word size. Holds operands for various operations.
