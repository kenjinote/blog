...
- ** Pila (Stack) **: Estructura de datos LIFO (último en entrar, primero en salir) con un máximo de 1024 elementos. Tamaño de palabra de 256 bits. Almacena los operandos para varias operaciones.
