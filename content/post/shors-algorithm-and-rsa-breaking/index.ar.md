...
يمكن تحويلها. من هنا، باستخدام [خوارزمية إقليدس](https://kenji.blog/p/euclidean-algorithm/) لحساب القاسم المشترك الأكبر لـ $ N $ و $ a^{r/2} \pm 1 $، يمكن الحصول على العوامل الأولية لـ $ N $ باحتمالية عالية جدًا.
