...
Dari sini, dengan menggunakan algoritma [Euclide](https://kenji.blog/p/euclid/)an untuk menghitung faktor persekutuan terbesar $ N $ dan $ a^{r/2} \pm 1 $, faktor prima $ N $ dapat diperoleh dengan probabilitas yang sangat tinggi.
