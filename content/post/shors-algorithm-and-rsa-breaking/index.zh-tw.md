---
title: '量子電腦會破解 RSA 加密嗎？解說秀爾演算法 (Shor''s Algorithm)'
...
從這裡，利用[歐幾里得](https://kenji.blog/zh-tw/p/euclid/)演算法計算 $ N $ 和 $ a^{r/2} \pm 1 $ 的最大公因數，就有極高的機率能得到 $ N $ 的質因數。
...
為了對抗這種時間差帶來的威脅，以NIST（美國國家標準暨技術研究院）為中心，正急起直追地推動 **「後量子密碼學（PQC: Post-Quantum [Crypto](https://kenji.blog/zh-tw/p/cryptocurrency-and-bitcoin/)graphy）」** 的標準化流程。
