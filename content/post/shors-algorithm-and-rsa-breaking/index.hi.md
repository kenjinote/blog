---
title: 'क्या क्वांटम कंप्यूटर RSA एन्क्रिप्शन को तोड़ देंगे? शोर के एल्गोरिदम की व्याख्या'
...
description: 'हम बताते हैं कि क्वांटम कंप्यूटरों के उदय से आधुनिक संचार बुनियादी ढांचे का समर्थन करने वाला RSA एन्क्रिप्शन कैसे खतरे में है। शोर के एल्गोरिदम के तंत्र से लेकर NISQ युग में हार्डवेयर की वर्तमान स्थिति तक, हम अगली पीढ़ी के क्रिप्टैनालिसिस और सुरक्षा के भविष्य पर चर्चा करते हैं।'
---

## परिचय: क्रिप्टोग्राफी और क्वांटम कंप्यूटर का प्रतिच्छेदन

आधुनिक इंटरनेट समाज में, "सार्वजनिक-कुंजी क्रिप्टोग्राफी" (Public-key cryptography) संचार की गोपनीयता की रक्षा के लिए नींव के रूप में कार्य करती है। उनमें से सबसे प्रसिद्ध "[RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन" है, जिसे 1977 में रॉन रिवेस्ट, आदि शमीर और लियोनार्ड एडलमैन द्वारा विकसित किया गया था। ऑनलाइन शॉपिंग भुगतान, वेबसाइट ब्राउज़िंग (HTTPS) और हर दिन हमारे द्वारा उपयोग किए जाने वाले ईमेल भेजने और प्राप्त करने से लेकर, RSA एन्क्रिप्शन इंटरनेट बुनियादी ढांचे के दिल के रूप में कार्य करता है।
...
इस लेख में, हम GNFS (जनरल नंबर फील्ड सीव), एक क्लासिकल डिक्रिप्शन विधि, और "शोर का एल्गोरिदम" ([Shor's Algorithm](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/)) के तंत्र में गहराई से उतरेंगे, जो क्वांटम कंप्यूटर का उपयोग करके एक निश्चित डिक्रिप्शन एल्गोरिदम है। हम क्वांटम फूरियर ट्रांसफॉर्म और अवधि खोज जैसी उन्नत अवधारणाओं को आसानी से समझने वाले तरीके से समझाएंगे, और वर्तमान NISQ (Noisy Intermediate-Scale Quantum) युग में क्वांटम हार्डवेयर की वर्तमान स्थिति और [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)-2048 को क्रैक करने के लिए आवश्यक बाधाओं की विस्तार से जांच करेंगे।
...
में बदला जा सकता है। यहाँ से, [[यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिथ्म](https://kenji.blog/p/euclidean-algorithm/) ([[Euclid](https://kenji.blog/hi/p/euclid/)e](https://kenji.blog/p/euclid/)an algorithm) का उपयोग करके $ N $ और $ a^{r/2} \pm 1 $ के सबसे बड़े सामान्य भाजक की गणना करके, $ N $ के अभाज्य गुणनखंडों को बहुत अधिक संभावना के साथ प्राप्त किया जा सकता है।
...
एक बार $ r $ ज्ञात हो जाने के बाद, हम चरण 1 के सूत्र का उपयोग करके $ N $ के अभाज्य गुणनखंडों की गणना कर सकते हैं, और [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन पूरी तरह से डिक्रिप्ट हो जाएगा।
...
इस समय अंतराल के खतरे का मुकाबला करने के लिए, NIST (राष्ट्रीय मानक और प्रौद्योगिकी संस्थान) के नेतृत्व में, **"पोस्ट-क्वांटम क्रिप्टोग्राफी" (PQC: Post-Quantum [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy)** के मानकीकरण की प्रक्रिया तेज गति से आगे बढ़ रही है।
