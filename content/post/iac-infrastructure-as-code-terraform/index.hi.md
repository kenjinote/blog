...
Terraform में, Terraform कोर स्वचालित रूप से कोड में दिखाई देने वाले संदर्भ संबंधों (जैसे सबनेट सेटिंग्स में `aws_vpc.main.id` का संदर्भ देना) से एक **निर्भरता ग्राफ (Dependency Graph)** बनाता है।
...
2. **क्रेडेंशियल्स को हार्ड-कोड करना** : सीधे कोड में एक्सेस कुंजियों और गुप्त कुंजियों को लिखना। पर्यावरण चर (Environment Variables) या IAM भूमिकाओं (OIDC एकीकरण आदि) का उपयोग करें।
