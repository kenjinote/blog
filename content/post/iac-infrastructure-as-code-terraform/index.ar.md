...
تيرافورم هي أداة IaC مفتوحة المصدر طورتها شركة HashiCorp باستخدام لغة [Go](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/). تتيح لك تكوين وإدارة أي واجهة برمجة تطبيقات (API) ككود، بدءاً من البنية التحتية السحابية وحتى إعدادات SaaS.
