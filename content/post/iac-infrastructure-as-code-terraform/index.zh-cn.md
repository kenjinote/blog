...
本文将从IaC的概念开始，重点介绍其可以说是事实标准的 **Terraform** 。我们将非常详细地解析Terraform采用的“声明式配置管理”哲学、内部架构、[状态管理](/zh-cn/p/state-management-history-redux-context-recoil-zustand/)（State）机制，以及实际的最佳实践。
