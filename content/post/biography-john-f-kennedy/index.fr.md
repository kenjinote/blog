---
title: "John F. Kennedy : La vie et la philosophie du jeune président qui a ouvert une nouvelle ère"
date: "2026-09-23T19:46:03+09:00"
categories: ["biography"]
tags: ["john-f-kennedy", "history"]
image: "eyecatch.jpg"
slug: "biography-john-f-kennedy"
description: "John Fitzgerald Kennedy (JFK), le 35e président des États-Unis, était un leader charismatique qui a guidé la nation à travers le tournant historique de la"
---
...
```mermaid
flowchart TD
    A["Naissance et petite enfance (1917-)"] --> B["Service durant la Seconde Guerre mondiale : héroïsme du PT-109 (1943)"]
    B --> C["Début de la carrière politique (1946-)"]
    C --> D["35e Président des États-Unis (1961)"]
    
    D --> E{"Politiques et défis clés"}
    
    E --> F["Politique de la Nouvelle Frontière"]
    E --> G["Programme Apollo (1961)"]
    E --> H["Crise des missiles de Cuba (1962)"]
    E --> I["Soutien aux droits civiques"]
    
    F --> J["Création du Peace Corps"]
    G --> K["Alunissage (1969)"]
    H --> L["Traité d'interdiction des essais nucléaires (1963)"]
    I --> M["Civil Rights Act (1964)"]
    
    J --> N["Assassinat à Dallas (1963)"]
    K --> N
    L --> N
    M --> N
    
    N --> O["Héritage durable et inspiration"]
```
