---
title: "John F. Kennedy: Kehidupan dan Filosofi Presiden Muda yang Merintis Era Baru"
...
```mermaid
flowchart TD
    A["Kelahiran & Kehidupan Awal (1917-)"] --> B["Dinas Perang Dunia II: Kepahlawanan PT-109 (1943)"]
    B --> C["Karier Politik Dimulai (1946-)"]
    C --> D["Presiden AS ke-35 (1961)"]
    
    D --> E{"Kebijakan & Tantangan Utama"}
    
    E --> F["Kebijakan New Frontier"]
    E --> G["Program Apollo (1961)"]
    E --> H["Krisis Rudal Kuba (1962)"]
    E --> I["Dukungan untuk Hak Sipil"]
    
    F --> J["Pembentukan Korps Perdamaian"]
    G --> K["Pendaratan di Bulan (1969)"]
    H --> L["Perjanjian Larangan Uji Coba Nuklir (1963)"]
    I --> M["Undang-Undang Hak Sipil (1964)"]
    
    J --> N["Pembunuhan di Dallas (1963)"]
    K --> N
    L --> N
    M --> N
    
    N --> O["Warisan & Inspirasi Abadi"]
```
