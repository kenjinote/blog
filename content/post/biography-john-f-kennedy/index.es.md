---
title: "John F. Kennedy: La vida y filosofía del joven presidente que fue pionero de una nueva era"
...
```mermaid
flowchart TD
    A["Nacimiento y primeros años (1917-)"] --> B["Servicio en la SGM: Heroísmo en el PT-109 (1943)"]
    B --> C["Inicio de la carrera política (1946-)"]
    C --> D["35º Presidente de los EE. UU. (1961)"]
    
    D --> E{"Políticas clave y desafíos"}
    
    E --> F["Política de la Nueva Frontera"]
    E --> G["Programa Apolo (1961)"]
    E --> H["Crisis de los Misiles de Cuba (1962)"]
    E --> I["Apoyo a los Derechos Civiles"]
    
    F --> J["Establecimiento del Cuerpo de Paz"]
    G --> K["Llegada a la Luna (1969)"]
    H --> L["Tratado de Prohibición de Ensayos Nucleares (1963)"]
    I --> M["Ley de Derechos Civiles (1964)"]
    
    J --> N["Asesinato en Dallas (1963)"]
    K --> N
    L --> N
    M --> N
    
    N --> O["Legado e inspiración perdurables"]
```
