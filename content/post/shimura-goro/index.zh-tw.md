...
1949年，志村進入東京大學理學部數學科。當時的日本數學界，雖然以[高木貞治](https://kenji.blog/zh-tw/p/takagi-teiji/)的類域論等為基礎，但在戰後復興期，面臨著如何跟上世界潮流的課題。在這裡，志村遇到了 **[谷山豐](/zh-tw/p/taniyama-yutaka/)** （[Yutaka Taniyama](https://kenji.blog/zh-tw/p/taniyama-yutaka/)），兩人後來結下了深厚的友誼，並命運與共。
...
據說志村和谷山變得親密的契機，是圍繞著一個數學問題的瑣碎交流。他們互相[認可](https://kenji.blog/zh-tw/p/oauth2-oidc-authentication-authorization-difference/)對方的才華，日以繼夜地沉浸在數學的討論中。他們特別感興趣的是代數幾何和數論交叉點上的「複乘理論」的近代化。
