...
# परिचय: [एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) क्या है?

संख्या सिद्धांत के क्षेत्र में कई अनसुलझी समस्याएं मौजूद हैं, लेकिन उनमें से जिसे विशेष रूप से महत्वपूर्ण माना गया है वह **[एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/)** (ABC Conjecture) है। यह अनुमान 1985 में जोसेफ ओस्टर्ले (Joseph Oesterlé) और डेविड मैसर (David Masser) द्वारा स्वतंत्र रूप से तैयार किया गया था।

[एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) पूर्णांकों के जोड़ और गुणा (अभाज्य गुणनखंडन) के बीच एक गहरे संबंध का सुझाव देता है। यह पहली नज़र में सरल लगने वाले समीकरण $a + b = c$ में छिपे आश्चर्यजनक गुणों का वर्णन करता है।

## [एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) की सख्त परिभाषा
...
[एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) यह दावा करता है कि किसी भी $\epsilon > 0$ के लिए, सह-अभाज्य धनात्मक पूर्णांकों $(a, b, c)$ के केवल परिमित त्रिक मौजूद हैं जो निम्नलिखित को संतुष्ट करते हैं:
...
# [एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) से प्राप्त आश्चर्यजनक परिणाम

यदि [एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) पूरी तरह से सिद्ध हो जाता है (IUT सिद्धांत द्वारा, या अन्य तरीकों से), तो संख्या सिद्धांत में कई महत्वपूर्ण प्रमेय एक ही बार में प्राप्त हो जाएंगे। आइए इसकी तुलना **मॉर्डेल अनुमान** (जिसे अब फाल्टिंग्स के प्रमेय के रूप में जाना जाता है) और **[फर्मेट का अंतिम प्रमेय](https://kenji.blog/p/fermats-last-theorem/)** से करें।

## फर्मेट के अंतिम प्रमेय के लिए अनुप्रयोग

[फर्मेट का अंतिम प्रमेय](https://kenji.blog/p/fermats-last-theorem/) बताता है कि जब $n \ge 3$ होता है, तो कोई धनात्मक पूर्णांक त्रिक $(x, y, z)$ मौजूद नहीं होता है जो $x^n + y^n = z^n$ को संतुष्ट करता हो। इसे 1995 में [एंड्रयू विल्स](https://kenji.blog/p/wiles/) द्वारा सिद्ध किया गया था, लेकिन बहुत उन्नत और जटिल गणित का उपयोग किया गया था।

यदि हम मान लें कि [एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) सही है, तो आश्चर्यजनक रूप से, [फर्मेट का अंतिम प्रमेय](https://kenji.blog/p/fermats-last-theorem/) (कम से कम जब $n$ पर्याप्त रूप से बड़ा हो) केवल कुछ पंक्तियों में सिद्ध किया जा सकता है।

मान लें कि $x^n + y^n = z^n$ है, और $(x, y, z)$ सह-अभाज्य हैं। $a=x^n$, $b=y^n$, $c=z^n$ पर [एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) लागू करने पर:

$$ z^n < \text{मूल}(x^n y^n z^n)^{1+\epsilon} = \text{मूल}(xyz)^{1+\epsilon} \le (xyz)^{1+\epsilon} < (z^3)^{1+\epsilon} $$

यदि हम $\epsilon$ को पर्याप्त रूप से छोटा लेते हैं, तो जब $n$, $3(1+\epsilon)$ से बड़ा होता है (अर्थात $n \ge 4$ के आसपास), यह असमानता एक विरोधाभास की ओर ले जाती है। इसलिए, यह तुरंत स्पष्ट हो जाता है कि $n$ बड़ा होने पर कोई समाधान मौजूद नहीं है। इस तरह, [एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) संख्या सिद्धांत के लिए एक शक्तिशाली **मास्टर की** (master key) के रूप में कार्य करता है।
...
[एबीसी अनुमान](https://kenji.blog/p/abc-conjecture/) और इंटर-यूनिवर्सल टेकमुलर सिद्धांत 21वीं सदी के गणित के सबसे बड़े नाटकों में से एक हैं। जोड़ और गुणा की अथाह गहराई, जो सबसे सरल अवधारणाएं हैं जिन्हें हम प्राथमिक विद्यालय में सीखते हैं, अभी मानव बुद्धिमत्ता की सीमाओं का परीक्षण कर रही हैं।
