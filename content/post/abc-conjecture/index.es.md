...
# Introducción: ¿Qué es la Conjetura ABC?
...
El último teorema de Fermat establece que para $n \ge 3$, no existe ninguna terna de números enteros positivos $(x, y, z)$ que satisfaga $x^n + y^n = z^n$. Fue demostrado por Andrew Wiles en 1995, pero se utilizaron matemáticas sumamente avanzadas y complejas.
