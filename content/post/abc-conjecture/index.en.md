...
The ABC Conjecture suggests a deep relationship between the addition and multiplication (prime factorization) of integers. It describes surprising properties hidden in the seemingly simple equation $a + b = c$.
...
The ABC Conjecture claims that for any $\epsilon > 0$, there are only finitely many tuples of coprime positive integers $(a, b, c)$ that satisfy the following:
...
The ABC Conjecture and Inter-Universal Teichmüller Theory constitute one of the greatest dramas in 21st-century mathematics. The bottomless depth of addition and multiplication, the simplest concepts learned in elementary school, is right now testing the limits of human intelligence.
