...
La conjecture ABC suggère une relation profonde entre l'addition et la multiplication (factorisation en nombres premiers) des nombres entiers. Elle décrit les propriétés étonnantes cachées dans une équation apparemment simple, $a + b = c$.
...
La conjecture ABC affirme que pour tout $\epsilon > 0$, il n'existe qu'un nombre fini de triplets d'entiers positifs premiers entre eux $(a, b, c)$ satisfaisant la condition suivante.
...
Le dernier théorème de Fermat stipule que pour $n \ge 3$, il n'existe pas de triplet d'entiers positifs $(x, y, z)$ satisfaisant $x^n + y^n = z^n$. Il a été prouvé par Andrew Wiles en 1995, mais des mathématiques extrêmement avancées et complexes ont été utilisées.
...
La conjecture ABC et la théorie inter-universelle de Teichmüller sont l'un des plus grands drames des mathématiques du 21e siècle. La profondeur insondable des concepts les plus simples appris à l'école primaire, l'addition et la multiplication, met actuellement à l'épreuve les limites de l'intelligence humaine.
