...
其中的秘密隐藏在 **“无限”** 和 **“[选择公理](/zh-cn/p/axiom-of-choice-and-zorns-lemma/)”** 这两个关键词中。
...
这是因为我们承认了作为现代数学基础的 **“[选择公理](/zh-cn/p/axiom-of-choice-and-zorns-lemma/)（Axiom of Choice）”** 这一规则。

简单来说，[选择公理](/zh-cn/p/axiom-of-choice-and-zorns-lemma/)就是这样的规则：

> **选择公理的直观理解**
> 当有许多个盒子里分别装着东西时， **“可以从每个盒子中各取出一个东西，组成一个新的套装（集合）”** 的规则。

如果盒子的数量是有限的，任何人都能轻易做到。
但是， **如果盒子的数量是“无限个”** ，人类就不可能完成无限次“逐一挑选”的操作。即便如此，[选择公理](/zh-cn/p/axiom-of-choice-and-zorns-lemma/)仍然承认“可以认为挑选出来组成的新集合是存在的”。

这个公理在构建现代数学体系时非常方便且不可或缺。大多数数学家都觉得“嗯，这是理所当然的”从而接受了这条规则。

然而，一旦承认了[选择公理](/zh-cn/p/axiom-of-choice-and-zorns-lemma/)，就等同于承认了前面提到的“分散到无法测量体积的点的集合（不可测集合）”的存在。其结果就是，“一个球变成两个球”的巴拿赫-塔斯基定理，作为一种逻辑上的必然被推导了出来。
...
当这个定理被发表时，一些数学家主张：“既然能得出这么违背常理的结论，那么[选择公理](/zh-cn/p/axiom-of-choice-and-zorns-lemma/)一定是错的！”
但到了今天，许多数学家都已经接受了[选择公理](/zh-cn/p/axiom-of-choice-and-zorns-lemma/)，也把巴拿赫-塔斯基定理视为“三维空间和无限集合所拥有的一种奇妙而美丽的性质”接受了下来。
