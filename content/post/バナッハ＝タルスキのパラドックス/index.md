...
その秘密は、 **「無限」** と **「[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)」** という2つのキーワードに隠されています。
...
## 5. すべての元凶：「[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)」とは何か？

では、なぜ「体積を測ることができないほど複雑な分割」が数学的に可能なのでしょうか？
それは、現代数学の基礎となっている **「[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)（Axiom of Choice）」** というルールを認めているからです。

[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)とは、ざっくり言うと次のようなルールです。

> **[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)のイメージ**
> たくさんの箱の中にそれぞれモノが入っているとき、 **「各箱から1つずつモノを選び出して、新しいセット（集合）を作ることができる」** というルール。

箱の数が有限個なら、誰でも普通にできます。
しかし、 **箱の数が「無限個」あった場合** 、人間が「1つずつ選ぶ」操作を無限回終わらせることはできません。それでも、「選んで作ったセットが存在するとして良い」と認めるのが[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)です。

この公理は、現代の数学を構築する上で非常に便利で不可欠なものでした。数学者のほとんどは「まあ、当たり前だよね」とこのルールを受け入れました。

しかし、この[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)を認めると、先ほどの「体積が測れないほど散らばったモヤモヤの点の集合（非可測集合）」の存在を認めることになってしまいます。そして、その結果として「1つの球が2つになる」というバナッハ＝タルスキの定理が、論理的必然として導き出されてしまうのです。
...
この定理が発表されたとき、一部の数学者たちは「こんな非常識な結論が出るなら、[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)は間違っているに違いない！」と主張しました。
しかし現在では、多くの数学者が[選択公理](https://kenji.blog/p/axiom-of-choice-and-zorns-lemma/)を受け入れ、バナッハ＝タルスキの定理も「3次元空間と無限集合が持つ、奇妙だけど美しい性質」として受け入れています。
