...
[Le paradoxe de Banach-Tarski](https://kenji.blog/fr/p/バナッハ＝タルスキのパラドックス/) n'est pas un paradoxe au sens d'"incohérence logique". C'est un paradoxe dans le sens où **la logique est correcte à 100 %, mais la conclusion à laquelle elle aboutit contredit violemment l'intuition humaine et les lois de la physique**.
...
[Le paradoxe de Banach-Tarski](https://kenji.blog/fr/p/バナッハ＝タルスキのパラドックス/) nous enseigne **à quel point le concept de "l'infini" surpasse allègrement notre simple intuition humaine**, et on peut dire que c'est l'un des plus grands chefs-d'œuvre des mathématiques modernes.
