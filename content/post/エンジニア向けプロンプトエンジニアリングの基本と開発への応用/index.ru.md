...
Системный промпт определяет **глобальные ограничения, персону (роль) и основные правила поведения** для LLM. Если проводить аналогию с проектированием программного обеспечения, он выполняет роль «переменных окружения» или «базового класса» приложения, или же «[Docker](https://kenji.blog/ru/p/docker-container-namespace-[cgroups](https://kenji.blog/ru/p/docker-container-namespace-cgroups-layers/)-layers/)file» для контейнера.
...
При создании агента, который исследует причину и генерирует патч при падении тестов в [CI/CD](https://kenji.blog/ru/p/cicd-pipeline-github-actions-best-practices/)-конвейере, LLM можно предоставить следующие инструменты:
