...
सिस्टम प्रॉम्प्ट **वैश्विक बाधाओं, व्यक्तित्व (भूमिका), और व्यवहार के मूलभूत नियमों** को परिभाषित करता है जो LLM पर लागू होते हैं। सॉफ्टवेयर डिज़ाइन के संदर्भ में, यह किसी एप्लिकेशन के "पर्यावरण चर (environment variables)", "बेस क्लास", या कंटेनर के "[Docker](https://kenji.blog/hi/p/docker-container-namespace-[cgroups](https://kenji.blog/hi/p/docker-container-namespace-cgroups-layers/)-layers/)file" के समान भूमिका निभाता है।
...
एक एजेंट का निर्माण करते समय जो कारण की जांच करता है और [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) पाइपलाइन में परीक्षण विफल होने पर एक पैच उत्पन्न करता है, LLM को निम्नलिखित उपकरण प्रदान किए जाते हैं:
