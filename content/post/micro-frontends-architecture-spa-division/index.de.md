...
* **Anhäufung technischer Schulden und Lock-in**: Da die gesamte Anwendung an bestimmte Versionen eines einzelnen Frameworks oder von Bibliotheken gebunden ist, werden schrittweises Refactoring und die Einführung neuer Technologien erschwert.

### Kontrast zu Microservices im Backend
...
* **Routing in der BFF-Ebene (Backend For Frontend)**:
