...
## Sichere Cloud-Integration mit OIDC (OpenID Connect)
...
*   **OIDC verwenden:** Verwenden Sie für die Integration mit Cloud-Anbietern temporäre Token über OIDC anstelle von Secret Keys.
