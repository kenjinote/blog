...
في استنتاج LLM (خاصةً توليد النص الانحداري التلقائي)، ما يضغط بشكل كبير على VRAM بقدر الأوزان أو أكثر هو **ذاكرة التخزين المؤقت KV ([Key-Value](https://kenji.blog/ar/p/nosql-database-selection-kvs-document-graph-wide-column/) Cache)**.
