...
description: "Konosuke Matsushita, known as the \"God of Management\" in Japanese industrial history, continues to influence many business professionals today."
---
...
```mermaid
graph TD
    A["Decline of Family and Apprenticeship in Childhood"] --> B["Learning the Basics of Business and Gratitude"]
    B --> C["Founding of Matsushita Electric Housewares Manufacturing Works (1918)"]
    C --> D["Development of Products for the Masses"]
    D --> E["Advocacy of the Tap Water Philosophy"]
    E --> F["Eliminating Social Poverty and Improving Living Standards"]
    C --> G["Establishment of the Guiding Principles and Creed (1929)"]
    G --> H["Clarification of Corporate Social Mission"]
    H --> I["Postwar Leap and Globalization"]
    I --> J["Establishment of Matsushita Institute of Government and Management, Nurturing the Next Generation"]
    F --> J
```
