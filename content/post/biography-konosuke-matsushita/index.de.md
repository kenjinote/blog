---
title: "Das Leben und die Philosophie von Konosuke Matsushita: Das Vermächtnis des Gottes des Managements für die Zukunft"
date: "2026-09-23T20:59:56+09:00"
categories: ["biography"]
tags: ["konosuke-matsushita", "history"]
image: "eyecatch.jpg"
slug: "biography-konosuke-matsushita"
description: "Konosuke Matsushita, der in der japanischen Industriegeschichte als „Gott des Managements“ bezeichnet wird, beeinflusst auch heute noch viele Geschäftsleute."
---
...
```mermaid
graph TD
    A["Niedergang der Familie und Lehrjahre in der Kindheit"] --> B["Erlernen der Grundlagen der Geschäftswelt und der Dankbarkeit"]
    B --> C["Gründung der Matsushita Electric Housewares Manufacturing Works (1918)"]
    C --> D["Entwicklung von Produkten für die Massen"]
    D --> E["Befürwortung der Leitungswasser-Philosophie"]
    E --> F["Beseitigung von gesellschaftlicher Armut und Verbesserung des Lebensstandards"]
    C --> G["Aufstellung der Leitprinzipien und des Credos (1929)"]
    G --> H["Klärung des sozialen Auftrags des Unternehmens"]
    H --> I["Nachkriegsaufstieg und Globalisierung"]
    I --> J["Gründung des Matsushita Institute of Government and Management, Förderung der nächsten Generation"]
    F --> J
```
