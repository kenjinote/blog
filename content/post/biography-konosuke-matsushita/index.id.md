---
title: "Kehidupan dan Filosofi Konosuke Matsushita: Warisan Dewa Manajemen untuk Masa Depan"
...
```mermaid
graph TD
    A["Kemerosotan Keluarga dan Masa Magang di Masa Kecil"] --> B["Mempelajari Dasar-dasar Bisnis dan Rasa Syukur"]
    B --> C["Pendirian Matsushita Electric Housewares Manufacturing Works (1918)"]
    C --> D["Pengembangan Produk untuk Massa"]
    D --> E["Advokasi Filosofi Air Keran"]
    E --> F["Menghilangkan Kemiskinan Sosial dan Meningkatkan Taraf Hidup"]
    C --> G["Penetapan Prinsip-prinsip Panduan dan Kredo (1929)"]
    G --> H["Klarifikasi Misi Sosial Perusahaan"]
    H --> I["Lompatan Pasca Perang dan Globalisasi"]
    I --> J["Pendirian Matsushita Institute of Government and Management, Membina Generasi Berikutnya"]
    F --> J
```
