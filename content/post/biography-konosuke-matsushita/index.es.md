---
title: "La vida y filosofía de Konosuke Matsushita: El legado del Dios de la Gestión para el futuro"
...
```mermaid
graph TD
    A["Declive de la familia y aprendizaje en la infancia"] --> B["Aprendizaje de los fundamentos empresariales y la gratitud"]
    B --> C["Fundación de Matsushita Electric Housewares Manufacturing Works (1918)"]
    C --> D["Desarrollo de productos para las masas"]
    D --> E["Defensa de la Filosofía del Agua del Grifo"]
    E --> F["Eliminación de la pobreza social y mejora del nivel de vida"]
    C --> G["Establecimiento de los Principios Rectores y el Credo (1929)"]
    G --> H["Clarificación de la misión social corporativa"]
    H --> I["Salto de la posguerra y globalización"]
    I --> J["Establecimiento del Instituto Matsushita de Gobierno y Gestión, formando a la próxima generación"]
    F --> J
```
