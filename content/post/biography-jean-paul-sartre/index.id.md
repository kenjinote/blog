---
title: "Jean-Paul Sartre: Bintang Besar Eksistensialisme dan Perjalanannya"
...
```mermaid
flowchart TD
    Sartre["Jean-Paul Sartre"] --> Philo["Filsafat Eksistensialisme"]
    Philo --> Book1["Ada dan Ketiadaan"]
    Philo --> Action["Engagement (Partisipasi Sosial)"]
    Sartre --> Beauvoir["Simone de Beauvoir"]
    Beauvoir -->|"Pernikahan Kontrak (Kawan intelektual)"| Sartre
    Sartre --> Camus["Albert Camus"]
    Camus -.->|"Perpisahan akibat konflik ideologis"| Sartre
    Sartre --> Nobel["Hadiah Nobel Sastra (1964)"]
    Nobel -->|"Ditolak karena menolak segala otoritas"| Sartre
```
