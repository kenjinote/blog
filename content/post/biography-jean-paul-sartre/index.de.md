---
title: "Jean-Paul Sartre: Der große Stern des Existenzialismus und sein Weg"
...
```mermaid
flowchart TD
    Sartre["Jean-Paul Sartre"] --> Philo["Existenzialistische Philosophie"]
    Philo --> Book1["Das Sein und das Nichts"]
    Philo --> Action["Engagement (Gesellschaftliche Teilnahme)"]
    Sartre --> Beauvoir["Simone de Beauvoir"]
    Beauvoir -->|"Offene Ehe (Intellektuelle Weggefährten)"| Sartre
    Sartre --> Camus["Albert Camus"]
    Camus -.->|"Bruch durch ideologischen Konflikt"| Sartre
    Sartre --> Nobel["Nobelpreis für Literatur (1964)"]
    Nobel -->|"Abgelehnt aus Zurückweisung jeglicher Autorität"| Sartre
```
