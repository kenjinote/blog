---
title: "Jean-Paul Sartre : Le géant de l'existentialisme et sa trajectoire"
...
```mermaid
flowchart TD
    Sartre["Jean-Paul Sartre"] --> Philo["Philosophie existentialiste"]
    Philo --> Book1["L'Être et le Néant"]
    Philo --> Action["Engagement (Participation sociale)"]
    Sartre --> Beauvoir["Simone de Beauvoir"]
    Beauvoir -->|"Mariage de raison (Camarades intellectuels)"| Sartre
    Sartre --> Camus["Albert Camus"]
    Camus -.->|"Séparation due à des conflits idéologiques"| Sartre
    Sartre --> Nobel["Prix Nobel de littérature (1964)"]
    Nobel -->|"Refusé, rejetant toute autorité"| Sartre
```
