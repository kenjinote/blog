---
title: "El padre de la medicina, Hipócrates: su vida y la filosofía que perdura en la actualidad"
...
```mermaid
graph TD
    A["Hipócrates (aprox. 460 a.C. - 370 a.C.)"] --> B["Separación de medicina y religión"]
    A --> C["Propuesta de la teoría de los cuatro humores"]
    A --> D["Establecimiento de la ética médica"]

    B --> E["Enfoque racionalista y científico"]
    C --> F["Teoría básica de la medicina occidental (aprox. 2000 años)"]
    D --> G["Juramento Hipocrático"]

    E --> H["Énfasis en la observación clínica y el registro"]
    F --> I["Sistematización por Galeno y otros"]
    G --> J["Ética médica moderna (bioética)"]

    H --> K["MBE moderna (Medicina Basada en la Evidencia)"]
    I --> L["Autoridad médica hasta el Renacimiento"]
    J --> M["Normas médicas y protección de la privacidad"]
```
