---
title: "Hippocrate, le Père de la Médecine : Sa vie et sa philosophie dans le monde moderne"
...
description: "Dans la Grèce antique, la médecine a longtemps été profondément liée aux prières adressées aux dieux, à la superstition et à la magie."
---
...
```mermaid
graph TD
    A["Hippocrate (env. 460 - 370 av. J.-C.)"] --> B["Séparation de la médecine et de la religion"]
    A --> C["Théorie des quatre humeurs"]
    A --> D["Établissement de l'éthique médicale"]

    B --> E["Approche rationaliste et scientifique"]
    C --> F["Théorie fondamentale de la médecine occidentale (env. 2000 ans)"]
    D --> G["Serment d'Hippocrate"]

    E --> H["Importance de l'observation clinique et de l'enregistrement"]
    F --> I["Systématisation par Galien et d'autres"]
    G --> J["Éthique médicale moderne (bioéthique)"]

    H --> K["EBM moderne (Médecine fondée sur les preuves)"]
    I --> L["Autorité médicale jusqu'à la Renaissance"]
    J --> M["Normes des médecins et protection de la vie privée"]
```
