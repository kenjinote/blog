---
title: "Bapak Kedokteran, Hippocrates: Kehidupannya dan Filosofi yang Hidup di Era Modern"
...
description: "Di Yunani Kuno, kedokteran telah lama dikaitkan dengan doa kepada para dewa, takhayul, dan sihir."
---
...
```mermaid
graph TD
    A["Hippocrates (sekitar 460 SM - sekitar 370 SM)"] --> B["Pemisahan kedokteran dan agama"]
    A --> C["Mengusulkan teori empat cairan"]
    A --> D["Penetapan etika medis"]

    B --> E["Pendekatan rasional dan ilmiah"]
    C --> F["Teori dasar kedokteran Barat (sekitar 2000 tahun)"]
    D --> G["Sumpah Hippocrates"]

    E --> H["Menekankan observasi klinis dan pencatatan"]
    F --> I["Sistematisasi oleh Galenus dan lainnya"]
    G --> J["Etika medis modern (bioetika)"]

    H --> K["EBM Modern (Kedokteran Berbasis Bukti)"]
    I --> L["Otoritas kedokteran hingga masa Renaisans"]
    J --> M["Norma dokter dan perlindungan privasi"]
```
