...
description: "In ancient Greece, medicine was long deeply tied to prayers to the gods, superstitions, and magic."
---
...
```mermaid
graph TD
    A["Hippocrates (c. 460 BC - c. 370 BC)"] --> B["Separation of Medicine and Religion"]
    A --> C["Advocacy of Humorism (Four Humors Theory)"]
    A --> D["Establishment of Medical Ethics"]

    B --> E["Rationalist and Scientific Approach"]
    C --> F["Foundational Theory of Western Medicine (for about 2,000 years)"]
    D --> G["The Hippocratic Oath"]

    E --> H["Emphasis on Clinical Observation and Recording"]
    F --> I["Systematization by Galen and Others"]
    G --> J["Modern Medical Ethics (Bioethics)"]

    H --> K["Modern EBM (Evidence-Based Medicine)"]
    I --> L["Authority in Medicine until the Renaissance"]
    J --> M["Norms for Physicians and Privacy Protection"]
```
