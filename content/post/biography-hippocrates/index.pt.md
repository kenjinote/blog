---
title: "O Pai da Medicina, Hipócrates: Sua Vida e a Filosofia que Vive Hoje"
...
```mermaid
graph TD
    A["Hipócrates (aprox. 460 a.C. - aprox. 370 a.C.)"] --> B["Separação entre medicina e religião"]
    A --> C["Proposição da Teoria dos Humores"]
    A --> D["Estabelecimento da ética médica"]

    B --> E["Abordagem racional e científica"]
    C --> F["Teoria fundamental da medicina ocidental (por cerca de 2.000 anos)"]
    D --> G["O Juramento de Hipócrates"]

    E --> H["Ênfase na observação clínica e registros"]
    F --> I["Sistematização por Galeno e outros"]
    G --> J["Ética médica moderna (Bioética)"]

    H --> K["MBE moderna (Medicina Baseada em Evidências)"]
    I --> L["Autoridade médica até a Renascença"]
    J --> M["Normas para médicos e proteção de privacidade"]
```
