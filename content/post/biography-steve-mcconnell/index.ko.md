...
description: "소프트웨어 개발에 종사하는 사람이라면 《코드 컴플리트》(Code Complete)라는 두꺼운 명저를 본 적이 있을 것입니다. 이 책의 저자인 스티브 맥코넬(Steve McConnell)은 프로그래밍이라는 혼돈스러운 작업에 질서를 가져오고, 진정한 의미의 '소프트웨어 공학'(So"
---
