---
title: "L'héritage de Steve McConnell : Le maître qui a élevé le développement logiciel au rang d'« Ingénierie »"
date: "2026-09-24T16:08:36+09:00"
categories: ["biography"]
tags: ["steve-mcconnell", "history"]
image: "eyecatch.jpg"
slug: "biography-steve-mcconnell"
description: "Quiconque est impliqué dans le développement de logiciels a probablement croisé l'épais et magistral ouvrage intitulé Code Complete."
---
...
```mermaid
graph TD
    SM["Steve McConnell"] --> BK["Auteur & Leader d'opinion"]
    SM --> CS["Construx Software (Fondée en 1996)"]
    
    BK --> CC["Code Complete (1993, 2004)"]
    BK --> RD["Rapid Development (1996)"]
    BK --> SE["Software Estimation (2006)"]
    
    CC --> BP["Meilleures pratiques en codage et construction"]
    RD --> PM["Gestion de projet efficace"]
    SE --> SQ["Méthodes d'estimation scientifique"]
    
    CS --> TR["Formation et conseil pour l'industrie"]
    
    BP --> IF["Faire progresser le génie logiciel"]
    PM --> IF
    SQ --> IF
    TR --> IF
```
