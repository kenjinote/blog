---
title: "Das Vermächtnis von Steve McConnell: Der Meister, der Softwareentwicklung zur 'Ingenieurskunst' erhob"
date: 2026-09-23T19:18:01+09:00
categories: ["biography"]
tags: ["steve-mcconnell", "history"]
image: "eyecatch.jpg"
slug: "biography-steve-mcconnell"
description: "Jeder, der mit Softwareentwicklung zu tun hat, ist wahrscheinlich schon auf das dicke, meisterhafte Buch mit dem Titel Code Complete gestoßen."
---
...
```mermaid
graph TD
    SM["Steve McConnell"] --> BK["Autor & Vordenker"]
    SM --> CS["Construx Software (Gegründet 1996)"]
    
    BK --> CC["Code Complete (1993, 2004)"]
    BK --> RD["Rapid Development (1996)"]
    BK --> SE["Software Estimation (2006)"]
    
    CC --> BP["Best Practices in Codierung & Konstruktion"]
    RD --> PM["Effektives Projektmanagement"]
    SE --> SQ["Wissenschaftliche Schätzmethoden"]
    
    CS --> TR["Branchenschulung & Beratung"]
    
    BP --> IF["Förderung des Software Engineering"]
    PM --> IF
    SQ --> IF
    TR --> IF
```
