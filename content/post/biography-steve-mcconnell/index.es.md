...
description: "Cualquiera que esté involucrado en el desarrollo de software probablemente se haya encontrado con el grueso y magistral libro titulado Code Complete (Códig"
---
...
```mermaid
graph TD
    SM["Steve McConnell"] --> BK["Autor y Líder de Pensamiento"]
    SM --> CS["Construx Software (Fundada en 1996)"]
    
    BK --> CC["Code Complete (1993, 2004)"]
    BK --> RD["Rapid Development (1996)"]
    BK --> SE["Software Estimation (2006)"]
    
    CC --> BP["Mejores prácticas en codificación y construcción"]
    RD --> PM["Gestión de proyectos eficaz"]
    SE --> SQ["Métodos de estimación científica"]
    
    CS --> TR["Formación y consultoría de la industria"]
    
    BP --> IF["Avance de la Ingeniería de Software"]
    PM --> IF
    SQ --> IF
    TR --> IF
```
