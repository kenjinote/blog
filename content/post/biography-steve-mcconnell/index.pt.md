---
title: "O Legado de Steve McConnell: O Mestre que Elevou o Desenvolvimento de Software à 'Engenharia'"
...
description: "Qualquer pessoa envolvida com o desenvolvimento de software provavelmente já se deparou com o livro espesso e magistral intitulado Code Complete."
---
...
```mermaid
graph TD
    SM["Steve McConnell"] --> BK["Autor e Líder de Pensamento"]
    SM --> CS["Construx Software (Fundada em 1996)"]
    
    BK --> CC["Code Complete (1993, 2004)"]
    BK --> RD["Rapid Development (1996)"]
    BK --> SE["Software Estimation (2006)"]
    
    CC --> BP["Melhores práticas em codificação e construção"]
    RD --> PM["Gerenciamento de projetos eficaz"]
    SE --> SQ["Métodos de estimativa científica"]
    
    CS --> TR["Treinamento e consultoria na indústria"]
    
    BP --> IF["Avanço da Engenharia de Software"]
    PM --> IF
    SQ --> IF
    TR --> IF
```
