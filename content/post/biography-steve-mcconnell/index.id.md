---
title: "Warisan Steve McConnell: Sang Master yang Mengangkat Pengembangan Perangkat Lunak menjadi 'Rekayasa'"
date: "2026-09-24T16:08:36+09:00"
categories: ["biography"]
tags: ["steve-mcconnell", "history"]
image: "eyecatch.jpg"
slug: "biography-steve-mcconnell"
description: "Siapa pun yang terlibat dalam pengembangan perangkat lunak kemungkinan besar pernah menemukan buku tebal dan luar biasa berjudul Code Complete."
---
...
```mermaid
graph TD
    SM["Steve McConnell"] --> BK["Penulis & Pemimpin Pemikiran"]
    SM --> CS["Construx Software (Didirikan 1996)"]
    
    BK --> CC["Code Complete (1993, 2004)"]
    BK --> RD["Rapid Development (1996)"]
    BK --> SE["Software Estimation (2006)"]
    
    CC --> BP["Praktik Terbaik dalam Pengkodean & Konstruksi"]
    RD --> PM["Manajemen Proyek yang Efektif"]
    SE --> SQ["Metode Estimasi Ilmiah"]
    
    CS --> TR["Pelatihan & Konsultasi Industri"]
    
    BP --> IF["Memajukan Rekayasa Perangkat Lunak"]
    PM --> IF
    SQ --> IF
    TR --> IF
```
