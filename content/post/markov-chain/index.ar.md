...
إذا لوحظت سلسلة ماركوف لفترة طويلة ( $n \to \infty$ )، فماذا يحدث للتوزيع الاحتمالي للحالات؟ في العديد من [سلاسل ماركوف](https://kenji.blog/p/markov-chain/)، فإنها تتقارب إلى توزيع احتمالي محدد بغض النظر عن الحالة الأولية. يسمى هذا **التوزيع الثابت** .
...
## تطبيقات [سلاسل ماركوف](https://kenji.blog/p/markov-chain/)

لا تقتصر [سلاسل ماركوف](https://kenji.blog/p/markov-chain/) على عالم الرياضيات؛ بل يتم تطبيقها على أنظمة العالم الحقيقي المختلفة.
...
تستند [سلاسل ماركوف](https://kenji.blog/p/markov-chain/) إلى افتراض بسيط ولكنه قوي وهو أن "التنبؤات المستقبلية ممكنة طالما أن المعلومات الحالية متاحة". نظراً لهذه **الخاصية لماركوف** ، يمكن صياغة الظواهر التي تبدو معقدة كمصفوفة احتمالية انتقال، ويمكن استنتاج الاتجاهات طويلة الأجل (التوزيعات الثابتة) رياضياً.
