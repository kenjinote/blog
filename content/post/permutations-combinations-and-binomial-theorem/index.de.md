...
### 3. Die verborgene Verbindung zur Fibonacci-Folge
...
Dies ist keine andere als die **Fibonacci-Folge**, bei der Sie die beiden vorherigen Zahlen addieren, um die nächste zu bilden. Die mystische Folge, die überall in der Natur vorkommt, wie z. B. bei der Anordnung von Sonnenblumenkernen und der Spirale eines Nautilusgehäuses, ist tief in einem Dreieck eingebettet, das lediglich Kombinationen anordnet. Es ist ein sehr schönes und bewegendes Beispiel dafür, wie die Mathematik, ein Produkt des menschlichen logischen Denkens, mit den Gesetzmäßigkeiten der Natur verbunden ist.
