...
# [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de [Pascal](https://kenji.blog/es/p/pascal/): La Hermosa Geometría de los Números

Organizar los coeficientes binomiales que aparecen en la fórmula de expansión del Teorema del Binomio en forma de pirámide de arriba hacia abajo como $n=0, 1, 2, \dots$ se llama el "[Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de [Pascal](https://kenji.blog/es/p/pascal/)". Este triángulo simplemente estructurado va mucho más allá de ser una mera ayuda de cálculo, albergando en su interior innumerables propiedades matemáticas hermosas y profundas.

## Reglas de Construcción del [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de [Pascal](https://kenji.blog/es/p/pascal/)

El [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de [Pascal](https://kenji.blog/es/p/pascal/) comienza colocando un $1$ en el vértice más alto (fila 0). Para las filas que siguen, los $1$s siempre se colocan en ambos extremos, y todos los números internos se construyen de acuerdo con una regla extremadamente simple: "la suma del número de arriba a la izquierda y el número de arriba a la derecha".
...
## Propiedades Asombrosas Ocultas en el [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de [Pascal](https://kenji.blog/es/p/pascal/)

Si observas de cerca el [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de [Pascal](https://kenji.blog/es/p/pascal/), notarás que innumerables regularidades se ocultan dentro. Introduzcamos algunas de ellas.
...
Intenta sumar los números del [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de [Pascal](https://kenji.blog/es/p/pascal/) a lo largo de "líneas diagonales poco profundas". Sorprendentemente, aparece la secuencia $1, 1, 2, 3, 5, 8, 13, 21, \dots$.
...
### 4. Geometría Fractal: [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de Sierpinski

Intenta expandir el [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de [Pascal](https://kenji.blog/es/p/pascal/) enormemente a decenas o cientos de filas, pintando los "números impares" en el interior de negro y dejando los "números pares" en blanco. Entonces, emerge claramente una figura fractal auto-similar llamada el "[Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de Sierpinski".
