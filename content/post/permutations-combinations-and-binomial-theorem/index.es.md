...
Intenta expandir el [Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de Pascal enormemente a decenas o cientos de filas, pintando los "números impares" en el interior de negro y dejando los "números pares" en blanco. Entonces, emerge claramente una figura fractal auto-similar llamada el "[Tri](https://kenji.blog/es/p/sorting-algorithms/)ángulo de Sierpinski".
