...
# मेमोरी प्रबंधन की सच्चाई में आपका स्वागत है: C, [Java](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) और [Rust](https://kenji.blog/hi/p/webassembly-wasm-current-future/) से सुलझती गहराई
...
C भाषा द्वारा लाया गया **मैन्युअल प्रबंधन** की स्वतंत्रता और जिम्मेदारी, [Java](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) द्वारा लोकप्रिय बनाया गया **गार्बेज कलेक्शन** ( GC ) के माध्यम से सुरक्षित स्वचालन, और [Rust](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) द्वारा प्रस्तुत **ओनरशिप** ( Ownership ) के रूप में संकलन-समय सत्यापन का प्रतिमान। इन 3 पूरी तरह से अलग दृष्टिकोणों की तुलना और विश्लेषण करके, हम इस बात की **इतिहास और विकास** के सार तक पहुंचेंगे कि प्रोग्रामिंग भाषाओं ने मेमोरी नामक सीमित संसाधन के साथ कैसे काम किया है।
...
4. **स्टैक सेगमेंट ([Stack](https://kenji.blog/hi/p/c-language-pointers-memory-management-stack-heap/) Segment)** : वह क्षेत्र जहां स्थानीय चर और फ़ंक्शन कॉल संदर्भ (वापसी पता, तर्क, आदि) संग्रहीत किए जाते हैं।
5. **हीप सेगमेंट ([Heap](https://kenji.blog/hi/p/c-language-pointers-memory-management-stack-heap/) Segment)** : प्रोग्राम के निष्पादन के दौरान गतिशील रूप से मेमोरी आवंटित करने का क्षेत्र।
...
2. **डैंगलिंग पॉइंटर (Dangling [Pointer](https://kenji.blog/hi/p/c-language-pointers-memory-management-stack-heap/))** : एक पॉइंटर जो उस मेमोरी क्षेत्र को इंगित करता रहता है जिसे पहले ही `free` द्वारा मुक्त किया जा चुका है। इस पॉइंटर के माध्यम से मेमोरी तक पहुंचने का प्रयास अपरिभाषित व्यवहार (सेगमेंटेशन फॉल्ट, आदि) का कारण बनता है।
...
## 3. [Java](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/): गार्बेज कलेक्शन द्वारा लाई गई क्रांति
...
### 3.2 [Java](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) कोड में मेमोरी का व्यवहार
...
C भाषा का "मैन्युअल प्रबंधन के कारण चरम प्रदर्शन" और [Java](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) का "स्वचालित प्रबंधन के कारण मेमोरी सुरक्षा"। माना जाता था कि ये दोनों लंबे समय से ट्रेड-ऑफ रिलेशनशिप में हैं। हालाँकि, [Rust](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) भाषा ने **"ओनरशिप ( Ownership )"** का अभूतपूर्व मॉडल पेश करके एक बड़ी उपलब्धि हासिल की, जो गार्बेज कलेक्शन को खत्म करते हुए कंपाइल समय पर 100% मेमोरी सुरक्षा की गारंटी देता है।
...
इसके अलावा, [Rust](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) के कंपाइलर में अंतर्निहित **बॉरो चेकर ( Borrow Checker )**, कंपाइल समय पर निम्नलिखित सख्त नियमों को लागू करता है:
...
| **[Java](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/)** | GC (गार्बेज कलेक्शन) | विकास की गति में सुधार, मेमोरी सुरक्षा की गारंटी | STW के कारण लेटेंसी में उतार-चढ़ाव, खराब कैश दक्षता |
...
जब हम सिस्टम डिज़ाइन करते हैं, तो "यह सबसे तेज़ है इसलिए [Rust](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) का उपयोग करें" या "यह सुरक्षित है इसलिए [Java](https://kenji.blog/hi/p/programming-languages-history-paradigm-evolution/) का उपयोग करें" जैसे अल्पकालिक निर्णय लेने के बजाय, एक शीर्ष इंजीनियर का मार्ग सिस्टम की आवश्यकताओं (लेटेंसी की सख्ती, विकास संसाधन, रखरखाव) का मिलान मेमोरी प्रबंधन की **सच्चाई** के साथ करना और सर्वोत्तम तकनीक चुनना है।
