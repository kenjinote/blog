...
# मेमोरी प्रबंधन की सच्चाई में आपका स्वागत है: C, Java और Rust से सुलझती गहराई
...
## 4. Rust: ओनरशिप और बॉरोइंग द्वारा लाया गया तीसरा रास्ता
...
Rust में, जब आप किसी चर को दूसरे चर में असाइन करते हैं, या मान को किसी फ़ंक्शन में पास करते हैं, तो ओनरशिप "स्थानांतरित ( Move )" हो जाता है। मूल चर फिर अप्राप्य हो जाता है (परिणामस्वरूप संकलन त्रुटि होती है)। यह संरचनात्मक रूप से डबल फ्री (Double Free) को असंभव बना देता है।
...
यदि हर ऑपरेशन के साथ ओनरशिप को स्थानांतरित कर दिया जाए, तो प्रोग्रामिंग अत्यंत असुविधाजनक हो जाएगी। ओनरशिप लिए बिना डेटा तक पहुंचने के लिए, Rust में **संदर्भ ( Reference )** और **बॉरोइंग ( Borrowing )** की अवधारणा है।
...
- **C / C++ / Rust** : जब आप संरचनाओं का एक सरणी ( `struct Array[100]` या `Vec<MyStruct>` ) बनाते हैं, तो डेटा को मेमोरी में लगातार बिना किसी अंतराल के रखा जाता है। सरणी पर लूप करते समय, CPU का हार्डवेयर प्रीफ़ेचर पूरी तरह से काम करता है, और कैश हिट दर नाटकीय रूप से बढ़ जाती है।
...
$ h $ को 0.99 (C/Rust दृष्टिकोण) बनाने या इसे 0.5 (Java-जैसे पॉइंटर चेज़िंग) तक कम करने के बीच, एप्लिकेशन की लूप निष्पादन गति में दर्जनों गुना का अंतर है। यही वास्तविक कारण है कि गेम इंजन और उच्च-आवृत्ति ट्रेडिंग सिस्टम में C++ और Rust को चुना जाता है।
...
| **Rust** | ओनरशिप / बॉरो चेकर | शून्य रनटाइम लागत के साथ सुरक्षा, उच्च गति | खड़ी सीखने की अवस्था, लाइफटाइम डिजाइनिंग में कठिनाई |
