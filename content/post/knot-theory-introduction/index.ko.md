...
일반적인 매듭과 수학적 매듭의 가장 큰 차이점은 **양끝이 붙어 있다는 점(폐곡선이라는 점)**에 있습니다. 끝이 고정되어 있지 않다면 어떤 매듭도 결국에는 스르르 풀려버리고 맙니다. 하지만 양끝을 연결하여 고리로 만들면 그 '얽힌 방식'은 고정되며, 자르지 않는 이상 다른 얽힌 방식으로 변화시킬 수 없습니다.
...
그리고 현대에 매듭 이론은 차세대 컴퓨터인 '양자 컴퓨터'의 실현을 향한 가장 중요한 테마 중 하나가 되었습니다.
