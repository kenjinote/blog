...
यह साइलो (silos) होना हमेशा बुरा नहीं होता है। यदि आप स्पष्ट API इंटरफेस के साथ एक स्वतंत्र रूप से परिनियोजित (deployable) [माइक्रोसर्विसेज आर्किटेक्चर](/hi/p/microservices-architecture-bff-api-gateway/) अपनाते हैं, तो टीमों के बीच संचार को जानबूझकर सीमित करने और स्वतंत्रता बढ़ाने की "इन्वर्स कॉनवे मैन्युवर (Inverse Conway Maneuver)" के रूप में अनुशंसा भी की जा सकती है। पूर्ण रिमोट वर्क को स्पष्ट सीमाओं वाले लूज़ली कपल्ड (loosely coupled) सिस्टम विकसित करने के लिए उपयुक्त माना जा सकता है।
...
# असमकालिक संचार ([Asynchronous](https://kenji.blog/hi/p/event-driven-architecture-async/) Communication) की कीमत और संज्ञानात्मक भार
...
## जीरो ट्रस्ट ([BeyondCorp](https://kenji.blog/hi/p/zero-trust-network-architecture-beyond-corp/)) द्वारा पैराडाइम शिफ्ट

इस नेटवर्क सीमा को तोड़ने और सच्चे अर्थों में "एक ऐसा वातावरण जहां आप कहीं से भी आराम से और सुरक्षित रूप से काम कर सकते हैं" का एहसास कराने वाला समाधान **जीरो ट्रस्ट नेटवर्क आर्किटेक्चर ([Zero Trust](https://kenji.blog/hi/p/zero-trust-network-architecture-beyond-corp/) Network Architecture: ZTNA)** है, जिसका प्रतिनिधित्व Google के "BeyondCorp" द्वारा किया जाता है।
