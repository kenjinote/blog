...
В этой статье мы не будем рассматривать бинарную дискуссию «удаленная работа против возвращения в офис» просто как вопрос эмоций или личных предпочтений. Вместо этого мы проведем тщательный анализ через объективную и техническую призму организационной социологии, количественной оценки инженерной производительности (метрики DORA, фреймворк SPACE) и базовой сетевой архитектуры (VPN и [Zero Trust](https://kenji.blog/ru/p/zero-trust-network-architecture-beyond-corp/)). Давайте вместе найдем «истинно оптимальное решение», к которому должны стремиться современные инженерные организации в этой сложной проблеме на стыке технологий и человеческого общества.
...
# Техническая база, поддерживающая удаленную работу: от ограничений VPN к [Zero Trust](https://kenji.blog/ru/p/zero-trust-network-architecture-beyond-corp/)
...
## Сдвиг парадигмы с помощью Zero Trust ([BeyondCorp](https://kenji.blog/ru/p/zero-trust-network-architecture-beyond-corp/))
