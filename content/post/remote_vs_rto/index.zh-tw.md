...
打破這種網路極限，實現真正「無論在何處都能舒適且安全地工作」的環境的，是以 Google 提出的「BeyondCorp」為代表的 **零信任網路架構（[Zero Trust](https://kenji.blog/zh-tw/p/zero-trust-network-architecture-beyond-corp/) Network Architecture: ZTNA）** 。
