...
ما يكمن وراء Signals هو نظرية "البرمجة التفاعلية (Reactive Programming)" التي تنمذج التبعيات بين الحالات والعمليات الحسابية كـ **رسم بياني موجه غير دوري (Directed Acyclic [Graph](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/): DAG)** وتحدد ترتيب التحديثات بكفاءة باستخدام الفرز الطوبولوجي (Topological sort).
