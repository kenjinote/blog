---
title: '【サンプル付き】C++からWindows.AIを呼び出しONNXモデルを実行する方法'
...
image: "img.webp"
categories: ["ツール・開発環境"]
description: 'Windows標準のWindows MLを活用してAI機能にアクセス！Win32アプリのC++環境から「Microsoft.Windows.AI」を呼び出し、ONNX形式のAIモデルを実行する具体的な手順をサンプルコード付きで分かりやすく解説します。'
---
