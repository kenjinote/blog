---
title: 'Pitágoras: La intersección de las matemáticas y el misticismo'
...
```mermaid
graph TD
    A["Samos (Nacimiento)"] --> B["Egipto y Babilonia (Estudio)"]
    B --> C["Crotona (Orden Fundada)"]
    C --> D["Matemáticas y Filosofía"]
    C --> E["Misticismo y Reencarnación"]
```
