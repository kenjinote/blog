---
title: "Marcos do Desenvolvimento de Software: A Trajetória e Filosofia de Martin Fowler"
...
graph TD
    MF["Martin Fowler"]
    MF --> AM["Manifesto Ágil (2001)"]
    MF --> Books["Livros Notáveis"]
    Books --> REF["Refactoring (1999)"]
    Books --> PEAA["PoEAA (2002)"]
    MF --> Concepts["Conceitos Chave"]
    Concepts --> CI["Integração Contínua"]
    Concepts --> MS["Microsserviços"]
    Concepts --> DI["Injeção de Dependência"]
```
