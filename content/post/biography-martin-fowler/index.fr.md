---
title: "Jalons du Développement Logiciel : La Trajectoire et la Philosophie de Martin Fowler"
...
graph TD
    MF["Martin Fowler"]
    MF --> AM["Manifeste Agile (2001)"]
    MF --> Books["Livres Notables"]
    Books --> REF["Refactoring (1999)"]
    Books --> PEAA["PoEAA (2002)"]
    MF --> Concepts["Concepts Clés"]
    Concepts --> CI["Intégration Continue"]
    Concepts --> MS["Microservices"]
    Concepts --> DI["Injection de Dépendances"]
```
