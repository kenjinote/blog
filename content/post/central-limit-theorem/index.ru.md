...
Из независимости получается следующее уравнение. Поскольку предел является характеристической функцией стандартного нормального распределения, сходимость по распределению следует из теоремы непрерывности Леви. Характеристические функции и [производящие функции](/ru/p/generating-functions/) моментов — это разные вещи, и для этого доказательства наличие производящей функции моментов не требуется.
