...
Eine Vervierfachung des Stichprobenumfangs halbiert den Standardfehler. Das Gesetz der großen Zahlen besagt, dass sich der Stichprobenmittelwert $\mu$ nähert, und der zentrale Grenzwertsatz beschreibt die Form der Verteilung, indem die Schwankung darum mit $\sqrt{n}$ multipliziert wird.
