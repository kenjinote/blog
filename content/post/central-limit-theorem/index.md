...
コーシー分布には有限の平均も分散もなく、独立な標準コーシー変数の標本平均も標準コーシー分布のままです。また、すべての $X_i$ が同じ変数に等しい場合は独立性がなく、平均をとってもばらつきは減りません。「$n\ge30$ なら常に十分」という保証もありません。歪みや裾の重さによって必要な標本数は異なります。独立で同分布でない場合の拡張には、リンデベルグ条件やリャプノフ条件など、追加の条件を確認する必要があります。
