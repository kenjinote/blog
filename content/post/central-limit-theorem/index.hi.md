...
डेटा विज्ञान और सांख्यिकी का अध्ययन करते समय, **केंद्रीय सीमा प्रमेय** (सेंट्रल लिमिट थ्योरम - CLT) से बचना असंभव है। इस प्रमेय में लगभग एक जादुई गुण है: "डेटा का वितरण (डिस्ट्रीब्यूशन) चाहे जो भी हो, उसके सैंपल के औसत (मीन) का वितरण नमूना आकार बढ़ने के साथ-साथ एक सामान्य वितरण (नॉर्मल डिस्ट्रीब्यूशन) के करीब पहुँच जाता है।"

इस लेख में, हम केंद्रीय सीमा प्रमेय को व्यापक रूप से समझाएंगे, एक सहज छवि से लेकर एक सख्त गणितीय परिभाषा और व्यावहारिक अनुप्रयोग उदाहरणों तक।

## 2. केंद्रीय सीमा प्रमेय क्या है?

केंद्रीय सीमा प्रमेय (CLT) प्रायिकता सिद्धांत और सांख्यिकी में सबसे शक्तिशाली और आश्चर्यजनक परिणामों में से एक है। सीधे शब्दों में कहें तो, बड़ी संख्या में यादृच्छिक रूप से निकाले गए स्वतंत्र यादृच्छिक चर का योग (या औसत) एक सामान्य वितरण द्वारा अनुमानित होता है, भले ही मूल चर का वितरण कुछ भी रहा हो।
...
मान लें कि नमूना माध्य $\bar{X} = \frac{1}{n} \sum_{i=1}^{n} X_i$ है। केंद्रीय सीमा प्रमेय के अनुसार, जब $n$ पर्याप्त रूप से बड़ा होता है, तो नीचे दिखाया गया मानकीकृत चर $Z$ मानक सामान्य वितरण $\mathcal{N}(0, 1)$ की ओर अभिसरित (कन्वर्ज) होता है।
...
## 3. केंद्रीय सीमा प्रमेय का विज़ुअलाइज़ेशन

केंद्रीय सीमा प्रमेय कैसे काम करता है, इसे दृश्य रूप से समझने के लिए, यहां मर्मेड (Mermaid) का उपयोग करते हुए एक प्रक्रिया आरेख (प्रोसेस डायग्राम) दिया गया है।
...
केंद्रीय सीमा प्रमेय के एक सख्त प्रमाण के लिए अभिलक्षणिक कार्यों (कैरेक्टरिस्टिक फंक्शन्स) और टेलर विस्तार (टेलर एक्सपेंशन) का उपयोग किया जाता है। यहाँ एक संक्षिप्त अवलोकन दिया गया है।
...
### परिशिष्ट 3: मानक त्रुटि (स्टैंडर्ड एरर) और बड़ी संख्याओं का नियम
...
नमूनों की संख्या को चौगुना करने से मानक त्रुटि आधी हो जाती है। बड़ी संख्याओं का नियम (लॉ ऑफ़ लार्ज नंबर्स) बताता है कि नमूना माध्य $\mu$ के करीब पहुंचता है, और केंद्रीय सीमा प्रमेय इसके चारों ओर के उतार-चढ़ाव को $\sqrt{n}$ से गुणा करके वितरण के आकार का वर्णन करता है।
