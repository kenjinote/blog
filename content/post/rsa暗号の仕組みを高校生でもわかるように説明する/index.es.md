...
## 8. Cómo calcular la clave privada $d$: Algoritmo de [Euclides](https://kenji.blog/es/p/euclid/) extendido

En el ejemplo de cálculo a mano, buscamos $k$ por intuición para encontrar $d=103$, pero cuando los números tienen cientos de dígitos, este método es imposible. En los programas reales, se utiliza un algoritmo llamado **"Algoritmo de [Euclides](https://kenji.blog/es/p/euclid/) extendido"**.

Resolver $7d \equiv 1 \pmod{120}$ es lo mismo que encontrar enteros $d, y$ que cumplan con $7d + 120y = 1$. Se puede encontrar esto mecánicamente haciendo el proceso inverso del algoritmo de [Euclides](https://kenji.blog/es/p/euclid/).
