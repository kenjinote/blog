...
## 2. Математические основы [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) 1: Простые числа и факторизация
...
[Леонард Эйлер](https://kenji.blog/ru/p/euler/), используя функцию $\phi(N)$, доказал следующую красивую теорему.
...
Именно эта формула является фундаментальным принципом, на котором строится магия [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/): **"после шифрования и расшифрования мы возвращаемся к исходному значению"**.
...
## 7. Конкретный пример: давайте испытаем [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) вручную, используя небольшие простые числа
...
## 8. Как найти закрытый ключ $d$: Расширенный алгоритм [Евклид](https://kenji.blog/ru/p/euclid/)а

В примере с ручными вычислениями мы нашли $d=103$, подобрав $k$ интуитивно, но если числа состоят из сотен цифр, этот метод не сработает. В реальных программах используется алгоритм, называемый **"расширенным алгоритмом [Евклид](https://kenji.blog/ru/p/euclid/)а"**.

Решить $7d \equiv 1 \pmod{120}$ — это то же самое, что найти целые числа $d$ и $y$, удовлетворяющие уравнению $7d + 120y = 1$. Выполняя алгоритм [Евклид](https://kenji.blog/ru/p/euclid/)а в обратном порядке, это можно вычислить механически.
...
## 9. Другое лицо [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/): Цифровая подпись
...
## 10. [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) на практике в коде
...
Основываясь на знаниях школьной математики, мы разобрали механизмы работы алгоритма [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/).
