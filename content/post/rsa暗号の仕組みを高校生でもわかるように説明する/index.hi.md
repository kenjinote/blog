...
इंटरनेट समाज की सुरक्षा को बुनियादी रूप से समर्थन देने वाली तकनीकों में से एक "[RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन" है। ऑनलाइन शॉपिंग में क्रेडिट कार्ड से भुगतान, दोस्तों के साथ सोशल मीडिया पर बातचीत, कंपनी की गोपनीय जानकारी का आदान-प्रदान, आदि—जिन संचारों का हम प्रतिदिन जाने-अनजाने उपयोग करते हैं, उनमें से अधिकांश इस RSA एन्क्रिप्शन या इसकी उत्तराधिकारी तकनीकों द्वारा सुरक्षित होते हैं।
...
## 2. [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन का समर्थन करने वाला गणितीय आधार 1: अभाज्य संख्याएँ और अभाज्य गुणनखंडन
...
[लियोनहार्ड यूलर](https://kenji.blog/hi/p/euler/) ने इस $\phi(N)$ का उपयोग करके निम्नलिखित सुंदर प्रमेय सिद्ध किया:
...
यह समीकरण ही वह मूल सिद्धांत है जो [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन के इस जादू को काम करने देता है: **"जब आप इसे एन्क्रिप्ट करते हैं और फिर डिक्रिप्ट करते हैं, तो यह अपनी मूल अवस्था में वापस आ जाता है।"**
...
## 7. एक ठोस उदाहरण: आइए छोटी अभाज्य संख्याओं का उपयोग करके हाथ से [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) की गणना करें
...
## 8. निजी कुंजी $d$ कैसे ज्ञात करें: विस्तारित [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिथम

मैन्युअल गणना के उदाहरण में, हमने अनुमान लगाकर $k$ का मान खोजा और $d=103$ प्राप्त किया, लेकिन जब संख्याएँ सैकड़ों अंकों की हो जाती हैं, तो यह विधि असंभव है। वास्तविक प्रोग्रामों में, **"विस्तारित [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिथम"** नामक एल्गोरिथम का उपयोग किया जाता है।

$7d \equiv 1 \pmod{120}$ को हल करने का मतलब ऐसे पूर्णांक $d, y$ ज्ञात करना है जो $7d + 120y = 1$ को संतुष्ट करते हों। [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिथम को उल्टे क्रम में लागू करके, इसकी गणना व्यवस्थित तरीके से की जा सकती है।
...
## 9. [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन का एक और चेहरा: डिजिटल हस्ताक्षर
...
## 10. एक प्रोग्राम के साथ [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन का अनुभव करना
...
हमने हाई स्कूल के गणितीय ज्ञान के आधार पर [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन के तंत्र का खुलासा किया है।
