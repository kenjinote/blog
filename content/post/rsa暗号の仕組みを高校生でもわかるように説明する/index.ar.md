...
## 8. كيفية إيجاد المفتاح السري $d$: [خوارزمية إقليدس](https://kenji.blog/p/euclidean-algorithm/) الممتدة

في مثال الحساب اليدوي، اعتمدنا على التخمين للبحث عن $k$ وإيجاد $d=103$، لكن هذه الطريقة مستحيلة عندما تتكون الأعداد من مئات الأرقام. في البرامج الحقيقية، تُستخدم خوارزمية تسمى **"[خوارزمية إقليدس](https://kenji.blog/p/euclidean-algorithm/) الممتدة"**.

حل التطابق $7d \equiv 1 \pmod{120}$ هو نفسه إيجاد الأعداد الصحيحة $d, y$ التي تحقق المعادلة $7d + 120y = 1$. من خلال الحساب العكسي ل[خوارزمية إقليدس](https://kenji.blog/p/euclidean-algorithm/)، يمكن إيجاد ذلك ميكانيكيًا.
