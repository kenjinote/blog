...
من هنا تبدأ الرياضيات السحرية التي تشكل جوهر تشفير RSA. ستظهر "مبرهنة أويلر"، وهي تعميم لـ "[مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/)".
...
أثبت [ليونهارد أويلر](https://kenji.blog/p/euler/) هذه المبرهنة الجميلة باستخدام $\phi(N)$:

**مبرهنة أويلر:**
عندما يكون العددان الصحيحان $a$ و $N$ أوليين نسبيًا، يتحقق التطابق التالي:
$$ a^{\phi(N)} \equiv 1 \pmod N $$

هذه خاصية مذهلة تعني أن "حاصل ضرب أي عدد $a$ في نفسه $\phi(N)$ مرة ثم قسمته على $N$، سيعطي باقيًا يساوي $1$ دائمًا". (إذا كان $N$ عددًا أوليًا $p$، فإنها تصبح $a^{p-1} \equiv 1 \pmod p$، وتُعرف باسم [مبرهنة فيرما الصغرى](https://kenji.blog/p/fermats-little-theorem/)).
...
## 8. كيفية إيجاد المفتاح السري $d$: [خوارزمية [إقليدس](https://kenji.blog/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة

في مثال الحساب اليدوي، اعتمدنا على التخمين للبحث عن $k$ وإيجاد $d=103$، لكن هذه الطريقة مستحيلة عندما تتكون الأعداد من مئات الأرقام. في البرامج الحقيقية، تُستخدم خوارزمية تسمى **"[خوارزمية [إقليدس](https://kenji.blog/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/) الممتدة"**.

حل التطابق $7d \equiv 1 \pmod{120}$ هو نفسه إيجاد الأعداد الصحيحة $d, y$ التي تحقق المعادلة $7d + 120y = 1$. من خلال الحساب العكسي ل[خوارزمية [إقليدس](https://kenji.blog/p/euclid/)](https://kenji.blog/p/euclidean-algorithm/)، يمكن إيجاد ذلك ميكانيكيًا.
