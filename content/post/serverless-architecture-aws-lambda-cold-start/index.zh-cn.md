...
可以使用[排队论](/zh-cn/p/queuing-theory-basics/)（如 M/M/c 模型），通过数学模型来模拟冷启动发生的概率。
...
- 对于 **突发流量多的[异步处理](/zh-cn/p/event-driven-architecture-async/)** 和 **希望将运营成本最小化的 Web API** ，AWS Lambda 则是不二之选。
