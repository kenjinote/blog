...
我們可以使用[排隊理論](/zh-tw/p/queuing-theory-basics/)（如 M/M/c 模型等）在數學上對冷啟動發生的機率建立模型。
...
- 對於 **突發流量多的[非同步處理](/zh-tw/p/event-driven-architecture-async/)** ，或者 **希望將維運成本降到最低的 Web API** ，AWS Lambda 則是最佳的選擇。
