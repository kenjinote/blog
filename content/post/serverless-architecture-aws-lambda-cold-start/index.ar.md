...
Firecracker هو مراقب أجهزة افتراضية (VMM) يستخدم KVM (الآلة الافتراضية القائمة على النواة) لتشغيل "أجهزة افتراضية صغيرة" (MicroVM) خفيفة الوزن في أجزاء من الألف من الثانية. مكتوب بلغة [Rust](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/)، ومن خلال إزالة نماذج الأجهزة غير الضرورية إلى أقصى حد مقارنة بالأجهزة الافتراضية التقليدية (مثل QEMU)، فإنه يحقق تشغيلًا سريعًا للغاية مع عبء منخفض على الذاكرة.
...
3. **تهيئة بيئة التشغيل**: تبدأ عمليات مثل Node.js، و Python، و [Java](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/)، وما إلى ذلك. تستهلك اللغات التي تستخدم تجميع في الوقت المناسب (JIT) مثل Java و C# وقتًا طويلاً هنا.
...
باستخدام [نظرية الطوابير](/ar/p/queuing-theory-basics/) (مثل نموذج M/M/c)، يمكن وضع نموذج رياضي لاحتمالية حدوث بداية باردة.
...
- **المجموعة الأسرع**: لغات التجميع المسبق (AOT) مثل [Go](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/)، و [Rust](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/)، و C++، ولغات البرمجة النصية خفيفة الوزن (Python، و Node.js). تميل البدايات الباردة هنا إلى أن تستغرق مئات المللي ثانية أو أقل.
...
جاء **AWS Lambda SnapStart** كمنقذ للغات ذات بدء التشغيل البطيء مثل [Java](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/). هذه تقنية رائدة تأخذ لقطة لحالة الآلة الافتراضية وتستعيدها أثناء البداية الباردة.
...
عند تمكين SnapStart، يتم تسريع وقت البداية الباردة لوظائف [Java](https://kenji.blog/ar/p/programming-languages-history-paradigm-evolution/) بما يصل إلى **10 أضعاف أو أكثر**. ويرجع ذلك إلى أن بدء تشغيل بيئة التشغيل، وتجميع JIT، وتهيئة أطر العمل الثقيلة مثل Spring Boot يتم تقديمها إلى "وقت النشر".
