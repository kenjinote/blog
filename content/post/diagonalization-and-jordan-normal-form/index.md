...
対角化とよく似た行列の分解手法として **特異値分解 (SVD)** があります。これら二つの手法は、目的と適用範囲が異なります。
...
対角化の強力な応用例として、離散力学系およびマルコフ連鎖が挙げられます。
...
工学の分野、とりわけ現代制御理論においても、対角化とジョルダン標準形は中心的な役割を果たします。線形時不変システム（LTIシステム）は、状態空間表現を用いて以下のように記述されます。
