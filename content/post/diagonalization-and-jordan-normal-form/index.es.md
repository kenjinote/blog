...
## Teorema de Cayley-Hamilton y el polinomio mínimo

Para comprender mejor, consideramos polinomios de matrices. Toda matriz $A$ satisface su polinomio característico $p(\lambda) = \det(\lambda I - A)$, o sea $p(A) = 0$. Esto es el **Teorema de Cayley-Hamilton**.
...
## Diferencia con la Descomposición en Valores Singulares (SVD)

Similar es la **Descomposición en Valores Singulares (SVD)**.
