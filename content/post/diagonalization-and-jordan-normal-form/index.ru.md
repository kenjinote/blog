...
## [Теорема Кэли-Гамильтона](https://kenji.blog/ru/p/cayley-hamilton-theorem/) и минимальный многочлен
...
[SVD](/ru/p/singular-value-decomposition/) $A = U \Sigma V^*$ применимо к любым матрицам $m \times n$. Диагонализация применяется только к квадратным и нужна для возведения в степень.
...
[Диагонализация и жорданова нормальная форма](https://kenji.blog/ru/p/diagonalization-and-jordan-normal-form/) — это ключ к пониманию сложных систем в математике, физике и инженерии.
