...
जब आप PowerShell में `Get-Content` का उपयोग करते हैं और रेगुलर एक्सप्रेशन (regular expressions) का उपयोग करके इसे पंक्ति-दर-पंक्ति पार्स करते हैं, तो ऑब्जेक्ट निर्माण और कचरा संग्रहण ([Garbage Collection](https://kenji.blog/hi/p/memory-management-garbage-collection/): GC) के ओवरहेड के कारण CPU समय की बड़ी मात्रा का उपभोग होता है।
