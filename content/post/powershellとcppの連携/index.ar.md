...
عند استخدام `Get-Content` في PowerShell وتحليل سطر بسطر باستخدام التعبيرات النمطية (Regular Expressions)، يتم استهلاك قدر كبير من وقت وحدة المعالجة المركزية بسبب العبء الإضافي لإنشاء الكائنات وجمع القمامة ([Garbage Collection](https://kenji.blog/ar/p/memory-management-garbage-collection/) أو GC).
