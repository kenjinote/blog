---
title: "La Ley de Moore: El futuro tejido por los semiconductores y la evolución exponencial"
description: "Cómo la \"Ley de Moore\" ha impulsado la industria de los semiconductores y ha logrado la evolución tecnológica exponencial en la sociedad moderna. Explicamos detalladamente su historia, mecanismos, límites y tecnologías del futuro."
...
```mermaid
graph TD
    A["Artículo de Gordon Moore en 1965"] -- "Predicción" --> B["Duplicación del número de transistores"]
    B -- "Cada 18-24 meses" --> C["Crecimiento exponencial de la capacidad de computación"]
    C -- "Provoca" --> D["La revolución del PC y el Internet"]
    C -- "Provoca" --> E["Los teléfonos inteligentes y la nube"]
    C -- "Provoca" --> F["La IA generativa y el aprendizaje profundo"]
```
...
```mermaid
graph LR
    A["Llegada de los límites físicos y económicos"] -- "Solución" --> B["Innovación en arquitectura y empaquetado"]
    B -- "Transistores GAA" --> C["Supresión de la corriente de fuga y continuación de la miniaturización"]
    B -- "Tecnología de chiplets" --> D["Mejora del rendimiento y optimización de costos"]
    B -- "Apilamiento 3D (TSV/HBM)" --> E["Mejora espectacular del ancho de banda de memoria y ahorro de energía"]
    C -- "Computación de próxima generación" --> F["Evolución en los dominios de IA / HPC"]
    D -- "Computación de próxima generación" --> F
    E -- "Computación de próxima generación" --> F
```
