...
# [群、环、域：不仅仅是数字，更是抽象“结构”本身的现代代数入门](https://kenji.blog/zh-cn/p/groups-rings-and-fields/)
...
如果满足交换律 $a \cdot b = b \cdot a$，则称为 **交换群** 或 **阿贝尔群 ([Abel](https://kenji.blog/zh-cn/p/abel/)ian Group)**。
