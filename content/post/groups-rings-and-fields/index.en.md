...
1. **[Crypto](https://kenji.blog/en/p/cryptocurrency-and-bitcoin/)graphy and Finite Fields**
   The reason we can securely communicate over the Internet is thanks to technologies like [RSA](https://kenji.blog/en/p/modern-cryptography-public-key-hash-signature/) and elliptic curve cryptography. These directly apply the properties of algebraic structures like "finite fields" and "groups" (such as the difficulty of the discrete logarithm problem) rather than real numbers.
