...
体論のさらに先にあるのが、代数学の金字塔とも言える **[ガロア理論](https://kenji.blog/p/galois-theory/) ([Galois Theory](/p/galois-theory/))** です。フランスの天才数学者[エヴァリスト・ガロア](https://kenji.blog/p/galois/)は、「方程式が代数的に解けるための条件」を明らかにするために、群論と体論を融合させました。
...
1. **暗号理論と有限体**
   私たちがインターネットで安全に通信できるのは、[RSA](https://kenji.blog/p/modern-cryptography-public-key-hash-signature/)暗号や[楕円曲線暗号](/p/elliptic-curve-cryptography-math-cpp/)といった技術のおかげです。これらは実数ではなく、「有限体」や「群」という代数構造の性質（離散対数問題の難しさなど）を直接応用しています。

2. **物理学と群論**
   現代物理学、特に素粒子物理学や量子力学において、「群論」は宇宙の法則を記述する言語です。粒子の対称性や保存則（エネルギー保存の法則など）は、物理系が持つ「対称群」や「リー群 (Lie Group)」の性質として数学的に証明されます。

3. **[誤り訂正符号](/p/error-correcting-codes-explained/)**
   CDやDVD、QRコード、深宇宙探査機との通信などにおいて、データがノイズで壊れた際にそれを復元する「[誤り訂正符号](/p/error-correcting-codes-explained/)」。ここでも有限体上の多項式環やベクトル空間の理論が使われています。
