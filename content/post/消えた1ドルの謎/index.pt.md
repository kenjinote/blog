...
| Débito | Crédito |
| :--- | :--- |
| Adiantamento: $30 | Receita de Vendas (Sales): $25<br>Recepcionista (Caixa): $5 |
...
| Débito | Crédito |
| :--- | :--- |
| Reembolso aos clientes: $3<br>Perda por desvio (Loss): $2 | Recepcionista (Caixa): $5 |
...
```mermaid
pie title Destino final dos 30 dólares iniciais (Lado dos Ativos)
    "Caixa do hotel (Vendas 25 dólares)" : 25
    "Carteira dos clientes (Reembolso 3 dólares)" : 3
    "Bolso do garçom (Desvio 2 dólares)" : 2
```
