...
description: "Walt Disney (Walter Elias Disney) est un \"créateur de rêves\" emblématique du XXe siècle, dont la portée dépasse largement le cadre d'un simple animateur ou"
---
...
```mermaid
graph TD
    W["Walt Disney (1901-1966)"] --> O["Oswald le lapin chanceux (Perte des droits)"]
    O --> M["Création de Mickey Mouse (1928)"]
    M --> S["Silly Symphonies et innovation technologique"]
    S --> SW["Blanche-Neige (1937) - Long métrage d'animation"]
    SW --> T["Prises de vues réelles et expansion télévisuelle"]
    T --> D["Disneyland (1955)"]
    D --> E["Vision d'EPCOT (La ville de demain)"]
    E --> L["Empire mondial de Disney"]
```
