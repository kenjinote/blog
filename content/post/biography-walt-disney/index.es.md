...
description: "Walt Disney (Walter Elias Disney) no se limitó a ser un mero animador o productor de cine; es un \"creador de sueños\" que representa el siglo XX."
---
...
```mermaid
graph TD
    W["Walt Disney (1901-1966)"] --> O["Oswald el conejo afortunado (Pérdida de derechos)"]
    O --> M["Creación de Mickey Mouse (1928)"]
    M --> S["Silly Symphonies e innovación tecnológica"]
    S --> SW["Blancanieves (1937) - Animación de largometraje"]
    SW --> T["Acción en vivo y expansión en televisión"]
    T --> D["Disneylandia (1955)"]
    D --> E["Visión de EPCOT (Ciudad del mañana)"]
    E --> L["Imperio global de Disney"]
```
