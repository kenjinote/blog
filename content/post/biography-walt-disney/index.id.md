---
title: "Pria yang Mewujudkan Mimpi: Kehidupan dan Perjalanan Kreatif Walt Disney"
date: 2026-09-23T20:51:46+09:00
categories: ["biography"]
tags: ["walt-disney", "history"]
image: "eyecatch.jpg"
slug: "biography-walt-disney"
description: "Walt Disney (Walter Elias Disney) bukan hanya sekadar animator atau produser film, melainkan \"Pencipta Mimpi\" perwakilan abad ke-20."
---
...
```mermaid
graph TD
    W["Walt Disney (1901-1966)"] --> O["Oswald the Lucky Rabbit (Kehilangan Hak Cipta)"]
    O --> M["Penciptaan Mickey Mouse (1928)"]
    M --> S["Silly Symphonies & Inovasi Teknologi"]
    S --> SW["Snow White (1937) - Animasi Panjang"]
    SW --> T["Live-Action & Ekspansi TV"]
    T --> D["Disneyland (1955)"]
    D --> E["Visi EPCOT (Kota Masa Depan)"]
    E --> L["Kerajaan Disney Global"]
```
