---
title: 'أمر لا بد منه لمطوري تطبيقات Windows! كيفية إضافة شهادة ذاتية التوقيع إلى MSIX وتثبيته محلياً'
slug: "msixにشهادة موقعة ذاتياをつけてتثبيتできるようにする"
date: 2025-08-30T04:18:04+09:00
tags: ["msix", "شهادة ذاتية", "تثبيت"]
draft: false
image: "img.webp"
categories: ["تكنولوجيا المعلومات"]
description: 'نشرح بوضوح وبخطوات محددة، مع أوامر PowerShell، كيفية إنشاء وإضافة شهادة ذاتية التوقيع إلى حزم MSIX، المفيدة لتوزيع تطبيقات Windows للاختبار، وجعلها قابلة للتثبيت في بيئة محلية دون استخدام شهادة تجارية.'
---
