...
```mermaid
graph TD
    A["Charles Chaplin"] --> B["Pobreza en la infancia y experiencia en la pantomima"]
    B --> C["Nacimiento de El vagabundo (The Tramp)"]
    C --> D["Fundación de United Artists"]
    D --> E["El Chico y Luces de la ciudad (Fusión de patetismo y risas)"]
    D --> F["Tiempos modernos (Crítica a la civilización de las máquinas)"]
    D --> G["El Gran Dictador (Resistencia al fascismo)"]
    F --> H["Exilio de EE. UU. debido a la caza de brujas"]
    G --> H
    H --> I["Vida en el exilio en Suiza y Candilejas"]
    I --> J["Premio Honorífico de la Academia en 1972 y reconciliación con Hollywood"]
    J --> K["Eterno Rey de la Comedia brillando en la historia del cine"]
```
