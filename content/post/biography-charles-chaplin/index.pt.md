---
title: "【Biografia】 Charles Chaplin: A vida e a filosofia do 'Rei da Comédia' que teceu o mundo com risos e lágrimas"
...
```mermaid
graph TD
    A["Charles Chaplin"] --> B["Pobreza na infância e experiência com pantomima"]
    B --> C["Nascimento de O Vagabundo (The Tramp)"]
    C --> D["Fundação da United Artists"]
    D --> E["O Garoto e Luzes da Cidade (Fusão de pathos e riso)"]
    D --> F["Tempos Modernos (Crítica à civilização mecânica)"]
    D --> G["O Grande Ditador (Resistência ao fascismo)"]
    F --> H["Exílio da América devido à Ameaça Vermelha"]
    G --> H
    H --> I["Vida no exílio na Suíça e Luzes da Ribalta"]
    I --> J["1972 Oscar Honorário e reconciliação com Hollywood"]
    J --> K["Eterno Rei da Comédia brilhando na história do cinema"]
```
