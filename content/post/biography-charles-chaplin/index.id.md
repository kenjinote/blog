...
```mermaid
graph TD
    A["Charles Chaplin"] --> B["Kemiskinan Masa Kecil dan Pengalaman Pantomim"]
    B --> C["Kelahiran The Tramp (Si Gelandangan)"]
    C --> D["Pendirian United Artists"]
    D --> E["The Kid & City Lights (Perpaduan Pathos dan Tawa)"]
    D --> F["Modern Times (Kritik terhadap Peradaban Mesin)"]
    D --> G["The Great Dictator (Perlawanan terhadap Fasisme)"]
    F --> H["Pengasingan dari Amerika akibat Ketakutan Merah"]
    G --> H
    H --> I["Kehidupan Pengasingan di Swiss dan Limelight"]
    I --> J["1972 Penghargaan Kehormatan Academy Award & Rekonsiliasi"]
    J --> K["Raja Komedi Abadi dalam Sejarah Film"]
```
