...
Pendant ses années d'études à l'Université de Cambridge, Newton a lu attentivement l'« Arithmetica Infinitorum » de [Wallis](https://kenji.blog/fr/p/wallis/) et en fut profondément impressionné. En généralisant et en développant davantage la méthode d'interpolation de Wallis, Newton a découvert le **théorème du binôme généralisé** pour n'importe quelle puissance rationnelle. De plus, en faisant progresser le concept algébrique de limites de [Wallis](https://kenji.blog/fr/p/wallis/), il est finalement parvenu à la fondation du **calcul**.
