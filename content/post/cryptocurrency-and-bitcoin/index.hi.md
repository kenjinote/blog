...
शीर्षक था "Bitcoin: A Peer-to-Peer Electronic Cash System" (बिटकॉइन: एक [P2P](https://kenji.blog/hi/p/webrtc-realtime-communication-p2p/) इलेक्ट्रॉनिक नकद प्रणाली)। 9-पृष्ठों के इस पेपर में यह दर्शाया गया था कि पिछले इलेक्ट्रॉनिक धन प्रयासों को परेशान करने वाली डबल-स्पेंडिंग समस्या को **प्रूफ-ऑफ़-वर्क (Proof of Work: [PoW](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/))** नामक तंत्र का उपयोग करके पूरी तरह से विकेंद्रीकृत तरीके से कैसे हल किया जा सकता है।
...
## 3. ब्लॉकचेन आर्किटेक्चर ([Blockchain](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/) Architecture)

बिटकॉइन को शक्ति प्रदान करने वाली मुख्य तकनीक "[ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) (Blockchain)" है। [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/), डिस्ट्रिब्यूटेड लेजर टेक्नोलॉजी ([Distributed Ledger](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/) Technology: DLT) का एक रूप है, जहां डेटा को "ब्लॉक" नामक इकाइयों में समूहीकृत किया जाता है और वे क्रिप्टोग्राफिक रूप से एक श्रृंखला (chain) की तरह एक साथ जुड़े होते हैं।
...
एक ब्लॉक में मुख्य रूप से एक "ब्लॉक हेडर (Block Header)" और "ट्रांजैक्शन डेटा ([Transaction](https://kenji.blog/hi/p/rdbms-transaction-acid-isolation-level-lock/) Data)" होता है।
...
[ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) में, ब्लॉक आकार को सीमित रखने और डेटा से छेड़छाड़ का कुशलतापूर्वक पता लगाने के लिए **मर्केल ट्री (Merkle [Tree](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))** नामक डेटा संरचना का उपयोग किया जाता है। मर्केल ट्री एक प्रकार का बाइनरी ट्री (binary tree) है जहां लीफ नोड्स (leaf nodes) में प्रत्येक लेन-देन का हैश मान होता है, और पेरेंट नोड्स (parent nodes) चाइल्ड नोड्स (child nodes) के हैश मानों को जोड़कर फिर से हैश किए गए मान होते हैं।
...
### सार्वजनिक-कुंजी क्रिप्टोग्राफी ([Public Key](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) [Cryptography](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)) और डिजिटल हस्ताक्षर
...
जब ऐलिस (Alice) बॉब (Bob) को बिटकॉइन भेजती है, तो ऐलिस लेन-देन डेटा के लिए एक **डिजिटल हस्ताक्षर ([Digital Signature](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/))** बनाने के लिए अपनी निजी कुंजी का उपयोग करती है। नेटवर्क के भागीदार ऐलिस की सार्वजनिक कुंजी का उपयोग करके यह सत्यापित कर सकते हैं कि क्या वह हस्ताक्षर वैध है (यानी, क्या यह वास्तव में ऐलिस द्वारा उसकी निजी कुंजी का उपयोग करके बनाया गया था)।

### एलाप्टिक कर्व क्रिप्टोग्राफी (Elliptic Curve Cryptography: ECC) और secp256k1

बिटकॉइन में सार्वजनिक कुंजी निर्माण और डिजिटल हस्ताक्षर के लिए [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन के बजाय **एलाप्टिक कर्व क्रिप्टोग्राफी ([ECC](/hi/p/elliptic-curve-cryptography-math-cpp/))** का उपयोग किया जाता है। [ECC](/hi/p/elliptic-curve-cryptography-math-cpp/) का यह लाभ है कि यह RSA की तुलना में बहुत छोटी कुंजी लंबाई के साथ समकक्ष सुरक्षा स्तर प्रदान कर सकता है।
...
## 5. सर्वसम्मति एल्गोरिथ्म ([Consensus Algorithm](https://kenji.blog/hi/p/byzantine-generals-problem-consensus/)) और प्रूफ-ऑफ़-वर्क ([PoW](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/))
...
### बीजान्टिन जनरल्स की समस्या ([Byzantine Generals](https://kenji.blog/hi/p/byzantine-generals-problem-consensus/) Problem)
...
बिटकॉइन ने **प्रूफ-ऑफ़-वर्क ([PoW](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/))** और **सबसे लंबी श्रृंखला के नियम (Longest Chain Rule)** को मिलाकर व्यावहारिक रूप से इस समस्या को हल किया है।
...
लक्ष्य का मान जितना छोटा होगा, शर्त को पूरा करने वाला हैश खोजने की संभावना उतनी ही कम होगी। यदि लक्ष्य ऐसा मान है जिसके शुरुआत में $k$ शून्य (zeros) आवश्यक हैं, तो उस ब्लॉक को खोजने के लिए आवश्यक औसत गणनाओं की संख्या $2^k$ होगी। यह विशाल कम्प्यूटेशनल ऊर्जा का निवेश ही है जो [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) के पिछले रिकॉर्ड के साथ छेड़छाड़ करना असंभव बनाता है।
...
बिटकॉइन लेन-देन बैंक खाते के शेष राशि (खाता-आधारित मॉडल) जैसे तंत्र का उपयोग नहीं करते हैं, बल्कि **UTXO (Unspent [Transaction](https://kenji.blog/hi/p/rdbms-transaction-acid-isolation-level-lock/) Output: खर्च न किया गया लेन-देन आउटपुट)** मॉडल को अपनाते हैं।
...
[ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) प्रोटोकॉल को अपग्रेड करते समय, "फोर्क (विभाजन)" नामक एक घटना घटित हो सकती है।
...
लाइटनिंग नेटवर्क में, प्रतिभागी एक-दूसरे के साथ [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) के बाहर (ऑफ-चेन) "पेमेंट चैनल (Payment Channel)" खोलते हैं। चैनल के भीतर, जब तक दोनों पक्ष सहमत हों, तब तक [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) पर लेन-देन दर्ज किए बिना तुरंत और लगभग मुफ्त में धन का आदान-प्रदान किया जा सकता है। केवल अंतिम शेष राशि के निपटान के समय, लेन-देन [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) (लेयर 1) पर दर्ज किया जाता है।

### प्रूफ-ऑफ़-स्टेक ([PoS](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/)) के साथ तुलना

[PoW](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/) की एक और बड़ी चुनौती खनन द्वारा की जाने वाली भारी बिजली की खपत है। इस पर्यावरणीय समस्या के समाधान के रूप में, इथेरियम (Ethereum) जैसी प्रणालियाँ **प्रूफ-ऑफ़-स्टेक (Proof of Stake: PoS)** नामक एक अन्य सर्वसम्मति एल्गोरिथ्म पर स्थानांतरित हो गई हैं।
...
पिछले अध्यायों में चर्चा किए गए SHA-256 और एलाप्टिक कर्व क्रिप्टोग्राफी ([ECC](/hi/p/elliptic-curve-cryptography-math-cpp/)) के पीछे, सूचना-सैद्धांतिक सुरक्षा और कम्प्यूटेशनल सुरक्षा के दो प्रतिमान (paradigms) मौजूद हैं। बिटकॉइन सहित आधुनिक क्रिप्टोकरेंसी मुख्य रूप से कम्प्यूटेशनल सुरक्षा (Computational Security) पर निर्भर करती हैं।
...
1994 में पीटर शोर (Peter Shor) द्वारा प्रकाशित "शोर का एल्गोरिथ्म ([Shor's Algorithm](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/))" ने गणितीय रूप से साबित कर दिया कि एक क्वांटम कंप्यूटर का उपयोग करके, प्राइम फैक्टराइजेशन समस्या (प्राइम फैक्टराइजेशन - [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन का आधार) और डिस्क्रीट लॉगरिथम समस्या ([ECC](/hi/p/elliptic-curve-cryptography-math-cpp/) का आधार) को बहुपद समय (polynomial time) $\mathcal{O}(n^3)$ में हल किया जा सकता है।
...
2. **क्वांटम-प्रतिरोधी क्रिप्टोग्राफी (Post-Quantum [Cryptography](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/): PQC) में संक्रमण** : क्वांटम कंप्यूटरों के व्यावहारिक होने से पहले, बिटकॉइन प्रोटोकॉल को हार्ड फोर्क (hard fork) के माध्यम से अपग्रेड करने की चर्चा हो रही है। यह NIST (अमेरिकी राष्ट्रीय मानक और प्रौद्योगिकी संस्थान) द्वारा चयनित लैटिस-आधारित क्रिप्टोग्राफी ([Lattice-based cryptography](/hi/p/lattice-based-cryptography-math-intuition/)) या मल्टीवेरिएट पॉलीनोमियल क्रिप्टोग्राफी (Multivariate polynomial cryptography) जैसे नए हस्ताक्षर एल्गोरिदम पर स्थानांतरित होगा, जिसे क्वांटम कंप्यूटरों द्वारा भी क्रैक करना मुश्किल है।

## 9. नेटवर्क टोपोलॉजी और [P2P](https://kenji.blog/hi/p/webrtc-realtime-communication-p2p/) प्रोटोकॉल विवरण
...
- **पूर्ण नोड (Full Node)** : एक नोड जो जेनेसिस ब्लॉक से लेकर नवीनतम ब्लॉक तक सभी [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) डेटा (सैकड़ों GB या अधिक) को डाउनलोड और सत्यापित करता है। यह नेटवर्क की सुरक्षा का मूल आधार है क्योंकि यह स्वतंत्र रूप से लेन-देन की वैधता और डबल-स्पेंडिंग की अनुपस्थिति की जांच करता है।
- **SPV नोड (Simplified Payment Verification Node)** : एक हल्का नोड जो पूरे [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) के बजाय केवल ब्लॉक हेडर डाउनलोड करता है। यह मुख्य रूप से स्मार्टफोन वॉलेट आदि के लिए उपयोग किया जाता है। यह पुष्टि कर सकता है कि उसका अपना लेन-देन एक ब्लॉक में शामिल है (मर्केल पथ का सत्यापन), लेकिन इसमें पूर्ण नोड के समान सत्यापन क्षमताएं नहीं हैं।
- **माइनिंग नोड (Mining Node)** : एक नोड जो [PoW](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/) गणना करता है और नए ब्लॉक बनाता है। वर्तमान में, ASIC (Application Specific Integrated Circuit) नामक समर्पित माइनिंग हार्डवेयर से युक्त विशाल "माइनिंग पूल (Mining Pool)" यह भूमिका निभाते हैं।
...
[ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) के लिए सबसे बड़ा खतरा **51% अटैक** माना जाता है। यदि एक दुर्भावनापूर्ण एकल इकाई संपूर्ण नेटवर्क की कम्प्यूटेशनल शक्ति (हैश रेट) के आधे से अधिक (51% या अधिक) को नियंत्रित करती है, तो निम्नलिखित कार्य संभव हो जाते हैं:
...
पहली नज़र में, [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) तकनीक गणित और कोड का एक जटिल द्रव्यमान लग सकती है, लेकिन इसका सार है **"अधिकार पर भरोसा किए बिना गणित और भौतिकी के नियमों पर आधारित, मानवता के लिए एक नई सर्वसम्मति-निर्माण प्रणाली"**।
...
यदि आप इस लेख को पढ़ने के बाद [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) तकनीक और क्रिप्टोग्राफी के बारे में अधिक गहराई से जानना चाहते हैं, तो यहां कुछ अनुशंसित संसाधन दिए गए हैं।

### अवश्य पढ़े जाने वाले मूल पेपर (Whitepapers)
- **Bitcoin: A Peer-to-Peer Electronic Cash System** (Satoshi Nakamoto, 2008)
  - वह स्मारकीय पेपर जहां से यह सब शुरू हुआ। केवल 9 पृष्ठों में, PoW, इंसेंटिव (प्रोत्साहन) और मर्केल ट्री (Merkle [Tree](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) को मिलाकर एक डिस्ट्रिब्यूटेड लेजर (distributed ledger) का मूल डिज़ाइन पूरी तरह से वर्णित किया गया है।
...
1. **अमूर्त बीजगणित (Abstract Algebra: Group, Ring, Field)** : विशेष रूप से, परिमित क्षेत्र (Galois Field) की अवधारणा एलाप्टिक कर्व क्रिप्टोग्राफी (Elliptic Curve [Cryptography](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)) को समझने के लिए अपरिहार्य है।
...
3. **गेम थ्योरी (Game theory)** : यह नैश इक्विलिब्रियम (Nash Equilibrium) और बीजान्टिन जनरल्स समस्या ([Byzantine Generals](https://kenji.blog/hi/p/byzantine-generals-problem-consensus/) Problem) जैसे प्रतिभागियों के प्रोत्साहन डिज़ाइन (incentive design) को गणितीय रूप से मॉडल करने के लिए एक ढांचा प्रदान करता है।
...
[ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) की तकनीकी खोज कंप्यूटर विज्ञान, अर्थशास्त्र और समाजशास्त्र के चौराहे पर ज्ञान का एक नया फ्रंटियर (frontier) है। कोड पढ़कर, अपना खुद का नोड सेट करके, और टेस्टनेट (testnet) पर लेन-देन करके, आप इस तकनीक की वास्तविक क्षमता और इसकी सीमाओं का प्रत्यक्ष अनुभव प्राप्त कर सकेंगे।
