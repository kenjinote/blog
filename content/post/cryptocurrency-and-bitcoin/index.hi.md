...
शीर्षक था "Bitcoin: A Peer-to-Peer Electronic Cash System" (बिटकॉइन: एक [P2P](https://kenji.blog/hi/p/webrtc-realtime-communication-p2p/) इलेक्ट्रॉनिक नकद प्रणाली)। 9-पृष्ठों के इस पेपर में यह दर्शाया गया था कि पिछले इलेक्ट्रॉनिक धन प्रयासों को परेशान करने वाली डबल-स्पेंडिंग समस्या को **प्रूफ-ऑफ़-वर्क (Proof of Work: PoW)** नामक तंत्र का उपयोग करके पूरी तरह से विकेंद्रीकृत तरीके से कैसे हल किया जा सकता है।
...
## 5. सर्वसम्मति एल्गोरिथ्म ([Consensus Algorithm](https://kenji.blog/hi/p/byzantine-generals-problem-consensus/)) और प्रूफ-ऑफ़-वर्क (PoW)
