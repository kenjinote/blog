...
बिटकॉइन को शक्ति प्रदान करने वाली मुख्य तकनीक "ब्लॉकचेन (Blockchain)" है। ब्लॉकचेन, डिस्ट्रिब्यूटेड लेजर टेक्नोलॉजी ([Distributed Ledger](https://kenji.blog/hi/p/blockchain-technology-smart-contract-distributed-ledger/) Technology: DLT) का एक रूप है, जहां डेटा को "ब्लॉक" नामक इकाइयों में समूहीकृत किया जाता है और वे क्रिप्टोग्राफिक रूप से एक श्रृंखला (chain) की तरह एक साथ जुड़े होते हैं।
...
बिटकॉइन में सार्वजनिक कुंजी निर्माण और डिजिटल हस्ताक्षर के लिए [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन के बजाय **एलाप्टिक कर्व क्रिप्टोग्राफी (ECC)** का उपयोग किया जाता है। ECC का यह लाभ है कि यह RSA की तुलना में बहुत छोटी कुंजी लंबाई के साथ समकक्ष सुरक्षा स्तर प्रदान कर सकता है।
...
1994 में पीटर शोर (Peter Shor) द्वारा प्रकाशित "शोर का एल्गोरिथ्म ([Shor's Algorithm](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/))" ने गणितीय रूप से साबित कर दिया कि एक क्वांटम कंप्यूटर का उपयोग करके, प्राइम फैक्टराइजेशन समस्या (प्राइम फैक्टराइजेशन - [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन का आधार) और डिस्क्रीट लॉगरिथम समस्या (ECC का आधार) को बहुपद समय (polynomial time) $\mathcal{O}(n^3)$ में हल किया जा सकता है।
