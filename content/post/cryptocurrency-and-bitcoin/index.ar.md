...
لم يولد البيتكوين كطفرة مفاجئة. وراء ذلك تاريخ يمتد لعقود من علم التشفير وحركة أيديولوجية [للمهندسين](/ar/p/prompt-engineering-for-engineers/) الذين يقدرون الخصوصية.
...
كان العنوان "Bitcoin: A Peer-to-Peer Electronic Cash System" (البيتكوين: نظام نقد إلكتروني من ند لند). أظهرت هذه الورقة المكونة من 9 صفحات كيفية حل مشكلة الإنفاق المزدوج التي واجهتها محاولات النقود الإلكترونية السابقة بطريقة لامركزية بالكامل باستخدام آلية تسمى **إثبات العمل (Proof of Work: [PoW](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/))** .
...
التقنية الأساسية التي تدعم البيتكوين هي "[البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) ([Blockchain](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/))". [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) هو شكل من أشكال تقنية دفتر الأستاذ الموزع ([Distributed Ledger](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/) Technology: DLT)، حيث يتم تجميع البيانات في وحدات تسمى "كتل"، والتي ترتبط هيكليًا معًا مثل سلسلة باستخدام التشفير.
...
تتكون الكتلة الواحدة بشكل أساسي من "رأس الكتلة (Block Header)" و "بيانات المعاملة ([Transaction](https://kenji.blog/ar/p/rdbms-transaction-acid-isolation-level-lock/) Data)".
...
في [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/)، يتم استخدام بنية بيانات تسمى **شجرة ميركل (Merkle [Tree](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))** للكشف عن التلاعب بالبيانات بكفاءة مع الحفاظ على حجم الكتلة منخفضًا. شجرة ميركل هي نوع من الأشجار الثنائية، حيث تحتوي العقد الطرفية على قيمة التجزئة لكل معاملة، وتكون العقدة الأم هي نتيجة تسلسل قيم التجزئة للعقد الفرعية وإعادة تجزئتها.
...
### تشفير المفتاح العام ([Public Key](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/) [Cryptography](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)) والتوقيع الرقمي
...
عندما ترسل أليس البيتكوين إلى بوب، تستخدم أليس مفتاحها الخاص لإنشاء **توقيع رقمي ([Digital Signature](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/))** لبيانات المعاملة. يمكن للمشاركين في الشبكة استخدام مفتاح أليس العام للتحقق مما إذا كان هذا التوقيع صالحًا (ما إذا كانت أليس قد أنشأته حقًا باستخدام مفتاحها الخاص).

### تشفير المنحنى الإهليلجي (Elliptic Curve Cryptography: ECC) و secp256k1

بالنسبة لإنشاء المفتاح العام للبيتكوين والتوقيع الرقمي، يتم استخدام **تشفير المنحنى الإهليلجي ([ECC](/ar/p/elliptic-curve-cryptography-math-cpp/))** بدلاً من تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/). يتمتع [ECC](/ar/p/elliptic-curve-cryptography-math-cpp/) بميزة القدرة على توفير مستوى أمان مكافئ بطول مفتاح أقصر بكثير مقارنة بـ RSA.
...
## 5. خوارزمية الإجماع وإثبات العمل ([PoW](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/))
...
"[مشكلة الجنرالات البيزنطيين](/ar/p/byzantine-generals-problem/)" هي مشكلة كلاسيكية في الحوسبة الموزعة. يقوم العديد من الجنرالات بمحاصرة مدينة معادية، ويجب أن يتفقوا على الهجوم أو التراجع، ولكن قد يكون هناك خونة بين الجنرالات يرسلون رسائل مزيفة. المشكلة هي كيفية التوصل إلى اتفاق صحيح مع الجنرالات المخلصين فقط في ظل هذه الظروف.

نجح البيتكوين عمليًا في حل هذه المشكلة من خلال الجمع بين **إثبات العمل ([PoW](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/))** و **قاعدة السلسلة الأطول (Longest Chain Rule)** .
...
عند ترقية بروتوكول [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/)، قد يحدث حدث يسمى "الشوكة (التفرع)".
...
في شبكة البرق، يفتح المشاركون "قنوات دفع (Payment Channel)" خارج [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) (خارج السلسلة). ضمن القناة، طالما أن كلا الطرفين متفقان، يمكن تبادل الأموال على الفور وبشكل شبه مجاني لعدد غير محدود من المرات دون تسجيل المعاملات في [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/). يتم تسجيل المعاملة في [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) (الطبقة 1) فقط عند التسوية النهائية للرصيد.

### مقارنة مع إثبات الحصة ([PoS](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/))

التحدي الرئيسي الآخر في [PoW](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/) هو الاستهلاك الهائل للطاقة بسبب التعدين. كتدبير مضاد لهذه المشكلة البيئية، انتقلت الإيثيريوم وغيرها إلى خوارزمية إجماع أخرى تسمى **إثبات الحصة (Proof of Stake: PoS)** .
...
وراء SHA-256 وتشفير المنحنى الإهليلجي ([ECC](/ar/p/elliptic-curve-cryptography-math-cpp/)) الموضح في الفصول السابقة، هناك نموذجان: أمان نظرية المعلومات والأمان الحسابي. تعتمد العملات المشفرة الحديثة، بما في ذلك البيتكوين، بشكل أساسي على الأمان الحسابي (Computational Security).
...
أثبتت "خوارزمية شور ([Shor's Algorithm](https://kenji.blog/ar/p/quantum-computing-shors-algorithm/))"، التي نشرها بيتر شور (Peter [Shor](/ar/p/shors-algorithm-and-rsa-breaking/)) في عام 1994، رياضيًا أنه باستخدام أجهزة الكمبيوتر الكمومية، يمكن حل مشكلة التحليل إلى العوامل الأولية (أساس تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/)) ومشكلة اللوغاريتم المنفصل (أساس [ECC](/ar/p/elliptic-curve-cryptography-math-cpp/)) في وقت كثير الحدود $\mathcal{O}(n^3)$.
...
2. **الانتقال إلى تشفير ما بعد الكم (Post-Quantum [Cryptography](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/): [PQC](/ar/p/post-quantum-cryptography/))**: قبل أن تصبح أجهزة الكمبيوتر الكمومية قابلة للتطبيق عمليًا، تجري مناقشات حول تنفيذ شوكة صلبة في بروتوكول البيتكوين والانتقال إلى خوارزميات توقيع جديدة يصعب على أجهزة الكمبيوتر الكمومية فك تشفيرها، مثل التشفير القائم على الشبكة ([Lattice-based cryptography](/ar/p/lattice-based-cryptography-math-intuition/)) أو تشفير كثير الحدود متعدد المتغيرات (Multivariate polynomial cryptography)، والتي يتم اختيارها بواسطة NIST (المعهد الوطني للمعايير والتكنولوجيا في الولايات المتحدة).

## 9. طوبولوجيا الشبكة وتفاصيل بروتوكول [P2P](https://kenji.blog/ar/p/webrtc-realtime-communication-p2p/)
...
- **العقدة الكاملة (Full Node)**: عقدة تقوم بتنزيل والتحقق من جميع بيانات [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) (مئات الجيجابايت أو أكثر)، من كتلة التكوين إلى أحدث كتلة. للتحقق بشكل مستقل من صحة المعاملات ووجود أي إنفاق مزدوج، فهي تشكل أساس أمان الشبكة.
- **عقدة SPV (التحقق المبسط من الدفع)**: عقدة خفيفة الوزن تقوم بتنزيل رؤوس الكتل فقط، وليس [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) بأكمله. يتم استخدامه بشكل أساسي لمحافظ الهواتف الذكية. يمكنها تأكيد ما إذا كانت معاملاتها الخاصة مدرجة في الكتلة (التحقق من [مسار](/ar/p/windows-%E3%81%A7%D9%85%D8%B3%D8%A7%D8%B1%E3%81%AE%E9%80%9A%E3%81%A3%E3%81%9F%D9%85%D9%84%D9%81-%D8%AA%D9%86%D9%81%D9%8A%D8%B0%D9%8A%E3%81%AE%E5%A0%B4%E6%89%80%E3%82%92%E8%A6%8B%E3%81%A4%E3%81%91%E3%82%8B%E6%96%B9%E6%B3%95/) ميركل)، ولكن ليس لديها نفس قدرة التحقق التي تتمتع بها العقدة الكاملة.
- **عقدة التعدين (Mining Node)**: عقدة تقوم بإجراء حسابات [PoW](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/) وتنشئ كتلًا جديدة. حاليًا، تلعب مجموعات عملاقة تسمى "مجمعات التعدين"، التي تجمع أجهزة التعدين المخصصة المعروفة باسم ASIC (الدوائر المتكاملة الخاصة بالتطبيقات)، هذا الدور.
...
السبب الذي يجعل المعدنين ينفقون كميات هائلة من الكهرباء والاستثمارات في الأجهزة لتعدين الكتل هو وجود مكافأة اقتصادية. عندما ينجح المعدنون في إنشاء كتلة جديدة، فإنهم يتلقون عملات بيتكوين تم إصدارها حديثًا من خلال معاملة خاصة تسمى **معاملة كوين بيس (Coinbase [Transaction](https://kenji.blog/ar/p/rdbms-transaction-acid-isolation-level-lock/))** .
...
للوهلة الأولى، تبدو تقنية [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) وكأنها كتلة معقدة من الرياضيات والأكواد، ولكن جوهرها ليس سوى **"نظام جديد لتشكيل الإجماع للبشرية لا يعتمد على السلطة، بل يعتمد على الرياضيات وقوانين الفيزياء كأساس للثقة"** .
...
لأولئك الذين قرأوا هذه المقالة ويريدون معرفة المزيد عن تقنية [البلوكتشين](/ar/p/blockchain-technology-smart-contract-distributed-ledger/) ونظرية التشفير، إليك بعض الموارد الموصى بها.
