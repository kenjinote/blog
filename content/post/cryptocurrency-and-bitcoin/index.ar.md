...
التقنية الأساسية التي تدعم البيتكوين هي "البلوكتشين ([Blockchain](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/))". البلوكتشين هو شكل من أشكال تقنية دفتر الأستاذ الموزع ([Distributed Ledger](https://kenji.blog/ar/p/blockchain-technology-smart-contract-distributed-ledger/) Technology: DLT)، حيث يتم تجميع البيانات في وحدات تسمى "كتل"، والتي ترتبط هيكليًا معًا مثل سلسلة باستخدام التشفير.
...
في البلوكتشين، يتم استخدام بنية بيانات تسمى **شجرة ميركل (Merkle [Tree](https://kenji.blog/ar/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/))** للكشف عن التلاعب بالبيانات بكفاءة مع الحفاظ على حجم الكتلة منخفضًا. شجرة ميركل هي نوع من الأشجار الثنائية، حيث تحتوي العقد الطرفية على قيمة التجزئة لكل معاملة، وتكون العقدة الأم هي نتيجة تسلسل قيم التجزئة للعقد الفرعية وإعادة تجزئتها.
...
بالنسبة لإنشاء المفتاح العام للبيتكوين والتوقيع الرقمي، يتم استخدام **تشفير المنحنى الإهليلجي (ECC)** بدلاً من تشفير [RSA](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/). يتمتع ECC بميزة القدرة على توفير مستوى أمان مكافئ بطول مفتاح أقصر بكثير مقارنة بـ RSA.
...
2. **الانتقال إلى تشفير ما بعد الكم (Post-Quantum [Cryptography](https://kenji.blog/ar/p/modern-cryptography-public-key-hash-signature/): PQC)**: قبل أن تصبح أجهزة الكمبيوتر الكمومية قابلة للتطبيق عمليًا، تجري مناقشات حول تنفيذ شوكة صلبة في بروتوكول البيتكوين والانتقال إلى خوارزميات توقيع جديدة يصعب على أجهزة الكمبيوتر الكمومية فك تشفيرها، مثل التشفير القائم على الشبكة (Lattice-based cryptography) أو تشفير كثير الحدود متعدد المتغيرات (Multivariate polynomial cryptography)، والتي يتم اختيارها بواسطة NIST (المعهد الوطني للمعايير والتكنولوجيا في الولايات المتحدة).
