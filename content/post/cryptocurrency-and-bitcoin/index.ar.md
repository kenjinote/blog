...
### مشكلة الجنرالات البيزنطيين (Byzantine Generals Problem)
...
أثبتت "خوارزمية شور (Shor's Algorithm)"، التي نشرها بيتر شور (Peter Shor) في عام 1994، رياضيًا أنه باستخدام أجهزة الكمبيوتر الكمومية، يمكن حل مشكلة التحليل إلى العوامل الأولية (أساس تشفير RSA) ومشكلة اللوغاريتم المنفصل (أساس ECC) في وقت كثير الحدود $$\mathcal{O}(n^3)$$.
