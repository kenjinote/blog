...
«Алгоритм Шора» (Shor's Algorithm), предложенный Питером Шором в 1994 году, математически доказал, что квантовый компьютер способен решить задачу факторизации целых чисел (основу RSA) и проблему дискретного логарифма (основу ECC) за полиномиальное время $$\mathcal{O}(n^3)$$.
