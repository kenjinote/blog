...
- $\alpha$ : Sobrecarga (overhead) de rede e protocolos (geralmente entre 0,1 e 0,2 em protocolos [TCP](https://kenji.blog/pt/p/http3-quic-protocol-tcp-udp/)/IP ou SMB)
