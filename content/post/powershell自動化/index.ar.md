...
- **Bypass**: لا يتم حظر أي شيء، ولا تُعرض أي تحذيرات. يُستخدم غالبًا لتنفيذ البرامج النصية المؤقتة (مثل خطوط أنابيب [CI/CD](https://kenji.blog/ar/p/cicd-pipeline-github-actions-best-practices/)).
...
- $\alpha$ : الحمل الزائد للشبكة والبروتوكولات (عادةً ما يتراوح بين 0.1 و 0.2 في بروتوكولات [TCP](https://kenji.blog/ar/p/http3-quic-protocol-tcp-udp/)/IP أو SMB)
