...
- **Bypass**: कुछ भी ब्लॉक नहीं किया जाता है और कोई चेतावनी नहीं दिखाई जाती है। इसका उपयोग अक्सर अस्थायी स्क्रिप्ट निष्पादन (जैसे [CI/CD](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) पाइपलाइन) के लिए किया जाता है।
...
- $\alpha$ : नेटवर्क या प्रोटोकॉल ओवरहेड (आमतौर पर [TCP](https://kenji.blog/hi/p/http3-quic-protocol-tcp-udp/)/IP या SMB प्रोटोकॉल के लिए 0.1 से 0.2)
