...
- $\alpha$ : Overhead des Netzwerks oder Protokolls (normalerweise 0,1 bis 0,2 bei [TCP](https://kenji.blog/de/p/http3-quic-protocol-tcp-udp/)/IP oder SMB-Protokoll)
