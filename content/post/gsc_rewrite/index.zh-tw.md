...
透過這項分析，可以量化地發現 **主題的遺漏 (內容差距)** ，例如：「原來排名前面的文章也提到了『部署至 [Docker](https://kenji.blog/zh-tw/p/docker-container-namespace-cgroups-layers/) 容器的方法』與『建置 [CI/CD](https://kenji.blog/zh-tw/p/cicd-pipeline-github-actions-best-practices/) 流程』，但我的文章卻沒有觸及」。
