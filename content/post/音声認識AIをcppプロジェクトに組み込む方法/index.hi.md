...
रियल-टाइम प्रोसेसिंग में, साइलेंट भागों के लिए लगातार इन्फेरेंस निष्पादित करना गणना संसाधनों की बर्बादी है। पहले चरण में VAD एल्गोरिथम (जैसे सरल ऊर्जा-आधारित थ्रेशोल्डिंग या [WebRTC](https://kenji.blog/hi/p/webrtc-realtime-communication-p2p/) VAD) शामिल करके, हम यह नियंत्रण स्थापित कर सकते हैं: **"बफरिंग केवल तभी शुरू करें जब कोई बोलना शुरू करे, और `whisper_full` को तभी ट्रिगर करें जब बोलना बंद हो जाए (एक निश्चित अवधि तक मौन)।"**
