---
title: 'Teiji Takagi: O matemático japonês de classe mundial que estabeleceu a teoria de corpos de classes'
...
Depois de retornar ao Japão, [Takagi](https://kenji.blog/pt/p/takagi-teiji/) continuou sua própria pesquisa enquanto ensinava jovens acadêmicos como professor na Universidade Imperial de Tóquio. No entanto, quando a Primeira Guerra Mundial eclodiu em 1914, o intercâmbio acadêmico entre o Japão e a Europa foi completamente cortado. Sem receber os últimos artigos ou periódicos, [Takagi](https://kenji.blog/pt/p/takagi-teiji/) não teve escolha a não ser aprofundar seus próprios pensamentos sozinho em seu laboratório.

Esse "isolamento" ironicamente se tornou o solo que produziu uma grande criação. [Takagi](https://kenji.blog/pt/p/takagi-teiji/) começou a reexaminar os problemas relativos a extensões abelianas relativas propostos por [Hilbert](https://kenji.blog/pt/p/hilbert/) a partir de sua perspectiva única.

### A concepção da teoria de corpos de classes

[Hilbert](https://kenji.blog/pt/p/hilbert/) havia conjeturado e provado parcialmente a existência de um "corpo de classes absoluto" para um dado corpo de números algébricos $K$, que é uma extensão abeliana não ramificada máxima cujo grupo de [Galois](https://kenji.blog/pt/p/galois/) é isomorfo ao grupo de classes de ideais de $K$.

[Takagi](https://kenji.blog/pt/p/takagi-teiji/) pensou que, ao remover essa restrição de ser "não ramificada", uma correspondência igualmente bela poderia ser válida para qualquer extensão abeliana. Esta foi a ideia central da **teoria de corpos de classes** de [Takagi](https://kenji.blog/pt/p/takagi-teiji/).

## 3. O pináculo da matemática: O núcleo da teoria de corpos de classes

Vejamos as afirmações da teoria de corpos de classes usando fórmulas matemáticas. Considere uma extensão abeliana finita $L$ de um corpo de números algébricos $K$. [Takagi](https://kenji.blog/pt/p/takagi-teiji/) mostrou que, ao considerar um grupo de ideais de congruência $H$ dentro do grupo de ideais de $K$ que satisfaz condições específicas, há uma correspondência biunívoca entre $L$ e $H$.

### Teorema de existência e teorema fundamental de [Takagi](https://kenji.blog/pt/p/takagi-teiji/)

Os principais teoremas provados por Teiji [Takagi](https://kenji.blog/pt/p/takagi-teiji/) são os seguintes:

1. **Teorema do Isomorfismo**: Para qualquer extensão abeliana $L/K$, existe um grupo de ideais de congruência adequado $H$ de $K$, e o grupo de [Galois](https://kenji.blog/pt/p/galois/) $\text{Gal}(L/K)$ é isomorfo ao grupo quociente $I/H$.
...
A conjectura de [Hilbert](https://kenji.blog/pt/p/hilbert/) é incluída como um caso especial em que o módulo é trivial (quando não há ramificação). [Takagi](https://kenji.blog/pt/p/takagi-teiji/) generalizou isso para uma forma que permite a ramificação arbitrária, estabelecendo uma teoria completa em relação a extensões abelianas de corpos de números algébricos.

### Beleza matemática: Generalização do teorema de [Kronecker](https://kenji.blog/pt/p/kronecker/)-Weber

A beleza da teoria de corpos de classes reside na extensão do **teorema de [Kronecker](https://kenji.blog/pt/p/kronecker/)-Weber** para o corpo dos números racionais $\mathbb{Q}$ para corpos de números algébricos gerais. O teorema de [Kronecker](https://kenji.blog/pt/p/kronecker/)-Weber afirma que "qualquer extensão abeliana finita do corpo de números racionais está contida em um subcorpo de algum corpo ciclotômico $\mathbb{Q}(\zeta_n)$".

$$ L \subset \mathbb{Q}(\zeta_n) \quad (\text{onde } \zeta_n \text{ é uma raiz primitiva } n\text{-ésima da unidade}) $$

A teoria de corpos de classes de [Takagi](https://kenji.blog/pt/p/takagi-teiji/) determinou completamente que tipo de corpo desempenha o papel de corpo ciclotômico quando este $\mathbb{Q}$ é substituído por um corpo de números algébricos arbitrário $K$.

## 4. Reconhecimento global e a lei de reciprocidade de Artin

Em 1920, no Congresso Internacional de Matemáticos realizado em Estrasburgo, após o fim da Primeira Guerra Mundial, [Takagi](https://kenji.blog/pt/p/takagi-teiji/) apresentou esta teoria de corpos de classes. No entanto, pelo fato de o conteúdo ser tão inovador a princípio, ele não foi totalmente compreendido.

Mais tarde, o envio de uma separata do seu artigo a Carl Siegel, na Alemanha, chamou a atenção de matemáticos promissores, como Emil Artin e [Helmut Hasse](https://kenji.blog/pt/p/hasse/). Eles compreenderam imediatamente a grandeza da teoria de [Takagi](https://kenji.blog/pt/p/takagi-teiji/) e avançaram em pesquisas posteriores baseadas nessa base.

Em particular, Artin provou a **lei de reciprocidade de Artin** usando a teoria de [Takagi](https://kenji.blog/pt/p/takagi-teiji/), completando a formulação da teoria de corpos de classes. Com isso, o nome de Teiji [Takagi](https://kenji.blog/pt/p/takagi-teiji/) ficou para sempre gravado na história da matemática.

## 5. Genealogia da teoria: A difusão da teoria de corpos de classes

A teoria de Teiji [Takagi](https://kenji.blog/pt/p/takagi-teiji/) teve uma enorme influência nos matemáticos posteriores. Esta genealogia é mostrada no diagrama Mermaid abaixo.

```mermaid
graph TD
    Kronecker["Kronecker"] -->|"O sonho de juventude de Kronecker"| Hilbert["Hilbert"]
    Weber["Weber"] -->|"Conceito de grupo de classes"| Hilbert
    Hilbert -->|"Conjectura do corpo de classes absoluto"| Takagi["Takagi"]
    Takagi -->|"Estabelecimento da teoria geral de corpos de classes"| Artin["Artin"]
    Artin -->|"Prova da lei de reciprocidade"| Chevalley["Chevalley"]
    Chevalley -->|"Formulação usando ideles"| Weil["Weil"]
    Takagi -->|"Desenvolvimento da teoria local de corpos de classes"| Hasse["Hasse"]
...
Além de suas realizações matemáticas, Teiji [Takagi](https://kenji.blog/pt/p/takagi-teiji/) fez contribuições incomensuráveis ​​para o ensino de matemática no Japão. Seus livros foram as bíblias por gerações de estudantes de ciências no Japão.
