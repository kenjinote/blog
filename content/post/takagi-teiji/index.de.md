...
Nach seiner Rückkehr nach Japan setzte [Takagi](https://kenji.blog/de/p/takagi-teiji/) seine eigenen Forschungen fort, während er als Professor an der Kaiserlichen Universität Tokio jüngere Wissenschaftler unterrichtete. Doch als 1914 der Erste Weltkrieg ausbrach, brach der akademische Austausch zwischen Japan und Europa vollständig ab. Ohne Zugang zu den neuesten Arbeiten oder Zeitschriften blieb [Takagi](https://kenji.blog/de/p/takagi-teiji/) nichts anderes übrig, als seine eigenen Gedanken allein in seinem Arbeitszimmer zu vertiefen.

Diese "Isolation" wurde ironischerweise zum Nährboden, aus dem eine großartige Schöpfung hervorging. [Takagi](https://kenji.blog/de/p/takagi-teiji/) begann, die von [Hilbert](https://kenji.blog/de/p/hilbert/) vorgeschlagenen Probleme zu relativen abelschen Erweiterungen aus seiner eigenen, einzigartigen Perspektive neu zu betrachten.

### Die Konzeption der Klassenkörpertheorie

[Hilbert](https://kenji.blog/de/p/hilbert/) hatte die Existenz eines "absoluten Klassenkörpers" für einen gegebenen algebraischen Zahlkörper $K$ vermutet und teilweise bewiesen. Dies ist eine maximale unverzweigte abelsche Erweiterung, deren [Galois](https://kenji.blog/de/p/galois/)gruppe isomorph zur Idealklassengruppe von $K$ ist.

[Takagi](https://kenji.blog/de/p/takagi-teiji/) dachte, dass durch die Aufhebung dieser Einschränkung der "Unverzweigtheit" eine ähnlich schöne Korrespondenz für jede abelsche Erweiterung gelten könnte. Dies war die Kernidee von [Takagi](https://kenji.blog/de/p/takagi-teiji/)s **Klassenkörpertheorie**.

## 3. Der Höhepunkt der Mathematik: Der Kern der Klassenkörpertheorie

Betrachten wir die Aussagen der Klassenkörpertheorie anhand mathematischer Formeln. Sei $L$ eine endliche abelsche Erweiterung eines algebraischen Zahlkörpers $K$. [Takagi](https://kenji.blog/de/p/takagi-teiji/) zeigte, dass durch die Betrachtung einer Kongruenzidealgruppe $H$ innerhalb der Idealgruppe von $K$, die bestimmte Bedingungen erfüllt, eine Eins-zu-eins-Korrespondenz zwischen $L$ und $H$ besteht.

### [Takagi](https://kenji.blog/de/p/takagi-teiji/)s Existenzsatz und Hauptsatz

Die wichtigsten von Teiji [Takagi](https://kenji.blog/de/p/takagi-teiji/) bewiesenen Sätze sind die folgenden:

1. **Isomorphiesatz**: Zu jeder abelschen Erweiterung $L/K$ existiert eine geeignete Kongruenzidealgruppe $H$ von $K$, und die [Galois](https://kenji.blog/de/p/galois/)gruppe $\text{Gal}(L/K)$ ist isomorph zur Faktorgruppe $I/H$.
...
[Hilbert](https://kenji.blog/de/p/hilbert/)s Vermutung ist als Spezialfall enthalten, bei dem der Modul trivial ist (wenn es keine Verzweigung gibt). [Takagi](https://kenji.blog/de/p/takagi-teiji/) verallgemeinerte dies auf eine Form, die beliebige Verzweigungen zulässt, und begründete damit eine vollständige Theorie der abelschen Erweiterungen algebraischer Zahlkörper.

### Mathematische Schönheit: Verallgemeinerung des Satzes von [Kronecker](https://kenji.blog/de/p/kronecker/)-Weber

Die Schönheit der Klassenkörpertheorie liegt in der Ausweitung des **Satzes von [Kronecker](https://kenji.blog/de/p/kronecker/)-Weber** für den Körper der rationalen Zahlen $\mathbb{Q}$ auf allgemeine algebraische Zahlkörper. Der Satz von [Kronecker](https://kenji.blog/de/p/kronecker/)-Weber besagt: "Jede endliche abelsche Erweiterung des rationalen Zahlkörpers ist in einem Teilkörper eines Kreisteilungskörpers $\mathbb{Q}(\zeta_n)$ enthalten."

$$ L \subset \mathbb{Q}(\zeta_n) \quad (\text{wobei } \zeta_n \text{ eine primitive } n\text{-te Einheitswurzel ist}) $$

[Takagi](https://kenji.blog/de/p/takagi-teiji/)s Klassenkörpertheorie bestimmte vollständig, welche Art von Körper die Rolle des Kreisteilungskörpers spielt, wenn dieses $\mathbb{Q}$ durch einen beliebigen algebraischen Zahlkörper $K$ ersetzt wird.

## 4. Globale Anerkennung und das Artinsche Reziprozitätsgesetz

1920, auf dem Internationalen Mathematikerkongress, der nach dem Ende des Ersten Weltkriegs in Straßburg stattfand, präsentierte [Takagi](https://kenji.blog/de/p/takagi-teiji/) diese Klassenkörpertheorie. Da der Inhalt jedoch anfangs so innovativ war, wurde er nicht vollständig verstanden.

Die spätere Zusendung eines Sonderdrucks seiner Arbeit an Carl Siegel in Deutschland weckte die Aufmerksamkeit aufstrebender Mathematiker wie Emil Artin und [Helmut Hasse](https://kenji.blog/de/p/hasse/). Sie verstanden sofort die Größe von [Takagi](https://kenji.blog/de/p/takagi-teiji/)s Theorie und trieben auf dieser Grundlage weitere Forschungen voran.

Insbesondere bewies Artin unter Verwendung von [Takagi](https://kenji.blog/de/p/takagi-teiji/)s Theorie das **Artinsche Reziprozitätsgesetz** und vollendete damit die Formulierung der Klassenkörpertheorie. Damit wurde der Name Teiji [Takagi](https://kenji.blog/de/p/takagi-teiji/) für immer in die Geschichte der Mathematik eingraviert.

## 5. Genealogie der Theorie: Die Ausbreitung der Klassenkörpertheorie

Die Theorie von Teiji [Takagi](https://kenji.blog/de/p/takagi-teiji/) hatte einen enormen Einfluss auf spätere Mathematiker. Diese Genealogie wird im folgenden Mermaid-Diagramm dargestellt.

```mermaid
graph TD
    Kronecker["Kronecker"] -->|"Kroneckers Jugendtraum"| Hilbert["Hilbert"]
    Weber["Weber"] -->|"Konzept der Klassengruppe"| Hilbert
    Hilbert -->|"Vermutung des absoluten Klassenkörpers"| Takagi["Takagi"]
    Takagi -->|"Begründung der allgemeinen Klassenkörpertheorie"| Artin["Artin"]
    Artin -->|"Beweis des Reziprozitätsgesetzes"| Chevalley["Chevalley"]
    Chevalley -->|"Formulierung mittels Idelen"| Weil["Weil"]
    Takagi -->|"Entwicklung zur lokalen Klassenkörpertheorie"| Hasse["Hasse"]
...
Über seine mathematischen Errungenschaften hinaus leistete Teiji [Takagi](https://kenji.blog/de/p/takagi-teiji/) unermessliche Beiträge zur Mathematikausbildung in Japan. Seine Bücher waren für Generationen von Naturwissenschaftsstudenten in Japan die Standardwerke.
