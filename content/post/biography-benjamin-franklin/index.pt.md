...
```mermaid
flowchart TD
    A["Benjamin Franklin (1706-1790)"] --> B["Editoração e Negócios"]
    A --> C["Ciência e Invenção"]
    A --> D["Política e Diplomacia"]
    A --> E["Filosofia e Dever Cívico"]

    B --> B1["Pennsylvania Gazette"]
    B --> B2["Almanaque do Pobre Ricardo"]
    B2 --> E1["Treze Virtudes"]

    C --> C1["Experiência da Pipa (1752)"]
    C --> C2["Pára-raios"]
    C --> C3["Lentes Bifocais e Fogão de Franklin"]

    D --> D1["Declaração de Independência (1776)"]
    D --> D2["Tratado de Aliança com a França (1778)"]
    D --> D3["Tratado de Paris (1783)"]
    D --> D4["Constituição dos EUA (1787)"]

    E --> E1
    E --> E2["Primeira Biblioteca Pública"]
    E --> E3["Universidade da Pensilvânia"]
