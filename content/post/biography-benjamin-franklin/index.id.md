---
title: "Bapak Pendiri Amerika dan Jenius Universal: Kehidupan dan Filosofi Benjamin Franklin"
...
```mermaid
flowchart TD
    A["Benjamin Franklin (1706-1790)"] --> B["Penerbitan & Bisnis"]
    A --> C["Sains & Penemuan"]
    A --> D["Politik & Diplomasi"]
    A --> E["Filosofi & Tugas Sipil"]

    B --> B1["Pennsylvania Gazette"]
    B --> B2["Poor Richard's Almanack"]
    B2 --> E1["Tiga Belas Kebajikan"]

    C --> C1["Eksperimen Layang-layang (1752)"]
    C --> C2["Penangkal Petir"]
    C --> C3["Lensa Bifokal & Tungku Franklin"]

    D --> D1["Deklarasi Kemerdekaan (1776)"]
    D --> D2["Perjanjian Aliansi dengan Prancis (1778)"]
    D --> D3["Perjanjian Paris (1783)"]
    D --> D4["Konstitusi AS (1787)"]

    E --> E1
    E --> E2["Perpustakaan Umum Pertama"]
