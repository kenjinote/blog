---
title: "Gründervater Amerikas und Universalgenie: Das Leben und die Philosophie von Benjamin Franklin"
...
```mermaid
flowchart TD
    A["Benjamin Franklin (1706-1790)"] --> B["Verlagswesen & Wirtschaft"]
    A --> C["Wissenschaft & Erfindung"]
    A --> D["Politik & Diplomatie"]
    A --> E["Philosophie & Bürgerpflicht"]

    B --> B1["Pennsylvania Gazette"]
    B --> B2["Poor Richard's Almanack"]
    B2 --> E1["Dreizehn Tugenden"]

    C --> C1["Drachenexperiment (1752)"]
    C --> C2["Blitzableiter"]
    C --> C3["Bifokalbrille & Franklin-Ofen"]

    D --> D1["Unabhängigkeitserklärung (1776)"]
    D --> D2["Bündnisvertrag mit Frankreich (1778)"]
    D --> D3["Vertrag von Paris (1783)"]
    D --> D4["US-Verfassung (1787)"]

    E --> E1
    E --> E2["Erste öffentliche Bibliothek"]
