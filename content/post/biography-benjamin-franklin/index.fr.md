...
```mermaid
flowchart TD
    A["Benjamin Franklin (1706-1790)"] --> B["Édition et Affaires"]
    A --> C["Science et Invention"]
    A --> D["Politique et Diplomatie"]
    A --> E["Philosophie et Devoir civique"]

    B --> B1["Pennsylvania Gazette"]
    B --> B2["L'Almanach du Bonhomme Richard"]
    B2 --> E1["Treize Vertus"]

    C --> C1["Expérience du cerf-volant (1752)"]
    C --> C2["Paratonnerre"]
    C --> C3["Lunettes à double foyer & Poêle Franklin"]

    D --> D1["Déclaration d'indépendance (1776)"]
    D --> D2["Traité d'alliance avec la France (1778)"]
    D --> D3["Traité de Paris (1783)"]
    D --> D4["Constitution des États-Unis (1787)"]

    E --> E1
    E --> E2["Première bibliothèque publique"]
    E --> E3["Université de Pennsylvanie"]
