...
[مشكلة النقل الأمثل](https://kenji.blog/p/optimal-transport-problem/) ([Optimal Transport Problem](https://kenji.blog/p/optimal-transport-problem/)) هي مشكلة رياضية تطرح السؤال **"كيفية نقل المواد بأقل جهد"** عند نقل مادة (مثل كومة من الرمل) من مكان إلى آخر (مثل حفرة).
...
بافتراض أن دالة التكلفة المرتبطة بالحركة هي $c(x, y)$، فإن [مشكلة النقل الأمثل](https://kenji.blog/p/optimal-transport-problem/) لمونج هي إيجاد تطبيق $T$ يقلل التكلفة الإجمالية التالية.
...
[مشكلة النقل الأمثل](https://kenji.blog/p/optimal-transport-problem/) لكانتوروفيتش هي إيجاد توزيع مشترك $\pi$ يقلل التكلفة الإجمالية التالية.
...
بدأت [مشكلة النقل الأمثل](https://kenji.blog/p/optimal-transport-problem/) من الاستكشاف الرياضي البحت وأصبحت الآن أداة قوية تدعم علم البيانات. من المرجح أن تستمر هذه الفكرة البديهية لقياس "الاختلاف" بين التوزيعات في التطبيق في مجالات مختلفة في المستقبل.
