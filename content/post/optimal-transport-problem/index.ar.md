...
مشكلة النقل الأمثل (Optimal Transport Problem) هي مشكلة رياضية تطرح السؤال **"كيفية نقل المواد بأقل جهد"** عند نقل مادة (مثل كومة من الرمل) من مكان إلى آخر (مثل حفرة).
...
بافتراض أن دالة التكلفة المرتبطة بالحركة هي $c(x, y)$، فإن مشكلة النقل الأمثل لمونج هي إيجاد تطبيق $T$ يقلل التكلفة الإجمالية التالية.
...
مشكلة النقل الأمثل لكانتوروفيتش هي إيجاد توزيع مشترك $\pi$ يقلل التكلفة الإجمالية التالية.
...
بدأت مشكلة النقل الأمثل من الاستكشاف الرياضي البحت وأصبحت الآن أداة قوية تدعم علم البيانات. من المرجح أن تستمر هذه الفكرة البديهية لقياس "الاختلاف" بين التوزيعات في التطبيق في مجالات مختلفة في المستقبل.
