...
The Optimal Transport Problem is a mathematical problem that asks **"how to move material with minimal effort"** when moving a substance (like a sandpile) from one place to another (like a hole).
