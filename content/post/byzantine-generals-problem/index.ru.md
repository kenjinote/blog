...
categories: ["Технические объяснения", "Распределенные системы"]
tags: ["Задача византийских генералов", "Блокчейн", "Консенсус", "Алгоритмы"]
slug: "byzantine-generals-problem"
---

При изучении распределенных систем и технологий блокчейн вы обязательно столкнетесь с **задачей византийских генералов** (Byzantine Generals Problem). В ней рассматривается чрезвычайно важная тема: как система в целом формирует правильный консенсус в ситуации, когда в сети присутствуют «предатели» или «вышедшие из строя узлы».
...
Задача византийских генералов — это мысленный эксперимент о достижении консенсуса в распределенных вычислениях, предложенный Лесли Лэмпортом (Leslie Lamport) и его коллегами в 1982 году.
...
В последние годы эта проблема снова привлекла большое внимание благодаря появлению **технологий блокчейн**. Поскольку блокчейн — это P2P-сеть без центрального администратора, существует вероятность того, что злоумышленные участники (узлы) будут транслировать ложную историю транзакций. Это в точности задача византийских генералов.
...
Сатоши Накамото, создатель Биткойна, решил эту проблему с помощью совершенно нового подхода. Это **консенсус Накамото**, сочетающий **Proof of Work** (PoW) и правило признания самой длинной цепи истинной.
...
### Применение BFT в PoS (Proof of Stake)
...
Эволюция алгоритмов, не позволяющих системе остановиться даже при допущении наличия предателей, продолжится и в будущем. Понимание математических доказательств и алгоритмов, лежащих в основе этой проблемы, станет очень мощным оружием для инженеров, занимающихся проектированием распределенных систем.
