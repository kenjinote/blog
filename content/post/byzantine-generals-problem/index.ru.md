...
При изучении распределенных систем и технологий блокчейн вы обязательно столкнетесь с **задачей византийских генералов** ([Byzantine Generals](https://kenji.blog/ru/p/byzantine-generals-problem-consensus/) Problem). В ней рассматривается чрезвычайно важная тема: как система в целом формирует правильный консенсус в ситуации, когда в сети присутствуют «предатели» или «вышедшие из строя узлы».
...
Сатоши Накамото, создатель [Биткойн](https://kenji.blog/ru/p/cryptocurrency-and-bitcoin/)а, решил эту проблему с помощью совершенно нового подхода. Это **консенсус Накамото**, сочетающий **Proof of Work** (PoW) и правило признания самой длинной цепи истинной.
