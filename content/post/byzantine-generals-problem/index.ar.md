...
في تصميم [الأنظمة الموزعة](/ar/p/cap-theorem-distributed-systems-tradeoff/) الأكثر تقدماً، يتم تحديد انتقال حالة النظام بشكل صارم لإثبات صحة خوارزمية BFT.
...
**[مشكلة الجنرالات البيزنطيين](https://kenji.blog/ar/p/byzantine-generals-problem/)** هي النظرية الأساسية لضمان موثوقية [الأنظمة الموزعة](/ar/p/cap-theorem-distributed-systems-tradeoff/). السؤال عن "كيفية اتخاذ قرارات صحيحة ككل في بيئة لا تعرف فيها بمن تثق" يتم تطبيقه الآن في جميع البنى التحتية لتقنية المعلومات الحديثة، من التكنولوجيا الأساسية للأصول المشفرة، إلى أنظمة التحكم في الطائرات، والحوسبة السحابية.

بافتراض وجود خونة، فإن تطور الخوارزميات للحفاظ على استمرار عمل النظام لن يتوقف في المستقبل. بالنسبة [للمهندسين](/ar/p/prompt-engineering-for-engineers/) المشاركين في تصميم [الأنظمة الموزعة](/ar/p/cap-theorem-distributed-systems-tradeoff/)، فإن فهم البراهين الرياضية والخوارزميات التي تكمن وراء هذه المشكلة سيكون سلاحاً قوياً جداً.
