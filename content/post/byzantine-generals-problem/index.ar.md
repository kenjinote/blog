...
عند دراسة الأنظمة الموزعة (Distributed Systems) أو تقنية البلوكشين (Blockchain)، فمن المؤكد أنك ستواجه ما يُعرف بـ **[مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/)** (Byzantine Generals Problem). تتناول هذه المشكلة موضوعاً في غاية الأهمية: كيف يمكن للنظام بأكمله أن يتوصل إلى إجماع (Consensus) صحيح في بيئة يوجد بها "خونة" أو "عقد (Nodes) معطلة" داخل الشبكة.

في هذه المقالة، سنشرح **[مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/)** بالتفصيل من الأساسيات إلى التطبيقات، وذلك باستخدام قصة ملموسة، وشروط رياضية، ورسوم توضيحية.

## 1. ما هي [مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/)؟

[مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/) هي تجربة فكرية حول الإجماع في الحوسبة الموزعة، اقترحها ليزلي لامبورت (Leslie Lamport) وآخرون في عام 1982.
...
وبهذا الشكل، تتساءل **[مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/)**: "كيف يمكن للعقد الطبيعية أن تصل إلى نفس الاستنتاج في شبكة يمكن لأي عقدة خبيثة فيها نشر معلومات كاذبة عشوائية؟"

## 2. الشروط الصارمة لتكوين الإجماع

في هذه المشكلة، من أجل التوصل إلى إجماع في النظام بأكمله، يجب استيفاء الشرطين التاليين (شروط التناسق التفاعلي - Interactive Consistency):
...
ما هو نوع الخوارزمية اللازمة لحل [مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/) وتشكيل إجماع؟
...
تسمى القدرة على مقاومة [مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/) **تحمل الأخطاء البيزنطية** (Byzantine Fault Tolerance, BFT). وهو مؤشر مهم لضمان استمرار النظام الموزع في العمل بشكل طبيعي حتى مع وجود أعطال أو هجمات خبيثة.

في السنوات الأخيرة، عادت هذه المشكلة لتسلط عليها الأضواء بشكل كبير بفضل ظهور **تقنية البلوكشين** (Blockchain). نظراً لأن البلوكشين عبارة عن شبكة نظير إلى نظير (P2P) بدون مدير مركزي، فهناك احتمال أن يقوم المشاركون (العقد) الخبيثون بنشر سجلات معاملات مزيفة. إنها [مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/) بحد ذاتها.
...
في إجماع ناكاموتو، فقط أولئك الذين يفوزون في مسابقة رياضية (التعدين) يكتسبون الحق في اقتراح كتلة (Block). لكي يتعرف النظام على معلومات خاطئة، يجب السيطرة على أكثر من نصف (51% أو أكثر) من قوة الحوسبة للشبكة بأكملها، وهو تصميم يجعل الأمر بالغ الصعوبة من الناحية العملية. بهذا، يُعتبر أنه حل [مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/) باحتمالية عالية في شبكة مفتوحة يشارك فيها عدد غير محدد من الأشخاص.
...
**[مشكلة الجنرالات البيزنطيين](https://kenji.blog/p/byzantine-generals-problem/)** هي النظرية الأساسية لضمان موثوقية الأنظمة الموزعة. السؤال عن "كيفية اتخاذ قرارات صحيحة ككل في بيئة لا تعرف فيها بمن تثق" يتم تطبيقه الآن في جميع البنى التحتية لتقنية المعلومات الحديثة، من التكنولوجيا الأساسية للأصول المشفرة، إلى أنظمة التحكم في الطائرات، والحوسبة السحابية.
