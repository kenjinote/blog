---
title: '[مقدمة إلى Python] شرح خوارزمية "برج هانوي" التي يتم حلها بالمعالجة العودية'
slug: "ハノイの塔"
...
image: "img.webp"
categories: ["برمجة"]
description: 'نشرح بوضوح مفهوم "الاستدعاء العودي (Recursive)" في البرمجة من خلال اللغز الشهير "برج هانوي"، مرفقاً بنموذج كود Python. نوصي به للمبتدئين الذين يرغبون في تعلم أساسيات الخوارزميات.'
---
