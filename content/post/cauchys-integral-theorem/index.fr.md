...
### Dérivation Complexe et les Équations de Cauchy-Riemann
...
De plus, si $u$ et $v$ ont des dérivées partielles continues, le respect de ces équations équivaut à ce que $f(z)$ soit holomorphe. Ces équations relationnelles, qui possèdent une belle symétrie, jouent un rôle crucial dans la preuve du théorème intégral de Cauchy décrite plus tard.

## 3. Définition et Propriétés de l'Intégration Complexe

Ensuite, nous définissons l'intégration curviligne sur le plan complexe. Le théorème intégral de Cauchy étant un théorème sur l'intégration le long d'une "courbe" sur le plan complexe, il est essentiel de clarifier la définition de cette intégration.
...
## 4. Formulation du Théorème Intégral de Cauchy

Maintenant que nos préparatifs sont terminés, nous énonçons enfin la formulation exacte de notre sujet principal, le théorème intégral de Cauchy.

**Théorème (Théorème Intégral de Cauchy)**
...
Ici, comme preuve classique et intuitive du théorème intégral de Cauchy, nous introduisons une méthode utilisant le **théorème de Green** du calcul. (Note : Cette preuve suppose que les dérivées partielles sont continues, c'est-à-dire que $f'(z)$ est continue.)
...
Maintenant, nous substituons l'équation de Cauchy-Riemann $\frac{\partial u}{\partial y} = -\frac{\partial v}{\partial x}$, qui est une propriété des fonctions holomorphes. Ensuite, l'intégrande devient le suivant :
...
À nouveau, en substituant l'autre équation de Cauchy-Riemann $\frac{\partial u}{\partial x} = \frac{\partial v}{\partial y}$, l'intégrande devient $\frac{\partial v}{\partial y} - \frac{\partial v}{\partial y} = 0$, et l'intégrale de la partie imaginaire devient également nulle.
...
Ceci est le squelette de la preuve du théorème intégral de Cauchy. Nous pouvons voir qu'en combinant magnifiquement les équations de Cauchy-Riemann et le théorème de Green, la preuve peut être accomplie de manière étonnamment simple.
...
La preuve est très simple. Considérez un chemin qui va vers $B$ via $C_1$, et retourne à $A$ via le chemin inverse $-C_2$. Cela forme une seule courbe fermée $C = C_1 + (-C_2)$. Par le théorème intégral de Cauchy, l'intégrale le long de cette courbe fermée est nulle.
...
## 9. Application : Formule Intégrale de Cauchy et Extension aux Domaines Multiplement Connexes

Le théorème intégral de Cauchy est un théorème magnifique en soi, mais il sert de base puissante pour dériver successivement d'autres théorèmes importants en analyse complexe.

### Formule Intégrale de Cauchy

La conséquence la plus directe et la plus largement applicable du théorème est la **formule intégrale de Cauchy**. Lorsqu'une fonction $f(z)$ est holomorphe dans un domaine $D$, pour une courbe fermée simple $C$ à l'intérieur de $D$ et tout point $a$ à l'intérieur de celle-ci, ce qui suit est vérifié :
