...
Berawal dari teorema ini, pencapaian luar biasa dari analisis kompleks seperti rumus integral [Cauchy](https://kenji.blog/id/p/cauchy/), pembuktian bahwa suatu fungsi dapat diturunkan secara tak terbatas (menjamin ekspansi Taylor dan ekspansi Laurent), dan [Teorema Residu](/id/p/residue-theorem/) diturunkan secara berurutan. Teorema integral [Cauchy](https://kenji.blog/id/p/cauchy/) benar-benar dapat dikatakan sebagai fondasi yang paling kuat dan indah yang menopang bangunan matematika yang megah dari analisis kompleks dari akar-akarnya.
