...
3. चूँकि $\gcd(M_i, m_i) = 1$ है, इसलिए मॉड्यूलो $m_i$ में $M_i$ का गुणनात्मक व्युत्क्रम (multiplicative inverse) $y_i$ मौजूद होता है। यानी, विस्तारित [यूक्लिड](https://kenji.blog/hi/p/euclid/)ियन एल्गोरिदम आदि का उपयोग करके ऐसा $y_i$ खोजें जो $M_i y_i \equiv 1 \pmod{m_i}$ को संतुष्ट करता हो।
...
## आधुनिक काल में अनुप्रयोग: [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन और CRT
