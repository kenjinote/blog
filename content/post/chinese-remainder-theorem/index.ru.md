...
Китайская теорема об остатках ([Chinese Remainder Theorem](https://kenji.blog/ru/p/chinese-remainder-theorem/), сокращенно CRT) — одна из самых важных и красивых теорем в теории чисел. Её истоки восходят к древнекитайскому математическому трактату «[Сунь-цзы](/ru/p/biography-sun-tzu/) суаньцзин», составленному примерно в III-V веках. Эта теорема, начавшаяся с простой древней арифметической задачи, спустя тысячелетия играет незаменимую роль в технологиях криптографии с открытым ключом, таких как **[RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) криптография**, обеспечивая безопасность повседневных коммуникаций в интернете.
...
Корни Китайской теоремы об остатках лежат в известной задаче, описанной в 26-м вопросе нижнего тома «[Сунь-цзы](/ru/p/biography-sun-tzu/) суаньцзин».
...
Решением этой задачи является $x = 23$. В «[Сунь-цзы](/ru/p/biography-sun-tzu/) суаньцзин» также приведен конкретный алгоритм вычисления для нахождения этого решения, что считается первым историческим примером конструктивного метода для Китайской теоремы об остатках.
...
3. Поскольку $\gcd(M_i, m_i) = 1$, существует мультипликативно обратное значение $y_i$ для $M_i$ по модулю $m_i$. А именно, находится $y_i$, удовлетворяющее $M_i y_i \equiv 1 \pmod{m_i}$, с помощью расширенного алгоритма [Евклид](https://kenji.blog/ru/p/euclid/)а.
...
Давайте решим вышеописанную «Задачу [Сунь-цзы](/ru/p/biography-sun-tzu/)» с помощью этого алгоритма.
...
Таким образом, наименьшее положительное решение равно **23** , что идеально совпадает с ответом [Сунь-цзы](/ru/p/biography-sun-tzu/).

## Современное применение: [RSA](https://kenji.blog/ru/p/modern-cryptography-public-key-hash-signature/) криптография и CRT
