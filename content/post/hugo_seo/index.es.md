...
## 7. Rendimiento del sitio y Core [Web Vitals](https://kenji.blog/es/p/web-vitals-frontend-performance-optimization-lcp-fid-cls/)

En SEO, **la velocidad de carga de la página** es tan importante como la optimización de las etiquetas. Google ha incorporado los [Core Web Vitals](https://kenji.blog/es/p/web-vitals-frontend-performance-optimization-lcp-fid-cls/) (LCP, FID/INP, [CLS](https://kenji.blog/es/p/web-vitals-frontend-performance-optimization-lcp-fid-cls/)) como factores de clasificación.
