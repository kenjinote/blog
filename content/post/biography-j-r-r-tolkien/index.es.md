---
title: "J.R.R. Tolkien: La trayectoria del padre de la fantasía moderna y la creación de un mito"
...
```mermaid
graph TD
    Tolkien["J.R.R. Tolkien"] --> Experiences["Experiencias de vida"]
    Tolkien --> Academia["Carrera académica"]
    Tolkien --> Creation["Subcreación"]

    Experiences --> WWI["Primera Guerra Mundial"]
    Experiences --> Nature["Amor por la naturaleza"]
    
    Academia --> Oxford["Profesor de Oxford"]
    Academia --> Inklings["Los Inklings (C.S. Lewis)"]
    Academia --> Philology["Filología y Mitología"]

    Creation --> Languages["Lenguas élficas"]
    Creation --> MiddleEarth["Tierra Media"]
    ...
    MiddleEarth --> Hobbit["El Hobbit (1937)"]
    MiddleEarth --> LOTR["El Señor de los Anillos"]
    MiddleEarth --> Silmarillion["El Silmarillion"]
    
    Inklings --> LOTR
    
    LOTR --> Legacy["Género de fantasía moderna"]
    Legacy --> TRPG["Juegos de rol de mesa (D&D)"]
    Legacy --> VideoGames["Videojuegos"]
    Legacy --> Literature["Literatura de fantasía"]
    Legacy --> Movies["Adaptaciones cinematográficas"]
```
