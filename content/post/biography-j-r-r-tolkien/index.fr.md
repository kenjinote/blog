---
title: "J.R.R. Tolkien : La trajectoire du père de la fantasy moderne et la création d'un mythe"
...
```mermaid
graph TD
    Tolkien["J.R.R. Tolkien"] --> Experiences["Expériences de vie"]
    Tolkien --> Academia["Carrière académique"]
    Tolkien --> Creation["Sous-création"]

    Experiences --> WWI["Première Guerre mondiale"]
    Experiences --> Nature["Amour pour la nature"]
    
    Academia --> Oxford["Professeur à Oxford"]
    Academia --> Inklings["Les Inklings (C.S. Lewis)"]
    Academia --> Philology["Philologie & Mythologie"]

    Creation --> Languages["Langues elfiques"]
    Creation --> MiddleEarth["Terre du Milieu"]
    ...
    MiddleEarth --> Hobbit["Le Hobbit (1937)"]
    MiddleEarth --> LOTR["Le Seigneur des Anneaux"]
    MiddleEarth --> Silmarillion["Le Silmarillion"]
    
    Inklings --> LOTR
    
    LOTR --> Legacy["Genre de la fantasy moderne"]
    Legacy --> TRPG["Jeu de rôle sur table (D&D)"]
    Legacy --> VideoGames["Jeux vidéo"]
    Legacy --> Literature["Littérature de fantasy"]
    Legacy --> Movies["Adaptations cinématographiques"]
```
