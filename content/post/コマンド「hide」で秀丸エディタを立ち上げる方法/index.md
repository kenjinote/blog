---
title: '秀丸エディタを「hide」コマンド一発で起動！Windowsの便利な設定方法'
...
image: "img_2.webp"
categories: ["ツール・開発環境"]
description: 'Windows 10/11で、「ファイル名を指定して実行」やコマンドプロンプトから「hide」と入力するだけで秀丸エディタを素早く起動する方法を解説します。レジストリエディタのApp Pathsを使った便利なカスタマイズ手順です。'
---
