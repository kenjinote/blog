...
- **Amazon Neptune** : Une base de données de graphes entièrement gérée par AWS. Supporte Property [Graph](https://kenji.blog/fr/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/) (Gremlin) et RDF (SPARQL).
