...
في المقابل، تتبنى العديد من قواعد بيانات NoSQL نهجاً **بدون مخطط** أو بمخطط مرن. لا يلزم التحديد المسبق والكامل لهيكل البيانات، مما يتيح تغيير شكل البيانات ديناميكياً لتلائم التغييرات في متطلبات التطبيق. تتوافق هذه الخاصية بشكل جيد جداً مع التطوير الرشيق (Agile) وبنية الخدمات المصغرة ([Microservices](https://kenji.blog/ar/p/microservices-architecture-bff-api-gateway/)).
...
erDiagram
    ...
    ROW_KEY {
        string مفتاح_الصف_مفتاح_التقسيم
    }
    
    COLUMN_FAMILY_1 {
        string العمود_1_الاسم_القيمة_الطابع_الزمني
        string العمود_2_الاسم_القيمة_الطابع_الزمني
        string العمود_n
    }
    
    COLUMN_FAMILY_2 {
        string العمود_أ_الاسم_القيمة_الطابع_الزمني
        string العمود_ب_الاسم_القيمة_الطابع_الزمني
    }
