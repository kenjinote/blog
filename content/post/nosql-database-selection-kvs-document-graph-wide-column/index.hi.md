...
NoSQL डेटाबेस कोई एक तकनीक नहीं है, बल्कि यह विशिष्ट उपयोग के मामलों (use cases) के लिए अनुकूलित विभिन्न डेटा मॉडलों के लिए एक सामान्य शब्द है। इस लेख में, हम RDBMS और NoSQL के बीच के महत्वपूर्ण अंतरों को स्पष्ट करने के बाद, चार प्रमुख NoSQL डेटा मॉडलों: **की-वैल्यू (KVS)** , **दस्तावेज़-उन्मुख (Document)** , **ग्राफ़ (Graph)** , और **वाइड-कॉलम (Wide-column)** की विशेषताओं, फायदे और नुकसान, और उपयुक्त उपयोग के मामलों पर विस्तार से और व्यापक रूप से चर्चा करेंगे।
...
ग्राफ़ डेटाबेस गणित में "ग्राफ़ सिद्धांत (Graph Theory)" के आधार पर एक डेटा मॉडल अपनाते हैं। डेटा बनाने वाले मुख्य तत्व निम्नलिखित तीन हैं:
