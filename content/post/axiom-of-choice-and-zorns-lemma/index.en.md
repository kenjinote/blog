...
# [The Axiom of Choice and Zorn's Lemma](https://kenji.blog/en/p/axiom-of-choice-and-zorns-lemma/): The Concept of "Choice" That Shook the Foundations of Mathematics
...
> A solid ball in three-dimensional [Euclide](https://kenji.blog/en/p/euclid/)an space can be partitioned into a finite number of pieces (for example, 5 fragments). By rearranging these pieces using only rotations and translations (rigid motions) and reassembling them, one can create **two** balls of exactly the same size as the original.
...
[The Axiom of Choice and Zorn's Lemma](https://kenji.blog/en/p/axiom-of-choice-and-zorns-lemma/) demonstrate how the operation of "choice"—so obvious in finite domains that it goes unnoticed—gives rise to profoundly deep, terrifying, and beautiful structures the moment one steps into the realm of infinity.
