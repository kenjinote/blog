...
選擇公理在為數學帶來巨大力量的同時，也導致了完全顛覆我們空間直覺的結果。其中最著名的例子就是 **[巴拿赫-塔斯基悖論](/zh-tw/p/banach-tarski-paradox/)** （Banach-Tarski Paradox）。
...
原因很簡單。如果拒絕選擇公理（只採用 ZF 公理體系），失去的數學成果太過巨大。所有向量空間的基、拓撲空間緊緻性的乘積、勒貝格測度的許多有用性質等都將崩塌。即使付出[巴拿赫-塔斯基悖論](/zh-tw/p/banach-tarski-paradox/)這樣的「代價」，為了維護現代豐富而美麗的抽象數學體系，選擇公理還是被接受了。
