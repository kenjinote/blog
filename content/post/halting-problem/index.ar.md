...
ومع ذلك، في مجال علوم الكمبيوتر، تم إثبات رياضيًا أن مثل هذه الأداة الحلم **"لا يمكن صنعها أبدًا"**. هذا ما يُعرف باسم **"مشكلة التوقف" ([Halting Problem](https://kenji.blog/ar/p/turing-machine-computability/))** الشهيرة.
...
طرح [آلان تورينج](https://kenji.blog/ar/p/turing/) هذه المشكلة وأثبتها في عام 1936، في عصر لم تكن فيه الحواسيب الإلكترونية (الكمبيوتر) موجودة كما هي اليوم. لتعريف "ما هو الحساب؟" بدقة رياضية، ابتكر آلة افتراضية تسمى **"آلة تورينج" ([Turing Machine](https://kenji.blog/ar/p/turing-machine-computability/))**.
