...
في هذه المقالة، سنشرح هذه المشكلة التي أثبتها آلان تورينج (Alan Turing) في عام 1936، بطريقة سهلة الفهم باستخدام أمثلة بديهية، وصيغ رياضية (KaTeX)، ورسوم توضيحية (Mermaid).
...
طرح آلان تورينج هذه المشكلة وأثبتها في عام 1936، في عصر لم تكن فيه الحواسيب الإلكترونية (الكمبيوتر) موجودة كما هي اليوم. لتعريف "ما هو الحساب؟" بدقة رياضية، ابتكر آلة افتراضية تسمى **"آلة تورينج" (Turing Machine)**.
...
## العلاقة العميقة مع مبرهنات عدم الاكتمال لغودل

"مفارقة المرجعية الذاتية" (Self-reference) الكامنة وراء إثبات مشكلة التوقف ترتبط ارتباطًا وثيقًا بـ **"مبرهنات عدم الاكتمال" (Incompleteness Theorems)** التي نشرها كورت غودل (Kurt Gödel) في عام 1931، قبل تورينج بوقت قصير.
