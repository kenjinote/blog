...
然而，在计算机科学领域，这种梦想般的工具已经在数学上被证明为 **“绝对无法做出”** 。这就是著名的 **“停机问题（Halting Problem）”** 。

本文将对阿兰·图灵（Alan Turing）在1936年证明的这个问题，通过直观的具体例子、数学公式（KaTeX）以及图解（Mermaid），进行通俗易懂的解说。
...
停机问题证明根底里的“自我指涉的悖论”，与图灵提出该问题稍早之前的1931年，库尔特·哥德尔（Kurt Gödel）发表的 **“不完备定理（Incompleteness Theorems）”** 有着深刻的联系。
