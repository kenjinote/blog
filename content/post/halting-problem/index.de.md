...
In diesem Artikel erklären wir dieses Problem, das 1936 von Alan Turing bewiesen wurde, verständlich anhand von intuitiven Beispielen, mathematischen Formeln (KaTeX) und Diagrammen (Mermaid).
...
Als Alan Turing dieses Problem 1936 aufwarf und bewies, gab es noch keine elektronischen Rechenmaschinen (Computer) wie heute. Um die Frage „Was ist Berechnung?“ mathematisch exakt zu definieren, erfand er eine fiktive Maschine, die **„Turingmaschine“** (Turing Machine).
...
## Tiefe Verbindung zu Gödels Unvollständigkeitssätzen

Das „Paradoxon der Selbstreferenz“, das dem Beweis des Halteproblems zugrunde liegt, hat eine tiefe Verbindung zu den **„Unvollständigkeitssätzen“** (Incompleteness Theorems), die Kurt Gödel kurz vor Turing im Jahr 1931 veröffentlichte.
