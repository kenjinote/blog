...
Modern development processes are built on the premise of being **cloud-native** and **AI-driven**. [Container](https://kenji.blog/en/p/docker-container-namespace-cgroups-layers/)ization (Docker-layers/)/[Kubernetes](/en/p/kubernetes-k8s-architecture-pod-service-ingress/)), [microservices architecture](/en/p/microservices-architecture-bff-api-gateway/), and [CI/CD](https://kenji.blog/en/p/cicd-pipeline-github-actions-best-practices/) pipeline automation are no longer "special technologies" but "standard infrastructure."
