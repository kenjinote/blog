...
現代的開發流程是以 **雲端原生** 以及 **AI驅動** 為前提。容器化（[Docker](https://kenji.blog/zh-tw/p/docker-container-namespace-cgroups-layers/)/[Kubernetes](/zh-tw/p/kubernetes-k8s-architecture-pod-service-ingress/)）、[微服務架構](/zh-tw/p/microservices-architecture-bff-api-gateway/)、[CI/CD](https://kenji.blog/zh-tw/p/cicd-pipeline-github-actions-best-practices/)流水線的自動化，已經不再是「特別的技術」，而是「標準的基礎設施」。
