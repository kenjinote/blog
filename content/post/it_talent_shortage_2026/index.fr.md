...
Le processus de développement moderne suppose d'être **Cloud Native** et **axé sur l'IA**. La conteneurisation ([Docker](https://kenji.blog/fr/p/docker-container-namespace-cgroups-layers/)/Kubernetes), l'architecture de microservices et l'automatisation des pipelines [CI/CD](https://kenji.blog/fr/p/cicd-pipeline-github-actions-best-practices/) ne sont plus des 'technologies spéciales' mais une 'infrastructure standard'.
