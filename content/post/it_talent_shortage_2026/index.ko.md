...
현대의 개발 프로세스는 **클라우드 네이티브 ** 이며, **AI 주도** 인 것을 전제로 합니다. 컨테이너화([Docker](https://kenji.blog/ko/p/docker-container-namespace-cgroups-layers/)/[Kubernetes](/ko/p/kubernetes-k8s-architecture-pod-service-ingress/)), [마이크로서비스 아키텍처](/ko/p/microservices-architecture-bff-api-gateway/), [CI/CD](https://kenji.blog/ko/p/cicd-pipeline-github-actions-best-practices/) 파이프라인의 자동화는 더 이상 '특별한 기술'이 아니라 '표준적인 인프라'입니다.
...
## 5. [엔지니어를 위한](https://kenji.blog/ko/p/エンジニア向け[プロンプトエンジニアリング](https://kenji.blog/ko/p/large-language-models-llm-transformer-prompt-engineering/)の基本と開発への応用/) 생존 전략: 2026년 이후를 살아남기 위해
