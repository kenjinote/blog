...
现代的开发流程，前提是 **云原生** 和 **AI驱动** 。容器化（[Docker](https://kenji.blog/zh-cn/p/docker-container-namespace-cgroups-layers/)/[Kubernetes](/zh-cn/p/kubernetes-k8s-architecture-pod-service-ingress/)）、[微服务架构](/zh-cn/p/microservices-architecture-bff-api-gateway/)、[CI/CD](https://kenji.blog/zh-cn/p/cicd-pipeline-github-actions-best-practices/)流水线的自动化，早已不再是“特殊技术”，而是“标准基础设施”。
