...
## 3. [GitHub Actions](https://kenji.blog/hi/p/cicd-pipeline-github-actions-best-practices/) का उपयोग करके शेड्यूलिंग और स्वचालन
...
जब नोट्स की संख्या सैकड़ों या हज़ारों में बढ़ जाती है, तो केवल कीवर्ड सर्च (पूर्ण-पाठ खोज) के साथ वांछित नोट ढूंढना मुश्किल हो जाता है। ऐसे मामलों में जहाँ "मुझे कीवर्ड याद नहीं आ रहा है, लेकिन मैं ऐसी अवधारणा वाला एक नोट खोजना चाहता हूँ जो समान हो," बड़े भाषा मॉडल ([LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/)) के Embeddings का लाभ उठाने वाली सिमेंटिक (अर्थ संबंधी) खोज बहुत प्रभावी हो जाती है।
...
उदाहरण के लिए, तकनीकी नींव से संबंधित प्रश्नों को दर्ज करें, जैसे "CAP प्रमेय के 3 तत्व क्या हैं?" और "क्या कारण है कि [B-Tree](https://kenji.blog/hi/p/b-tree-database-index-theory/) इंडेक्स में O(log N) का खोज प्रदर्शन है?", और उन्हें अपनी दैनिक दिनचर्या के हिस्से के रूप में समीक्षा करें। जब ज्ञान को आपके मस्तिष्क में दीर्घकालिक स्मृति के रूप में अनुक्रमित किया जाता है, तो जानकारी अनजाने में जुड़ जाती है जब आप स्नान कर रहे होते हैं या टहल रहे होते हैं, जिससे यह अहसास (यूरेका क्षण) होता है, "आह, मैं वितरित प्रणालियों ([Distributed System](https://kenji.blog/hi/p/cap-theorem-distributed-systems/)s) के सर्वसम्मति एल्गोरिदम पर एक लेख लिख सकता हूँ।"
...
## 9. विचार से लेकर प्रकाशन तक का अवस्था संक्रमण मॉडल ([State](https://kenji.blog/hi/p/iac-infrastructure-as-code-terraform/) Transition Model)
