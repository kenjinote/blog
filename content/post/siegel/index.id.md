...
```mermaid
graph LR
    A["Bentuk modular eliptik (g=1)"] -->|"Ekstensi ke teori fungsi multivariabel"| B["Bentuk modular Siegel (g>=2)"]
    B -->|"Analisis representasi bentuk kuadratik"| C["Rumus Siegel-Weil"]
    C -->|"Teori representasi automorfik"| D["Pengembangan menuju program Langlands"]
```
...
Melalui bakat analitiknya yang tak tertandingi dan rasa hormat yang mendalam terhadap matematika klasik, Carl Ludwig Siegel meninggalkan pencapaian yang menentukan dan mengubah zaman dalam teori bilangan, geometri Diophantine, dan mekanika benda langit.
