...
المصفوفة العشوائية هي مصفوفة تُعطى عناصرها بواسطة متغيرات عشوائية. للوهلة الأولى، إنها مجرد مصفوفة عشوائية من الأرقام، ولكن مع اقتراب حجم المصفوفة من اللانهاية، يظهر قانون جميل وعالمي بشكل مذهل في توزيع [القيم الذاتية (eigenvalues)](/ar/p/eigenvalues-and-eigenvectors/) الخاصة بها. يكمن هذا القانون خلف أنظمة مختلفة تماماً، من العالم المجهري للنوى الذرية، وألغاز توزيع الأعداد الأولية، وتقلبات الأسعار في الأسواق المالية، إلى ديناميكيات التعلم لأحدث نماذج التعلم العميق.
...
والمثير للدهشة أن توزيع التباعد لـ [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) لهذه المصفوفة العشوائية المبسطة للغاية يتطابق تماماً مع توزيع التباعد لمستويات الطاقة في نوى اليورانيوم الفعلية. واكتشف فيغنر أيضاً أنه في النهاية حيث يؤول حجم المصفوفة $N$ إلى اللانهاية، فإن التوزيع الكثافي الكلي لـ [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) يشكل شكل نصف دائرة. هذا هو "قانون نصف الدائرة لفيغنر" الشهير.
...
لنفترض مصفوفة متماثلة حقيقية $X$ بحجم $N \times N$ حيث عناصرها $X_{ij}$ هي متغيرات عشوائية مستقلة بشكل متبادل بمتوسط 0 وتباين 1. نبحث عن النهاية ($N \to \infty$) لتوزيع [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) للمصفوفة المقاسة $W = \frac{1}{\sqrt{N}}X$.

## النهج عن طريق طريقة العزوم

لتحليل دالة التوزيع التجريبية لـ [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/)، نقوم بحساب العزم من الرتبة $k$ وهو $m_k$ للتوزيع. نظراً لأن أثر المصفوفة (مجموع العناصر القطرية) يساوي مجموع [قيمها الذاتية](/ar/p/eigenvalues-and-eigenvectors/)، فإننا نقيم:
...
العدد الإجمالي لمثل هذه المسارات (مسارات دايك) بطول $2m$ يُعطى بواسطة "[أعداد كاتالان](/ar/p/catalan-numbers/)" $C_m$، الشهيرة في التوافيقيات.
...
في أحد الأيام، أثناء وقت الشاي في معهد الدراسات المتقدمة في برينستون، ذكر مونتغمري هذه النتيجة للفيزيائي فريمان دايسون. ذُهل دايسون. لماذا؟ لأن الصيغة كانت مطابقة تماماً لتوزيع التباعد لـ [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) لـ GUE (المجموعة الوحدوية الغاوسية) التي اشتقها دايسون بنفسه.
...
هنا يأتي دور نظرية المصفوفة العشوائية. في عام 1999، طبق بوشو وآخرون ولالو وآخرون بشكل مستقل نظرية المصفوفة العشوائية على مصفوفات التغاير للأسواق المالية. قاموا بمقارنة توزيع [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) لمصفوفة التغاير التي تم الحصول عليها من بيانات السلاسل الزمنية العشوائية البحتة (توزيع مارتشينكو-باستور) مع توزيع [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) لمصفوفة التغاير لبيانات السوق الفعلية.

ونتيجة لذلك، وجدوا أن الغالبية العظمى (أكثر من 90٪) من [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) لبيانات السوق تقع ضمن الحدود النظرية التي تنبأت بها نظرية المصفوفة العشوائية. بعبارة أخرى، هذه مجرد "ضوضاء". من ناحية أخرى، تبين أن عدداً قليلاً فقط من [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) الكبيرة التي تتجاوز الحدود بكثير تحتوي على معلومات مفيدة تعكس بنية الارتباط الحقيقية للسوق (مثل عوامل السوق وعوامل القطاع).

بناءً على هذه الرؤية، تم تطوير طرق لـ "تنظيف" مصفوفة التغاير عن طريق تصفية [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) المقابلة للضوضاء (على سبيل المثال، جعلها صفراً أو استبدالها بمتوسط القيمة). هذا يحسن أداء واستقرار المحافظ بشكل كبير، ويُستخدم حالياً كتقنية قياسية في العديد من الصناديق الكمية.
...
عند تهيئة مصفوفات الأوزان بقيم عشوائية، فإنها تكون بالضبط مصفوفة عشوائية. من خلال تطبيق نظرية المصفوفة العشوائية، يمكن للمرء أن يحلل بدقة انتقال تباين الإشارة أثناء مرورها عبر الطبقات وسلوك التدرجات أثناء الانتشار العكسي (backpropagation). على سبيل المثال، يوفر تحليل تأثير دوال التنشيط غير الخطية على الطيف (توزيع [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/)) للمصفوفات العشوائية مبرراً نظرياً لطرق التهيئة القياسية الحديثة مثل تهيئة Xavier وتهيئة He.

## توزيع القيم الذاتية لهيسيان (Hessian)

فهم ديناميكيات عملية التعلم يتطلب بشكل أساسي تحليل مصفوفة هيسيان، التي تمثل انحناء دالة الخسارة. مصفوفة هيسيان لـ [LLMs](/ar/p/large-language-models-llm-transformer-prompt-engineering/) ([نماذج اللغة الكبيرة](/ar/p/large-language-models-llm-transformer-prompt-engineering/)) التي تحتوي على عشرات الملايين إلى مئات المليارات من المعلمات هي مصفوفة عملاقة، مما يجعل من الصعب فحص خصائصها بشكل مباشر، ولكن يمكن استخدام نظرية المصفوفة العشوائية لتقريب وتوقع توزيع [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) الخاص بها.

أظهرت الدراسات أن توزيع [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) لمصفوفة هيسيان في الشبكات العصبية العميقة يتكون من كتلة (عدد كبير من [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) بالقرب من الصفر) وعدد قليل من القيم المتطرفة الكبيرة (outliers). يمكن نمذجة جزء الكتلة كمصفوفة عشوائية صاخبة (على سبيل المثال، الاتجاهات التي تحتوي على القليل من المعلومات)، بينما تشير القيم المتطرفة إلى اتجاهات تعلم حرجة مرتبطة ارتباطاً مباشراً بالمهمة. يوفر فهم هذه البنية الطيفية رؤى قيّمة للغاية لتحسين تقارب خوارزميات التحسين (مثل SGD و Adam) وتحسين جداول معدل التعلم.
...
عندما تقوم بتشغيل هذا الكود، يمكنك التأكد من أن [القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) للمصفوفات المولدة عشوائياً موزعة في شكل نصف دائري جميل. إن أكبر جاذبية لنظرية المصفوفة العشوائية هي أنه، على الرغم من أن عناصر المصفوفات الفردية عشوائية تماماً، إلا أنه يظهر قانون منظم ومثالي ككل.

---

# الخاتمة

في هذا المقال، تابعنا القصة الكبرى لنظرية المصفوفة العشوائية، بدءاً من الفيزياء النووية وامتداداً إلى الرياضيات البحتة والهندسة المالية وتقنيات الذكاء الاصطناعي الحديثة. إن حقيقة أن الأنظمة المعقدة التي تبدو غير مرتبطة يمكن أن تتواصل باستخدام اللغة المشتركة المتمثلة في "[القيم الذاتية](/ar/p/eigenvalues-and-eigenvectors/) للمصفوفات العشوائية" في ظل الظروف القاسية، توضح العمق الغامض الذي تمتلكه الطبيعة والرياضيات.
