...
2. **Client (क्लाइंट)**
   - यह वह एप्लिकेशन है जो रिसोर्स ओनर की अनुमति से रिसोर्स सर्वर तक पहुंचने का प्रयास करता है। इस उदाहरण में, यह "आपके द्वारा विकसित किया जा रहा Node.js एप्लिकेशन (Slack App)" है। हालाँकि इसे "क्लाइंट" कहा जाता है, यहां तक कि सर्वर साइड पर चलने वाले वेब अनुप्रयोगों को भी [OAuth](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) के संदर्भ में "क्लाइंट" कहा जाता है।
3. **[Authorization](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) Server (ऑथराइजेशन सर्वर)**
...
एक शब्द में, [OAuth](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) फ्लो **"क्लाइंट द्वारा रिसोर्स ओनर की सहमति प्राप्त करने, ऑथराइजेशन सर्वर से एक्सेस टोकन प्राप्त करने, और उसका उपयोग करके रिसोर्स सर्वर से डेटा प्राप्त करने/हेरफेर करने"** की प्रक्रिया है।

---

# 2. ऑथराइजेशन कोड ग्रांट ([Authorization](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) Code Grant) का संपूर्ण विश्लेषण

[OAuth 2.0](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) में कई प्रवाह (ग्रांट प्रकार) मौजूद हैं, लेकिन वेब एप्लिकेशन जैसे सर्वर-साइड वातावरण में जहां सीक्रेट कुंजी (Client Secret) को सुरक्षित रूप से रखा जा सकता है, सबसे अनुशंसित और व्यापक रूप से उपयोग किया जाने वाला **ऑथराइजेशन कोड ग्रांट (Authorization Code Grant)** है।
...
4. "[OAuth](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) & Permissions" स्क्रीन पर जाएं और "Redirect URLs" में कॉलबैक URL रजिस्टर करें। इस बार, स्थानीय विकास को ध्यान में रखते हुए, निम्नलिखित सेट करें।
...
# 4. कार्यान्वयन चरण 1: `/slack/install` और [CSRF](https://kenji.blog/hi/p/web-security-basics-cors-csp/) रोकथाम का `state` पैरामीटर
...
उपयोगकर्ता का ब्राउज़र तुरंत निर्दिष्ट `Location` पर चला जाता है, और Slack की स्क्रीन (Consent Screen) प्रदर्शित होती है, और एक परिचित स्क्रीन दिखाई देती है जो कहती है "My First [OAuth](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) App कार्यक्षेत्र (Workspace) तक पहुंच मांग रहा है"।
...
`xoxb-` से शुरू होने वाला यह स्ट्रिंग Slack में **Bot एक्सेस टोकन** है। इसके बाद, जब एप्लिकेशन Slack API (Resource Server) को अनुरोध भेजता है, तो प्रमाणीकरण ([Authentication](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/)) और प्राधिकरण ([Authorization](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/)) को HTTP हेडर में `Authorization: Bearer xoxb-...` जोड़कर साबित किया जाता है।
...
एक्सेस टोकन (`xoxb-...`) Slack वर्कस्पेस के लिए "मास्टर कुंजी" की तरह है। इसे कभी भी प्लेनटेक्स्ट (सादे पाठ) में डेटाबेस (MySQL, PostgreSQL, [MongoDB](https://kenji.blog/hi/p/nosql-database-selection-kvs-document-graph-wide-column/) आदि) में सहेजा नहीं जाना चाहिए। यदि किसी भी कारण से, जैसे SQL इंजेक्शन द्वारा, डेटाबेस लीक हो जाता है, तो यह एक बड़ी आपदा होगी जिसमें सभी ग्राहकों के Slack खातों पर नियंत्रण कर लिया जाएगा।

डेटाबेस में सेव करने से पहले एप्लिकेशन लेयर पर **AES-256-GCM** जैसे शक्तिशाली सममित-कुंजी एन्क्रिप्शन (Symmetric-key encryption) का उपयोग करके इसे एन्क्रिप्ट करना सुनिश्चित करें। एन्क्रिप्शन/डिक्रिप्शन के लिए मास्टर कुंजी को AWS KMS (Key Management [Service](https://kenji.blog/hi/p/kubernetes-k8s-architecture-pod-service-ingress/)) या GCP Cloud KMS जैसी सुरक्षित कुंजी प्रबंधन सेवाओं का उपयोग करके सख्ती से प्रबंधित किया जाना चाहिए।

## 2. टोकन रोटेशन (Token Rotation)
लंबे समय तक चलने वाले टोकन का उपयोग करना जोखिम भरा हो सकता है। नवीनतम [OAuth](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) कार्यान्वयनों में, "रिफ्रेश टोकन (Refresh Token)" का उपयोग करने और हर कुछ घंटों में एक नया एक्सेस टोकन फिर से जारी करने (टोकन रोटेशन) की अनुशंसा की जाती है। आप विकल्प सेटिंग्स में Slack API में टोकन रोटेशन को भी सक्षम कर सकते हैं।

---

# निष्कर्ष

इस लेख में, हमने Slack App एकीकरण के लिए विशिष्ट Node.js कार्यान्वयन कोड के साथ [OAuth 2.0](https://kenji.blog/hi/p/oauth2-oidc-authentication-authorization-difference/) ऑथराइजेशन कोड ग्रांट प्रवाह के बारे में विस्तार से बताया है।
