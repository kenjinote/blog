...
2000年、クレイ数学研究所は数学における7つの極めて重要な未解決問題に対して、それぞれ100万ドルの懸賞金をかけました。これを **ミレニアム懸賞問題** と呼びます。その中には、有名な「リーマン予想」や「P対NP問題」などが含まれていますが、物理学と深い関わりを持つ問題が一つあります。それが **「ヤン＝ミルズ方程式と質量ギャップ問題」** （Yang-Mills and Mass Gap）です。
