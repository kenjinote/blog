...
slug: "eguiでЯпонский языкを表示する方法"
date: 2023-04-01T03:17:52+09:00
tags: ["rust", "egui", "библиотека-GUI", "японский"]
draft: false
image: "img.webp"
categories: ["it-technology"]
description: 'Объясняется метод реализации для корректного отображения японского языка в легкой GUI-библиотеке для Rust — «egui». Представлены конкретные примеры кода для загрузки шрифта Meiryo в Windows и его применения к приложению.'
---
