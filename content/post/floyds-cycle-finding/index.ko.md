...
본 기사에서는 이 알고리즘의 구조부터 수학적 배경, 그리고 C++과 [Rust](https://kenji.blog/ko/p/webassembly-wasm-current-future/)에 의한 구체적인 구현 예시까지 자세히 해설합니다.
...
그러면 위의 이론을 C++과 [Rust](https://kenji.blog/ko/p/webassembly-wasm-current-future/)로 구현해 보겠습니다.
...
데이터 구조 구현이나 경기 프로그래밍에서 이 알고리즘은 매우 강력한 무기가 됩니다. 꼭 직접 손을 움직여 C++이나 [Rust](https://kenji.blog/ko/p/webassembly-wasm-current-future/)로 구현해 보시기 바랍니다.
