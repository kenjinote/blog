...
لهذا السبب، عند إعطاء سلسلة نصية مخادعة لنمط معين من التعابير النمطية (مثال: `(a+)+$`)، قد تنفجر التعقيدات الحسابية بشكل أسي وتتسبب في تجميد النظام، مما يؤدي إلى ثغرة أمنية تُعرف باسم **ReDoS** (Regular Expression Denial of Service). إذا كنت تعرف النظرية، فيمكنك التفكير منطقيًا في سبب حدوث التراجع وكيفية إعادة كتابة النمط ليتحول إلى معالجة آمنة مكافئة لـ DFA.
