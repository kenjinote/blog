---
title: '[PQC] क्वांटम कंप्यूटर का खतरा और अगली पीढ़ी की पोस्ट-क्वांटम क्रिप्टोग्राफी की पूरी तस्वीर'
...
description: 'सार्वजनिक-कुंजी क्रिप्टोग्राफी में भविष्य में क्वांटम कंप्यूटर के व्यावहारिक अनुप्रयोग के साथ डिक्रिप्ट होने का जोखिम है। यह आलेख अगली पीढ़ी की सुरक्षा तकनीक ''पोस्ट-क्वांटम क्रिप्टोग्राफी (PQC)'' के तंत्र और महत्व के बारे में विस्तार से बताता है, जिसे इस खतरे (Y2Q समस्या) का मुकाबला करने চ্যাম্পियन लिए विकसित किया जा रहा है।'
---

## परिचय: क्वांटम कंप्यूटर द्वारा क्रिप्टोग्राफी के लिए लाया गया "खतरा"

वर्तमान में, हम इंटरनेट पर जो संचार प्रतिदिन करते हैं - ऑनलाइन बैंकिंग में भुगतान, वेबसाइट ब्राउज़िंग (HTTPS), मैसेजिंग ऐप्स के माध्यम से बातचीत, और [ब्लॉकचेन](/hi/p/blockchain-technology-smart-contract-distributed-ledger/) या क्रिप्टोकरेंसी लेनदेन - उनमें से अधिकांश "पब्लिक-की क्रिप्टोग्राफी" (Public-key cryptography) नामक तकनीक द्वारा सुरक्षित हैं। विशेष रूप से, [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) और एलीप्टिक कर्व क्रिप्टोग्राफी ([ECC](/hi/p/elliptic-curve-cryptography-math-cpp/)) जैसे एल्गोरिदम आधुनिक डिजिटल समाज की विश्वसनीयता का आधार हैं।
...
- प्रसंस्करण गति बहुत तेज है (कुछ मामलों में [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) या [ECC](/hi/p/elliptic-curve-cryptography-math-cpp/) से भी तेज)।
...
**सिस्टम का अवलोकन:** 
शुरुआती बिंदु एक वन-टाइम सिग्नेचर स्कीम है जिसे "लैम्पोर्ट सिग्नेचर" (Lamport Signature) कहा जाता है, जिसका उपयोग केवल एक बार किया जा सकता है। "मर्कल ट्री" (Merkle [Tree](https://kenji.blog/hi/p/tree-graph-data-structures-search-dfs-bfs-dijkstra/)) नामक ट्री-संरचित डेटा प्रारूप में इन्हें बंडल करके, एक की-पेयर (key pair) के साथ कई सिग्नेचर संभव हो जाते हैं।
...
### 3. मल्टीवेरिएट पॉलीनोमियल-आधारित क्रिप्टोग्राफी (Multivariate [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy)
...
### 4. कोड-आधारित क्रिप्टोग्राफी (Code-based [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy)
...
हालाँकि NIST ने प्रारंभिक मानकीकरण प्रक्रिया पूरी कर ली है, लेकिन यह और अधिक एल्गोरिदम खोजना जारी रखे हुए है। विशेष रूप से, चूँकि मानक "लैटिस क्रिप्टोग्राफी" की ओर झुके हुए हैं, **एल्गोरिदम विविधता ([Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/) Diversity)** सुनिश्चित करना महत्वपूर्ण माना जाता है। कोड-आधारित क्रिप्टोग्राफी का मूल्यांकन की शेयरिंग के लिए बैकअप मानक के रूप में किया जा रहा है, और भविष्य में PQC की नींव और भी मजबूत हो जाएगी।

---

## PQC माइग्रेशन परिदृश्य और चुनौतियाँ: "क्रिप्टो-एजिलिटी" का महत्व

NIST से आधिकारिक मानकों के जारी होने के साथ, दुनिया भर की सरकारी एजेंसियां, वित्तीय संस्थान और प्रौद्योगिकी कंपनियां मौजूदा [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/)/[ECC](/hi/p/elliptic-curve-cryptography-math-cpp/) से PQC की ओर माइग्रेशन (स्थानांतरण) में तेजी ला रही हैं। NSA (यूएस नेशनल सिक्योरिटी एजेंसी) के दिशानिर्देश भी माइग्रेशन के शीघ्र पूरा होने की सलाह देते हैं।
...
कंपनियों और सिस्टम डेवलपर्स को भविष्य में जिस चीज के बारे में सबसे ज्यादा जागरूक होना चाहिए, वह है **"क्रिप्टो-एजिलिटी" ([Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)-Agility)** सुनिश्चित करना। यदि भविष्य में किसी एल्गोरिदम में कोई दोष पाया जाता है বাধ या कोई नया मानक सामने आता है, तो एक लचीले आर्किटेक्चर डिज़ाइन का होना आवश्यक है जो सिस्टम को रोके बिना क्रिप्टोग्राफ़िक एल्गोरिदम को तुरंत बदल और अपडेट कर सके।

एक क्रिप्टोग्राफ़िक इन्वेंट्री (CBOM: [Crypto](https://kenji.blog/hi/p/cryptocurrency-and-bitcoin/)graphy Bill of Materials) बनाना जो सटीक रूप से पहचानती है कि आपके सिस्टम के भीतर "कहाँ", "कौन सी क्रिप्टोग्राफी", और "किस उद्देश्य से" उपयोग की जा रही है, PQC माइग्रेशन की दिशा में पहला महत्वपूर्ण कदम है।
