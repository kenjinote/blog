...
Actuellement, la plupart des communications que nous effectuons quotidiennement sur Internet — paiements bancaires en ligne, navigation web (HTTPS), échanges sur des applications de messagerie, et même transactions sur [blockchain](/fr/p/blockchain-technology-smart-contract-distributed-ledger/) ou cryptomonnaies — sont protégées par une technologie appelée "cryptographie à clé publique". Plus précisément, des algorithmes comme le chiffrement [RSA](https://kenji.blog/fr/p/modern-cryptography-public-key-hash-signature/) et la cryptographie sur les courbes elliptiques ([ECC](/fr/p/elliptic-curve-cryptography-math-cpp/)) constituent le fondement de la fiabilité de notre société numérique moderne.
...
Pour faire face à cette crise sans précédent, des cryptographes et des instituts de recherche du monde entier concentrent leurs efforts pour développer la **cryptographie post-quantique (PQC : Post-Quantum [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphy)** , une technologie de chiffrement de nouvelle génération capable de maintenir la sécurité même contre les attaques d'ordinateurs quantiques. Dans cet article, nous expliquerons en détail depuis les bases de la PQC jusqu'aux mécanismes de ses principaux algorithmes, ainsi que les dernières tendances de normalisation mondiale menées par l'Institut national des normes et de la technologie (NIST) des États-Unis.

---

## Qu'est-ce que la cryptographie post-quantique (PQC) ?

La cryptographie post-quantique (Post-Quantum [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphy, PQC) est un terme générique désignant les algorithmes de chiffrement conçus pour fonctionner sur les ordinateurs classiques existants, tout en résistant aux attaques (comme l'algorithme de Shor) menées par de futurs ordinateurs quantiques à grande échelle.

Des technologies souvent confondues sont la "cryptographie quantique (Quantum [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphy)" et la "distribution quantique de clés (QKD)", mais il s'agit d'approches totalement différentes. La cryptographie quantique (QKD) est une technologie matérielle qui utilise les lois de la mécanique quantique (comme le fait que l'observation modifie l'état) pour rendre l'écoute sur le canal de communication physiquement impossible. Elle nécessite des fibres optiques dédiées et des équipements spéciaux, ce qui pose des problèmes de coût de déploiement et de limite de distance.

En revanche, **la PQC est une technologie de cryptographie purement logicielle basée sur les mathématiques** . Par conséquent, elle peut être intégrée sous forme de mise à jour logicielle dans l'infrastructure Internet existante, les serveurs, les smartphones, les navigateurs, etc., ce qui la rend extrêmement applicable dans le monde réel. Pour les entreprises informatiques et les gouvernements du monde entier, remplacer (migrer) le [RSA](https://kenji.blog/fr/p/modern-cryptography-public-key-hash-signature/) et l'[ECC](/fr/p/elliptic-curve-cryptography-math-cpp/) actuellement utilisés par cette PQC est une tâche urgente.
...
### 1. [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphie fondée sur les réseaux (Lattice-based [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphy)
...
- Vitesse de traitement très rapide (parfois plus rapide que [RSA](https://kenji.blog/fr/p/modern-cryptography-public-key-hash-signature/) ou [ECC](/fr/p/elliptic-curve-cryptography-math-cpp/)).
...
### 2. [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphie fondée sur le hachage (Hash-based [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphy)
...
### 3. [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphie multivariée (Multivariate [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphy)
...
### 4. [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphie fondée sur les codes (Code-based [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphy)
...
1. **FIPS 203: ML-KEM (anciennement : CRYSTALS-Kyber)** 
   ...
   - **Technologie de base :** [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphie fondée sur les réseaux (Module-LWE)
...
3. **FIPS 205: SLH-DSA (anciennement : SPHINCS+)** 
   - **Utilisation :** Signature numérique
   - **Technologie de base :** [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphie fondée sur le hachage (sans état)
...
Bien que le NIST ait terminé son premier processus de normalisation, il continue d'explorer d'autres algorithmes. La normalisation étant particulièrement biaisée en faveur de la "cryptographie fondée sur les réseaux", il est jugé essentiel d'assurer la **diversité des algorithmes ([Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/) Diversity)** . Des évaluations sont en cours pour des méthodes comme la cryptographie basée sur les codes comme norme de sauvegarde pour l'échange de clés, et les fondations de la PQC devraient devenir encore plus solides à l'avenir.

---

## Scénarios de transition vers la PQC et défis : L'importance de la "[Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)-Agilité"

Avec la publication de normes officielles par le NIST, les agences gouvernementales, les institutions financières et les entreprises technologiques du monde entier accélèrent leur migration (transition) des systèmes existants [RSA](https://kenji.blog/fr/p/modern-cryptography-public-key-hash-signature/)/[ECC](/fr/p/elliptic-curve-cryptography-math-cpp/) vers la PQC. Les directives d'organismes tels que la NSA (Agence nationale de sécurité américaine) recommandent également d'achever cette migration rapidement.
...
### Réalisation de la crypto-agilité ([Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)-Agility)

Ce dont les entreprises et les développeurs de systèmes devront être le plus conscients à l'avenir, c'est d'assurer la **"crypto-agilité ([Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)-Agility)"** . Il est essentiel de concevoir une architecture flexible permettant d'échanger et de mettre à jour rapidement les algorithmes de chiffrement sans arrêter le système, au cas où des failles seraient découvertes dans un algorithme ou si de nouvelles normes apparaissaient à l'avenir.

La création d'un inventaire cryptographique (CBOM : [Crypto](https://kenji.blog/fr/p/cryptocurrency-and-bitcoin/)graphy Bill of Materials) pour identifier avec précision "où", "quelle cryptographie" et "dans quel but" est utilisée au sein des systèmes de l'entreprise constitue une première étape importante vers la migration PQC.
