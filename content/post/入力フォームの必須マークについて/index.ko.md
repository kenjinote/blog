...
title: '입력 폼의 필수 마크 최적화｜해외 UI 가이드라인에서 배우는 모범 사례'
...
image: "img.webp"
categories: ["블로그 운영"]
description: '웹 폼에서의 ''필수 항목'' 마크에 대한 모범 사례를 해외 UI 가이드라인을 바탕으로 해설합니다. 별표(*)의 올바른 사용법이나 ''Required'' 명시, 접근성 향상을 위한 ARIA 속성 활용법을 정리했습니다.'
---
