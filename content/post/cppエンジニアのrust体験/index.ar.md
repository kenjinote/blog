...
تدمج Rust مفهوم "الملكية" في التصميم الأساسي للغة، وتُجري تحليلًا ثابتًا صارمًا من خلال ميزة في المترجم تُعرف باسم **مدقق الاستعارة ([Borrow Checker](https://kenji.blog/ar/p/memory-management-garbage-collection/))**.
...
أهم ما يميز الإرسال الديناميكي في [Rust](https://kenji.blog/ar/p/webassembly-wasm-current-future/) (`dyn Trait`) هو أنه لا يمتلك vptr داخل بنية البيانات، بل يستخدم **مؤشرًا سمينًا (Fat Pointer)**. يحتفظ المؤشر السمين بزوج يتكون من "مؤشر إلى البيانات" و "مؤشر إلى vtable". هذا يجعل من السهل جدًا تنفيذ (أو توسيع) السمات للأنواع المعرفة في المكتبات الخارجية لاحقًا وإرسالها ديناميكيًا.
