...
## Kepemilikan (Ownership) [Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/) dan Pertahanan Absolut [Borrow Checker](https://kenji.blog/id/p/memory-management-garbage-collection/)

[Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/) menggabungkan konsep "kepemilikan" ini ke dalam desain inti bahasanya, dan melakukan analisis statis yang ketat melalui fitur kompilator yang disebut **Borrow Checker (Pengecek Peminjaman)**.
...
Yang lebih kuat lagi adalah aturan "peminjaman (Borrowing)" yang merujuk pada sumber daya. Di [Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/), aturan berikut ini dipaksakan:
...
Di C++, sangat mudah untuk membuat beberapa referensi atau pointer yang mutable (dapat diubah) ke objek yang sama, dan ini memicu kerusakan status yang tidak terduga (seperti pembatalan iterator). [Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/) mencegah bug ini sejak awal dengan melarang kombinasi "Aliasing (penamaan alternatif) + Mutability (kemampuan diubah)" di tingkat bahasa.
...
Sebaliknya, [Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/) secara tegas memisahkan smart pointer sesuai dengan tujuan penggunaannya.
...
Terlebih lagi, di dalam [Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/) terdapat 2 sifat inti (core traits) yang menjamin keamanan pemrosesan paralel.
...
[Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/) memungkinkan dilakukannya refaktor untuk memaksimalkan $P$ ini dengan sangat aman, mengandalkan sistem tipe.
...
Di [Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/), konsep pengecualian tidak ada. Kesalahan dikembalikan murni sebagai "nilai", dan direpresentasikan menggunakan tipe enumerasi (tipe data aljabar) `Result<T, E>`.
...
[Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/) membuang "pewarisan kelas" ala orientasi objek klasik dan sebagai gantinya mengadopsi konsep "**Traits**" (ini mirip dengan Konsep/Concept C++20, namun jauh lebih kaya fitur).
...
[Rust](https://kenji.blog/id/p/webassembly-wasm-current-future/) hadir dengan standar **Cargo**, yaitu gabungan antara manajer paket dan sistem build terbaik di dunia.
