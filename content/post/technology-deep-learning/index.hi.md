...
और अब, इस डीप लर्निंग को आगे बढ़ाते हुए "Transformer (ट्रांसफॉर्मर)" नामक एक आर्किटेक्चर सामने आया है, और एक विशाल न्यूरल नेटवर्क बनाया गया है जिसने इंटरनेट पर बड़ी मात्रा में टेक्स्ट डेटा सीखा है। यह "**लार्ज लैंग्वेज मॉडल ([LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/))**" है, और यही वह "जेनरेटिव AI" जिसे हम हर दिन **ChatGPT** के रूप में उपयोग करते हैं।
