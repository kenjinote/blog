...
وفي الوقت الحاضر، ظهرت بنية تُسمى "Transformer" وهي تطور للتعلم العميق، مما أدى إلى ولادة شبكات عصبية ضخمة تعلمت من كميات هائلة من البيانات النصية الموجودة على الإنترنت. هذا هو "**النموذج اللغوي الكبير ([LLM](/ar/p/local-llm-windows-2026/))**"، وهو الجوهر الحقيقي لـ "الذكاء الاصطناعي التوليدي" الذي نستخدمه يومياً مثل **ChatGPT**.
