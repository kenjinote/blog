...
# परिचय: [Transformer](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) का गणित क्यों सीखें?
...
हालांकि, अक्सर "Attention (ध्यान तंत्र) का उपयोग करके संदर्भ को समझने" जैसी गुणात्मक व्याख्याएं Transformer के काम करने के तरीके के बारे में देखने को मिलती हैं, लेकिन वास्तविकता यह है कि [शुरुआती लोगों के लिए](/hi/p/%E0%A4%9A%E0%A4%AE%E0%A4%A1%E0%A4%BC%E0%A5%87-%E0%A4%95%E0%A5%87-%E0%A4%89%E0%A4%A4%E0%A5%8D%E0%A4%AA%E0%A4%BE%E0%A4%A6%E3%81%AE%E3%83%A1%E3%83%B3%E3%83%86%E3%83%8A%E3%83%B3%E3%82%B9/) इसके पीछे की **गणितीय संरचना** में गहराई से जाने वाले स्पष्टीकरण आश्चर्यजनक रूप से कम हैं। यह वास्तव में समझने के लिए कि AI "शब्दों" को "गणितीय सूत्रों" के रूप में कैसे संसाधित करता है और आश्चर्यजनक रूप से प्राकृतिक पाठ कैसे उत्पन्न करता है, इसके गणितीय तंत्र को समझना आवश्यक है।
...
[Transformer](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/), RNN की तरह क्रमिक रूप से शब्दों को संसाधित नहीं करता है, बल्कि सभी शब्दों को एक साथ समानांतर में संसाधित करता है। गणना गति के दृष्टिकोण से यह एक बड़ा लाभ है, लेकिन साथ ही यह **"शब्दों का क्रम (Word order)" जैसी महत्वपूर्ण जानकारी खो जाने** की समस्या का कारण बनता है। उदाहरण के लिए, "कुत्ता आदमी को काटता है" और "आदमी कुत्ते को काटता है" में समान इनपुट शब्द सेट हैं, लेकिन उनके अर्थ पूरी तरह से अलग हैं।
...
डीप लर्निंग में, जैसे-जैसे नेटवर्क में लेयर्स गहरी होती जाती हैं, प्रशिक्षण के दौरान ग्रेडिएंट गायब हो जाते हैं या फट जाते हैं (Exploding gradient), जिससे एक समस्या उत्पन्न होती है कि वे अच्छी तरह से नहीं सीख पाते। इसे रोकने के लिए, [Transformer](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) के प्रत्येक सब-लेयर (Attention और FFN) के चारों ओर **अवशिष्ट कनेक्शन (Residual Connection)** और ** लेयर नॉर्मलाइज़ेशन (Layer Normalization)** को रखा गया है।
...
यदि वाक्य छोटा है तो यह कोई समस्या नहीं है, लेकिन यदि आप एक पूरी किताब जैसा लंबा संदर्भ [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) में इनपुट करने का प्रयास करते हैं, तो $N$ दसियों हज़ार से लेकर लाखों तक पहुँच सकता है, और पारंपरिक Attention गणना GPU मेमोरी को तुरंत समाप्त कर देगी।
...
इस लेख में, हमने [Transformer](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) मॉडल के भीतर गहराई में छिपी गणितीय संरचना को उजागर किया है।
