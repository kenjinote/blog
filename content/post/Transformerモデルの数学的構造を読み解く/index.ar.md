...
في المستقبل، قد تظهر بنيات جديدة تتجاوز Transformer (مثل Mamba، وهو نموذج حالة الفضاء - [State](https://kenji.blog/ar/p/iac-infrastructure-as-code-terraform/) Space Model)، ولكن الإطار الرياضي لـ "فهم السياق بواسطة الاهتمام" الذي بناه Transformer سيُحفر بالتأكيد إلى الأبد في تاريخ الذكاء الاصطناعي.
