...
# مقدمة: لماذا نتعلم رياضيات الـ [Transformer](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/)؟
...
ومع ذلك، في حين نرى غالباً تفسيرات نوعية لآلية عمل Transformer مثل "فهم السياق باستخدام Attention (آلية الانتباه)"، إلا أن التفسيرات التي تتعمق في **البنية الرياضية** الكامنة وراءها [للمبتدئين](/ar/p/%D9%85%D9%86%D8%AA%D8%AC%D8%A7%D8%AA-%D8%AC%D9%84%D8%AF%D9%8A%D8%A9%E3%81%AE%E3%83%A1%E3%83%B3%E3%83%86%E3%83%8A%E3%83%B3%E3%82%B9/) قليلة بشكل مفاجئ. لفهم كيف يقوم الذكاء الاصطناعي بمعالجة "الكلمات" كـ "معادلات رياضية" وتوليد نصوص طبيعية بشكل مذهل حقاً، من الضروري فك تشفير آليته الرياضية.
...
في التعلم العميق، عندما يتم زيادة عمق طبقات الشبكة، تحدث مشكلة تلاشي أو انفجار التدرج أثناء التدريب، مما يعيق التعلم بشكل صحيح. لمنع حدوث ذلك، يتم وضع **اتصال متبقي (Residual Connection)** و ** تسوية الطبقة (Layer Normalization)** حول كل طبقة فرعية (الانتباه و FFN) في الـ [Transformer](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/).
...
لا تمثل هذه مشكلة عندما تكون الجمل قصيرة، ولكن عند محاولة إدخال سياق طويل جداً مثل كتاب كامل في نماذج [LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/)، يصل $N$ إلى عشرات الآلاف أو مئات الآلاف، وفي الحسابات التقليدية للانتباه، ستنفد ذاكرة وحدة معالجة الرسومات (GPU) على الفور.
...
في هذا المقال، قمنا بفك تشفير البنية الرياضية العميقة لنموذج [Transformer](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/).
...
في المستقبل، قد تظهر بنيات جديدة تتجاوز Transformer (مثل Mamba، وهو نموذج حالة الفضاء - [State](https://kenji.blog/ar/p/iac-infrastructure-as-code-terraform/) Space Model)، ولكن الإطار الرياضي لـ "فهم السياق بواسطة الاهتمام" الذي بناه [Transformer](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) سيُحفر بالتأكيد إلى الأبد في تاريخ الذكاء الاصطناعي.

إذا سنحت لك الفرصة لاستخدام نماذج [LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) مثل ChatGPT أو Claude في المستقبل، فحاول أن تتخيل تريليونات المرات من ضرب المصفوفات $Q K^T$ التي تُحسب كل ثانية في الخلفية، ودالة Softmax التي تستخرج الاحتمالات. سيرتفع وعيك بالتقنية، وستجد عالم الذكاء الاصطناعي أكثر إثارة للاهتمام.
