---
title: "¿Mercader de la muerte o mensajero de la paz? El verdadero legado de Alfred Nobel"
...
```mermaid
graph TD
    A["Alfred Nobel"] -->|Invención| B["Dinamita (1867)"]
    B -->|Uso Industrial| C["Desarrollo de Infraestructura"]
    B -->|Uso Militar| D["Armamentismo"]
    D --> E["Error Periodístico (Mercader de la Muerte)"]
    E -->|Reflexión y Agonía| F["Testamento (1895)"]
    F -->|Legado| G["Premio Nobel"]
    G --> H["Física"]
    G --> I["Química"]
    G --> J["Fisiología / Medicina"]
    G --> K["Literatura"]
    G --> L["Paz"]
```
