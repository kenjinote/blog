---
title: "Mercador da Morte ou Mensageiro da Paz: O Verdadeiro Legado de Alfred Nobel"
...
```mermaid
graph TD
    A["Alfred Nobel"] -->|Invenção| B["Dinamite (1867)"]
    B -->|Uso Industrial| C["Desenvolvimento de Infraestruturas"]
    B -->|Uso Militar| D["Uso como Arma"]
    D --> E["Erro de Jornal (Mercador da Morte)"]
    E -->|Reflexão e Agonia| F["Testamento (1895)"]
    F -->|Legado| G["Prêmio Nobel"]
    G --> H["Física"]
    G --> I["Química"]
    G --> J["Fisiologia / Medicina"]
    G --> K["Literatura"]
    G --> L["Paz"]
```
