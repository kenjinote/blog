---
title: "Pedagang Kematian atau Utusan Perdamaian: Warisan Sejati Alfred Nobel"
...
```mermaid
graph TD
    A["Alfred Nobel"] -->|Penemuan| B["Dinamit (1867)"]
    B -->|Penggunaan Industri| C["Pembangunan Infrastruktur"]
    B -->|Penggunaan Militer| D["Persenjataan"]
    D --> E["Kesalahan Surat Kabar (Pedagang Kematian)"]
    E -->|Refleksi dan Penderitaan| F["Surat Wasiat (1895)"]
    F -->|Warisan| G["Hadiah Nobel"]
    G --> H["Fisika"]
    G --> I["Kimia"]
    G --> J["Fisiologi / Kedokteran"]
    G --> K["Sastra"]
    G --> L["Perdamaian"]
```
