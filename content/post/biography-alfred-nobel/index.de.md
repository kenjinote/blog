---
title: "Kaufmann des Todes oder Friedensbote: Das wahre Vermächtnis von Alfred Nobel"
...
```mermaid
graph TD
    A["Alfred Nobel"] -->|Erfindung| B["Dynamit (1867)"]
    B -->|Industrielle Nutzung| C["Infrastrukturentwicklung"]
    B -->|Militärische Nutzung| D["Bewaffnung"]
    D --> E["Zeitungsfehler (Kaufmann des Todes)"]
    E -->|Reflexion & Qual| F["Testament (1895)"]
    F -->|Vermächtnis| G["Nobelpreis"]
    G --> H["Physik"]
    G --> I["Chemie"]
    G --> J["Physiologie / Medizin"]
    G --> K["Literatur"]
    G --> L["Frieden"]
```
