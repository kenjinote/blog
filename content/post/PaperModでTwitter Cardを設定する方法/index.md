---
title: 'Hugo PaperModでTwitter Card（Xカード）を設定する方法'
...
categories: ["ブログ運営"]
description: 'HugoのPaperModテーマにおけるTwitter Cardの設定方法を解説します。サイト全体に適用するconfig.tomlへの記述方法と、各記事のMarkdownヘッダへ個別に画像を指定する方法を紹介。SNSシェア時のアイキャッチ画像表示に役立つ設定手順です。'
---
# はじめに
