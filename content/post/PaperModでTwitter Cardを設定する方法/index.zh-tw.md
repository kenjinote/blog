---
title: '在 Hugo PaperMod 中設定 Twitter Card (X Card) 的方法'
...
categories: ["ブログ運営"]
description: '說明在 Hugo 的 PaperMod 主題中設定 Twitter Card 的方法。介紹套用於整個網站的 config.toml 撰寫方式，以及在各篇文章的 Markdown 標頭中個別指定圖片的方法。這是有助於在社群媒體分享時顯示首圖的設定步驟。'
---
# 簡介
