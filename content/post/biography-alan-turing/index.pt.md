---
title: "Alan Turing: O Pai da IA e seu Fim Trágico"
date: "2026-09-24T16:08:36+09:00"
description: "Aprofundaremos detalhadamente a vida, as conquistas e o legado de Alan Turing, um matemático genial que lançou as bases da ciência da computação moderna e da inteligência artificial, mas que sofreu um fim trágico à mercê de sua época."
...
```mermaid
graph TD
    A["Fita de entrada"] -- "Leitura/Escrita de dados" --> B["Cabeça"]
    B -- "Transição de estado" --> C["Registro de estado"]
    C -- "Determina a próxima ação" --> D["Tabela de regras de controle"]
    D -- "Instrução de ação" --> B
```
...
```mermaid
graph LR
    A["Juiz humano (C)"] -- "Pergunta em texto" --> B["Humano (B)"]
    A -- "Pergunta em texto" --> C["Computador (A)"]
    B -- "Resposta" --> A
    C -- "Resposta (fingindo ser humano)" --> A
```
