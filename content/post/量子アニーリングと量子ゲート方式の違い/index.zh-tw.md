...
- **質因數分解（Shor 演算法）**: 能在多項式時間內對巨大的合成數進行質因數分解的演算法。一旦其實用化，將會破解當前如 [RSA](https://kenji.blog/zh-tw/p/modern-cryptography-public-key-hash-signature/) 等公開金鑰密碼基礎建設，因此轉向抗量子密碼學（PQC）已成為當務之急。
