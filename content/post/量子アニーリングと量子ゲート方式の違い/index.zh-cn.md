...
- **质因数分解（Shor算法）**: 能够在多项式时间内分解巨大合数的算法。一旦该算法投入实际应用，目前的[RSA](https://kenji.blog/zh-cn/p/modern-cryptography-public-key-hash-signature/)等公钥加密基础设施将被破解，因此向抗量子密码（PQC）过渡已迫在眉睫。
