...
क्वांटम एनीलिंग इस भौतिक प्रणाली की प्रकृति का लाभ उठाता है कि प्राकृतिक दुनिया हमेशा "निम्नतम ऊर्जा अवस्था (ग्राउंड स्टेट/Ground [State](https://kenji.blog/hi/p/iac-infrastructure-as-code-terraform/))" में बसने का प्रयास करती है।
...
क्वांटम गेट मॉडल में, क्वांटम बिट्स के पूरे सिस्टम की स्थिति को "स्टेट वेक्टर ([State](https://kenji.blog/hi/p/iac-infrastructure-as-code-terraform/) Vector)" $|\psi\rangle$ के रूप में दर्शाया जाता है। एक सिंगल क्यूबिट की स्थिति को बेसिस स्टेट्स $|0\rangle$ और $|1\rangle$ के रैखिक संयोजन (linear combination) के रूप में व्यक्त किया जाता है:
...
हम जिस मौजूदा चरण में हैं वह दर्जनों से लेकर सैकड़ों क्यूबिट्स वाले **NISQ (Noisy Intermediate-Scale Quantum)** उपकरणों का युग है, जिनमें त्रुटि सुधार नहीं होता है। पूर्ण त्रुटि सुधार वाले **FTQC (Fault-Tolerant [Quantum Computing](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/))** को प्राप्त करने के लिए अभी भी कई सफलताओं (breakthroughs) की आवश्यकता है।
...
- **प्राइम फैक्टराइजेशन ([Shor's Algorithm](https://kenji.blog/hi/p/quantum-computing-shors-algorithm/))**: एक एल्गोरिदम जो बहुपद समय (polynomial time) में विशाल समग्र संख्याओं का अभाज्य गुणनखंडन (prime factorization) करता है। यदि इसे व्यावहारिक उपयोग में लाया जाता है, तो वर्तमान सार्वजनिक-कुंजी (public-key) एन्क्रिप्शन बुनियादी ढाँचा जैसे कि [RSA](https://kenji.blog/hi/p/modern-cryptography-public-key-hash-signature/) एन्क्रिप्शन टूट जाएगा, जिससे पोस्ट-क्वांटम क्रिप्टोग्राफी (PQC) में संक्रमण एक तत्काल आवश्यकता बन जाएगी।
