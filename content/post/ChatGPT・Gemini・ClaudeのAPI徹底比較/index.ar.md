...
نهدف إلى أن يكون هذا دليلاً كاملاً لقرائنا لاختيار API الخاص بـ [LLM](/ar/p/local-llm-windows-2026/) الأنسب لحالات الاستخدام الخاصة بهم، وبناء تطبيقات ذكاء اصطناعي قابلة للتوسع وعالية الكفاءة من حيث التكلفة.
...
| **Google** | [Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/) 1.5 Pro | 2,000K | معالجة النصوص الطويلة جدًا، متعدد الوسائط (فيديو/صوت) | تحليل قواعد البيانات البرمجية الضخمة، تلخيص الفيديو |
| **Google** | [Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/) 1.5 Flash | 2,000K | زمن استجابة منخفض، إنتاجية عالية، تكلفة منخفضة جدًا | المعالجة في الوقت الفعلي، معالجة الدفعات للبيانات الضخمة |
| **Anthropic** | Claude 3.5 Sonnet | 200K | قدرات البرمجة، توليد نصوص طبيعية | دعم تطوير البرمجيات، خدمة العملاء المتقدمة |
| **Anthropic** | Claude 3.5 Haiku | 200K | استجابة فائقة السرعة، أداء عالي مقابل التكلفة | الذكاء الاصطناعي للطرفيات ([Edge AI](/ar/p/edge-ai-future-iot-implementation/))، روبوتات الدردشة في الوقت الفعلي |

---

## 3. تعمق في البنية: ما وراء كواليس طلبات API

عند استدعاء [LLM](/ar/p/local-llm-windows-2026/) API، ما هي العمليات التي تتم في الخلفية؟ من أجل تحسين الأداء، من الضروري فهم هذه البنية.
...
في التطبيقات التي تعمل في الوقت الفعلي، يرتبط زمن الاستجابة (Latency) ارتباطًا مباشرًا بتجربة المستخدم (UX). يمكن نمذجة زمن الاستجابة الكلي لـ [LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) API ریاضیًا كالتالي:
...
يزداد التعقيد الحسابي للانتباه الذاتي في بنية [Transformer](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) بشكل تربيعي بالنسبة لطول التسلسل المدخل $L$.

$$ \text{Complexity} = O(L^2 \cdot d) $$

حيث $d$ هو عدد أبعاد متجه التضمين (Embedding). وبسبب هذا القيد، يتدهور $T_{TTFT}$ عادة بشكل حاد عندما تطول المطالبة.
ومع ذلك، تتبنى نماذج [Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/) 1.5 من Google بنيات تحسين ثورية مثل "Ring Attention" و "Block-wise Compute"، ونجحت في إنشاء الرمز الأول في وقت معقول (من بضع ثوانٍ إلى عشرات الثواني) حتى عند إدخال نص طويل يصل إلى 2 مليون رمز.
...
في Anthropic (Claude) و Google ([Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/))، من خلال التخزين المؤقت لكتل نصية معينة، يمكن تقليل تكاليف الإدخال بشكل كبير (حتى 90%).
...
هنا سنقوم بكتابة نص برمجي باستخدام Python لإرسال طلبات غير متزامنة إلى 3 واجهات برمجة تطبيقات (OpenAI و Anthropic و [Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/)) في نفس الوقت، ومقارنة أوقات الاستجابة.
...
لجعل [LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) يعمل كـ "وكيل ذكاء اصطناعي" (AI Agent) يتفاعل مع الأنظمة الخارجية، وليس مجرد روبوت دردشة، فإن استدعاء الأدوات أو الوظائف (Tool Calling) يعد أمرًا ضروريًا. فيما يلي مثال باستخدام Node.js (TypeScript) لجعل OpenAI API يستدعي واجهة برمجة تطبيقات الطقس.
...
تمتلك نماذج Claude 3.5 Sonnet و [Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/) 1.5 Pro أيضًا ميزات مشابهة لاستدعاء الأدوات، وعلى الرغم من وجود اختلافات طفيفة في طرق تعريف المخططات، إلا أن التدفق الأساسي يظل مشتركًا.
...
- **Google ([Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/) 1.5 Pro)**: ** تتغلب على جميع المنافسين في تحليل الفيديو.** يمكن إدخال ملف فيديو مدته ساعة (الإطارات + الصوت) كما هو، ويمكنها الإجابة على أسئلة دقيقة مثل "ما هو عنوان المستند الذي يحمله الشخص الذي يظهر على الحافة اليمنى من الشاشة في الدقيقة 12 و45 ثانية؟".
...
عند استخدام الشركات لـ [LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/) API في بيئة الإنتاج، فإن أكبر مخاوفها تتمحور حول "هل ستُستخدم بياناتنا في تدريب الذكاء الاصطناعي؟" و"هل يلبي متطلبات الامتثال؟".
...
2. **تحليل المستندات الطويلة جدًا، المعالجة الدفعية للفيديو/الصوت**:
   **👑 الفائز: [Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/) 1.5 Pro (Google)**
   نافذة السياق التي تبلغ 2 مليون رمز هي سلاح لا مثيل له. لا يوجد ما يضاهي [Gemini](/ar/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D8%B7%D8%B1%D9%8A%D9%82%D8%A9-%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%85%D9%84/) في المهام التي تتطلب فهم الصورة الكاملة للبيانات، مثل تحليل مئات الصفحات من أدلة PDF أو تلخيص تسجيلات اجتماعات طويلة.
...
الاتجاه المستقبلي هو عدم الاعتماد على API واحد (Vendor lock-in)، بل التبديل الديناميكي بين النماذج حسب صعوبة أو أهمية المهمة، وهو ما يُعرف بهندسة **"توجيه [LLM](https://kenji.blog/ar/p/large-language-models-llm-transformer-prompt-engineering/)" (LLM Routing)**.
