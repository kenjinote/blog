...
| **Google** | [Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/) 1.5 Pro | 2,000K | Обработка сверхдлинных текстов, мультимодальность (видео/аудио) | Анализ огромных кодовых баз, суммаризация видео |
| **Google** | [Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/) 1.5 Flash | 2,000K | Низкая задержка, высокая пропускная способность, низкая стоимость | Обработка в реальном времени, пакетная обработка больших объемов данных |
...
В приложениях реального времени задержка напрямую влияет на пользовательский опыт (UX). Задержку [LLM](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/) API $T_{total}$ можно математически смоделировать следующим образом:
...
Вычислительная сложность внутреннего внимания (Self-Attention) в архитектуре [Transformer](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/) возрастает квадратично относительно длины входной последовательности $L$.
...
Однако в модели [Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/) 1.5 от Google используются инновационные архитектурные оптимизации, такие как «Ring Attention» и «Block-wise Compute», что позволяет генерировать первый токен за разумное время (от нескольких секунд до нескольких десятков секунд) даже при подаче текста длиной в 2 миллиона токенов.
...
Anthropic (Claude) и Google ([Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/)) позволяют кэшировать определенные блоки текста, снижая затраты на ввод (до 90%).
...
В этом разделе мы используем Python для написания скрипта, который одновременно отправляет асинхронные запросы к трем API: OpenAI, Anthropic и [Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/), а затем сравнивает их задержки.
...
Чтобы заставить [LLM](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/) работать не просто как чат-бот, а как «ИИ-агент», взаимодействующий с внешними системами, необходим функционал Tool Calling (или Function Calling). Ниже приведен пример на Node.js (TypeScript), в котором API OpenAI просят вызвать API погоды.
...
Claude 3.5 Sonnet и [Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/) 1.5 Pro также имеют аналогичные функции Tool Calling, и хотя способы определения схем немного отличаются, базовый рабочий процесс остается тем же.
...
- **Google ([Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/) 1.5 Pro)**: ** Безоговорочный лидер в анализе видео.** Позволяет напрямую загружать часовой видеофайл (кадры + звук) и получать ответы на такие узконаправленные вопросы, как: «Как называется документ в руках человека, появившегося в правой части экрана на 12-й минуте 45-й секунде?».
...
Когда компании используют [LLM](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/) API в производственной среде, они больше всего беспокоятся о том, «Не будут ли наши данные использоваться для обучения ИИ?» и «Соответствует ли это требованиям комплаенса?».
...
- **OpenAI**: При использовании Azure OpenAI [Service](https://kenji.blog/ru/p/kubernetes-k8s-architecture-pod-service-ingress/) вы получаете доступ к системе безопасности корпоративного уровня от Microsoft, SLA и возможности подключения к закрытой сети с помощью Azure Private Link.
...
2. **Анализ сверхдлинных документов и массовая обработка видео/аудио**:
   **👑 Победитель: [Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/) 1.5 Pro (Google)**
   Контекстное окно в 2 миллиона токенов — это его уникальное преимущество. Если вам необходимо охватить картину целиком, например, проанализировать сотни страниц PDF-руководств или резюмировать многочасовые видеозаписи встреч, [Gemini](/ru/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1-%D1%80%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D1%8F/) просто нет равных.
...
Вместо того чтобы полагаться на один API (vendor lock-in), будущим трендом становится архитектура **«[LLM](https://kenji.blog/ru/p/large-language-models-llm-transformer-prompt-engineering/)-маршрутизации (LLM Routing)»**, при которой модель динамически переключается в зависимости от сложности и важности задачи.
