...
हमारा उद्देश्य है कि यह पाठकों के लिए एक संपूर्ण मार्गदर्शिका बने जिससे वे अपने उपयोग के मामलों के लिए सर्वश्रेष्ठ [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) API का चयन कर सकें और स्केलेबल तथा लागत-प्रभावी AI एप्लिकेशन का निर्माण कर सकें।
...
| **Google** | [Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/) 1.5 Pro | 2,000K | अति-लंबे पाठ प्रसंस्करण, मल्टीमॉडल (वीडियो/ऑडियो) | विशाल कोडबेस विश्लेषण, वीडियो सारांश |
| **Google** | [Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/) 1.5 Flash | 2,000K | कम विलंबता, उच्च थ्रूपुट, अत्यधिक कम लागत | रियल-टाइम प्रसंस्करण, बड़े डेटा का बैच प्रसंस्करण |
...
जब आप [LLM](/hi/p/large-language-models-llm-transformer-prompt-engineering/) API को कॉल करते हैं, तो बैकएंड में किस तरह की प्रक्रिया होती है? प्रदर्शन को अनुकूलित करने के लिए इस आर्किटेक्चर को समझना आवश्यक है।
...
रियल-टाइम एप्लिकेशन में, विलंबता सीधे उपयोगकर्ता अनुभव (UX) को प्रभावित करती है। [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) API की विलंबता $T_{total}$ को गणितीय रूप से निम्न प्रकार मॉडल किया जा सकता है:
...
[Transformer](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) आर्किटेक्चर में सेल्फ-अटेंशन की गणना जटिलता इनपुट अनुक्रम की लंबाई $L$ के संबंध में द्विघातीय रूप से (quadratically) बढ़ती है।
...
हालाँकि, Google का [Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/) 1.5 "Ring Attention" और "Block-wise Compute" जैसे अभिनव अनुकूलन आर्किटेक्चर को अपनाता है, जो 2 मिलियन टोकन के लंबे पाठ इनपुट के साथ भी व्यावहारिक समय (कुछ सेकंड से लेकर कई दहाई सेकंड) में पहला टोकन सफलतापूर्वक उत्पन्न कर सकता है।
...
Anthropic (Claude) और Google ([Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/)) विशिष्ट टेक्स्ट ब्लॉक को कैश करके इनपुट लागत को काफी कम (90% तक) कर सकते हैं।
...
यहाँ, हम एक ऐसी स्क्रिप्ट लागू करेंगे जो एक साथ OpenAI, Anthropic और [Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/) API को अतुल्यकालिक (asynchronous) रूप से अनुरोध भेजती है और Python का उपयोग करके विलंबता (latency) की तुलना करती है।
...
[LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) को केवल एक चैटबॉट के रूप में काम करने के बजाय बाहरी प्रणालियों के साथ जुड़ने वाले "AI एजेंट" के रूप में कार्य करने के लिए, टूल कॉलिंग (या फंक्शन कॉलिंग) आवश्यक है। नीचे Node.js (TypeScript) का उपयोग करके OpenAI API के माध्यम से मौसम API को कॉल करने का एक उदाहरण दिया गया है।
...
Claude 3.5 Sonnet और [Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/) 1.5 Pro में भी समतुल्य टूल कॉलिंग कार्यक्षमता है। हालांकि स्कीमा को परिभाषित करने के तरीके में कुछ अंतर हैं, फिर भी बुनियादी प्रवाह (flow) समान है।
...
- **Google ([Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/) 1.5 Pro)**: ** वीडियो विश्लेषण में यह बाकियों को पछाड़ देता है।** आप 1 घंटे की वीडियो फ़ाइल (फ्रेम + ऑडियो) को सीधे इनपुट कर सकते हैं और बहुत विशिष्ट प्रश्नों का उत्तर पा सकते हैं जैसे, "12 मिनट 45 सेकंड पर स्क्रीन के दाईं ओर दिखाई देने वाले व्यक्ति के पास मौजूद दस्तावेज़ का शीर्षक क्या है?"
...
जब कंपनियाँ उत्पादन वातावरण (production environments) में [LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) API का उपयोग करती हैं, तो सबसे बड़ी चिंताएँ होती हैं: "क्या हमारे डेटा का उपयोग AI को प्रशिक्षित करने के लिए किया जाएगा?" और "क्या यह अनुपालन आवश्यकताओं को पूरा करता है?"
...
2. **अति-लंबे दस्तावेज़ों का विश्लेषण, वीडियो/ऑडियो का बैच प्रसंस्करण**:
   **👑 विजेता: [Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/) 1.5 Pro (Google)**
   इसकी 2 मिलियन टोकन की कॉन्टेक्स्ट विंडो इसका अद्वितीय हथियार है। उन कार्यों के लिए जहाँ आपको पूरे डेटा की समग्र तस्वीर (big picture) को समझने की आवश्यकता होती है, जैसे सैकड़ों पृष्ठों के PDF मैनुअल का विश्लेषण करना या लंबी मीटिंग रिकॉर्डिंग का सारांश देना, [Gemini](/hi/p/google-one-gemini%E3%81%8C%E8%A7%A3%E7%B4%84%E3%81%A7%E3%81%8D%E3%81%AA%E3%81%84%E6%99%82%E3%81%AE%E0%A4%B8%E0%A4%AE%E0%A4%BE%E0%A4%A7%E0%A4%BE%E0%A4%A8/) का कोई मुकाबला नहीं है।
...
एक ही API (वेंडर लॉक-इन) पर निर्भर रहने के बजाय, भविष्य का रुझान एक **"[LLM](https://kenji.blog/hi/p/large-language-models-llm-transformer-prompt-engineering/) राउटिंग"** आर्किटेक्चर है जो कार्य की कठिनाई और महत्व के आधार पर मॉडल को गतिशील रूप से (dynamically) बदलता है।
