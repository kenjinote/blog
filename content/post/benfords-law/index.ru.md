...
Математический закон, объясняющий этот загадочный феномен, — это **Закон Бенфорда (Benford's Law)**.
...
Закон Бенфорда (также известный как закон первой цифры) гласит, что во многих наборах реальных числовых данных вероятность появления первой цифры (наиболее значимой ненулевой цифры) выше для меньших чисел.
...
Закон Бенфорда не может быть применен ко всем данным. Существует четкое различие между данными, к которым он применяется, и данными, к которым он не применяется.
...
**Закон Бенфорда** — один из прекрасных математических порядков, скрытых в, казалось бы, хаотичном мире.
