...
«Голландец» здесь — это Гвидо ван Россум, [создатель Python](/ru/p/biography-guido-van-rossum/). В этом есть доля юмора: полное понимание намерений создателя языка может занять некоторое время.
