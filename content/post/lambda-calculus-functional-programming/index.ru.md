...
Сегодня, когда мы используем `map` или `filter` в React, применяем алгебраические типы данных в Rust или пишем лямбда-выражения на Python, мы все пользуемся плодами великого интеллектуального наследия Чёрча.
