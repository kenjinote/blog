...
そこでDNSは、世界中にある何十万台ものサーバーが協力してデータを分散管理する「**階層型の分散データベース**」として設計されました。これは、コンピュータサイエンス史上、最も成功し、最も大規模に稼働している分散システムと言われています。
...
しかし、1980年代にポール・モカペトリスらによって設計されたこの階層型分散システムがなければ、現在の巨大なインターネットは絶対に成り立ちませんでした。
