...
因此，DNS被设计为一个「 **分层分布式数据库** 」，由世界各地的数十万台服务器协作并分布式地管理数据。这被称为计算机科学史上最成功、最大规模运行的[分布式系统](/zh-cn/p/cap-theorem-distributed-systems-tradeoff/)。
...
然而，如果没有20世纪80年代由保罗·莫卡佩特里斯（Paul Mockapetris）等人设计的这种分层[分布式系统](/zh-cn/p/cap-theorem-distributed-systems-tradeoff/)，现在庞大的互联网是绝对无法成立的。
