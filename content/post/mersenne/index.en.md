...
[Marin Mersenne](https://kenji.blog/en/p/mersenne/) (1588–1648) was a 17th-century French theologian, philosopher, mathematician, and music theorist. While he made his own mathematical discoveries, he is most widely known for his role as the **"post-box of Europe"**, connecting the great scholars of his time.

In this article, we will explore [Mersenne](https://kenji.blog/en/p/mersenne/)'s life, the massive intellectual network he built, and the **[Mersenne](https://kenji.blog/en/p/mersenne/) primes** that are deeply connected to modern cryptography. Furthermore, we will delve into his contributions to acoustics and his influence on scientific methodology.

## Early Life and Monastic Life

[Marin Mersenne](https://kenji.blog/en/p/mersenne/) was born on September 8, 1588, to a peasant family in Oizé, Maine, France. After receiving basic education at a college in Le Mans, he entered the Jesuit college of La Flèche in 1604. There, he met [René Descartes](https://kenji.blog/en/p/descartes/), who would later become the father of modern philosophy, and forged a lifelong friendship with him.

In 1611, [Mersenne](https://kenji.blog/en/p/mersenne/) joined the Order of Minims. The Minims were an order with strict disciplines (such as fasting and vegetarianism), but they fostered a culture that encouraged the pursuit of scholarship. In 1619, he settled at the Convent of L'Annonciade in Paris, which became his base for immersing himself in theology, philosophy, and natural sciences.
...
## The Post-Box of Europe: The [Mersenne](https://kenji.blog/en/p/mersenne/) Network
...
Leveraging his innate curiosity and sociability, [Mersenne](https://kenji.blog/en/p/mersenne/) engaged in an enormous amount of correspondence with scholars across Europe. His monastic cell was akin to a scientific academy, through which many scholars exchanged ideas. This network is often referred to as the "[Mersenne](https://kenji.blog/en/p/mersenne/) network".
...
[Mersenne](https://kenji.blog/en/p/mersenne/)'s name is undoubtedly best remembered today in the form of **[Mersenne](https://kenji.blog/en/p/mersenne/) primes**.

A [Mersenne](https://kenji.blog/en/p/mersenne/) number is defined as follows:

$$
M_n = 2^n - 1 \quad (\text{where } n \text{ is a natural number})
$$

When this $M_n$ is a prime number, it is called a "[Mersenne](https://kenji.blog/en/p/mersenne/) prime".
...
In his 1644 book *Cogitata Physico-Mathematica*, [Mersenne](https://kenji.blog/en/p/mersenne/) claimed that for $n \le 257$, $M_n$ is prime only for:

$$
\text{Prime when } n = 2, 3, 5, 7, 13, 17, 19, 31, 67, 127, 257
$$

At the time, checking the primality of huge numbers by hand was practically impossible, so this bold claim was met with great astonishment. [Mersenne](https://kenji.blog/en/p/mersenne/) himself admitted that he had not rigorously calculated all the numbers.
...
Beyond mathematics, [Mersenne](https://kenji.blog/en/p/mersenne/) is also called the **"father of acoustics"**. His *Harmonie Universelle*, published in 1636, is the most comprehensive work on music theory and instruments of its time. In this book, he explored the physical foundations of pitch and consonance.

He discovered "[Mersenne](https://kenji.blog/en/p/mersenne/)'s laws" regarding the frequency of vibrating strings. The fundamental frequency $f$ of a string is expressed by the following equation based on the string's length $L$, tension $T$, and linear density $\mu$ (mass per unit length).
...
## Philosophy and Religion: Relationship with [Descartes](https://kenji.blog/en/p/descartes/)
