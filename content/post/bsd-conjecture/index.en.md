...
In 1922, Louis Mordell proved a decisive theorem regarding the structure of the rational point group $E(\mathbb{Q})$. Later, André Weil extended this to more general number fields and abelian varieties, and it is known as the Mordell-Weil theorem.
...
This problem was completely solved by the **Modularity Theorem** (formerly the Taniyama-Shimura Conjecture), which was fully proved in 2001. Through the monumental work of Andrew Wiles, Richard Taylor, Christophe Breuil, Brian Conrad, and Fred Diamond, it was shown that "all elliptic curves over the field of rational numbers are modular."
