...
## はじめに
アインシュタインの相対性理論は、私たちの時間と空間に対する理解を根本から変えました。

```mermaid
graph LR
    A["Special Relativity (1905)"] --> B["General Relativity (1915)"]
    A --> C["E=mc^2"]
    B --> D["Gravity as Space-Time Curvature"]
```

## アインシュタイン方程式
重力と時空の曲率の関係は、以下のテンソル方程式で表されます。
$$ R_{\mu
u} - rac{1}{2}g_{\mu
u}R + \Lambda g_{\mu
