...
## [베이즈 정리](https://kenji.blog/ko/p/bayes-theorem/)와 전체의 시각화
...
이 현상은 조건부 확률을 구하는 **"[베이즈 정리](https://kenji.blog/ko/p/bayes-theorem/)"** 에 의해 수학적으로 설명되지만, 인간의 뇌는 이 계산에 매우 서툽니다.
