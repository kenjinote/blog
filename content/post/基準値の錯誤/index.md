...
## [ベイズの定理](https://kenji.blog/p/bayes-theorem/)と全体の可視化
...
この現象は、条件付き確率を求める **「[ベイズの定理](https://kenji.blog/p/bayes-theorem/)」** によって数学的に説明されますが、人間の脳はこの計算が非常に苦手です。
...
- **顔[認証](https://kenji.blog/p/oauth2-oidc-authentication-authorization-difference/)システムとテロリスト** ：
