...
description: "即使在准确率99%的检查中呈阳性，实际生病的概率仅有9%？分析人类直觉被统计数据欺骗的「基准率谬误」。"
...
## [贝叶斯定理](https://kenji.blog/zh-cn/p/bayes-theorem/)与整体可视化
...
这种现象可以由计算条件概率的 **“[贝叶斯定理](https://kenji.blog/zh-cn/p/bayes-theorem/)”** 在数学上进行解释，但人类大脑非常不擅长进行这种计算。
