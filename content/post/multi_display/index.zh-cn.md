...
这是最标准的配置。如果横向并排摆放，由于边框位于正中央，你的脖子必须始终向左或向右倾斜。为了避免这种情况，建议将一台放在正前方（主屏），另一台放在斜侧方（副屏），或者上下堆叠摆放（[Stack](https://kenji.blog/zh-cn/p/c-language-pointers-memory-management-stack-heap/) 布局）。
