---
title: 'WindowsにGemini CLIをインストールする方法｜Node.jsから徹底解説'
...
image: "img.webp"
categories: ["PC・ガジェット"]
description: 'Googleの生成AI「Gemini」をコマンドラインから使える「Gemini CLI」をWindows環境にインストールする方法を初心者向けに解説。Node.jsやnpmの準備からPowerShellでの実行手順まで詳しく紹介します。'
---
