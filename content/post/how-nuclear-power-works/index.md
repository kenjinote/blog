...
本記事では、商用発電で広く使われる**軽水炉**を中心に説明します。図は役割を理解するための模式図で、実際の配管配置や運転手順を示すものではありません。[核融合発電](/p/how-fusion-power-works/)は軽い原子核を結合させる別方式であり、ここで扱う核分裂炉とは区別します。[米国エネルギー省の原子炉入門][doe-reactor]
