...
dir_path = r'c:\work\kenji.blog\content\post\continuum-hypothesis'
os.makedirs(dir_path, exist_ok=True)

shutil.copy(
    r'C:\Users\kenjinote\.gemini\antigravity\brain\b6e476c9-e790-400d-a21f-a11db13d822c\eyecatch_1789358679567.jpg',
    os.path.join(dir_path, 'eyecatch.jpg')
)
...
with open(os.path.join(dir_path, 'index.md'), 'w', encoding='utf-8') as f:
    f.write(content)
print(f'Wrote {len(content)} characters to index.md.')
