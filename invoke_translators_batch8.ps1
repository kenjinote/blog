...
$articles = @("game-othello-rules", "game-chess-rules", "game-poker-rules", "game-mahjong-rules", "game-rubiks-cube", "history-of-iphone")
...
$json += "] }"
$json | Out-File -Encoding utf8 subagents8.json
