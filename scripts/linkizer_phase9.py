...
targets = {
    'time-space-complexity-big-o-notation-examples': [
        "時間計算量", "空間計算量", "O記法", "Big O"
    ],
    'sorting-algorithms-visualized-bubble-quick-merge': [
        "ソートアルゴリズム", "バブルソート", "クイックソート", "マージソート", "Sorting Algorithm", "Sorting Algorithms"
    ],
    'search-algorithms-linear-binary-hash-table-principles': [
        "探索アルゴリズム", "線形探索", "二分探索", "ハッシュテーブル", "Binary Search", "Hash Table"
    ],
    'tree-graph-data-structures-search-dfs-bfs-dijkstra': [
        "木構造", "グラフ", "DFS", "BFS", "ダイクストラ法", "Graph", "Tree", "Dijkstra"
    ],
    'dynamic-programming-dp-introduction-knapsack-fibonacci': [
        "動的計画法", "DP", "ナップサック問題", "フィボナッチ数列", "Dynamic Programming"
    ]
}
