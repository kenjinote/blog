...
directories = [
    r"c:\work\kenji.blog\content\post\rdbms-transaction-acid-isolation-level-lock",
    r"c:\work\kenji.blog\content\post\nosql-database-selection-kvs-document-graph-wide-column",
    r"c:\work\kenji.blog\content\post\microservices-architecture-bff-api-gateway",
    r"c:\work\kenji.blog\content\post\event-driven-architecture-message-queue-kafka-rabbitmq",
    r"c:\work\kenji.blog\content\post\cap-theorem-distributed-systems-tradeoff"
]
