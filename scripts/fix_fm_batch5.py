...
directories = [
    r"c:\work\kenji.blog\content\post\docker-container-namespace-cgroups-layers",
    r"c:\work\kenji.blog\content\post\kubernetes-k8s-architecture-pod-service-ingress",
    r"c:\work\kenji.blog\content\post\serverless-architecture-aws-lambda-cold-start",
    r"c:\work\kenji.blog\content\post\iac-infrastructure-as-code-terraform",
    r"c:\work\kenji.blog\content\post\cicd-pipeline-github-actions-best-practices"
]
...
print("Fixed front matter and inline math for phase 5.")
