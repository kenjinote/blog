...
directories = [
    r"c:\work\kenji.blog\content\post\b-tree-database-index-theory",
    r"c:\work\kenji.blog\content\post\graph-theory-dijkstra-a-star",
    r"c:\work\kenji.blog\content\post\cap-theorem-distributed-systems",
    r"c:\work\kenji.blog\content\post\byzantine-generals-problem-consensus",
    r"c:\work\kenji.blog\content\post\information-theory-shannon-entropy"
]
...
print("Fixed front matter and inline math for phase 2.")
