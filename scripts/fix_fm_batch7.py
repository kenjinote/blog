...
directories = [
    r"c:\work\kenji.blog\content\post\pwa-progressive-web-apps-service-worker",
    r"c:\work\kenji.blog\content\post\web-vitals-frontend-performance-optimization-lcp-fid-cls",
    r"c:\work\kenji.blog\content\post\state-management-history-redux-context-recoil-zustand",
    r"c:\work\kenji.blog\content\post\graphql-vs-rest-api-overfetching-type-safety",
    r"c:\work\kenji.blog\content\post\micro-frontends-architecture-spa-division"
]
...
print("Fixed front matter and inline math for phase 7.")
