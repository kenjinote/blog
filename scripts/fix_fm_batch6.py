...
directories = [
    r"c:\work\kenji.blog\content\post\modern-cryptography-public-key-hash-signature",
    r"c:\work\kenji.blog\content\post\oauth2-oidc-authentication-authorization-difference",
    r"c:\work\kenji.blog\content\post\zero-trust-network-architecture-beyond-corp",
    r"c:\work\kenji.blog\content\post\web-application-vulnerability-owasp-top-10",
    r"c:\work\kenji.blog\content\post\blockchain-technology-smart-contract-distributed-ledger"
]
...
print("Fixed front matter and inline math for phase 6.")
