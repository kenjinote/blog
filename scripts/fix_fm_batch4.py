...
directories = [
    r"c:\work\kenji.blog\content\post\browser-rendering-mechanism-dom-paint",
    r"c:\work\kenji.blog\content\post\webassembly-wasm-current-future",
    r"c:\work\kenji.blog\content\post\http3-quic-protocol-tcp-udp",
    r"c:\work\kenji.blog\content\post\webrtc-realtime-communication-p2p",
    r"c:\work\kenji.blog\content\post\web-security-basics-cors-csp"
]
...
print("Fixed front matter and inline math for phase 4.")
