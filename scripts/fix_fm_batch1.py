...
directories = [
    r"c:\work\kenji.blog\content\post\p-vs-np-problem",
    r"c:\work\kenji.blog\content\post\turing-machine-computability",
    r"c:\work\kenji.blog\content\post\quantum-computing-shors-algorithm",
    r"c:\work\kenji.blog\content\post\lambda-calculus-functional-programming",
    r"c:\work\kenji.blog\content\post\automata-formal-language-theory"
]
...
print("Fixed front matter and inline math.")
